...
require github.com/sourcegraph/cdktf-provider-gen v0.0.0-20230814213155-40493e559b2b
...
require (
	...
	github.com/sourcegraph/sourcegraph/lib v0.0.0-20230810200548-f8a32bcbd9e3 // indirect
