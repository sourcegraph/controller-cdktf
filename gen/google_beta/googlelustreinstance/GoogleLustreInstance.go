...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_lustre_instance google_lustre_instance}.
...
func (j *jsiiProxy_GoogleLustreInstance) CapacityGibInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"capacityGibInput",
...
func (j *jsiiProxy_GoogleLustreInstance) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleLustreInstance) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_GoogleLustreInstance) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleLustreInstance) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleLustreInstance) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleLustreInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleLustreInstance) Filesystem() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filesystem",
...
func (j *jsiiProxy_GoogleLustreInstance) FilesystemInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filesystemInput",
...
func (j *jsiiProxy_GoogleLustreInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleLustreInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleLustreInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleLustreInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleLustreInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleLustreInstance) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_GoogleLustreInstance) InstanceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceIdInput",
...
func (j *jsiiProxy_GoogleLustreInstance) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleLustreInstance) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleLustreInstance) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GoogleLustreInstance) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_GoogleLustreInstance) MountPoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mountPoint",
...
func (j *jsiiProxy_GoogleLustreInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleLustreInstance) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_GoogleLustreInstance) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_GoogleLustreInstance) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleLustreInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleLustreInstance) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleLustreInstance) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_GoogleLustreInstance) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleLustreInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleLustreInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleLustreInstance) Timeouts() GoogleLustreInstanceTimeoutsOutputReference {
	var returns GoogleLustreInstanceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_lustre_instance google_lustre_instance} Resource.
func NewGoogleLustreInstance(scope constructs.Construct, id *string, config *GoogleLustreInstanceConfig) GoogleLustreInstance {
	_init_.Initialize()

	if err := validateNewGoogleLustreInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleLustreInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleLustreInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GoogleLustreInstance_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleLustreInstance.GoogleLustreInstance",
...
func (g *jsiiProxy_GoogleLustreInstance) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleLustreInstance) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleLustreInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleLustreInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleLustreInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleLustreInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleLustreInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleLustreInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleLustreInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleLustreInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLustreInstance) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleLustreInstance) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleLustreInstance) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleLustreInstance) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleLustreInstance) ResetGkeSupportEnabled() {
	_jsii_.InvokeVoid(
		g,
		"resetGkeSupportEnabled",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLustreInstance) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLustreInstance) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLustreInstance) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLustreInstance) ToString() *string {
	var returns *string
