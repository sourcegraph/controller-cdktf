...
func (j *jsiiProxy_DataGoogleMemorystoreInstanceMaintenancePolicyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleMemorystoreInstanceMaintenancePolicyList_Override(d DataGoogleMemorystoreInstanceMaintenancePolicyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleMemorystoreInstanceMaintenancePolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
