...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logMetadata", GoGetter: "LogMetadata"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogPromptsAndResponses", GoMethod: "ResetLogPromptsAndResponses"},
