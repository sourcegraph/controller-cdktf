...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exportCustomRoutesWithPublicIp", GoGetter: "ExportCustomRoutesWithPublicIp"},
			_jsii_.MemberProperty{JsiiProperty: "exportCustomRoutesWithPublicIpInput", GoGetter: "ExportCustomRoutesWithPublicIpInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "importCustomRoutesWithPublicIp", GoGetter: "ImportCustomRoutesWithPublicIp"},
			_jsii_.MemberProperty{JsiiProperty: "importCustomRoutesWithPublicIpInput", GoGetter: "ImportCustomRoutesWithPublicIpInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "peerNetworkType", GoGetter: "PeerNetworkType"},
			_jsii_.MemberProperty{JsiiProperty: "peerNetworkTypeInput", GoGetter: "PeerNetworkTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImportCustomRoutesWithPublicIp", GoMethod: "ResetImportCustomRoutesWithPublicIp"},
