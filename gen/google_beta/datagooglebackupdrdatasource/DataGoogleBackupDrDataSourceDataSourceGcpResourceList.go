...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceDataSourceGcpResourceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleBackupDrDataSourceDataSourceGcpResourceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBackupDrDataSourceDataSourceGcpResourceList {
	_init_.Initialize()
...
func NewDataGoogleBackupDrDataSourceDataSourceGcpResourceList_Override(d DataGoogleBackupDrDataSourceDataSourceGcpResourceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceDataSourceGcpResourceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceDataSourceGcpResourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceDataSourceGcpResourceList) Resolve(_context cdktf.IResolveContext) interface{} {
