...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_backup_dr_data_source google_backup_dr_data_source}.
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) BackupConfigInfo() DataGoogleBackupDrDataSourceBackupConfigInfoList {
	var returns DataGoogleBackupDrDataSourceBackupConfigInfoList
	_jsii_.Get(
		j,
		"backupConfigInfo",
		&returns,
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) BackupCount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupCount",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) BackupVaultId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupVaultId",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) BackupVaultIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupVaultIdInput",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) ConfigState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configState",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) DataSourceBackupApplianceApplication() DataGoogleBackupDrDataSourceDataSourceBackupApplianceApplicationList {
	var returns DataGoogleBackupDrDataSourceDataSourceBackupApplianceApplicationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) DataSourceGcpResource() DataGoogleBackupDrDataSourceDataSourceGcpResourceList {
	var returns DataGoogleBackupDrDataSourceDataSourceGcpResourceList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) DataSourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataSourceId",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) DataSourceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataSourceIdInput",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) TotalStoredBytes() *string {
	var returns *string
	_jsii_.Get(
		j,
		"totalStoredBytes",
...
func (j *jsiiProxy_DataGoogleBackupDrDataSource) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_backup_dr_data_source google_backup_dr_data_source} Data Source.
func NewDataGoogleBackupDrDataSource(scope constructs.Construct, id *string, config *DataGoogleBackupDrDataSourceConfig) DataGoogleBackupDrDataSource {
	...
	if err := validateNewDataGoogleBackupDrDataSourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleBackupDrDataSource_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleBackupDrDataSource.DataGoogleBackupDrDataSource",
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBackupDrDataSource) ToString() *string {
	var returns *string
