...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_logging_folder_bucket_config google_logging_folder_bucket_config}.
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleLoggingFolderBucketConfig) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_logging_folder_bucket_config google_logging_folder_bucket_config} Resource.
...
func GoogleLoggingFolderBucketConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleLoggingFolderBucketConfig) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleLoggingFolderBucketConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingFolderBucketConfig) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
