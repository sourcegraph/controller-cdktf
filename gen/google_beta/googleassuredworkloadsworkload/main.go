...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complianceRegime", GoGetter: "ComplianceRegime"},
			_jsii_.MemberProperty{JsiiProperty: "complianceRegimeInput", GoGetter: "ComplianceRegimeInput"},
			_jsii_.MemberProperty{JsiiProperty: "complianceStatus", GoGetter: "ComplianceStatus"},
			_jsii_.MemberProperty{JsiiProperty: "compliantButDisallowedServices", GoGetter: "CompliantButDisallowedServices"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ekmProvisioningResponse", GoGetter: "EkmProvisioningResponse"},
			_jsii_.MemberProperty{JsiiProperty: "enableSovereignControls", GoGetter: "EnableSovereignControls"},
			_jsii_.MemberProperty{JsiiProperty: "enableSovereignControlsInput", GoGetter: "EnableSovereignControlsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "kajEnrollmentState", GoGetter: "KajEnrollmentState"},
			_jsii_.MemberProperty{JsiiProperty: "kmsSettings", GoGetter: "KmsSettings"},
			_jsii_.MemberProperty{JsiiProperty: "kmsSettingsInput", GoGetter: "KmsSettingsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "partner", GoGetter: "Partner"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putKmsSettings", GoMethod: "PutKmsSettings"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKmsSettings", GoMethod: "ResetKmsSettings"},
			...
			_jsii_.MemberProperty{JsiiProperty: "saaEnrollmentResponse", GoGetter: "SaaEnrollmentResponse"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "ekmProvisioningErrorDomain", GoGetter: "EkmProvisioningErrorDomain"},
			_jsii_.MemberProperty{JsiiProperty: "ekmProvisioningErrorMapping", GoGetter: "EkmProvisioningErrorMapping"},
			_jsii_.MemberProperty{JsiiProperty: "ekmProvisioningState", GoGetter: "EkmProvisioningState"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nextRotationTimeInput", GoGetter: "NextRotationTimeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dataLogsViewer", GoGetter: "DataLogsViewer"},
			_jsii_.MemberProperty{JsiiProperty: "dataLogsViewerInput", GoGetter: "DataLogsViewerInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAssuredWorkloadsMonitoring", GoMethod: "ResetAssuredWorkloadsMonitoring"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataLogsViewer", GoMethod: "ResetDataLogsViewer"},
			_jsii_.MemberMethod{JsiiMethod: "resetServiceAccessApprover", GoMethod: "ResetServiceAccessApprover"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "serviceAccessApprover", GoGetter: "ServiceAccessApprover"},
			_jsii_.MemberProperty{JsiiProperty: "serviceAccessApproverInput", GoGetter: "ServiceAccessApproverInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "setupErrors", GoGetter: "SetupErrors"},
			_jsii_.MemberProperty{JsiiProperty: "setupStatus", GoGetter: "SetupStatus"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
