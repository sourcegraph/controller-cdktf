...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "frequencyOptions", GoGetter: "FrequencyOptions"},
			_jsii_.MemberProperty{JsiiProperty: "frequencyOptionsInput", GoGetter: "FrequencyOptionsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "objectMetadataReportOptions", GoGetter: "ObjectMetadataReportOptions"},
			_jsii_.MemberProperty{JsiiProperty: "objectMetadataReportOptionsInput", GoGetter: "ObjectMetadataReportOptionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFrequencyOptions", GoMethod: "PutFrequencyOptions"},
			_jsii_.MemberMethod{JsiiMethod: "putObjectMetadataReportOptions", GoMethod: "PutObjectMetadataReportOptions"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisplayName", GoMethod: "ResetDisplayName"},
			_jsii_.MemberMethod{JsiiMethod: "resetFrequencyOptions", GoMethod: "ResetFrequencyOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetObjectMetadataReportOptions", GoMethod: "ResetObjectMetadataReportOptions"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "headerRequired", GoGetter: "HeaderRequired"},
			_jsii_.MemberProperty{JsiiProperty: "headerRequiredInput", GoGetter: "HeaderRequiredInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "recordSeparator", GoGetter: "RecordSeparator"},
			_jsii_.MemberProperty{JsiiProperty: "recordSeparatorInput", GoGetter: "RecordSeparatorInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDelimiter", GoMethod: "ResetDelimiter"},
			_jsii_.MemberMethod{JsiiMethod: "resetHeaderRequired", GoMethod: "ResetHeaderRequired"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecordSeparator", GoMethod: "ResetRecordSeparator"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putStorageDestinationOptions", GoMethod: "PutStorageDestinationOptions"},
			_jsii_.MemberMethod{JsiiMethod: "putStorageFilters", GoMethod: "PutStorageFilters"},
			_jsii_.MemberMethod{JsiiMethod: "resetStorageFilters", GoMethod: "ResetStorageFilters"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "storageDestinationOptions", GoGetter: "StorageDestinationOptions"},
			_jsii_.MemberProperty{JsiiProperty: "storageDestinationOptionsInput", GoGetter: "StorageDestinationOptionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "storageFilters", GoGetter: "StorageFilters"},
			_jsii_.MemberProperty{JsiiProperty: "storageFiltersInput", GoGetter: "StorageFiltersInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
