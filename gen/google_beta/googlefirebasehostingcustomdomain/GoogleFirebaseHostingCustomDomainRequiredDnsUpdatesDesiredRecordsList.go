...
func (j *jsiiProxy_GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList {
	_init_.Initialize()
...
func NewGoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList_Override(g GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleFirebaseHostingCustomDomainRequiredDnsUpdatesDesiredRecordsList) Resolve(_context cdktf.IResolveContext) interface{} {
