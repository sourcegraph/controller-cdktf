...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglegkehubmembershipbinding/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/data-sources/google_gke_hub_membership_binding google_gke_hub_membership_binding}.
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) DeleteTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteTime",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) MembershipBindingId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipBindingId",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) MembershipBindingIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) MembershipId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipId",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) MembershipIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipIdInput",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) State() DataGoogleGkeHubMembershipBindingStateList {
	var returns DataGoogleGkeHubMembershipBindingStateList
	_jsii_.Get(
		j,
		"state",
		&returns,
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_DataGoogleGkeHubMembershipBinding) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/data-sources/google_gke_hub_membership_binding google_gke_hub_membership_binding} Data Source.
func NewDataGoogleGkeHubMembershipBinding(scope constructs.Construct, id *string, config *DataGoogleGkeHubMembershipBindingConfig) DataGoogleGkeHubMembershipBinding {
	...
	if err := validateNewDataGoogleGkeHubMembershipBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleGkeHubMembershipBinding{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBinding",
...
func DataGoogleGkeHubMembershipBinding_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBinding",
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleGkeHubMembershipBinding) ToString() *string {
	var returns *string
