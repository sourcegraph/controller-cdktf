...
func (j *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"google-beta.dataGoogleContainerCluster.DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList",
...
func NewDataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList_Override(d DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyDailyMaintenanceWindowList) Resolve(_context cdktf.IResolveContext) interface{} {
