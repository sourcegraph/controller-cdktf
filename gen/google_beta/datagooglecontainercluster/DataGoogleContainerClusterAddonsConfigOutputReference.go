...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) IstioConfig() DataGoogleContainerClusterAddonsConfigIstioConfigList {
	var returns DataGoogleContainerClusterAddonsConfigIstioConfigList
	_jsii_.Get(
		j,
		"istioConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigOutputReference) KalmConfig() DataGoogleContainerClusterAddonsConfigKalmConfigList {
	var returns DataGoogleContainerClusterAddonsConfigKalmConfigList
	_jsii_.Get(
		j,
		"kalmConfig",
		&returns,
...
func NewDataGoogleContainerClusterAddonsConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleContainerClusterAddonsConfigOutputReference {
	...
	_jsii_.Create(
		"google-beta.dataGoogleContainerCluster.DataGoogleContainerClusterAddonsConfigOutputReference",
