...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolDefaultsNodeConfigDefaultsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
