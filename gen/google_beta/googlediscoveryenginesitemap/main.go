...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemap",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sitemapId", GoGetter: "SitemapId"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineSitemapConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts",
