...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "envKeyvaluemapId", GoGetter: "EnvKeyvaluemapId"},
			_jsii_.MemberProperty{JsiiProperty: "envKeyvaluemapIdInput", GoGetter: "EnvKeyvaluemapIdInput"},
