...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_gkeonprem_bare_metal_admin_cluster google_gkeonprem_bare_metal_admin_cluster}.
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) EffectiveAnnotations() cdktf.StringMap {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_gkeonprem_bare_metal_admin_cluster google_gkeonprem_bare_metal_admin_cluster} Resource.
...
func GoogleGkeonpremBareMetalAdminCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleGkeonpremBareMetalAdminCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminCluster) ToHclTerraform() interface{} {
	var returns interface{}
