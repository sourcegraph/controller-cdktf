...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleGkeHubFeatureSpecClusterupgradeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleGkeHubFeatureSpecClusterupgradeList {
	_init_.Initialize()
...
func NewDataGoogleGkeHubFeatureSpecClusterupgradeList_Override(d DataGoogleGkeHubFeatureSpecClusterupgradeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeList) Resolve(_context cdktf.IResolveContext) interface{} {
