...
func (j *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"google-beta.googleNetworkSecurityClientTlsPolicy.GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference",
...
func NewGoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference_Override(g GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkSecurityClientTlsPolicyClientCertificateGrpcEndpointOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
