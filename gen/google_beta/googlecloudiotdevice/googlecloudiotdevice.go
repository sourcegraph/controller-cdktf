...
// Generates CDKTF code for importing a GoogleCloudiotDevice resource upon running "cdktf plan <stack-name>".
func GoogleCloudiotDevice_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleCloudiotDevice_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleCloudiotDevice) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleCloudiotDevice) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleCloudiotDevice) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleCloudiotDevice) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleCloudiotDevice) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleCloudiotDevice) MoveToId(id *string) {
