...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlebillingsubaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_billing_subaccount google_billing_subaccount}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_billing_subaccount google_billing_subaccount} Resource.
...
func GoogleBillingSubaccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleBillingSubaccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleBillingSubaccount) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleBillingSubaccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleBillingSubaccount) ToHclTerraform() interface{} {
	var returns interface{}
