...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagoogleorganizationiamcustomrole/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_organization_iam_custom_role google_organization_iam_custom_role}.
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Permissions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissions",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) RoleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleId",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) RoleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleIdInput",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Stage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stage",
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleOrganizationIamCustomRole) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_organization_iam_custom_role google_organization_iam_custom_role} Data Source.
func NewDataGoogleOrganizationIamCustomRole(scope constructs.Construct, id *string, config *DataGoogleOrganizationIamCustomRoleConfig) DataGoogleOrganizationIamCustomRole {
	...
	if err := validateNewDataGoogleOrganizationIamCustomRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleOrganizationIamCustomRole{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleOrganizationIamCustomRole.DataGoogleOrganizationIamCustomRole",
...
func DataGoogleOrganizationIamCustomRole_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleOrganizationIamCustomRole.DataGoogleOrganizationIamCustomRole",
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleOrganizationIamCustomRole) ToString() *string {
	var returns *string
