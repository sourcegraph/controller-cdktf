...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_identity_platform_inbound_saml_config google_identity_platform_inbound_saml_config}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_identity_platform_inbound_saml_config google_identity_platform_inbound_saml_config} Resource.
...
func GoogleIdentityPlatformInboundSamlConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleIdentityPlatformInboundSamlConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleIdentityPlatformInboundSamlConfig) ToHclTerraform() interface{} {
	var returns interface{}
