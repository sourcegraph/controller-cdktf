...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googleactivedirectorydomain/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_active_directory_domain google_active_directory_domain}.
type GoogleActiveDirectoryDomain interface {
	...
	PutTimeouts(value *GoogleActiveDirectoryDomainTimeouts)
	ResetAdmin()
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) AdminInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"adminInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) AuthorizedNetworks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"authorizedNetworks",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) AuthorizedNetworksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) DomainNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainNameInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Fqdn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqdn",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Locations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"locations",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) LocationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"locationsInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) ReservedIpRange() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reservedIpRange",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) ReservedIpRangeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) Timeouts() GoogleActiveDirectoryDomainTimeoutsOutputReference {
	var returns GoogleActiveDirectoryDomainTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_active_directory_domain google_active_directory_domain} Resource.
func NewGoogleActiveDirectoryDomain(scope constructs.Construct, id *string, config *GoogleActiveDirectoryDomainConfig) GoogleActiveDirectoryDomain {
	...
	if err := validateNewGoogleActiveDirectoryDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleActiveDirectoryDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomain",
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) PutTimeouts(value *GoogleActiveDirectoryDomainTimeouts) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetAdmin() {
	_jsii_.InvokeVoid(
		g,
		"resetAdmin",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetAuthorizedNetworks() {
	_jsii_.InvokeVoid(
		g,
		"resetAuthorizedNetworks",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetDeletionProtection() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionProtection",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ToString() *string {
	var returns *string
