...
func (j *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (g *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) Get(index *float64) GoogleTranscoderJobConfigEditListStructOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleTranscoderJobConfigEditListStructOutputReference
...
func (g *jsiiProxy_GoogleTranscoderJobConfigEditListStructList) ToString() *string {
	var returns *string
