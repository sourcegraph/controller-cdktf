...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.googleComputeInstantSnapshotIamPolicy.GoogleComputeInstantSnapshotIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleComputeInstantSnapshotIamPolicy.GoogleComputeInstantSnapshotIamPolicyConfig",
