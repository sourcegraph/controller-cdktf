...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEntryTypeId", GoMethod: "ResetEntryTypeId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRequiredAspects", GoMethod: "ResetRequiredAspects"},
			_jsii_.MemberMethod{JsiiMethod: "resetSystemAttribute", GoMethod: "ResetSystemAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetTypeAliases", GoMethod: "ResetTypeAliases"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "systemAttribute", GoGetter: "SystemAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "systemAttributeInput", GoGetter: "SystemAttributeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "typeAliases", GoGetter: "TypeAliases"},
