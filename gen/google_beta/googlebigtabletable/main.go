...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automatedBackupPolicyInput", GoGetter: "AutomatedBackupPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAutomatedBackupPolicy", GoMethod: "PutAutomatedBackupPolicy"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSplitKeys", GoMethod: "ResetSplitKeys"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "splitKeys", GoGetter: "SplitKeys"},
			_jsii_.MemberProperty{JsiiProperty: "splitKeysInput", GoGetter: "SplitKeysInput"},
