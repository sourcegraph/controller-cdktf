...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parserConfig", GoGetter: "ParserConfig"},
			_jsii_.MemberProperty{JsiiProperty: "parserConfigInput", GoGetter: "ParserConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParserConfig", GoMethod: "ResetParserConfig"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreNotificationConfig",
		reflect.TypeOf((*GoogleHealthcareHl7V2StoreNotificationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreNotificationConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreNotificationConfigs",
	...
	_jsii_.RegisterClass(
		"google-beta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreParserConfigOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowNullHeader", GoMethod: "ResetAllowNullHeader"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreTimeouts",
