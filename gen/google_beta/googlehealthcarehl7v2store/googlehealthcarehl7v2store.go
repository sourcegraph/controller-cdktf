...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_healthcare_hl7_v2_store google_healthcare_hl7_v2_store}.
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_healthcare_hl7_v2_store google_healthcare_hl7_v2_store} Resource.
...
func GoogleHealthcareHl7V2Store_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleHealthcareHl7V2Store_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) MoveToId(id *string) {
