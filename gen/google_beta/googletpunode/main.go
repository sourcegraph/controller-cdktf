...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "tensorflowVersion", GoGetter: "TensorflowVersion"},
			_jsii_.MemberProperty{JsiiProperty: "tensorflowVersionInput", GoGetter: "TensorflowVersionInput"},
