...
type GoogleDatastreamStreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemasTables struct {
	...
	// columns block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_datastream_stream#columns GoogleDatastreamStream#columns}
