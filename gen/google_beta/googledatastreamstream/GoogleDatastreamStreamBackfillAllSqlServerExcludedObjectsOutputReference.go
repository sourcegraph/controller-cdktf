...
func (j *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference {
	_init_.Initialize()
...
func NewGoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference_Override(g GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllSqlServerExcludedObjectsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
