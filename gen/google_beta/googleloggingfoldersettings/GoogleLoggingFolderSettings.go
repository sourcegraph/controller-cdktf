...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_logging_folder_settings google_logging_folder_settings}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_logging_folder_settings google_logging_folder_settings} Resource.
func NewGoogleLoggingFolderSettings(scope constructs.Construct, id *string, config *GoogleLoggingFolderSettingsConfig) GoogleLoggingFolderSettings {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleLoggingFolderSettings.GoogleLoggingFolderSettings",
...
func GoogleLoggingFolderSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleLoggingFolderSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleLoggingFolderSettings) ToHclTerraform() interface{} {
	var returns interface{}
