...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysConfig",
		reflect.TypeOf((*DataGoogleTagsTagKeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeys",
