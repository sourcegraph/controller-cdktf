...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.78.0/docs/resources/google_game_services_game_server_deployment_rollout google_game_services_game_server_deployment_rollout}.
...
func (j *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.78.0/docs/resources/google_game_services_game_server_deployment_rollout google_game_services_game_server_deployment_rollout} Resource.
...
func (j *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout)SetCount(val interface{}) {
...
// Generates CDKTF code for importing a GoogleGameServicesGameServerDeploymentRollout resource upon running "cdktf plan <stack-name>".
func GoogleGameServicesGameServerDeploymentRollout_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleGameServicesGameServerDeploymentRollout_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func GoogleGameServicesGameServerDeploymentRollout_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGoogleGameServicesGameServerDeploymentRollout_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GoogleGameServicesGameServerDeploymentRollout_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGoogleGameServicesGameServerDeploymentRollout_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleGameServicesGameServerDeploymentRollout) MoveToId(id *string) {
