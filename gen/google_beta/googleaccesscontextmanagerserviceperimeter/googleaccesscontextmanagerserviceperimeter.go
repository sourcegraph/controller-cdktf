...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_access_context_manager_service_perimeter google_access_context_manager_service_perimeter}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_access_context_manager_service_perimeter google_access_context_manager_service_perimeter} Resource.
...
func GoogleAccessContextManagerServicePerimeter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleAccessContextManagerServicePerimeter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeter) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeter) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeter) MoveToId(id *string) {
