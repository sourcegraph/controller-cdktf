...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexTaskIamMember.GoogleDataplexTaskIamMemberCondition",
		reflect.TypeOf((*GoogleDataplexTaskIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleDataplexTaskIamMember.GoogleDataplexTaskIamMemberConditionOutputReference",
