...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_storage_bucket google_storage_bucket}.
type DataGoogleStorageBucket interface {
	...
	HierarchicalNamespace() DataGoogleStorageBucketHierarchicalNamespaceList
	Id() *string
	SetId(val *string)
	IdInput() *string
	...
	LifecycleRule() DataGoogleStorageBucketLifecycleRuleList
	Location() *string
...
func (j *jsiiProxy_DataGoogleStorageBucket) Cors() DataGoogleStorageBucketCorsList {
	var returns DataGoogleStorageBucketCorsList
	_jsii_.Get(
		j,
		"cors",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) DefaultEventBasedHold() cdktf.IResolvable {
...
func (j *jsiiProxy_DataGoogleStorageBucket) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Encryption() DataGoogleStorageBucketEncryptionList {
	var returns DataGoogleStorageBucketEncryptionList
	_jsii_.Get(
		j,
		"encryption",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) ForceDestroy() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"forceDestroy",
...
func (j *jsiiProxy_DataGoogleStorageBucket) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleStorageBucket) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleStorageBucket) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleStorageBucket) HierarchicalNamespace() DataGoogleStorageBucketHierarchicalNamespaceList {
	var returns DataGoogleStorageBucketHierarchicalNamespaceList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleStorageBucket) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleStorageBucket) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Labels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleStorageBucket) LifecycleRule() DataGoogleStorageBucketLifecycleRuleList {
	var returns DataGoogleStorageBucketLifecycleRuleList
	_jsii_.Get(
		j,
		"lifecycleRule",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Logging() DataGoogleStorageBucketLoggingList {
	var returns DataGoogleStorageBucketLoggingList
	_jsii_.Get(
		j,
		"logging",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleStorageBucket) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleStorageBucket) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleStorageBucket) RequesterPays() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"requesterPays",
...
func (j *jsiiProxy_DataGoogleStorageBucket) RetentionPolicy() DataGoogleStorageBucketRetentionPolicyList {
	var returns DataGoogleStorageBucketRetentionPolicyList
	_jsii_.Get(
		j,
		"retentionPolicy",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) StorageClass() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageClass",
...
func (j *jsiiProxy_DataGoogleStorageBucket) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleStorageBucket) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleStorageBucket) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
func (j *jsiiProxy_DataGoogleStorageBucket) Versioning() DataGoogleStorageBucketVersioningList {
	var returns DataGoogleStorageBucketVersioningList
	_jsii_.Get(
		j,
		"versioning",
		&returns,
...
func (j *jsiiProxy_DataGoogleStorageBucket) Website() DataGoogleStorageBucketWebsiteList {
	var returns DataGoogleStorageBucketWebsiteList
	_jsii_.Get(
		j,
		"website",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_storage_bucket google_storage_bucket} Data Source.
func NewDataGoogleStorageBucket(scope constructs.Construct, id *string, config *DataGoogleStorageBucketConfig) DataGoogleStorageBucket {
	...
	if err := validateNewDataGoogleStorageBucketParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleStorageBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleStorageBucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleStorageBucket) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleStorageBucket) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleStorageBucket) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleStorageBucket) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageBucket) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageBucket) ToString() *string {
	var returns *string
