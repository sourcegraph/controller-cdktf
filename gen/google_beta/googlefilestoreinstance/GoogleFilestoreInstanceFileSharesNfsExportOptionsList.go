...
type GoogleFilestoreInstanceFileSharesNfsExportOptionsList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for GoogleFilestoreInstanceFileSharesNfsExportOptionsList
type jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewGoogleFilestoreInstanceFileSharesNfsExportOptionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleFilestoreInstanceFileSharesNfsExportOptionsList {
	...
	if err := validateNewGoogleFilestoreInstanceFileSharesNfsExportOptionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) Get(index *float64) GoogleFilestoreInstanceFileSharesNfsExportOptionsOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleFilestoreInstanceFileSharesNfsExportOptionsOutputReference
...
func (g *jsiiProxy_GoogleFilestoreInstanceFileSharesNfsExportOptionsList) ToString() *string {
	var returns *string
