...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList {
	_init_.Initialize()
...
func NewGoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList_Override(g GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeterEgressPolicyEgressToOperationsList) Resolve(_context cdktf.IResolveContext) interface{} {
