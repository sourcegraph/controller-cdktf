...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList) InternalValue() interface{} {
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_GoogleBigqueryRoutineArgumentsList)SetWrapsSet(val *bool) {
...
func (g *jsiiProxy_GoogleBigqueryRoutineArgumentsList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleBigqueryRoutineArgumentsList) Get(index *float64) GoogleBigqueryRoutineArgumentsOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleBigqueryRoutineArgumentsOutputReference
...
func (g *jsiiProxy_GoogleBigqueryRoutineArgumentsList) ToString() *string {
	var returns *string
