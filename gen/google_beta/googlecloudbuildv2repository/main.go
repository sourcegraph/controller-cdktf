...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parentConnection", GoGetter: "ParentConnection"},
			_jsii_.MemberProperty{JsiiProperty: "parentConnectionInput", GoGetter: "ParentConnectionInput"},
