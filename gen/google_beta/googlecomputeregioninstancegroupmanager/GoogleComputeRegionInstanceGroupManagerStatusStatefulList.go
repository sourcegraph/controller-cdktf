...
func (g *jsiiProxy_GoogleComputeRegionInstanceGroupManagerStatusStatefulList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
