...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList {
	_init_.Initialize()
...
func NewDataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList_Override(d DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageList) Resolve(_context cdktf.IResolveContext) interface{} {
