...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglecertificatemanagercertificatemap/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_certificate_manager_certificate_map google_certificate_manager_certificate_map}.
type DataGoogleCertificateManagerCertificateMap interface {
	...
	GclbTargets() DataGoogleCertificateManagerCertificateMapGclbTargetsList
	Id() *string
	SetId(val *string)
	IdInput() *string
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GclbTargets() DataGoogleCertificateManagerCertificateMapGclbTargetsList {
	var returns DataGoogleCertificateManagerCertificateMapGclbTargetsList
	_jsii_.Get(
		j,
		"gclbTargets",
		&returns,
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleCertificateManagerCertificateMap) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_certificate_manager_certificate_map google_certificate_manager_certificate_map} Data Source.
func NewDataGoogleCertificateManagerCertificateMap(scope constructs.Construct, id *string, config *DataGoogleCertificateManagerCertificateMapConfig) DataGoogleCertificateManagerCertificateMap {
	...
	if err := validateNewDataGoogleCertificateManagerCertificateMapParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleCertificateManagerCertificateMap{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleCertificateManagerCertificateMap.DataGoogleCertificateManagerCertificateMap",
...
func DataGoogleCertificateManagerCertificateMap_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleCertificateManagerCertificateMap.DataGoogleCertificateManagerCertificateMap",
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCertificateManagerCertificateMap) ToString() *string {
	var returns *string
