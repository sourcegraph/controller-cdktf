...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceWorkstation", GoMethod: "ResetSourceWorkstation"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "sourceWorkstation", GoGetter: "SourceWorkstation"},
			_jsii_.MemberProperty{JsiiProperty: "sourceWorkstationInput", GoGetter: "SourceWorkstationInput"},
