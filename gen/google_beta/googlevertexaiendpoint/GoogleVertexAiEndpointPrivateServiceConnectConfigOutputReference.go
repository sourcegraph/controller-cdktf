...
type GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference interface {
	cdktf.ComplexObject
	...
	SetInternalValue(val *GoogleVertexAiEndpointPrivateServiceConnectConfig)
...
// The jsii proxy struct for GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference
type jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference struct {
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) InternalValue() *GoogleVertexAiEndpointPrivateServiceConnectConfig {
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ProjectAllowlist() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"projectAllowlist",
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ProjectAllowlistInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference {
	...
	if err := validateNewGoogleVertexAiEndpointPrivateServiceConnectConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ResetProjectAllowlist() {
	_jsii_.InvokeVoid(
		g,
		"resetProjectAllowlist",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigOutputReference) ToString() *string {
	var returns *string
