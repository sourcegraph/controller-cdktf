...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_compute_disk google_compute_disk}.
...
func (j *jsiiProxy_GoogleComputeDisk) CreateSnapshotBeforeDestroyPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeDisk) CreateSnapshotBeforeDestroyPrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_compute_disk google_compute_disk} Resource.
...
func GoogleComputeDisk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeDisk_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeDisk) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeDisk) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeDisk) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeDisk) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeDisk) ResetCreateSnapshotBeforeDestroy() {
	_jsii_.InvokeVoid(
		g,
		"resetCreateSnapshotBeforeDestroy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeDisk) ResetCreateSnapshotBeforeDestroyPrefix() {
	_jsii_.InvokeVoid(
		g,
		"resetCreateSnapshotBeforeDestroyPrefix",
		nil, // no parameters
