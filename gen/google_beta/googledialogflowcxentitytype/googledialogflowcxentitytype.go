...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_dialogflow_cx_entity_type google_dialogflow_cx_entity_type}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_dialogflow_cx_entity_type google_dialogflow_cx_entity_type} Resource.
...
func GoogleDialogflowCxEntityType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleDialogflowCxEntityType_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) ToHclTerraform() interface{} {
	var returns interface{}
