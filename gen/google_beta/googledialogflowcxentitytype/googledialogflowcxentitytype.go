...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoExpansionMode", GoGetter: "AutoExpansionMode"},
			_jsii_.MemberProperty{JsiiProperty: "autoExpansionModeInput", GoGetter: "AutoExpansionModeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enableFuzzyExtraction", GoGetter: "EnableFuzzyExtraction"},
			_jsii_.MemberProperty{JsiiProperty: "enableFuzzyExtractionInput", GoGetter: "EnableFuzzyExtractionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "excludedPhrases", GoGetter: "ExcludedPhrases"},
			_jsii_.MemberProperty{JsiiProperty: "excludedPhrasesInput", GoGetter: "ExcludedPhrasesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExcludedPhrases", GoMethod: "PutExcludedPhrases"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeConfig",
		reflect.TypeOf((*GoogleDialogflowCxEntityTypeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeEntities",
		reflect.TypeOf((*GoogleDialogflowCxEntityTypeEntities)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeEntitiesList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeEntitiesOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeExcludedPhrases",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDialogflowCxEntityType.GoogleDialogflowCxEntityTypeTimeouts",
