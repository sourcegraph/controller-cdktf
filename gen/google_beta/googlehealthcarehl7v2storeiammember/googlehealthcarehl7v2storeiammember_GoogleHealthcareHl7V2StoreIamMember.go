...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlehealthcarehl7v2storeiammember/internal"
)
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
