...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_document_ai_warehouse_document_schema google_document_ai_warehouse_document_schema}.
...
type jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ProjectNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumber",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ProjectNumberInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumberInput",
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) PropertyDefinitions() GoogleDocumentAiWarehouseDocumentSchemaPropertyDefinitionsList {
	var returns GoogleDocumentAiWarehouseDocumentSchemaPropertyDefinitionsList
	_jsii_.Get(
		j,
		"propertyDefinitions",
		&returns,
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) Timeouts() GoogleDocumentAiWarehouseDocumentSchemaTimeoutsOutputReference {
	var returns GoogleDocumentAiWarehouseDocumentSchemaTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_document_ai_warehouse_document_schema google_document_ai_warehouse_document_schema} Resource.
func NewGoogleDocumentAiWarehouseDocumentSchema(scope constructs.Construct, id *string, config *GoogleDocumentAiWarehouseDocumentSchemaConfig) GoogleDocumentAiWarehouseDocumentSchema {
	...
	if err := validateNewGoogleDocumentAiWarehouseDocumentSchemaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleDocumentAiWarehouseDocumentSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleDocumentAiWarehouseDocumentSchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GoogleDocumentAiWarehouseDocumentSchema_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleDocumentAiWarehouseDocumentSchema.GoogleDocumentAiWarehouseDocumentSchema",
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) PutTimeouts(value *GoogleDocumentAiWarehouseDocumentSchemaTimeouts) {
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ResetDocumentIsFolder() {
	_jsii_.InvokeVoid(
		g,
		"resetDocumentIsFolder",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDocumentAiWarehouseDocumentSchema) ToString() *string {
	var returns *string
