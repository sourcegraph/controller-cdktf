...
// Represents a {@link https://www.terraform.io/docs/providers/google-beta/d/google_project_organization_policy google_project_organization_policy}.
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) BooleanPolicy() DataGoogleProjectOrganizationPolicyBooleanPolicyList {
	var returns DataGoogleProjectOrganizationPolicyBooleanPolicyList
	_jsii_.Get(
		j,
		"booleanPolicy",
		&returns,
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Constraint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"constraint",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) ConstraintInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"constraintInput",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) ListPolicy() DataGoogleProjectOrganizationPolicyListPolicyList {
	var returns DataGoogleProjectOrganizationPolicyListPolicyList
	_jsii_.Get(
		j,
		"listPolicy",
		&returns,
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) RestorePolicy() DataGoogleProjectOrganizationPolicyRestorePolicyList {
	var returns DataGoogleProjectOrganizationPolicyRestorePolicyList
	_jsii_.Get(
		j,
		"restorePolicy",
		&returns,
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy) Version() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"version",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/d/google_project_organization_policy google_project_organization_policy} Data Source.
func NewDataGoogleProjectOrganizationPolicy(scope constructs.Construct, id *string, config *DataGoogleProjectOrganizationPolicyConfig) DataGoogleProjectOrganizationPolicy {
	...
	if err := validateNewDataGoogleProjectOrganizationPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGoogleProjectOrganizationPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleProjectOrganizationPolicy) ToString() *string {
	var returns *string
