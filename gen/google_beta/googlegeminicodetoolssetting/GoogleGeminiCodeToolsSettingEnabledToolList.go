...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) InternalValue() interface{} {
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList)SetWrapsSet(val *bool) {
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) Get(index *float64) GoogleGeminiCodeToolsSettingEnabledToolOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleGeminiCodeToolsSettingEnabledToolOutputReference
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolList) ToString() *string {
	var returns *string
