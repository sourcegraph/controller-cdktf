...
func (j *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList {
	_init_.Initialize()
...
func NewDataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList_Override(d DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleStorageControlProjectIntelligenceConfigFilterIncludedCloudStorageLocationsList) Resolve(_context cdktf.IResolveContext) interface{} {
