...
func (j *jsiiProxy_GoogleComputeRouterNat) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeRouterNat(scope constructs.Construct, id *string, config *GoogleComputeRouterNatConfig) GoogleComputeRouterNat {
	...
	_jsii_.Create(
		"google-beta.googleComputeRouterNat.GoogleComputeRouterNat",
...
func (j *jsiiProxy_GoogleComputeRouterNat)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
