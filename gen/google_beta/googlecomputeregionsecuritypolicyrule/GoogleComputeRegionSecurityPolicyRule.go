...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_compute_region_security_policy_rule google_compute_region_security_policy_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_compute_region_security_policy_rule google_compute_region_security_policy_rule} Resource.
...
func GoogleComputeRegionSecurityPolicyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleComputeRegionSecurityPolicyRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRule) ToHclTerraform() interface{} {
	var returns interface{}
