...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_backup_dr_backup_plan google_backup_dr_backup_plan}.
...
func (j *jsiiProxy_GoogleBackupDrBackupPlan) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleBackupDrBackupPlan) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBackupDrBackupPlan) Provider() cdktf.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_backup_dr_backup_plan google_backup_dr_backup_plan} Resource.
func NewGoogleBackupDrBackupPlan(scope constructs.Construct, id *string, config *GoogleBackupDrBackupPlanConfig) GoogleBackupDrBackupPlan {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleBackupDrBackupPlan.GoogleBackupDrBackupPlan",
...
func (g *jsiiProxy_GoogleBackupDrBackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBackupDrBackupPlan) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBackupDrBackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
