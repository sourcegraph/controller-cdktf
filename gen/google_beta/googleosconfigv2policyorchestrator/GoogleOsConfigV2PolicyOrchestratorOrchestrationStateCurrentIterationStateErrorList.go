...
func (j *jsiiProxy_GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList {
	_init_.Initialize()
...
func NewGoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList_Override(g GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleOsConfigV2PolicyOrchestratorOrchestrationStateCurrentIterationStateErrorList) Resolve(_context cdktf.IResolveContext) interface{} {
