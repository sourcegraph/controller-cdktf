...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlecomputebackendservicesignedurlkey/internal"
)
...
type GoogleComputeBackendServiceSignedUrlKey interface {
	...
	PutTimeouts(value *GoogleComputeBackendServiceSignedUrlKeyTimeouts)
	ResetId()
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) BackendServiceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backendServiceInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) KeyValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyValue",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) KeyValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyValueInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) Timeouts() GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference {
	var returns GoogleComputeBackendServiceSignedUrlKeyTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_backend_service_signed_url_key google_compute_backend_service_signed_url_key} Resource.
func NewGoogleComputeBackendServiceSignedUrlKey(scope constructs.Construct, id *string, config *GoogleComputeBackendServiceSignedUrlKeyConfig) GoogleComputeBackendServiceSignedUrlKey {
	...
	if err := validateNewGoogleComputeBackendServiceSignedUrlKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleComputeBackendServiceSignedUrlKey{}

	_jsii_.Create(
		"google-beta.googleComputeBackendServiceSignedUrlKey.GoogleComputeBackendServiceSignedUrlKey",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func GoogleComputeBackendServiceSignedUrlKey_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google-beta.googleComputeBackendServiceSignedUrlKey.GoogleComputeBackendServiceSignedUrlKey",
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) PutTimeouts(value *GoogleComputeBackendServiceSignedUrlKeyTimeouts) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ToString() *string {
	var returns *string
