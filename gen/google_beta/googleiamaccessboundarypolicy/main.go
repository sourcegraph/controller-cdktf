...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamAccessBoundaryPolicy.GoogleIamAccessBoundaryPolicyRules",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "availablePermissions", GoGetter: "AvailablePermissions"},
			_jsii_.MemberProperty{JsiiProperty: "availablePermissionsInput", GoGetter: "AvailablePermissionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "availableResource", GoGetter: "AvailableResource"},
			_jsii_.MemberProperty{JsiiProperty: "availableResourceInput", GoGetter: "AvailableResourceInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAvailabilityCondition", GoMethod: "PutAvailabilityCondition"},
			_jsii_.MemberMethod{JsiiMethod: "resetAvailabilityCondition", GoMethod: "ResetAvailabilityCondition"},
			_jsii_.MemberMethod{JsiiMethod: "resetAvailablePermissions", GoMethod: "ResetAvailablePermissions"},
			_jsii_.MemberMethod{JsiiMethod: "resetAvailableResource", GoMethod: "ResetAvailableResource"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAccessBoundaryRule", GoMethod: "PutAccessBoundaryRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccessBoundaryRule", GoMethod: "ResetAccessBoundaryRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamAccessBoundaryPolicy.GoogleIamAccessBoundaryPolicyTimeouts",
