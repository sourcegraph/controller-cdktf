...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableReferentialIntegrity", GoGetter: "DisableReferentialIntegrity"},
			_jsii_.MemberProperty{JsiiProperty: "disableReferentialIntegrityInput", GoGetter: "DisableReferentialIntegrityInput"},
			_jsii_.MemberProperty{JsiiProperty: "disableResourceVersioning", GoGetter: "DisableResourceVersioning"},
			_jsii_.MemberProperty{JsiiProperty: "disableResourceVersioningInput", GoGetter: "DisableResourceVersioningInput"},
			_jsii_.MemberProperty{JsiiProperty: "enableHistoryImport", GoGetter: "EnableHistoryImport"},
			_jsii_.MemberProperty{JsiiProperty: "enableHistoryImportInput", GoGetter: "EnableHistoryImportInput"},
			_jsii_.MemberProperty{JsiiProperty: "enableUpdateCreate", GoGetter: "EnableUpdateCreate"},
			_jsii_.MemberProperty{JsiiProperty: "enableUpdateCreateInput", GoGetter: "EnableUpdateCreateInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationConfigs", GoGetter: "NotificationConfigs"},
			_jsii_.MemberProperty{JsiiProperty: "notificationConfigsInput", GoGetter: "NotificationConfigsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putNotificationConfigs", GoMethod: "PutNotificationConfigs"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableUpdateCreate", GoMethod: "ResetEnableUpdateCreate"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLabels", GoMethod: "ResetLabels"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotificationConfig", GoMethod: "ResetNotificationConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotificationConfigs", GoMethod: "ResetNotificationConfigs"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetStreamConfigs", GoMethod: "ResetStreamConfigs"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetVersion", GoMethod: "ResetVersion"},
			_jsii_.MemberProperty{JsiiProperty: "selfLink", GoGetter: "SelfLink"},
			_jsii_.MemberProperty{JsiiProperty: "streamConfigs", GoGetter: "StreamConfigs"},
			_jsii_.MemberProperty{JsiiProperty: "streamConfigsInput", GoGetter: "StreamConfigsInput"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreConfig",
		reflect.TypeOf((*GoogleHealthcareFhirStoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreNotificationConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreNotificationConfigs",
	...
	_jsii_.RegisterClass(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreNotificationConfigsOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pubsubTopic", GoGetter: "PubsubTopic"},
			_jsii_.MemberProperty{JsiiProperty: "pubsubTopicInput", GoGetter: "PubsubTopicInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendFullResource", GoMethod: "ResetSendFullResource"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sendFullResource", GoGetter: "SendFullResource"},
			_jsii_.MemberProperty{JsiiProperty: "sendFullResourceInput", GoGetter: "SendFullResourceInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreStreamConfigsBigqueryDestination",
		reflect.TypeOf((*GoogleHealthcareFhirStoreStreamConfigsBigqueryDestination)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreStreamConfigsBigqueryDestinationOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "datasetUri", GoGetter: "DatasetUri"},
			_jsii_.MemberProperty{JsiiProperty: "datasetUriInput", GoGetter: "DatasetUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putSchemaConfig", GoMethod: "PutSchemaConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "schemaConfig", GoGetter: "SchemaConfig"},
			_jsii_.MemberProperty{JsiiProperty: "schemaConfigInput", GoGetter: "SchemaConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreStreamConfigsBigqueryDestinationSchemaConfig",
		reflect.TypeOf((*GoogleHealthcareFhirStoreStreamConfigsBigqueryDestinationSchemaConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreStreamConfigsBigqueryDestinationSchemaConfigLastUpdatedPartitionConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lastUpdatedPartitionConfig", GoGetter: "LastUpdatedPartitionConfig"},
			_jsii_.MemberProperty{JsiiProperty: "lastUpdatedPartitionConfigInput", GoGetter: "LastUpdatedPartitionConfigInput"},
			_jsii_.MemberMethod{JsiiMethod: "putLastUpdatedPartitionConfig", GoMethod: "PutLastUpdatedPartitionConfig"},
			_jsii_.MemberProperty{JsiiProperty: "recursiveStructureDepth", GoGetter: "RecursiveStructureDepth"},
			_jsii_.MemberProperty{JsiiProperty: "recursiveStructureDepthInput", GoGetter: "RecursiveStructureDepthInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetLastUpdatedPartitionConfig", GoMethod: "ResetLastUpdatedPartitionConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetSchemaType", GoMethod: "ResetSchemaType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareFhirStore.GoogleHealthcareFhirStoreTimeouts",
