...
type GoogleCloudbuildTriggerPubsubConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *GoogleCloudbuildTriggerPubsubConfig
	SetInternalValue(val *GoogleCloudbuildTriggerPubsubConfig)
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) InternalValue() *GoogleCloudbuildTriggerPubsubConfig {
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ServiceAccountEmail() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountEmail",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ServiceAccountEmailInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) Subscription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscription",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) Topic() *string {
	var returns *string
	_jsii_.Get(
		j,
		"topic",
...
func (j *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) TopicInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"topicInput",
...
func NewGoogleCloudbuildTriggerPubsubConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleCloudbuildTriggerPubsubConfigOutputReference {
	...
	_jsii_.Create(
		"google-beta.googleCloudbuildTrigger.GoogleCloudbuildTriggerPubsubConfigOutputReference",
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ResetServiceAccountEmail() {
	_jsii_.InvokeVoid(
		g,
		"resetServiceAccountEmail",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudbuildTriggerPubsubConfigOutputReference) ToString() *string {
	var returns *string
