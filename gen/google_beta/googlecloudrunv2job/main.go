...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRunExecutionToken", GoMethod: "ResetRunExecutionToken"},
			_jsii_.MemberMethod{JsiiMethod: "resetStartExecutionToken", GoMethod: "ResetStartExecutionToken"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "runExecutionToken", GoGetter: "RunExecutionToken"},
			_jsii_.MemberProperty{JsiiProperty: "runExecutionTokenInput", GoGetter: "RunExecutionTokenInput"},
			_jsii_.MemberProperty{JsiiProperty: "startExecutionToken", GoGetter: "StartExecutionToken"},
			_jsii_.MemberProperty{JsiiProperty: "startExecutionTokenInput", GoGetter: "StartExecutionTokenInput"},
