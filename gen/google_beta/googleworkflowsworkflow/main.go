...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "callLogLevel", GoGetter: "CallLogLevel"},
			_jsii_.MemberProperty{JsiiProperty: "callLogLevelInput", GoGetter: "CallLogLevelInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "executionHistoryLevel", GoGetter: "ExecutionHistoryLevel"},
			_jsii_.MemberProperty{JsiiProperty: "executionHistoryLevelInput", GoGetter: "ExecutionHistoryLevelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExecutionHistoryLevel", GoMethod: "ResetExecutionHistoryLevel"},
