...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglestorageobjectsignedurl/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.69.1/docs/data-sources/google_storage_object_signed_url google_storage_object_signed_url}.
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) BucketInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ContentMd5() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentMd5",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ContentMd5Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentMd5Input",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ContentType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentType",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ContentTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentTypeInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Credentials() *string {
	var returns *string
	_jsii_.Get(
		j,
		"credentials",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) CredentialsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"credentialsInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Duration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"duration",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) DurationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"durationInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ExtensionHeaders() *map[string]*string {
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) ExtensionHeadersInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"extensionHeadersInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) HttpMethod() *string {
	var returns *string
	_jsii_.Get(
		j,
		"httpMethod",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) HttpMethodInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"httpMethodInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) SignedUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"signedUrl",
...
func (j *jsiiProxy_DataGoogleStorageObjectSignedUrl) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.69.1/docs/data-sources/google_storage_object_signed_url google_storage_object_signed_url} Data Source.
func NewDataGoogleStorageObjectSignedUrl(scope constructs.Construct, id *string, config *DataGoogleStorageObjectSignedUrlConfig) DataGoogleStorageObjectSignedUrl {
	...
	if err := validateNewDataGoogleStorageObjectSignedUrlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleStorageObjectSignedUrl_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrl",
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetContentMd5() {
	_jsii_.InvokeVoid(
		d,
		"resetContentMd5",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetContentType() {
	_jsii_.InvokeVoid(
		d,
		"resetContentType",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetCredentials() {
	_jsii_.InvokeVoid(
		d,
		"resetCredentials",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetDuration() {
	_jsii_.InvokeVoid(
		d,
		"resetDuration",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetExtensionHeaders() {
	_jsii_.InvokeVoid(
		d,
		"resetExtensionHeaders",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetHttpMethod() {
	_jsii_.InvokeVoid(
		d,
		"resetHttpMethod",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleStorageObjectSignedUrl) ToString() *string {
	var returns *string
