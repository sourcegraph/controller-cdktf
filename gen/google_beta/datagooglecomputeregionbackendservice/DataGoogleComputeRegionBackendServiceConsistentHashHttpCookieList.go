...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList_Override(d DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceConsistentHashHttpCookieList) Resolve(_context cdktf.IResolveContext) interface{} {
