...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList_Override(d DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceCircuitBreakersConnectTimeoutList) Resolve(_context cdktf.IResolveContext) interface{} {
