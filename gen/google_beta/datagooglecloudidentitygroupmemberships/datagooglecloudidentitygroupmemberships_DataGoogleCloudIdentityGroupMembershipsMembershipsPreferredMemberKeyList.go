...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList {
	_init_.Initialize()
...
func NewDataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList_Override(d DataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupMembershipsMembershipsPreferredMemberKeyList) Resolve(_context cdktf.IResolveContext) interface{} {
