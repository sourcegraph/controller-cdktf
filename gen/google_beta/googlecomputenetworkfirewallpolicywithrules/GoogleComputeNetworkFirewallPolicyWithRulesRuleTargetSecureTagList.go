...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) InternalValue() interface{} {
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList)SetWrapsSet(val *bool) {
...
func (g *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) Get(index *float64) GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagOutputReference
...
func (g *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GoogleComputeNetworkFirewallPolicyWithRulesRuleTargetSecureTagList) ToString() *string {
	var returns *string
