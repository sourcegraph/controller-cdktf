...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_region_disk google_compute_region_disk}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_compute_region_disk google_compute_region_disk} Resource.
...
func GoogleComputeRegionDisk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeRegionDisk_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRegionDisk) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRegionDisk) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionDisk) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionDisk) MoveToId(id *string) {
