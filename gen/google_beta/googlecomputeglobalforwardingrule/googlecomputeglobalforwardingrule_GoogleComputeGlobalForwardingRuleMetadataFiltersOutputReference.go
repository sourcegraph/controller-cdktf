...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) FilterLabelsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterLabelsInput",
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewGoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference {
	...
	_jsii_.Create(
		"google-beta.googleComputeGlobalForwardingRule.GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference",
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) PutFilterLabels(value interface{}) {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRuleMetadataFiltersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
