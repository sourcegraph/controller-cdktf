...
type DataGoogleLoggingSinkConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/data-sources/google_logging_sink#id DataGoogleLoggingSink#id}
	//
