...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_compute_instance_group_manager google_compute_instance_group_manager}.
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManager) AllInstancesConfig() DataGoogleComputeInstanceGroupManagerAllInstancesConfigList {
	var returns DataGoogleComputeInstanceGroupManagerAllInstancesConfigList
	_jsii_.Get(
		j,
		"allInstancesConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManager) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManager) InstanceGroupManagerId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManager) Params() DataGoogleComputeInstanceGroupManagerParamsList {
	var returns DataGoogleComputeInstanceGroupManagerParamsList
	_jsii_.Get(
		j,
		"params",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_compute_instance_group_manager google_compute_instance_group_manager} Data Source.
