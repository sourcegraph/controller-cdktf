...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_compute_instance google_compute_instance}.
type DataGoogleComputeInstance interface {
	...
	SetId(val *string)
	IdInput() *string
	InstanceEncryptionKey() DataGoogleComputeInstanceInstanceEncryptionKeyList
	InstanceId() *string
...
func (j *jsiiProxy_DataGoogleComputeInstance) InstanceEncryptionKey() DataGoogleComputeInstanceInstanceEncryptionKeyList {
	var returns DataGoogleComputeInstanceInstanceEncryptionKeyList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleComputeInstance) PartnerMetadata() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"partnerMetadata",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_compute_instance google_compute_instance} Data Source.
