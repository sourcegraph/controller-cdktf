...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList {
	_init_.Initialize()
...
func NewDataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList_Override(d DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderX509TrustStoreList) Resolve(_context cdktf.IResolveContext) interface{} {
