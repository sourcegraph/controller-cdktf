...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "redundantInterface", GoGetter: "RedundantInterface"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRedundantInterface", GoMethod: "ResetRedundantInterface"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRouterInterface.GoogleComputeRouterInterfaceConfig",
