...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_access_context_manager_access_policy_iam_binding google_access_context_manager_access_policy_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_access_context_manager_access_policy_iam_binding google_access_context_manager_access_policy_iam_binding} Resource.
...
func GoogleAccessContextManagerAccessPolicyIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleAccessContextManagerAccessPolicyIamBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleAccessContextManagerAccessPolicyIamBinding) ToHclTerraform() interface{} {
	var returns interface{}
