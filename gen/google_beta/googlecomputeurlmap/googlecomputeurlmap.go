...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_url_map google_compute_url_map}.
type GoogleComputeUrlMap interface {
	...
	PutDefaultCustomErrorResponsePolicy(value *GoogleComputeUrlMapDefaultCustomErrorResponsePolicy)
...
func (j *jsiiProxy_GoogleComputeUrlMap) DefaultCustomErrorResponsePolicy() GoogleComputeUrlMapDefaultCustomErrorResponsePolicyOutputReference {
	var returns GoogleComputeUrlMapDefaultCustomErrorResponsePolicyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeUrlMap) DefaultCustomErrorResponsePolicyInput() *GoogleComputeUrlMapDefaultCustomErrorResponsePolicy {
	var returns *GoogleComputeUrlMapDefaultCustomErrorResponsePolicy
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_url_map google_compute_url_map} Resource.
...
func GoogleComputeUrlMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeUrlMap_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeUrlMap) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) PutDefaultCustomErrorResponsePolicy(value *GoogleComputeUrlMapDefaultCustomErrorResponsePolicy) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) ResetDefaultCustomErrorResponsePolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDefaultCustomErrorResponsePolicy",
		nil, // no parameters
