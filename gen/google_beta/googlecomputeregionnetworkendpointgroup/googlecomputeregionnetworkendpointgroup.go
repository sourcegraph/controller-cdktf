...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_compute_region_network_endpoint_group google_compute_region_network_endpoint_group}.
type GoogleComputeRegionNetworkEndpointGroup interface {
	...
	PutPscData(value *GoogleComputeRegionNetworkEndpointGroupPscData)
...
func (j *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) PscData() GoogleComputeRegionNetworkEndpointGroupPscDataOutputReference {
	var returns GoogleComputeRegionNetworkEndpointGroupPscDataOutputReference
	_jsii_.Get(
		j,
		"pscData",
		&returns,
...
func (j *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) PscDataInput() *GoogleComputeRegionNetworkEndpointGroupPscData {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_compute_region_network_endpoint_group google_compute_region_network_endpoint_group} Resource.
...
func GoogleComputeRegionNetworkEndpointGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeRegionNetworkEndpointGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) PutPscData(value *GoogleComputeRegionNetworkEndpointGroupPscData) {
	if err := g.validatePutPscDataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GoogleComputeRegionNetworkEndpointGroup) ResetPscData() {
	_jsii_.InvokeVoid(
		g,
		"resetPscData",
		nil, // no parameters
