...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationProject", GoGetter: "DestinationProject"},
			_jsii_.MemberProperty{JsiiProperty: "destinationProjectId", GoGetter: "DestinationProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "destinationProjectInput", GoGetter: "DestinationProjectInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelConfig",
		reflect.TypeOf((*GoogleGkeBackupBackupChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeouts",
