...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglevmwareenginenetworkpeering/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_vmwareengine_network_peering google_vmwareengine_network_peering}.
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) PeerNetwork() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerNetwork",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) PeerNetworkType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerNetworkType",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) StateDetails() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateDetails",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) VmwareEngineNetwork() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vmwareEngineNetwork",
...
func (j *jsiiProxy_DataGoogleVmwareengineNetworkPeering) VmwareEngineNetworkCanonical() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_vmwareengine_network_peering google_vmwareengine_network_peering} Data Source.
func NewDataGoogleVmwareengineNetworkPeering(scope constructs.Construct, id *string, config *DataGoogleVmwareengineNetworkPeeringConfig) DataGoogleVmwareengineNetworkPeering {
	...
	if err := validateNewDataGoogleVmwareengineNetworkPeeringParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleVmwareengineNetworkPeering_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleVmwareengineNetworkPeering.DataGoogleVmwareengineNetworkPeering",
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareengineNetworkPeering) ToString() *string {
	var returns *string
