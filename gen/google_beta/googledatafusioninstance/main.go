...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableRbac", GoGetter: "EnableRbac"},
			_jsii_.MemberProperty{JsiiProperty: "enableRbacInput", GoGetter: "EnableRbacInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enableStackdriverMonitoring", GoGetter: "EnableStackdriverMonitoring"},
			_jsii_.MemberProperty{JsiiProperty: "enableStackdriverMonitoringInput", GoGetter: "EnableStackdriverMonitoringInput"},
			_jsii_.MemberProperty{JsiiProperty: "eventPublishConfig", GoGetter: "EventPublishConfig"},
			_jsii_.MemberProperty{JsiiProperty: "eventPublishConfigInput", GoGetter: "EventPublishConfigInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "p4ServiceAccount", GoGetter: "P4ServiceAccount"},
			_jsii_.MemberProperty{JsiiProperty: "privateInstance", GoGetter: "PrivateInstance"},
			_jsii_.MemberProperty{JsiiProperty: "privateInstanceInput", GoGetter: "PrivateInstanceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putEventPublishConfig", GoMethod: "PutEventPublishConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableRbac", GoMethod: "ResetEnableRbac"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableStackdriverLogging", GoMethod: "ResetEnableStackdriverLogging"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableStackdriverMonitoring", GoMethod: "ResetEnableStackdriverMonitoring"},
			_jsii_.MemberMethod{JsiiMethod: "resetEventPublishConfig", GoMethod: "ResetEventPublishConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateInstance", GoMethod: "ResetPrivateInstance"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tenantProjectId", GoGetter: "TenantProjectId"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataFusionInstance.GoogleDataFusionInstanceAccelerators",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataFusionInstance.GoogleDataFusionInstanceCryptoKeyConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataFusionInstance.GoogleDataFusionInstanceEventPublishConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataFusionInstance.GoogleDataFusionInstanceNetworkConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ipAllocation", GoGetter: "IpAllocation"},
			_jsii_.MemberProperty{JsiiProperty: "ipAllocationInput", GoGetter: "IpAllocationInput"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataFusionInstance.GoogleDataFusionInstanceTimeouts",
