...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberConfig",
