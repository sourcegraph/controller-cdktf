...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiConsumerDataEncryptionKeyName", GoGetter: "ApiConsumerDataEncryptionKeyName"},
			_jsii_.MemberProperty{JsiiProperty: "apiConsumerDataEncryptionKeyNameInput", GoGetter: "ApiConsumerDataEncryptionKeyNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "apiConsumerDataLocation", GoGetter: "ApiConsumerDataLocation"},
			_jsii_.MemberProperty{JsiiProperty: "apiConsumerDataLocationInput", GoGetter: "ApiConsumerDataLocationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "controlPlaneEncryptionKeyName", GoGetter: "ControlPlaneEncryptionKeyName"},
			_jsii_.MemberProperty{JsiiProperty: "controlPlaneEncryptionKeyNameInput", GoGetter: "ControlPlaneEncryptionKeyNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "disableVpcPeering", GoGetter: "DisableVpcPeering"},
			_jsii_.MemberProperty{JsiiProperty: "disableVpcPeeringInput", GoGetter: "DisableVpcPeeringInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBillingType", GoMethod: "ResetBillingType"},
			_jsii_.MemberMethod{JsiiMethod: "resetControlPlaneEncryptionKeyName", GoMethod: "ResetControlPlaneEncryptionKeyName"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisableVpcPeering", GoMethod: "ResetDisableVpcPeering"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRuntimeDatabaseEncryptionKeyName", GoMethod: "ResetRuntimeDatabaseEncryptionKeyName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "runtimeDatabaseEncryptionKeyName", GoGetter: "RuntimeDatabaseEncryptionKeyName"},
			_jsii_.MemberProperty{JsiiProperty: "runtimeDatabaseEncryptionKeyNameInput", GoGetter: "RuntimeDatabaseEncryptionKeyNameInput"},
