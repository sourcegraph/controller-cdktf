...
// Generates CDKTF code for importing a GoogleCloudiotRegistry resource upon running "cdktf plan <stack-name>".
func GoogleCloudiotRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleCloudiotRegistry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleCloudiotRegistry) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleCloudiotRegistry) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleCloudiotRegistry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleCloudiotRegistry) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleCloudiotRegistry) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleCloudiotRegistry) MoveToId(id *string) {
