...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cloudExadataInfrastructure", GoGetter: "CloudExadataInfrastructure"},
			_jsii_.MemberProperty{JsiiProperty: "cloudExadataInfrastructureInput", GoGetter: "CloudExadataInfrastructureInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dbNodeIds", GoGetter: "DbNodeIds"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxMemorySizeGb", GoGetter: "MaxMemorySizeGb"},
			_jsii_.MemberProperty{JsiiProperty: "maxOcpuCount", GoGetter: "MaxOcpuCount"},
