...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_logging_folder_sink google_logging_folder_sink}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_logging_folder_sink google_logging_folder_sink} Resource.
...
func GoogleLoggingFolderSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleLoggingFolderSink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleLoggingFolderSink) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleLoggingFolderSink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleLoggingFolderSink) ToHclTerraform() interface{} {
	var returns interface{}
