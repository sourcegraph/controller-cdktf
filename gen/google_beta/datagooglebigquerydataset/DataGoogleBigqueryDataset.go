...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Access() DataGoogleBigqueryDatasetAccessList {
	var returns DataGoogleBigqueryDatasetAccessList
	_jsii_.Get(
		j,
		"access",
		&returns,
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) CreationTime() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DatasetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetId",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DatasetIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetIdInput",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DefaultCollation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultCollation",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DefaultEncryptionConfiguration() DataGoogleBigqueryDatasetDefaultEncryptionConfigurationList {
	var returns DataGoogleBigqueryDatasetDefaultEncryptionConfigurationList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DefaultPartitionExpirationMs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DefaultTableExpirationMs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) ExternalCatalogDatasetOptions() DataGoogleBigqueryDatasetExternalCatalogDatasetOptionsList {
	var returns DataGoogleBigqueryDatasetExternalCatalogDatasetOptionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) FriendlyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyName",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) LastModifiedTime() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) MaxTimeTravelHours() *string {
	var returns *string
	_jsii_.Get(
		j,
		"maxTimeTravelHours",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) StorageBillingModel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageBillingModel",
...
func (j *jsiiProxy_DataGoogleBigqueryDataset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_bigquery_dataset google_bigquery_dataset} Data Source.
func NewDataGoogleBigqueryDataset(scope constructs.Construct, id *string, config *DataGoogleBigqueryDatasetConfig) DataGoogleBigqueryDataset {
	...
	if err := validateNewDataGoogleBigqueryDatasetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBigqueryDataset) ToString() *string {
	var returns *string
