...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleCloudRunV2JobIamMember.GoogleCloudRunV2JobIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleCloudRunV2JobIamMember.GoogleCloudRunV2JobIamMemberConfig",
