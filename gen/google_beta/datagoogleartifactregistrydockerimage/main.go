...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "imageSizeBytes", GoGetter: "ImageSizeBytes"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleArtifactRegistryDockerImage.DataGoogleArtifactRegistryDockerImageConfig",
