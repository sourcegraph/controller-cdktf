...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.googleDataprocMetastoreDatabaseIamBinding.GoogleDataprocMetastoreDatabaseIamBinding",
		reflect.TypeOf((*GoogleDataprocMetastoreDatabaseIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleDataprocMetastoreDatabaseIamBinding{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleDataprocMetastoreDatabaseIamBinding.GoogleDataprocMetastoreDatabaseIamBindingCondition",
		reflect.TypeOf((*GoogleDataprocMetastoreDatabaseIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google-beta.googleDataprocMetastoreDatabaseIamBinding.GoogleDataprocMetastoreDatabaseIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleDataprocMetastoreDatabaseIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleDataprocMetastoreDatabaseIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleDataprocMetastoreDatabaseIamBinding.GoogleDataprocMetastoreDatabaseIamBindingConfig",
		reflect.TypeOf((*GoogleDataprocMetastoreDatabaseIamBindingConfig)(nil)).Elem(),
	)
}
