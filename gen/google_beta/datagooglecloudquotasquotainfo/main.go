...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dimensionsInfos", GoGetter: "DimensionsInfos"},
			...
			_jsii_.MemberProperty{JsiiProperty: "isConcurrent", GoGetter: "IsConcurrent"},
			_jsii_.MemberProperty{JsiiProperty: "isFixed", GoGetter: "IsFixed"},
			_jsii_.MemberProperty{JsiiProperty: "isPrecise", GoGetter: "IsPrecise"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "metric", GoGetter: "Metric"},
			_jsii_.MemberProperty{JsiiProperty: "metricDisplayName", GoGetter: "MetricDisplayName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "quotaDisplayName", GoGetter: "QuotaDisplayName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceRequestQuotaUri", GoGetter: "ServiceRequestQuotaUri"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ineligibilityReason", GoGetter: "IneligibilityReason"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "isEligible", GoGetter: "IsEligible"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
