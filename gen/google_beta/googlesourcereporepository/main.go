...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "createIgnoreAlreadyExists", GoGetter: "CreateIgnoreAlreadyExists"},
			_jsii_.MemberProperty{JsiiProperty: "createIgnoreAlreadyExistsInput", GoGetter: "CreateIgnoreAlreadyExistsInput"},
