...
type GoogleRedisClusterPscConfigs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_redis_cluster#network GoogleRedisCluster#network}
