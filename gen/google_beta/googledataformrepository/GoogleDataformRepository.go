...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_dataform_repository google_dataform_repository}.
type GoogleDataformRepository interface {
	...
	GitRemoteSettings() GoogleDataformRepositoryGitRemoteSettingsOutputReference
	GitRemoteSettingsInput() *GoogleDataformRepositoryGitRemoteSettings
	Id() *string
	SetId(val *string)
	IdInput() *string
	KmsKeyName() *string
...
type jsiiProxy_GoogleDataformRepository struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleDataformRepository) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleDataformRepository) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleDataformRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataformRepository) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleDataformRepository) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleDataformRepository) GitRemoteSettings() GoogleDataformRepositoryGitRemoteSettingsOutputReference {
	var returns GoogleDataformRepositoryGitRemoteSettingsOutputReference
	_jsii_.Get(
		j,
		"gitRemoteSettings",
		&returns,
...
func (j *jsiiProxy_GoogleDataformRepository) GitRemoteSettingsInput() *GoogleDataformRepositoryGitRemoteSettings {
...
func (j *jsiiProxy_GoogleDataformRepository) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleDataformRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleDataformRepository) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleDataformRepository) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleDataformRepository) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleDataformRepository) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleDataformRepository) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleDataformRepository) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataformRepository) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GoogleDataformRepository) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GoogleDataformRepository) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleDataformRepository) Timeouts() GoogleDataformRepositoryTimeoutsOutputReference {
	var returns GoogleDataformRepositoryTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_dataform_repository google_dataform_repository} Resource.
func NewGoogleDataformRepository(scope constructs.Construct, id *string, config *GoogleDataformRepositoryConfig) GoogleDataformRepository {
	...
	if err := validateNewGoogleDataformRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleDataformRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleDataformRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleDataformRepository) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDataformRepository) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataformRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleDataformRepository) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleDataformRepository) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleDataformRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleDataformRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleDataformRepository) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleDataformRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleDataformRepository) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataformRepository) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataformRepository) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDataformRepository) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleDataformRepository) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleDataformRepository) PutGitRemoteSettings(value *GoogleDataformRepositoryGitRemoteSettings) {
	if err := g.validatePutGitRemoteSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GoogleDataformRepository) PutTimeouts(value *GoogleDataformRepositoryTimeouts) {
...
func (g *jsiiProxy_GoogleDataformRepository) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataformRepository) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataformRepository) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataformRepository) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataformRepository) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataformRepository) ToString() *string {
	var returns *string
