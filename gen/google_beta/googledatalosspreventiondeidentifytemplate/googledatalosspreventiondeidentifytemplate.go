...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_data_loss_prevention_deidentify_template google_data_loss_prevention_deidentify_template}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_data_loss_prevention_deidentify_template google_data_loss_prevention_deidentify_template} Resource.
...
// Generates CDKTF code for importing a GoogleDataLossPreventionDeidentifyTemplate resource upon running "cdktf plan <stack-name>".
func GoogleDataLossPreventionDeidentifyTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleDataLossPreventionDeidentifyTemplate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleDataLossPreventionDeidentifyTemplate) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDataLossPreventionDeidentifyTemplate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataLossPreventionDeidentifyTemplate) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDataLossPreventionDeidentifyTemplate) MoveToId(id *string) {
