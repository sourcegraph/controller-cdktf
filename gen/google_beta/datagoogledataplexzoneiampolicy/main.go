...
func init() {
	_jsii_.RegisterClass(
		"google-beta.dataGoogleDataplexZoneIamPolicy.DataGoogleDataplexZoneIamPolicy",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleDataplexZoneIamPolicy.DataGoogleDataplexZoneIamPolicyConfig",
