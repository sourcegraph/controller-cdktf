...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_region_security_policy google_compute_region_security_policy}.
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) DdosProtectionConfig() GoogleComputeRegionSecurityPolicyDdosProtectionConfigOutputReference {
	var returns GoogleComputeRegionSecurityPolicyDdosProtectionConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) DdosProtectionConfigInput() *GoogleComputeRegionSecurityPolicyDdosProtectionConfig {
	var returns *GoogleComputeRegionSecurityPolicyDdosProtectionConfig
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Fingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fingerprint",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) PolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyId",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) SelfLinkWithPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Timeouts() GoogleComputeRegionSecurityPolicyTimeoutsOutputReference {
	var returns GoogleComputeRegionSecurityPolicyTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_region_security_policy google_compute_region_security_policy} Resource.
func NewGoogleComputeRegionSecurityPolicy(scope constructs.Construct, id *string, config *GoogleComputeRegionSecurityPolicyConfig) GoogleComputeRegionSecurityPolicy {
	...
	if err := validateNewGoogleComputeRegionSecurityPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleComputeRegionSecurityPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleComputeRegionSecurityPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ResetType() {
	_jsii_.InvokeVoid(
		g,
		"resetType",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ToString() *string {
	var returns *string
