...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRegionSecurityPolicy.GoogleComputeRegionSecurityPolicyConfig",
		reflect.TypeOf((*GoogleComputeRegionSecurityPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRegionSecurityPolicy.GoogleComputeRegionSecurityPolicyDdosProtectionConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRegionSecurityPolicy.GoogleComputeRegionSecurityPolicyTimeouts",
