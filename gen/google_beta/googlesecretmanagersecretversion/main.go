...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleSecretManagerSecretVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretData", GoMethod: "ResetSecretData"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecretDataWo", GoMethod: "ResetSecretDataWo"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecretDataWoVersion", GoMethod: "ResetSecretDataWoVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "secretDataWo", GoGetter: "SecretDataWo"},
			_jsii_.MemberProperty{JsiiProperty: "secretDataWoInput", GoGetter: "SecretDataWoInput"},
			_jsii_.MemberProperty{JsiiProperty: "secretDataWoVersion", GoGetter: "SecretDataWoVersion"},
			_jsii_.MemberProperty{JsiiProperty: "secretDataWoVersionInput", GoGetter: "SecretDataWoVersionInput"},
