...
func (j *jsiiProxy_DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleComputeForwardingRules.DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList",
...
func NewDataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList_Override(d DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeForwardingRulesRulesServiceDirectoryRegistrationsList) Resolve(_context cdktf.IResolveContext) interface{} {
