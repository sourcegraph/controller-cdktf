...
func (j *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList {
	_init_.Initialize()
...
func NewGoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList_Override(g GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleNetworkSecurityMirroringEndpointGroupConnectedDeploymentGroupsLocationsList) Resolve(_context cdktf.IResolveContext) interface{} {
