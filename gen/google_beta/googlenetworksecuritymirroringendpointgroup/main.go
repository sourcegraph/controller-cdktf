...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectedDeploymentGroups", GoGetter: "ConnectedDeploymentGroups"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mirroringEndpointGroupId", GoGetter: "MirroringEndpointGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "mirroringEndpointGroupIdInput", GoGetter: "MirroringEndpointGroupIdInput"},
