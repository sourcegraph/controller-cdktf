...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_compute_backend_bucket google_compute_backend_bucket}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/resources/google_compute_backend_bucket google_compute_backend_bucket} Resource.
...
func GoogleComputeBackendBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeBackendBucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeBackendBucket) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleComputeBackendBucket) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleComputeBackendBucket) ToHclTerraform() interface{} {
	var returns interface{}
