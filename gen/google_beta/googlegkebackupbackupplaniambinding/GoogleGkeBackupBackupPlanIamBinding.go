...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlegkebackupbackupplaniambinding/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_gke_backup_backup_plan_iam_binding google_gke_backup_backup_plan_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_gke_backup_backup_plan_iam_binding google_gke_backup_backup_plan_iam_binding} Resource.
func NewGoogleGkeBackupBackupPlanIamBinding(scope constructs.Construct, id *string, config *GoogleGkeBackupBackupPlanIamBindingConfig) GoogleGkeBackupBackupPlanIamBinding {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.googleGkeBackupBackupPlanIamBinding.GoogleGkeBackupBackupPlanIamBinding",
...
func GoogleGkeBackupBackupPlanIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleGkeBackupBackupPlanIamBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) ToHclTerraform() interface{} {
	var returns interface{}
