...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberCondition",
		reflect.TypeOf((*GoogleAccessContextManagerAccessPolicyIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberConfig",
