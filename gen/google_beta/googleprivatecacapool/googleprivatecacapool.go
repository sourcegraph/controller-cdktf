...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_privateca_ca_pool google_privateca_ca_pool}.
type GooglePrivatecaCaPool interface {
	...
	SetId(val *string)
	IdInput() *string
	IssuancePolicy() GooglePrivatecaCaPoolIssuancePolicyOutputReference
	IssuancePolicyInput() *GooglePrivatecaCaPoolIssuancePolicy
...
type jsiiProxy_GooglePrivatecaCaPool struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GooglePrivatecaCaPool) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) IssuancePolicy() GooglePrivatecaCaPoolIssuancePolicyOutputReference {
	var returns GooglePrivatecaCaPoolIssuancePolicyOutputReference
	_jsii_.Get(
		j,
		"issuancePolicy",
		&returns,
...
func (j *jsiiProxy_GooglePrivatecaCaPool) IssuancePolicyInput() *GooglePrivatecaCaPoolIssuancePolicy {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Labels() *map[string]*string {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Node() constructs.Node {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) PublishingOptions() GooglePrivatecaCaPoolPublishingOptionsOutputReference {
	var returns GooglePrivatecaCaPoolPublishingOptionsOutputReference
	_jsii_.Get(
		j,
		"publishingOptions",
		&returns,
...
func (j *jsiiProxy_GooglePrivatecaCaPool) PublishingOptionsInput() *GooglePrivatecaCaPoolPublishingOptions {
	var returns *GooglePrivatecaCaPoolPublishingOptions
	_jsii_.Get(
		j,
		"publishingOptionsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GooglePrivatecaCaPool) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GooglePrivatecaCaPool) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Tier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tier",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) TierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tierInput",
...
func (j *jsiiProxy_GooglePrivatecaCaPool) Timeouts() GooglePrivatecaCaPoolTimeoutsOutputReference {
	var returns GooglePrivatecaCaPoolTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_privateca_ca_pool google_privateca_ca_pool} Resource.
func NewGooglePrivatecaCaPool(scope constructs.Construct, id *string, config *GooglePrivatecaCaPoolConfig) GooglePrivatecaCaPool {
	...
	if err := validateNewGooglePrivatecaCaPoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) MoveFromId(id *string) {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) MoveToId(id *string) {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) PutPublishingOptions(value *GooglePrivatecaCaPoolPublishingOptions) {
	if err := g.validatePutPublishingOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GooglePrivatecaCaPool) PutTimeouts(value *GooglePrivatecaCaPoolTimeouts) {
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetIssuancePolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetIssuancePolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetPublishingOptions() {
	_jsii_.InvokeVoid(
		g,
		"resetPublishingOptions",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCaPool) ToString() *string {
	var returns *string
