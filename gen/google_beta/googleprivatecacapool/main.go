...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backdateDuration", GoGetter: "BackdateDuration"},
			_jsii_.MemberProperty{JsiiProperty: "backdateDurationInput", GoGetter: "BackdateDurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBackdateDuration", GoMethod: "ResetBackdateDuration"},
