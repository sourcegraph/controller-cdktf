...
func init() {
	_jsii_.RegisterClass(
		"google-beta.googleDataplexTaskIamBinding.GoogleDataplexTaskIamBinding",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexTaskIamBinding.GoogleDataplexTaskIamBindingCondition",
		reflect.TypeOf((*GoogleDataplexTaskIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleDataplexTaskIamBinding.GoogleDataplexTaskIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexTaskIamBinding.GoogleDataplexTaskIamBindingConfig",
