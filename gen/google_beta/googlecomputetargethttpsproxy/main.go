...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTlsEarlyData", GoMethod: "ResetTlsEarlyData"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tlsEarlyData", GoGetter: "TlsEarlyData"},
			_jsii_.MemberProperty{JsiiProperty: "tlsEarlyDataInput", GoGetter: "TlsEarlyDataInput"},
