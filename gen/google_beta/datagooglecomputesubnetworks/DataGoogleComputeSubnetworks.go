...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_compute_subnetworks google_compute_subnetworks}.
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) Subnetworks() DataGoogleComputeSubnetworksSubnetworksList {
	var returns DataGoogleComputeSubnetworksSubnetworksList
	_jsii_.Get(
		j,
		"subnetworks",
		&returns,
...
func (j *jsiiProxy_DataGoogleComputeSubnetworks) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_compute_subnetworks google_compute_subnetworks} Data Source.
func NewDataGoogleComputeSubnetworks(scope constructs.Construct, id *string, config *DataGoogleComputeSubnetworksConfig) DataGoogleComputeSubnetworks {
	...
	if err := validateNewDataGoogleComputeSubnetworksParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_compute_subnetworks google_compute_subnetworks} Data Source.
func NewDataGoogleComputeSubnetworks_Override(d DataGoogleComputeSubnetworks, scope constructs.Construct, id *string, config *DataGoogleComputeSubnetworksConfig) {
	_init_.Initialize()
...
func DataGoogleComputeSubnetworks_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworks",
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ResetFilter() {
	_jsii_.InvokeVoid(
		d,
		"resetFilter",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeSubnetworks) ToString() *string {
	var returns *string
