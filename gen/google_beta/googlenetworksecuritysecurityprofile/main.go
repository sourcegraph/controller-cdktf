...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customInterceptProfile", GoGetter: "CustomInterceptProfile"},
			_jsii_.MemberProperty{JsiiProperty: "customInterceptProfileInput", GoGetter: "CustomInterceptProfileInput"},
			_jsii_.MemberProperty{JsiiProperty: "customMirroringProfile", GoGetter: "CustomMirroringProfile"},
			_jsii_.MemberProperty{JsiiProperty: "customMirroringProfileInput", GoGetter: "CustomMirroringProfileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCustomInterceptProfile", GoMethod: "PutCustomInterceptProfile"},
			...
			_jsii_.MemberProperty{JsiiProperty: "threatPreventionProfile", GoGetter: "ThreatPreventionProfile"},
			_jsii_.MemberProperty{JsiiProperty: "threatPreventionProfileInput", GoGetter: "ThreatPreventionProfileInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroup", GoGetter: "InterceptEndpointGroup"},
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroupInput", GoGetter: "InterceptEndpointGroupInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAntivirusOverrides", GoMethod: "PutAntivirusOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "putSeverityOverrides", GoMethod: "PutSeverityOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "putThreatOverrides", GoMethod: "PutThreatOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAntivirusOverrides", GoMethod: "ResetAntivirusOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetSeverityOverrides", GoMethod: "ResetSeverityOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetThreatOverrides", GoMethod: "ResetThreatOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "severityOverrides", GoGetter: "SeverityOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "severityOverridesInput", GoGetter: "SeverityOverridesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "threatOverrides", GoGetter: "ThreatOverrides"},
