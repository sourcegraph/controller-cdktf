...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowMissingInput", GoGetter: "AllowMissingInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "backupMinimumEnforcedRetentionDurationInput", GoGetter: "BackupMinimumEnforcedRetentionDurationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "deletable", GoGetter: "Deletable"},
			...
			_jsii_.MemberProperty{JsiiProperty: "effectiveTimeInput", GoGetter: "EffectiveTimeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ignoreBackupPlanReferences", GoGetter: "IgnoreBackupPlanReferences"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreBackupPlanReferencesInput", GoGetter: "IgnoreBackupPlanReferencesInput"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreInactiveDatasources", GoGetter: "IgnoreInactiveDatasources"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreInactiveDatasourcesInput", GoGetter: "IgnoreInactiveDatasourcesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEffectiveTime", GoMethod: "ResetEffectiveTime"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreBackupPlanReferences", GoMethod: "ResetIgnoreBackupPlanReferences"},
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreInactiveDatasources", GoMethod: "ResetIgnoreInactiveDatasources"},
