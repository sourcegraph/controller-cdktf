...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "responsePolicyName", GoGetter: "ResponsePolicyName"},
			_jsii_.MemberProperty{JsiiProperty: "responsePolicyNameInput", GoGetter: "ResponsePolicyNameInput"},
