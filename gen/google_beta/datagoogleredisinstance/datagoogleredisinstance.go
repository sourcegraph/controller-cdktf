...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_redis_instance google_redis_instance}.
...
func (j *jsiiProxy_DataGoogleRedisInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_DataGoogleRedisInstance) MaintenanceVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"maintenanceVersion",
...
func (j *jsiiProxy_DataGoogleRedisInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/data-sources/google_redis_instance google_redis_instance} Data Source.
...
func DataGoogleRedisInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataGoogleRedisInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
