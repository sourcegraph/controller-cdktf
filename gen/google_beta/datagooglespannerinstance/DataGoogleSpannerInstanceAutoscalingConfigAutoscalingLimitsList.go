...
func (d *jsiiProxy_DataGoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
