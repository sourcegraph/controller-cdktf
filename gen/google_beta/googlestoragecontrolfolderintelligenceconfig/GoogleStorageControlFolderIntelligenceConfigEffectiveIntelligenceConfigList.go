...
func (j *jsiiProxy_GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList {
	_init_.Initialize()
...
func NewGoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList_Override(g GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleStorageControlFolderIntelligenceConfigEffectiveIntelligenceConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
