...
func (j *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList_Override(d DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroupServerlessDeploymentList) Resolve(_context cdktf.IResolveContext) interface{} {
