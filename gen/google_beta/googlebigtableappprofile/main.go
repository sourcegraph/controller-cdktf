...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataBoostIsolationReadOnly", GoGetter: "DataBoostIsolationReadOnly"},
			_jsii_.MemberProperty{JsiiProperty: "dataBoostIsolationReadOnlyInput", GoGetter: "DataBoostIsolationReadOnlyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ignoreWarnings", GoGetter: "IgnoreWarnings"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreWarningsInput", GoGetter: "IgnoreWarningsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "multiClusterRoutingClusterIds", GoGetter: "MultiClusterRoutingClusterIds"},
			_jsii_.MemberProperty{JsiiProperty: "multiClusterRoutingClusterIdsInput", GoGetter: "MultiClusterRoutingClusterIdsInput"},
			_jsii_.MemberProperty{JsiiProperty: "multiClusterRoutingUseAny", GoGetter: "MultiClusterRoutingUseAny"},
			_jsii_.MemberProperty{JsiiProperty: "multiClusterRoutingUseAnyInput", GoGetter: "MultiClusterRoutingUseAnyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDataBoostIsolationReadOnly", GoMethod: "PutDataBoostIsolationReadOnly"},
			_jsii_.MemberMethod{JsiiMethod: "putSingleClusterRouting", GoMethod: "PutSingleClusterRouting"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMultiClusterRoutingClusterIds", GoMethod: "ResetMultiClusterRoutingClusterIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetMultiClusterRoutingUseAny", GoMethod: "ResetMultiClusterRoutingUseAny"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProject", GoMethod: "ResetProject"},
			_jsii_.MemberMethod{JsiiMethod: "resetRowAffinity", GoMethod: "ResetRowAffinity"},
			_jsii_.MemberMethod{JsiiMethod: "resetSingleClusterRouting", GoMethod: "ResetSingleClusterRouting"},
			_jsii_.MemberMethod{JsiiMethod: "resetStandardIsolation", GoMethod: "ResetStandardIsolation"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rowAffinity", GoGetter: "RowAffinity"},
			_jsii_.MemberProperty{JsiiProperty: "rowAffinityInput", GoGetter: "RowAffinityInput"},
			_jsii_.MemberProperty{JsiiProperty: "singleClusterRouting", GoGetter: "SingleClusterRouting"},
			_jsii_.MemberProperty{JsiiProperty: "singleClusterRoutingInput", GoGetter: "SingleClusterRoutingInput"},
			_jsii_.MemberProperty{JsiiProperty: "standardIsolation", GoGetter: "StandardIsolation"},
			_jsii_.MemberProperty{JsiiProperty: "standardIsolationInput", GoGetter: "StandardIsolationInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "computeBillingOwner", GoGetter: "ComputeBillingOwner"},
			_jsii_.MemberProperty{JsiiProperty: "computeBillingOwnerInput", GoGetter: "ComputeBillingOwnerInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowTransactionalWrites", GoMethod: "ResetAllowTransactionalWrites"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
