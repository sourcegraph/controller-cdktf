...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglekmssecretciphertext/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_kms_secret_ciphertext google_kms_secret_ciphertext}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_kms_secret_ciphertext google_kms_secret_ciphertext} Data Source.
...
func DataGoogleKmsSecretCiphertext_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleKmsSecretCiphertext_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
