...
type GoogleApiGatewayApiConfig struct {
	...
	ManagedService *string `field:"optional" json:"managedService" yaml:"managedService"`
	...
	Timeouts *GoogleApiGatewayApiTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
