...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "managedService", GoGetter: "ManagedService"},
			_jsii_.MemberProperty{JsiiProperty: "managedServiceInput", GoGetter: "ManagedServiceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManagedService", GoMethod: "ResetManagedService"},
