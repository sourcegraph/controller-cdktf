...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.76.0/docs/data-sources/google_vmwareengine_private_cloud google_vmwareengine_private_cloud}.
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Hcx() DataGoogleVmwareenginePrivateCloudHcxList {
	var returns DataGoogleVmwareenginePrivateCloudHcxList
	_jsii_.Get(
		j,
		"hcx",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ManagementCluster() DataGoogleVmwareenginePrivateCloudManagementClusterList {
	var returns DataGoogleVmwareenginePrivateCloudManagementClusterList
	_jsii_.Get(
		j,
		"managementCluster",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) NetworkConfig() DataGoogleVmwareenginePrivateCloudNetworkConfigList {
	var returns DataGoogleVmwareenginePrivateCloudNetworkConfigList
	_jsii_.Get(
		j,
		"networkConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Nsx() DataGoogleVmwareenginePrivateCloudNsxList {
	var returns DataGoogleVmwareenginePrivateCloudNsxList
	_jsii_.Get(
		j,
		"nsx",
		&returns,
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloud) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.76.0/docs/data-sources/google_vmwareengine_private_cloud google_vmwareengine_private_cloud} Data Source.
func NewDataGoogleVmwareenginePrivateCloud(scope constructs.Construct, id *string, config *DataGoogleVmwareenginePrivateCloudConfig) DataGoogleVmwareenginePrivateCloud {
	...
	if err := validateNewDataGoogleVmwareenginePrivateCloudParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleVmwareenginePrivateCloud{}

	_jsii_.Create(
		"google-beta.dataGoogleVmwareenginePrivateCloud.DataGoogleVmwareenginePrivateCloud",
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloud) ToString() *string {
	var returns *string
