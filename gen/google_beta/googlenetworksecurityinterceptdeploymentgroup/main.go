...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectedEndpointGroups", GoGetter: "ConnectedEndpointGroups"},
			...
			_jsii_.MemberProperty{JsiiProperty: "interceptDeploymentGroupId", GoGetter: "InterceptDeploymentGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "interceptDeploymentGroupIdInput", GoGetter: "InterceptDeploymentGroupIdInput"},
