...
type jsiiProxy_GoogleBigtableInstance struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleBigtableInstance) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleBigtableInstance) Cluster() GoogleBigtableInstanceClusterList {
	var returns GoogleBigtableInstanceClusterList
	_jsii_.Get(
		j,
		"cluster",
		&returns,
...
func (j *jsiiProxy_GoogleBigtableInstance) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleBigtableInstance) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleBigtableInstance) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleBigtableInstance) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBigtableInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleBigtableInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleBigtableInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleBigtableInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) InstanceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceType",
...
func (j *jsiiProxy_GoogleBigtableInstance) InstanceTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceTypeInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleBigtableInstance) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBigtableInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleBigtableInstance) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleBigtableInstance) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleBigtableInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleBigtableInstance) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleBigtableInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewGoogleBigtableInstance(scope constructs.Construct, id *string, config *GoogleBigtableInstanceConfig) GoogleBigtableInstance {
	...
	if err := validateNewGoogleBigtableInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GoogleBigtableInstance)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (g *jsiiProxy_GoogleBigtableInstance) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleBigtableInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleBigtableInstance) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableInstance) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetDeletionProtection() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionProtection",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetDisplayName() {
	_jsii_.InvokeVoid(
		g,
		"resetDisplayName",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetInstanceType() {
	_jsii_.InvokeVoid(
		g,
		"resetInstanceType",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableInstance) ToString() *string {
	var returns *string
