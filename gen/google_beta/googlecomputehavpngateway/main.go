...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gatewayIpVersion", GoGetter: "GatewayIpVersion"},
			_jsii_.MemberProperty{JsiiProperty: "gatewayIpVersionInput", GoGetter: "GatewayIpVersionInput"},
