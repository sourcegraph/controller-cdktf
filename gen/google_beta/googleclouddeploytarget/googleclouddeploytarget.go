...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_clouddeploy_target google_clouddeploy_target}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_clouddeploy_target google_clouddeploy_target} Resource.
...
func GoogleClouddeployTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGoogleClouddeployTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleClouddeployTarget) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleClouddeployTarget) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleClouddeployTarget) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleClouddeployTarget) MoveToId(id *string) {
