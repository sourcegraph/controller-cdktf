...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "anthosCluster", GoGetter: "AnthosCluster"},
			_jsii_.MemberProperty{JsiiProperty: "anthosClusterInput", GoGetter: "AnthosClusterInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "executionConfigs", GoGetter: "ExecutionConfigs"},
			_jsii_.MemberProperty{JsiiProperty: "executionConfigsInput", GoGetter: "ExecutionConfigsInput"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTarget.GoogleClouddeployTargetAnthosCluster",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTarget.GoogleClouddeployTargetConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTarget.GoogleClouddeployTargetGke",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInternalIp", GoMethod: "ResetInternalIp"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTarget.GoogleClouddeployTargetTimeouts",
		reflect.TypeOf((*GoogleClouddeployTargetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleClouddeployTarget.GoogleClouddeployTargetTimeoutsOutputReference",
