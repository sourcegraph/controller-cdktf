...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_artifact_registry_repository google_artifact_registry_repository}.
...
type jsiiProxy_DataGoogleArtifactRegistryRepository struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Format() *string {
	var returns *string
	_jsii_.Get(
		j,
		"format",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) KmsKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyName",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Labels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) MavenConfig() DataGoogleArtifactRegistryRepositoryMavenConfigList {
	var returns DataGoogleArtifactRegistryRepositoryMavenConfigList
	_jsii_.Get(
		j,
		"mavenConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepository) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/data-sources/google_artifact_registry_repository google_artifact_registry_repository} Data Source.
func NewDataGoogleArtifactRegistryRepository(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryRepositoryConfig) DataGoogleArtifactRegistryRepository {
	...
	if err := validateNewDataGoogleArtifactRegistryRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleArtifactRegistryRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleArtifactRegistryRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepository) ToString() *string {
	var returns *string
