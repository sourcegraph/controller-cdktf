...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryMavenConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleArtifactRegistryRepositoryMavenConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleArtifactRegistryRepositoryMavenConfigList {
	...
	_jsii_.Create(
		"@cdktf/provider-google-beta.dataGoogleArtifactRegistryRepository.DataGoogleArtifactRegistryRepositoryMavenConfigList",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryMavenConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryMavenConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryMavenConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
