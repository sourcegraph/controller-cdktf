...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlesqlsourcerepresentationinstance/internal"
)
...
func (j *jsiiProxy_GoogleSqlSourceRepresentationInstance) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleSqlSourceRepresentationInstance)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
