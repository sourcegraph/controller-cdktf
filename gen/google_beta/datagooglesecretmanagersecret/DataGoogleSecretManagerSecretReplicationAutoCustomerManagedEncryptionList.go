...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList {
	_init_.Initialize()
...
func NewDataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList_Override(d DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationAutoCustomerManagedEncryptionList) Resolve(_context cdktf.IResolveContext) interface{} {
