...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedReplicasList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleSecretManagerSecretReplicationUserManagedReplicasList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerSecretReplicationUserManagedReplicasList {
	_init_.Initialize()
...
func NewDataGoogleSecretManagerSecretReplicationUserManagedReplicasList_Override(d DataGoogleSecretManagerSecretReplicationUserManagedReplicasList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedReplicasList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedReplicasList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretReplicationUserManagedReplicasList) Resolve(_context cdktf.IResolveContext) interface{} {
