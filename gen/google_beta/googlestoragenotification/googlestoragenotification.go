...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleStorageNotification)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationId", GoGetter: "NotificationId"},
			_jsii_.MemberProperty{JsiiProperty: "objectNamePrefix", GoGetter: "ObjectNamePrefix"},
			_jsii_.MemberProperty{JsiiProperty: "objectNamePrefixInput", GoGetter: "ObjectNamePrefixInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetObjectNamePrefix", GoMethod: "ResetObjectNamePrefix"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleStorageNotification.GoogleStorageNotificationConfig",
		reflect.TypeOf((*GoogleStorageNotificationConfig)(nil)).Elem(),
	)
}
