...
type GoogleCloudfunctionsFunctionSecretVolumesVersions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/4.69.1/docs/resources/google_cloudfunctions_function#path GoogleCloudfunctionsFunction#path}
