...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dryRunSpec", GoGetter: "DryRunSpec"},
			_jsii_.MemberProperty{JsiiProperty: "dryRunSpecInput", GoGetter: "DryRunSpecInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDryRunSpec", GoMethod: "PutDryRunSpec"},
