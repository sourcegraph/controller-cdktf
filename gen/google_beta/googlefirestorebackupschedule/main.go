...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dailyRecurrence", GoGetter: "DailyRecurrence"},
			_jsii_.MemberProperty{JsiiProperty: "dailyRecurrenceInput", GoGetter: "DailyRecurrenceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDailyRecurrence", GoMethod: "PutDailyRecurrence"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWeeklyRecurrence", GoMethod: "ResetWeeklyRecurrence"},
