...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_region_health_check google_compute_region_health_check}.
...
func (j *jsiiProxy_GoogleComputeRegionHealthCheck) HealthCheckId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"healthCheckId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_region_health_check google_compute_region_health_check} Resource.
...
func GoogleComputeRegionHealthCheck_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeRegionHealthCheck_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeRegionHealthCheck) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeRegionHealthCheck) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionHealthCheck) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeRegionHealthCheck) MoveToId(id *string) {
