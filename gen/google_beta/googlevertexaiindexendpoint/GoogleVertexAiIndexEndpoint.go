...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlevertexaiindexendpoint/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_vertex_ai_index_endpoint google_vertex_ai_index_endpoint}.
...
type jsiiProxy_GoogleVertexAiIndexEndpoint struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) Timeouts() GoogleVertexAiIndexEndpointTimeoutsOutputReference {
	var returns GoogleVertexAiIndexEndpointTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpoint) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_vertex_ai_index_endpoint google_vertex_ai_index_endpoint} Resource.
func NewGoogleVertexAiIndexEndpoint(scope constructs.Construct, id *string, config *GoogleVertexAiIndexEndpointConfig) GoogleVertexAiIndexEndpoint {
	...
	if err := validateNewGoogleVertexAiIndexEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleVertexAiIndexEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleVertexAiIndexEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GoogleVertexAiIndexEndpoint_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleVertexAiIndexEndpoint.GoogleVertexAiIndexEndpoint",
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetNetwork() {
	_jsii_.InvokeVoid(
		g,
		"resetNetwork",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		g,
		"resetRegion",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpoint) ToString() *string {
	var returns *string
