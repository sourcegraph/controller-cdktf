...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_discovery_engine_data_store google_discovery_engine_data_store}.
type GoogleDiscoveryEngineDataStore interface {
	...
	DocumentProcessingConfig() GoogleDiscoveryEngineDataStoreDocumentProcessingConfigOutputReference
	DocumentProcessingConfigInput() *GoogleDiscoveryEngineDataStoreDocumentProcessingConfig
	// Experimental.
...
func (j *jsiiProxy_GoogleDiscoveryEngineDataStore) DocumentProcessingConfig() GoogleDiscoveryEngineDataStoreDocumentProcessingConfigOutputReference {
	var returns GoogleDiscoveryEngineDataStoreDocumentProcessingConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleDiscoveryEngineDataStore) DocumentProcessingConfigInput() *GoogleDiscoveryEngineDataStoreDocumentProcessingConfig {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_discovery_engine_data_store google_discovery_engine_data_store} Resource.
...
func GoogleDiscoveryEngineDataStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleDiscoveryEngineDataStore_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) ResetDocumentProcessingConfig() {
	_jsii_.InvokeVoid(
		g,
		"resetDocumentProcessingConfig",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GoogleDiscoveryEngineDataStore) ToHclTerraform() interface{} {
	var returns interface{}
