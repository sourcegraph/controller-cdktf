...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_scc_folder_scc_big_query_export google_scc_folder_scc_big_query_export}.
type GoogleSccFolderSccBigQueryExport interface {
	...
	PutTimeouts(value *GoogleSccFolderSccBigQueryExportTimeouts)
	ResetId()
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) BigQueryExportIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Dataset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataset",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) DatasetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Folder() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folder",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) FolderInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) MostRecentEditor() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mostRecentEditor",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Principal() *string {
	var returns *string
	_jsii_.Get(
		j,
		"principal",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) Timeouts() GoogleSccFolderSccBigQueryExportTimeoutsOutputReference {
	var returns GoogleSccFolderSccBigQueryExportTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_scc_folder_scc_big_query_export google_scc_folder_scc_big_query_export} Resource.
func NewGoogleSccFolderSccBigQueryExport(scope constructs.Construct, id *string, config *GoogleSccFolderSccBigQueryExportConfig) GoogleSccFolderSccBigQueryExport {
	...
	if err := validateNewGoogleSccFolderSccBigQueryExportParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleSccFolderSccBigQueryExport{}

	_jsii_.Create(
		"@cdktf/provider-google-beta.googleSccFolderSccBigQueryExport.GoogleSccFolderSccBigQueryExport",
...
func GoogleSccFolderSccBigQueryExport_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleSccFolderSccBigQueryExport.GoogleSccFolderSccBigQueryExport",
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) PutTimeouts(value *GoogleSccFolderSccBigQueryExportTimeouts) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) ToString() *string {
	var returns *string
