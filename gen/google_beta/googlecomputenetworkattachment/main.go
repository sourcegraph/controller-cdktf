...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectionEndpoints", GoGetter: "ConnectionEndpoints"},
			...
			_jsii_.MemberProperty{JsiiProperty: "producerAcceptLists", GoGetter: "ProducerAcceptLists"},
			_jsii_.MemberProperty{JsiiProperty: "producerAcceptListsInput", GoGetter: "ProducerAcceptListsInput"},
			_jsii_.MemberProperty{JsiiProperty: "producerRejectLists", GoGetter: "ProducerRejectLists"},
			_jsii_.MemberProperty{JsiiProperty: "producerRejectListsInput", GoGetter: "ProducerRejectListsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProducerRejectLists", GoMethod: "ResetProducerRejectLists"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "secondaryIpCidrRanges", GoGetter: "SecondaryIpCidrRanges"},
