...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backendMetastores", GoGetter: "BackendMetastores"},
			_jsii_.MemberProperty{JsiiProperty: "backendMetastoresInput", GoGetter: "BackendMetastoresInput"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataprocMetastoreFederation.GoogleDataprocMetastoreFederationBackendMetastores",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "metastoreType", GoGetter: "MetastoreType"},
			_jsii_.MemberProperty{JsiiProperty: "metastoreTypeInput", GoGetter: "MetastoreTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
