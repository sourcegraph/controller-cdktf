...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagooglemonitoringnotificationchannel/internal"
)
...
func (j *jsiiProxy_DataGoogleMonitoringNotificationChannel) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleMonitoringNotificationChannel)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
