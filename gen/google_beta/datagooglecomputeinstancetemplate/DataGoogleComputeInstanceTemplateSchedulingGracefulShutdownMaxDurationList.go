...
func (j *jsiiProxy_DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList {
	_init_.Initialize()
...
func NewDataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList_Override(d DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateSchedulingGracefulShutdownMaxDurationList) Resolve(_context cdktf.IResolveContext) interface{} {
