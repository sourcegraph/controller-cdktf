...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
