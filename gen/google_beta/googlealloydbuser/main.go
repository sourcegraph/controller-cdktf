...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "databaseRoles", GoGetter: "DatabaseRoles"},
			_jsii_.MemberProperty{JsiiProperty: "databaseRolesInput", GoGetter: "DatabaseRolesInput"},
