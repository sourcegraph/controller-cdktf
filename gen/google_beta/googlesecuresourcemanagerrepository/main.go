...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "initialConfig", GoGetter: "InitialConfig"},
			_jsii_.MemberProperty{JsiiProperty: "initialConfigInput", GoGetter: "InitialConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInitialConfig", GoMethod: "ResetInitialConfig"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "gitignores", GoGetter: "Gitignores"},
			_jsii_.MemberProperty{JsiiProperty: "gitignoresInput", GoGetter: "GitignoresInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "readme", GoGetter: "Readme"},
			_jsii_.MemberProperty{JsiiProperty: "readmeInput", GoGetter: "ReadmeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultBranch", GoMethod: "ResetDefaultBranch"},
			_jsii_.MemberMethod{JsiiMethod: "resetGitignores", GoMethod: "ResetGitignores"},
			_jsii_.MemberMethod{JsiiMethod: "resetLicense", GoMethod: "ResetLicense"},
			_jsii_.MemberMethod{JsiiMethod: "resetReadme", GoMethod: "ResetReadme"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "gitHttps", GoGetter: "GitHttps"},
