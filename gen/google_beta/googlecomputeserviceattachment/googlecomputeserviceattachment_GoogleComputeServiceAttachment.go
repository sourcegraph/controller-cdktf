...
// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_service_attachment google_compute_service_attachment}.
...
func (j *jsiiProxy_GoogleComputeServiceAttachment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_service_attachment google_compute_service_attachment} Resource.
...
func (j *jsiiProxy_GoogleComputeServiceAttachment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
