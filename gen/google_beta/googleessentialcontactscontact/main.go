...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "languageTag", GoGetter: "LanguageTag"},
			_jsii_.MemberProperty{JsiiProperty: "languageTagInput", GoGetter: "LanguageTagInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationCategorySubscriptions", GoGetter: "NotificationCategorySubscriptions"},
			_jsii_.MemberProperty{JsiiProperty: "notificationCategorySubscriptionsInput", GoGetter: "NotificationCategorySubscriptionsInput"},
