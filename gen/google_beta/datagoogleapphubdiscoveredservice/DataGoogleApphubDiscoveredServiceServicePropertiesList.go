...
func (j *jsiiProxy_DataGoogleApphubDiscoveredServiceServicePropertiesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleApphubDiscoveredServiceServicePropertiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleApphubDiscoveredServiceServicePropertiesList {
	_init_.Initialize()
...
func NewDataGoogleApphubDiscoveredServiceServicePropertiesList_Override(d DataGoogleApphubDiscoveredServiceServicePropertiesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleApphubDiscoveredServiceServicePropertiesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredServiceServicePropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredServiceServicePropertiesList) Resolve(_context cdktf.IResolveContext) interface{} {
