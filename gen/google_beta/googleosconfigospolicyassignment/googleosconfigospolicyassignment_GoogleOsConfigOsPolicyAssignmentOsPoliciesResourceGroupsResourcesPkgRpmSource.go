...
type GoogleOsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgRpmSource struct {
	// Defaults to false.
	//
	...
	Gcs *GoogleOsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgRpmSourceGcs `field:"optional" json:"gcs" yaml:"gcs"`
	...
	Remote *GoogleOsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgRpmSourceRemote `field:"optional" json:"remote" yaml:"remote"`
}
