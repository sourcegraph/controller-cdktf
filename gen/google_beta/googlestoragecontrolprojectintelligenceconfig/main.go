...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "editionConfigInput", GoGetter: "EditionConfigInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludedCloudStorageBucketsInput", GoGetter: "ExcludedCloudStorageBucketsInput"},
			_jsii_.MemberProperty{JsiiProperty: "excludedCloudStorageLocations", GoGetter: "ExcludedCloudStorageLocations"},
			_jsii_.MemberProperty{JsiiProperty: "excludedCloudStorageLocationsInput", GoGetter: "ExcludedCloudStorageLocationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "includedCloudStorageBucketsInput", GoGetter: "IncludedCloudStorageBucketsInput"},
			_jsii_.MemberProperty{JsiiProperty: "includedCloudStorageLocations", GoGetter: "IncludedCloudStorageLocations"},
			_jsii_.MemberProperty{JsiiProperty: "includedCloudStorageLocationsInput", GoGetter: "IncludedCloudStorageLocationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putExcludedCloudStorageBuckets", GoMethod: "PutExcludedCloudStorageBuckets"},
			_jsii_.MemberMethod{JsiiMethod: "putExcludedCloudStorageLocations", GoMethod: "PutExcludedCloudStorageLocations"},
			_jsii_.MemberMethod{JsiiMethod: "putIncludedCloudStorageBuckets", GoMethod: "PutIncludedCloudStorageBuckets"},
			_jsii_.MemberMethod{JsiiMethod: "putIncludedCloudStorageLocations", GoMethod: "PutIncludedCloudStorageLocations"},
			_jsii_.MemberMethod{JsiiMethod: "resetExcludedCloudStorageBuckets", GoMethod: "ResetExcludedCloudStorageBuckets"},
			_jsii_.MemberMethod{JsiiMethod: "resetExcludedCloudStorageLocations", GoMethod: "ResetExcludedCloudStorageLocations"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludedCloudStorageBuckets", GoMethod: "ResetIncludedCloudStorageBuckets"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludedCloudStorageLocations", GoMethod: "ResetIncludedCloudStorageLocations"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
