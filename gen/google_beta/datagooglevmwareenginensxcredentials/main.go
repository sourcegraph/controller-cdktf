...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleVmwareengineNsxCredentials)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.dataGoogleVmwareengineNsxCredentials.DataGoogleVmwareengineNsxCredentialsConfig",
		reflect.TypeOf((*DataGoogleVmwareengineNsxCredentialsConfig)(nil)).Elem(),
	)
}
