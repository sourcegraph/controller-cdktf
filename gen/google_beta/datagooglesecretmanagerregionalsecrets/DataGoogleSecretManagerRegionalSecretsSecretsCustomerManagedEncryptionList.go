...
func (j *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList {
	_init_.Initialize()
...
func NewDataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList_Override(d DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleSecretManagerRegionalSecretsSecretsCustomerManagedEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
