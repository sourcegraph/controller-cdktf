...
func (j *jsiiProxy_GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleStorageControlOrganizationIntelligenceConfigTrialConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList {
	_init_.Initialize()
...
func NewGoogleStorageControlOrganizationIntelligenceConfigTrialConfigList_Override(g GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleStorageControlOrganizationIntelligenceConfigTrialConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
