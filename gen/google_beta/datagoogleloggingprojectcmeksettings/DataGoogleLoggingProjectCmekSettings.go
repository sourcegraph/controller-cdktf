...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/datagoogleloggingprojectcmeksettings/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/data-sources/google_logging_project_cmek_settings google_logging_project_cmek_settings}.
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) KmsKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyName",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) KmsKeyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyNameInput",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) KmsKeyVersionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyVersionName",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ServiceAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountId",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.45.0/docs/data-sources/google_logging_project_cmek_settings google_logging_project_cmek_settings} Data Source.
func NewDataGoogleLoggingProjectCmekSettings(scope constructs.Construct, id *string, config *DataGoogleLoggingProjectCmekSettingsConfig) DataGoogleLoggingProjectCmekSettings {
	...
	if err := validateNewDataGoogleLoggingProjectCmekSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleLoggingProjectCmekSettings_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleLoggingProjectCmekSettings.DataGoogleLoggingProjectCmekSettings",
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ResetKmsKeyName() {
	_jsii_.InvokeVoid(
		d,
		"resetKmsKeyName",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleLoggingProjectCmekSettings) ToString() *string {
	var returns *string
