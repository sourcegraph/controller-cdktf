...
type GoogleComputeMachineImageIamBindingConfig struct {
	// Experimental.
	...
	Condition *GoogleComputeMachineImageIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
