...
type GoogleComputeResourcePolicyAttachmentConfig struct {
	// Experimental.
	...
	Timeouts *GoogleComputeResourcePolicyAttachmentTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
