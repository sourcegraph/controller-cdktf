...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
