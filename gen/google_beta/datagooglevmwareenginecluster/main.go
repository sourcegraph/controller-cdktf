...
func init() {
	_jsii_.RegisterClass(
		"google-beta.dataGoogleVmwareengineCluster.DataGoogleVmwareengineCluster",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleVmwareengineCluster.DataGoogleVmwareengineClusterConfig",
		reflect.TypeOf((*DataGoogleVmwareengineClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleVmwareengineCluster.DataGoogleVmwareengineClusterNodeTypeConfigs",
		reflect.TypeOf((*DataGoogleVmwareengineClusterNodeTypeConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleVmwareengineCluster.DataGoogleVmwareengineClusterNodeTypeConfigsList",
