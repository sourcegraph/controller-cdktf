...
func init() {
	_jsii_.RegisterClass(
		"google-beta.dataGoogleDataplexDatascanIamPolicy.DataGoogleDataplexDatascanIamPolicy",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleDataplexDatascanIamPolicy.DataGoogleDataplexDatascanIamPolicyConfig",
