...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapTunnelInstanceIamBinding.GoogleIapTunnelInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIapTunnelInstanceIamBinding.GoogleIapTunnelInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapTunnelInstanceIamBinding.GoogleIapTunnelInstanceIamBindingConfig",
