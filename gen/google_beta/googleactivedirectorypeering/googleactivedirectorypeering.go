...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_active_directory_peering google_active_directory_peering}.
type GoogleActiveDirectoryPeering interface {
	...
	PutTimeouts(value *GoogleActiveDirectoryPeeringTimeouts)
	ResetId()
	ResetLabels()
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) AuthorizedNetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) DomainResource() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainResource",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) DomainResourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainResourceInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) PeeringId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peeringId",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) PeeringIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peeringIdInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) StatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) StatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessage",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) StatusMessageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusMessageInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) Timeouts() GoogleActiveDirectoryPeeringTimeoutsOutputReference {
	var returns GoogleActiveDirectoryPeeringTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_active_directory_peering google_active_directory_peering} Resource.
func NewGoogleActiveDirectoryPeering(scope constructs.Construct, id *string, config *GoogleActiveDirectoryPeeringConfig) GoogleActiveDirectoryPeering {
	...
	if err := validateNewGoogleActiveDirectoryPeeringParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GoogleActiveDirectoryPeering_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.googleActiveDirectoryPeering.GoogleActiveDirectoryPeering",
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) PutTimeouts(value *GoogleActiveDirectoryPeeringTimeouts) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetStatus() {
	_jsii_.InvokeVoid(
		g,
		"resetStatus",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetStatusMessage() {
	_jsii_.InvokeVoid(
		g,
		"resetStatusMessage",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ToString() *string {
	var returns *string
