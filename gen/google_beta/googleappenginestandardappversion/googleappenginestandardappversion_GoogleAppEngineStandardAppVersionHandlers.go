...
type GoogleAppEngineStandardAppVersionHandlers struct {
	...
	Script *GoogleAppEngineStandardAppVersionHandlersScript `field:"optional" json:"script" yaml:"script"`
	...
	StaticFiles *GoogleAppEngineStandardAppVersionHandlersStaticFiles `field:"optional" json:"staticFiles" yaml:"staticFiles"`
	// URL prefix.
	//
