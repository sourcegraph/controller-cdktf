...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) validatePutAttachedDiskParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeInstanceFromTemplateAttachedDisk; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) validatePutGuestAcceleratorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeInstanceFromTemplateGuestAccelerator; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeInstanceFromTemplateNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) validatePutScratchDiskParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeInstanceFromTemplateScratchDisk; received %#v (a %T)", value, value)
		}
	}
