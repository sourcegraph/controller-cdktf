...
type GoogleComputeRouterPeerCustomLearnedIpRanges struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_router_peer#range GoogleComputeRouterPeer#range}
