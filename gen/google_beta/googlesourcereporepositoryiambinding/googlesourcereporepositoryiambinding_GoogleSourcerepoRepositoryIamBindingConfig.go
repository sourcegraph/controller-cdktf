...
type GoogleSourcerepoRepositoryIamBindingConfig struct {
	// Experimental.
	...
	Condition *GoogleSourcerepoRepositoryIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
