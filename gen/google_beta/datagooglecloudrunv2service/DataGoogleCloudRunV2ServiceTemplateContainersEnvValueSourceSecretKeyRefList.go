...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList_Override(d DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersEnvValueSourceSecretKeyRefList) Resolve(_context cdktf.IResolveContext) interface{} {
