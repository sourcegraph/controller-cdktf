...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList_Override(d DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateVpcAccessNetworkInterfacesList) Resolve(_context cdktf.IResolveContext) interface{} {
