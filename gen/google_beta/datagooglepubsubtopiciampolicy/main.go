...
func init() {
	_jsii_.RegisterClass(
		"google-beta.dataGooglePubsubTopicIamPolicy.DataGooglePubsubTopicIamPolicy",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGooglePubsubTopicIamPolicy.DataGooglePubsubTopicIamPolicyConfig",
