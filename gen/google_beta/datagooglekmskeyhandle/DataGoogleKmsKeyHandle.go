...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_kms_key_handle google_kms_key_handle}.
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) ResourceTypeSelector() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleKmsKeyHandle) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_kms_key_handle google_kms_key_handle} Data Source.
func NewDataGoogleKmsKeyHandle(scope constructs.Construct, id *string, config *DataGoogleKmsKeyHandleConfig) DataGoogleKmsKeyHandle {
	...
	if err := validateNewDataGoogleKmsKeyHandleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/data-sources/google_kms_key_handle google_kms_key_handle} Data Source.
func NewDataGoogleKmsKeyHandle_Override(d DataGoogleKmsKeyHandle, scope constructs.Construct, id *string, config *DataGoogleKmsKeyHandleConfig) {
	_init_.Initialize()
...
func DataGoogleKmsKeyHandle_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google-beta.dataGoogleKmsKeyHandle.DataGoogleKmsKeyHandle",
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleKmsKeyHandle) ToString() *string {
	var returns *string
