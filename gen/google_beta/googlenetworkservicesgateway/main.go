...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "certificateUrls", GoGetter: "CertificateUrls"},
			_jsii_.MemberProperty{JsiiProperty: "certificateUrlsInput", GoGetter: "CertificateUrlsInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "createTime", GoGetter: "CreateTime"},
			_jsii_.MemberProperty{JsiiProperty: "deleteSwgAutogenRouterOnDestroy", GoGetter: "DeleteSwgAutogenRouterOnDestroy"},
			_jsii_.MemberProperty{JsiiProperty: "deleteSwgAutogenRouterOnDestroyInput", GoGetter: "DeleteSwgAutogenRouterOnDestroyInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "effectiveLabels", GoGetter: "EffectiveLabels"},
			_jsii_.MemberProperty{JsiiProperty: "envoyHeaders", GoGetter: "EnvoyHeaders"},
			_jsii_.MemberProperty{JsiiProperty: "envoyHeadersInput", GoGetter: "EnvoyHeadersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteSwgAutogenRouterOnDestroy", GoMethod: "ResetDeleteSwgAutogenRouterOnDestroy"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvoyHeaders", GoMethod: "ResetEnvoyHeaders"},
			_jsii_.MemberMethod{JsiiMethod: "resetGatewaySecurityPolicy", GoMethod: "ResetGatewaySecurityPolicy"},
