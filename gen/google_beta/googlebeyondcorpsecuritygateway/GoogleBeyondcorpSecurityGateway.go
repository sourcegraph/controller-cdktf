...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_beyondcorp_security_gateway google_beyondcorp_security_gateway}.
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.30.0/docs/resources/google_beyondcorp_security_gateway google_beyondcorp_security_gateway} Resource.
...
func GoogleBeyondcorpSecurityGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
