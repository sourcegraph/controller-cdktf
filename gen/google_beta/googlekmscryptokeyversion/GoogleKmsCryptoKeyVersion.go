...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_kms_crypto_key_version google_kms_crypto_key_version}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.38.0/docs/resources/google_kms_crypto_key_version google_kms_crypto_key_version} Resource.
...
func GoogleKmsCryptoKeyVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleKmsCryptoKeyVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) MoveToId(id *string) {
