...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
