...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kmsConfigInput", GoGetter: "KmsConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "labels", GoGetter: "Labels"},
			_jsii_.MemberProperty{JsiiProperty: "labelsInput", GoGetter: "LabelsInput"},
			_jsii_.MemberProperty{JsiiProperty: "ldapEnabled", GoGetter: "LdapEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "ldapEnabledInput", GoGetter: "LdapEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKmsConfig", GoMethod: "ResetKmsConfig"},
