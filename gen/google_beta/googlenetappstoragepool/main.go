...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowAutoTiering", GoGetter: "AllowAutoTiering"},
			_jsii_.MemberProperty{JsiiProperty: "allowAutoTieringInput", GoGetter: "AllowAutoTieringInput"},
