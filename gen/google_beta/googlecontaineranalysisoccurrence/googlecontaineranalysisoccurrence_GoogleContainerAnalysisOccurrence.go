...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google_beta/googlecontaineranalysisoccurrence/internal"
)
...
func (j *jsiiProxy_GoogleContainerAnalysisOccurrence) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleContainerAnalysisOccurrence)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
