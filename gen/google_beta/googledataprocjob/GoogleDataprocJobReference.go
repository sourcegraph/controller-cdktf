...
type GoogleDataprocJobReference struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.6.0/docs/resources/google_dataproc_job#job_id GoogleDataprocJob#job_id}
