...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_health_check google_compute_health_check}.
...
func (j *jsiiProxy_GoogleComputeHealthCheck) SourceRegions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceRegions",
...
func (j *jsiiProxy_GoogleComputeHealthCheck) SourceRegionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"sourceRegionsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/6.32.0/docs/resources/google_compute_health_check google_compute_health_check} Resource.
...
func GoogleComputeHealthCheck_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleComputeHealthCheck_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleComputeHealthCheck) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleComputeHealthCheck) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeHealthCheck) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleComputeHealthCheck) MoveToId(id *string) {
...
func (g *jsiiProxy_GoogleComputeHealthCheck) ResetSourceRegions() {
	_jsii_.InvokeVoid(
		g,
		"resetSourceRegions",
		nil, // no parameters
