...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_apigee_keystores_aliases_self_signed_cert google_apigee_keystores_aliases_self_signed_cert}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/5.30.0/docs/resources/google_apigee_keystores_aliases_self_signed_cert google_apigee_keystores_aliases_self_signed_cert} Resource.
...
func GoogleApigeeKeystoresAliasesSelfSignedCert_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGoogleApigeeKeystoresAliasesSelfSignedCert_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCert) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCert) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCert) MoveFromId(id *string) {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCert) MoveToId(id *string) {
