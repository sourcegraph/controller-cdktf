...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigAuxiliaryNodeGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
