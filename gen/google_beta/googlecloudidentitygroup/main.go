...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "initialGroupConfigInput", GoGetter: "InitialGroupConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInitialGroupConfig", GoMethod: "ResetInitialGroupConfig"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupAdditionalGroupKeys",
