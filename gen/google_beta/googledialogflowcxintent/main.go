...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isDefaultNegativeIntent", GoGetter: "IsDefaultNegativeIntent"},
			_jsii_.MemberProperty{JsiiProperty: "isDefaultNegativeIntentInput", GoGetter: "IsDefaultNegativeIntentInput"},
			_jsii_.MemberProperty{JsiiProperty: "isDefaultWelcomeIntent", GoGetter: "IsDefaultWelcomeIntent"},
			_jsii_.MemberProperty{JsiiProperty: "isDefaultWelcomeIntentInput", GoGetter: "IsDefaultWelcomeIntentInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsDefaultWelcomeIntent", GoMethod: "ResetIsDefaultWelcomeIntent"},
