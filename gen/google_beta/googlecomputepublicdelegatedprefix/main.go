...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parentPrefix", GoGetter: "ParentPrefix"},
			_jsii_.MemberProperty{JsiiProperty: "parentPrefixInput", GoGetter: "ParentPrefixInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsLiveMigration", GoMethod: "ResetIsLiveMigration"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputePublicDelegatedPrefix.GoogleComputePublicDelegatedPrefixConfig",
		reflect.TypeOf((*GoogleComputePublicDelegatedPrefixConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputePublicDelegatedPrefix.GoogleComputePublicDelegatedPrefixTimeouts",
