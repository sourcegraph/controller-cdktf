...
func NewGkeprivate(scope constructs.Construct, id *string, options *GkeprivateOptions) Gkeprivate {
	_init_.Initialize()

	if err := validateNewGkeprivateParameters(scope, id, options); err != nil {
		panic(err)
	}
...
func NewGkeprivate_Override(g Gkeprivate, scope constructs.Construct, id *string, options *GkeprivateOptions) {
	_init_.Initialize()
