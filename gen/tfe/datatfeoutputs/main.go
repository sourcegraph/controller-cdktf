...
func init() {
	_jsii_.RegisterClass(
		"tfe.dataTfeOutputs.DataTfeOutputs",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nonsensitiveValues", GoGetter: "NonsensitiveValues"},
	...
	_jsii_.RegisterStruct(
		"tfe.dataTfeOutputs.DataTfeOutputsConfig",
