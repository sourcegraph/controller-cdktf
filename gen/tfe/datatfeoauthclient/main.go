...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceProvider", GoMethod: "ResetServiceProvider"},
			_jsii_.MemberProperty{JsiiProperty: "serviceProvider", GoGetter: "ServiceProvider"},
			_jsii_.MemberProperty{JsiiProperty: "serviceProviderDisplayName", GoGetter: "ServiceProviderDisplayName"},
	...
	_jsii_.RegisterStruct(
		"tfe.dataTfeOauthClient.DataTfeOauthClientConfig",
