...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/tfe/adminorganizationsettings/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/resources/admin_organization_settings tfe_admin_organization_settings}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/resources/admin_organization_settings tfe_admin_organization_settings} Resource.
...
func AdminOrganizationSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAdminOrganizationSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AdminOrganizationSettings) AddMoveTarget(moveTarget *string) {
