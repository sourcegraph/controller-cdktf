...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/tfe/policy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/resources/policy tfe_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/resources/policy tfe_policy} Resource.
...
func Policy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_Policy) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_Policy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_Policy) MoveFromId(id *string) {
...
func (p *jsiiProxy_Policy) MoveToId(id *string) {
...
func (p *jsiiProxy_Policy) ResetOrganization() {
	_jsii_.InvokeVoid(
		p,
		"resetOrganization",
		nil, // no parameters
