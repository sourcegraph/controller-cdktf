...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/data-sources/policy_set tfe_policy_set}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/tfe/0.42.0/docs/data-sources/policy_set tfe_policy_set} Data Source.
...
func DataTfePolicySet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataTfePolicySet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
