...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/random/uuid/internal"
)
...
func (j *jsiiProxy_Uuid) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewUuid(scope constructs.Construct, id *string, config *UuidConfig) Uuid {
	...
	if err := validateNewUuidParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Uuid{}
...
func (j *jsiiProxy_Uuid)SetCount(val interface{}) {
...
func Uuid_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateUuid_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Uuid_IsConstruct(x interface{}) *bool {
	...
	if err := validateUuid_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Uuid_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUuid_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Uuid_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUuid_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (u *jsiiProxy_Uuid) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_Uuid) HasResourceMove() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_Uuid) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (u *jsiiProxy_Uuid) MoveFromId(id *string) {
...
func (u *jsiiProxy_Uuid) MoveTo(moveTarget *string, index interface{}) {
...
func (u *jsiiProxy_Uuid) MoveToId(id *string) {
...
func (u *jsiiProxy_Uuid) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_Uuid) ToHclTerraform() interface{} {
	var returns interface{}
