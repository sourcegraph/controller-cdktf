...
type jsiiProxy_TemplateSms struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TemplateSms) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TemplateSms) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TemplateSms) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TemplateSms) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TemplateSms) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TemplateSms) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TemplateSms) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TemplateSms) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TemplateSms) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TemplateSms) Node() constructs.Node {
...
func (j *jsiiProxy_TemplateSms) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TemplateSms) Template() *string {
	var returns *string
	_jsii_.Get(
		j,
		"template",
...
func (j *jsiiProxy_TemplateSms) TemplateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateInput",
...
func (j *jsiiProxy_TemplateSms) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TemplateSms) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TemplateSms) Translations() TemplateSmsTranslationsList {
	var returns TemplateSmsTranslationsList
	_jsii_.Get(
		j,
		"translations",
		&returns,
...
func (j *jsiiProxy_TemplateSms) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_TemplateSms) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewTemplateSms(scope constructs.Construct, id *string, config *TemplateSmsConfig) TemplateSms {
	...
	if err := validateNewTemplateSmsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_TemplateSms)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (t *jsiiProxy_TemplateSms) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TemplateSms) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TemplateSms) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TemplateSms) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TemplateSms) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TemplateSms) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TemplateSms) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TemplateSms) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TemplateSms) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateSms) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateSms) ResetTranslations() {
	_jsii_.InvokeVoid(
		t,
		"resetTranslations",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateSms) ToString() *string {
	var returns *string
