...
func init() {
	_jsii_.RegisterClass(
		"okta.authServerClaim.AuthServerClaim",
		reflect.TypeOf((*AuthServerClaim)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "alwaysIncludeInToken", GoGetter: "AlwaysIncludeInToken"},
			_jsii_.MemberProperty{JsiiProperty: "alwaysIncludeInTokenInput", GoGetter: "AlwaysIncludeInTokenInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "claimTypeInput", GoGetter: "ClaimTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "groupFilterType", GoGetter: "GroupFilterType"},
			_jsii_.MemberProperty{JsiiProperty: "groupFilterTypeInput", GoGetter: "GroupFilterTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGroupFilterType", GoMethod: "ResetGroupFilterType"},
	...
	_jsii_.RegisterStruct(
		"okta.authServerClaim.AuthServerClaimConfig",
		reflect.TypeOf((*AuthServerClaimConfig)(nil)).Elem(),
	)
}
