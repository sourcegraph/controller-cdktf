...
func (r *jsiiProxy_ResourceSet) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (r *jsiiProxy_ResourceSet) validateImportFromParameters(id *string) error {
	return nil
}
...
func (r *jsiiProxy_ResourceSet) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (r *jsiiProxy_ResourceSet) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateResourceSet_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_ResourceSet) validateSetCountParameters(val interface{}) error {
	return nil
}
