...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/signon_policy_rule okta_signon_policy_rule}.
...
func (j *jsiiProxy_SignonPolicyRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/signon_policy_rule okta_signon_policy_rule} Resource.
func NewSignonPolicyRule(scope constructs.Construct, id *string, config *SignonPolicyRuleConfig) SignonPolicyRule {
	...
	_jsii_.Create(
		"@cdktf/provider-okta.signonPolicyRule.SignonPolicyRule",
...
func (j *jsiiProxy_SignonPolicyRule)SetCount(val interface{}) {
...
// Generates CDKTF code for importing a SignonPolicyRule resource upon running "cdktf plan <stack-name>".
func SignonPolicyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSignonPolicyRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func SignonPolicyRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSignonPolicyRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SignonPolicyRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSignonPolicyRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SignonPolicyRule) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SignonPolicyRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SignonPolicyRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SignonPolicyRule) MoveFromId(id *string) {
...
func (s *jsiiProxy_SignonPolicyRule) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SignonPolicyRule) MoveToId(id *string) {
...
func (s *jsiiProxy_SignonPolicyRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SignonPolicyRule) ToHclTerraform() interface{} {
	var returns interface{}
