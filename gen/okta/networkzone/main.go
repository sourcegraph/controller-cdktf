...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "asnsInput", GoGetter: "AsnsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dynamicLocationsInput", GoGetter: "DynamicLocationsInput"},
			_jsii_.MemberProperty{JsiiProperty: "dynamicProxyType", GoGetter: "DynamicProxyType"},
			_jsii_.MemberProperty{JsiiProperty: "dynamicProxyTypeInput", GoGetter: "DynamicProxyTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDynamicProxyType", GoMethod: "ResetDynamicProxyType"},
			_jsii_.MemberMethod{JsiiMethod: "resetGateways", GoMethod: "ResetGateways"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProxies", GoMethod: "ResetProxies"},
