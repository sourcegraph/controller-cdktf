...
type UserSchemaPropertyArrayOneOfOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for UserSchemaPropertyArrayOneOfOutputReference
type jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference struct {
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) Const() *string {
	var returns *string
	_jsii_.Get(
		j,
		"const",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) ConstInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"constInput",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
func NewUserSchemaPropertyArrayOneOfOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) UserSchemaPropertyArrayOneOfOutputReference {
	...
	if err := validateNewUserSchemaPropertyArrayOneOfOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) ComputeFqn() *string {
	var returns *string
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserSchemaPropertyArrayOneOfOutputReference) ToString() *string {
	var returns *string
