...
func PolicyRulePassword_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validatePolicyRulePassword_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PolicyRulePassword) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PolicyRulePassword) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PolicyRulePassword) MoveFromId(id *string) {
...
func (p *jsiiProxy_PolicyRulePassword) MoveToId(id *string) {
