...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "masterOverridePriorityInput", GoGetter: "MasterOverridePriorityInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMasterOverridePriority", GoMethod: "ResetMasterOverridePriority"},
