...
type GroupSchemaPropertyArrayOneOfList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) GroupSchemaPropertyArrayOneOfOutputReference
...
// The jsii proxy struct for GroupSchemaPropertyArrayOneOfList
type jsiiProxy_GroupSchemaPropertyArrayOneOfList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) InternalValue() interface{} {
...
func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_GroupSchemaPropertyArrayOneOfList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (g *jsiiProxy_GroupSchemaPropertyArrayOneOfList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GroupSchemaPropertyArrayOneOfList) ToString() *string {
	var returns *string
