...
func GroupSchemaProperty_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGroupSchemaProperty_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GroupSchemaProperty) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GroupSchemaProperty) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GroupSchemaProperty) MoveFromId(id *string) {
...
func (g *jsiiProxy_GroupSchemaProperty) MoveToId(id *string) {
