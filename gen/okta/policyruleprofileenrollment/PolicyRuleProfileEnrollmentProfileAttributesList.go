...
type PolicyRuleProfileEnrollmentProfileAttributesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) PolicyRuleProfileEnrollmentProfileAttributesOutputReference
...
// The jsii proxy struct for PolicyRuleProfileEnrollmentProfileAttributesList
type jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) InternalValue() interface{} {
...
func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (p *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PolicyRuleProfileEnrollmentProfileAttributesList) ToString() *string {
	var returns *string
