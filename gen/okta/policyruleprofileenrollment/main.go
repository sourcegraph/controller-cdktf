...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "emailVerification", GoGetter: "EmailVerification"},
			_jsii_.MemberProperty{JsiiProperty: "emailVerificationInput", GoGetter: "EmailVerificationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "profileAttributes", GoGetter: "ProfileAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "profileAttributesInput", GoGetter: "ProfileAttributesInput"},
			_jsii_.MemberProperty{JsiiProperty: "progressiveProfilingAction", GoGetter: "ProgressiveProfilingAction"},
			_jsii_.MemberProperty{JsiiProperty: "progressiveProfilingActionInput", GoGetter: "ProgressiveProfilingActionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProfileAttributes", GoMethod: "ResetProfileAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "resetProgressiveProfilingAction", GoMethod: "ResetProgressiveProfilingAction"},
			_jsii_.MemberMethod{JsiiMethod: "resetTargetGroupId", GoMethod: "ResetTargetGroupId"},
			_jsii_.MemberMethod{JsiiMethod: "resetUiSchemaId", GoMethod: "ResetUiSchemaId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "uiSchemaId", GoGetter: "UiSchemaId"},
