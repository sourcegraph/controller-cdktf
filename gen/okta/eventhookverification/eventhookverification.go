...
type EventHookVerification interface {
	...
	EventHookId() *string
	SetEventHookId(val *string)
	EventHookIdInput() *string
	// Experimental.
...
type jsiiProxy_EventHookVerification struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_EventHookVerification) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_EventHookVerification) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EventHookVerification) EventHookId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"eventHookId",
...
func (j *jsiiProxy_EventHookVerification) EventHookIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"eventHookIdInput",
...
func (j *jsiiProxy_EventHookVerification) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EventHookVerification) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EventHookVerification) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EventHookVerification) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EventHookVerification) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EventHookVerification) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventHookVerification) Node() constructs.Node {
...
func (j *jsiiProxy_EventHookVerification) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_EventHookVerification) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EventHookVerification) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewEventHookVerification(scope constructs.Construct, id *string, config *EventHookVerificationConfig) EventHookVerification {
	...
	if err := validateNewEventHookVerificationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventHookVerification{}
...
func EventHookVerification_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEventHookVerification_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventHookVerification) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EventHookVerification) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventHookVerification) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EventHookVerification) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EventHookVerification) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EventHookVerification) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EventHookVerification) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EventHookVerification) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EventHookVerification) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EventHookVerification) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EventHookVerification) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventHookVerification) MoveFromId(id *string) {
...
func (e *jsiiProxy_EventHookVerification) MoveToId(id *string) {
...
func (e *jsiiProxy_EventHookVerification) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_EventHookVerification) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EventHookVerification) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EventHookVerification) ToString() *string {
	var returns *string
