...
type ThreeFieldAppUsersOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for ThreeFieldAppUsersOutputReference
type jsiiProxy_ThreeFieldAppUsersOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) Password() *string {
	var returns *string
	_jsii_.Get(
		j,
		"password",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) PasswordInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"passwordInput",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) Username() *string {
	var returns *string
	_jsii_.Get(
		j,
		"username",
...
func (j *jsiiProxy_ThreeFieldAppUsersOutputReference) UsernameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usernameInput",
...
func NewThreeFieldAppUsersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ThreeFieldAppUsersOutputReference {
	...
	_jsii_.Create(
		"okta.threeFieldApp.ThreeFieldAppUsersOutputReference",
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) ResetPassword() {
	_jsii_.InvokeVoid(
		t,
		"resetPassword",
		nil, // no parameters
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) ResetUsername() {
	_jsii_.InvokeVoid(
		t,
		"resetUsername",
		nil, // no parameters
...
func (t *jsiiProxy_ThreeFieldAppUsersOutputReference) ToString() *string {
	var returns *string
