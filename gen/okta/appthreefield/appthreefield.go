...
func AppThreeField_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAppThreeField_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppThreeField) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppThreeField) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppThreeField) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppThreeField) MoveToId(id *string) {
