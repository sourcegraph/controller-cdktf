...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/social_idp okta_social_idp}.
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/social_idp okta_social_idp} Resource.
...
// Generates CDKTF code for importing a SocialIdp resource upon running "cdktf plan <stack-name>".
func SocialIdp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSocialIdp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SocialIdp) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SocialIdp) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SocialIdp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SocialIdp) MoveFromId(id *string) {
...
func (s *jsiiProxy_SocialIdp) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SocialIdp) MoveToId(id *string) {
...
func (s *jsiiProxy_SocialIdp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SocialIdp) ToHclTerraform() interface{} {
	var returns interface{}
