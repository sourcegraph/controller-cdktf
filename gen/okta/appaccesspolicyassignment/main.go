...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppAccessPolicyAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-okta.appAccessPolicyAssignment.AppAccessPolicyAssignmentConfig",
		reflect.TypeOf((*AppAccessPolicyAssignmentConfig)(nil)).Elem(),
	)
}
