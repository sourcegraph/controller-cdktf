...
type AppSamlAttributeStatementsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AppSamlAttributeStatementsOutputReference
...
// The jsii proxy struct for AppSamlAttributeStatementsList
type jsiiProxy_AppSamlAttributeStatementsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppSamlAttributeStatementsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppSamlAttributeStatementsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppSamlAttributeStatementsList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppSamlAttributeStatementsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppSamlAttributeStatementsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppSamlAttributeStatementsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AppSamlAttributeStatementsList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppSamlAttributeStatementsList) ToString() *string {
	var returns *string
