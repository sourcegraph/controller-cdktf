...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "expressionValueInput", GoGetter: "ExpressionValueInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "groupAssignmentsInput", GoGetter: "GroupAssignmentsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRemoveAssignedUsers", GoMethod: "ResetRemoveAssignedUsers"},
	...
	_jsii_.RegisterStruct(
		"okta.groupRule.GroupRuleConfig",
