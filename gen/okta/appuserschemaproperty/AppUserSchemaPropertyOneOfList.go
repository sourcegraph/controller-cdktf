...
type AppUserSchemaPropertyOneOfList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AppUserSchemaPropertyOneOfOutputReference
...
// The jsii proxy struct for AppUserSchemaPropertyOneOfList
type jsiiProxy_AppUserSchemaPropertyOneOfList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppUserSchemaPropertyOneOfList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AppUserSchemaPropertyOneOfList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppUserSchemaPropertyOneOfList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppUserSchemaPropertyOneOfList) ToString() *string {
	var returns *string
