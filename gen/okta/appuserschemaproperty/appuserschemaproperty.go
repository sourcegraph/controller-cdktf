...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/app_user_schema_property okta_app_user_schema_property}.
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/app_user_schema_property okta_app_user_schema_property} Resource.
...
func AppUserSchemaProperty_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppUserSchemaProperty_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppUserSchemaProperty) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppUserSchemaProperty) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppUserSchemaProperty) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppUserSchemaProperty) MoveToId(id *string) {
