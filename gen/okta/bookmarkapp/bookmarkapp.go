...
// Generates CDKTF code for importing a BookmarkApp resource upon running "cdktf plan <stack-name>".
func BookmarkApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBookmarkApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BookmarkApp) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BookmarkApp) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BookmarkApp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BookmarkApp) MoveFromId(id *string) {
...
func (b *jsiiProxy_BookmarkApp) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BookmarkApp) MoveToId(id *string) {
...
func (b *jsiiProxy_BookmarkApp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BookmarkApp) ToHclTerraform() interface{} {
	var returns interface{}
