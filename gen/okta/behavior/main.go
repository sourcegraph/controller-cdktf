...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "numberOfAuthentications", GoGetter: "NumberOfAuthentications"},
			_jsii_.MemberProperty{JsiiProperty: "numberOfAuthenticationsInput", GoGetter: "NumberOfAuthenticationsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRadiusFromLocation", GoMethod: "ResetRadiusFromLocation"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetVelocity", GoMethod: "ResetVelocity"},
