...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deleteWhenAbsent", GoGetter: "DeleteWhenAbsent"},
			_jsii_.MemberProperty{JsiiProperty: "deleteWhenAbsentInput", GoGetter: "DeleteWhenAbsentInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "pushStatus", GoGetter: "PushStatus"},
			_jsii_.MemberProperty{JsiiProperty: "pushStatusInput", GoGetter: "PushStatusInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPushStatus", GoMethod: "ResetPushStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
