...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "idOfGroupOwner", GoGetter: "IdOfGroupOwner"},
			_jsii_.MemberProperty{JsiiProperty: "idOfGroupOwnerInput", GoGetter: "IdOfGroupOwnerInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "originType", GoGetter: "OriginType"},
