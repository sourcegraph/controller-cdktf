...
type jsiiProxy_AdminRoleTargets struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AdminRoleTargets) Apps() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"apps",
...
func (j *jsiiProxy_AdminRoleTargets) AppsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"appsInput",
...
func (j *jsiiProxy_AdminRoleTargets) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AdminRoleTargets) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AdminRoleTargets) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AdminRoleTargets) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AdminRoleTargets) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AdminRoleTargets) Groups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groups",
...
func (j *jsiiProxy_AdminRoleTargets) GroupsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupsInput",
...
func (j *jsiiProxy_AdminRoleTargets) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AdminRoleTargets) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AdminRoleTargets) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AdminRoleTargets) Node() constructs.Node {
...
func (j *jsiiProxy_AdminRoleTargets) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AdminRoleTargets) RoleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleId",
...
func (j *jsiiProxy_AdminRoleTargets) RoleType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleType",
...
func (j *jsiiProxy_AdminRoleTargets) RoleTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleTypeInput",
...
func (j *jsiiProxy_AdminRoleTargets) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AdminRoleTargets) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AdminRoleTargets) UserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_AdminRoleTargets) UserIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userIdInput",
...
func NewAdminRoleTargets(scope constructs.Construct, id *string, config *AdminRoleTargetsConfig) AdminRoleTargets {
	...
	if err := validateNewAdminRoleTargetsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AdminRoleTargets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAdminRoleTargets_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AdminRoleTargets) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AdminRoleTargets) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AdminRoleTargets) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AdminRoleTargets) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AdminRoleTargets) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AdminRoleTargets) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AdminRoleTargets) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AdminRoleTargets) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AdminRoleTargets) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AdminRoleTargets) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AdminRoleTargets) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AdminRoleTargets) MoveFromId(id *string) {
...
func (a *jsiiProxy_AdminRoleTargets) MoveToId(id *string) {
...
func (a *jsiiProxy_AdminRoleTargets) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AdminRoleTargets) ResetApps() {
	_jsii_.InvokeVoid(
		a,
		"resetApps",
		nil, // no parameters
...
func (a *jsiiProxy_AdminRoleTargets) ResetGroups() {
	_jsii_.InvokeVoid(
		a,
		"resetGroups",
		nil, // no parameters
...
func (a *jsiiProxy_AdminRoleTargets) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AdminRoleTargets) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AdminRoleTargets) ToString() *string {
	var returns *string
