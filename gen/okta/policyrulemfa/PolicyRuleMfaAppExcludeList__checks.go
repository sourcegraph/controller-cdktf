...
func (p *jsiiProxy_PolicyRuleMfaAppExcludeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PolicyRuleMfaAppExcludeList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*PolicyRuleMfaAppExclude; received %#v (a %T)", val, val)
		}
	}
