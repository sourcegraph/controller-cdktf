...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/data-sources/idp_metadata_saml okta_idp_metadata_saml}.
...
func (j *jsiiProxy_DataOktaIdpMetadataSaml) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/data-sources/idp_metadata_saml okta_idp_metadata_saml} Data Source.
...
func (j *jsiiProxy_DataOktaIdpMetadataSaml)SetCount(val interface{}) {
...
func DataOktaIdpMetadataSaml_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaIdpMetadataSaml_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataOktaIdpMetadataSaml_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaIdpMetadataSaml_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataOktaIdpMetadataSaml_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataOktaIdpMetadataSaml_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataOktaIdpMetadataSaml) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataOktaIdpMetadataSaml) ToHclTerraform() interface{} {
	var returns interface{}
