...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hasSharedUsername", GoGetter: "HasSharedUsername"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-okta.appUser.AppUserConfig",
		reflect.TypeOf((*AppUserConfig)(nil)).Elem(),
	)
}
