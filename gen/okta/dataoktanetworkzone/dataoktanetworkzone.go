...
type jsiiProxy_DataOktaNetworkZone struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaNetworkZone) Asns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"asns",
...
func (j *jsiiProxy_DataOktaNetworkZone) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaNetworkZone) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaNetworkZone) DynamicLocations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dynamicLocations",
...
func (j *jsiiProxy_DataOktaNetworkZone) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaNetworkZone) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaNetworkZone) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaNetworkZone) Gateways() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"gateways",
...
func (j *jsiiProxy_DataOktaNetworkZone) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaNetworkZone) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOktaNetworkZone) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaNetworkZone) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataOktaNetworkZone) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataOktaNetworkZone) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaNetworkZone) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaNetworkZone) Proxies() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"proxies",
...
func (j *jsiiProxy_DataOktaNetworkZone) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaNetworkZone) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DataOktaNetworkZone) Usage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usage",
...
func NewDataOktaNetworkZone(scope constructs.Construct, id *string, config *DataOktaNetworkZoneConfig) DataOktaNetworkZone {
	...
	if err := validateNewDataOktaNetworkZoneParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaNetworkZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaNetworkZone_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOktaNetworkZone) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaNetworkZone) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaNetworkZone) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaNetworkZone) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaNetworkZone) ResetName() {
	_jsii_.InvokeVoid(
		d,
		"resetName",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaNetworkZone) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaNetworkZone) ToString() *string {
	var returns *string
