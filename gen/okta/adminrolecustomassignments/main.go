...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customRoleId", GoGetter: "CustomRoleId"},
			_jsii_.MemberProperty{JsiiProperty: "customRoleIdInput", GoGetter: "CustomRoleIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceSetId", GoGetter: "ResourceSetId"},
			_jsii_.MemberProperty{JsiiProperty: "resourceSetIdInput", GoGetter: "ResourceSetIdInput"},
