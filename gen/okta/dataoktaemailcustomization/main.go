...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customizationId", GoGetter: "CustomizationId"},
			_jsii_.MemberProperty{JsiiProperty: "customizationIdInput", GoGetter: "CustomizationIdInput"},
