package dataoktauserprofilemappingsource
...
type jsiiProxy_DataOktaUserProfileMappingSource struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaUserProfileMappingSource) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaUserProfileMappingSource) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func NewDataOktaUserProfileMappingSource(scope constructs.Construct, id *string, config *DataOktaUserProfileMappingSourceConfig) DataOktaUserProfileMappingSource {
	...
	if err := validateNewDataOktaUserProfileMappingSourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaUserProfileMappingSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataOktaUserProfileMappingSource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaUserProfileMappingSource) ToString() *string {
	var returns *string
