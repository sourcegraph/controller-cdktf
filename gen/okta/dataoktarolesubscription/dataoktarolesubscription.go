...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataOktaRoleSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"okta.dataOktaRoleSubscription.DataOktaRoleSubscriptionConfig",
		reflect.TypeOf((*DataOktaRoleSubscriptionConfig)(nil)).Elem(),
	)
}
