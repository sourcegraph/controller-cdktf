...
type jsiiProxy_DataOktaBrand struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOktaBrand) BrandId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"brandId",
...
func (j *jsiiProxy_DataOktaBrand) BrandIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"brandIdInput",
...
func (j *jsiiProxy_DataOktaBrand) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOktaBrand) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataOktaBrand) CustomPrivacyPolicyUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaBrand) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaBrand) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOktaBrand) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaBrand) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaBrand) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaBrand) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOktaBrand) Links() *string {
	var returns *string
	_jsii_.Get(
		j,
		"links",
...
func (j *jsiiProxy_DataOktaBrand) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOktaBrand) RemovePoweredByOkta() cdktf.IResolvable {
...
func (j *jsiiProxy_DataOktaBrand) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOktaBrand) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataOktaBrand(scope constructs.Construct, id *string, config *DataOktaBrandConfig) DataOktaBrand {
	...
	_jsii_.Create(
		"okta.dataOktaBrand.DataOktaBrand",
...
func (d *jsiiProxy_DataOktaBrand) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaBrand) ToString() *string {
	var returns *string
