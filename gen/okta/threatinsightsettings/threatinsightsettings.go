...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/okta/threatinsightsettings/internal"
)

// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/threat_insight_settings okta_threat_insight_settings}.
...
type jsiiProxy_ThreatInsightSettings struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ThreatInsightSettings) Action() *string {
	var returns *string
	_jsii_.Get(
		j,
		"action",
...
func (j *jsiiProxy_ThreatInsightSettings) ActionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"actionInput",
...
func (j *jsiiProxy_ThreatInsightSettings) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ThreatInsightSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ThreatInsightSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ThreatInsightSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ThreatInsightSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ThreatInsightSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ThreatInsightSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ThreatInsightSettings) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ThreatInsightSettings) NetworkExcludes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"networkExcludes",
...
func (j *jsiiProxy_ThreatInsightSettings) NetworkExcludesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ThreatInsightSettings) Node() constructs.Node {
...
func (j *jsiiProxy_ThreatInsightSettings) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ThreatInsightSettings) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ThreatInsightSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/threat_insight_settings okta_threat_insight_settings} Resource.
...
func ThreatInsightSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateThreatInsightSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_ThreatInsightSettings) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_ThreatInsightSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_ThreatInsightSettings) MoveFromId(id *string) {
...
func (t *jsiiProxy_ThreatInsightSettings) MoveToId(id *string) {
...
func (t *jsiiProxy_ThreatInsightSettings) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_ThreatInsightSettings) ResetNetworkExcludes() {
	_jsii_.InvokeVoid(
		t,
		"resetNetworkExcludes",
		nil, // no parameters
...
func (t *jsiiProxy_ThreatInsightSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_ThreatInsightSettings) ToString() *string {
	var returns *string
