...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "forceIsDefault", GoGetter: "ForceIsDefault"},
			_jsii_.MemberProperty{JsiiProperty: "forceIsDefaultInput", GoGetter: "ForceIsDefaultInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetForceIsDefault", GoMethod: "ResetForceIsDefault"},
