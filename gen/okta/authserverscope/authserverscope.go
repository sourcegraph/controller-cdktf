...
type AuthServerScope interface {
	...
	SetMetadataPublish(val *string)
	MetadataPublishInput() *string
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
...
type jsiiProxy_AuthServerScope struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AuthServerScope) AuthServerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authServerId",
...
func (j *jsiiProxy_AuthServerScope) AuthServerIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authServerIdInput",
...
func (j *jsiiProxy_AuthServerScope) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuthServerScope) Consent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"consent",
...
func (j *jsiiProxy_AuthServerScope) ConsentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"consentInput",
...
func (j *jsiiProxy_AuthServerScope) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuthServerScope) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AuthServerScope) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AuthServerScope) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_AuthServerScope) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_AuthServerScope) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuthServerScope) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuthServerScope) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuthServerScope) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuthServerScope) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AuthServerScope) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuthServerScope) MetadataPublish() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metadataPublish",
...
func (j *jsiiProxy_AuthServerScope) MetadataPublishInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metadataPublishInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_AuthServerScope) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AuthServerScope) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AuthServerScope) Node() constructs.Node {
...
func (j *jsiiProxy_AuthServerScope) SystemAttribute() cdktf.IResolvable {
...
func (j *jsiiProxy_AuthServerScope) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuthServerScope) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAuthServerScope(scope constructs.Construct, id *string, config *AuthServerScopeConfig) AuthServerScope {
	...
	if err := validateNewAuthServerScopeParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AuthServerScope_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuthServerScope_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuthServerScope) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuthServerScope) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuthServerScope) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuthServerScope) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuthServerScope) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuthServerScope) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuthServerScope) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuthServerScope) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuthServerScope) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuthServerScope) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuthServerScope) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuthServerScope) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuthServerScope) MoveToId(id *string) {
...
func (a *jsiiProxy_AuthServerScope) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuthServerScope) ResetConsent() {
	_jsii_.InvokeVoid(
		a,
		"resetConsent",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetDefault() {
	_jsii_.InvokeVoid(
		a,
		"resetDefault",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetDescription() {
	_jsii_.InvokeVoid(
		a,
		"resetDescription",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetDisplayName() {
	_jsii_.InvokeVoid(
		a,
		"resetDisplayName",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetMetadataPublish() {
	_jsii_.InvokeVoid(
		a,
		"resetMetadataPublish",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuthServerScope) ToString() *string {
	var returns *string
