...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/user_schema okta_user_schema}.
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/user_schema okta_user_schema} Resource.
...
// Experimental.
func UserSchema_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserSchema_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func UserSchema_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserSchema_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
