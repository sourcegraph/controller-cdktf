...
func Idp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIdp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_Idp) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_Idp) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_Idp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_Idp) MoveFromId(id *string) {
...
func (i *jsiiProxy_Idp) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_Idp) MoveToId(id *string) {
...
func (i *jsiiProxy_Idp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_Idp) ToHclTerraform() interface{} {
	var returns interface{}
