...
func (j *jsiiProxy_Group) validateSetCustomProfileAttributesParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Group) validateSetDescriptionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
