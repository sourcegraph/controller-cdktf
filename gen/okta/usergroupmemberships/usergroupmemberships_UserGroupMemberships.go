...
type jsiiProxy_UserGroupMemberships struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_UserGroupMemberships) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_UserGroupMemberships) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UserGroupMemberships) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserGroupMemberships) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_UserGroupMemberships) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserGroupMemberships) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserGroupMemberships) Groups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groups",
...
func (j *jsiiProxy_UserGroupMemberships) GroupsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupsInput",
...
func (j *jsiiProxy_UserGroupMemberships) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserGroupMemberships) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserGroupMemberships) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserGroupMemberships) Node() constructs.Node {
...
func (j *jsiiProxy_UserGroupMemberships) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_UserGroupMemberships) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserGroupMemberships) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserGroupMemberships) UserId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_UserGroupMemberships) UserIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userIdInput",
...
func NewUserGroupMemberships(scope constructs.Construct, id *string, config *UserGroupMembershipsConfig) UserGroupMemberships {
	...
	if err := validateNewUserGroupMembershipsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_UserGroupMemberships{}

	_jsii_.Create(
		"okta.userGroupMemberships.UserGroupMemberships",
...
func (j *jsiiProxy_UserGroupMemberships)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (u *jsiiProxy_UserGroupMemberships) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserGroupMemberships) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserGroupMemberships) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserGroupMemberships) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserGroupMemberships) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserGroupMemberships) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserGroupMemberships) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserGroupMemberships) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserGroupMemberships) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserGroupMemberships) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UserGroupMemberships) ResetId() {
	_jsii_.InvokeVoid(
		u,
		"resetId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGroupMemberships) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGroupMemberships) ToString() *string {
	var returns *string
