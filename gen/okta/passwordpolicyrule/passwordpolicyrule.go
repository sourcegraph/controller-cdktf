...
// Generates CDKTF code for importing a PasswordPolicyRule resource upon running "cdktf plan <stack-name>".
func PasswordPolicyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePasswordPolicyRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PasswordPolicyRule) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PasswordPolicyRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PasswordPolicyRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PasswordPolicyRule) MoveFromId(id *string) {
...
func (p *jsiiProxy_PasswordPolicyRule) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PasswordPolicyRule) MoveToId(id *string) {
...
func (p *jsiiProxy_PasswordPolicyRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PasswordPolicyRule) ToHclTerraform() interface{} {
	var returns interface{}
