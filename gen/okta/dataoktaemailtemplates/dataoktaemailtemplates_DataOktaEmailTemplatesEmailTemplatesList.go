...
type DataOktaEmailTemplatesEmailTemplatesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataOktaEmailTemplatesEmailTemplatesOutputReference
...
// The jsii proxy struct for DataOktaEmailTemplatesEmailTemplatesList
type jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataOktaEmailTemplatesEmailTemplatesList) ToString() *string {
	var returns *string
