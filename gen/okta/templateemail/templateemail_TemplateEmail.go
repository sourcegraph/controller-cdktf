...
// The jsii proxy struct for TemplateEmail
type jsiiProxy_TemplateEmail struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TemplateEmail) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TemplateEmail) Connection() interface{} {
...
func (j *jsiiProxy_TemplateEmail) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_TemplateEmail) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TemplateEmail) DefaultLanguage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultLanguage",
...
func (j *jsiiProxy_TemplateEmail) DefaultLanguageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TemplateEmail) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TemplateEmail) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TemplateEmail) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TemplateEmail) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TemplateEmail) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TemplateEmail) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TemplateEmail) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TemplateEmail) Node() constructs.Node {
...
func (j *jsiiProxy_TemplateEmail) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TemplateEmail) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_TemplateEmail) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_TemplateEmail) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TemplateEmail) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TemplateEmail) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TemplateEmail) Translations() TemplateEmailTranslationsList {
	var returns TemplateEmailTranslationsList
	_jsii_.Get(
		j,
		"translations",
		&returns,
...
func (j *jsiiProxy_TemplateEmail) TranslationsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"translationsInput",
...
func (j *jsiiProxy_TemplateEmail) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_TemplateEmail) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (t *jsiiProxy_TemplateEmail) ResetDefaultLanguage() {
	_jsii_.InvokeVoid(
		t,
		"resetDefaultLanguage",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateEmail) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateEmail) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TemplateEmail) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TemplateEmail) ToMetadata() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TemplateEmail) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TemplateEmail) ToTerraform() interface{} {
	var returns interface{}
