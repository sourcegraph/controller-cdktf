...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clientWhitelist", GoGetter: "ClientWhitelist"},
			_jsii_.MemberProperty{JsiiProperty: "clientWhitelistInput", GoGetter: "ClientWhitelistInput"},
