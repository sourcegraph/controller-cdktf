...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "trustAudience", GoGetter: "TrustAudience"},
			_jsii_.MemberProperty{JsiiProperty: "trustIssuer", GoGetter: "TrustIssuer"},
			_jsii_.MemberProperty{JsiiProperty: "trustKid", GoGetter: "TrustKid"},
			_jsii_.MemberProperty{JsiiProperty: "trustRevocation", GoGetter: "TrustRevocation"},
			_jsii_.MemberProperty{JsiiProperty: "trustRevocationCacheLifetime", GoGetter: "TrustRevocationCacheLifetime"},
