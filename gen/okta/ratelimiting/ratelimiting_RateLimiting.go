...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/okta/ratelimiting/internal"
)
...
type jsiiProxy_RateLimiting struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_RateLimiting) Authorize() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorize",
...
func (j *jsiiProxy_RateLimiting) AuthorizeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizeInput",
...
func (j *jsiiProxy_RateLimiting) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RateLimiting) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_RateLimiting) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RateLimiting) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RateLimiting) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RateLimiting) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RateLimiting) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RateLimiting) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RateLimiting) Login() *string {
	var returns *string
	_jsii_.Get(
		j,
		"login",
...
func (j *jsiiProxy_RateLimiting) LoginInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"loginInput",
...
func (j *jsiiProxy_RateLimiting) Node() constructs.Node {
...
func (j *jsiiProxy_RateLimiting) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_RateLimiting) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RateLimiting) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewRateLimiting(scope constructs.Construct, id *string, config *RateLimitingConfig) RateLimiting {
	...
	if err := validateNewRateLimitingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RateLimiting) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RateLimiting) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RateLimiting) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RateLimiting) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RateLimiting) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RateLimiting) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RateLimiting) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RateLimiting) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RateLimiting) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RateLimiting) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RateLimiting) ResetCommunicationsEnabled() {
	_jsii_.InvokeVoid(
		r,
		"resetCommunicationsEnabled",
		nil, // no parameters
...
func (r *jsiiProxy_RateLimiting) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RateLimiting) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_RateLimiting) ToString() *string {
	var returns *string
