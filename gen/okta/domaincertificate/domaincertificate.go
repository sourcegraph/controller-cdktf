...
func DomainCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDomainCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DomainCertificate) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DomainCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DomainCertificate) MoveFromId(id *string) {
...
func (d *jsiiProxy_DomainCertificate) MoveToId(id *string) {
