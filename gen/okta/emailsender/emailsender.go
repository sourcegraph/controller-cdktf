...
type EmailSender interface {
	...
	DnsRecords() EmailSenderDnsRecordsList
	// Experimental.
...
type jsiiProxy_EmailSender struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_EmailSender) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_EmailSender) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EmailSender) DnsRecords() EmailSenderDnsRecordsList {
	var returns EmailSenderDnsRecordsList
	_jsii_.Get(
		j,
		"dnsRecords",
		&returns,
...
func (j *jsiiProxy_EmailSender) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmailSender) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailSender) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EmailSender) FromAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fromAddress",
...
func (j *jsiiProxy_EmailSender) FromAddressInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fromAddressInput",
...
func (j *jsiiProxy_EmailSender) FromName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fromName",
...
func (j *jsiiProxy_EmailSender) FromNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fromNameInput",
...
func (j *jsiiProxy_EmailSender) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EmailSender) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EmailSender) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EmailSender) Node() constructs.Node {
...
func (j *jsiiProxy_EmailSender) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_EmailSender) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_EmailSender) Subdomain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subdomain",
...
func (j *jsiiProxy_EmailSender) SubdomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subdomainInput",
...
func (j *jsiiProxy_EmailSender) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EmailSender) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewEmailSender(scope constructs.Construct, id *string, config *EmailSenderConfig) EmailSender {
	...
	if err := validateNewEmailSenderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EmailSender_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmailSender_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmailSender) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailSender) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EmailSender) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EmailSender) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EmailSender) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EmailSender) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EmailSender) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EmailSender) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EmailSender) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EmailSender) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmailSender) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EmailSender) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmailSender) MoveToId(id *string) {
...
func (e *jsiiProxy_EmailSender) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_EmailSender) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailSender) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailSender) ToString() *string {
	var returns *string
