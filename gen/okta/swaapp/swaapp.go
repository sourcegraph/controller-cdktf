...
// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/swa_app okta_swa_app}.
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/swa_app okta_swa_app} Resource.
...
// Generates CDKTF code for importing a SwaApp resource upon running "cdktf plan <stack-name>".
func SwaApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSwaApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func SwaApp_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSwaApp_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SwaApp_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSwaApp_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SwaApp) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SwaApp) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SwaApp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SwaApp) MoveFromId(id *string) {
...
func (s *jsiiProxy_SwaApp) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SwaApp) MoveToId(id *string) {
...
func (s *jsiiProxy_SwaApp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SwaApp) ToHclTerraform() interface{} {
	var returns interface{}
