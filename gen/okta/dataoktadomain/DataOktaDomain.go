...
type DataOktaDomain interface {
	...
	DnsRecords() DataOktaDomainDnsRecordsList
	Domain() *string
...
func (j *jsiiProxy_DataOktaDomain) CertificateSourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOktaDomain) DnsRecords() DataOktaDomainDnsRecordsList {
	var returns DataOktaDomainDnsRecordsList
	_jsii_.Get(
		j,
		"dnsRecords",
		&returns,
...
func (j *jsiiProxy_DataOktaDomain) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_DataOktaDomain) DomainIdOrName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdOrName",
...
func (j *jsiiProxy_DataOktaDomain) DomainIdOrNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdOrNameInput",
...
func (j *jsiiProxy_DataOktaDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOktaDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOktaDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOktaDomain) Node() constructs.Node {
...
func (j *jsiiProxy_DataOktaDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataOktaDomain) ValidationStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"validationStatus",
...
func NewDataOktaDomain(scope constructs.Construct, id *string, config *DataOktaDomainConfig) DataOktaDomain {
	...
	if err := validateNewDataOktaDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOktaDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-okta.dataOktaDomain.DataOktaDomain",
...
func (d *jsiiProxy_DataOktaDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOktaDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOktaDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOktaDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOktaDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOktaDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOktaDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOktaDomain) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOktaDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOktaDomain) ToString() *string {
	var returns *string
