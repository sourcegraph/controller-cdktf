...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "domainIdOrName", GoGetter: "DomainIdOrName"},
			_jsii_.MemberProperty{JsiiProperty: "domainIdOrNameInput", GoGetter: "DomainIdOrNameInput"},
