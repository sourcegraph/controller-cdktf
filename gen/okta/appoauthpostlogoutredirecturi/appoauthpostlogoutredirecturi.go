...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/okta/appoauthpostlogoutredirecturi/internal"
)

// Represents a {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/app_oauth_post_logout_redirect_uri okta_app_oauth_post_logout_redirect_uri}.
...
// Create a new {@link https://registry.terraform.io/providers/okta/okta/3.41.0/docs/resources/app_oauth_post_logout_redirect_uri okta_app_oauth_post_logout_redirect_uri} Resource.
func NewAppOauthPostLogoutRedirectUri(scope constructs.Construct, id *string, config *AppOauthPostLogoutRedirectUriConfig) AppOauthPostLogoutRedirectUri {
	...
	if err := validateNewAppOauthPostLogoutRedirectUriParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppOauthPostLogoutRedirectUri_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppOauthPostLogoutRedirectUri_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AppOauthPostLogoutRedirectUri_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppOauthPostLogoutRedirectUri_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppOauthPostLogoutRedirectUri_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppOauthPostLogoutRedirectUri_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppOauthPostLogoutRedirectUri_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppOauthPostLogoutRedirectUri_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) MoveToId(id *string) {
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppOauthPostLogoutRedirectUri) ToHclTerraform() interface{} {
	var returns interface{}
