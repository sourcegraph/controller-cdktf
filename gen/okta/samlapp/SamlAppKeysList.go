...
type SamlAppKeysList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) SamlAppKeysOutputReference
...
// The jsii proxy struct for SamlAppKeysList
type jsiiProxy_SamlAppKeysList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_SamlAppKeysList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SamlAppKeysList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SamlAppKeysList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SamlAppKeysList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SamlAppKeysList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_SamlAppKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SamlAppKeysList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SamlAppKeysList) ToString() *string {
	var returns *string
