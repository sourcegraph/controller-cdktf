...
func (j *jsiiProxy_SamlApp) SamlSignedRequestEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SamlApp) SamlSignedRequestEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SamlApp)SetSamlSignedRequestEnabled(val interface{}) {
...
func (s *jsiiProxy_SamlApp) ResetSamlSignedRequestEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetSamlSignedRequestEnabled",
		nil, // no parameters
