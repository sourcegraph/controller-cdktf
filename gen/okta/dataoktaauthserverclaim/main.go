...
func init() {
	_jsii_.RegisterClass(
		"okta.dataOktaAuthServerClaim.DataOktaAuthServerClaim",
		reflect.TypeOf((*DataOktaAuthServerClaim)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"okta.dataOktaAuthServerClaim.DataOktaAuthServerClaimConfig",
		reflect.TypeOf((*DataOktaAuthServerClaimConfig)(nil)).Elem(),
	)
}
