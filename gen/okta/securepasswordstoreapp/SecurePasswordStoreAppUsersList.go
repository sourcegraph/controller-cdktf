...
type SecurePasswordStoreAppUsersList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) SecurePasswordStoreAppUsersOutputReference
...
// The jsii proxy struct for SecurePasswordStoreAppUsersList
type jsiiProxy_SecurePasswordStoreAppUsersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_SecurePasswordStoreAppUsersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurePasswordStoreAppUsersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurePasswordStoreAppUsersList) InternalValue() interface{} {
...
func (j *jsiiProxy_SecurePasswordStoreAppUsersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecurePasswordStoreAppUsersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SecurePasswordStoreAppUsersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_SecurePasswordStoreAppUsersList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurePasswordStoreAppUsersList) ToString() *string {
	var returns *string
