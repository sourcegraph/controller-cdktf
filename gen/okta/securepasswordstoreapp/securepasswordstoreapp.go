...
// Generates CDKTF code for importing a SecurePasswordStoreApp resource upon running "cdktf plan <stack-name>".
func SecurePasswordStoreApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurePasswordStoreApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurePasswordStoreApp) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurePasswordStoreApp) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurePasswordStoreApp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurePasswordStoreApp) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurePasswordStoreApp) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurePasswordStoreApp) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurePasswordStoreApp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurePasswordStoreApp) ToHclTerraform() interface{} {
	var returns interface{}
