...
func MfaPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMfaPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MfaPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MfaPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MfaPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MfaPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MfaPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MfaPolicy) MoveToId(id *string) {
...
func (m *jsiiProxy_MfaPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MfaPolicy) ToHclTerraform() interface{} {
	var returns interface{}
