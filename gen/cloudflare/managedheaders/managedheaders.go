...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/managed_headers cloudflare_managed_headers}.
...
type jsiiProxy_ManagedHeaders struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ManagedHeaders) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ManagedHeaders) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ManagedHeaders) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ManagedHeaders) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedHeaders) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ManagedHeaders) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ManagedHeaders) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ManagedHeaders) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagedHeaders) ManagedRequestHeaders() ManagedHeadersManagedRequestHeadersList {
	var returns ManagedHeadersManagedRequestHeadersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedHeaders) ManagedResponseHeaders() ManagedHeadersManagedResponseHeadersList {
	var returns ManagedHeadersManagedResponseHeadersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedHeaders) Node() constructs.Node {
...
func (j *jsiiProxy_ManagedHeaders) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ManagedHeaders) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ManagedHeaders) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedHeaders) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ManagedHeaders) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func ManagedHeaders_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateManagedHeaders_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_ManagedHeaders) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_ManagedHeaders) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedHeaders) ResetManagedRequestHeaders() {
	_jsii_.InvokeVoid(
		m,
		"resetManagedRequestHeaders",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedHeaders) ResetManagedResponseHeaders() {
	_jsii_.InvokeVoid(
		m,
		"resetManagedResponseHeaders",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedHeaders) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedHeaders) ToString() *string {
	var returns *string
