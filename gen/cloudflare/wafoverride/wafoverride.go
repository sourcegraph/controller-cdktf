...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WafOverride)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "overrideId", GoGetter: "OverrideId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRewriteAction", GoMethod: "ResetRewriteAction"},
			_jsii_.MemberMethod{JsiiMethod: "resetRules", GoMethod: "ResetRules"},
			_jsii_.MemberProperty{JsiiProperty: "rewriteAction", GoGetter: "RewriteAction"},
			_jsii_.MemberProperty{JsiiProperty: "rewriteActionInput", GoGetter: "RewriteActionInput"},
	...
	_jsii_.RegisterStruct(
		"cloudflare.wafOverride.WafOverrideConfig",
		reflect.TypeOf((*WafOverrideConfig)(nil)).Elem(),
	)
}
