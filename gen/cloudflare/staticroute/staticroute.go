...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/staticroute/internal"
)
...
type jsiiProxy_StaticRoute struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_StaticRoute) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_StaticRoute) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_StaticRoute) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_StaticRoute) ColoNames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"coloNames",
...
func (j *jsiiProxy_StaticRoute) ColoNamesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"coloNamesInput",
...
func (j *jsiiProxy_StaticRoute) ColoRegions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"coloRegions",
...
func (j *jsiiProxy_StaticRoute) ColoRegionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"coloRegionsInput",
...
func (j *jsiiProxy_StaticRoute) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_StaticRoute) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_StaticRoute) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_StaticRoute) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_StaticRoute) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StaticRoute) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_StaticRoute) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_StaticRoute) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_StaticRoute) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StaticRoute) Nexthop() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nexthop",
...
func (j *jsiiProxy_StaticRoute) NexthopInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nexthopInput",
...
func (j *jsiiProxy_StaticRoute) Node() constructs.Node {
...
func (j *jsiiProxy_StaticRoute) Prefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefix",
...
func (j *jsiiProxy_StaticRoute) PrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefixInput",
...
func (j *jsiiProxy_StaticRoute) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_StaticRoute) PriorityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priorityInput",
...
func (j *jsiiProxy_StaticRoute) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_StaticRoute) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_StaticRoute) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StaticRoute) Weight() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"weight",
...
func (j *jsiiProxy_StaticRoute) WeightInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"weightInput",
...
func NewStaticRoute(scope constructs.Construct, id *string, config *StaticRouteConfig) StaticRoute {
	...
	if err := validateNewStaticRouteParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StaticRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStaticRoute_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StaticRoute) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StaticRoute) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StaticRoute) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StaticRoute) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StaticRoute) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StaticRoute) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StaticRoute) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StaticRoute) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StaticRoute) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StaticRoute) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StaticRoute) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_StaticRoute) ResetAccountId() {
	_jsii_.InvokeVoid(
		s,
		"resetAccountId",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetColoNames() {
	_jsii_.InvokeVoid(
		s,
		"resetColoNames",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetColoRegions() {
	_jsii_.InvokeVoid(
		s,
		"resetColoRegions",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ResetWeight() {
	_jsii_.InvokeVoid(
		s,
		"resetWeight",
		nil, // no parameters
...
func (s *jsiiProxy_StaticRoute) ToString() *string {
	var returns *string
