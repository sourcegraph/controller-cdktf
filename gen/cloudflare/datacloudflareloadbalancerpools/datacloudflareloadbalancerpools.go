...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/data-sources/load_balancer_pools cloudflare_load_balancer_pools}.
...
type jsiiProxy_DataCloudflareLoadBalancerPools struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataCloudflareLoadBalancerPools) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareLoadBalancerPools(scope constructs.Construct, id *string, config *DataCloudflareLoadBalancerPoolsConfig) DataCloudflareLoadBalancerPools {
	...
	if err := validateNewDataCloudflareLoadBalancerPoolsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareLoadBalancerPools_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareLoadBalancerPools_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataCloudflareLoadBalancerPools_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.dataCloudflareLoadBalancerPools.DataCloudflareLoadBalancerPools",
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPools) ToString() *string {
	var returns *string
