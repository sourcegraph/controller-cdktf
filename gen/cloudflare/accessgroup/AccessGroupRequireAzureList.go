...
type AccessGroupRequireAzureList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AccessGroupRequireAzureOutputReference
...
// The jsii proxy struct for AccessGroupRequireAzureList
type jsiiProxy_AccessGroupRequireAzureList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AccessGroupRequireAzureList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AccessGroupRequireAzureList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessGroupRequireAzureList) InternalValue() interface{} {
...
func (j *jsiiProxy_AccessGroupRequireAzureList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AccessGroupRequireAzureList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AccessGroupRequireAzureList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AccessGroupRequireAzureList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessGroupRequireAzureList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AccessGroupRequireAzureList) ToString() *string {
	var returns *string
