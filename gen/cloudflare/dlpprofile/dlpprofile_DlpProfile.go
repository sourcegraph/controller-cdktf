...
type jsiiProxy_DlpProfile struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DlpProfile) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_DlpProfile) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DlpProfile) AllowedMatchCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"allowedMatchCount",
...
func (j *jsiiProxy_DlpProfile) AllowedMatchCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DlpProfile) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DlpProfile) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DlpProfile) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DlpProfile) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DlpProfile) Entry() DlpProfileEntryList {
	var returns DlpProfileEntryList
	_jsii_.Get(
		j,
		"entry",
		&returns,
...
func (j *jsiiProxy_DlpProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DlpProfile) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DlpProfile) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DlpProfile) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DlpProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DlpProfile) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DlpProfile) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DlpProfile) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DlpProfile) Node() constructs.Node {
...
func (j *jsiiProxy_DlpProfile) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DlpProfile) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DlpProfile) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DlpProfile) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewDlpProfile(scope constructs.Construct, id *string, config *DlpProfileConfig) DlpProfile {
	...
	if err := validateNewDlpProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DlpProfile_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.dlpProfile.DlpProfile",
...
func (d *jsiiProxy_DlpProfile) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DlpProfile) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DlpProfile) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DlpProfile) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DlpProfile) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DlpProfile) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DlpProfile) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DlpProfile) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DlpProfile) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DlpProfile) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DlpProfile) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
...
func (d *jsiiProxy_DlpProfile) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DlpProfile) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DlpProfile) ToString() *string {
	var returns *string
