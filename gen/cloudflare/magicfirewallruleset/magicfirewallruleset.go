...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/magicfirewallruleset/internal"
)
...
type jsiiProxy_MagicFirewallRuleset struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_MagicFirewallRuleset) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_MagicFirewallRuleset) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_MagicFirewallRuleset) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_MagicFirewallRuleset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MagicFirewallRuleset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_MagicFirewallRuleset) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_MagicFirewallRuleset) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MagicFirewallRuleset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MagicFirewallRuleset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MagicFirewallRuleset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MagicFirewallRuleset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MagicFirewallRuleset) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MagicFirewallRuleset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_MagicFirewallRuleset) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_MagicFirewallRuleset) Node() constructs.Node {
...
func (j *jsiiProxy_MagicFirewallRuleset) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_MagicFirewallRuleset) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MagicFirewallRuleset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewMagicFirewallRuleset(scope constructs.Construct, id *string, config *MagicFirewallRulesetConfig) MagicFirewallRuleset {
	...
	if err := validateNewMagicFirewallRulesetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MagicFirewallRuleset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMagicFirewallRuleset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MagicFirewallRuleset) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetStringAttribute(terraformAttribute *string) *string {
...
func (m *jsiiProxy_MagicFirewallRuleset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (m *jsiiProxy_MagicFirewallRuleset) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MagicFirewallRuleset) OverrideLogicalId(newLogicalId *string) {
...
func (m *jsiiProxy_MagicFirewallRuleset) ResetDescription() {
	_jsii_.InvokeVoid(
		m,
		"resetDescription",
		nil, // no parameters
...
func (m *jsiiProxy_MagicFirewallRuleset) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MagicFirewallRuleset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MagicFirewallRuleset) ResetRules() {
	_jsii_.InvokeVoid(
		m,
		"resetRules",
		nil, // no parameters
...
func (m *jsiiProxy_MagicFirewallRuleset) ToString() *string {
	var returns *string
