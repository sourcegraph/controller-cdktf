...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/mtlscertificate/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/cloudflare/r/mtls_certificate cloudflare_mtls_certificate}.
...
func (j *jsiiProxy_MtlsCertificate) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_MtlsCertificate) Certificates() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificates",
...
func (j *jsiiProxy_MtlsCertificate) CertificatesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificatesInput",
...
func (j *jsiiProxy_MtlsCertificate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MtlsCertificate) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MtlsCertificate) ExpiresOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiresOn",
...
func (j *jsiiProxy_MtlsCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MtlsCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MtlsCertificate) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MtlsCertificate) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_MtlsCertificate) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_MtlsCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_MtlsCertificate) PrivateKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"privateKey",
...
func (j *jsiiProxy_MtlsCertificate) PrivateKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"privateKeyInput",
...
func (j *jsiiProxy_MtlsCertificate) SerialNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serialNumber",
...
func (j *jsiiProxy_MtlsCertificate) Signature() *string {
	var returns *string
	_jsii_.Get(
		j,
		"signature",
...
func (j *jsiiProxy_MtlsCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/mtls_certificate cloudflare_mtls_certificate} Resource.
func NewMtlsCertificate(scope constructs.Construct, id *string, config *MtlsCertificateConfig) MtlsCertificate {
	_init_.Initialize()

	if err := validateNewMtlsCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MtlsCertificate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func MtlsCertificate_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.mtlsCertificate.MtlsCertificate",
...
func (m *jsiiProxy_MtlsCertificate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (m *jsiiProxy_MtlsCertificate) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (m *jsiiProxy_MtlsCertificate) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (m *jsiiProxy_MtlsCertificate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (m *jsiiProxy_MtlsCertificate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (m *jsiiProxy_MtlsCertificate) GetStringAttribute(terraformAttribute *string) *string {
...
func (m *jsiiProxy_MtlsCertificate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (m *jsiiProxy_MtlsCertificate) OverrideLogicalId(newLogicalId *string) {
...
func (m *jsiiProxy_MtlsCertificate) ResetName() {
	_jsii_.InvokeVoid(
		m,
		"resetName",
		nil, // no parameters
...
func (m *jsiiProxy_MtlsCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MtlsCertificate) ResetPrivateKey() {
	_jsii_.InvokeVoid(
		m,
		"resetPrivateKey",
		nil, // no parameters
...
func (m *jsiiProxy_MtlsCertificate) ToString() *string {
	var returns *string
