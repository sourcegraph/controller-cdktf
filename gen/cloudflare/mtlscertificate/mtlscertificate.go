...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/mtls_certificate cloudflare_mtls_certificate}.
...
func (m *jsiiProxy_MtlsCertificate) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MtlsCertificate) MoveFromId(id *string) {
...
func (m *jsiiProxy_MtlsCertificate) MoveToId(id *string) {
