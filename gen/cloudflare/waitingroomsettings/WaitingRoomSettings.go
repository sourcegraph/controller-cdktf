...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/waitingroomsettings/internal"
)
...
type jsiiProxy_WaitingRoomSettings struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_WaitingRoomSettings) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_WaitingRoomSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_WaitingRoomSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WaitingRoomSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WaitingRoomSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WaitingRoomSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WaitingRoomSettings) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WaitingRoomSettings) Node() constructs.Node {
...
func (j *jsiiProxy_WaitingRoomSettings) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WaitingRoomSettings) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WaitingRoomSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WaitingRoomSettings) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_WaitingRoomSettings) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/waiting_room_settings cloudflare_waiting_room_settings} Resource.
func NewWaitingRoomSettings(scope constructs.Construct, id *string, config *WaitingRoomSettingsConfig) WaitingRoomSettings {
	_init_.Initialize()

	if err := validateNewWaitingRoomSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_WaitingRoomSettings{}
...
func WaitingRoomSettings_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.waitingRoomSettings.WaitingRoomSettings",
...
func (w *jsiiProxy_WaitingRoomSettings) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WaitingRoomSettings) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_WaitingRoomSettings) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_WaitingRoomSettings) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_WaitingRoomSettings) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_WaitingRoomSettings) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_WaitingRoomSettings) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_WaitingRoomSettings) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_WaitingRoomSettings) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WaitingRoomSettings) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_WaitingRoomSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WaitingRoomSettings) ResetSearchEngineCrawlerBypass() {
	_jsii_.InvokeVoid(
		w,
		"resetSearchEngineCrawlerBypass",
		nil, // no parameters
...
func (w *jsiiProxy_WaitingRoomSettings) ToString() *string {
	var returns *string
