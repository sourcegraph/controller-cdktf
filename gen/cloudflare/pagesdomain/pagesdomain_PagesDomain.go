...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/pagesdomain/internal"
)
...
func (j *jsiiProxy_PagesDomain) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_PagesDomain) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PagesDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_PagesDomain) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_PagesDomain) DomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainInput",
...
func (j *jsiiProxy_PagesDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PagesDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_PagesDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PagesDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PagesDomain) Node() constructs.Node {
...
func (j *jsiiProxy_PagesDomain) ProjectName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectName",
...
func (j *jsiiProxy_PagesDomain) ProjectNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNameInput",
...
func (j *jsiiProxy_PagesDomain) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_PagesDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/pages_domain cloudflare_pages_domain} Resource.
func NewPagesDomain(scope constructs.Construct, id *string, config *PagesDomainConfig) PagesDomain {
	_init_.Initialize()

	if err := validateNewPagesDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PagesDomain)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func PagesDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.pagesDomain.PagesDomain",
...
func (p *jsiiProxy_PagesDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PagesDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PagesDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PagesDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PagesDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PagesDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PagesDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PagesDomain) OverrideLogicalId(newLogicalId *string) {
...
func (p *jsiiProxy_PagesDomain) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PagesDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		p,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (p *jsiiProxy_PagesDomain) ToString() *string {
	var returns *string
