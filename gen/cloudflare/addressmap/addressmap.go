...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultSni", GoGetter: "DefaultSni"},
			_jsii_.MemberProperty{JsiiProperty: "defaultSniInput", GoGetter: "DefaultSniInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMemberships", GoMethod: "ResetMemberships"},
