...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/address_map cloudflare_address_map}.
...
type jsiiProxy_AddressMap struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AddressMap) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AddressMap) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AddressMap) CanDelete() cdktf.IResolvable {
...
func (j *jsiiProxy_AddressMap) CanModifyIps() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"canModifyIps",
...
func (j *jsiiProxy_AddressMap) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AddressMap) DefaultSni() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultSni",
...
func (j *jsiiProxy_AddressMap) DefaultSniInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultSniInput",
...
func (j *jsiiProxy_AddressMap) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AddressMap) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AddressMap) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AddressMap) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AddressMap) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AddressMap) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AddressMap) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AddressMap) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AddressMap) Memberships() AddressMapMembershipsList {
	var returns AddressMapMembershipsList
	_jsii_.Get(
		j,
		"memberships",
		&returns,
...
func (j *jsiiProxy_AddressMap) Node() constructs.Node {
...
func (j *jsiiProxy_AddressMap) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AddressMap) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AddressMap) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAddressMap(scope constructs.Construct, id *string, config *AddressMapConfig) AddressMap {
	...
	if err := validateNewAddressMapParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AddressMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAddressMap_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AddressMap_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.addressMap.AddressMap",
...
func (a *jsiiProxy_AddressMap) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AddressMap) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AddressMap) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AddressMap) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AddressMap) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AddressMap) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AddressMap) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AddressMap) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AddressMap) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AddressMap) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AddressMap) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AddressMap) MoveFromId(id *string) {
...
func (a *jsiiProxy_AddressMap) MoveToId(id *string) {
...
func (a *jsiiProxy_AddressMap) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AddressMap) ResetDefaultSni() {
	_jsii_.InvokeVoid(
		a,
		"resetDefaultSni",
		nil, // no parameters
...
func (a *jsiiProxy_AddressMap) ResetDescription() {
	_jsii_.InvokeVoid(
		a,
		"resetDescription",
		nil, // no parameters
...
func (a *jsiiProxy_AddressMap) ResetIps() {
	_jsii_.InvokeVoid(
		a,
		"resetIps",
		nil, // no parameters
...
func (a *jsiiProxy_AddressMap) ResetMemberships() {
	_jsii_.InvokeVoid(
		a,
		"resetMemberships",
		nil, // no parameters
...
func (a *jsiiProxy_AddressMap) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AddressMap) ToString() *string {
	var returns *string
