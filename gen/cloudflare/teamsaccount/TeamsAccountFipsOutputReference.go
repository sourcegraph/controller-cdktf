...
func (j *jsiiProxy_TeamsAccountFipsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TeamsAccountFipsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_TeamsAccountFipsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TeamsAccountFipsOutputReference) InternalValue() *TeamsAccountFips {
...
func (j *jsiiProxy_TeamsAccountFipsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) ResetTls() {
	_jsii_.InvokeVoid(
		t,
		"resetTls",
		nil, // no parameters
...
func (t *jsiiProxy_TeamsAccountFipsOutputReference) ToString() *string {
	var returns *string
