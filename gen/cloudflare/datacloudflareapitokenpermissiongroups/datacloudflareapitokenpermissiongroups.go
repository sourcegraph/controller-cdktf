...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/datacloudflareapitokenpermissiongroups/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/data-sources/api_token_permission_groups cloudflare_api_token_permission_groups}.
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) Permissions() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"permissions",
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareApiTokenPermissionGroups) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareApiTokenPermissionGroups(scope constructs.Construct, id *string, config *DataCloudflareApiTokenPermissionGroupsConfig) DataCloudflareApiTokenPermissionGroups {
	...
	if err := validateNewDataCloudflareApiTokenPermissionGroupsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareApiTokenPermissionGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareApiTokenPermissionGroups_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareApiTokenPermissionGroups) ToString() *string {
	var returns *string
