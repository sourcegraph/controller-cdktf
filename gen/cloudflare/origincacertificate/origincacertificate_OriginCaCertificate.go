...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/origincacertificate/internal"
)
...
func (j *jsiiProxy_OriginCaCertificate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OriginCaCertificate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
