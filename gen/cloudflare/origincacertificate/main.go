...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "minDaysForRenewal", GoGetter: "MinDaysForRenewal"},
			_jsii_.MemberProperty{JsiiProperty: "minDaysForRenewalInput", GoGetter: "MinDaysForRenewalInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRequestedValidity", GoMethod: "ResetRequestedValidity"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.originCaCertificate.OriginCaCertificateConfig",
		reflect.TypeOf((*OriginCaCertificateConfig)(nil)).Elem(),
	)
}
