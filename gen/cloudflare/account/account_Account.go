...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/account/internal"
)
...
func (j *jsiiProxy_Account) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/account cloudflare_account} Resource.
...
func (j *jsiiProxy_Account)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
