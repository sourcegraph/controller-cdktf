...
// Represents a {@link https://www.terraform.io/docs/providers/cloudflare/r/list_item cloudflare_list_item}.
...
type jsiiProxy_ListItemA struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ListItemA) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_ListItemA) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ListItemA) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ListItemA) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_ListItemA) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_ListItemA) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ListItemA) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ListItemA) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ListItemA) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ListItemA) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ListItemA) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ListItemA) Ip() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ip",
...
func (j *jsiiProxy_ListItemA) IpInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipInput",
...
func (j *jsiiProxy_ListItemA) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ListItemA) ListId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listId",
...
func (j *jsiiProxy_ListItemA) ListIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listIdInput",
...
func (j *jsiiProxy_ListItemA) Node() constructs.Node {
...
func (j *jsiiProxy_ListItemA) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ListItemA) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ListItemA) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/list_item cloudflare_list_item} Resource.
func NewListItemA(scope constructs.Construct, id *string, config *ListItemAConfig) ListItemA {
	_init_.Initialize()

	if err := validateNewListItemAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ListItemA)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (l *jsiiProxy_ListItemA) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_ListItemA) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_ListItemA) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_ListItemA) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_ListItemA) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_ListItemA) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_ListItemA) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_ListItemA) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_ListItemA) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_ListItemA) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_ListItemA) ResetIp() {
	_jsii_.InvokeVoid(
		l,
		"resetIp",
		nil, // no parameters
...
func (l *jsiiProxy_ListItemA) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_ListItemA) ResetRedirect() {
	_jsii_.InvokeVoid(
		l,
		"resetRedirect",
		nil, // no parameters
...
func (l *jsiiProxy_ListItemA) ToString() *string {
	var returns *string
