...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/tieredcache/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/tiered_cache cloudflare_tiered_cache}.
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/tiered_cache cloudflare_tiered_cache} Resource.
...
func TieredCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTieredCache_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TieredCache) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TieredCache) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TieredCache) MoveFromId(id *string) {
...
func (t *jsiiProxy_TieredCache) MoveToId(id *string) {
