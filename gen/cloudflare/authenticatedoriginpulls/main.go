...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authenticatedOriginPullsCertificate", GoGetter: "AuthenticatedOriginPullsCertificate"},
			_jsii_.MemberProperty{JsiiProperty: "authenticatedOriginPullsCertificateInput", GoGetter: "AuthenticatedOriginPullsCertificateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthenticatedOriginPullsCertificate", GoMethod: "ResetAuthenticatedOriginPullsCertificate"},
