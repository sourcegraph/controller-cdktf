...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/list cloudflare_list}.
type List interface {
...
type jsiiProxy_List struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_List) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_List) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_List) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_List) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_List) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_List) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_List) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_List) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_List) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_List) KindInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kindInput",
...
func (j *jsiiProxy_List) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_List) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_List) Node() constructs.Node {
...
func (j *jsiiProxy_List) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_List) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_List) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/list cloudflare_list} Resource.
func NewList(scope constructs.Construct, id *string, config *ListConfig) List {
	_init_.Initialize()

	if err := validateNewListParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_List{}
...
func List_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateList_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_List) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_List) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_List) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_List) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_List) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_List) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_List) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_List) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_List) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_List) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_List) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_List) MoveFromId(id *string) {
...
func (l *jsiiProxy_List) MoveToId(id *string) {
...
func (l *jsiiProxy_List) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_List) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_List) ToString() *string {
	var returns *string
