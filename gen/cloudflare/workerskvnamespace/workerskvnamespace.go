...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/workerskvnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/workers_kv_namespace cloudflare_workers_kv_namespace}.
...
func (j *jsiiProxy_WorkersKvNamespace) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_WorkersKvNamespace) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WorkersKvNamespace) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkersKvNamespace) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WorkersKvNamespace) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WorkersKvNamespace) Node() constructs.Node {
...
func (j *jsiiProxy_WorkersKvNamespace) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WorkersKvNamespace) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WorkersKvNamespace) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WorkersKvNamespace) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_WorkersKvNamespace) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/workers_kv_namespace cloudflare_workers_kv_namespace} Resource.
func NewWorkersKvNamespace(scope constructs.Construct, id *string, config *WorkersKvNamespaceConfig) WorkersKvNamespace {
	_init_.Initialize()

	if err := validateNewWorkersKvNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WorkersKvNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWorkersKvNamespace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorkersKvNamespace) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkersKvNamespace) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersKvNamespace) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_WorkersKvNamespace) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_WorkersKvNamespace) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_WorkersKvNamespace) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_WorkersKvNamespace) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_WorkersKvNamespace) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_WorkersKvNamespace) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_WorkersKvNamespace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorkersKvNamespace) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersKvNamespace) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkersKvNamespace) MoveToId(id *string) {
...
func (w *jsiiProxy_WorkersKvNamespace) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_WorkersKvNamespace) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WorkersKvNamespace) ToString() *string {
	var returns *string
