...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/filter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/filter cloudflare_filter}.
...
func (j *jsiiProxy_Filter) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Filter) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Filter) ExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expressionInput",
...
func (j *jsiiProxy_Filter) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Filter) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Filter) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Filter) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Filter) Node() constructs.Node {
...
func (j *jsiiProxy_Filter) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Filter) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_Filter) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Filter) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Filter) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_Filter) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewFilter(scope constructs.Construct, id *string, config *FilterConfig) Filter {
	...
	if err := validateNewFilterParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Filter{}
...
func Filter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFilter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_Filter) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_Filter) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_Filter) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_Filter) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_Filter) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_Filter) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_Filter) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_Filter) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_Filter) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_Filter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_Filter) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_Filter) MoveFromId(id *string) {
...
func (f *jsiiProxy_Filter) MoveToId(id *string) {
...
func (f *jsiiProxy_Filter) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_Filter) ToString() *string {
	var returns *string
