...
func (j *jsiiProxy_ZoneLockdownConfigurationsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ZoneLockdownConfigurationsList)SetWrapsSet(val *bool) {
...
func (z *jsiiProxy_ZoneLockdownConfigurationsList) ComputeFqn() *string {
	var returns *string
...
func (z *jsiiProxy_ZoneLockdownConfigurationsList) Get(index *float64) ZoneLockdownConfigurationsOutputReference {
	if err := z.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ZoneLockdownConfigurationsOutputReference
...
func (z *jsiiProxy_ZoneLockdownConfigurationsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (z *jsiiProxy_ZoneLockdownConfigurationsList) ToString() *string {
	var returns *string
