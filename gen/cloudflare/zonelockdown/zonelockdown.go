...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/zone_lockdown cloudflare_zone_lockdown}.
...
type jsiiProxy_ZoneLockdown struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ZoneLockdown) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZoneLockdown) Configurations() ZoneLockdownConfigurationsList {
	var returns ZoneLockdownConfigurationsList
	_jsii_.Get(
		j,
		"configurations",
		&returns,
...
func (j *jsiiProxy_ZoneLockdown) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZoneLockdown) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ZoneLockdown) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZoneLockdown) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZoneLockdown) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZoneLockdown) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ZoneLockdown) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZoneLockdown) Node() constructs.Node {
...
func (j *jsiiProxy_ZoneLockdown) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZoneLockdown) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZoneLockdown) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZoneLockdown) Urls() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"urls",
...
func (j *jsiiProxy_ZoneLockdown) UrlsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"urlsInput",
...
func (j *jsiiProxy_ZoneLockdown) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ZoneLockdown) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func ZoneLockdown_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateZoneLockdown_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (z *jsiiProxy_ZoneLockdown) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZoneLockdown) ResetId() {
	_jsii_.InvokeVoid(
		z,
		"resetId",
		nil, // no parameters
...
func (z *jsiiProxy_ZoneLockdown) ToString() *string {
	var returns *string
