...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customSslOptions", GoGetter: "CustomSslOptions"},
			_jsii_.MemberProperty{JsiiProperty: "customSslOptionsInput", GoGetter: "CustomSslOptionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "customSslPriority", GoGetter: "CustomSslPriority"},
			_jsii_.MemberProperty{JsiiProperty: "customSslPriorityInput", GoGetter: "CustomSslPriorityInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "geoRestrictions", GoGetter: "GeoRestrictions"},
			_jsii_.MemberProperty{JsiiProperty: "geoRestrictionsInput", GoGetter: "GeoRestrictionsInput"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getListAttribute", GoMethod: "GetListAttribute"},
