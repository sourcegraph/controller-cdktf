...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/email_routing_rule cloudflare_email_routing_rule}.
...
func (j *jsiiProxy_EmailRoutingRule) Action() EmailRoutingRuleActionList {
	var returns EmailRoutingRuleActionList
	_jsii_.Get(
		j,
		"action",
		&returns,
...
func (j *jsiiProxy_EmailRoutingRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EmailRoutingRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailRoutingRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EmailRoutingRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EmailRoutingRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EmailRoutingRule) Matcher() EmailRoutingRuleMatcherList {
	var returns EmailRoutingRuleMatcherList
	_jsii_.Get(
		j,
		"matcher",
		&returns,
...
func (j *jsiiProxy_EmailRoutingRule) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_EmailRoutingRule) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_EmailRoutingRule) Node() constructs.Node {
...
func (j *jsiiProxy_EmailRoutingRule) PriorityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priorityInput",
...
func (j *jsiiProxy_EmailRoutingRule) Tag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tag",
...
func (j *jsiiProxy_EmailRoutingRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmailRoutingRule) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_EmailRoutingRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewEmailRoutingRule(scope constructs.Construct, id *string, config *EmailRoutingRuleConfig) EmailRoutingRule {
	...
	if err := validateNewEmailRoutingRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmailRoutingRule) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailRoutingRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EmailRoutingRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EmailRoutingRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EmailRoutingRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EmailRoutingRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EmailRoutingRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EmailRoutingRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EmailRoutingRule) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_EmailRoutingRule) ResetEnabled() {
	_jsii_.InvokeVoid(
		e,
		"resetEnabled",
		nil, // no parameters
...
func (e *jsiiProxy_EmailRoutingRule) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailRoutingRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailRoutingRule) ToString() *string {
	var returns *string
