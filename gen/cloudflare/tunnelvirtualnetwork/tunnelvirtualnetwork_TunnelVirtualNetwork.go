...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/tunnelvirtualnetwork/internal"
)
...
// The jsii proxy struct for TunnelVirtualNetwork
type jsiiProxy_TunnelVirtualNetwork struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TunnelVirtualNetwork) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_TunnelVirtualNetwork) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_TunnelVirtualNetwork) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TunnelVirtualNetwork) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_TunnelVirtualNetwork) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_TunnelVirtualNetwork) Connection() interface{} {
...
func (j *jsiiProxy_TunnelVirtualNetwork) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_TunnelVirtualNetwork) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TunnelVirtualNetwork) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TunnelVirtualNetwork) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TunnelVirtualNetwork) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TunnelVirtualNetwork) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TunnelVirtualNetwork) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TunnelVirtualNetwork) IsDefaultNetwork() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isDefaultNetwork",
...
func (j *jsiiProxy_TunnelVirtualNetwork) IsDefaultNetworkInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TunnelVirtualNetwork) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TunnelVirtualNetwork) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_TunnelVirtualNetwork) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_TunnelVirtualNetwork) Node() constructs.Node {
...
func (j *jsiiProxy_TunnelVirtualNetwork) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TunnelVirtualNetwork) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_TunnelVirtualNetwork) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_TunnelVirtualNetwork) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TunnelVirtualNetwork) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TunnelVirtualNetwork) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (t *jsiiProxy_TunnelVirtualNetwork) ResetComment() {
	_jsii_.InvokeVoid(
		t,
		"resetComment",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelVirtualNetwork) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelVirtualNetwork) ResetIsDefaultNetwork() {
	_jsii_.InvokeVoid(
		t,
		"resetIsDefaultNetwork",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelVirtualNetwork) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelVirtualNetwork) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TunnelVirtualNetwork) ToMetadata() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TunnelVirtualNetwork) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TunnelVirtualNetwork) ToTerraform() interface{} {
	var returns interface{}
