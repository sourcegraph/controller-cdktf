...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putRequestIp", GoMethod: "PutRequestIp"},
			_jsii_.MemberProperty{JsiiProperty: "requestIp", GoGetter: "RequestIp"},
			_jsii_.MemberProperty{JsiiProperty: "requestIpInput", GoGetter: "RequestIpInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequestIp", GoMethod: "ResetRequestIp"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "notIn", GoGetter: "NotIn"},
			_jsii_.MemberProperty{JsiiProperty: "notInInput", GoGetter: "NotInInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetIn", GoMethod: "ResetIn"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotIn", GoMethod: "ResetNotIn"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "permissionGroups", GoGetter: "PermissionGroups"},
			_jsii_.MemberProperty{JsiiProperty: "permissionGroupsInput", GoGetter: "PermissionGroupsInput"},
