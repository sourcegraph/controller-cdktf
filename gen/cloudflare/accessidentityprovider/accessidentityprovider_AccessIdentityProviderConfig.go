...
type AccessIdentityProviderConfig struct {
	...
	// scim_config block.
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/access_identity_provider#scim_config AccessIdentityProvider#scim_config}
