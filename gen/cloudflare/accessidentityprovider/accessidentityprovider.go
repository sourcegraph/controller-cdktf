...
type jsiiProxy_AccessIdentityProvider struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AccessIdentityProvider) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AccessIdentityProvider) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AccessIdentityProvider) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AccessIdentityProvider) Config() AccessIdentityProviderConfigAList {
	var returns AccessIdentityProviderConfigAList
	_jsii_.Get(
		j,
		"config",
		&returns,
...
func (j *jsiiProxy_AccessIdentityProvider) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccessIdentityProvider) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccessIdentityProvider) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessIdentityProvider) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccessIdentityProvider) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AccessIdentityProvider) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AccessIdentityProvider) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessIdentityProvider) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AccessIdentityProvider) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AccessIdentityProvider) Node() constructs.Node {
...
func (j *jsiiProxy_AccessIdentityProvider) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccessIdentityProvider) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessIdentityProvider) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_AccessIdentityProvider) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_AccessIdentityProvider) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_AccessIdentityProvider) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewAccessIdentityProvider(scope constructs.Construct, id *string, config *AccessIdentityProviderConfig) AccessIdentityProvider {
	...
	if err := validateNewAccessIdentityProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AccessIdentityProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccessIdentityProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessIdentityProvider) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessIdentityProvider) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessIdentityProvider) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AccessIdentityProvider) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AccessIdentityProvider) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AccessIdentityProvider) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AccessIdentityProvider) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AccessIdentityProvider) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AccessIdentityProvider) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AccessIdentityProvider) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessIdentityProvider) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AccessIdentityProvider) ResetConfig() {
	_jsii_.InvokeVoid(
		a,
		"resetConfig",
		nil, // no parameters
...
func (a *jsiiProxy_AccessIdentityProvider) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessIdentityProvider) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessIdentityProvider) ResetZoneId() {
	_jsii_.InvokeVoid(
		a,
		"resetZoneId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessIdentityProvider) ToString() *string {
	var returns *string
