...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.observatoryScheduledTest.ObservatoryScheduledTestTimeouts",
		reflect.TypeOf((*ObservatoryScheduledTestTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.observatoryScheduledTest.ObservatoryScheduledTestTimeoutsOutputReference",
		reflect.TypeOf((*ObservatoryScheduledTestTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ObservatoryScheduledTestTimeoutsOutputReference{}
