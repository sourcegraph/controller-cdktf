...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/observatoryscheduledtest/internal"
)
...
func (j *jsiiProxy_ObservatoryScheduledTest) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ObservatoryScheduledTest) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ObservatoryScheduledTest) Frequency() *string {
	var returns *string
	_jsii_.Get(
		j,
		"frequency",
...
func (j *jsiiProxy_ObservatoryScheduledTest) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ObservatoryScheduledTest) Node() constructs.Node {
...
func (j *jsiiProxy_ObservatoryScheduledTest) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ObservatoryScheduledTest) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ObservatoryScheduledTest) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
func (j *jsiiProxy_ObservatoryScheduledTest) UrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlInput",
...
func (j *jsiiProxy_ObservatoryScheduledTest) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ObservatoryScheduledTest) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewObservatoryScheduledTest(scope constructs.Construct, id *string, config *ObservatoryScheduledTestConfig) ObservatoryScheduledTest {
	...
	if err := validateNewObservatoryScheduledTestParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ObservatoryScheduledTest_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.observatoryScheduledTest.ObservatoryScheduledTest",
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetStringAttribute(terraformAttribute *string) *string {
...
func (o *jsiiProxy_ObservatoryScheduledTest) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (o *jsiiProxy_ObservatoryScheduledTest) OverrideLogicalId(newLogicalId *string) {
...
func (o *jsiiProxy_ObservatoryScheduledTest) ToString() *string {
	var returns *string
