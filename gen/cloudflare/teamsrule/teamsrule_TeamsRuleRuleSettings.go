...
type TeamsRuleRuleSettings struct {
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#allow_child_bypass TeamsRule#allow_child_bypass}
	AllowChildBypass interface{} `field:"optional" json:"allowChildBypass" yaml:"allowChildBypass"`
	// audit_ssh block.
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#audit_ssh TeamsRule#audit_ssh}
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#bypass_parent_rule TeamsRule#bypass_parent_rule}
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#ip_categories TeamsRule#ip_categories}
	...
	// payload_log block.
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#payload_log TeamsRule#payload_log}
	PayloadLog *TeamsRuleRuleSettingsPayloadLog `field:"optional" json:"payloadLog" yaml:"payloadLog"`
	// untrusted_cert block.
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/teams_rule#untrusted_cert TeamsRule#untrusted_cert}
