...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "argoSmartRouting", GoGetter: "ArgoSmartRouting"},
			_jsii_.MemberProperty{JsiiProperty: "argoSmartRoutingInput", GoGetter: "ArgoSmartRoutingInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "edgeIpConnectivity", GoGetter: "EdgeIpConnectivity"},
			_jsii_.MemberProperty{JsiiProperty: "edgeIpConnectivityInput", GoGetter: "EdgeIpConnectivityInput"},
			_jsii_.MemberProperty{JsiiProperty: "edgeIps", GoGetter: "EdgeIps"},
			_jsii_.MemberProperty{JsiiProperty: "edgeIpsInput", GoGetter: "EdgeIpsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "originDirectInput", GoGetter: "OriginDirectInput"},
			_jsii_.MemberProperty{JsiiProperty: "originDns", GoGetter: "OriginDns"},
			_jsii_.MemberProperty{JsiiProperty: "originDnsInput", GoGetter: "OriginDnsInput"},
			_jsii_.MemberProperty{JsiiProperty: "originPort", GoGetter: "OriginPort"},
			_jsii_.MemberProperty{JsiiProperty: "originPortInput", GoGetter: "OriginPortInput"},
			_jsii_.MemberProperty{JsiiProperty: "originPortRange", GoGetter: "OriginPortRange"},
			_jsii_.MemberProperty{JsiiProperty: "originPortRangeInput", GoGetter: "OriginPortRangeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEdgeIpConnectivity", GoMethod: "ResetEdgeIpConnectivity"},
			_jsii_.MemberMethod{JsiiMethod: "resetEdgeIps", GoMethod: "ResetEdgeIps"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpFirewall", GoMethod: "ResetIpFirewall"},
			_jsii_.MemberMethod{JsiiMethod: "resetOriginDirect", GoMethod: "ResetOriginDirect"},
			_jsii_.MemberMethod{JsiiMethod: "resetOriginDns", GoMethod: "ResetOriginDns"},
			_jsii_.MemberMethod{JsiiMethod: "resetOriginPort", GoMethod: "ResetOriginPort"},
			_jsii_.MemberMethod{JsiiMethod: "resetOriginPortRange", GoMethod: "ResetOriginPortRange"},
