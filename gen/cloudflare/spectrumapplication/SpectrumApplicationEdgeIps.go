...
type SpectrumApplicationEdgeIps struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/spectrum_application#type SpectrumApplication#type}
	Type *string `field:"required" json:"type" yaml:"type"`
	// The IP versions supported for inbound connections on Spectrum anycast IPs.
	//
	// Required when `type` is not `static`. Available values: `all`, `ipv4`, `ipv6`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/spectrum_application#connectivity SpectrumApplication#connectivity}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/spectrum_application#ips SpectrumApplication#ips}
