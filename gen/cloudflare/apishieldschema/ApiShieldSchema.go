...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/apishieldschema/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/api_shield_schema cloudflare_api_shield_schema}.
...
type jsiiProxy_ApiShieldSchema struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ApiShieldSchema) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ApiShieldSchema) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ApiShieldSchema) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApiShieldSchema) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ApiShieldSchema) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_ApiShieldSchema) KindInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kindInput",
...
func (j *jsiiProxy_ApiShieldSchema) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiShieldSchema) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ApiShieldSchema) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ApiShieldSchema) Node() constructs.Node {
...
func (j *jsiiProxy_ApiShieldSchema) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ApiShieldSchema) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ApiShieldSchema) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiShieldSchema) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ApiShieldSchema) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/api_shield_schema cloudflare_api_shield_schema} Resource.
func NewApiShieldSchema(scope constructs.Construct, id *string, config *ApiShieldSchemaConfig) ApiShieldSchema {
	_init_.Initialize()

	if err := validateNewApiShieldSchemaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiShieldSchema_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.apiShieldSchema.ApiShieldSchema",
...
func (a *jsiiProxy_ApiShieldSchema) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiShieldSchema) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApiShieldSchema) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApiShieldSchema) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApiShieldSchema) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApiShieldSchema) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApiShieldSchema) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApiShieldSchema) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApiShieldSchema) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiShieldSchema) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ApiShieldSchema) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ApiShieldSchema) ResetValidationEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetValidationEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_ApiShieldSchema) ToString() *string {
	var returns *string
