...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/urlnormalizationsettings/internal"
)
...
func (j *jsiiProxy_UrlNormalizationSettings) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UrlNormalizationSettings) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UrlNormalizationSettings) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UrlNormalizationSettings) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UrlNormalizationSettings) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UrlNormalizationSettings) Node() constructs.Node {
...
func (j *jsiiProxy_UrlNormalizationSettings) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_UrlNormalizationSettings) ScopeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeInput",
...
func (j *jsiiProxy_UrlNormalizationSettings) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UrlNormalizationSettings) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_UrlNormalizationSettings) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_UrlNormalizationSettings) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_UrlNormalizationSettings) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/url_normalization_settings cloudflare_url_normalization_settings} Resource.
func NewUrlNormalizationSettings(scope constructs.Construct, id *string, config *UrlNormalizationSettingsConfig) UrlNormalizationSettings {
	...
	if err := validateNewUrlNormalizationSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_UrlNormalizationSettings)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func UrlNormalizationSettings_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.urlNormalizationSettings.UrlNormalizationSettings",
...
func (u *jsiiProxy_UrlNormalizationSettings) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UrlNormalizationSettings) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UrlNormalizationSettings) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UrlNormalizationSettings) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UrlNormalizationSettings) ToString() *string {
	var returns *string
