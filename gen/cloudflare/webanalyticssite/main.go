...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoInstallInput", GoGetter: "AutoInstallInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetZoneTag", GoMethod: "ResetZoneTag"},
			_jsii_.MemberProperty{JsiiProperty: "rulesetId", GoGetter: "RulesetId"},
			_jsii_.MemberProperty{JsiiProperty: "siteTag", GoGetter: "SiteTag"},
			_jsii_.MemberProperty{JsiiProperty: "siteToken", GoGetter: "SiteToken"},
			_jsii_.MemberProperty{JsiiProperty: "snippet", GoGetter: "Snippet"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.webAnalyticsSite.WebAnalyticsSiteTimeouts",
		reflect.TypeOf((*WebAnalyticsSiteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.webAnalyticsSite.WebAnalyticsSiteTimeoutsOutputReference",
		reflect.TypeOf((*WebAnalyticsSiteTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
