...
type NotificationPolicyPagerdutyIntegrationList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for NotificationPolicyPagerdutyIntegrationList
type jsiiProxy_NotificationPolicyPagerdutyIntegrationList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewNotificationPolicyPagerdutyIntegrationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NotificationPolicyPagerdutyIntegrationList {
	...
	if err := validateNewNotificationPolicyPagerdutyIntegrationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) Get(index *float64) NotificationPolicyPagerdutyIntegrationOutputReference {
	if err := n.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns NotificationPolicyPagerdutyIntegrationOutputReference
...
func (n *jsiiProxy_NotificationPolicyPagerdutyIntegrationList) ToString() *string {
	var returns *string
