...
type NotificationPolicyEmailIntegrationList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) NotificationPolicyEmailIntegrationOutputReference
...
// The jsii proxy struct for NotificationPolicyEmailIntegrationList
type jsiiProxy_NotificationPolicyEmailIntegrationList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) InternalValue() interface{} {
...
func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_NotificationPolicyEmailIntegrationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (n *jsiiProxy_NotificationPolicyEmailIntegrationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NotificationPolicyEmailIntegrationList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NotificationPolicyEmailIntegrationList) ToString() *string {
	var returns *string
