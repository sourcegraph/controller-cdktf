...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/firewallrule/internal"
)
...
type jsiiProxy_FirewallRule struct {
...
func (j *jsiiProxy_FirewallRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_FirewallRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_FirewallRule) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_FirewallRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_FirewallRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirewallRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_FirewallRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_FirewallRule) Node() constructs.Node {
...
func (j *jsiiProxy_FirewallRule) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_FirewallRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_FirewallRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirewallRule) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_FirewallRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewFirewallRule(scope constructs.Construct, id *string, config *FirewallRuleConfig) FirewallRule {
	...
	if err := validateNewFirewallRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func FirewallRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFirewallRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallRule) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FirewallRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FirewallRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FirewallRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FirewallRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FirewallRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FirewallRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FirewallRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FirewallRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FirewallRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallRule) MoveFromId(id *string) {
...
func (f *jsiiProxy_FirewallRule) MoveToId(id *string) {
...
func (f *jsiiProxy_FirewallRule) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_FirewallRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		f,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (f *jsiiProxy_FirewallRule) ToString() *string {
	var returns *string
