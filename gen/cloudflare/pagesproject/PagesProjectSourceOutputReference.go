...
type PagesProjectSourceOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for PagesProjectSourceOutputReference
type jsiiProxy_PagesProjectSourceOutputReference struct {
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) Config() PagesProjectSourceConfigOutputReference {
	var returns PagesProjectSourceConfigOutputReference
	_jsii_.Get(
		j,
		"config",
		&returns,
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_PagesProjectSourceOutputReference) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func NewPagesProjectSourceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) PagesProjectSourceOutputReference {
	...
	if err := validateNewPagesProjectSourceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PagesProjectSourceOutputReference) ToString() *string {
	var returns *string
