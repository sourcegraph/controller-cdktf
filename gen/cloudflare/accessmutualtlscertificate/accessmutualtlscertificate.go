...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/accessmutualtlscertificate/internal"
)
...
type AccessMutualTlsCertificate interface {
	...
	SetAssociatedHostnames(val *[]*string)
	AssociatedHostnamesInput() *[]*string
	// Experimental.
...
type jsiiProxy_AccessMutualTlsCertificate struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AccessMutualTlsCertificate) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) AssociatedHostnames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"associatedHostnames",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) AssociatedHostnamesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"associatedHostnamesInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_AccessMutualTlsCertificate) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Certificate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificate",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) CertificateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificateInput",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Fingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fingerprint",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AccessMutualTlsCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessMutualTlsCertificate) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_AccessMutualTlsCertificate) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func AccessMutualTlsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccessMutualTlsCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessMutualTlsCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessMutualTlsCertificate) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessMutualTlsCertificate) MoveToId(id *string) {
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetAccountId() {
	_jsii_.InvokeVoid(
		a,
		"resetAccountId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetAssociatedHostnames() {
	_jsii_.InvokeVoid(
		a,
		"resetAssociatedHostnames",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetCertificate() {
	_jsii_.InvokeVoid(
		a,
		"resetCertificate",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ResetZoneId() {
	_jsii_.InvokeVoid(
		a,
		"resetZoneId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessMutualTlsCertificate) ToString() *string {
	var returns *string
