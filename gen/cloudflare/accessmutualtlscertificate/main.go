...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "associatedHostnamesInput", GoGetter: "AssociatedHostnamesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssociatedHostnames", GoMethod: "ResetAssociatedHostnames"},
