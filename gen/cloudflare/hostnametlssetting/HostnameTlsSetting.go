...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/hostnametlssetting/internal"
)
...
func (j *jsiiProxy_HostnameTlsSetting) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_HostnameTlsSetting) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_HostnameTlsSetting) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HostnameTlsSetting) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_HostnameTlsSetting) Hostname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostname",
...
func (j *jsiiProxy_HostnameTlsSetting) HostnameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostnameInput",
...
func (j *jsiiProxy_HostnameTlsSetting) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_HostnameTlsSetting) Node() constructs.Node {
...
func (j *jsiiProxy_HostnameTlsSetting) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HostnameTlsSetting) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
func (j *jsiiProxy_HostnameTlsSetting) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_HostnameTlsSetting) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewHostnameTlsSetting(scope constructs.Construct, id *string, config *HostnameTlsSettingConfig) HostnameTlsSetting {
	...
	if err := validateNewHostnameTlsSettingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func HostnameTlsSetting_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.hostnameTlsSetting.HostnameTlsSetting",
...
func (h *jsiiProxy_HostnameTlsSetting) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (h *jsiiProxy_HostnameTlsSetting) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (h *jsiiProxy_HostnameTlsSetting) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (h *jsiiProxy_HostnameTlsSetting) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (h *jsiiProxy_HostnameTlsSetting) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (h *jsiiProxy_HostnameTlsSetting) GetStringAttribute(terraformAttribute *string) *string {
...
func (h *jsiiProxy_HostnameTlsSetting) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (h *jsiiProxy_HostnameTlsSetting) OverrideLogicalId(newLogicalId *string) {
...
func (h *jsiiProxy_HostnameTlsSetting) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		h,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (h *jsiiProxy_HostnameTlsSetting) ToString() *string {
	var returns *string
