...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/teamsproxyendpoint/internal"
)
...
type jsiiProxy_TeamsProxyEndpoint struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TeamsProxyEndpoint) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_TeamsProxyEndpoint) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_TeamsProxyEndpoint) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TeamsProxyEndpoint) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TeamsProxyEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TeamsProxyEndpoint) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TeamsProxyEndpoint) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TeamsProxyEndpoint) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TeamsProxyEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TeamsProxyEndpoint) Ips() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ips",
...
func (j *jsiiProxy_TeamsProxyEndpoint) IpsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipsInput",
...
func (j *jsiiProxy_TeamsProxyEndpoint) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TeamsProxyEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_TeamsProxyEndpoint) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_TeamsProxyEndpoint) Node() constructs.Node {
...
func (j *jsiiProxy_TeamsProxyEndpoint) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TeamsProxyEndpoint) Subdomain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subdomain",
...
func (j *jsiiProxy_TeamsProxyEndpoint) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TeamsProxyEndpoint) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewTeamsProxyEndpoint(scope constructs.Construct, id *string, config *TeamsProxyEndpointConfig) TeamsProxyEndpoint {
	...
	if err := validateNewTeamsProxyEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func TeamsProxyEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTeamsProxyEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TeamsProxyEndpoint) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TeamsProxyEndpoint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TeamsProxyEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TeamsProxyEndpoint) OverrideLogicalId(newLogicalId *string) {
...
func (t *jsiiProxy_TeamsProxyEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TeamsProxyEndpoint) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TeamsProxyEndpoint) ToString() *string {
	var returns *string
