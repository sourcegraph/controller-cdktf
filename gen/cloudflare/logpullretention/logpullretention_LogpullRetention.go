...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/logpullretention/internal"
)
...
type jsiiProxy_LogpullRetention struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_LogpullRetention) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LogpullRetention) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LogpullRetention) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LogpullRetention) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LogpullRetention) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LogpullRetention) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LogpullRetention) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogpullRetention) Node() constructs.Node {
...
func (j *jsiiProxy_LogpullRetention) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LogpullRetention) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LogpullRetention) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LogpullRetention) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_LogpullRetention) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewLogpullRetention(scope constructs.Construct, id *string, config *LogpullRetentionConfig) LogpullRetention {
	...
	if err := validateNewLogpullRetentionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogpullRetention) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogpullRetention) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LogpullRetention) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LogpullRetention) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LogpullRetention) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LogpullRetention) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LogpullRetention) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LogpullRetention) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LogpullRetention) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogpullRetention) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LogpullRetention) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LogpullRetention) ToString() *string {
	var returns *string
