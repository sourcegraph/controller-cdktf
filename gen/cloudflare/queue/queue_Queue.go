...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/queue/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/cloudflare/r/queue cloudflare_queue}.
...
func (j *jsiiProxy_Queue) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_Queue) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Queue) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/queue cloudflare_queue} Resource.
...
func (j *jsiiProxy_Queue)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func Queue_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.queue.Queue",
...
func (q *jsiiProxy_Queue) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (q *jsiiProxy_Queue) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (q *jsiiProxy_Queue) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (q *jsiiProxy_Queue) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (q *jsiiProxy_Queue) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (q *jsiiProxy_Queue) GetStringAttribute(terraformAttribute *string) *string {
...
func (q *jsiiProxy_Queue) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
