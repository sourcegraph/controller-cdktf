...
func AccessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAccessPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessPolicy) MoveToId(id *string) {
