...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/d1database/internal"
)
...
func (j *jsiiProxy_D1Database) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_D1Database) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_D1Database) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_D1Database) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_D1Database) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_D1Database) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_D1Database) Node() constructs.Node {
...
func (j *jsiiProxy_D1Database) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewD1Database(scope constructs.Construct, id *string, config *D1DatabaseConfig) D1Database {
	...
	if err := validateNewD1DatabaseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func D1Database_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.d1Database.D1Database",
...
func (d *jsiiProxy_D1Database) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_D1Database) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_D1Database) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_D1Database) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_D1Database) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_D1Database) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_D1Database) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_D1Database) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_D1Database) ToString() *string {
	var returns *string
