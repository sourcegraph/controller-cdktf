...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/email_routing_catch_all cloudflare_email_routing_catch_all}.
...
func (j *jsiiProxy_EmailRoutingCatchAll) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_EmailRoutingCatchAll) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailRoutingCatchAll) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_EmailRoutingCatchAll) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EmailRoutingCatchAll) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_EmailRoutingCatchAll) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_EmailRoutingCatchAll) Node() constructs.Node {
...
func (j *jsiiProxy_EmailRoutingCatchAll) Tag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tag",
...
func (j *jsiiProxy_EmailRoutingCatchAll) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EmailRoutingCatchAll) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_EmailRoutingCatchAll) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewEmailRoutingCatchAll(scope constructs.Construct, id *string, config *EmailRoutingCatchAllConfig) EmailRoutingCatchAll {
	...
	if err := validateNewEmailRoutingCatchAllParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EmailRoutingCatchAll_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.emailRoutingCatchAll.EmailRoutingCatchAll",
...
func (e *jsiiProxy_EmailRoutingCatchAll) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EmailRoutingCatchAll) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EmailRoutingCatchAll) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_EmailRoutingCatchAll) ResetEnabled() {
	_jsii_.InvokeVoid(
		e,
		"resetEnabled",
		nil, // no parameters
...
func (e *jsiiProxy_EmailRoutingCatchAll) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_EmailRoutingCatchAll) ToString() *string {
	var returns *string
