...
type LoadBalancerRulesOverridesSessionAffinityAttributes struct {
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/load_balancer#samesite LoadBalancer#samesite}
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/load_balancer#secure LoadBalancer#secure}
	...
	//
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/cloudflare/r/load_balancer#zero_downtime_failover LoadBalancer#zero_downtime_failover}
