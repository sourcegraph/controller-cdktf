...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/datacloudflareorigincarootcertificate/internal"
)
...
// The jsii proxy struct for DataCloudflareOriginCaRootCertificate
type jsiiProxy_DataCloudflareOriginCaRootCertificate struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Algorithm() *string {
	var returns *string
	_jsii_.Get(
		j,
		"algorithm",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) AlgorithmInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"algorithmInput",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) CertPem() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certPem",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareOriginCaRootCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func DataCloudflareOriginCaRootCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareOriginCaRootCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataCloudflareOriginCaRootCertificate_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataCloudflareOriginCaRootCertificate_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataCloudflareOriginCaRootCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataCloudflareOriginCaRootCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareOriginCaRootCertificate) ToTerraform() interface{} {
	var returns interface{}
