...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/datacloudflareuser/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/data-sources/user cloudflare_user}.
...
type jsiiProxy_DataCloudflareUser struct {
...
func (j *jsiiProxy_DataCloudflareUser) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareUser) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareUser) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareUser) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareUser) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/data-sources/user cloudflare_user} Data Source.
func NewDataCloudflareUser(scope constructs.Construct, id *string, config *DataCloudflareUserConfig) DataCloudflareUser {
	_init_.Initialize()

	if err := validateNewDataCloudflareUserParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareUser_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-cloudflare.dataCloudflareUser.DataCloudflareUser",
...
func (d *jsiiProxy_DataCloudflareUser) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareUser) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareUser) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareUser) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareUser) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareUser) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareUser) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareUser) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareUser) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareUser) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareUser) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareUser) ToString() *string {
	var returns *string
