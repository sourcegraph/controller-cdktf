...
type DataCloudflareWafGroupsGroupsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataCloudflareWafGroupsGroupsOutputReference
...
// The jsii proxy struct for DataCloudflareWafGroupsGroupsList
type jsiiProxy_DataCloudflareWafGroupsGroupsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataCloudflareWafGroupsGroupsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataCloudflareWafGroupsGroupsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareWafGroupsGroupsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataCloudflareWafGroupsGroupsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataCloudflareWafGroupsGroupsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataCloudflareWafGroupsGroupsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareWafGroupsGroupsList {
	...
	_jsii_.Create(
		"cloudflare.dataCloudflareWafGroups.DataCloudflareWafGroupsGroupsList",
...
func (d *jsiiProxy_DataCloudflareWafGroupsGroupsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareWafGroupsGroupsList) ToString() *string {
	var returns *string
