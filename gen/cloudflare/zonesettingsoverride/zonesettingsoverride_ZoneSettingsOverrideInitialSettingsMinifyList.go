...
// The jsii proxy struct for ZoneSettingsOverrideInitialSettingsMinifyList
type jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (z *jsiiProxy_ZoneSettingsOverrideInitialSettingsMinifyList) ToString() *string {
	var returns *string
