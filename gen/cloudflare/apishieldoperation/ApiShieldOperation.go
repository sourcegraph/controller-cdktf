...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/apishieldoperation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/api_shield_operation cloudflare_api_shield_operation}.
...
func (j *jsiiProxy_ApiShieldOperation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ApiShieldOperation) Endpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpoint",
...
func (j *jsiiProxy_ApiShieldOperation) EndpointInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointInput",
...
func (j *jsiiProxy_ApiShieldOperation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApiShieldOperation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ApiShieldOperation) Host() *string {
	var returns *string
	_jsii_.Get(
		j,
		"host",
...
func (j *jsiiProxy_ApiShieldOperation) HostInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostInput",
...
func (j *jsiiProxy_ApiShieldOperation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ApiShieldOperation) Method() *string {
	var returns *string
	_jsii_.Get(
		j,
		"method",
...
func (j *jsiiProxy_ApiShieldOperation) MethodInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"methodInput",
...
func (j *jsiiProxy_ApiShieldOperation) Node() constructs.Node {
...
func (j *jsiiProxy_ApiShieldOperation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiShieldOperation) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.20.0/docs/resources/api_shield_operation cloudflare_api_shield_operation} Resource.
func NewApiShieldOperation(scope constructs.Construct, id *string, config *ApiShieldOperationConfig) ApiShieldOperation {
	_init_.Initialize()

	if err := validateNewApiShieldOperationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiShieldOperation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApiShieldOperation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApiShieldOperation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApiShieldOperation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApiShieldOperation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApiShieldOperation) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApiShieldOperation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApiShieldOperation) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ApiShieldOperation) ToString() *string {
	var returns *string
