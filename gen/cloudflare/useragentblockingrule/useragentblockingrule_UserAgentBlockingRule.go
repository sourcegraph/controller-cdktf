...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/useragentblockingrule/internal"
)
...
func (j *jsiiProxy_UserAgentBlockingRule) Configuration() UserAgentBlockingRuleConfigurationOutputReference {
	var returns UserAgentBlockingRuleConfigurationOutputReference
	_jsii_.Get(
		j,
		"configuration",
		&returns,
...
func (j *jsiiProxy_UserAgentBlockingRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UserAgentBlockingRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserAgentBlockingRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserAgentBlockingRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserAgentBlockingRule) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_UserAgentBlockingRule) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_UserAgentBlockingRule) Node() constructs.Node {
...
func (j *jsiiProxy_UserAgentBlockingRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserAgentBlockingRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewUserAgentBlockingRule(scope constructs.Construct, id *string, config *UserAgentBlockingRuleConfig) UserAgentBlockingRule {
	...
	if err := validateNewUserAgentBlockingRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_UserAgentBlockingRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func UserAgentBlockingRule_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.userAgentBlockingRule.UserAgentBlockingRule",
...
func (u *jsiiProxy_UserAgentBlockingRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserAgentBlockingRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserAgentBlockingRule) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UserAgentBlockingRule) PutConfiguration(value *UserAgentBlockingRuleConfiguration) {
	if err := u.validatePutConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		u,
...
func (u *jsiiProxy_UserAgentBlockingRule) ToString() *string {
	var returns *string
