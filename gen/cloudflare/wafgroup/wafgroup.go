...
// The jsii proxy struct for WafGroup
type jsiiProxy_WafGroup struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_WafGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_WafGroup) Connection() interface{} {
...
func (j *jsiiProxy_WafGroup) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_WafGroup) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_WafGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_WafGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WafGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WafGroup) GroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupId",
...
func (j *jsiiProxy_WafGroup) GroupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupIdInput",
...
func (j *jsiiProxy_WafGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WafGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WafGroup) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_WafGroup) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_WafGroup) Node() constructs.Node {
...
func (j *jsiiProxy_WafGroup) PackageId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageId",
...
func (j *jsiiProxy_WafGroup) PackageIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageIdInput",
...
func (j *jsiiProxy_WafGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WafGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_WafGroup) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_WafGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WafGroup) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafGroup) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_WafGroup) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewWafGroup(scope constructs.Construct, id *string, config *WafGroupConfig) WafGroup {
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.wafGroup.WafGroup",
...
// Experimental.
func WafGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafGroup) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
...
func (w *jsiiProxy_WafGroup) ResetMode() {
	_jsii_.InvokeVoid(
		w,
		"resetMode",
		nil, // no parameters
...
func (w *jsiiProxy_WafGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WafGroup) ResetPackageId() {
	_jsii_.InvokeVoid(
		w,
		"resetPackageId",
		nil, // no parameters
...
func (w *jsiiProxy_WafGroup) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafGroup) ToMetadata() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafGroup) ToString() *string {
	var returns *string
...
func (w *jsiiProxy_WafGroup) ToTerraform() interface{} {
	var returns interface{}
