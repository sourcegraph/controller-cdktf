...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/accesscacertificate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.3.0/docs/resources/access_ca_certificate cloudflare_access_ca_certificate}.
...
type jsiiProxy_AccessCaCertificate struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AccessCaCertificate) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AccessCaCertificate) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AccessCaCertificate) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_AccessCaCertificate) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_AccessCaCertificate) Aud() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aud",
...
func (j *jsiiProxy_AccessCaCertificate) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AccessCaCertificate) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccessCaCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccessCaCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessCaCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccessCaCertificate) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AccessCaCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AccessCaCertificate) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessCaCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_AccessCaCertificate) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccessCaCertificate) PublicKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKey",
...
func (j *jsiiProxy_AccessCaCertificate) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AccessCaCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessCaCertificate) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_AccessCaCertificate) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func AccessCaCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccessCaCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessCaCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessCaCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessCaCertificate) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessCaCertificate) MoveToId(id *string) {
...
func (a *jsiiProxy_AccessCaCertificate) ResetAccountId() {
	_jsii_.InvokeVoid(
		a,
		"resetAccountId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessCaCertificate) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessCaCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessCaCertificate) ResetZoneId() {
	_jsii_.InvokeVoid(
		a,
		"resetZoneId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessCaCertificate) ToString() *string {
	var returns *string
