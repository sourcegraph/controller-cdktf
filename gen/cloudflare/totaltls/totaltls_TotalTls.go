...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/totaltls/internal"
)
...
type jsiiProxy_TotalTls struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TotalTls) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TotalTls) CertificateAuthority() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TotalTls) CertificateAuthorityInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TotalTls) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TotalTls) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TotalTls) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TotalTls) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TotalTls) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TotalTls) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TotalTls) Node() constructs.Node {
...
func (j *jsiiProxy_TotalTls) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TotalTls) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TotalTls) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TotalTls) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://www.terraform.io/docs/providers/cloudflare/r/total_tls cloudflare_total_tls} Resource.
func NewTotalTls(scope constructs.Construct, id *string, config *TotalTlsConfig) TotalTls {
	_init_.Initialize()

	if err := validateNewTotalTlsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_TotalTls)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func TotalTls_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"cloudflare.totalTls.TotalTls",
...
func (t *jsiiProxy_TotalTls) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TotalTls) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TotalTls) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TotalTls) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TotalTls) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TotalTls) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TotalTls) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TotalTls) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TotalTls) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TotalTls) OverrideLogicalId(newLogicalId *string) {
...
func (t *jsiiProxy_TotalTls) ResetCertificateAuthority() {
	_jsii_.InvokeVoid(
		t,
		"resetCertificateAuthority",
		nil, // no parameters
...
func (t *jsiiProxy_TotalTls) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TotalTls) ToString() *string {
	var returns *string
