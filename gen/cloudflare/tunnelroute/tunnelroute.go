...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/cloudflare/tunnelroute/internal"
)
...
type jsiiProxy_TunnelRoute struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_TunnelRoute) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_TunnelRoute) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_TunnelRoute) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_TunnelRoute) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_TunnelRoute) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_TunnelRoute) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_TunnelRoute) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_TunnelRoute) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TunnelRoute) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_TunnelRoute) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_TunnelRoute) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_TunnelRoute) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TunnelRoute) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_TunnelRoute) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_TunnelRoute) Node() constructs.Node {
...
func (j *jsiiProxy_TunnelRoute) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_TunnelRoute) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TunnelRoute) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TunnelRoute) TunnelId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tunnelId",
...
func (j *jsiiProxy_TunnelRoute) TunnelIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tunnelIdInput",
...
func TunnelRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTunnelRoute_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TunnelRoute) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TunnelRoute) ResetComment() {
	_jsii_.InvokeVoid(
		t,
		"resetComment",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelRoute) ResetId() {
	_jsii_.InvokeVoid(
		t,
		"resetId",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelRoute) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		t,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (t *jsiiProxy_TunnelRoute) ToString() *string {
	var returns *string
