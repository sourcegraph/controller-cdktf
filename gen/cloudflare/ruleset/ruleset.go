...
func (j *jsiiProxy_Ruleset) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_Ruleset) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_Ruleset) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ruleset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ruleset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Ruleset) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Ruleset) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ruleset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ruleset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ruleset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ruleset) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_Ruleset) KindInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kindInput",
...
func (j *jsiiProxy_Ruleset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Ruleset) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Ruleset) Node() constructs.Node {
...
func (j *jsiiProxy_Ruleset) Phase() *string {
	var returns *string
	_jsii_.Get(
		j,
		"phase",
...
func (j *jsiiProxy_Ruleset) PhaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"phaseInput",
...
func (j *jsiiProxy_Ruleset) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ruleset) Rules() RulesetRulesList {
	var returns RulesetRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_Ruleset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ruleset) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewRuleset(scope constructs.Construct, id *string, config *RulesetConfig) Ruleset {
	...
	if err := validateNewRulesetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Ruleset{}
...
func Ruleset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateRuleset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Ruleset) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Ruleset) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Ruleset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_Ruleset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_Ruleset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_Ruleset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_Ruleset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_Ruleset) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_Ruleset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_Ruleset) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Ruleset) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Ruleset) MoveFromId(id *string) {
...
func (r *jsiiProxy_Ruleset) MoveToId(id *string) {
...
func (r *jsiiProxy_Ruleset) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_Ruleset) ResetAccountId() {
	_jsii_.InvokeVoid(
		r,
		"resetAccountId",
		nil, // no parameters
...
func (r *jsiiProxy_Ruleset) ResetDescription() {
	_jsii_.InvokeVoid(
		r,
		"resetDescription",
		nil, // no parameters
...
func (r *jsiiProxy_Ruleset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_Ruleset) ResetZoneId() {
	_jsii_.InvokeVoid(
		r,
		"resetZoneId",
		nil, // no parameters
...
func (r *jsiiProxy_Ruleset) ToString() *string {
	var returns *string
