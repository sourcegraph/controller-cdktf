...
type RulesetRulesActionParametersResponseOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for RulesetRulesActionParametersResponseOutputReference
type jsiiProxy_RulesetRulesActionParametersResponseOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ContentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentInput",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ContentType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentType",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ContentTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentTypeInput",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) StatusCode() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"statusCode",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) StatusCodeInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"statusCodeInput",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ResetContent() {
	_jsii_.InvokeVoid(
		r,
		"resetContent",
		nil, // no parameters
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ResetContentType() {
	_jsii_.InvokeVoid(
		r,
		"resetContentType",
		nil, // no parameters
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ResetStatusCode() {
	_jsii_.InvokeVoid(
		r,
		"resetStatusCode",
		nil, // no parameters
...
func (r *jsiiProxy_RulesetRulesActionParametersResponseOutputReference) ToString() *string {
	var returns *string
