...
type RulesetRulesActionParametersAutominifyList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) RulesetRulesActionParametersAutominifyOutputReference
...
// The jsii proxy struct for RulesetRulesActionParametersAutominifyList
type jsiiProxy_RulesetRulesActionParametersAutominifyList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) InternalValue() interface{} {
...
func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_RulesetRulesActionParametersAutominifyList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (r *jsiiProxy_RulesetRulesActionParametersAutominifyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RulesetRulesActionParametersAutominifyList) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RulesetRulesActionParametersAutominifyList) ToString() *string {
	var returns *string
