...
type CertificatePackValidationRecordsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) CertificatePackValidationRecordsOutputReference
...
// The jsii proxy struct for CertificatePackValidationRecordsList
type jsiiProxy_CertificatePackValidationRecordsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_CertificatePackValidationRecordsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CertificatePackValidationRecordsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CertificatePackValidationRecordsList) InternalValue() interface{} {
...
func (j *jsiiProxy_CertificatePackValidationRecordsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CertificatePackValidationRecordsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_CertificatePackValidationRecordsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (c *jsiiProxy_CertificatePackValidationRecordsList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CertificatePackValidationRecordsList) ToString() *string {
	var returns *string
