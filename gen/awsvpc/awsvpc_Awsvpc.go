...
func NewAwsvpc(scope constructs.Construct, id *string, options *AwsvpcOptions) Awsvpc {
	_init_.Initialize()

	if err := validateNewAwsvpcParameters(scope, id, options); err != nil {
		panic(err)
	}
	j := jsiiProxy_Awsvpc{}
...
func NewAwsvpc_Override(a Awsvpc, scope constructs.Construct, id *string, options *AwsvpcOptions) {
	_init_.Initialize()
