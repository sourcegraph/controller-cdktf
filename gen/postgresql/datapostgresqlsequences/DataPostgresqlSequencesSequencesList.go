...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/postgresql/datapostgresqlsequences/internal"
)
...
func (d *jsiiProxy_DataPostgresqlSequencesSequencesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
