...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/postgresql/usermapping/internal"
)
...
type jsiiProxy_UserMapping struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_UserMapping) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_UserMapping) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserMapping) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_UserMapping) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserMapping) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserMapping) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserMapping) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserMapping) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserMapping) Node() constructs.Node {
...
func (j *jsiiProxy_UserMapping) Options() *map[string]*string {
...
func (j *jsiiProxy_UserMapping) OptionsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"optionsInput",
...
func (j *jsiiProxy_UserMapping) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_UserMapping) ServerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverName",
...
func (j *jsiiProxy_UserMapping) ServerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverNameInput",
...
func (j *jsiiProxy_UserMapping) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserMapping) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserMapping) UserName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userName",
...
func (j *jsiiProxy_UserMapping) UserNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userNameInput",
...
func NewUserMapping(scope constructs.Construct, id *string, config *UserMappingConfig) UserMapping {
	...
	if err := validateNewUserMappingParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_UserMapping{}
...
func UserMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateUserMapping_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func UserMapping_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-postgresql.userMapping.UserMapping",
...
func (u *jsiiProxy_UserMapping) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserMapping) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserMapping) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserMapping) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserMapping) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserMapping) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserMapping) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserMapping) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserMapping) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserMapping) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (u *jsiiProxy_UserMapping) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserMapping) MoveFromId(id *string) {
...
func (u *jsiiProxy_UserMapping) MoveToId(id *string) {
...
func (u *jsiiProxy_UserMapping) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UserMapping) ResetId() {
	_jsii_.InvokeVoid(
		u,
		"resetId",
		nil, // no parameters
...
func (u *jsiiProxy_UserMapping) ResetOptions() {
	_jsii_.InvokeVoid(
		u,
		"resetOptions",
		nil, // no parameters
...
func (u *jsiiProxy_UserMapping) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserMapping) ToString() *string {
	var returns *string
