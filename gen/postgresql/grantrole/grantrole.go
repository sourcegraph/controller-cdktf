...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/postgresql/grantrole/internal"
)

// Represents a {@link https://registry.terraform.io/providers/sourcegraph/postgresql/1.18.0/docs/resources/grant_role postgresql_grant_role}.
...
func (j *jsiiProxy_GrantRole) Connection() interface{} {
...
func (j *jsiiProxy_GrantRole) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GrantRole) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GrantRole) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/sourcegraph/postgresql/1.18.0/docs/resources/grant_role postgresql_grant_role} Resource.
func NewGrantRole(scope constructs.Construct, id *string, config *GrantRoleConfig) GrantRole {
	_init_.Initialize()

	if err := validateNewGrantRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GrantRole)SetConnection(val interface{}) {
...
func (j *jsiiProxy_GrantRole)SetCount(val interface{}) {
...
func (j *jsiiProxy_GrantRole)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GrantRole)SetGrantRole(val *string) {
	if err := j.validateSetGrantRoleParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GrantRole)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_GrantRole)SetWithAdminOption(val interface{}) {
	if err := j.validateSetWithAdminOptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func GrantRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGrantRole_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GrantRole_IsConstruct(x interface{}) *bool {
	...
	if err := validateGrantRole_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GrantRole_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGrantRole_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GrantRole_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGrantRole_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GrantRole) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GrantRole) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GrantRole) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GrantRole) MoveFromId(id *string) {
...
func (g *jsiiProxy_GrantRole) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GrantRole) MoveToId(id *string) {
...
func (g *jsiiProxy_GrantRole) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GrantRole) ToHclTerraform() interface{} {
	var returns interface{}
