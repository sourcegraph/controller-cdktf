...
func init() {
	...
	_jsii_.RegisterStruct(
		"kubernetes.csiDriver.CsiDriverConfig",
		reflect.TypeOf((*CsiDriverConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"kubernetes.csiDriver.CsiDriverMetadata",
		reflect.TypeOf((*CsiDriverMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"kubernetes.csiDriver.CsiDriverMetadataOutputReference",
	...
	_jsii_.RegisterStruct(
		"kubernetes.csiDriver.CsiDriverSpec",
		reflect.TypeOf((*CsiDriverSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"kubernetes.csiDriver.CsiDriverSpecOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "podInfoOnMount", GoGetter: "PodInfoOnMount"},
			_jsii_.MemberProperty{JsiiProperty: "podInfoOnMountInput", GoGetter: "PodInfoOnMountInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPodInfoOnMount", GoMethod: "ResetPodInfoOnMount"},
			_jsii_.MemberMethod{JsiiMethod: "resetVolumeLifecycleModes", GoMethod: "ResetVolumeLifecycleModes"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
