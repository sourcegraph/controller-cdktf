...
type Annotations interface {
	...
	MetadataInput() *AnnotationsMetadata
	// The tree node.
...
func (j *jsiiProxy_Annotations) Annotations() *map[string]*string {
...
func (j *jsiiProxy_Annotations) AnnotationsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"annotationsInput",
...
func (j *jsiiProxy_Annotations) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_Annotations) ApiVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersionInput",
...
func (j *jsiiProxy_Annotations) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Annotations) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Annotations) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Annotations) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Annotations) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Annotations) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Annotations) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Annotations) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_Annotations) KindInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kindInput",
...
func (j *jsiiProxy_Annotations) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Annotations) Metadata() AnnotationsMetadataOutputReference {
	var returns AnnotationsMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Annotations) MetadataInput() *AnnotationsMetadata {
	var returns *AnnotationsMetadata
	_jsii_.Get(
		j,
		"metadataInput",
		&returns,
...
func (j *jsiiProxy_Annotations) Node() constructs.Node {
...
func (j *jsiiProxy_Annotations) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Annotations) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Annotations) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAnnotations(scope constructs.Construct, id *string, config *AnnotationsConfig) Annotations {
	...
	if err := validateNewAnnotationsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Annotations_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"kubernetes.annotations.Annotations",
...
func (a *jsiiProxy_Annotations) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_Annotations) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_Annotations) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_Annotations) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_Annotations) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_Annotations) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_Annotations) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_Annotations) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_Annotations) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_Annotations) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_Annotations) PutMetadata(value *AnnotationsMetadata) {
...
func (a *jsiiProxy_Annotations) ResetForce() {
	_jsii_.InvokeVoid(
		a,
		"resetForce",
		nil, // no parameters
...
func (a *jsiiProxy_Annotations) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_Annotations) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_Annotations) ToString() *string {
	var returns *string
