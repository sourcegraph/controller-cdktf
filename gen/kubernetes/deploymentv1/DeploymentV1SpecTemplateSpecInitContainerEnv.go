...
type DeploymentV1SpecTemplateSpecInitContainerEnv struct {
	...
	// value_from block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/deployment_v1#value_from DeploymentV1#value_from}
