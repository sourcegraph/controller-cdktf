...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecContainerList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecContainerList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DeploymentV1SpecTemplateSpecContainer:
		val := val.(*[]*DeploymentV1SpecTemplateSpecContainer)
	...
	case []*DeploymentV1SpecTemplateSpecContainer:
		val_ := val.([]*DeploymentV1SpecTemplateSpecContainer)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DeploymentV1SpecTemplateSpecContainer; received %#v (a %T)", val, val)
		}
	}
