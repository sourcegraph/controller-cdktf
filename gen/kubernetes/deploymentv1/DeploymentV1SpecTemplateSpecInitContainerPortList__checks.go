...
func (d *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerPortList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DeploymentV1SpecTemplateSpecInitContainerPortList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DeploymentV1SpecTemplateSpecInitContainerPort:
		val := val.(*[]*DeploymentV1SpecTemplateSpecInitContainerPort)
	...
	case []*DeploymentV1SpecTemplateSpecInitContainerPort:
		val_ := val.([]*DeploymentV1SpecTemplateSpecInitContainerPort)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DeploymentV1SpecTemplateSpecInitContainerPort; received %#v (a %T)", val, val)
		}
	}
