...
type DeploymentV1SpecTemplateSpecVolumePersistentVolumeClaim struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/deployment_v1#claim_name DeploymentV1#claim_name}
