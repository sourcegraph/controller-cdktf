...
func (j *jsiiProxy_IngressStatusLoadBalancerList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IngressStatusLoadBalancerList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IngressStatusLoadBalancerList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_IngressStatusLoadBalancerList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_IngressStatusLoadBalancerList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_IngressStatusLoadBalancerList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IngressStatusLoadBalancerList) Get(index *float64) IngressStatusLoadBalancerOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns IngressStatusLoadBalancerOutputReference
...
func (i *jsiiProxy_IngressStatusLoadBalancerList) ToString() *string {
	var returns *string
