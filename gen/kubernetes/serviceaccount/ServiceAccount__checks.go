...
func (s *jsiiProxy_ServiceAccount) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (s *jsiiProxy_ServiceAccount) validatePutImagePullSecretParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ServiceAccountImagePullSecret:
		value := value.(*[]*ServiceAccountImagePullSecret)
	...
	case []*ServiceAccountImagePullSecret:
		value_ := value.([]*ServiceAccountImagePullSecret)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ServiceAccountImagePullSecret; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_ServiceAccount) validatePutSecretParameters(value interface{}) error {
	...
	case *[]*ServiceAccountSecret:
		value := value.(*[]*ServiceAccountSecret)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ServiceAccountSecret:
		value_ := value.([]*ServiceAccountSecret)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ServiceAccountSecret; received %#v (a %T)", value, value)
		}
	}
