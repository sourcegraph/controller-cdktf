...
func (d *jsiiProxy_DataKubernetesIngressV1SpecRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataKubernetesIngressV1SpecRuleList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataKubernetesIngressV1SpecRuleList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataKubernetesIngressV1SpecRuleList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
