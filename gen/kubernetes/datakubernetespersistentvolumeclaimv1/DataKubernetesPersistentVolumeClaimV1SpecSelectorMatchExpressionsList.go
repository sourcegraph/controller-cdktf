...
func (d *jsiiProxy_DataKubernetesPersistentVolumeClaimV1SpecSelectorMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
