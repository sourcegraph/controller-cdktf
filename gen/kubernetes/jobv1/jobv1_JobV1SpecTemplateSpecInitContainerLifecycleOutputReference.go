...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) PostStartInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"postStartInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) PreStopInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"preStopInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) PutPostStart(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) PutPreStop(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecycleOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
