...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerEnvList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerEnvList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerEnvList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
