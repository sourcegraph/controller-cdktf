...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePreStopList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerLifecyclePreStopList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*JobV1SpecTemplateSpecContainerLifecyclePreStop:
		val := val.(*[]*JobV1SpecTemplateSpecContainerLifecyclePreStop)
	...
	case []*JobV1SpecTemplateSpecContainerLifecyclePreStop:
		val_ := val.([]*JobV1SpecTemplateSpecContainerLifecyclePreStop)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*JobV1SpecTemplateSpecContainerLifecyclePreStop; received %#v (a %T)", val, val)
		}
	}
