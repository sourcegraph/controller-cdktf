...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewJobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList {
	_init_.Initialize()
...
func NewJobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList_Override(j JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecVolumeProjectedSourcesSecretItemsList) Resolve(_context cdktf.IResolveContext) interface{} {
