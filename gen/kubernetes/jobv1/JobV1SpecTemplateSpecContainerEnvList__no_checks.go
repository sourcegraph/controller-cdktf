...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerEnvList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerEnvList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_JobV1SpecTemplateSpecContainerEnvList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
