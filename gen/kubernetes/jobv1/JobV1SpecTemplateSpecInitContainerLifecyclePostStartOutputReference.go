...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) TcpSocketInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tcpSocketInput",
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) PutTcpSocket(value interface{}) {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerLifecyclePostStartOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
