...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerPortList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerPortList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerPortList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*JobV1SpecTemplateSpecInitContainerPort:
		val_ := val.([]*JobV1SpecTemplateSpecInitContainerPort)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerPortList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_JobV1SpecTemplateSpecInitContainerPortList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
