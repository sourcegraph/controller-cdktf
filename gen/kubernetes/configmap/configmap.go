...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/kubernetes/configmap/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/config_map kubernetes_config_map}.
type ConfigMap interface {
	...
	MetadataInput() *ConfigMapMetadata
	// The tree node.
	...
	PutMetadata(value *ConfigMapMetadata)
	ResetBinaryData()
	ResetData()
	ResetId()
	ResetImmutable()
...
func (j *jsiiProxy_ConfigMap) BinaryDataInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"binaryDataInput",
...
func (j *jsiiProxy_ConfigMap) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ConfigMap) DataInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"dataInput",
...
func (j *jsiiProxy_ConfigMap) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ConfigMap) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConfigMap) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConfigMap) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ConfigMap) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ConfigMap) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ConfigMap) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigMap) Metadata() ConfigMapMetadataOutputReference {
	var returns ConfigMapMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_ConfigMap) MetadataInput() *ConfigMapMetadata {
	var returns *ConfigMapMetadata
	_jsii_.Get(
		j,
		"metadataInput",
		&returns,
...
func (j *jsiiProxy_ConfigMap) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ConfigMap) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConfigMap) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewConfigMap(scope constructs.Construct, id *string, config *ConfigMapConfig) ConfigMap {
	...
	if err := validateNewConfigMapParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConfigMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigMap_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConfigMap_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-kubernetes.configMap.ConfigMap",
...
func (c *jsiiProxy_ConfigMap) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigMap) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigMap) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ConfigMap) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ConfigMap) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ConfigMap) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ConfigMap) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ConfigMap) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ConfigMap) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ConfigMap) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigMap) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigMap) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigMap) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigMap) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ConfigMap) PutMetadata(value *ConfigMapMetadata) {
...
func (c *jsiiProxy_ConfigMap) ResetBinaryData() {
	_jsii_.InvokeVoid(
		c,
		"resetBinaryData",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMap) ResetData() {
	_jsii_.InvokeVoid(
		c,
		"resetData",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMap) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMap) ResetImmutable() {
	_jsii_.InvokeVoid(
		c,
		"resetImmutable",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMap) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
