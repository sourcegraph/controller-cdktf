...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataKubernetesPodV1SpecContainerLivenessProbeExecList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecContainerLivenessProbeExecList {
	...
	_jsii_.Create(
		"kubernetes.dataKubernetesPodV1.DataKubernetesPodV1SpecContainerLivenessProbeExecList",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) Get(index *float64) DataKubernetesPodV1SpecContainerLivenessProbeExecOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataKubernetesPodV1SpecContainerLivenessProbeExecOutputReference
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecContainerLivenessProbeExecList) ToString() *string {
	var returns *string
