...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) Get(index *float64) DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapOutputReference
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapList) ToString() *string {
	var returns *string
