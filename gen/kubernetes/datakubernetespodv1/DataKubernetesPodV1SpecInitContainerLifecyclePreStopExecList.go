...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLifecyclePreStopExecList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
