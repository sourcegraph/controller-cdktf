...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"kubernetes.dataKubernetesPodV1.DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList",
...
func NewDataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList_Override(d DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerLifecyclePreStopHttpGetHttpHeaderList) Resolve(_context cdktf.IResolveContext) interface{} {
