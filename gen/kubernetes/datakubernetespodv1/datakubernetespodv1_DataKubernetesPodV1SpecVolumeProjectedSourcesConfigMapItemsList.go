...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"kubernetes.dataKubernetesPodV1.DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList",
...
func NewDataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList_Override(d DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodV1SpecVolumeProjectedSourcesConfigMapItemsList) Resolve(_context cdktf.IResolveContext) interface{} {
