...
func (d *jsiiProxy_DataKubernetesPodV1SpecInitContainerEnvValueFromConfigMapKeyRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
