...
func (j *jsiiProxy_DataKubernetesIngressStatusLoadBalancerIngressList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataKubernetesIngressStatusLoadBalancerIngressList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesIngressStatusLoadBalancerIngressList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesIngressStatusLoadBalancerIngressList) Resolve(_context cdktf.IResolveContext) interface{} {
