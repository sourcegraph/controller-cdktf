...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerPortList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DaemonSetV1SpecTemplateSpecContainerPortList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DaemonSetV1SpecTemplateSpecContainerPort:
		val := val.(*[]*DaemonSetV1SpecTemplateSpecContainerPort)
	...
	case []*DaemonSetV1SpecTemplateSpecContainerPort:
		val_ := val.([]*DaemonSetV1SpecTemplateSpecContainerPort)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DaemonSetV1SpecTemplateSpecContainerPort; received %#v (a %T)", val, val)
		}
	}
