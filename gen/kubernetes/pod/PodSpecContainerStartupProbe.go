...
type PodSpecContainerStartupProbe struct {
	// exec block.
	//
	...
	Exec *PodSpecContainerStartupProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *PodSpecContainerStartupProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
