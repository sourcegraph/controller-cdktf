...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSpecContainerVolumeMountOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
