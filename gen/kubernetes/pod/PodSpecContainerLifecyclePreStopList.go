...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList) InternalValue() interface{} {
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopList) Get(index *float64) PodSpecContainerLifecyclePreStopOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PodSpecContainerLifecyclePreStopOutputReference
...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopList) ToString() *string {
	var returns *string
