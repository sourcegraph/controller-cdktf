...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) InternalValue() interface{} {
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) Get(index *float64) PodSpecVolumeProjectedSourcesSecretItemsOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PodSpecVolumeProjectedSourcesSecretItemsOutputReference
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) ToString() *string {
	var returns *string
