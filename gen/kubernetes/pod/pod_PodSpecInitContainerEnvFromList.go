...
func (j *jsiiProxy_PodSpecInitContainerEnvFromList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPodSpecInitContainerEnvFromList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PodSpecInitContainerEnvFromList {
	_init_.Initialize()
...
func NewPodSpecInitContainerEnvFromList_Override(p PodSpecInitContainerEnvFromList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PodSpecInitContainerEnvFromList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PodSpecInitContainerEnvFromList) Resolve(_context cdktf.IResolveContext) interface{} {
