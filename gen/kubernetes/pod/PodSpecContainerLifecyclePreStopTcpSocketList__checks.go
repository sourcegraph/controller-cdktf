...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopTcpSocketList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopTcpSocketList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*PodSpecContainerLifecyclePreStopTcpSocket:
		val := val.(*[]*PodSpecContainerLifecyclePreStopTcpSocket)
	...
	case []*PodSpecContainerLifecyclePreStopTcpSocket:
		val_ := val.([]*PodSpecContainerLifecyclePreStopTcpSocket)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*PodSpecContainerLifecyclePreStopTcpSocket; received %#v (a %T)", val, val)
		}
	}
