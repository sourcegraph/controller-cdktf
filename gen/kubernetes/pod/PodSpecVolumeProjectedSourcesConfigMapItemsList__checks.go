...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesConfigMapItemsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesConfigMapItemsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*PodSpecVolumeProjectedSourcesConfigMapItems:
		val := val.(*[]*PodSpecVolumeProjectedSourcesConfigMapItems)
	...
	case []*PodSpecVolumeProjectedSourcesConfigMapItems:
		val_ := val.([]*PodSpecVolumeProjectedSourcesConfigMapItems)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*PodSpecVolumeProjectedSourcesConfigMapItems; received %#v (a %T)", val, val)
		}
	}
