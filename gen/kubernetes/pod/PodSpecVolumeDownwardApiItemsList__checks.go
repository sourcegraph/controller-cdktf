...
func (p *jsiiProxy_PodSpecVolumeDownwardApiItemsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodSpecVolumeDownwardApiItemsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*PodSpecVolumeDownwardApiItems:
		val_ := val.([]*PodSpecVolumeDownwardApiItems)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
