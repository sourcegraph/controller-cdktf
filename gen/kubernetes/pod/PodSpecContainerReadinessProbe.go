...
type PodSpecContainerReadinessProbe struct {
	...
	Exec *PodSpecContainerReadinessProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *PodSpecContainerReadinessProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
