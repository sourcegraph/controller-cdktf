...
func (p *jsiiProxy_PodSpecContainerLifecyclePreStopList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodSpecContainerLifecyclePreStopList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*PodSpecContainerLifecyclePreStop:
		val_ := val.([]*PodSpecContainerLifecyclePreStop)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
