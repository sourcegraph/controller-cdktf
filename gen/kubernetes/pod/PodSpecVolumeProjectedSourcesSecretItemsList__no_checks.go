...
func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (p *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_PodSpecVolumeProjectedSourcesSecretItemsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
