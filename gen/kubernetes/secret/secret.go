...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/secret kubernetes_secret}.
...
func (j *jsiiProxy_Secret) BinaryData() *map[string]*string {
...
func (j *jsiiProxy_Secret) BinaryDataInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"binaryDataInput",
...
func (j *jsiiProxy_Secret) Data() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"data",
...
func (j *jsiiProxy_Secret) DataInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"dataInput",
...
func (j *jsiiProxy_Secret) Immutable() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"immutable",
...
func (j *jsiiProxy_Secret) ImmutableInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"immutableInput",
...
func (j *jsiiProxy_Secret) Metadata() SecretMetadataOutputReference {
	var returns SecretMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Secret) MetadataInput() *SecretMetadata {
	var returns *SecretMetadata
	_jsii_.Get(
		j,
		"metadataInput",
		&returns,
...
func (j *jsiiProxy_Secret) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/secret kubernetes_secret} Resource.
...
func (j *jsiiProxy_Secret)SetBinaryData(val *map[string]*string) {
...
func (j *jsiiProxy_Secret)SetData(val *map[string]*string) {
...
func (j *jsiiProxy_Secret)SetImmutable(val interface{}) {
...
func (j *jsiiProxy_Secret)SetType(val *string) {
...
func (s *jsiiProxy_Secret) PutMetadata(value *SecretMetadata) {
...
func (s *jsiiProxy_Secret) ResetImmutable() {
	_jsii_.InvokeVoid(
		s,
		"resetImmutable",
		nil, // no parameters
