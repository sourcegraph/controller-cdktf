...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList) InternalValue() interface{} {
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewValidatingWebhookConfigurationWebhookList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ValidatingWebhookConfigurationWebhookList {
	...
	_jsii_.Create(
		"kubernetes.validatingWebhookConfiguration.ValidatingWebhookConfigurationWebhookList",
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ValidatingWebhookConfigurationWebhookList)SetWrapsSet(val *bool) {
...
func (v *jsiiProxy_ValidatingWebhookConfigurationWebhookList) ComputeFqn() *string {
	var returns *string
...
func (v *jsiiProxy_ValidatingWebhookConfigurationWebhookList) Get(index *float64) ValidatingWebhookConfigurationWebhookOutputReference {
	if err := v.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ValidatingWebhookConfigurationWebhookOutputReference
...
func (v *jsiiProxy_ValidatingWebhookConfigurationWebhookList) ToString() *string {
	var returns *string
