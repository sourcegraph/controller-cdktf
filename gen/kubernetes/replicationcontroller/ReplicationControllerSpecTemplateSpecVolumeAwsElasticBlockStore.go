...
type ReplicationControllerSpecTemplateSpecVolumeAwsElasticBlockStore struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/replication_controller#partition ReplicationController#partition}
