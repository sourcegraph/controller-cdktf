...
func (j *jsiiProxy_ReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList {
	_init_.Initialize()
...
func NewReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList_Override(r ReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (r *jsiiProxy_ReplicationControllerSpecTemplateSpecContainerLifecyclePostStartTcpSocketList) Resolve(_context cdktf.IResolveContext) interface{} {
