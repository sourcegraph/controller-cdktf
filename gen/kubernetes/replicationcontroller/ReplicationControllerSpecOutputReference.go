...
type ReplicationControllerSpecOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *ReplicationControllerSpec
	SetInternalValue(val *ReplicationControllerSpec)
	...
	Template() ReplicationControllerSpecTemplateOutputReference
	TemplateInput() *ReplicationControllerSpecTemplate
	// Experimental.
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) InternalValue() *ReplicationControllerSpec {
	var returns *ReplicationControllerSpec
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) MinReadySeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minReadySeconds",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) MinReadySecondsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) Replicas() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"replicas",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) ReplicasInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"replicasInput",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) Selector() *map[string]*string {
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) SelectorInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"selectorInput",
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) Template() ReplicationControllerSpecTemplateOutputReference {
	var returns ReplicationControllerSpecTemplateOutputReference
	_jsii_.Get(
		j,
		"template",
		&returns,
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) TemplateInput() *ReplicationControllerSpecTemplate {
	var returns *ReplicationControllerSpecTemplate
	_jsii_.Get(
		j,
		"templateInput",
		&returns,
...
func (j *jsiiProxy_ReplicationControllerSpecOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) PutTemplate(value *ReplicationControllerSpecTemplate) {
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) ResetMinReadySeconds() {
	_jsii_.InvokeVoid(
		r,
		"resetMinReadySeconds",
		nil, // no parameters
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) ResetReplicas() {
	_jsii_.InvokeVoid(
		r,
		"resetReplicas",
		nil, // no parameters
...
func (r *jsiiProxy_ReplicationControllerSpecOutputReference) ToString() *string {
	var returns *string
