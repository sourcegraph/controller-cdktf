...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/config_map_v1_data kubernetes_config_map_v1_data}.
type ConfigMapV1Data interface {
	...
	MetadataInput() *ConfigMapV1DataMetadata
	// The tree node.
...
type jsiiProxy_ConfigMapV1Data struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ConfigMapV1Data) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ConfigMapV1Data) Data() *map[string]*string {
...
func (j *jsiiProxy_ConfigMapV1Data) DataInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"dataInput",
...
func (j *jsiiProxy_ConfigMapV1Data) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ConfigMapV1Data) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConfigMapV1Data) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConfigMapV1Data) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ConfigMapV1Data) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ConfigMapV1Data) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ConfigMapV1Data) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfigMapV1Data) Metadata() ConfigMapV1DataMetadataOutputReference {
	var returns ConfigMapV1DataMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_ConfigMapV1Data) MetadataInput() *ConfigMapV1DataMetadata {
...
func (j *jsiiProxy_ConfigMapV1Data) Node() constructs.Node {
...
func (j *jsiiProxy_ConfigMapV1Data) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ConfigMapV1Data) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConfigMapV1Data) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewConfigMapV1Data(scope constructs.Construct, id *string, config *ConfigMapV1DataConfig) ConfigMapV1Data {
	...
	if err := validateNewConfigMapV1DataParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConfigMapV1Data_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigMapV1Data_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConfigMapV1Data_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-kubernetes.configMapV1Data.ConfigMapV1Data",
...
func (c *jsiiProxy_ConfigMapV1Data) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigMapV1Data) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigMapV1Data) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ConfigMapV1Data) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ConfigMapV1Data) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ConfigMapV1Data) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ConfigMapV1Data) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ConfigMapV1Data) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ConfigMapV1Data) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ConfigMapV1Data) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigMapV1Data) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigMapV1Data) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigMapV1Data) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigMapV1Data) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ConfigMapV1Data) PutMetadata(value *ConfigMapV1DataMetadata) {
...
func (c *jsiiProxy_ConfigMapV1Data) ResetForce() {
	_jsii_.InvokeVoid(
		c,
		"resetForce",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMapV1Data) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMapV1Data) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ConfigMapV1Data) ToString() *string {
	var returns *string
