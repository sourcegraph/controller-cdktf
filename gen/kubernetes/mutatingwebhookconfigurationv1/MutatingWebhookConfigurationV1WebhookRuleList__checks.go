...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_MutatingWebhookConfigurationV1WebhookRuleList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*MutatingWebhookConfigurationV1WebhookRule:
		val_ := val.([]*MutatingWebhookConfigurationV1WebhookRule)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
