...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*MutatingWebhookConfigurationV1Webhook:
		val_ := val.([]*MutatingWebhookConfigurationV1Webhook)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_MutatingWebhookConfigurationV1WebhookList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
