...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) InternalValue() interface{} {
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList)SetWrapsSet(val *bool) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) ComputeFqn() *string {
	var returns *string
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) Get(index *float64) HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference {
	if err := h.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns HorizontalPodAutoscalerSpecBehaviorScaleDownOutputReference
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecBehaviorScaleDownList) ToString() *string {
	var returns *string
