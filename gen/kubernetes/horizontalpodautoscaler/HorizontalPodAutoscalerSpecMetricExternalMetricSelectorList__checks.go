...
func (h *jsiiProxy_HorizontalPodAutoscalerSpecMetricExternalMetricSelectorList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_HorizontalPodAutoscalerSpecMetricExternalMetricSelectorList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*HorizontalPodAutoscalerSpecMetricExternalMetricSelector:
		val := val.(*[]*HorizontalPodAutoscalerSpecMetricExternalMetricSelector)
	...
	case []*HorizontalPodAutoscalerSpecMetricExternalMetricSelector:
		val_ := val.([]*HorizontalPodAutoscalerSpecMetricExternalMetricSelector)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*HorizontalPodAutoscalerSpecMetricExternalMetricSelector; received %#v (a %T)", val, val)
		}
	}
