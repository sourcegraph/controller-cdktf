...
type RoleBindingV1RoleRefOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *RoleBindingV1RoleRef
	SetInternalValue(val *RoleBindingV1RoleRef)
	Kind() *string
	SetKind(val *string)
	KindInput() *string
	Name() *string
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) ApiGroupInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiGroupInput",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) InternalValue() *RoleBindingV1RoleRef {
	var returns *RoleBindingV1RoleRef
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) KindInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kindInput",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_RoleBindingV1RoleRefOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func NewRoleBindingV1RoleRefOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RoleBindingV1RoleRefOutputReference {
	...
	_jsii_.Create(
		"kubernetes.roleBindingV1.RoleBindingV1RoleRefOutputReference",
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RoleBindingV1RoleRefOutputReference) ToString() *string {
	var returns *string
