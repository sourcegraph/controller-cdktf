...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/role kubernetes_role}.
type Role interface {
...
func (j *jsiiProxy_Role) Metadata() RoleMetadataOutputReference {
	var returns RoleMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Role) MetadataInput() *RoleMetadata {
...
func (j *jsiiProxy_Role) Rule() RoleRuleList {
	var returns RoleRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
func (r *jsiiProxy_Role) PutMetadata(value *RoleMetadata) {
