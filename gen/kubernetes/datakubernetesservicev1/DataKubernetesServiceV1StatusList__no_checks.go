...
func (d *jsiiProxy_DataKubernetesServiceV1StatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataKubernetesServiceV1StatusList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataKubernetesServiceV1StatusList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataKubernetesServiceV1StatusList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
