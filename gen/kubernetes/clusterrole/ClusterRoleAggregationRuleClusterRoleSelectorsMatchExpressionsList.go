...
func (c *jsiiProxy_ClusterRoleAggregationRuleClusterRoleSelectorsMatchExpressionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
