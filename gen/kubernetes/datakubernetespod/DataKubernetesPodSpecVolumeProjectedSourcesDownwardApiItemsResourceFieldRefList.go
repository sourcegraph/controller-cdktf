...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList {
	_init_.Initialize()
...
func NewDataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList_Override(d DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRefList) Resolve(_context cdktf.IResolveContext) interface{} {
