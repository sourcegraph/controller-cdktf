...
func (d *jsiiProxy_DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRefList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
