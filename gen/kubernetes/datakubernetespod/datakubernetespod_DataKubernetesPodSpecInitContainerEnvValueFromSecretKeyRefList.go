...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"kubernetes.dataKubernetesPod.DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList",
...
func NewDataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList_Override(d DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRefList) Resolve(_context cdktf.IResolveContext) interface{} {
