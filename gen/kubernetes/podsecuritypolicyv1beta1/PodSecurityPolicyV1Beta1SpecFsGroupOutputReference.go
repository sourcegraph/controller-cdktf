...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecFsGroupOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecFsGroupOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
