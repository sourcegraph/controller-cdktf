...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptions:
		val_ := val.([]*PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptions)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
