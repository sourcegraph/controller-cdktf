...
type PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *PodSecurityPolicyV1Beta1SpecSeLinux
	SetInternalValue(val *PodSecurityPolicyV1Beta1SpecSeLinux)
	Rule() *string
	SetRule(val *string)
	RuleInput() *string
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) InternalValue() *PodSecurityPolicyV1Beta1SpecSeLinux {
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) Rule() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rule",
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) RuleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleInput",
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) SeLinuxOptions() PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList {
	var returns PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList
	_jsii_.Get(
		j,
		"seLinuxOptions",
		&returns,
...
func (j *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) ResetSeLinuxOptions() {
	_jsii_.InvokeVoid(
		p,
		"resetSeLinuxOptions",
		nil, // no parameters
...
func (p *jsiiProxy_PodSecurityPolicyV1Beta1SpecSeLinuxOutputReference) ToString() *string {
	var returns *string
