...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/data-sources/config_map_v1 kubernetes_config_map_v1}.
...
func NewDataKubernetesConfigMapV1(scope constructs.Construct, id *string, config *DataKubernetesConfigMapV1Config) DataKubernetesConfigMapV1 {
	...
	_jsii_.Create(
		"kubernetes.dataKubernetesConfigMapV1.DataKubernetesConfigMapV1",
