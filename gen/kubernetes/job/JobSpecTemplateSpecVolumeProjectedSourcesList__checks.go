...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*JobSpecTemplateSpecVolumeProjectedSources:
		val_ := val.([]*JobSpecTemplateSpecVolumeProjectedSources)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_JobSpecTemplateSpecVolumeProjectedSourcesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
