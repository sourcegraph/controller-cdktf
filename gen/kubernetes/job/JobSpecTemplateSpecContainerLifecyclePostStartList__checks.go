...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_JobSpecTemplateSpecContainerLifecyclePostStartList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*JobSpecTemplateSpecContainerLifecyclePostStart:
		val := val.(*[]*JobSpecTemplateSpecContainerLifecyclePostStart)
	...
	case []*JobSpecTemplateSpecContainerLifecyclePostStart:
		val_ := val.([]*JobSpecTemplateSpecContainerLifecyclePostStart)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*JobSpecTemplateSpecContainerLifecyclePostStart; received %#v (a %T)", val, val)
		}
	}
