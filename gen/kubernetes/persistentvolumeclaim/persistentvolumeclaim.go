...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/persistent_volume_claim kubernetes_persistent_volume_claim}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/persistent_volume_claim kubernetes_persistent_volume_claim} Resource.
...
func PersistentVolumeClaim_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePersistentVolumeClaim_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PersistentVolumeClaim) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PersistentVolumeClaim) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PersistentVolumeClaim) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PersistentVolumeClaim) MoveFromId(id *string) {
...
func (p *jsiiProxy_PersistentVolumeClaim) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PersistentVolumeClaim) MoveToId(id *string) {
...
func (p *jsiiProxy_PersistentVolumeClaim) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PersistentVolumeClaim) ToHclTerraform() interface{} {
	var returns interface{}
