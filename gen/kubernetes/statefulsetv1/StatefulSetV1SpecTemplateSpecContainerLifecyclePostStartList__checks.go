...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePostStartList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecContainerLifecyclePostStartList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*StatefulSetV1SpecTemplateSpecContainerLifecyclePostStart:
		val := val.(*[]*StatefulSetV1SpecTemplateSpecContainerLifecyclePostStart)
	...
	case []*StatefulSetV1SpecTemplateSpecContainerLifecyclePostStart:
		val_ := val.([]*StatefulSetV1SpecTemplateSpecContainerLifecyclePostStart)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetV1SpecTemplateSpecContainerLifecyclePostStart; received %#v (a %T)", val, val)
		}
	}
