...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) InternalValue() interface{} {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewStatefulSetV1SpecTemplateSpecInitContainerPortList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StatefulSetV1SpecTemplateSpecInitContainerPortList {
	...
	_jsii_.Create(
		"kubernetes.statefulSetV1.StatefulSetV1SpecTemplateSpecInitContainerPortList",
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) Get(index *float64) StatefulSetV1SpecTemplateSpecInitContainerPortOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns StatefulSetV1SpecTemplateSpecInitContainerPortOutputReference
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerPortList) ToString() *string {
	var returns *string
