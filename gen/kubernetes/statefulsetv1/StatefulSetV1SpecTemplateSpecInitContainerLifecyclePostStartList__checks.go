...
func (s *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStartList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStartList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStart:
		val := val.(*[]*StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStart)
	...
	case []*StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStart:
		val_ := val.([]*StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStart)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetV1SpecTemplateSpecInitContainerLifecyclePostStart; received %#v (a %T)", val, val)
		}
	}
