...
type StatefulSetV1SpecTemplateSpecVolumePersistentVolumeClaim struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set_v1#claim_name StatefulSetV1#claim_name}
