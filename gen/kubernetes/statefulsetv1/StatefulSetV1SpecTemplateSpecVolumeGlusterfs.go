...
type StatefulSetV1SpecTemplateSpecVolumeGlusterfs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set_v1#endpoints_name StatefulSetV1#endpoints_name}
