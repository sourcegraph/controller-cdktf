...
type StatefulSetV1SpecTemplateSpecVolumeNfs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set_v1#server StatefulSetV1#server}
