...
func (s *jsiiProxy_ServiceAccountV1ImagePullSecretList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (s *jsiiProxy_ServiceAccountV1ImagePullSecretList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_ServiceAccountV1ImagePullSecretList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ServiceAccountV1ImagePullSecretList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
