...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/service_account_v1 kubernetes_service_account_v1}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/service_account_v1 kubernetes_service_account_v1} Resource.
...
func ServiceAccountV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceAccountV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceAccountV1) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceAccountV1) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServiceAccountV1) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServiceAccountV1) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServiceAccountV1) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServiceAccountV1) MoveToId(id *string) {
...
func (s *jsiiProxy_ServiceAccountV1) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServiceAccountV1) ToHclTerraform() interface{} {
	var returns interface{}
