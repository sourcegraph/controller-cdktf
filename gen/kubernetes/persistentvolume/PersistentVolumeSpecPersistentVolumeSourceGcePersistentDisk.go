...
type PersistentVolumeSpecPersistentVolumeSourceGcePersistentDisk struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/persistent_volume#pd_name PersistentVolume#pd_name}
