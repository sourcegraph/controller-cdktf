...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/service kubernetes_service}.
type Service interface {
	...
	PutMetadata(value *ServiceMetadata)
	PutSpec(value *ServiceSpec)
...
func (j *jsiiProxy_Service) Metadata() ServiceMetadataOutputReference {
	var returns ServiceMetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_Service) MetadataInput() *ServiceMetadata {
...
func (j *jsiiProxy_Service) Spec() ServiceSpecOutputReference {
	var returns ServiceSpecOutputReference
	_jsii_.Get(
		j,
		"spec",
		&returns,
...
func (j *jsiiProxy_Service) SpecInput() *ServiceSpec {
...
func (j *jsiiProxy_Service) Status() ServiceStatusList {
	var returns ServiceStatusList
	_jsii_.Get(
		j,
		"status",
		&returns,
...
func (j *jsiiProxy_Service) WaitForLoadBalancer() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"waitForLoadBalancer",
...
func (j *jsiiProxy_Service) WaitForLoadBalancerInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/service kubernetes_service} Resource.
...
func (j *jsiiProxy_Service)SetWaitForLoadBalancer(val interface{}) {
...
func (s *jsiiProxy_Service) PutMetadata(value *ServiceMetadata) {
...
func (s *jsiiProxy_Service) PutSpec(value *ServiceSpec) {
...
func (s *jsiiProxy_Service) ResetWaitForLoadBalancer() {
	_jsii_.InvokeVoid(
		s,
		"resetWaitForLoadBalancer",
		nil, // no parameters
