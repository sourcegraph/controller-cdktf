...
func (d *jsiiProxy_DeploymentSpecTemplateSpecInitContainerList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecInitContainerList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*DeploymentSpecTemplateSpecInitContainer:
		val_ := val.([]*DeploymentSpecTemplateSpecInitContainer)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
