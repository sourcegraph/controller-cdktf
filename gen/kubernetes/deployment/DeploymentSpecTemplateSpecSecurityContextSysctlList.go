...
func (j *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextSysctlList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDeploymentSpecTemplateSpecSecurityContextSysctlList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DeploymentSpecTemplateSpecSecurityContextSysctlList {
	_init_.Initialize()
...
func NewDeploymentSpecTemplateSpecSecurityContextSysctlList_Override(d DeploymentSpecTemplateSpecSecurityContextSysctlList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextSysctlList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextSysctlList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecSecurityContextSysctlList) Resolve(_context cdktf.IResolveContext) interface{} {
