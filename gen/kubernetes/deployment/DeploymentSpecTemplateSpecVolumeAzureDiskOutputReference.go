...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeAzureDiskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecTemplateSpecVolumeAzureDiskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
