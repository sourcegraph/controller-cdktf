...
func (d *jsiiProxy_DeploymentSpecOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeploymentSpecOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
