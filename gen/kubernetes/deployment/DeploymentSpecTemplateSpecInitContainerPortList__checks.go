...
func (d *jsiiProxy_DeploymentSpecTemplateSpecInitContainerPortList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecInitContainerPortList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DeploymentSpecTemplateSpecInitContainerPort:
		val := val.(*[]*DeploymentSpecTemplateSpecInitContainerPort)
	...
	case []*DeploymentSpecTemplateSpecInitContainerPort:
		val_ := val.([]*DeploymentSpecTemplateSpecInitContainerPort)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DeploymentSpecTemplateSpecInitContainerPort; received %#v (a %T)", val, val)
		}
	}
