...
func (d *jsiiProxy_DeploymentSpecTemplateSpecInitContainerVolumeMountList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DeploymentSpecTemplateSpecInitContainerVolumeMountList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DeploymentSpecTemplateSpecInitContainerVolumeMount:
		val := val.(*[]*DeploymentSpecTemplateSpecInitContainerVolumeMount)
	...
	case []*DeploymentSpecTemplateSpecInitContainerVolumeMount:
		val_ := val.([]*DeploymentSpecTemplateSpecInitContainerVolumeMount)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DeploymentSpecTemplateSpecInitContainerVolumeMount; received %#v (a %T)", val, val)
		}
	}
