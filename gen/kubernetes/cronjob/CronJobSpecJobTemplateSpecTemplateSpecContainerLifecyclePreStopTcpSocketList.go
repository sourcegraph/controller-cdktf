...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList {
	_init_.Initialize()
...
func NewCronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList_Override(c CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerLifecyclePreStopTcpSocketList) Resolve(_context cdktf.IResolveContext) interface{} {
