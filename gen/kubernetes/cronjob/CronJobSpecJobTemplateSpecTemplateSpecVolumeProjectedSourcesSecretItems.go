...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeProjectedSourcesSecretItems struct {
	// The key to project.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/cron_job#mode CronJob#mode}
