...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) InternalValue() interface{} {
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewCronJobSpecJobTemplateSpecTemplateSpecHostAliasesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList {
	...
	_jsii_.Create(
		"kubernetes.cronJob.CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList",
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) Get(index *float64) CronJobSpecJobTemplateSpecTemplateSpecHostAliasesOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns CronJobSpecJobTemplateSpecTemplateSpecHostAliasesOutputReference
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecHostAliasesList) ToString() *string {
	var returns *string
