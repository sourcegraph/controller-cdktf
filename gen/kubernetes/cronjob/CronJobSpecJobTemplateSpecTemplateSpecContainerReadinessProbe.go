...
type CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe struct {
	// exec block.
	//
	...
	Exec *CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
