...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeNfs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/cron_job#server CronJob#server}
