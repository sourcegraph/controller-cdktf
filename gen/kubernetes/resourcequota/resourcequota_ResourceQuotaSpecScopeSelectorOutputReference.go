...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) InternalValue() *ResourceQuotaSpecScopeSelector {
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) MatchExpression() ResourceQuotaSpecScopeSelectorMatchExpressionList {
	var returns ResourceQuotaSpecScopeSelectorMatchExpressionList
	_jsii_.Get(
		j,
		"matchExpression",
		&returns,
...
func (j *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func NewResourceQuotaSpecScopeSelectorOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ResourceQuotaSpecScopeSelectorOutputReference {
	...
	_jsii_.Create(
		"kubernetes.resourceQuota.ResourceQuotaSpecScopeSelectorOutputReference",
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) ResetMatchExpression() {
	_jsii_.InvokeVoid(
		r,
		"resetMatchExpression",
		nil, // no parameters
...
func (r *jsiiProxy_ResourceQuotaSpecScopeSelectorOutputReference) ToString() *string {
	var returns *string
