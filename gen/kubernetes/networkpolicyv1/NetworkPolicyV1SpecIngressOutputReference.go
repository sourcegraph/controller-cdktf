...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) From() NetworkPolicyV1SpecIngressFromList {
	var returns NetworkPolicyV1SpecIngressFromList
	_jsii_.Get(
		j,
		"from",
		&returns,
...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) Ports() NetworkPolicyV1SpecIngressPortsList {
	var returns NetworkPolicyV1SpecIngressPortsList
	_jsii_.Get(
		j,
		"ports",
		&returns,
...
func (j *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) ResetFrom() {
	_jsii_.InvokeVoid(
		n,
		"resetFrom",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) ResetPorts() {
	_jsii_.InvokeVoid(
		n,
		"resetPorts",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicyV1SpecIngressOutputReference) ToString() *string {
	var returns *string
