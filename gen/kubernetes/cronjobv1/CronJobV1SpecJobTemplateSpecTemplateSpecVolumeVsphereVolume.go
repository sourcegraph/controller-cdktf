...
type CronJobV1SpecJobTemplateSpecTemplateSpecVolumeVsphereVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/cron_job_v1#volume_path CronJobV1#volume_path}
