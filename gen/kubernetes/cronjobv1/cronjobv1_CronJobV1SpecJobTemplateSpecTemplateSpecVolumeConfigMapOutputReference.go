...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) ItemsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"itemsInput",
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) Optional() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optional",
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) OptionalInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionalInput",
...
func NewCronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference {
	...
	_jsii_.Create(
		"kubernetes.cronJobV1.CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference",
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference)SetOptional(val interface{}) {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) PutItems(value interface{}) {
...
func (c *jsiiProxy_CronJobV1SpecJobTemplateSpecTemplateSpecVolumeConfigMapOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
