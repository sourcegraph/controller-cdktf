...
type CronJobV1SpecJobTemplateSpecTemplateSpecVolumeFlexVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/cron_job_v1#options CronJobV1#options}
