...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "globalDefault", GoGetter: "GlobalDefault"},
			_jsii_.MemberProperty{JsiiProperty: "globalDefaultInput", GoGetter: "GlobalDefaultInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "preemptionPolicy", GoGetter: "PreemptionPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "preemptionPolicyInput", GoGetter: "PreemptionPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPreemptionPolicy", GoMethod: "ResetPreemptionPolicy"},
