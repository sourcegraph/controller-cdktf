...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/kubernetes/priorityclassv1/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/priority_class_v1 kubernetes_priority_class_v1}.
type PriorityClassV1 interface {
	...
	PutMetadata(value *PriorityClassV1Metadata)
	ResetDescription()
	ResetGlobalDefault()
	ResetId()
...
type jsiiProxy_PriorityClassV1 struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_PriorityClassV1) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_PriorityClassV1) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_PriorityClassV1) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_PriorityClassV1) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_PriorityClassV1) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_PriorityClassV1) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PriorityClassV1) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_PriorityClassV1) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PriorityClassV1) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PriorityClassV1) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PriorityClassV1) Metadata() PriorityClassV1MetadataOutputReference {
	var returns PriorityClassV1MetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_PriorityClassV1) MetadataInput() *PriorityClassV1Metadata {
	var returns *PriorityClassV1Metadata
	_jsii_.Get(
		j,
		"metadataInput",
		&returns,
...
func (j *jsiiProxy_PriorityClassV1) Node() constructs.Node {
...
func (j *jsiiProxy_PriorityClassV1) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PriorityClassV1) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PriorityClassV1) Value() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_PriorityClassV1) ValueInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"valueInput",
...
func NewPriorityClassV1(scope constructs.Construct, id *string, config *PriorityClassV1Config) PriorityClassV1 {
	...
	if err := validateNewPriorityClassV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PriorityClassV1_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePriorityClassV1_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PriorityClassV1_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-kubernetes.priorityClassV1.PriorityClassV1",
...
func (p *jsiiProxy_PriorityClassV1) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PriorityClassV1) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PriorityClassV1) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PriorityClassV1) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PriorityClassV1) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PriorityClassV1) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PriorityClassV1) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PriorityClassV1) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PriorityClassV1) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PriorityClassV1) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PriorityClassV1) OverrideLogicalId(newLogicalId *string) {
...
func (p *jsiiProxy_PriorityClassV1) PutMetadata(value *PriorityClassV1Metadata) {
...
func (p *jsiiProxy_PriorityClassV1) ResetDescription() {
	_jsii_.InvokeVoid(
		p,
		"resetDescription",
		nil, // no parameters
...
func (p *jsiiProxy_PriorityClassV1) ResetGlobalDefault() {
	_jsii_.InvokeVoid(
		p,
		"resetGlobalDefault",
		nil, // no parameters
...
func (p *jsiiProxy_PriorityClassV1) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PriorityClassV1) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		p,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (p *jsiiProxy_PriorityClassV1) ToString() *string {
	var returns *string
