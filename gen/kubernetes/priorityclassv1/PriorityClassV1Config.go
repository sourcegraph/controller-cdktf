...
type PriorityClassV1Config struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/priority_class_v1#value PriorityClassV1#value}
	Value *float64 `field:"required" json:"value" yaml:"value"`
	// An arbitrary string that usually provides guidelines on when this priority class should be used.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/priority_class_v1#description PriorityClassV1#description}
