...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerVolumeMountList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecInitContainerVolumeMountList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*StatefulSetSpecTemplateSpecInitContainerVolumeMount:
		val := val.(*[]*StatefulSetSpecTemplateSpecInitContainerVolumeMount)
	...
	case []*StatefulSetSpecTemplateSpecInitContainerVolumeMount:
		val_ := val.([]*StatefulSetSpecTemplateSpecInitContainerVolumeMount)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetSpecTemplateSpecInitContainerVolumeMount; received %#v (a %T)", val, val)
		}
	}
