...
type StatefulSetSpecTemplateSpecContainerStartupProbe struct {
	// exec block.
	//
	...
	Exec *StatefulSetSpecTemplateSpecContainerStartupProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
