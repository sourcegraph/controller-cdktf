...
type StatefulSetSpec struct {
	// selector block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#selector StatefulSet#selector}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#service_name StatefulSet#service_name}
	ServiceName *string `field:"required" json:"serviceName" yaml:"serviceName"`
	// template block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#template StatefulSet#template}
	Template *StatefulSetSpecTemplate `field:"required" json:"template" yaml:"template"`
	// Controls how pods are created during initial scale up, when replacing pods on nodes, or when scaling down.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#pod_management_policy StatefulSet#pod_management_policy}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#replicas StatefulSet#replicas}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#revision_history_limit StatefulSet#revision_history_limit}
