...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecImagePullSecretsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecImagePullSecretsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*StatefulSetSpecTemplateSpecImagePullSecrets:
		val := val.(*[]*StatefulSetSpecTemplateSpecImagePullSecrets)
	...
	case []*StatefulSetSpecTemplateSpecImagePullSecrets:
		val_ := val.([]*StatefulSetSpecTemplateSpecImagePullSecrets)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetSpecTemplateSpecImagePullSecrets; received %#v (a %T)", val, val)
		}
	}
