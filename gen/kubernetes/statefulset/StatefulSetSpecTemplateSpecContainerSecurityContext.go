...
type StatefulSetSpecTemplateSpecContainerSecurityContext struct {
	...
	Capabilities *StatefulSetSpecTemplateSpecContainerSecurityContextCapabilities `field:"optional" json:"capabilities" yaml:"capabilities"`
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#run_as_group StatefulSet#run_as_group}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#run_as_user StatefulSet#run_as_user}
	RunAsUser *string `field:"optional" json:"runAsUser" yaml:"runAsUser"`
	// seccomp_profile block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/stateful_set#seccomp_profile StatefulSet#seccomp_profile}
	SeccompProfile *StatefulSetSpecTemplateSpecContainerSecurityContextSeccompProfile `field:"optional" json:"seccompProfile" yaml:"seccompProfile"`
