...
type StatefulSetSpecTemplateSpecInitContainerLivenessProbe struct {
	// exec block.
	//
	...
	Exec *StatefulSetSpecTemplateSpecInitContainerLivenessProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *StatefulSetSpecTemplateSpecInitContainerLivenessProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
