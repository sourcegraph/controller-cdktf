...
type StatefulSetSpecTemplateSpecInitContainerStartupProbe struct {
	// exec block.
	//
	...
	Exec *StatefulSetSpecTemplateSpecInitContainerStartupProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *StatefulSetSpecTemplateSpecInitContainerStartupProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
