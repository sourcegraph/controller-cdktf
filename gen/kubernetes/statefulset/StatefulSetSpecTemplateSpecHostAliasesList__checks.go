...
func (s *jsiiProxy_StatefulSetSpecTemplateSpecHostAliasesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_StatefulSetSpecTemplateSpecHostAliasesList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*StatefulSetSpecTemplateSpecHostAliases:
		val := val.(*[]*StatefulSetSpecTemplateSpecHostAliases)
	...
	case []*StatefulSetSpecTemplateSpecHostAliases:
		val_ := val.([]*StatefulSetSpecTemplateSpecHostAliases)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetSpecTemplateSpecHostAliases; received %#v (a %T)", val, val)
		}
	}
