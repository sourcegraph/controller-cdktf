...
type CertificateSigningRequestV1 interface {
	...
	PutMetadata(value *CertificateSigningRequestV1Metadata)
	PutSpec(value *CertificateSigningRequestV1Spec)
	PutTimeouts(value *CertificateSigningRequestV1Timeouts)
	ResetAutoApprove()
	ResetId()
...
func (j *jsiiProxy_CertificateSigningRequestV1) Certificate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificate",
...
func (j *jsiiProxy_CertificateSigningRequestV1) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CertificateSigningRequestV1) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CertificateSigningRequestV1) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CertificateSigningRequestV1) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CertificateSigningRequestV1) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CertificateSigningRequestV1) Metadata() CertificateSigningRequestV1MetadataOutputReference {
	var returns CertificateSigningRequestV1MetadataOutputReference
	_jsii_.Get(
		j,
		"metadata",
		&returns,
...
func (j *jsiiProxy_CertificateSigningRequestV1) MetadataInput() *CertificateSigningRequestV1Metadata {
...
func (j *jsiiProxy_CertificateSigningRequestV1) Node() constructs.Node {
...
func (j *jsiiProxy_CertificateSigningRequestV1) Spec() CertificateSigningRequestV1SpecOutputReference {
	var returns CertificateSigningRequestV1SpecOutputReference
	_jsii_.Get(
		j,
		"spec",
		&returns,
...
func (j *jsiiProxy_CertificateSigningRequestV1) SpecInput() *CertificateSigningRequestV1Spec {
	var returns *CertificateSigningRequestV1Spec
	_jsii_.Get(
		j,
		"specInput",
		&returns,
...
func (j *jsiiProxy_CertificateSigningRequestV1) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CertificateSigningRequestV1) Timeouts() CertificateSigningRequestV1TimeoutsOutputReference {
	var returns CertificateSigningRequestV1TimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewCertificateSigningRequestV1(scope constructs.Construct, id *string, config *CertificateSigningRequestV1Config) CertificateSigningRequestV1 {
	...
	if err := validateNewCertificateSigningRequestV1Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CertificateSigningRequestV1_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-kubernetes.certificateSigningRequestV1.CertificateSigningRequestV1",
...
func (c *jsiiProxy_CertificateSigningRequestV1) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_CertificateSigningRequestV1) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CertificateSigningRequestV1) MoveFromId(id *string) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) MoveToId(id *string) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) PutMetadata(value *CertificateSigningRequestV1Metadata) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) PutSpec(value *CertificateSigningRequestV1Spec) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) PutTimeouts(value *CertificateSigningRequestV1Timeouts) {
...
func (c *jsiiProxy_CertificateSigningRequestV1) ResetAutoApprove() {
	_jsii_.InvokeVoid(
		c,
		"resetAutoApprove",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateSigningRequestV1) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateSigningRequestV1) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateSigningRequestV1) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateSigningRequestV1) ToString() *string {
	var returns *string
