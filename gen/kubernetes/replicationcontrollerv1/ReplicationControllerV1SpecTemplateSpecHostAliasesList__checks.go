...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecHostAliasesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecHostAliasesList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ReplicationControllerV1SpecTemplateSpecHostAliases:
		val := val.(*[]*ReplicationControllerV1SpecTemplateSpecHostAliases)
	...
	case []*ReplicationControllerV1SpecTemplateSpecHostAliases:
		val_ := val.([]*ReplicationControllerV1SpecTemplateSpecHostAliases)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ReplicationControllerV1SpecTemplateSpecHostAliases; received %#v (a %T)", val, val)
		}
	}
