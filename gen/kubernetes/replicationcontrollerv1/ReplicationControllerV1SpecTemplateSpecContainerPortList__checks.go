...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerPortList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerPortList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*ReplicationControllerV1SpecTemplateSpecContainerPort:
		val := val.(*[]*ReplicationControllerV1SpecTemplateSpecContainerPort)
	...
	case []*ReplicationControllerV1SpecTemplateSpecContainerPort:
		val_ := val.([]*ReplicationControllerV1SpecTemplateSpecContainerPort)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ReplicationControllerV1SpecTemplateSpecContainerPort; received %#v (a %T)", val, val)
		}
	}
