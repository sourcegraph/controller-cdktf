...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItemsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItemsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItems:
		val := val.(*[]*ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItems)
	...
	case []*ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItems:
		val_ := val.([]*ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItems)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ReplicationControllerV1SpecTemplateSpecVolumeConfigMapItems; received %#v (a %T)", val, val)
		}
	}
