...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedTopologiesInput", GoGetter: "AllowedTopologiesInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowVolumeExpansion", GoGetter: "AllowVolumeExpansion"},
			_jsii_.MemberProperty{JsiiProperty: "allowVolumeExpansionInput", GoGetter: "AllowVolumeExpansionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAllowedTopologies", GoMethod: "PutAllowedTopologies"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetReclaimPolicy", GoMethod: "ResetReclaimPolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resetVolumeBindingMode", GoMethod: "ResetVolumeBindingMode"},
			_jsii_.MemberProperty{JsiiProperty: "storageProvisioner", GoGetter: "StorageProvisioner"},
	...
	_jsii_.RegisterStruct(
		"kubernetes.dataKubernetesStorageClass.DataKubernetesStorageClassAllowedTopologies",
		reflect.TypeOf((*DataKubernetesStorageClassAllowedTopologies)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"kubernetes.dataKubernetesStorageClass.DataKubernetesStorageClassAllowedTopologiesMatchLabelExpressions",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "matchLabelExpressions", GoGetter: "MatchLabelExpressions"},
			_jsii_.MemberProperty{JsiiProperty: "matchLabelExpressionsInput", GoGetter: "MatchLabelExpressionsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putMatchLabelExpressions", GoMethod: "PutMatchLabelExpressions"},
			_jsii_.MemberMethod{JsiiMethod: "resetMatchLabelExpressions", GoMethod: "ResetMatchLabelExpressions"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"kubernetes.dataKubernetesStorageClass.DataKubernetesStorageClassConfig",
		reflect.TypeOf((*DataKubernetesStorageClassConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"kubernetes.dataKubernetesStorageClass.DataKubernetesStorageClassMetadata",
		reflect.TypeOf((*DataKubernetesStorageClassMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"kubernetes.dataKubernetesStorageClass.DataKubernetesStorageClassMetadataOutputReference",
