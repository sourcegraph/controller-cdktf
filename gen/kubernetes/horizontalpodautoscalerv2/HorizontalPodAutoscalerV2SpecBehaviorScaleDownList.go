...
func (j *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorScaleDownList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewHorizontalPodAutoscalerV2SpecBehaviorScaleDownList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HorizontalPodAutoscalerV2SpecBehaviorScaleDownList {
	...
	_jsii_.Create(
		"@cdktf/provider-kubernetes.horizontalPodAutoscalerV2.HorizontalPodAutoscalerV2SpecBehaviorScaleDownList",
...
func (j *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorScaleDownList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorScaleDownList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecBehaviorScaleDownList) Resolve(_context cdktf.IResolveContext) interface{} {
