...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecMetricExternalMetricSelectorList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_HorizontalPodAutoscalerV2SpecMetricExternalMetricSelectorList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector:
		val := val.(*[]*HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector)
	...
	case []*HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector:
		val_ := val.([]*HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector; received %#v (a %T)", val, val)
		}
	}
