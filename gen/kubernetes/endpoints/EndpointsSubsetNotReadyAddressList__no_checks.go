...
func (e *jsiiProxy_EndpointsSubsetNotReadyAddressList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (e *jsiiProxy_EndpointsSubsetNotReadyAddressList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_EndpointsSubsetNotReadyAddressList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_EndpointsSubsetNotReadyAddressList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
