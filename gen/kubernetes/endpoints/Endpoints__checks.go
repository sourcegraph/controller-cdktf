...
func (e *jsiiProxy_Endpoints) validatePutSubsetParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EndpointsSubset; received %#v (a %T)", value, value)
		}
	}
