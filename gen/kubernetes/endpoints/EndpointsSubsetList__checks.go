...
func (e *jsiiProxy_EndpointsSubsetList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_EndpointsSubsetList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*EndpointsSubset:
		val := val.(*[]*EndpointsSubset)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*EndpointsSubset; received %#v (a %T)", val, val)
		}
	}
