...
func (d *jsiiProxy_DaemonsetSpecSelectorMatchExpressionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DaemonsetSpecSelectorMatchExpressionsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DaemonsetSpecSelectorMatchExpressions:
		val := val.(*[]*DaemonsetSpecSelectorMatchExpressions)
	...
	case []*DaemonsetSpecSelectorMatchExpressions:
		val_ := val.([]*DaemonsetSpecSelectorMatchExpressions)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DaemonsetSpecSelectorMatchExpressions; received %#v (a %T)", val, val)
		}
	}
