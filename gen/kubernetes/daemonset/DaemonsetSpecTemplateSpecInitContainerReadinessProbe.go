...
type DaemonsetSpecTemplateSpecInitContainerReadinessProbe struct {
	// exec block.
	//
	...
	Exec *DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec `field:"optional" json:"exec" yaml:"exec"`
	...
	HttpGet *DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet `field:"optional" json:"httpGet" yaml:"httpGet"`
