...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) InternalValue() interface{} {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) Get(index *float64) DaemonsetSpecTemplateSpecInitContainerOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DaemonsetSpecTemplateSpecInitContainerOutputReference
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecInitContainerList) ToString() *string {
	var returns *string
