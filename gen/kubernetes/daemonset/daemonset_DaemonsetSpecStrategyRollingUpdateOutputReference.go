...
func (j *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDaemonsetSpecStrategyRollingUpdateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DaemonsetSpecStrategyRollingUpdateOutputReference {
	_init_.Initialize()
...
func NewDaemonsetSpecStrategyRollingUpdateOutputReference_Override(d DaemonsetSpecStrategyRollingUpdateOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonsetSpecStrategyRollingUpdateOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
