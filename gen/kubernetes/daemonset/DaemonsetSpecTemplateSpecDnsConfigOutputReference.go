...
type DaemonsetSpecTemplateSpecDnsConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *DaemonsetSpecTemplateSpecDnsConfig
	SetInternalValue(val *DaemonsetSpecTemplateSpecDnsConfig)
	Nameservers() *[]*string
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) InternalValue() *DaemonsetSpecTemplateSpecDnsConfig {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) Nameservers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nameservers",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) NameserversInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nameserversInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) Option() DaemonsetSpecTemplateSpecDnsConfigOptionList {
	var returns DaemonsetSpecTemplateSpecDnsConfigOptionList
	_jsii_.Get(
		j,
		"option",
		&returns,
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) Searches() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"searches",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) SearchesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"searchesInput",
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ResetNameservers() {
	_jsii_.InvokeVoid(
		d,
		"resetNameservers",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ResetOption() {
	_jsii_.InvokeVoid(
		d,
		"resetOption",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ResetSearches() {
	_jsii_.InvokeVoid(
		d,
		"resetSearches",
		nil, // no parameters
...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecDnsConfigOutputReference) ToString() *string {
	var returns *string
