...
func (d *jsiiProxy_DaemonsetSpecTemplateSpecTolerationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DaemonsetSpecTemplateSpecTolerationList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DaemonsetSpecTemplateSpecToleration:
		val := val.(*[]*DaemonsetSpecTemplateSpecToleration)
	...
	case []*DaemonsetSpecTemplateSpecToleration:
		val_ := val.([]*DaemonsetSpecTemplateSpecToleration)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DaemonsetSpecTemplateSpecToleration; received %#v (a %T)", val, val)
		}
	}
