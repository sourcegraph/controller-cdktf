...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList) InternalValue() interface{} {
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ClusterRoleBindingV1SubjectList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ClusterRoleBindingV1SubjectList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ClusterRoleBindingV1SubjectList) Get(index *float64) ClusterRoleBindingV1SubjectOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ClusterRoleBindingV1SubjectOutputReference
...
func (c *jsiiProxy_ClusterRoleBindingV1SubjectList) ToString() *string {
	var returns *string
