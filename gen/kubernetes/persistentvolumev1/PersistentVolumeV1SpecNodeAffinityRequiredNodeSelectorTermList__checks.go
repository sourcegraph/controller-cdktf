...
func (p *jsiiProxy_PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (p *jsiiProxy_PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTerm:
		val_ := val.([]*PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTerm)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
