...
func init() {
	...
	_jsii_.RegisterStruct(
		"kubernetes.limitRange.LimitRangeConfig",
		reflect.TypeOf((*LimitRangeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"kubernetes.limitRange.LimitRangeMetadata",
	...
	_jsii_.RegisterStruct(
		"kubernetes.limitRange.LimitRangeSpec",
		reflect.TypeOf((*LimitRangeSpec)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"kubernetes.limitRange.LimitRangeSpecLimit",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultRequest", GoGetter: "DefaultRequest"},
			_jsii_.MemberProperty{JsiiProperty: "defaultRequestInput", GoGetter: "DefaultRequestInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxLimitRequestRatio", GoGetter: "MaxLimitRequestRatio"},
			_jsii_.MemberProperty{JsiiProperty: "maxLimitRequestRatioInput", GoGetter: "MaxLimitRequestRatioInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultRequest", GoMethod: "ResetDefaultRequest"},
			_jsii_.MemberMethod{JsiiMethod: "resetMax", GoMethod: "ResetMax"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxLimitRequestRatio", GoMethod: "ResetMaxLimitRequestRatio"},
	...
	_jsii_.RegisterClass(
		"kubernetes.limitRange.LimitRangeSpecOutputReference",
