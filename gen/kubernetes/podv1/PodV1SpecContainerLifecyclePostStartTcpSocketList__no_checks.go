...
func (p *jsiiProxy_PodV1SpecContainerLifecyclePostStartTcpSocketList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (p *jsiiProxy_PodV1SpecContainerLifecyclePostStartTcpSocketList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_PodV1SpecContainerLifecyclePostStartTcpSocketList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_PodV1SpecContainerLifecyclePostStartTcpSocketList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
