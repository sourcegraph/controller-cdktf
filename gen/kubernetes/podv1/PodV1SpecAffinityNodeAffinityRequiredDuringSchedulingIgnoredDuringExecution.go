...
type PodV1SpecAffinityNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.15.0/docs/resources/pod_v1#node_selector_term PodV1#node_selector_term}
