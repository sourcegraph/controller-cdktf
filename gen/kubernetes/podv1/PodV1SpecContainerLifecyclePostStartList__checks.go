...
func (p *jsiiProxy_PodV1SpecContainerLifecyclePostStartList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_PodV1SpecContainerLifecyclePostStartList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*PodV1SpecContainerLifecyclePostStart:
		val := val.(*[]*PodV1SpecContainerLifecyclePostStart)
	...
	case []*PodV1SpecContainerLifecyclePostStart:
		val_ := val.([]*PodV1SpecContainerLifecyclePostStart)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*PodV1SpecContainerLifecyclePostStart; received %#v (a %T)", val, val)
		}
	}
