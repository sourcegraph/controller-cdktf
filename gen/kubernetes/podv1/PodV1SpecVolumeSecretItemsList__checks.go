...
func (j *jsiiProxy_PodV1SpecVolumeSecretItemsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*PodV1SpecVolumeSecretItems:
		val := val.(*[]*PodV1SpecVolumeSecretItems)
	...
	case []*PodV1SpecVolumeSecretItems:
		val_ := val.([]*PodV1SpecVolumeSecretItems)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*PodV1SpecVolumeSecretItems; received %#v (a %T)", val, val)
		}
	}
