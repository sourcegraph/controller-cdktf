...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lastsFor", GoGetter: "LastsFor"},
			_jsii_.MemberProperty{JsiiProperty: "lastsForInput", GoGetter: "LastsForInput"},
			_jsii_.MemberProperty{JsiiProperty: "measurement", GoGetter: "Measurement"},
			_jsii_.MemberProperty{JsiiProperty: "measurementInput", GoGetter: "MeasurementInput"},
			_jsii_.MemberProperty{JsiiProperty: "op", GoGetter: "Op"},
			_jsii_.MemberProperty{JsiiProperty: "opInput", GoGetter: "OpInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlertingWindow", GoMethod: "ResetAlertingWindow"},
			_jsii_.MemberMethod{JsiiMethod: "resetLastsFor", GoMethod: "ResetLastsFor"},
