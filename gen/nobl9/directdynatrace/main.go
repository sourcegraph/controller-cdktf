...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dynatraceToken", GoGetter: "DynatraceToken"},
			_jsii_.MemberProperty{JsiiProperty: "dynatraceTokenInput", GoGetter: "DynatraceTokenInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDynatraceToken", GoMethod: "ResetDynatraceToken"},
