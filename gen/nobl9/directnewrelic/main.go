...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "insightsQueryKey", GoGetter: "InsightsQueryKey"},
			_jsii_.MemberProperty{JsiiProperty: "insightsQueryKeyInput", GoGetter: "InsightsQueryKeyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInsightsQueryKey", GoMethod: "ResetInsightsQueryKey"},
