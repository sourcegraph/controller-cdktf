...
func (r *jsiiProxy_RoleBinding) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func (j *jsiiProxy_RoleBinding) validateSetDisplayNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_RoleBinding) validateSetNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_RoleBinding) validateSetProjectRefParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_RoleBinding) validateSetRoleRefParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_RoleBinding) validateSetUserParameters(val *string) error {
	return nil
}
