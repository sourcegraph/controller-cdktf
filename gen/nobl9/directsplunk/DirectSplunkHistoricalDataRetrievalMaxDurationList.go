...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) InternalValue() interface{} {
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) Get(index *float64) DirectSplunkHistoricalDataRetrievalMaxDurationOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DirectSplunkHistoricalDataRetrievalMaxDurationOutputReference
...
func (d *jsiiProxy_DirectSplunkHistoricalDataRetrievalMaxDurationList) ToString() *string {
	var returns *string
