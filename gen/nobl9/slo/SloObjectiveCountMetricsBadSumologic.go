...
type SloObjectiveCountMetricsBadSumologic struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#type Slo#type}
	Type *string `field:"required" json:"type" yaml:"type"`
	// Period of data aggregation.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#quantization Slo#quantization}
	Quantization *string `field:"optional" json:"quantization" yaml:"quantization"`
	// Aggregation function - avg, sum, min, max, count, none.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#rollup Slo#rollup}
