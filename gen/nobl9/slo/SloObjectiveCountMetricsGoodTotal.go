...
type SloObjectiveCountMetricsGoodTotal struct {
	...
	Honeycomb interface{} `field:"optional" json:"honeycomb" yaml:"honeycomb"`
	// influxdb block.
	//
	...
	LogicMonitor interface{} `field:"optional" json:"logicMonitor" yaml:"logicMonitor"`
	// newrelic block.
	//
