...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) InternalValue() interface{} {
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) Get(index *float64) SloObjectiveCountMetricsGoodLogicMonitorOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SloObjectiveCountMetricsGoodLogicMonitorOutputReference
...
func (s *jsiiProxy_SloObjectiveCountMetricsGoodLogicMonitorList) ToString() *string {
	var returns *string
