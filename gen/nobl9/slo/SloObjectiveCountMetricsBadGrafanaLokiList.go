...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) InternalValue() interface{} {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) Get(index *float64) SloObjectiveCountMetricsBadGrafanaLokiOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SloObjectiveCountMetricsBadGrafanaLokiOutputReference
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadGrafanaLokiList) ToString() *string {
	var returns *string
