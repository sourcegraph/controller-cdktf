...
type SloObjectiveCountMetricsGoodElasticsearch struct {
	// Index of metrics we want to query.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#index Slo#index}
