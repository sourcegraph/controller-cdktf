...
type SloObjectiveCountMetricsGoodTotalInstanaInfrastructure struct {
	// Metric ID.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#metric_retrieval_method Slo#metric_retrieval_method}
	MetricRetrievalMethod *string `field:"required" json:"metricRetrievalMethod" yaml:"metricRetrievalMethod"`
	// Plugin ID.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#plugin_id Slo#plugin_id}
	...
	// Snapshot ID.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#snapshot_id Slo#snapshot_id}
