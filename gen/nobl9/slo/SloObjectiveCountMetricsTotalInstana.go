...
type SloObjectiveCountMetricsTotalInstana struct {
	// Instana metric type 'application' or 'infrastructure'.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nobl9/nobl9/0.37.0/docs/resources/slo#metric_type Slo#metric_type}
