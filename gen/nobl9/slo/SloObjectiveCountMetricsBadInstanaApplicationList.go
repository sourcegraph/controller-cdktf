...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) InternalValue() interface{} {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) Get(index *float64) SloObjectiveCountMetricsBadInstanaApplicationOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SloObjectiveCountMetricsBadInstanaApplicationOutputReference
...
func (s *jsiiProxy_SloObjectiveCountMetricsBadInstanaApplicationList) ToString() *string {
	var returns *string
