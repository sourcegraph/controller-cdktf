...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) DefaultDuration() AgentHistoricalDataRetrievalDefaultDurationList {
	var returns AgentHistoricalDataRetrievalDefaultDurationList
	_jsii_.Get(
		j,
		"defaultDuration",
		&returns,
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) InternalValue() *AgentHistoricalDataRetrieval {
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) MaxDuration() AgentHistoricalDataRetrievalMaxDurationList {
	var returns AgentHistoricalDataRetrievalMaxDurationList
	_jsii_.Get(
		j,
		"maxDuration",
		&returns,
...
func (j *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AgentHistoricalDataRetrievalOutputReference) ToString() *string {
	var returns *string
