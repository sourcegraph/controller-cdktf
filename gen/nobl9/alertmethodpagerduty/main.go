...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSendResolution", GoMethod: "PutSendResolution"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendResolution", GoMethod: "ResetSendResolution"},
			_jsii_.MemberProperty{JsiiProperty: "sendResolution", GoGetter: "SendResolution"},
			_jsii_.MemberProperty{JsiiProperty: "sendResolutionInput", GoGetter: "SendResolutionInput"},
