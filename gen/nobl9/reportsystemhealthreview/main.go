...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rowGroupBy", GoGetter: "RowGroupBy"},
			_jsii_.MemberProperty{JsiiProperty: "rowGroupByInput", GoGetter: "RowGroupByInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSlo", GoMethod: "PutSlo"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "greenGt", GoGetter: "GreenGt"},
			_jsii_.MemberProperty{JsiiProperty: "greenGtInput", GoGetter: "GreenGtInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "redLte", GoGetter: "RedLte"},
			_jsii_.MemberProperty{JsiiProperty: "redLteInput", GoGetter: "RedLteInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetShowNoData", GoMethod: "ResetShowNoData"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "showNoData", GoGetter: "ShowNoData"},
			_jsii_.MemberProperty{JsiiProperty: "showNoDataInput", GoGetter: "ShowNoDataInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
