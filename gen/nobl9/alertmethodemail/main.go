...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bcc", GoGetter: "Bcc"},
			_jsii_.MemberProperty{JsiiProperty: "bccInput", GoGetter: "BccInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBcc", GoMethod: "ResetBcc"},
