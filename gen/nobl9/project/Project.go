...
func (j *jsiiProxy_Project) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_Project) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_Project) Label() ProjectLabelList {
	var returns ProjectLabelList
	_jsii_.Get(
		j,
		"label",
		&returns,
...
func (p *jsiiProxy_Project) ResetDisplayName() {
	_jsii_.InvokeVoid(
		p,
		"resetDisplayName",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetLabel() {
	_jsii_.InvokeVoid(
		p,
		"resetLabel",
		nil, // no parameters
