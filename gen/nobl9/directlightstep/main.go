...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "appToken", GoGetter: "AppToken"},
			_jsii_.MemberProperty{JsiiProperty: "appTokenInput", GoGetter: "AppTokenInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lightstepOrganization", GoGetter: "LightstepOrganization"},
			_jsii_.MemberProperty{JsiiProperty: "lightstepOrganizationInput", GoGetter: "LightstepOrganizationInput"},
			_jsii_.MemberProperty{JsiiProperty: "lightstepProject", GoGetter: "LightstepProject"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogCollectionEnabled", GoMethod: "ResetLogCollectionEnabled"},
