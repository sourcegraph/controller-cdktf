...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppConfig",
		reflect.TypeOf((*GoogleFirebaseWebAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseWebAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeoutsOutputReference",
