...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpoint",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpointConfig",
		reflect.TypeOf((*GoogleComputeNetworkEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpointTimeouts",
