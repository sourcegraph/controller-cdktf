...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowAgent.GoogleDialogflowAgent",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowAgent.GoogleDialogflowAgentConfig",
		reflect.TypeOf((*GoogleDialogflowAgentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowAgent.GoogleDialogflowAgentTimeouts",
