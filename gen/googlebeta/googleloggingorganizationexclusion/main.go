...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleLoggingOrganizationExclusion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingOrganizationExclusion.GoogleLoggingOrganizationExclusionConfig",
		reflect.TypeOf((*GoogleLoggingOrganizationExclusionConfig)(nil)).Elem(),
	)
}
