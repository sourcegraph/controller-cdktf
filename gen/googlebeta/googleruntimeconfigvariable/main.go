...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleRuntimeconfigVariable.GoogleRuntimeconfigVariable",
		reflect.TypeOf((*GoogleRuntimeconfigVariable)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleRuntimeconfigVariable.GoogleRuntimeconfigVariableConfig",
		reflect.TypeOf((*GoogleRuntimeconfigVariableConfig)(nil)).Elem(),
	)
}
