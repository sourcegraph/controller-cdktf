...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMember",
		reflect.TypeOf((*GoogleKmsKeyRingIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleKmsKeyRingIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberCondition",
		reflect.TypeOf((*GoogleKmsKeyRingIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleKmsKeyRingIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberConfig",
		reflect.TypeOf((*GoogleKmsKeyRingIamMemberConfig)(nil)).Elem(),
	)
}
