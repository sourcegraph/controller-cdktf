...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepository",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pubsubConfigs", GoGetter: "PubsubConfigs"},
			_jsii_.MemberProperty{JsiiProperty: "pubsubConfigsInput", GoGetter: "PubsubConfigsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPubsubConfigs", GoMethod: "ResetPubsubConfigs"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepositoryConfig",
		reflect.TypeOf((*GoogleSourcerepoRepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepositoryPubsubConfigs",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepositoryPubsubConfigsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeouts",
