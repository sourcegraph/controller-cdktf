...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolderIamMember.GoogleFolderIamMemberCondition",
		reflect.TypeOf((*GoogleFolderIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFolderIamMember.GoogleFolderIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolderIamMember.GoogleFolderIamMemberConfig",
