...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberCondition",
		reflect.TypeOf((*GoogleTagsTagKeyIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamMember.GoogleTagsTagKeyIamMemberConfig",
