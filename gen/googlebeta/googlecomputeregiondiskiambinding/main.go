...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionDiskIamBinding.GoogleComputeRegionDiskIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionDiskIamBinding.GoogleComputeRegionDiskIamBindingCondition",
		reflect.TypeOf((*GoogleComputeRegionDiskIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionDiskIamBinding.GoogleComputeRegionDiskIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionDiskIamBinding.GoogleComputeRegionDiskIamBindingConfig",
