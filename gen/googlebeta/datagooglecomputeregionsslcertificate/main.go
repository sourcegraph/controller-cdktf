...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeRegionSslCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeRegionSslCertificate.DataGoogleComputeRegionSslCertificateConfig",
		reflect.TypeOf((*DataGoogleComputeRegionSslCertificateConfig)(nil)).Elem(),
	)
}
