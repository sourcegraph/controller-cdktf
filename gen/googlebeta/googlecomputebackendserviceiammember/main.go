...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamMember.GoogleComputeBackendServiceIamMember",
		reflect.TypeOf((*GoogleComputeBackendServiceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamMember.GoogleComputeBackendServiceIamMemberCondition",
		reflect.TypeOf((*GoogleComputeBackendServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamMember.GoogleComputeBackendServiceIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleComputeBackendServiceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamMember.GoogleComputeBackendServiceIamMemberConfig",
		reflect.TypeOf((*GoogleComputeBackendServiceIamMemberConfig)(nil)).Elem(),
	)
}
