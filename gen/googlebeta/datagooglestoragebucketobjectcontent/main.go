...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContent",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentConfig",
		reflect.TypeOf((*DataGoogleStorageBucketObjectContentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryption",
		reflect.TypeOf((*DataGoogleStorageBucketObjectContentCustomerEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryptionList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryptionOutputReference",
