...
func (j *jsiiProxy_GoogleStorageTransferJob) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleStorageTransferJob(scope constructs.Construct, id *string, config *GoogleStorageTransferJobConfig) GoogleStorageTransferJob {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleStorageTransferJob.GoogleStorageTransferJob",
...
func (j *jsiiProxy_GoogleStorageTransferJob)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
