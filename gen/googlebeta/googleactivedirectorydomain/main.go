...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomain",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainConfig",
		reflect.TypeOf((*GoogleActiveDirectoryDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts",
		reflect.TypeOf((*GoogleActiveDirectoryDomainTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeoutsOutputReference",
