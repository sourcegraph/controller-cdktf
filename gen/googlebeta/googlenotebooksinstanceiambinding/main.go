...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleNotebooksInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingConfig",
