...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleStorageHmacKey.GoogleStorageHmacKey",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageHmacKey.GoogleStorageHmacKeyConfig",
		reflect.TypeOf((*GoogleStorageHmacKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageHmacKey.GoogleStorageHmacKeyTimeouts",
