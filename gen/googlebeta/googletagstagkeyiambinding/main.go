...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingCondition",
		reflect.TypeOf((*GoogleTagsTagKeyIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConditionOutputReference",
		...
		func() interface{} {
			j := jsiiProxy_GoogleTagsTagKeyIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConfig",
