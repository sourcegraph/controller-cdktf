...
// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_dataflow_job google_dataflow_job}.
...
func (j *jsiiProxy_GoogleDataflowJob) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_dataflow_job google_dataflow_job} Resource.
func NewGoogleDataflowJob(scope constructs.Construct, id *string, config *GoogleDataflowJobConfig) GoogleDataflowJob {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDataflowJob.GoogleDataflowJob",
...
func (j *jsiiProxy_GoogleDataflowJob)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
