...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingCondition",
		reflect.TypeOf((*GoogleRuntimeconfigConfigIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingConfig",
