...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlekmscryptokey/internal"
)
...
func (j *jsiiProxy_GoogleKmsCryptoKey) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleKmsCryptoKey)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
