...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannel",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sensitiveLabels", GoGetter: "SensitiveLabels"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelConfig",
		reflect.TypeOf((*DataGoogleMonitoringNotificationChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelSensitiveLabels",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelSensitiveLabelsOutputReference",
