...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingProjectExclusion.GoogleLoggingProjectExclusion",
		reflect.TypeOf((*GoogleLoggingProjectExclusion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingProjectExclusion.GoogleLoggingProjectExclusionConfig",
		reflect.TypeOf((*GoogleLoggingProjectExclusionConfig)(nil)).Elem(),
	)
}
