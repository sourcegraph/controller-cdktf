...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHub",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "routingVpcs", GoGetter: "RoutingVpcs"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubConfig",
		reflect.TypeOf((*GoogleNetworkConnectivityHubConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcs",
		reflect.TypeOf((*GoogleNetworkConnectivityHubRoutingVpcs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcsList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeouts",
