...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingProjectSink.GoogleLoggingProjectSinkBigqueryOptions",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingProjectSink.GoogleLoggingProjectSinkConfig",
		reflect.TypeOf((*GoogleLoggingProjectSinkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingProjectSink.GoogleLoggingProjectSinkExclusions",
