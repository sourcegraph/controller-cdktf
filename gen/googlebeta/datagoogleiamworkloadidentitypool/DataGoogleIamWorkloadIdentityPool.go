...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/datagoogleiamworkloadidentitypool/internal"
)
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPool) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewDataGoogleIamWorkloadIdentityPool(scope constructs.Construct, id *string, config *DataGoogleIamWorkloadIdentityPoolConfig) DataGoogleIamWorkloadIdentityPool {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleIamWorkloadIdentityPool.DataGoogleIamWorkloadIdentityPool",
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPool)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
