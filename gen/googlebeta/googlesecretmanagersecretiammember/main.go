...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSecretManagerSecretIamMember.GoogleSecretManagerSecretIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSecretManagerSecretIamMember.GoogleSecretManagerSecretIamMemberConfig",
