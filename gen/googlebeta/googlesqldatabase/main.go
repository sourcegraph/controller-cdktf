...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSqlDatabase.GoogleSqlDatabase",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlDatabase.GoogleSqlDatabaseConfig",
		reflect.TypeOf((*GoogleSqlDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlDatabase.GoogleSqlDatabaseTimeouts",
