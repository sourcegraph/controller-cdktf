...
func (j *jsiiProxy_GoogleComputeRegionInstanceGroupManager) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeRegionInstanceGroupManager(scope constructs.Construct, id *string, config *GoogleComputeRegionInstanceGroupManagerConfig) GoogleComputeRegionInstanceGroupManager {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeRegionInstanceGroupManager.GoogleComputeRegionInstanceGroupManager",
...
func (j *jsiiProxy_GoogleComputeRegionInstanceGroupManager)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
