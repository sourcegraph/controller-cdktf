...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecomputerouter/internal"
)
...
func NewGoogleComputeRouterBgpOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleComputeRouterBgpOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeRouter.GoogleComputeRouterBgpOutputReference",
