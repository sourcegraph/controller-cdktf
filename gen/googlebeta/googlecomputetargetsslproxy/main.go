...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetSslProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyTimeouts",
