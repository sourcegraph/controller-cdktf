...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJob",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "importJobId", GoGetter: "ImportJobId"},
			_jsii_.MemberProperty{JsiiProperty: "importJobIdInput", GoGetter: "ImportJobIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "importMethod", GoGetter: "ImportMethod"},
			_jsii_.MemberProperty{JsiiProperty: "importMethodInput", GoGetter: "ImportMethodInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobAttestation",
		reflect.TypeOf((*GoogleKmsKeyRingImportJobAttestation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobAttestationList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobAttestationOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobConfig",
		reflect.TypeOf((*GoogleKmsKeyRingImportJobConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobPublicKey",
		reflect.TypeOf((*GoogleKmsKeyRingImportJobPublicKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobPublicKeyList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobPublicKeyOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingImportJob.GoogleKmsKeyRingImportJobTimeouts",
