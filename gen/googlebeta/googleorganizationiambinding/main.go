...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingCondition",
		reflect.TypeOf((*GoogleOrganizationIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingConfig",
