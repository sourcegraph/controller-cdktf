...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingFolderSink.GoogleLoggingFolderSink",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingFolderSink.GoogleLoggingFolderSinkBigqueryOptions",
		reflect.TypeOf((*GoogleLoggingFolderSinkBigqueryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingFolderSink.GoogleLoggingFolderSinkBigqueryOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingFolderSink.GoogleLoggingFolderSinkConfig",
		reflect.TypeOf((*GoogleLoggingFolderSinkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingFolderSink.GoogleLoggingFolderSinkExclusions",
