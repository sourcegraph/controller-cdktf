...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigqueryTableIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberCondition",
		reflect.TypeOf((*GoogleBigqueryTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBigqueryTableIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamMember.GoogleBigqueryTableIamMemberConfig",
		reflect.TypeOf((*GoogleBigqueryTableIamMemberConfig)(nil)).Elem(),
	)
}
