...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigqueryConnectionIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamMember.GoogleBigqueryConnectionIamMemberCondition",
		reflect.TypeOf((*GoogleBigqueryConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamMember.GoogleBigqueryConnectionIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBigqueryConnectionIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamMember.GoogleBigqueryConnectionIamMemberConfig",
		reflect.TypeOf((*GoogleBigqueryConnectionIamMemberConfig)(nil)).Elem(),
	)
}
