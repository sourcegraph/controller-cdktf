...
func (j *jsiiProxy_GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList {
	_init_.Initialize()
...
func NewGoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList_Override(g GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeBackendBucketCdnPolicyNegativeCachingPolicyList) Resolve(_context cdktf.IResolveContext) interface{} {
