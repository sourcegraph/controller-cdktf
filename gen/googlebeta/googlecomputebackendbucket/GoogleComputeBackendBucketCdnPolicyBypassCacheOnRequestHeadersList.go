...
func (j *jsiiProxy_GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList {
	_init_.Initialize()
...
func NewGoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList_Override(g GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeBackendBucketCdnPolicyBypassCacheOnRequestHeadersList) Resolve(_context cdktf.IResolveContext) interface{} {
