...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingOrganizationSink.GoogleLoggingOrganizationSinkBigqueryOptions",
		reflect.TypeOf((*GoogleLoggingOrganizationSinkBigqueryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingOrganizationSink.GoogleLoggingOrganizationSinkBigqueryOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingOrganizationSink.GoogleLoggingOrganizationSinkConfig",
		reflect.TypeOf((*GoogleLoggingOrganizationSinkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingOrganizationSink.GoogleLoggingOrganizationSinkExclusions",
