...
func (j *jsiiProxy_GoogleDialogflowCxAgent) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleDialogflowCxAgent(scope constructs.Construct, id *string, config *GoogleDialogflowCxAgentConfig) GoogleDialogflowCxAgent {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgent",
...
func (j *jsiiProxy_GoogleDialogflowCxAgent)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
