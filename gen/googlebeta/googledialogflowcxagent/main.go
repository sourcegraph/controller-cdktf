...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgentConfig",
		reflect.TypeOf((*GoogleDialogflowCxAgentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgentSpeechToTextSettings",
		reflect.TypeOf((*GoogleDialogflowCxAgentSpeechToTextSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgentSpeechToTextSettingsOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgentTimeouts",
