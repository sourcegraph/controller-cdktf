...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicyConfig",
