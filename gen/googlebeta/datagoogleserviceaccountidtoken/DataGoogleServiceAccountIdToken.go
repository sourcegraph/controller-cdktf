...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/datagoogleserviceaccountidtoken/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/d/google_service_account_id_token google_service_account_id_token}.
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/d/google_service_account_id_token google_service_account_id_token} Data Source.
func NewDataGoogleServiceAccountIdToken(scope constructs.Construct, id *string, config *DataGoogleServiceAccountIdTokenConfig) DataGoogleServiceAccountIdToken {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
