...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnection",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionConfig",
		reflect.TypeOf((*GoogleServiceNetworkingConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionTimeouts",
