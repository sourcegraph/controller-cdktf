...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMember",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleCloudfunctions2FunctionIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberCondition",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberConfig",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamMemberConfig)(nil)).Elem(),
	)
}
