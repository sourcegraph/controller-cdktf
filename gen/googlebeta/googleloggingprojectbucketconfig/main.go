...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingProjectBucketConfig.GoogleLoggingProjectBucketConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingProjectBucketConfig.GoogleLoggingProjectBucketConfigConfig",
