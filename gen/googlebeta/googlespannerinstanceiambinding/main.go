...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleSpannerInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingConfig",
