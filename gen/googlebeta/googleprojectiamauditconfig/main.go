...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfig",
		reflect.TypeOf((*GoogleProjectIamAuditConfigAuditLogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfigList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigConfig",
