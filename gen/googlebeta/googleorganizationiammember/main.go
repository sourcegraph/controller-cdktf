...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMember",
		reflect.TypeOf((*GoogleOrganizationIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberCondition",
		reflect.TypeOf((*GoogleOrganizationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleOrganizationIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberConfig",
		reflect.TypeOf((*GoogleOrganizationIamMemberConfig)(nil)).Elem(),
	)
}
