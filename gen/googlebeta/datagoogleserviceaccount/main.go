...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleServiceAccount.DataGoogleServiceAccount",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleServiceAccount.DataGoogleServiceAccountConfig",
