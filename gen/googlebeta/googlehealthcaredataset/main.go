...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetConfig",
		reflect.TypeOf((*GoogleHealthcareDatasetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetTimeouts",
