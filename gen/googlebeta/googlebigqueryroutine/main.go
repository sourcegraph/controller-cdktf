...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutineArguments",
		reflect.TypeOf((*GoogleBigqueryRoutineArguments)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutineArgumentsList",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutineConfig",
		reflect.TypeOf((*GoogleBigqueryRoutineConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutineTimeouts",
		reflect.TypeOf((*GoogleBigqueryRoutineTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutineTimeoutsOutputReference",
