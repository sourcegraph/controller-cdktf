...
func (j *jsiiProxy_GoogleBigqueryRoutine) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleBigqueryRoutine(scope constructs.Construct, id *string, config *GoogleBigqueryRoutineConfig) GoogleBigqueryRoutine {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleBigqueryRoutine.GoogleBigqueryRoutine",
...
func (j *jsiiProxy_GoogleBigqueryRoutine)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
