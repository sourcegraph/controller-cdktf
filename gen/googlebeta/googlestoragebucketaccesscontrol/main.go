...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControl",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlConfig",
		reflect.TypeOf((*GoogleStorageBucketAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeouts",
