...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyConfig",
		reflect.TypeOf((*GoogleOsLoginSshPublicKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeouts",
