...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList {
	_init_.Initialize()
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList_Override(d DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectList) Resolve(_context cdktf.IResolveContext) interface{} {
