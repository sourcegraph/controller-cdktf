...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfig",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "preservedState", GoGetter: "PreservedState"},
			_jsii_.MemberProperty{JsiiProperty: "preservedStateInput", GoGetter: "PreservedStateInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "removeInstanceStateOnDestroyInput", GoGetter: "RemoveInstanceStateOnDestroyInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinimalAction", GoMethod: "ResetMinimalAction"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPreservedState", GoMethod: "ResetPreservedState"},
			_jsii_.MemberMethod{JsiiMethod: "resetProject", GoMethod: "ResetProject"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemoveInstanceStateOnDestroy", GoMethod: "ResetRemoveInstanceStateOnDestroy"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigConfig",
		reflect.TypeOf((*GoogleComputeRegionPerInstanceConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigPreservedState",
		reflect.TypeOf((*GoogleComputeRegionPerInstanceConfigPreservedState)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigPreservedStateDisk",
		reflect.TypeOf((*GoogleComputeRegionPerInstanceConfigPreservedStateDisk)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigPreservedStateDiskList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigPreservedStateDiskOutputReference",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigPreservedStateOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigTimeouts",
		reflect.TypeOf((*GoogleComputeRegionPerInstanceConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionPerInstanceConfig.GoogleComputeRegionPerInstanceConfigTimeoutsOutputReference",
