...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecomputeregionperinstanceconfig/internal"
)
...
func (j *jsiiProxy_GoogleComputeRegionPerInstanceConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleComputeRegionPerInstanceConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
