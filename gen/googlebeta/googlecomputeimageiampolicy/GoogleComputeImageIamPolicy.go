...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecomputeimageiampolicy/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_image_iam_policy google_compute_image_iam_policy}.
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_image_iam_policy google_compute_image_iam_policy} Resource.
func NewGoogleComputeImageIamPolicy(scope constructs.Construct, id *string, config *GoogleComputeImageIamPolicyConfig) GoogleComputeImageIamPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeImageIamPolicy.GoogleComputeImageIamPolicy",
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
