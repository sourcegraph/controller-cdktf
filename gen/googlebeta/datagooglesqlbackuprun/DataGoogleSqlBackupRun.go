...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/datagooglesqlbackuprun/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/d/google_sql_backup_run google_sql_backup_run}.
...
func (j *jsiiProxy_DataGoogleSqlBackupRun) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/d/google_sql_backup_run google_sql_backup_run} Data Source.
func NewDataGoogleSqlBackupRun(scope constructs.Construct, id *string, config *DataGoogleSqlBackupRunConfig) DataGoogleSqlBackupRun {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleSqlBackupRun.DataGoogleSqlBackupRun",
...
func (j *jsiiProxy_DataGoogleSqlBackupRun)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
