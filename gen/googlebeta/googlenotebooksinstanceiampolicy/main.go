...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamPolicy.GoogleNotebooksInstanceIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamPolicy.GoogleNotebooksInstanceIamPolicyConfig",
