...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateConfig",
		reflect.TypeOf((*GoogleComputeSslCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts",
		reflect.TypeOf((*GoogleComputeSslCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeoutsOutputReference",
