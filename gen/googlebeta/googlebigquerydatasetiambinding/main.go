...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBinding",
		reflect.TypeOf((*GoogleBigqueryDatasetIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBindingCondition",
		reflect.TypeOf((*GoogleBigqueryDatasetIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBigqueryDatasetIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryDatasetIamBinding.GoogleBigqueryDatasetIamBindingConfig",
		reflect.TypeOf((*GoogleBigqueryDatasetIamBindingConfig)(nil)).Elem(),
	)
}
