...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSccSource.GoogleSccSource",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSccSource.GoogleSccSourceConfig",
		reflect.TypeOf((*GoogleSccSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSccSource.GoogleSccSourceTimeouts",
