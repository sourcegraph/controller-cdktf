...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/datagooglekmssecretciphertext/internal"
)

// Represents a {@link https://www.terraform.io/docs/providers/google-beta/d/google_kms_secret_ciphertext google_kms_secret_ciphertext}.
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/d/google_kms_secret_ciphertext google_kms_secret_ciphertext} Data Source.
func NewDataGoogleKmsSecretCiphertext(scope constructs.Construct, id *string, config *DataGoogleKmsSecretCiphertextConfig) DataGoogleKmsSecretCiphertext {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleKmsSecretCiphertext.DataGoogleKmsSecretCiphertext",
...
func (j *jsiiProxy_DataGoogleKmsSecretCiphertext)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
