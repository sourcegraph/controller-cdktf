...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingConfig",
