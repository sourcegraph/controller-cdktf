...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroup.GoogleComputeInstanceGroup",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroup.GoogleComputeInstanceGroupConfig",
		reflect.TypeOf((*GoogleComputeInstanceGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroup.GoogleComputeInstanceGroupNamedPort",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroup.GoogleComputeInstanceGroupTimeouts",
