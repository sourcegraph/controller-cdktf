...
func (j *jsiiProxy_GooglePubsubSubscription) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_subscription google_pubsub_subscription} Resource.
func NewGooglePubsubSubscription(scope constructs.Construct, id *string, config *GooglePubsubSubscriptionConfig) GooglePubsubSubscription {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googlePubsubSubscription.GooglePubsubSubscription",
...
func (j *jsiiProxy_GooglePubsubSubscription)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
