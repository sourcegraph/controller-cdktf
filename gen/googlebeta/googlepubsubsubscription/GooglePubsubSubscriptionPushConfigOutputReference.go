...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) AttributesInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"attributesInput",
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) InternalValue() *GooglePubsubSubscriptionPushConfig {
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) OidcToken() GooglePubsubSubscriptionPushConfigOidcTokenOutputReference {
	var returns GooglePubsubSubscriptionPushConfigOidcTokenOutputReference
	_jsii_.Get(
		j,
		"oidcToken",
		&returns,
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) OidcTokenInput() *GooglePubsubSubscriptionPushConfigOidcToken {
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) PushEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pushEndpoint",
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) PushEndpointInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pushEndpointInput",
...
func (j *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func NewGooglePubsubSubscriptionPushConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GooglePubsubSubscriptionPushConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googlePubsubSubscription.GooglePubsubSubscriptionPushConfigOutputReference",
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) ResetAttributes() {
	_jsii_.InvokeVoid(
		g,
		"resetAttributes",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) ResetOidcToken() {
	_jsii_.InvokeVoid(
		g,
		"resetOidcToken",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePubsubSubscriptionPushConfigOutputReference) ToString() *string {
	var returns *string
