...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplate",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "tagTemplateId", GoGetter: "TagTemplateId"},
			_jsii_.MemberProperty{JsiiProperty: "tagTemplateIdInput", GoGetter: "TagTemplateIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateConfig",
		reflect.TypeOf((*GoogleDataCatalogTagTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFields",
		reflect.TypeOf((*GoogleDataCatalogTagTemplateFields)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsList",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putType", GoMethod: "PutType"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsType",
		reflect.TypeOf((*GoogleDataCatalogTagTemplateFieldsType)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsTypeEnumType",
		reflect.TypeOf((*GoogleDataCatalogTagTemplateFieldsTypeEnumType)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsTypeEnumTypeAllowedValues",
		reflect.TypeOf((*GoogleDataCatalogTagTemplateFieldsTypeEnumTypeAllowedValues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsTypeEnumTypeAllowedValuesList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateFieldsTypeEnumTypeOutputReference",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enumType", GoGetter: "EnumType"},
			_jsii_.MemberProperty{JsiiProperty: "enumTypeInput", GoGetter: "EnumTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "primitiveType", GoGetter: "PrimitiveType"},
			_jsii_.MemberProperty{JsiiProperty: "primitiveTypeInput", GoGetter: "PrimitiveTypeInput"},
			_jsii_.MemberMethod{JsiiMethod: "putEnumType", GoMethod: "PutEnumType"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnumType", GoMethod: "ResetEnumType"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrimitiveType", GoMethod: "ResetPrimitiveType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTagTemplate.GoogleDataCatalogTagTemplateTimeouts",
