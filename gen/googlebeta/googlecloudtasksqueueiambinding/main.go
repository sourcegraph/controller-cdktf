...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingCondition",
		reflect.TypeOf((*GoogleCloudTasksQueueIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingConditionOutputReference",
		...
		func() interface{} {
			j := jsiiProxy_GoogleCloudTasksQueueIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingConfig",
