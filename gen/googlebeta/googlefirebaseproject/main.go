...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFirebaseProject.GoogleFirebaseProject",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaseProject.GoogleFirebaseProjectConfig",
		reflect.TypeOf((*GoogleFirebaseProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaseProject.GoogleFirebaseProjectTimeouts",
		reflect.TypeOf((*GoogleFirebaseProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFirebaseProject.GoogleFirebaseProjectTimeoutsOutputReference",
