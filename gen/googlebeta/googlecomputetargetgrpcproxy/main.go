...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUrlMap", GoMethod: "ResetUrlMap"},
			_jsii_.MemberMethod{JsiiMethod: "resetValidateForProxyless", GoMethod: "ResetValidateForProxyless"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetGrpcProxy.GoogleComputeTargetGrpcProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetGrpcProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetGrpcProxy.GoogleComputeTargetGrpcProxyTimeouts",
