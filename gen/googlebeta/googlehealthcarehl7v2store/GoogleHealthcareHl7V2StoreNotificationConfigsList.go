...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlehealthcarehl7v2store/internal"
)
...
func NewGoogleHealthcareHl7V2StoreNotificationConfigsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleHealthcareHl7V2StoreNotificationConfigsList {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleHealthcareHl7V2Store.GoogleHealthcareHl7V2StoreNotificationConfigsList",
