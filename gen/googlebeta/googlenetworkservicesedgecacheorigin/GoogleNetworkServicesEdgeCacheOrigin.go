...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlenetworkservicesedgecacheorigin/internal"
)
...
func (j *jsiiProxy_GoogleNetworkServicesEdgeCacheOrigin) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleNetworkServicesEdgeCacheOrigin(scope constructs.Construct, id *string, config *GoogleNetworkServicesEdgeCacheOriginConfig) GoogleNetworkServicesEdgeCacheOrigin {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleNetworkServicesEdgeCacheOrigin.GoogleNetworkServicesEdgeCacheOrigin",
...
func (j *jsiiProxy_GoogleNetworkServicesEdgeCacheOrigin)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
