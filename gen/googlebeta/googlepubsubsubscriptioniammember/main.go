...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GooglePubsubSubscriptionIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberCondition",
		reflect.TypeOf((*GooglePubsubSubscriptionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberConditionOutputReference",
		reflect.TypeOf((*GooglePubsubSubscriptionIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberConfig",
		reflect.TypeOf((*GooglePubsubSubscriptionIamMemberConfig)(nil)).Elem(),
	)
}
