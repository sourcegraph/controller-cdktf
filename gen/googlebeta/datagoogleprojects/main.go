...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleProjects.DataGoogleProjectsConfig",
		reflect.TypeOf((*DataGoogleProjectsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleProjects.DataGoogleProjectsProjects",
		reflect.TypeOf((*DataGoogleProjectsProjects)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleProjects.DataGoogleProjectsProjectsList",
