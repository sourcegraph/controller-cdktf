...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigtableTableIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberCondition",
		reflect.TypeOf((*GoogleBigtableTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBigtableTableIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableTableIamMember.GoogleBigtableTableIamMemberConfig",
		reflect.TypeOf((*GoogleBigtableTableIamMemberConfig)(nil)).Elem(),
	)
}
