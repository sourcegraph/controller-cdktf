...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnector",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "minThroughput", GoGetter: "MinThroughput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorConfig",
		reflect.TypeOf((*DataGoogleVpcAccessConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnet",
		reflect.TypeOf((*DataGoogleVpcAccessConnectorSubnet)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnetList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnetOutputReference",
