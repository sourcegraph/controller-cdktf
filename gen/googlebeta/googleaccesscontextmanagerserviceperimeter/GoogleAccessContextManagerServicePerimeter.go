...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeter) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeter)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
