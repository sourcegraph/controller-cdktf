...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheck",
		reflect.TypeOf((*GoogleComputeHttpHealthCheck)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckConfig",
		reflect.TypeOf((*GoogleComputeHttpHealthCheckConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckTimeouts",
		reflect.TypeOf((*GoogleComputeHttpHealthCheckTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckTimeoutsOutputReference",
		reflect.TypeOf((*GoogleComputeHttpHealthCheckTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleComputeHttpHealthCheckTimeoutsOutputReference{}
