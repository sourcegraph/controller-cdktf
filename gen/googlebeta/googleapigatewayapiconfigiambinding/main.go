...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamBinding.GoogleApiGatewayApiConfigIamBinding",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamBinding.GoogleApiGatewayApiConfigIamBindingCondition",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamBinding.GoogleApiGatewayApiConfigIamBindingConfig",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamBindingConfig)(nil)).Elem(),
	)
}
