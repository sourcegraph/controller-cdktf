...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTag.GoogleDataCatalogTagConfig",
		reflect.TypeOf((*GoogleDataCatalogTagConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTag.GoogleDataCatalogTagFields",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTag.GoogleDataCatalogTagTimeouts",
		reflect.TypeOf((*GoogleDataCatalogTagTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTag.GoogleDataCatalogTagTimeoutsOutputReference",
