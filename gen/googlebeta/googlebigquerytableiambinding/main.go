...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigqueryTableIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingCondition",
		reflect.TypeOf((*GoogleBigqueryTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBigqueryTableIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingConfig",
		reflect.TypeOf((*GoogleBigqueryTableIamBindingConfig)(nil)).Elem(),
	)
}
