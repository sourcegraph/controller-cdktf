...
func (j *jsiiProxy_GoogleComputeBackendService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeBackendService(scope constructs.Construct, id *string, config *GoogleComputeBackendServiceConfig) GoogleComputeBackendService {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeBackendService.GoogleComputeBackendService",
...
func (j *jsiiProxy_GoogleComputeBackendService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
