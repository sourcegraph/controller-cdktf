...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseConfig",
		reflect.TypeOf((*GoogleFirebaserulesReleaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseTimeouts",
		reflect.TypeOf((*GoogleFirebaserulesReleaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseTimeoutsOutputReference",
