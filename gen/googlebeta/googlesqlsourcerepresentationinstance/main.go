...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSqlSourceRepresentationInstance.GoogleSqlSourceRepresentationInstance",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlSourceRepresentationInstance.GoogleSqlSourceRepresentationInstanceConfig",
		reflect.TypeOf((*GoogleSqlSourceRepresentationInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlSourceRepresentationInstance.GoogleSqlSourceRepresentationInstanceTimeouts",
