...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "certSerialNumber", GoGetter: "CertSerialNumber"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlSslCert.GoogleSqlSslCertConfig",
		reflect.TypeOf((*GoogleSqlSslCertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlSslCert.GoogleSqlSslCertTimeouts",
		reflect.TypeOf((*GoogleSqlSslCertTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSqlSslCert.GoogleSqlSslCertTimeoutsOutputReference",
