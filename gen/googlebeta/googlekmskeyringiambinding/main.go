...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleKmsKeyRingIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingCondition",
		reflect.TypeOf((*GoogleKmsKeyRingIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleKmsKeyRingIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsKeyRingIamBinding.GoogleKmsKeyRingIamBindingConfig",
		reflect.TypeOf((*GoogleKmsKeyRingIamBindingConfig)(nil)).Elem(),
	)
}
