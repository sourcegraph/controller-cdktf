...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressConfig",
		reflect.TypeOf((*GoogleApigeeNatAddressConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressTimeouts",
		reflect.TypeOf((*GoogleApigeeNatAddressTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressTimeoutsOutputReference",
