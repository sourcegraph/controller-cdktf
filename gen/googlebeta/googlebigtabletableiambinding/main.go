...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigtableTableIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingCondition",
		reflect.TypeOf((*GoogleBigtableTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBigtableTableIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableTableIamBinding.GoogleBigtableTableIamBindingConfig",
		reflect.TypeOf((*GoogleBigtableTableIamBindingConfig)(nil)).Elem(),
	)
}
