...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyConfig",
		reflect.TypeOf((*GoogleComputeSslPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts",
