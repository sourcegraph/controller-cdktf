...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googledialogflowcxwebhook/internal"
)
...
func NewGoogleDialogflowCxWebhookGenericWebServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleDialogflowCxWebhookGenericWebServiceOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDialogflowCxWebhook.GoogleDialogflowCxWebhookGenericWebServiceOutputReference",
