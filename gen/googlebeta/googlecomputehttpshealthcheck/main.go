...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeHttpsHealthCheck.GoogleComputeHttpsHealthCheck",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHttpsHealthCheck.GoogleComputeHttpsHealthCheckConfig",
		reflect.TypeOf((*GoogleComputeHttpsHealthCheckConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHttpsHealthCheck.GoogleComputeHttpsHealthCheckTimeouts",
