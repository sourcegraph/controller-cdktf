...
type GoogleAppEngineApplicationIapOutputReference interface {
	...
	SetInternalValue(val *GoogleAppEngineApplicationIap)
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) InternalValue() *GoogleAppEngineApplicationIap {
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Oauth2ClientId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientId",
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Oauth2ClientIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientIdInput",
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Oauth2ClientSecret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientSecret",
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Oauth2ClientSecretInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) Oauth2ClientSecretSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewGoogleAppEngineApplicationIapOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleAppEngineApplicationIapOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleAppEngineApplication.GoogleAppEngineApplicationIapOutputReference",
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		g,
		"resetEnabled",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleAppEngineApplicationIapOutputReference) ToString() *string {
	var returns *string
