...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSubnetworkIamMember.GoogleComputeSubnetworkIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeSubnetworkIamMember.GoogleComputeSubnetworkIamMemberConfig",
