...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleVpcAccessConnector.GoogleVpcAccessConnector",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVpcAccessConnector.GoogleVpcAccessConnectorConfig",
		reflect.TypeOf((*GoogleVpcAccessConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVpcAccessConnector.GoogleVpcAccessConnectorSubnet",
		reflect.TypeOf((*GoogleVpcAccessConnectorSubnet)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleVpcAccessConnector.GoogleVpcAccessConnectorSubnetOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVpcAccessConnector.GoogleVpcAccessConnectorTimeouts",
