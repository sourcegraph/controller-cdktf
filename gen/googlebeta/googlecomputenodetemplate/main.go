...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplate",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cpuOvercommitType", GoGetter: "CpuOvercommitType"},
			_jsii_.MemberProperty{JsiiProperty: "cpuOvercommitTypeInput", GoGetter: "CpuOvercommitTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "nodeAffinityLabels", GoGetter: "NodeAffinityLabels"},
			_jsii_.MemberProperty{JsiiProperty: "nodeAffinityLabelsInput", GoGetter: "NodeAffinityLabelsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putServerBinding", GoMethod: "PutServerBinding"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNodeAffinityLabels", GoMethod: "ResetNodeAffinityLabels"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerBinding", GoMethod: "ResetServerBinding"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "selfLink", GoGetter: "SelfLink"},
			_jsii_.MemberProperty{JsiiProperty: "serverBinding", GoGetter: "ServerBinding"},
			_jsii_.MemberProperty{JsiiProperty: "serverBindingInput", GoGetter: "ServerBindingInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateConfig",
		reflect.TypeOf((*GoogleComputeNodeTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateNodeTypeFlexibility",
		reflect.TypeOf((*GoogleComputeNodeTemplateNodeTypeFlexibility)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateNodeTypeFlexibilityOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "localSsd", GoGetter: "LocalSsd"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateServerBinding",
		reflect.TypeOf((*GoogleComputeNodeTemplateServerBinding)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateServerBindingOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateTimeouts",
		reflect.TypeOf((*GoogleComputeNodeTemplateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNodeTemplate.GoogleComputeNodeTemplateTimeoutsOutputReference",
