...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlestoragebucketobject/internal"
)
...
func NewGoogleStorageBucketObject(scope constructs.Construct, id *string, config *GoogleStorageBucketObjectConfig) GoogleStorageBucketObject {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleStorageBucketObject.GoogleStorageBucketObject",
