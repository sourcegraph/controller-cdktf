...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/datagoogleiamworkloadidentitypoolprovider/internal"
)
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderAwsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleIamWorkloadIdentityPoolProviderAwsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleIamWorkloadIdentityPoolProviderAwsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleIamWorkloadIdentityPoolProvider.DataGoogleIamWorkloadIdentityPoolProviderAwsList",
...
func NewDataGoogleIamWorkloadIdentityPoolProviderAwsList_Override(d DataGoogleIamWorkloadIdentityPoolProviderAwsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderAwsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolProviderAwsList) Resolve(_context cdktf.IResolveContext) interface{} {
