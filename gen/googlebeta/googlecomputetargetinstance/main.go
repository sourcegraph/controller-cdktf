...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstance",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "natPolicy", GoGetter: "NatPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "natPolicyInput", GoGetter: "NatPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNatPolicy", GoMethod: "ResetNatPolicy"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceConfig",
		reflect.TypeOf((*GoogleComputeTargetInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts",
