...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeHaVpnGateway.GoogleComputeHaVpnGateway",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putVpnInterfaces", GoMethod: "PutVpnInterfaces"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVpnInterfaces", GoMethod: "ResetVpnInterfaces"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHaVpnGateway.GoogleComputeHaVpnGatewayConfig",
		reflect.TypeOf((*GoogleComputeHaVpnGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHaVpnGateway.GoogleComputeHaVpnGatewayTimeouts",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeHaVpnGateway.GoogleComputeHaVpnGatewayVpnInterfaces",
		reflect.TypeOf((*GoogleComputeHaVpnGatewayVpnInterfaces)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeHaVpnGateway.GoogleComputeHaVpnGatewayVpnInterfacesList",
