...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicy",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gcRules", GoGetter: "GcRules"},
			_jsii_.MemberProperty{JsiiProperty: "gcRulesInput", GoGetter: "GcRulesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxVersionInput", GoGetter: "MaxVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putMaxAge", GoMethod: "PutMaxAge"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxVersion", GoMethod: "ResetMaxVersion"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicyConfig",
		reflect.TypeOf((*GoogleBigtableGcPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicyMaxAge",
		reflect.TypeOf((*GoogleBigtableGcPolicyMaxAge)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicyMaxAgeOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicyMaxVersion",
		reflect.TypeOf((*GoogleBigtableGcPolicyMaxVersion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableGcPolicy.GoogleBigtableGcPolicyMaxVersionList",
