...
type GoogleDataCatalogEntryConfig struct {
	// Experimental.
	...
	GcsFilesetSpec *GoogleDataCatalogEntryGcsFilesetSpec `field:"optional" json:"gcsFilesetSpec" yaml:"gcsFilesetSpec"`
	...
	Timeouts *GoogleDataCatalogEntryTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
