...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingConfig",
