...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamBinding.GoogleApiGatewayGatewayIamBinding",
		reflect.TypeOf((*GoogleApiGatewayGatewayIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamBinding.GoogleApiGatewayGatewayIamBindingCondition",
		reflect.TypeOf((*GoogleApiGatewayGatewayIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamBinding.GoogleApiGatewayGatewayIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleApiGatewayGatewayIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamBinding.GoogleApiGatewayGatewayIamBindingConfig",
		reflect.TypeOf((*GoogleApiGatewayGatewayIamBindingConfig)(nil)).Elem(),
	)
}
