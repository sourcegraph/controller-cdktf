...
func (j *jsiiProxy_GoogleDataprocMetastoreService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleDataprocMetastoreService(scope constructs.Construct, id *string, config *GoogleDataprocMetastoreServiceConfig) GoogleDataprocMetastoreService {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDataprocMetastoreService.GoogleDataprocMetastoreService",
...
func (j *jsiiProxy_GoogleDataprocMetastoreService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
