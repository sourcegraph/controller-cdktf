...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googleartifactregistryrepository/internal"
)
...
func NewGoogleArtifactRegistryRepositoryMavenConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleArtifactRegistryRepositoryMavenConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepository.GoogleArtifactRegistryRepositoryMavenConfigOutputReference",
