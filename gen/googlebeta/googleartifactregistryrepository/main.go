...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepository.GoogleArtifactRegistryRepositoryConfig",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepository.GoogleArtifactRegistryRepositoryMavenConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepository.GoogleArtifactRegistryRepositoryTimeouts",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepository.GoogleArtifactRegistryRepositoryTimeoutsOutputReference",
