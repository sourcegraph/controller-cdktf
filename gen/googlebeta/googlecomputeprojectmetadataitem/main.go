...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemConfig",
		reflect.TypeOf((*GoogleComputeProjectMetadataItemConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemTimeouts",
		reflect.TypeOf((*GoogleComputeProjectMetadataItemTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemTimeoutsOutputReference",
