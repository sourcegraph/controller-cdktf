...
func (j *jsiiProxy_GoogleComputeDisk) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeDisk(scope constructs.Construct, id *string, config *GoogleComputeDiskConfig) GoogleComputeDisk {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeDisk.GoogleComputeDisk",
...
func (j *jsiiProxy_GoogleComputeDisk)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
