...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleLoggingFolderBucketConfig.GoogleLoggingFolderBucketConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingFolderBucketConfig.GoogleLoggingFolderBucketConfigConfig",
