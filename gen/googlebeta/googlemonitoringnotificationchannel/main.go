...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringNotificationChannel.GoogleMonitoringNotificationChannelConfig",
		reflect.TypeOf((*GoogleMonitoringNotificationChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringNotificationChannel.GoogleMonitoringNotificationChannelSensitiveLabels",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringNotificationChannel.GoogleMonitoringNotificationChannelTimeouts",
		reflect.TypeOf((*GoogleMonitoringNotificationChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleMonitoringNotificationChannel.GoogleMonitoringNotificationChannelTimeoutsOutputReference",
