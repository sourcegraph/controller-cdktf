...
func (j *jsiiProxy_GoogleAppEngineDomainMapping) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleAppEngineDomainMapping(scope constructs.Construct, id *string, config *GoogleAppEngineDomainMappingConfig) GoogleAppEngineDomainMapping {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleAppEngineDomainMapping.GoogleAppEngineDomainMapping",
...
func (j *jsiiProxy_GoogleAppEngineDomainMapping)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
