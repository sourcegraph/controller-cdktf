...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberCondition",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiConfigIamMember.GoogleApiGatewayApiConfigIamMemberConfig",
		reflect.TypeOf((*GoogleApiGatewayApiConfigIamMemberConfig)(nil)).Elem(),
	)
}
