...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "machineImageEncryptionKey", GoGetter: "MachineImageEncryptionKey"},
			_jsii_.MemberProperty{JsiiProperty: "machineImageEncryptionKeyInput", GoGetter: "MachineImageEncryptionKeyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceInstance", GoGetter: "SourceInstance"},
			_jsii_.MemberProperty{JsiiProperty: "sourceInstanceInput", GoGetter: "SourceInstanceInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeMachineImage.GoogleComputeMachineImageConfig",
		reflect.TypeOf((*GoogleComputeMachineImageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKey",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeMachineImage.GoogleComputeMachineImageTimeouts",
		reflect.TypeOf((*GoogleComputeMachineImageTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeMachineImage.GoogleComputeMachineImageTimeoutsOutputReference",
