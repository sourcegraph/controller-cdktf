...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentity",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentityConfig",
		reflect.TypeOf((*GoogleProjectServiceIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentityTimeouts",
