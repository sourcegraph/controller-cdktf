...
type jsiiProxy_GoogleProjectService struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleProjectService) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleProjectService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleProjectService) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleProjectService) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleProjectService) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleProjectService) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleProjectService) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleProjectService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleProjectService) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleProjectService) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleProjectService) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GoogleProjectService) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GoogleProjectService) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleProjectService) Service() *string {
	var returns *string
	_jsii_.Get(
		j,
		"service",
...
func (j *jsiiProxy_GoogleProjectService) ServiceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceInput",
...
func (j *jsiiProxy_GoogleProjectService) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleProjectService) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleProjectService) Timeouts() GoogleProjectServiceTimeoutsOutputReference {
	var returns GoogleProjectServiceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewGoogleProjectService(scope constructs.Construct, id *string, config *GoogleProjectServiceConfig) GoogleProjectService {
	...
	if err := validateNewGoogleProjectServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleProjectService{}

	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleProjectService.GoogleProjectService",
...
func (j *jsiiProxy_GoogleProjectService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func GoogleProjectService_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-googlebeta.googleProjectService.GoogleProjectService",
...
func (g *jsiiProxy_GoogleProjectService) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleProjectService) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleProjectService) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleProjectService) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleProjectService) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleProjectService) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleProjectService) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleProjectService) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleProjectService) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleProjectService) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleProjectService) PutTimeouts(value *GoogleProjectServiceTimeouts) {
...
func (g *jsiiProxy_GoogleProjectService) ResetDisableDependentServices() {
	_jsii_.InvokeVoid(
		g,
		"resetDisableDependentServices",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ResetDisableOnDestroy() {
	_jsii_.InvokeVoid(
		g,
		"resetDisableOnDestroy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectService) ToString() *string {
	var returns *string
