...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceAccount.GoogleServiceAccount",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceAccount.GoogleServiceAccountConfig",
		reflect.TypeOf((*GoogleServiceAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceAccount.GoogleServiceAccountTimeouts",
		reflect.TypeOf((*GoogleServiceAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceAccount.GoogleServiceAccountTimeoutsOutputReference",
