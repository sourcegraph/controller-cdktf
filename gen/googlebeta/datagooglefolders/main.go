...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleFolders.DataGoogleFoldersConfig",
		reflect.TypeOf((*DataGoogleFoldersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleFolders.DataGoogleFoldersFolders",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleFolders.DataGoogleFoldersFoldersOutputReference",
