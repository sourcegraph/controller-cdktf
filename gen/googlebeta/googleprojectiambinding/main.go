...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamBinding.GoogleProjectIamBindingCondition",
		reflect.TypeOf((*GoogleProjectIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectIamBinding.GoogleProjectIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamBinding.GoogleProjectIamBindingConfig",
