...
// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_autoscaling_policy google_dataproc_autoscaling_policy}.
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_autoscaling_policy google_dataproc_autoscaling_policy} Resource.
func NewGoogleDataprocAutoscalingPolicy(scope constructs.Construct, id *string, config *GoogleDataprocAutoscalingPolicyConfig) GoogleDataprocAutoscalingPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDataprocAutoscalingPolicy.GoogleDataprocAutoscalingPolicy",
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
