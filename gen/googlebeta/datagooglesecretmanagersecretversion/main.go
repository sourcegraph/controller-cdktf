...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleSecretManagerSecretVersion.DataGoogleSecretManagerSecretVersion",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleSecretManagerSecretVersion.DataGoogleSecretManagerSecretVersionConfig",
