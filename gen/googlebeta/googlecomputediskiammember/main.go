...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberCondition",
		reflect.TypeOf((*GoogleComputeDiskIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberConfig",
