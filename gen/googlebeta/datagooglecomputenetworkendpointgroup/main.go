...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeNetworkEndpointGroup.DataGoogleComputeNetworkEndpointGroup",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeNetworkEndpointGroup.DataGoogleComputeNetworkEndpointGroupConfig",
