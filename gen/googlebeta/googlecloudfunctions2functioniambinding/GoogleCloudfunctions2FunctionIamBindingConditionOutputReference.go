...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecloudfunctions2functioniambinding/internal"
)
...
func NewGoogleCloudfunctions2FunctionIamBindingConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleCloudfunctions2FunctionIamBindingConditionOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleCloudfunctions2FunctionIamBinding.GoogleCloudfunctions2FunctionIamBindingConditionOutputReference",
