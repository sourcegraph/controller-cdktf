...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecomputeregiontargethttpsproxy/internal"
)
...
func NewGoogleComputeRegionTargetHttpsProxyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleComputeRegionTargetHttpsProxyTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeRegionTargetHttpsProxy.GoogleComputeRegionTargetHttpsProxyTimeoutsOutputReference",
