...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataflowFlexTemplateJob.GoogleDataflowFlexTemplateJob",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataflowFlexTemplateJob.GoogleDataflowFlexTemplateJobConfig",
