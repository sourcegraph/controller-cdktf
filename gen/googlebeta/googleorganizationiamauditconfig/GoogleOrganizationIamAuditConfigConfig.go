...
type GoogleOrganizationIamAuditConfigConfig struct {
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_organization_iam_audit_config#id GoogleOrganizationIamAuditConfig#id}.
	//
