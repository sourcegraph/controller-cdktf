...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamAuditConfig.GoogleOrganizationIamAuditConfigAuditLogConfig",
		reflect.TypeOf((*GoogleOrganizationIamAuditConfigAuditLogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleOrganizationIamAuditConfig.GoogleOrganizationIamAuditConfigAuditLogConfigList",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleOrganizationIamAuditConfig.GoogleOrganizationIamAuditConfigConfig",
