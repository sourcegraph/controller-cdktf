...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleGkeHubMembershipIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberCondition",
		reflect.TypeOf((*GoogleGkeHubMembershipIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleGkeHubMembershipIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberConfig",
		reflect.TypeOf((*GoogleGkeHubMembershipIamMemberConfig)(nil)).Elem(),
	)
}
