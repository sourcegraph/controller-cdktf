...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleCloudRunServiceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudRunServiceIamBinding.GoogleCloudRunServiceIamBindingCondition",
		reflect.TypeOf((*GoogleCloudRunServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudRunServiceIamBinding.GoogleCloudRunServiceIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleCloudRunServiceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudRunServiceIamBinding.GoogleCloudRunServiceIamBindingConfig",
		reflect.TypeOf((*GoogleCloudRunServiceIamBindingConfig)(nil)).Elem(),
	)
}
