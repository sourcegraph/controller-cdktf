...
type GoogleComputeFirewallPolicyRuleConfig struct {
	// Experimental.
	...
	Match *GoogleComputeFirewallPolicyRuleMatch `field:"required" json:"match" yaml:"match"`
	...
	Timeouts *GoogleComputeFirewallPolicyRuleTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
