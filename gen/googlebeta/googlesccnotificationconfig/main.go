...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfig",
		reflect.TypeOf((*GoogleSccNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeouts",
		reflect.TypeOf((*GoogleSccNotificationConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeoutsOutputReference",
