...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointConfig",
		reflect.TypeOf((*GoogleServiceDirectoryEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointTimeouts",
		reflect.TypeOf((*GoogleServiceDirectoryEndpointTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceDirectoryEndpoint.GoogleServiceDirectoryEndpointTimeoutsOutputReference",
