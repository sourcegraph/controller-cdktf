...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapTunnelIamBinding.GoogleIapTunnelIamBinding",
		reflect.TypeOf((*GoogleIapTunnelIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapTunnelIamBinding.GoogleIapTunnelIamBindingCondition",
		reflect.TypeOf((*GoogleIapTunnelIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapTunnelIamBinding.GoogleIapTunnelIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleIapTunnelIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapTunnelIamBinding.GoogleIapTunnelIamBindingConfig",
		reflect.TypeOf((*GoogleIapTunnelIamBindingConfig)(nil)).Elem(),
	)
}
