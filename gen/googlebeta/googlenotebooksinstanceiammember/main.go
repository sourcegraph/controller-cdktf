...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleNotebooksInstanceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberCondition",
		reflect.TypeOf((*GoogleNotebooksInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleNotebooksInstanceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberConfig",
		reflect.TypeOf((*GoogleNotebooksInstanceIamMemberConfig)(nil)).Elem(),
	)
}
