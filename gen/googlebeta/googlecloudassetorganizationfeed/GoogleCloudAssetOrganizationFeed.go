...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecloudassetorganizationfeed/internal"
)
...
func NewGoogleCloudAssetOrganizationFeed(scope constructs.Construct, id *string, config *GoogleCloudAssetOrganizationFeedConfig) GoogleCloudAssetOrganizationFeed {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleCloudAssetOrganizationFeed.GoogleCloudAssetOrganizationFeed",
