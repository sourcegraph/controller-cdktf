...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImageIamMember.GoogleComputeImageIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImageIamMember.GoogleComputeImageIamMemberConfig",
