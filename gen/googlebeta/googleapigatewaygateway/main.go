...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayConfig",
		reflect.TypeOf((*GoogleApiGatewayGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts",
