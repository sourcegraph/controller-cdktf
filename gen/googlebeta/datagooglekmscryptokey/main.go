...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyConfig",
		reflect.TypeOf((*DataGoogleKmsCryptoKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyVersionTemplate",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyVersionTemplateOutputReference",
