...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudiotRegistryIamBinding.GoogleCloudiotRegistryIamBindingConfig",
