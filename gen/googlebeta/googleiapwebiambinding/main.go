...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapWebIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapWebIamBinding.GoogleIapWebIamBindingCondition",
		reflect.TypeOf((*GoogleIapWebIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapWebIamBinding.GoogleIapWebIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleIapWebIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleIapWebIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapWebIamBinding.GoogleIapWebIamBindingConfig",
		reflect.TypeOf((*GoogleIapWebIamBindingConfig)(nil)).Elem(),
	)
}
