...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlecomputenetworkpeeringroutesconfig/internal"
)
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeNetworkPeeringRoutesConfig(scope constructs.Construct, id *string, config *GoogleComputeNetworkPeeringRoutesConfigConfig) GoogleComputeNetworkPeeringRoutesConfig {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeNetworkPeeringRoutesConfig.GoogleComputeNetworkPeeringRoutesConfig",
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
