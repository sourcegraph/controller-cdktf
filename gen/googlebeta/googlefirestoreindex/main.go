...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirestoreIndex.GoogleFirestoreIndexConfig",
		reflect.TypeOf((*GoogleFirestoreIndexConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirestoreIndex.GoogleFirestoreIndexFields",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirestoreIndex.GoogleFirestoreIndexTimeouts",
		reflect.TypeOf((*GoogleFirestoreIndexTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFirestoreIndex.GoogleFirestoreIndexTimeoutsOutputReference",
