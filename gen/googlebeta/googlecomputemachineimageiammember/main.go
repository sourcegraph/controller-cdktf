...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeMachineImageIamMember.GoogleComputeMachineImageIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeMachineImageIamMember.GoogleComputeMachineImageIamMemberConfig",
