...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerInstance.GoogleSpannerInstanceConfig",
		reflect.TypeOf((*GoogleSpannerInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerInstance.GoogleSpannerInstanceTimeouts",
