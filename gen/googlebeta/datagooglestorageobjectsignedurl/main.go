...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "extensionHeaders", GoGetter: "ExtensionHeaders"},
			_jsii_.MemberProperty{JsiiProperty: "extensionHeadersInput", GoGetter: "ExtensionHeadersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExtensionHeaders", GoMethod: "ResetExtensionHeaders"},
			_jsii_.MemberMethod{JsiiMethod: "resetHttpMethod", GoMethod: "ResetHttpMethod"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "signedUrl", GoGetter: "SignedUrl"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrlConfig",
