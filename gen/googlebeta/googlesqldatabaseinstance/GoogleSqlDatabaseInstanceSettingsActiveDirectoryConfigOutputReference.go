...
func (j *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleSqlDatabaseInstance.GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference",
...
func (j *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsActiveDirectoryConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
