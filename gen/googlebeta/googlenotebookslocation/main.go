...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksLocation.GoogleNotebooksLocationConfig",
		reflect.TypeOf((*GoogleNotebooksLocationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksLocation.GoogleNotebooksLocationTimeouts",
		reflect.TypeOf((*GoogleNotebooksLocationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksLocation.GoogleNotebooksLocationTimeoutsOutputReference",
