...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRouterInterface.GoogleComputeRouterInterfaceConfig",
		reflect.TypeOf((*GoogleComputeRouterInterfaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRouterInterface.GoogleComputeRouterInterfaceTimeouts",
