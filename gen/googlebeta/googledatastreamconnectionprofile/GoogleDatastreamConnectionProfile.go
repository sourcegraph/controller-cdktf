...
func (j *jsiiProxy_GoogleDatastreamConnectionProfile) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleDatastreamConnectionProfile(scope constructs.Construct, id *string, config *GoogleDatastreamConnectionProfileConfig) GoogleDatastreamConnectionProfile {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDatastreamConnectionProfile.GoogleDatastreamConnectionProfile",
...
func (j *jsiiProxy_GoogleDatastreamConnectionProfile)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
