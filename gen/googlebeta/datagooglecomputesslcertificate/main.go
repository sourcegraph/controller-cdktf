...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeSslCertificate.DataGoogleComputeSslCertificate",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeSslCertificate.DataGoogleComputeSslCertificateConfig",
