...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSqlServerUserDetails", GoMethod: "PutSqlServerUserDetails"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSqlServerUserDetails", GoMethod: "ResetSqlServerUserDetails"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetType", GoMethod: "ResetType"},
			_jsii_.MemberProperty{JsiiProperty: "sqlServerUserDetails", GoGetter: "SqlServerUserDetails"},
			_jsii_.MemberProperty{JsiiProperty: "sqlServerUserDetailsInput", GoGetter: "SqlServerUserDetailsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlUser.GoogleSqlUserConfig",
		reflect.TypeOf((*GoogleSqlUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlUser.GoogleSqlUserSqlServerUserDetails",
		reflect.TypeOf((*GoogleSqlUserSqlServerUserDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSqlUser.GoogleSqlUserSqlServerUserDetailsOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerRoles", GoMethod: "ResetServerRoles"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "serverRoles", GoGetter: "ServerRoles"},
			_jsii_.MemberProperty{JsiiProperty: "serverRolesInput", GoGetter: "ServerRolesInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSqlUser.GoogleSqlUserTimeouts",
