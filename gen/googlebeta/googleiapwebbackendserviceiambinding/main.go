...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamBinding.GoogleIapWebBackendServiceIamBinding",
		reflect.TypeOf((*GoogleIapWebBackendServiceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamBinding.GoogleIapWebBackendServiceIamBindingCondition",
		reflect.TypeOf((*GoogleIapWebBackendServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamBinding.GoogleIapWebBackendServiceIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleIapWebBackendServiceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamBinding.GoogleIapWebBackendServiceIamBindingConfig",
		reflect.TypeOf((*GoogleIapWebBackendServiceIamBindingConfig)(nil)).Elem(),
	)
}
