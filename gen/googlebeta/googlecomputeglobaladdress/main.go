...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeGlobalAddress.GoogleComputeGlobalAddressConfig",
		reflect.TypeOf((*GoogleComputeGlobalAddressConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeouts",
		reflect.TypeOf((*GoogleComputeGlobalAddressTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeoutsOutputReference",
