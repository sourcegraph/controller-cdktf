...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleVertexAiDataset.GoogleVertexAiDataset",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetConfig",
		reflect.TypeOf((*GoogleVertexAiDatasetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetEncryptionSpec",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetTimeouts",
