...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberCondition",
		reflect.TypeOf((*GoogleApiGatewayApiIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConfig",
