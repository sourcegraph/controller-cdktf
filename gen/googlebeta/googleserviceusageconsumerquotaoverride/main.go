...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "overrideValue", GoGetter: "OverrideValue"},
			_jsii_.MemberProperty{JsiiProperty: "overrideValueInput", GoGetter: "OverrideValueInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideConfig",
		reflect.TypeOf((*GoogleServiceUsageConsumerQuotaOverrideConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideTimeouts",
		reflect.TypeOf((*GoogleServiceUsageConsumerQuotaOverrideTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideTimeoutsOutputReference",
