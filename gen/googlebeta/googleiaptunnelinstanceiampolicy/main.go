...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamPolicy.GoogleIapTunnelInstanceIamPolicy",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamPolicy.GoogleIapTunnelInstanceIamPolicyConfig",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamPolicyConfig)(nil)).Elem(),
	)
}
