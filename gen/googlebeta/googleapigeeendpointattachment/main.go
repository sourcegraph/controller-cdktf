...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachment",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentConfig",
		reflect.TypeOf((*GoogleApigeeEndpointAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeouts",
