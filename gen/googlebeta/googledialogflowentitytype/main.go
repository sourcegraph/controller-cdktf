...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityType",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityTypeConfig",
		reflect.TypeOf((*GoogleDialogflowEntityTypeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityTypeEntities",
		reflect.TypeOf((*GoogleDialogflowEntityTypeEntities)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityTypeEntitiesList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityTypeEntitiesOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowEntityType.GoogleDialogflowEntityTypeTimeouts",
