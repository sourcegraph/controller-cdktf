...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMember",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberCondition",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberConditionOutputReference",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberConfig",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamMemberConfig)(nil)).Elem(),
	)
}
