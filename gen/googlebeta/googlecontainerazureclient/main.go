...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleContainerAzureClient.GoogleContainerAzureClient",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleContainerAzureClient.GoogleContainerAzureClientConfig",
		reflect.TypeOf((*GoogleContainerAzureClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleContainerAzureClient.GoogleContainerAzureClientTimeouts",
