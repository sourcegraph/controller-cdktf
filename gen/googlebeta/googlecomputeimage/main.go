...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageConfig",
		reflect.TypeOf((*GoogleComputeImageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageGuestOsFeatures",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageGuestOsFeaturesOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageRawDisk",
		reflect.TypeOf((*GoogleComputeImageRawDisk)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageRawDiskOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageTimeouts",
		reflect.TypeOf((*GoogleComputeImageTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeImage.GoogleComputeImageTimeoutsOutputReference",
