...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsConfig",
		reflect.TypeOf((*GoogleProjectDefaultServiceAccountsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts",
