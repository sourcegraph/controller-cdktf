...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googlebigqueryanalyticshubdataexchange/internal"
)
...
func NewGoogleBigqueryAnalyticsHubDataExchange(scope constructs.Construct, id *string, config *GoogleBigqueryAnalyticsHubDataExchangeConfig) GoogleBigqueryAnalyticsHubDataExchange {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleBigqueryAnalyticsHubDataExchange.GoogleBigqueryAnalyticsHubDataExchange",
