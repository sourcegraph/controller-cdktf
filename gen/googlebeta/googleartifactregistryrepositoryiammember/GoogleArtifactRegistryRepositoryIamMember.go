...
// Represents a {@link https://www.terraform.io/docs/providers/google-beta/r/google_artifact_registry_repository_iam_member google_artifact_registry_repository_iam_member}.
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google-beta/r/google_artifact_registry_repository_iam_member google_artifact_registry_repository_iam_member} Resource.
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
