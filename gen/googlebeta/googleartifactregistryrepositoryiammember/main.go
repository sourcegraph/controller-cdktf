...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepositoryIamMember.GoogleArtifactRegistryRepositoryIamMember",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepositoryIamMember.GoogleArtifactRegistryRepositoryIamMemberCondition",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleArtifactRegistryRepositoryIamMember.GoogleArtifactRegistryRepositoryIamMemberConfig",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryIamMemberConfig)(nil)).Elem(),
	)
}
