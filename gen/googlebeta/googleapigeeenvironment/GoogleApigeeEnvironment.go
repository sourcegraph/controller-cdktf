...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googleapigeeenvironment/internal"
)
...
type jsiiProxy_GoogleApigeeEnvironment struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GoogleApigeeEnvironment) ApiProxyType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiProxyType",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) ApiProxyTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiProxyTypeInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DeploymentType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentType",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DeploymentTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentTypeInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleApigeeEnvironment) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_GoogleApigeeEnvironment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleApigeeEnvironment) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleApigeeEnvironment) Timeouts() GoogleApigeeEnvironmentTimeoutsOutputReference {
	var returns GoogleApigeeEnvironmentTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewGoogleApigeeEnvironment(scope constructs.Construct, id *string, config *GoogleApigeeEnvironmentConfig) GoogleApigeeEnvironment {
	...
	if err := validateNewGoogleApigeeEnvironmentParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleApigeeEnvironment{}

	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironment",
...
func (j *jsiiProxy_GoogleApigeeEnvironment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func GoogleApigeeEnvironment_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironment",
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetApiProxyType() {
	_jsii_.InvokeVoid(
		g,
		"resetApiProxyType",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetDeploymentType() {
	_jsii_.InvokeVoid(
		g,
		"resetDeploymentType",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetDisplayName() {
	_jsii_.InvokeVoid(
		g,
		"resetDisplayName",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeEnvironment) ToString() *string {
	var returns *string
