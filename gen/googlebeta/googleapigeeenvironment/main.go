...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiProxyType", GoGetter: "ApiProxyType"},
			_jsii_.MemberProperty{JsiiProperty: "apiProxyTypeInput", GoGetter: "ApiProxyTypeInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironmentConfig",
		reflect.TypeOf((*GoogleApigeeEnvironmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironmentNodeConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "currentAggregateNodeCount", GoGetter: "CurrentAggregateNodeCount"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironmentTimeouts",
		reflect.TypeOf((*GoogleApigeeEnvironmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEnvironment.GoogleApigeeEnvironmentTimeoutsOutputReference",
