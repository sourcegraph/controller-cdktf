...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeRegionSslCertificate.GoogleComputeRegionSslCertificate",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionSslCertificate.GoogleComputeRegionSslCertificateConfig",
		reflect.TypeOf((*GoogleComputeRegionSslCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeRegionSslCertificate.GoogleComputeRegionSslCertificateTimeouts",
