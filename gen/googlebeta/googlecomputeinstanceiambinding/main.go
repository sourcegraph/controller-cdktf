...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleComputeInstanceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceIamBinding.GoogleComputeInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleComputeInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeInstanceIamBinding.GoogleComputeInstanceIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleComputeInstanceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceIamBinding.GoogleComputeInstanceIamBindingConfig",
		reflect.TypeOf((*GoogleComputeInstanceIamBindingConfig)(nil)).Elem(),
	)
}
