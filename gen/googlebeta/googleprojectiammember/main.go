...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectIamMember.GoogleProjectIamMember",
		reflect.TypeOf((*GoogleProjectIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamMember.GoogleProjectIamMemberCondition",
		reflect.TypeOf((*GoogleProjectIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectIamMember.GoogleProjectIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleProjectIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectIamMember.GoogleProjectIamMemberConfig",
		reflect.TypeOf((*GoogleProjectIamMemberConfig)(nil)).Elem(),
	)
}
