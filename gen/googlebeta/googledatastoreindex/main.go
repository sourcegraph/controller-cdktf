...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDatastoreIndex.GoogleDatastoreIndexConfig",
		reflect.TypeOf((*GoogleDatastoreIndexConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDatastoreIndex.GoogleDatastoreIndexProperties",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDatastoreIndex.GoogleDatastoreIndexPropertiesOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDatastoreIndex.GoogleDatastoreIndexTimeouts",
