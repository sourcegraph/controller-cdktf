...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroup",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupConfig",
		reflect.TypeOf((*GoogleApigeeEnvgroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeouts",
		reflect.TypeOf((*GoogleApigeeEnvgroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeoutsOutputReference",
