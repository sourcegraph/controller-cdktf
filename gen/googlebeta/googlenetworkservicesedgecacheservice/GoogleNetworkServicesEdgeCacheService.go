...
func (j *jsiiProxy_GoogleNetworkServicesEdgeCacheService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleNetworkServicesEdgeCacheService(scope constructs.Construct, id *string, config *GoogleNetworkServicesEdgeCacheServiceConfig) GoogleNetworkServicesEdgeCacheService {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleNetworkServicesEdgeCacheService.GoogleNetworkServicesEdgeCacheService",
...
func (j *jsiiProxy_GoogleNetworkServicesEdgeCacheService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
