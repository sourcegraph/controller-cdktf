...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagBinding.GoogleTagsTagBindingConfig",
		reflect.TypeOf((*GoogleTagsTagBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleTagsTagBinding.GoogleTagsTagBindingTimeouts",
		reflect.TypeOf((*GoogleTagsTagBindingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleTagsTagBinding.GoogleTagsTagBindingTimeoutsOutputReference",
