...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMember",
		reflect.TypeOf((*GoogleHealthcareDatasetIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberCondition",
		reflect.TypeOf((*GoogleHealthcareDatasetIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleHealthcareDatasetIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamMember.GoogleHealthcareDatasetIamMemberConfig",
		reflect.TypeOf((*GoogleHealthcareDatasetIamMemberConfig)(nil)).Elem(),
	)
}
