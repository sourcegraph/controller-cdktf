...
func (j *jsiiProxy_GoogleContainerAzureClusterWorkloadIdentityConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleContainerAzureClusterWorkloadIdentityConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleContainerAzureClusterWorkloadIdentityConfigList {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleContainerAzureCluster.GoogleContainerAzureClusterWorkloadIdentityConfigList",
...
func (j *jsiiProxy_GoogleContainerAzureClusterWorkloadIdentityConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleContainerAzureClusterWorkloadIdentityConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
