...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetwork",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkConfig",
		reflect.TypeOf((*DataGoogleComputeSubnetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRange",
		reflect.TypeOf((*DataGoogleComputeSubnetworkSecondaryIpRange)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRangeList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRangeOutputReference",
