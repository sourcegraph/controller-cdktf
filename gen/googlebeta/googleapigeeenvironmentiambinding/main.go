...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingCondition",
		reflect.TypeOf((*GoogleApigeeEnvironmentIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingConfig",
