...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingCondition",
		reflect.TypeOf((*GoogleHealthcareDatasetIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingConfig",
