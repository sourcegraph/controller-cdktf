...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataprocJobIamBinding.GoogleDataprocJobIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataprocJobIamBinding.GoogleDataprocJobIamBindingConfig",
