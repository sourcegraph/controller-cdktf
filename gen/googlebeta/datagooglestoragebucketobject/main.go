...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObject.DataGoogleStorageBucketObject",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectConfig",
		reflect.TypeOf((*DataGoogleStorageBucketObjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectCustomerEncryption",
