...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleResourceManagerLien.GoogleResourceManagerLienConfig",
		reflect.TypeOf((*GoogleResourceManagerLienConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleResourceManagerLien.GoogleResourceManagerLienTimeouts",
		reflect.TypeOf((*GoogleResourceManagerLienTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleResourceManagerLien.GoogleResourceManagerLienTimeoutsOutputReference",
