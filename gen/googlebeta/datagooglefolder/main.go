...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleFolder.DataGoogleFolder",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lookupOrganization", GoGetter: "LookupOrganization"},
			_jsii_.MemberProperty{JsiiProperty: "lookupOrganizationInput", GoGetter: "LookupOrganizationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLookupOrganization", GoMethod: "ResetLookupOrganization"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleFolder.DataGoogleFolderConfig",
