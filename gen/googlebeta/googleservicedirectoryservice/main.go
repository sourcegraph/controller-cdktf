...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceDirectoryService.GoogleServiceDirectoryService",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceDirectoryService.GoogleServiceDirectoryServiceConfig",
		reflect.TypeOf((*GoogleServiceDirectoryServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceDirectoryService.GoogleServiceDirectoryServiceTimeouts",
