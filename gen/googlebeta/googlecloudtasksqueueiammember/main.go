...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleCloudTasksQueueIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberCondition",
		reflect.TypeOf((*GoogleCloudTasksQueueIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleCloudTasksQueueIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberConfig",
		reflect.TypeOf((*GoogleCloudTasksQueueIamMemberConfig)(nil)).Elem(),
	)
}
