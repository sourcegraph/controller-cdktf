...
func (j *jsiiProxy_GoogleIdentityPlatformTenantInboundSamlConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleIdentityPlatformTenantInboundSamlConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
