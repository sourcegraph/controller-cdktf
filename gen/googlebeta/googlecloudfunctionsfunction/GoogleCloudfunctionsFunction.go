...
func (j *jsiiProxy_GoogleCloudfunctionsFunction) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleCloudfunctionsFunction(scope constructs.Construct, id *string, config *GoogleCloudfunctionsFunctionConfig) GoogleCloudfunctionsFunction {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleCloudfunctionsFunction.GoogleCloudfunctionsFunction",
...
func (j *jsiiProxy_GoogleCloudfunctionsFunction)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
