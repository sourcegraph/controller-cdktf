...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertext",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalAuthenticatedData", GoMethod: "ResetAdditionalAuthenticatedData"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextConfig",
		reflect.TypeOf((*GoogleKmsSecretCiphertextConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts",
