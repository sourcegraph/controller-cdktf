...
func (j *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleDialogflowCxPageEventHandlersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleDialogflowCxPageEventHandlersOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleDialogflowCxPage.GoogleDialogflowCxPageEventHandlersOutputReference",
...
func NewGoogleDialogflowCxPageEventHandlersOutputReference_Override(g GoogleDialogflowCxPageEventHandlersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxPageEventHandlersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
