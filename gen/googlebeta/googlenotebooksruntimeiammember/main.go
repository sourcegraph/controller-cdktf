...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberCondition",
		reflect.TypeOf((*GoogleNotebooksRuntimeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberConfig",
