...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareConsentStoreIamBinding.GoogleHealthcareConsentStoreIamBindingCondition",
		reflect.TypeOf((*GoogleHealthcareConsentStoreIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleHealthcareConsentStoreIamBinding.GoogleHealthcareConsentStoreIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareConsentStoreIamBinding.GoogleHealthcareConsentStoreIamBindingConfig",
