...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleCertificateManagerCertificateMapEntry.GoogleCertificateManagerCertificateMapEntry",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCertificateManagerCertificateMapEntry.GoogleCertificateManagerCertificateMapEntryConfig",
		reflect.TypeOf((*GoogleCertificateManagerCertificateMapEntryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleCertificateManagerCertificateMapEntry.GoogleCertificateManagerCertificateMapEntryTimeouts",
