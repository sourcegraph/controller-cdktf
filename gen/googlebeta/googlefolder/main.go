...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolder.GoogleFolderConfig",
		reflect.TypeOf((*GoogleFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolder.GoogleFolderTimeouts",
		reflect.TypeOf((*GoogleFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFolder.GoogleFolderTimeoutsOutputReference",
