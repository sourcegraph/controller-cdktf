...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceContents", GoGetter: "SourceContents"},
			_jsii_.MemberProperty{JsiiProperty: "sourceContentsInput", GoGetter: "SourceContentsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleWorkflowsWorkflow.GoogleWorkflowsWorkflowConfig",
		reflect.TypeOf((*GoogleWorkflowsWorkflowConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleWorkflowsWorkflow.GoogleWorkflowsWorkflowTimeouts",
		reflect.TypeOf((*GoogleWorkflowsWorkflowTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleWorkflowsWorkflow.GoogleWorkflowsWorkflowTimeoutsOutputReference",
