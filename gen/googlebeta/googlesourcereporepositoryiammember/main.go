...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamMember.GoogleSourcerepoRepositoryIamMemberCondition",
		reflect.TypeOf((*GoogleSourcerepoRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamMember.GoogleSourcerepoRepositoryIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamMember.GoogleSourcerepoRepositoryIamMemberConfig",
