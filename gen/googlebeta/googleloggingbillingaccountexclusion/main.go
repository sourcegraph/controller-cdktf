...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleLoggingBillingAccountExclusion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleLoggingBillingAccountExclusion.GoogleLoggingBillingAccountExclusionConfig",
		reflect.TypeOf((*GoogleLoggingBillingAccountExclusionConfig)(nil)).Elem(),
	)
}
