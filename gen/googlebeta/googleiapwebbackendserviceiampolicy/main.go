...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamPolicy.GoogleIapWebBackendServiceIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapWebBackendServiceIamPolicy.GoogleIapWebBackendServiceIamPolicyConfig",
