...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleDataCatalogTaxonomyIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTaxonomyIamMember.GoogleDataCatalogTaxonomyIamMemberCondition",
		reflect.TypeOf((*GoogleDataCatalogTaxonomyIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataCatalogTaxonomyIamMember.GoogleDataCatalogTaxonomyIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleDataCatalogTaxonomyIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataCatalogTaxonomyIamMember.GoogleDataCatalogTaxonomyIamMemberConfig",
		reflect.TypeOf((*GoogleDataCatalogTaxonomyIamMemberConfig)(nil)).Elem(),
	)
}
