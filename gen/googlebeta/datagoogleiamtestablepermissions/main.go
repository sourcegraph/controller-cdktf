...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissions",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customSupportLevel", GoGetter: "CustomSupportLevel"},
			_jsii_.MemberProperty{JsiiProperty: "customSupportLevelInput", GoGetter: "CustomSupportLevelInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "fullResourceName", GoGetter: "FullResourceName"},
			_jsii_.MemberProperty{JsiiProperty: "fullResourceNameInput", GoGetter: "FullResourceNameInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsConfig",
		reflect.TypeOf((*DataGoogleIamTestablePermissionsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissions",
		reflect.TypeOf((*DataGoogleIamTestablePermissionsPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsOutputReference",
