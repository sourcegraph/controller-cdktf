...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTelemetry", GoMethod: "ResetTelemetry"},
			...
			_jsii_.MemberProperty{JsiiProperty: "telemetryInput", GoGetter: "TelemetryInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceConfig",
		reflect.TypeOf((*GoogleMonitoringCustomServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetry",
		reflect.TypeOf((*GoogleMonitoringCustomServiceTelemetry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetryOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeouts",
		reflect.TypeOf((*GoogleMonitoringCustomServiceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeoutsOutputReference",
