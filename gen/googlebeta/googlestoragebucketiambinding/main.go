...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingCondition",
		reflect.TypeOf((*GoogleStorageBucketIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingConfig",
