...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPool",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolConfig",
		reflect.TypeOf((*GoogleIamWorkloadIdentityPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolTimeouts",
