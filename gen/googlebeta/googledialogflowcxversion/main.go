...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxVersion.GoogleDialogflowCxVersionConfig",
		reflect.TypeOf((*GoogleDialogflowCxVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxVersion.GoogleDialogflowCxVersionNluSettings",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxVersion.GoogleDialogflowCxVersionTimeouts",
		reflect.TypeOf((*GoogleDialogflowCxVersionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowCxVersion.GoogleDialogflowCxVersionTimeoutsOutputReference",
