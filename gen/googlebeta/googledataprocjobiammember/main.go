...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataprocJobIamMember.GoogleDataprocJobIamMember",
		reflect.TypeOf((*GoogleDataprocJobIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberCondition",
		reflect.TypeOf((*GoogleDataprocJobIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleDataprocJobIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberConfig",
		reflect.TypeOf((*GoogleDataprocJobIamMemberConfig)(nil)).Elem(),
	)
}
