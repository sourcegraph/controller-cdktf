...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringMeshIstioService.DataGoogleMonitoringMeshIstioServiceConfig",
		reflect.TypeOf((*DataGoogleMonitoringMeshIstioServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleMonitoringMeshIstioService.DataGoogleMonitoringMeshIstioServiceTelemetry",
