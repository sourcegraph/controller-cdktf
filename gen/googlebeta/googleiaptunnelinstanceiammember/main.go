...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamMember.GoogleIapTunnelInstanceIamMember",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamMember.GoogleIapTunnelInstanceIamMemberCondition",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamMember.GoogleIapTunnelInstanceIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapTunnelInstanceIamMember.GoogleIapTunnelInstanceIamMemberConfig",
		reflect.TypeOf((*GoogleIapTunnelInstanceIamMemberConfig)(nil)).Elem(),
	)
}
