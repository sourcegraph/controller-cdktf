...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberCondition",
		reflect.TypeOf((*GoogleSpannerDatabaseIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConfig",
