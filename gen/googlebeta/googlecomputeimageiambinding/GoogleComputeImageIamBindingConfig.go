...
type GoogleComputeImageIamBindingConfig struct {
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_compute_image_iam_binding#id GoogleComputeImageIamBinding#id}.
	//
