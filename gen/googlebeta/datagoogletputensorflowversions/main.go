...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleTpuTensorflowVersions.DataGoogleTpuTensorflowVersions",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleTpuTensorflowVersions.DataGoogleTpuTensorflowVersionsConfig",
