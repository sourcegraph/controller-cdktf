...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirestoreDocument.GoogleFirestoreDocumentConfig",
		reflect.TypeOf((*GoogleFirestoreDocumentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFirestoreDocument.GoogleFirestoreDocumentTimeouts",
