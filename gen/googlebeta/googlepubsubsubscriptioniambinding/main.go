...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingCondition",
		reflect.TypeOf((*GooglePubsubSubscriptionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingConfig",
