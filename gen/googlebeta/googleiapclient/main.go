...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapClient.GoogleIapClient",
		reflect.TypeOf((*GoogleIapClient)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "brand", GoGetter: "Brand"},
			_jsii_.MemberProperty{JsiiProperty: "brandInput", GoGetter: "BrandInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapClient.GoogleIapClientConfig",
		reflect.TypeOf((*GoogleIapClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIapClient.GoogleIapClientTimeouts",
		reflect.TypeOf((*GoogleIapClientTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIapClient.GoogleIapClientTimeoutsOutputReference",
