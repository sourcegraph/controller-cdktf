...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxy",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetTcpProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeouts",
