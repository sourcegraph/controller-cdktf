...
type GoogleComputeRegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy struct {
	...
	PerTryTimeout *GoogleComputeRegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout `field:"optional" json:"perTryTimeout" yaml:"perTryTimeout"`
