...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleComputeBackendServiceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamBinding.GoogleComputeBackendServiceIamBindingCondition",
		reflect.TypeOf((*GoogleComputeBackendServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamBinding.GoogleComputeBackendServiceIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleComputeBackendServiceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleComputeBackendServiceIamBindingConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeBackendServiceIamBinding.GoogleComputeBackendServiceIamBindingConfig",
		reflect.TypeOf((*GoogleComputeBackendServiceIamBindingConfig)(nil)).Elem(),
	)
}
