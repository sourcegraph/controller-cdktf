...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "databaseDialectInput", GoGetter: "DatabaseDialectInput"},
			_jsii_.MemberProperty{JsiiProperty: "ddl", GoGetter: "Ddl"},
			_jsii_.MemberProperty{JsiiProperty: "ddlInput", GoGetter: "DdlInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVersionRetentionPeriod", GoMethod: "ResetVersionRetentionPeriod"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerDatabase.GoogleSpannerDatabaseConfig",
		reflect.TypeOf((*GoogleSpannerDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerDatabase.GoogleSpannerDatabaseEncryptionConfig",
		reflect.TypeOf((*GoogleSpannerDatabaseEncryptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSpannerDatabase.GoogleSpannerDatabaseEncryptionConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSpannerDatabase.GoogleSpannerDatabaseTimeouts",
		reflect.TypeOf((*GoogleSpannerDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSpannerDatabase.GoogleSpannerDatabaseTimeoutsOutputReference",
