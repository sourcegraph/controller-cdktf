...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayConfig",
		reflect.TypeOf((*GoogleComputeVpnGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeouts",
