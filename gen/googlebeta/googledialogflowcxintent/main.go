...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntent",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTrainingPhrases", GoMethod: "ResetTrainingPhrases"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentConfig",
		reflect.TypeOf((*GoogleDialogflowCxIntentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentParameters",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentTimeouts",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentTrainingPhrases",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "partsInput", GoGetter: "PartsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putParts", GoMethod: "PutParts"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentTrainingPhrasesParts",
		reflect.TypeOf((*GoogleDialogflowCxIntentTrainingPhrasesParts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentTrainingPhrasesPartsList",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleDialogflowCxIntent.GoogleDialogflowCxIntentTrainingPhrasesPartsOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParameterId", GoMethod: "ResetParameterId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
