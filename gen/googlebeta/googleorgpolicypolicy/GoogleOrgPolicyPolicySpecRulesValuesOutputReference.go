...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googleorgpolicypolicy/internal"
)
...
func NewGoogleOrgPolicyPolicySpecRulesValuesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleOrgPolicyPolicySpecRulesValuesOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicySpecRulesValuesOutputReference",
