...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIdentityPlatformOauthIdpConfig.GoogleIdentityPlatformOauthIdpConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIdentityPlatformOauthIdpConfig.GoogleIdentityPlatformOauthIdpConfigConfig",
		reflect.TypeOf((*GoogleIdentityPlatformOauthIdpConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleIdentityPlatformOauthIdpConfig.GoogleIdentityPlatformOauthIdpConfigTimeouts",
		reflect.TypeOf((*GoogleIdentityPlatformOauthIdpConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleIdentityPlatformOauthIdpConfig.GoogleIdentityPlatformOauthIdpConfigTimeoutsOutputReference",
