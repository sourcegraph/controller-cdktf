...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition",
		reflect.TypeOf((*GoogleEndpointsServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingConfig",
