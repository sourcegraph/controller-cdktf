...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "projectTeam", GoGetter: "ProjectTeam"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageDefaultObjectAccessControl.GoogleStorageDefaultObjectAccessControlConfig",
		reflect.TypeOf((*GoogleStorageDefaultObjectAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageDefaultObjectAccessControl.GoogleStorageDefaultObjectAccessControlProjectTeam",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleStorageDefaultObjectAccessControl.GoogleStorageDefaultObjectAccessControlTimeouts",
