...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigqueryConnectionIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamBinding.GoogleBigqueryConnectionIamBindingCondition",
		reflect.TypeOf((*GoogleBigqueryConnectionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamBinding.GoogleBigqueryConnectionIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBigqueryConnectionIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigqueryConnectionIamBinding.GoogleBigqueryConnectionIamBindingConfig",
		reflect.TypeOf((*GoogleBigqueryConnectionIamBindingConfig)(nil)).Elem(),
	)
}
