...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googlePrivatecaCertificateTemplate.GooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList",
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplatePredefinedValuesPolicyIdsList) Resolve(_context cdktf.IResolveContext) interface{} {
