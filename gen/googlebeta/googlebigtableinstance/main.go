...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstance",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstanceCluster",
		reflect.TypeOf((*GoogleBigtableInstanceCluster)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterAutoscalingConfig",
		reflect.TypeOf((*GoogleBigtableInstanceClusterAutoscalingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterAutoscalingConfigOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cpuTarget", GoGetter: "CpuTarget"},
			_jsii_.MemberProperty{JsiiProperty: "cpuTargetInput", GoGetter: "CpuTargetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStorageTarget", GoMethod: "ResetStorageTarget"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "storageTarget", GoGetter: "StorageTarget"},
			_jsii_.MemberProperty{JsiiProperty: "storageTargetInput", GoGetter: "StorageTargetInput"},
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleBigtableInstance.GoogleBigtableInstanceConfig",
