...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolderIamBinding.GoogleFolderIamBindingCondition",
		reflect.TypeOf((*GoogleFolderIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleFolderIamBinding.GoogleFolderIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleFolderIamBinding.GoogleFolderIamBindingConfig",
