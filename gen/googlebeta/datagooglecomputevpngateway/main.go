...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGateway",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGatewayConfig",
