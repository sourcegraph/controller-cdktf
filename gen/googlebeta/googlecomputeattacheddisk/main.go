...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskConfig",
		reflect.TypeOf((*GoogleComputeAttachedDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeouts",
		reflect.TypeOf((*GoogleComputeAttachedDiskTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeoutsOutputReference",
