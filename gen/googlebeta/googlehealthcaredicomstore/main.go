...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDicomStore.GoogleHealthcareDicomStoreConfig",
		reflect.TypeOf((*GoogleHealthcareDicomStoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDicomStore.GoogleHealthcareDicomStoreNotificationConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDicomStore.GoogleHealthcareDicomStoreStreamConfigs",
		reflect.TypeOf((*GoogleHealthcareDicomStoreStreamConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDicomStore.GoogleHealthcareDicomStoreStreamConfigsBigqueryDestination",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "tableUri", GoGetter: "TableUri"},
			_jsii_.MemberProperty{JsiiProperty: "tableUriInput", GoGetter: "TableUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleHealthcareDicomStore.GoogleHealthcareDicomStoreTimeouts",
