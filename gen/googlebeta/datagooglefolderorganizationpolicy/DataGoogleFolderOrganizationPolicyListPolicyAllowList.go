...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyListPolicyAllowList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleFolderOrganizationPolicyListPolicyAllowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleFolderOrganizationPolicyListPolicyAllowList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleFolderOrganizationPolicy.DataGoogleFolderOrganizationPolicyListPolicyAllowList",
...
func NewDataGoogleFolderOrganizationPolicyListPolicyAllowList_Override(d DataGoogleFolderOrganizationPolicyListPolicyAllowList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyListPolicyAllowList)SetTerraformResource(val cdktf.IInterpolatingParent) {
