...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyBooleanPolicyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleFolderOrganizationPolicyBooleanPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleFolderOrganizationPolicyBooleanPolicyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleFolderOrganizationPolicy.DataGoogleFolderOrganizationPolicyBooleanPolicyList",
...
func NewDataGoogleFolderOrganizationPolicyBooleanPolicyList_Override(d DataGoogleFolderOrganizationPolicyBooleanPolicyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyBooleanPolicyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleFolderOrganizationPolicyBooleanPolicyList) Resolve(_context cdktf.IResolveContext) interface{} {
