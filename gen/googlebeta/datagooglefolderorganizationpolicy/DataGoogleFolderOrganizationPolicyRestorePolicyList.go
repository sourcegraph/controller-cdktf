...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyRestorePolicyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleFolderOrganizationPolicyRestorePolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleFolderOrganizationPolicyRestorePolicyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleFolderOrganizationPolicy.DataGoogleFolderOrganizationPolicyRestorePolicyList",
...
func NewDataGoogleFolderOrganizationPolicyRestorePolicyList_Override(d DataGoogleFolderOrganizationPolicyRestorePolicyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyRestorePolicyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleFolderOrganizationPolicyRestorePolicyList) Resolve(_context cdktf.IResolveContext) interface{} {
