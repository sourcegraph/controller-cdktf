...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyListPolicyDenyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleFolderOrganizationPolicyListPolicyDenyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleFolderOrganizationPolicyListPolicyDenyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.dataGoogleFolderOrganizationPolicy.DataGoogleFolderOrganizationPolicyListPolicyDenyList",
...
func NewDataGoogleFolderOrganizationPolicyListPolicyDenyList_Override(d DataGoogleFolderOrganizationPolicyListPolicyDenyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleFolderOrganizationPolicyListPolicyDenyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleFolderOrganizationPolicyListPolicyDenyList) Resolve(_context cdktf.IResolveContext) interface{} {
