...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/googlebeta/googleproject/internal"
)
...
type GoogleProject interface {
	...
	PutTimeouts(value *GoogleProjectTimeouts)
...
type jsiiProxy_GoogleProject struct {
...
func (j *jsiiProxy_GoogleProject) BillingAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccount",
...
func (j *jsiiProxy_GoogleProject) BillingAccountInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccountInput",
...
func (j *jsiiProxy_GoogleProject) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleProject) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GoogleProject) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GoogleProject) FolderId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderId",
...
func (j *jsiiProxy_GoogleProject) FolderIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderIdInput",
...
func (j *jsiiProxy_GoogleProject) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleProject) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GoogleProject) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GoogleProject) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GoogleProject) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GoogleProject) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleProject) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleProject) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleProject) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GoogleProject) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GoogleProject) Node() constructs.Node {
...
func (j *jsiiProxy_GoogleProject) Number() *string {
	var returns *string
	_jsii_.Get(
		j,
		"number",
...
func (j *jsiiProxy_GoogleProject) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_GoogleProject) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_GoogleProject) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_GoogleProject) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_GoogleProject) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleProject) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleProject) Timeouts() GoogleProjectTimeoutsOutputReference {
	var returns GoogleProjectTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewGoogleProject(scope constructs.Construct, id *string, config *GoogleProjectConfig) GoogleProject {
	...
	if err := validateNewGoogleProjectParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_GoogleProject{}

	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleProject.GoogleProject",
...
func (j *jsiiProxy_GoogleProject)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func GoogleProject_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-googlebeta.googleProject.GoogleProject",
...
func (g *jsiiProxy_GoogleProject) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleProject) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GoogleProject) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GoogleProject) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GoogleProject) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GoogleProject) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GoogleProject) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GoogleProject) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GoogleProject) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleProject) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GoogleProject) PutTimeouts(value *GoogleProjectTimeouts) {
...
func (g *jsiiProxy_GoogleProject) ResetAutoCreateNetwork() {
	_jsii_.InvokeVoid(
		g,
		"resetAutoCreateNetwork",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetBillingAccount() {
	_jsii_.InvokeVoid(
		g,
		"resetBillingAccount",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetFolderId() {
	_jsii_.InvokeVoid(
		g,
		"resetFolderId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetOrgId() {
	_jsii_.InvokeVoid(
		g,
		"resetOrgId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProject) ToString() *string {
	var returns *string
