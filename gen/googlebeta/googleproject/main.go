...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoCreateNetwork", GoGetter: "AutoCreateNetwork"},
			_jsii_.MemberProperty{JsiiProperty: "autoCreateNetworkInput", GoGetter: "AutoCreateNetworkInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSkipDelete", GoMethod: "ResetSkipDelete"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "skipDelete", GoGetter: "SkipDelete"},
			_jsii_.MemberProperty{JsiiProperty: "skipDeleteInput", GoGetter: "SkipDeleteInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProject.GoogleProjectConfig",
		reflect.TypeOf((*GoogleProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProject.GoogleProjectTimeouts",
		reflect.TypeOf((*GoogleProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProject.GoogleProjectTimeoutsOutputReference",
