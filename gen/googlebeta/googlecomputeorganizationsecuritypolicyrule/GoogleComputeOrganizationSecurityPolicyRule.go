...
func (j *jsiiProxy_GoogleComputeOrganizationSecurityPolicyRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewGoogleComputeOrganizationSecurityPolicyRule(scope constructs.Construct, id *string, config *GoogleComputeOrganizationSecurityPolicyRuleConfig) GoogleComputeOrganizationSecurityPolicyRule {
	...
	_jsii_.Create(
		"@cdktf/provider-googlebeta.googleComputeOrganizationSecurityPolicyRule.GoogleComputeOrganizationSecurityPolicyRule",
...
func (j *jsiiProxy_GoogleComputeOrganizationSecurityPolicyRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
