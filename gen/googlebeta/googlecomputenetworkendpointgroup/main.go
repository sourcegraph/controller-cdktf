...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupConfig",
		reflect.TypeOf((*GoogleComputeNetworkEndpointGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkEndpointGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupTimeoutsOutputReference",
