...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucket",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketConfig",
		reflect.TypeOf((*GoogleProjectUsageExportBucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts",
		reflect.TypeOf((*GoogleProjectUsageExportBucketTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeoutsOutputReference",
