...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleStorageProjectServiceAccount.DataGoogleStorageProjectServiceAccount",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUserProject", GoMethod: "ResetUserProject"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleStorageProjectServiceAccount.DataGoogleStorageProjectServiceAccountConfig",
