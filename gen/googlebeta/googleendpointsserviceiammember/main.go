...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleEndpointsServiceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberCondition",
		reflect.TypeOf((*GoogleEndpointsServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleEndpointsServiceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleEndpointsServiceIamMemberConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberConfig",
		reflect.TypeOf((*GoogleEndpointsServiceIamMemberConfig)(nil)).Elem(),
	)
}
