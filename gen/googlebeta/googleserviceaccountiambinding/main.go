...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition",
		reflect.TypeOf((*GoogleServiceAccountIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConfig",
