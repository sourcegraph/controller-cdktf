...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamMember.GoogleApiGatewayGatewayIamMemberCondition",
		reflect.TypeOf((*GoogleApiGatewayGatewayIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamMember.GoogleApiGatewayGatewayIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleApiGatewayGatewayIamMember.GoogleApiGatewayGatewayIamMemberConfig",
