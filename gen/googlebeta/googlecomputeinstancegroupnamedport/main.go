...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortA",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortAConfig",
		reflect.TypeOf((*GoogleComputeInstanceGroupNamedPortAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortTimeouts",
		reflect.TypeOf((*GoogleComputeInstanceGroupNamedPortTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortTimeoutsOutputReference",
