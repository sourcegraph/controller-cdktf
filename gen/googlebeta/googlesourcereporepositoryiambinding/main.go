...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamBinding.GoogleSourcerepoRepositoryIamBindingCondition",
		reflect.TypeOf((*GoogleSourcerepoRepositoryIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamBinding.GoogleSourcerepoRepositoryIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.googleSourcerepoRepositoryIamBinding.GoogleSourcerepoRepositoryIamBindingConfig",
