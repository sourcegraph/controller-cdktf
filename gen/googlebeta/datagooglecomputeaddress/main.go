...
func init() {
	_jsii_.RegisterClass(
		"@cdktf/provider-googlebeta.dataGoogleComputeAddress.DataGoogleComputeAddress",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-googlebeta.dataGoogleComputeAddress.DataGoogleComputeAddressConfig",
