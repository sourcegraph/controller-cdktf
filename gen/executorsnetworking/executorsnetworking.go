...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Executorsnetworking)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipCidrOutput", GoGetter: "IpCidrOutput"},
			_jsii_.MemberProperty{JsiiProperty: "nat", GoGetter: "Nat"},
			_jsii_.MemberProperty{JsiiProperty: "natIpOutput", GoGetter: "NatIpOutput"},
			_jsii_.MemberProperty{JsiiProperty: "natMinPortsPerVm", GoGetter: "NatMinPortsPerVm"},
			_jsii_.MemberProperty{JsiiProperty: "networkIdOutput", GoGetter: "NetworkIdOutput"},
	...
	_jsii_.RegisterStruct(
		"executorsnetworking.ExecutorsnetworkingOptions",
		reflect.TypeOf((*ExecutorsnetworkingOptions)(nil)).Elem(),
	)
}
