package sesdomainidentityverification
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesdomainidentityverification/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_domain_identity_verification aws_ses_domain_identity_verification}.
...
func (j *jsiiProxy_SesDomainIdentityVerification) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesDomainIdentityVerification) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSesDomainIdentityVerification(scope constructs.Construct, id *string, config *SesDomainIdentityVerificationConfig) SesDomainIdentityVerification {
	...
	if err := validateNewSesDomainIdentityVerificationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SesDomainIdentityVerification_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesDomainIdentityVerification_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesDomainIdentityVerification) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesDomainIdentityVerification) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesDomainIdentityVerification) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesDomainIdentityVerification) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesDomainIdentityVerification) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) MoveToId(id *string) {
...
func (s *jsiiProxy_SesDomainIdentityVerification) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
