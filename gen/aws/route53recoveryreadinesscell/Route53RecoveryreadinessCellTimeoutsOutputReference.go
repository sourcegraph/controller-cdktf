...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRoute53RecoveryreadinessCellTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53RecoveryreadinessCellTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRoute53RecoveryreadinessCellTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRoute53RecoveryreadinessCellTimeoutsOutputReference_Override(r Route53RecoveryreadinessCellTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessCellTimeoutsOutputReference) ToString() *string {
	var returns *string
