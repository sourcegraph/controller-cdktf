...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/organizationsdelegatedadministrator/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/organizations_delegated_administrator aws_organizations_delegated_administrator}.
...
func NewOrganizationsDelegatedAdministrator(scope constructs.Construct, id *string, config *OrganizationsDelegatedAdministratorConfig) OrganizationsDelegatedAdministrator {
	...
	if err := validateNewOrganizationsDelegatedAdministratorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsDelegatedAdministrator) AddMoveTarget(moveTarget *string) {
