...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ec2_instance_types aws_ec2_instance_types}.
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Filter() DataAwsEc2InstanceTypesFilterList {
	var returns DataAwsEc2InstanceTypesFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsEc2InstanceTypes) Timeouts() DataAwsEc2InstanceTypesTimeoutsOutputReference {
	var returns DataAwsEc2InstanceTypesTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsEc2InstanceTypes(scope constructs.Construct, id *string, config *DataAwsEc2InstanceTypesConfig) DataAwsEc2InstanceTypes {
	...
	if err := validateNewDataAwsEc2InstanceTypesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEc2InstanceTypes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEc2InstanceTypes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) PutTimeouts(value *DataAwsEc2InstanceTypesTimeouts) {
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEc2InstanceTypes) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
