...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/guarddutyorganizationconfiguration/internal"
)
...
func NewGuarddutyOrganizationConfiguration(scope constructs.Construct, id *string, config *GuarddutyOrganizationConfigurationConfig) GuarddutyOrganizationConfiguration {
	...
	if err := validateNewGuarddutyOrganizationConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
