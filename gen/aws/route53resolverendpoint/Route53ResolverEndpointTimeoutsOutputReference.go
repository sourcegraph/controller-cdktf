...
func (j *jsiiProxy_Route53ResolverEndpointTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53ResolverEndpointTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53ResolverEndpointTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewRoute53ResolverEndpointTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53ResolverEndpointTimeoutsOutputReference {
	...
	if err := validateNewRoute53ResolverEndpointTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRoute53ResolverEndpointTimeoutsOutputReference_Override(r Route53ResolverEndpointTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverEndpointTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53ResolverEndpointTimeoutsOutputReference) ToString() *string {
	var returns *string
