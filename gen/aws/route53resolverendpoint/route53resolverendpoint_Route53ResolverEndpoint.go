...
type Route53ResolverEndpoint interface {
	...
	SetId(val *string)
	IdInput() *string
	IpAddress() Route53ResolverEndpointIpAddressList
...
func (j *jsiiProxy_Route53ResolverEndpoint) Connection() interface{} {
...
func (j *jsiiProxy_Route53ResolverEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Route53ResolverEndpoint) IpAddress() Route53ResolverEndpointIpAddressList {
	var returns Route53ResolverEndpointIpAddressList
	_jsii_.Get(
		j,
		"ipAddress",
		&returns,
...
func (j *jsiiProxy_Route53ResolverEndpoint) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_Route53ResolverEndpoint) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func NewRoute53ResolverEndpoint(scope constructs.Construct, id *string, config *Route53ResolverEndpointConfig) Route53ResolverEndpoint {
	...
	if err := validateNewRoute53ResolverEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetConnection(val interface{}) {
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetId(val *string) {
...
func (j *jsiiProxy_Route53ResolverEndpoint)SetProvisioners(val *[]interface{}) {
...
func Route53ResolverEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateRoute53ResolverEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_Route53ResolverEndpoint) PutIpAddress(value interface{}) {
	if err := r.validatePutIpAddressParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_Route53ResolverEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
