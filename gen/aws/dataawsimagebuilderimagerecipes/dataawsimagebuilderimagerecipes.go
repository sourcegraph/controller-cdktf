...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_image_recipes aws_imagebuilder_image_recipes}.
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) Filter() DataAwsImagebuilderImageRecipesFilterList {
	var returns DataAwsImagebuilderImageRecipesFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_image_recipes aws_imagebuilder_image_recipes} Data Source.
func NewDataAwsImagebuilderImageRecipes(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageRecipesConfig) DataAwsImagebuilderImageRecipes {
	...
	if err := validateNewDataAwsImagebuilderImageRecipesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipes)SetId(val *string) {
...
func DataAwsImagebuilderImageRecipes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderImageRecipes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsImagebuilderImageRecipes_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsImagebuilderImageRecipes_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsImagebuilderImageRecipes_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderImageRecipes_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsImagebuilderImageRecipes_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsImagebuilderImageRecipes_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) PutFilter(value interface{}) {
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipes) ToHclTerraform() interface{} {
	var returns interface{}
