...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshiftserverless_endpoint_access aws_redshiftserverless_endpoint_access}.
...
type jsiiProxy_RedshiftserverlessEndpointAccess struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Address() *string {
	var returns *string
	_jsii_.Get(
		j,
		"address",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) EndpointName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointName",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) EndpointNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpointNameInput",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Node() constructs.Node {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) SubnetIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnetIdsInput",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) VpcEndpoint() RedshiftserverlessEndpointAccessVpcEndpointList {
	var returns RedshiftserverlessEndpointAccessVpcEndpointList
	_jsii_.Get(
		j,
		"vpcEndpoint",
		&returns,
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) VpcSecurityGroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"vpcSecurityGroupIds",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) VpcSecurityGroupIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) WorkgroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workgroupName",
...
func (j *jsiiProxy_RedshiftserverlessEndpointAccess) WorkgroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workgroupNameInput",
...
func NewRedshiftserverlessEndpointAccess(scope constructs.Construct, id *string, config *RedshiftserverlessEndpointAccessConfig) RedshiftserverlessEndpointAccess {
	...
	if err := validateNewRedshiftserverlessEndpointAccessParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftserverlessEndpointAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateRedshiftserverlessEndpointAccess_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) ResetVpcSecurityGroupIds() {
	_jsii_.InvokeVoid(
		r,
		"resetVpcSecurityGroupIds",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessEndpointAccess) ToString() *string {
	var returns *string
