...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/servicecatalog_organizations_access aws_servicecatalog_organizations_access}.
type ServicecatalogOrganizationsAccess interface {
	...
	PutTimeouts(value *ServicecatalogOrganizationsAccessTimeouts)
	ResetId()
...
func (j *jsiiProxy_ServicecatalogOrganizationsAccess) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogOrganizationsAccess) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogOrganizationsAccess) Timeouts() ServicecatalogOrganizationsAccessTimeoutsOutputReference {
	var returns ServicecatalogOrganizationsAccessTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogOrganizationsAccess(scope constructs.Construct, id *string, config *ServicecatalogOrganizationsAccessConfig) ServicecatalogOrganizationsAccess {
	...
	if err := validateNewServicecatalogOrganizationsAccessParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServicecatalogOrganizationsAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogOrganizationsAccess_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogOrganizationsAccess) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogOrganizationsAccess) PutTimeouts(value *ServicecatalogOrganizationsAccessTimeouts) {
...
func (s *jsiiProxy_ServicecatalogOrganizationsAccess) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogOrganizationsAccess) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
