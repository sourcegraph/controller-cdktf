...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/neptuneclustersnapshot/internal"
)
...
func NewNeptuneClusterSnapshotTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NeptuneClusterSnapshotTimeoutsOutputReference {
	...
	if err := validateNewNeptuneClusterSnapshotTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
