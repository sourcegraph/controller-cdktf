...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/fmspolicy/internal"
)
...
func NewFmsPolicyIncludeMapOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FmsPolicyIncludeMapOutputReference {
	...
	if err := validateNewFmsPolicyIncludeMapOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
