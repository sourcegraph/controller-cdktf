...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaydocumentationpart/internal"
)
...
func NewApiGatewayDocumentationPart(scope constructs.Construct, id *string, config *ApiGatewayDocumentationPartConfig) ApiGatewayDocumentationPart {
	...
	if err := validateNewApiGatewayDocumentationPartParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayDocumentationPart) PutLocation(value *ApiGatewayDocumentationPartLocation) {
	if err := a.validatePutLocationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
