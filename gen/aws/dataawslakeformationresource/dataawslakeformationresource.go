package dataawslakeformationresource
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawslakeformationresource/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/lakeformation_resource aws_lakeformation_resource}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/lakeformation_resource aws_lakeformation_resource} Data Source.
func NewDataAwsLakeformationResource(scope constructs.Construct, id *string, config *DataAwsLakeformationResourceConfig) DataAwsLakeformationResource {
	...
	if err := validateNewDataAwsLakeformationResourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsLakeformationResource_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsLakeformationResource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsLakeformationResource) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsLakeformationResource) ToHclTerraform() interface{} {
	var returns interface{}
