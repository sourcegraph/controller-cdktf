...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewayrestapi/internal"
)
...
func NewDataAwsApiGatewayRestApi(scope constructs.Construct, id *string, config *DataAwsApiGatewayRestApiConfig) DataAwsApiGatewayRestApi {
	...
	if err := validateNewDataAwsApiGatewayRestApiParameters(scope, id, config); err != nil {
		panic(err)
	}
