...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsnetworkfirewallfirewallpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy}.
...
func NewDataAwsNetworkfirewallFirewallPolicy(scope constructs.Construct, id *string, config *DataAwsNetworkfirewallFirewallPolicyConfig) DataAwsNetworkfirewallFirewallPolicy {
	...
	if err := validateNewDataAwsNetworkfirewallFirewallPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsNetworkfirewallFirewallPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsNetworkfirewallFirewallPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
