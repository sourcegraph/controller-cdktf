...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayusageplankey/internal"
)
...
func NewApiGatewayUsagePlanKey(scope constructs.Construct, id *string, config *ApiGatewayUsagePlanKeyConfig) ApiGatewayUsagePlanKey {
	...
	if err := validateNewApiGatewayUsagePlanKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
