...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudformationstack/internal"
)
...
func NewDataAwsCloudformationStack(scope constructs.Construct, id *string, config *DataAwsCloudformationStackConfig) DataAwsCloudformationStack {
	...
	if err := validateNewDataAwsCloudformationStackParameters(scope, id, config); err != nil {
		panic(err)
	}
