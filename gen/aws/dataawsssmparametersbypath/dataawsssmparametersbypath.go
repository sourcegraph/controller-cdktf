...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsssmparametersbypath/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ssm_parameters_by_path aws_ssm_parameters_by_path}.
...
func NewDataAwsSsmParametersByPath(scope constructs.Construct, id *string, config *DataAwsSsmParametersByPathConfig) DataAwsSsmParametersByPath {
	...
	if err := validateNewDataAwsSsmParametersByPathParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsSsmParametersByPath_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSsmParametersByPath_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
