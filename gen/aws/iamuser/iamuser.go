...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamuser/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_user aws_iam_user}.
...
func (j *jsiiProxy_IamUser) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamUser) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamUser(scope constructs.Construct, id *string, config *IamUserConfig) IamUser {
	...
	if err := validateNewIamUserParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_IamUser{}
...
func IamUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamUser) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamUser) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamUser) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamUser) MoveToId(id *string) {
...
func (i *jsiiProxy_IamUser) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
