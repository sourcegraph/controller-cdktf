...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxhostedpublicvirtualinterface/internal"
)
...
func NewDxHostedPublicVirtualInterfaceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DxHostedPublicVirtualInterfaceTimeoutsOutputReference {
	...
	if err := validateNewDxHostedPublicVirtualInterfaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
