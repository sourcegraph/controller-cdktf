...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/directoryserviceshareddirectory/internal"
)
...
func NewDirectoryServiceSharedDirectoryTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DirectoryServiceSharedDirectoryTimeoutsOutputReference {
	...
	if err := validateNewDirectoryServiceSharedDirectoryTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
