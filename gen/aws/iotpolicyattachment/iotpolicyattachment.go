...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iotpolicyattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iot_policy_attachment aws_iot_policy_attachment}.
...
func (j *jsiiProxy_IotPolicyAttachment) Connection() interface{} {
...
func (j *jsiiProxy_IotPolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IotPolicyAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iot_policy_attachment aws_iot_policy_attachment} Resource.
func NewIotPolicyAttachment(scope constructs.Construct, id *string, config *IotPolicyAttachmentConfig) IotPolicyAttachment {
	_init_.Initialize()

	if err := validateNewIotPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IotPolicyAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IotPolicyAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotPolicyAttachment)SetId(val *string) {
...
func (j *jsiiProxy_IotPolicyAttachment)SetProvisioners(val *[]interface{}) {
...
func IotPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IotPolicyAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateIotPolicyAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotPolicyAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotPolicyAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotPolicyAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotPolicyAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IotPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotPolicyAttachment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotPolicyAttachment) MoveToId(id *string) {
...
func (i *jsiiProxy_IotPolicyAttachment) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IotPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
