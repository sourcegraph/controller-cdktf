...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalbytematchset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_byte_match_set aws_wafregional_byte_match_set}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_byte_match_set aws_wafregional_byte_match_set} Resource.
func NewWafregionalByteMatchSet(scope constructs.Construct, id *string, config *WafregionalByteMatchSetConfig) WafregionalByteMatchSet {
	...
	if err := validateNewWafregionalByteMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalByteMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalByteMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalByteMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalByteMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalByteMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalByteMatchSet) PutByteMatchTuples(value interface{}) {
	if err := w.validatePutByteMatchTuplesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalByteMatchSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalByteMatchSet) ToHclTerraform() interface{} {
	var returns interface{}
