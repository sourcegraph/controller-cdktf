...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/serverlessapplicationrepositorycloudformationstack/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/serverlessapplicationrepository_cloudformation_stack aws_serverlessapplicationrepository_cloudformation_stack}.
...
func (s *jsiiProxy_ServerlessapplicationrepositoryCloudformationStack) AddMoveTarget(moveTarget *string) {
