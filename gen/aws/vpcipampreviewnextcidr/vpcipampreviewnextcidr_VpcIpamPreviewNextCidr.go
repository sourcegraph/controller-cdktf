...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpcipampreviewnextcidr/internal"
)
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcIpamPreviewNextCidr)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
