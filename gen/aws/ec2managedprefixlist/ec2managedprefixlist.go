...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2managedprefixlist/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ec2_managed_prefix_list aws_ec2_managed_prefix_list}.
...
type jsiiProxy_Ec2ManagedPrefixList struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Ec2ManagedPrefixList) AddressFamily() *string {
	var returns *string
	_jsii_.Get(
		j,
		"addressFamily",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) AddressFamilyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"addressFamilyInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Entry() Ec2ManagedPrefixListEntryList {
	var returns Ec2ManagedPrefixListEntryList
	_jsii_.Get(
		j,
		"entry",
		&returns,
...
func (j *jsiiProxy_Ec2ManagedPrefixList) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) MaxEntries() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxEntries",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) MaxEntriesInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxEntriesInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Node() constructs.Node {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Tags() *map[string]*string {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2ManagedPrefixList) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2ManagedPrefixList) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2ManagedPrefixList) Version() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"version",
...
func NewEc2ManagedPrefixList(scope constructs.Construct, id *string, config *Ec2ManagedPrefixListConfig) Ec2ManagedPrefixList {
	...
	if err := validateNewEc2ManagedPrefixListParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Ec2ManagedPrefixList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2ManagedPrefixList_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Ec2ManagedPrefixList_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.ec2ManagedPrefixList.Ec2ManagedPrefixList",
...
func (e *jsiiProxy_Ec2ManagedPrefixList) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ResetEntry() {
	_jsii_.InvokeVoid(
		e,
		"resetEntry",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ResetTags() {
	_jsii_.InvokeVoid(
		e,
		"resetTags",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ResetTagsAll() {
	_jsii_.InvokeVoid(
		e,
		"resetTagsAll",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2ManagedPrefixList) ToString() *string {
	var returns *string
