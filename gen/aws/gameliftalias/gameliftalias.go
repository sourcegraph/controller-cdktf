...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/gameliftalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/gamelift_alias aws_gamelift_alias}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/gamelift_alias aws_gamelift_alias} Resource.
func NewGameliftAlias(scope constructs.Construct, id *string, config *GameliftAliasConfig) GameliftAlias {
	_init_.Initialize()

	if err := validateNewGameliftAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GameliftAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGameliftAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GameliftAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateGameliftAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GameliftAlias_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGameliftAlias_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GameliftAlias_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGameliftAlias_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GameliftAlias) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GameliftAlias) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GameliftAlias) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GameliftAlias) MoveFromId(id *string) {
...
func (g *jsiiProxy_GameliftAlias) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GameliftAlias) MoveToId(id *string) {
...
func (g *jsiiProxy_GameliftAlias) PutRoutingStrategy(value *GameliftAliasRoutingStrategy) {
	if err := g.validatePutRoutingStrategyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GameliftAlias) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GameliftAlias) ToHclTerraform() interface{} {
	var returns interface{}
