...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicediscoveryprivatednsnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/service_discovery_private_dns_namespace aws_service_discovery_private_dns_namespace}.
...
func NewServiceDiscoveryPrivateDnsNamespace(scope constructs.Construct, id *string, config *ServiceDiscoveryPrivateDnsNamespaceConfig) ServiceDiscoveryPrivateDnsNamespace {
	...
	if err := validateNewServiceDiscoveryPrivateDnsNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServiceDiscoveryPrivateDnsNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceDiscoveryPrivateDnsNamespace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceDiscoveryPrivateDnsNamespace) AddMoveTarget(moveTarget *string) {
