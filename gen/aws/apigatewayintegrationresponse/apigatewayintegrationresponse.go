...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayintegrationresponse/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_integration_response aws_api_gateway_integration_response}.
...
func ApiGatewayIntegrationResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiGatewayIntegrationResponse) ImportFrom(id *string, provider cdktf.TerraformProvider) {
