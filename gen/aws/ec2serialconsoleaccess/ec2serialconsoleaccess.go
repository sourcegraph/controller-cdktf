package ec2serialconsoleaccess
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2serialconsoleaccess/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ec2_serial_console_access aws_ec2_serial_console_access}.
...
type jsiiProxy_Ec2SerialConsoleAccess struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Ec2SerialConsoleAccess) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) Node() constructs.Node {
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2SerialConsoleAccess) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewEc2SerialConsoleAccess(scope constructs.Construct, id *string, config *Ec2SerialConsoleAccessConfig) Ec2SerialConsoleAccess {
	...
	if err := validateNewEc2SerialConsoleAccessParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Ec2SerialConsoleAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2SerialConsoleAccess_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Ec2SerialConsoleAccess_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.ec2SerialConsoleAccess.Ec2SerialConsoleAccess",
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) MoveFromId(id *string) {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) MoveToId(id *string) {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) ResetEnabled() {
	_jsii_.InvokeVoid(
		e,
		"resetEnabled",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2SerialConsoleAccess) ToString() *string {
	var returns *string
