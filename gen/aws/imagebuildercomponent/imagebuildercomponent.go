...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "changeDescriptionInput", GoGetter: "ChangeDescriptionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSupportedOsVersions", GoMethod: "ResetSupportedOsVersions"},
			...
			_jsii_.MemberProperty{JsiiProperty: "supportedOsVersionsInput", GoGetter: "SupportedOsVersionsInput"},
	...
	_jsii_.RegisterStruct(
		"aws.imagebuilderComponent.ImagebuilderComponentConfig",
