...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/imagebuildercomponent/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/imagebuilder_component aws_imagebuilder_component}.
...
func (j *jsiiProxy_ImagebuilderComponent) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ImagebuilderComponent) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewImagebuilderComponent(scope constructs.Construct, id *string, config *ImagebuilderComponentConfig) ImagebuilderComponent {
	...
	if err := validateNewImagebuilderComponentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ImagebuilderComponent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateImagebuilderComponent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_ImagebuilderComponent) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_ImagebuilderComponent) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_ImagebuilderComponent) MoveFromId(id *string) {
...
func (i *jsiiProxy_ImagebuilderComponent) MoveToId(id *string) {
...
func (i *jsiiProxy_ImagebuilderComponent) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
