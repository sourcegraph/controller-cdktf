...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatcheventarchive/internal"
)
...
func NewCloudwatchEventArchive(scope constructs.Construct, id *string, config *CloudwatchEventArchiveConfig) CloudwatchEventArchive {
	...
	if err := validateNewCloudwatchEventArchiveParameters(scope, id, config); err != nil {
		panic(err)
	}
