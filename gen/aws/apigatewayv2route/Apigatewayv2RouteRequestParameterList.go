...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayv2route/internal"
)
...
func NewApigatewayv2RouteRequestParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Apigatewayv2RouteRequestParameterList {
	...
	if err := validateNewApigatewayv2RouteRequestParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_Apigatewayv2RouteRequestParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
