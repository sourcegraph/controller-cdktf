...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_option_group aws_db_option_group}.
...
func (j *jsiiProxy_DbOptionGroup) Connection() interface{} {
...
func (j *jsiiProxy_DbOptionGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbOptionGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbOptionGroup) Option() DbOptionGroupOptionList {
	var returns DbOptionGroupOptionList
	_jsii_.Get(
		j,
		"option",
		&returns,
...
func (j *jsiiProxy_DbOptionGroup) OptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionInput",
...
func (j *jsiiProxy_DbOptionGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_DbOptionGroup) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DbOptionGroup) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DbOptionGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DbOptionGroup) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_option_group aws_db_option_group} Resource.
func NewDbOptionGroup(scope constructs.Construct, id *string, config *DbOptionGroupConfig) DbOptionGroup {
	_init_.Initialize()

	if err := validateNewDbOptionGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DbOptionGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DbOptionGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbOptionGroup)SetId(val *string) {
...
func (j *jsiiProxy_DbOptionGroup)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_DbOptionGroup)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_DbOptionGroup)SetTagsAll(val *map[string]*string) {
...
func DbOptionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbOptionGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DbOptionGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDbOptionGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbOptionGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbOptionGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbOptionGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbOptionGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DbOptionGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbOptionGroup) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DbOptionGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbOptionGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbOptionGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbOptionGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbOptionGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DbOptionGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbOptionGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbOptionGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DbOptionGroup) MoveToId(id *string) {
...
func (d *jsiiProxy_DbOptionGroup) PutOption(value interface{}) {
...
func (d *jsiiProxy_DbOptionGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DbOptionGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DbOptionGroup) ToHclTerraform() interface{} {
	var returns interface{}
