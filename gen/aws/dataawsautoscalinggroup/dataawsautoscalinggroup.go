...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsautoscalinggroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/autoscaling_group aws_autoscaling_group}.
...
func NewDataAwsAutoscalingGroup(scope constructs.Construct, id *string, config *DataAwsAutoscalingGroupConfig) DataAwsAutoscalingGroup {
	...
	_jsii_.Create(
		"aws.dataAwsAutoscalingGroup.DataAwsAutoscalingGroup",
