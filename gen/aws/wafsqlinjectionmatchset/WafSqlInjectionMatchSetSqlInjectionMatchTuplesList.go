...
func (j *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWafSqlInjectionMatchSetSqlInjectionMatchTuplesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafSqlInjectionMatchSetSqlInjectionMatchTuplesList {
	_init_.Initialize()
...
func NewWafSqlInjectionMatchSetSqlInjectionMatchTuplesList_Override(w WafSqlInjectionMatchSetSqlInjectionMatchTuplesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WafSqlInjectionMatchSetSqlInjectionMatchTuplesList) Resolve(_context cdktf.IResolveContext) interface{} {
