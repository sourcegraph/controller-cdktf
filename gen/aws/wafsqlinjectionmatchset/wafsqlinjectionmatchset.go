...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/waf_sql_injection_match_set aws_waf_sql_injection_match_set}.
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafSqlInjectionMatchSet) SqlInjectionMatchTuples() WafSqlInjectionMatchSetSqlInjectionMatchTuplesList {
	var returns WafSqlInjectionMatchSetSqlInjectionMatchTuplesList
	_jsii_.Get(
		j,
...
func NewWafSqlInjectionMatchSet(scope constructs.Construct, id *string, config *WafSqlInjectionMatchSetConfig) WafSqlInjectionMatchSet {
	...
	if err := validateNewWafSqlInjectionMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafSqlInjectionMatchSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafSqlInjectionMatchSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafSqlInjectionMatchSet) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
