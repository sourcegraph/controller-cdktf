...
func (j *jsiiProxy_DataAwsAuditmanagerFrameworkControlSetsControlsList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataAwsAuditmanagerFrameworkControlSetsControlsList)SetInternalValue(val interface{}) {
