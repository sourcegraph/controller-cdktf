...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datasync_location_nfs aws_datasync_location_nfs}.
...
func (j *jsiiProxy_DatasyncLocationNfs) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (d *jsiiProxy_DatasyncLocationNfs) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatasyncLocationNfs) MoveToId(id *string) {
...
func (d *jsiiProxy_DatasyncLocationNfs) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
