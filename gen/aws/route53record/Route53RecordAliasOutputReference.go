...
// The jsii proxy struct for Route53RecordAliasOutputReference
type jsiiProxy_Route53RecordAliasOutputReference struct {
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_Route53RecordAliasOutputReference) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Route53RecordAliasOutputReference) ToString() *string {
	var returns *string
