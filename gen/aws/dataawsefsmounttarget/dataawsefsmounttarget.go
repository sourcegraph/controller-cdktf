...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsefsmounttarget/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/efs_mount_target aws_efs_mount_target}.
...
func (j *jsiiProxy_DataAwsEfsMountTarget) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEfsMountTarget(scope constructs.Construct, id *string, config *DataAwsEfsMountTargetConfig) DataAwsEfsMountTarget {
	...
	if err := validateNewDataAwsEfsMountTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEfsMountTarget) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
