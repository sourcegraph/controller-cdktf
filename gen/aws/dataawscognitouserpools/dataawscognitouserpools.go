package dataawscognitouserpools
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscognitouserpools/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cognito_user_pools aws_cognito_user_pools}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cognito_user_pools aws_cognito_user_pools} Data Source.
func NewDataAwsCognitoUserPools(scope constructs.Construct, id *string, config *DataAwsCognitoUserPoolsConfig) DataAwsCognitoUserPools {
	...
	if err := validateNewDataAwsCognitoUserPoolsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsCognitoUserPools{}

	_jsii_.Create(
		"@cdktf/provider-aws.dataAwsCognitoUserPools.DataAwsCognitoUserPools",
...
func DataAwsCognitoUserPools_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCognitoUserPools_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsCognitoUserPools_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCognitoUserPools_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCognitoUserPools_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCognitoUserPools_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCognitoUserPools_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCognitoUserPools_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCognitoUserPools) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCognitoUserPools) ToHclTerraform() interface{} {
	var returns interface{}
