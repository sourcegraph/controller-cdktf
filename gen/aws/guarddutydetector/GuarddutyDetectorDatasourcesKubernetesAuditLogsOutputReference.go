...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/guarddutydetector/internal"
)
...
func NewGuarddutyDetectorDatasourcesKubernetesAuditLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GuarddutyDetectorDatasourcesKubernetesAuditLogsOutputReference {
	...
	if err := validateNewGuarddutyDetectorDatasourcesKubernetesAuditLogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
