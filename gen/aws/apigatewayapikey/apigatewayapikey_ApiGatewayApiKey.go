...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayapikey/internal"
)
...
func NewApiGatewayApiKey(scope constructs.Construct, id *string, config *ApiGatewayApiKeyConfig) ApiGatewayApiKey {
	...
	if err := validateNewApiGatewayApiKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiGatewayApiKey{}

	_jsii_.Create(
		"aws.apiGatewayApiKey.ApiGatewayApiKey",
