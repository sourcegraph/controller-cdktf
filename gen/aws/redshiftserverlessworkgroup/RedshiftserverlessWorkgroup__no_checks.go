...
func (j *jsiiProxy_RedshiftserverlessWorkgroup) validateSetIdParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_RedshiftserverlessWorkgroup) validateSetTagsParameters(val *map[string]*string) error {
	return nil
}

func (j *jsiiProxy_RedshiftserverlessWorkgroup) validateSetTagsAllParameters(val *map[string]*string) error {
	return nil
}
