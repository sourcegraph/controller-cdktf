...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_routing_profile aws_connect_routing_profile}.
...
type jsiiProxy_ConnectRoutingProfile struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ConnectRoutingProfile) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_ConnectRoutingProfile) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ConnectRoutingProfile) DefaultOutboundQueueId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectRoutingProfile) DefaultOutboundQueueIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultOutboundQueueIdInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ConnectRoutingProfile) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ConnectRoutingProfile) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ConnectRoutingProfile) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectRoutingProfile) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConnectRoutingProfile) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ConnectRoutingProfile) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ConnectRoutingProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_ConnectRoutingProfile) InstanceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceIdInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConnectRoutingProfile) MediaConcurrencies() ConnectRoutingProfileMediaConcurrenciesList {
	var returns ConnectRoutingProfileMediaConcurrenciesList
	_jsii_.Get(
		j,
		"mediaConcurrencies",
		&returns,
...
func (j *jsiiProxy_ConnectRoutingProfile) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ConnectRoutingProfile) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) Node() constructs.Node {
...
func (j *jsiiProxy_ConnectRoutingProfile) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ConnectRoutingProfile) QueueConfigs() ConnectRoutingProfileQueueConfigsList {
	var returns ConnectRoutingProfileQueueConfigsList
	_jsii_.Get(
		j,
		"queueConfigs",
		&returns,
...
func (j *jsiiProxy_ConnectRoutingProfile) RoutingProfileId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingProfileId",
...
func (j *jsiiProxy_ConnectRoutingProfile) Tags() *map[string]*string {
...
func (j *jsiiProxy_ConnectRoutingProfile) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_ConnectRoutingProfile) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ConnectRoutingProfile) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConnectRoutingProfile) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewConnectRoutingProfile(scope constructs.Construct, id *string, config *ConnectRoutingProfileConfig) ConnectRoutingProfile {
	...
	if err := validateNewConnectRoutingProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConnectRoutingProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConnectRoutingProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConnectRoutingProfile_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.connectRoutingProfile.ConnectRoutingProfile",
...
func (c *jsiiProxy_ConnectRoutingProfile) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ConnectRoutingProfile) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ConnectRoutingProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConnectRoutingProfile) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConnectRoutingProfile) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConnectRoutingProfile) MoveToId(id *string) {
...
func (c *jsiiProxy_ConnectRoutingProfile) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ConnectRoutingProfile) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectRoutingProfile) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectRoutingProfile) ResetQueueConfigs() {
	_jsii_.InvokeVoid(
		c,
		"resetQueueConfigs",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectRoutingProfile) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectRoutingProfile) ResetTagsAll() {
	_jsii_.InvokeVoid(
		c,
		"resetTagsAll",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectRoutingProfile) ToString() *string {
	var returns *string
