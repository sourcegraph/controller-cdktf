...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmmaintenancewindowtarget/internal"
)
...
func NewSsmMaintenanceWindowTargetTargetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmMaintenanceWindowTargetTargetsList {
	...
	if err := validateNewSsmMaintenanceWindowTargetTargetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmMaintenanceWindowTargetTargetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
