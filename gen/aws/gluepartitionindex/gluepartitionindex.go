...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_partition_index aws_glue_partition_index}.
type GluePartitionIndex interface {
	...
	PutTimeouts(value *GluePartitionIndexTimeouts)
	ResetCatalogId()
	ResetId()
...
func (j *jsiiProxy_GluePartitionIndex) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GluePartitionIndex) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GluePartitionIndex) Timeouts() GluePartitionIndexTimeoutsOutputReference {
	var returns GluePartitionIndexTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewGluePartitionIndex(scope constructs.Construct, id *string, config *GluePartitionIndexConfig) GluePartitionIndex {
	...
	if err := validateNewGluePartitionIndexParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GluePartitionIndex_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGluePartitionIndex_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GluePartitionIndex) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GluePartitionIndex) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GluePartitionIndex) MoveFromId(id *string) {
...
func (g *jsiiProxy_GluePartitionIndex) MoveToId(id *string) {
...
func (g *jsiiProxy_GluePartitionIndex) PutTimeouts(value *GluePartitionIndexTimeouts) {
...
func (g *jsiiProxy_GluePartitionIndex) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GluePartitionIndex) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
