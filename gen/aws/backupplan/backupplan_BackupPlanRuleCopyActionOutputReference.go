...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) DestinationVaultArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationVaultArn",
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) DestinationVaultArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationVaultArnInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) Lifecycle() BackupPlanRuleCopyActionLifecycleOutputReference {
	var returns BackupPlanRuleCopyActionLifecycleOutputReference
	_jsii_.Get(
		j,
		"lifecycle",
		&returns,
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) LifecycleInput() *BackupPlanRuleCopyActionLifecycle {
...
func (j *jsiiProxy_BackupPlanRuleCopyActionOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func NewBackupPlanRuleCopyActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BackupPlanRuleCopyActionOutputReference {
	...
	_jsii_.Create(
		"aws.backupPlan.BackupPlanRuleCopyActionOutputReference",
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) PutLifecycle(value *BackupPlanRuleCopyActionLifecycle) {
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) ResetLifecycle() {
	_jsii_.InvokeVoid(
		b,
		"resetLifecycle",
		nil, // no parameters
...
func (b *jsiiProxy_BackupPlanRuleCopyActionOutputReference) ToString() *string {
	var returns *string
