...
func (b *jsiiProxy_BackupPlan) validateGetAnyMapAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetBooleanAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetBooleanMapAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetListAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetNumberAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetNumberListAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetNumberMapAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetStringAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateGetStringMapAttributeParameters(terraformAttribute *string) error {
	return nil
}
...
func (b *jsiiProxy_BackupPlan) validateMoveToIdParameters(id *string) error {
	return nil
}

func (b *jsiiProxy_BackupPlan) validateOverrideLogicalIdParameters(newLogicalId *string) error {
	return nil
}
...
func (j *jsiiProxy_BackupPlan) validateSetNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_BackupPlan) validateSetTagsParameters(val *map[string]*string) error {
	return nil
}

func (j *jsiiProxy_BackupPlan) validateSetTagsAllParameters(val *map[string]*string) error {
	return nil
}

func validateNewBackupPlanParameters(scope constructs.Construct, id *string, config *BackupPlanConfig) error {
	return nil
}
