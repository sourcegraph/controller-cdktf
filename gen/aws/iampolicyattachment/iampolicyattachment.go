...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iampolicyattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_policy_attachment aws_iam_policy_attachment}.
...
func (j *jsiiProxy_IamPolicyAttachment) Connection() interface{} {
...
func (j *jsiiProxy_IamPolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamPolicyAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_policy_attachment aws_iam_policy_attachment} Resource.
func NewIamPolicyAttachment(scope constructs.Construct, id *string, config *IamPolicyAttachmentConfig) IamPolicyAttachment {
	_init_.Initialize()

	if err := validateNewIamPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IamPolicyAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IamPolicyAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamPolicyAttachment)SetId(val *string) {
...
func (j *jsiiProxy_IamPolicyAttachment)SetProvisioners(val *[]interface{}) {
...
func IamPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IamPolicyAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateIamPolicyAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IamPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamPolicyAttachment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IamPolicyAttachment) MoveToId(id *string) {
...
func (i *jsiiProxy_IamPolicyAttachment) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IamPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
