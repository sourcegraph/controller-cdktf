...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_policy aws_iam_policy}.
...
func (j *jsiiProxy_DataAwsIamPolicy) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsIamPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamPolicy(scope constructs.Construct, id *string, config *DataAwsIamPolicyConfig) DataAwsIamPolicy {
	...
	if err := validateNewDataAwsIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsIamPolicy) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
