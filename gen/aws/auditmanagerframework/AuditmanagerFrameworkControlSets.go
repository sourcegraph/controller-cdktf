...
type AuditmanagerFrameworkControlSets struct {
	...
	// controls block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/auditmanager_framework#controls AuditmanagerFramework#controls}
