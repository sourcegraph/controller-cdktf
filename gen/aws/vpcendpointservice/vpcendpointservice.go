...
func init() {
	_jsii_.RegisterClass(
		"aws.vpcEndpointService.VpcEndpointService",
	...
	_jsii_.RegisterStruct(
		"aws.vpcEndpointService.VpcEndpointServicePrivateDnsNameConfiguration",
	...
	_jsii_.RegisterStruct(
		"aws.vpcEndpointService.VpcEndpointServiceTimeouts",
