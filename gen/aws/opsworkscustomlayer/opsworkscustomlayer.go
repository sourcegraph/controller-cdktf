...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/opsworks_custom_layer aws_opsworks_custom_layer}.
...
func OpsworksCustomLayer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOpsworksCustomLayer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksCustomLayer) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OpsworksCustomLayer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OpsworksCustomLayer) MoveFromId(id *string) {
...
func (o *jsiiProxy_OpsworksCustomLayer) MoveToId(id *string) {
