...
func (j *jsiiProxy_BackupSelection) Condition() BackupSelectionConditionList {
	var returns BackupSelectionConditionList
	_jsii_.Get(
		j,
		"condition",
		&returns,
...
func (j *jsiiProxy_BackupSelection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupSelection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BackupSelection) SelectionTag() BackupSelectionSelectionTagList {
	var returns BackupSelectionSelectionTagList
	_jsii_.Get(
		j,
		"selectionTag",
		&returns,
...
func NewBackupSelection(scope constructs.Construct, id *string, config *BackupSelectionConfig) BackupSelection {
	...
	if err := validateNewBackupSelectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupSelection) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
