...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicequotasservicequota/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/servicequotas_service_quota aws_servicequotas_service_quota}.
...
func NewServicequotasServiceQuota(scope constructs.Construct, id *string, config *ServicequotasServiceQuotaConfig) ServicequotasServiceQuota {
	...
	if err := validateNewServicequotasServiceQuotaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServicequotasServiceQuota_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicequotasServiceQuota_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicequotasServiceQuota) AddMoveTarget(moveTarget *string) {
