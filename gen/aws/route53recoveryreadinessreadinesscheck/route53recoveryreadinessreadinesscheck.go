...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53recoveryreadinessreadinesscheck/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53recoveryreadiness_readiness_check aws_route53recoveryreadiness_readiness_check}.
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoveryreadinessReadinessCheck) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53RecoveryreadinessReadinessCheck(scope constructs.Construct, id *string, config *Route53RecoveryreadinessReadinessCheckConfig) Route53RecoveryreadinessReadinessCheck {
	...
	if err := validateNewRoute53RecoveryreadinessReadinessCheckParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53RecoveryreadinessReadinessCheck_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53RecoveryreadinessReadinessCheck_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53RecoveryreadinessReadinessCheck) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
