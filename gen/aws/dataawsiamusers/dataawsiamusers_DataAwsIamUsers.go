...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamusers/internal"
)
...
func (j *jsiiProxy_DataAwsIamUsers) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamUsers) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamUsers(scope constructs.Construct, id *string, config *DataAwsIamUsersConfig) DataAwsIamUsers {
	...
	if err := validateNewDataAwsIamUsersParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsIamUsers{}

	_jsii_.Create(
		"aws.dataAwsIamUsers.DataAwsIamUsers",
...
func (d *jsiiProxy_DataAwsIamUsers) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
