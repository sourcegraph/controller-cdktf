...
func (d *jsiiProxy_DataAwsImagebuilderDistributionConfigurationDistributionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAwsImagebuilderDistributionConfigurationDistributionList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfigurationDistributionList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfigurationDistributionList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
