...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/glaciervault/internal"
)
...
func NewGlacierVaultNotificationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlacierVaultNotificationOutputReference {
	...
	if err := validateNewGlacierVaultNotificationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
