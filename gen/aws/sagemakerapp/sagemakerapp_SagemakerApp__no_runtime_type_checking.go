...
func (j *jsiiProxy_SagemakerApp) validateSetIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_SagemakerApp) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	return nil
}
...
func (j *jsiiProxy_SagemakerApp) validateSetTagsParameters(val *map[string]*string) error {
	return nil
}

func (j *jsiiProxy_SagemakerApp) validateSetTagsAllParameters(val *map[string]*string) error {
	return nil
}
