...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appsyncdomainnameapiassociation/internal"
)
...
func NewAppsyncDomainNameApiAssociation(scope constructs.Construct, id *string, config *AppsyncDomainNameApiAssociationConfig) AppsyncDomainNameApiAssociation {
	...
	if err := validateNewAppsyncDomainNameApiAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_AppsyncDomainNameApiAssociation{}

	_jsii_.Create(
		"aws.appsyncDomainNameApiAssociation.AppsyncDomainNameApiAssociation",
...
func AppsyncDomainNameApiAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppsyncDomainNameApiAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
