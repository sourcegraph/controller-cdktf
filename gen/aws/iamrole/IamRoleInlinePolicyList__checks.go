...
func (i *jsiiProxy_IamRoleInlinePolicyList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_IamRoleInlinePolicyList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*IamRoleInlinePolicy:
		val := val.(*[]*IamRoleInlinePolicy)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*IamRoleInlinePolicy; received %#v (a %T)", val, val)
		}
	}
