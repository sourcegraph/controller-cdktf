...
func (j *jsiiProxy_PrometheusWorkspace) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PrometheusWorkspace) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_PrometheusWorkspace) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PrometheusWorkspace) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_PrometheusWorkspace) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_PrometheusWorkspace) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewPrometheusWorkspace(scope constructs.Construct, id *string, config *PrometheusWorkspaceConfig) PrometheusWorkspace {
	...
	if err := validateNewPrometheusWorkspaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PrometheusWorkspace)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (p *jsiiProxy_PrometheusWorkspace) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PrometheusWorkspace) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PrometheusWorkspace) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PrometheusWorkspace) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PrometheusWorkspace) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PrometheusWorkspace) ResetTags() {
	_jsii_.InvokeVoid(
		p,
		"resetTags",
		nil, // no parameters
...
func (p *jsiiProxy_PrometheusWorkspace) ResetTagsAll() {
	_jsii_.InvokeVoid(
		p,
		"resetTagsAll",
		nil, // no parameters
