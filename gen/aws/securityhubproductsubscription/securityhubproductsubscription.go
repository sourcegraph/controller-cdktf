...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/securityhubproductsubscription/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/securityhub_product_subscription aws_securityhub_product_subscription}.
...
func (j *jsiiProxy_SecurityhubProductSubscription) Connection() interface{} {
...
func (j *jsiiProxy_SecurityhubProductSubscription) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubProductSubscription) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityhubProductSubscription) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/securityhub_product_subscription aws_securityhub_product_subscription} Resource.
func NewSecurityhubProductSubscription(scope constructs.Construct, id *string, config *SecurityhubProductSubscriptionConfig) SecurityhubProductSubscription {
	...
	if err := validateNewSecurityhubProductSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetId(val *string) {
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetProductArn(val *string) {
	if err := j.validateSetProductArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SecurityhubProductSubscription)SetProvisioners(val *[]interface{}) {
...
func SecurityhubProductSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubProductSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SecurityhubProductSubscription_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecurityhubProductSubscription_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityhubProductSubscription_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityhubProductSubscription_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityhubProductSubscription_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityhubProductSubscription_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SecurityhubProductSubscription) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityhubProductSubscription) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubProductSubscription) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityhubProductSubscription) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityhubProductSubscription) ToHclTerraform() interface{} {
	var returns interface{}
