...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_infrastructure_configuration aws_imagebuilder_infrastructure_configuration}.
type DataAwsImagebuilderInfrastructureConfiguration interface {
	...
	SetId(val *string)
	IdInput() *string
	InstanceMetadataOptions() DataAwsImagebuilderInfrastructureConfigurationInstanceMetadataOptionsList
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) InstanceMetadataOptions() DataAwsImagebuilderInfrastructureConfigurationInstanceMetadataOptionsList {
	var returns DataAwsImagebuilderInfrastructureConfigurationInstanceMetadataOptionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) Logging() DataAwsImagebuilderInfrastructureConfigurationLoggingList {
	var returns DataAwsImagebuilderInfrastructureConfigurationLoggingList
	_jsii_.Get(
		j,
		"logging",
		&returns,
...
func NewDataAwsImagebuilderInfrastructureConfiguration(scope constructs.Construct, id *string, config *DataAwsImagebuilderInfrastructureConfigurationConfig) DataAwsImagebuilderInfrastructureConfiguration {
	...
	if err := validateNewDataAwsImagebuilderInfrastructureConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration{}

	_jsii_.Create(
		"aws.dataAwsImagebuilderInfrastructureConfiguration.DataAwsImagebuilderInfrastructureConfiguration",
...
func (d *jsiiProxy_DataAwsImagebuilderInfrastructureConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
