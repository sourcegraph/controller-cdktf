...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.dataAwsEc2NetworkInsightsAnalysis.DataAwsEc2NetworkInsightsAnalysisExplanationsPrefixList",
		reflect.TypeOf((*DataAwsEc2NetworkInsightsAnalysisExplanationsPrefixList)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.dataAwsEc2NetworkInsightsAnalysis.DataAwsEc2NetworkInsightsAnalysisExplanationsPrefixListList",
