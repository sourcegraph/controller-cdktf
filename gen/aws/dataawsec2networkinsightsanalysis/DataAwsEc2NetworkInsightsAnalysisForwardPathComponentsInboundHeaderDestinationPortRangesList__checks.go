...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderDestinationPortRangesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
