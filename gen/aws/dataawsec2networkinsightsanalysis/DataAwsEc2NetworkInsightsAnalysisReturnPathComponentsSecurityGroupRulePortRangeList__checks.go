...
func (d *jsiiProxy_DataAwsEc2NetworkInsightsAnalysisReturnPathComponentsSecurityGroupRulePortRangeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
