...
func (j *jsiiProxy_SagemakerCodeRepository) Connection() interface{} {
...
func (j *jsiiProxy_SagemakerCodeRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerCodeRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SagemakerCodeRepository) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSagemakerCodeRepository(scope constructs.Construct, id *string, config *SagemakerCodeRepositoryConfig) SagemakerCodeRepository {
	...
	if err := validateNewSagemakerCodeRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerCodeRepository)SetCodeRepositoryName(val *string) {
	if err := j.validateSetCodeRepositoryNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerCodeRepository)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SagemakerCodeRepository)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerCodeRepository)SetId(val *string) {
...
func (j *jsiiProxy_SagemakerCodeRepository)SetProvisioners(val *[]interface{}) {
...
func SagemakerCodeRepository_IsConstruct(x interface{}) *bool {
	...
	if err := validateSagemakerCodeRepository_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SagemakerCodeRepository) PutGitConfig(value *SagemakerCodeRepositoryGitConfig) {
	if err := s.validatePutGitConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SagemakerCodeRepository) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
