...
func (j *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (s *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) ToString() *string {
	var returns *string
