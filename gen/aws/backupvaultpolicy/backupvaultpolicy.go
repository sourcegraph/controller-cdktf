...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/backupvaultpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/backup_vault_policy aws_backup_vault_policy}.
...
func (j *jsiiProxy_BackupVaultPolicy) Connection() interface{} {
...
func (j *jsiiProxy_BackupVaultPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupVaultPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BackupVaultPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/backup_vault_policy aws_backup_vault_policy} Resource.
func NewBackupVaultPolicy(scope constructs.Construct, id *string, config *BackupVaultPolicyConfig) BackupVaultPolicy {
	_init_.Initialize()

	if err := validateNewBackupVaultPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BackupVaultPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_BackupVaultPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupVaultPolicy)SetId(val *string) {
...
func (j *jsiiProxy_BackupVaultPolicy)SetProvisioners(val *[]interface{}) {
...
func BackupVaultPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBackupVaultPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BackupVaultPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateBackupVaultPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BackupVaultPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBackupVaultPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BackupVaultPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBackupVaultPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BackupVaultPolicy) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupVaultPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BackupVaultPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BackupVaultPolicy) MoveFromId(id *string) {
...
func (b *jsiiProxy_BackupVaultPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BackupVaultPolicy) MoveToId(id *string) {
...
func (b *jsiiProxy_BackupVaultPolicy) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BackupVaultPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BackupVaultPolicy) ToHclTerraform() interface{} {
	var returns interface{}
