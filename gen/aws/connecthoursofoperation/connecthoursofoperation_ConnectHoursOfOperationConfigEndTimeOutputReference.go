...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewConnectHoursOfOperationConfigEndTimeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConnectHoursOfOperationConfigEndTimeOutputReference {
	_init_.Initialize()

	if err := validateNewConnectHoursOfOperationConfigEndTimeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewConnectHoursOfOperationConfigEndTimeOutputReference_Override(c ConnectHoursOfOperationConfigEndTimeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ConnectHoursOfOperationConfigEndTimeOutputReference) ToString() *string {
	var returns *string
