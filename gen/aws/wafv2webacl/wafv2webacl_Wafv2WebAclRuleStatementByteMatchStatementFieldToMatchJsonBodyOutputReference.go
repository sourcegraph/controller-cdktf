...
type Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody
	SetInternalValue(val *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody)
	InvalidFallbackBehavior() *string
	SetInvalidFallbackBehavior(val *string)
	InvalidFallbackBehaviorInput() *string
	MatchPattern() Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternOutputReference
	MatchPatternInput() *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern
	MatchScope() *string
	...
	PutMatchPattern(value *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern)
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) InternalValue() *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody {
	var returns *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) MatchPattern() Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternOutputReference {
	var returns Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternOutputReference
	_jsii_.Get(
		j,
		"matchPattern",
		&returns,
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) MatchPatternInput() *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference {
	_init_.Initialize()

	if err := validateNewWafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference_Override(w Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference)SetInternalValue(val *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody) {
...
func (j *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) PutMatchPattern(value *Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern) {
...
func (w *jsiiProxy_Wafv2WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
