...
type Wafv2WebAclRuleStatementNotStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementNotStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
