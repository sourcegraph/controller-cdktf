...
type Wafv2WebAclRuleStatementAndStatementStatementSqliMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementAndStatementStatementSqliMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
