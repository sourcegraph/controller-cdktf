...
type Wafv2WebAclRuleStatementAndStatementStatementByteMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
