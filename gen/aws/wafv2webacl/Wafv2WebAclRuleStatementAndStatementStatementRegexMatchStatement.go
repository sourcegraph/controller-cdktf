...
type Wafv2WebAclRuleStatementAndStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
