...
type Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
