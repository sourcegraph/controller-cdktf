...
type Wafv2WebAclRuleStatementRegexPatternSetReferenceStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
