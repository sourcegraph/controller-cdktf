...
type Wafv2WebAclRule struct {
	...
	// action block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafv2_web_acl#action Wafv2WebAcl#action}
	Action *Wafv2WebAclRuleAction `field:"optional" json:"action" yaml:"action"`
	// override_action block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafv2_web_acl#override_action Wafv2WebAcl#override_action}
