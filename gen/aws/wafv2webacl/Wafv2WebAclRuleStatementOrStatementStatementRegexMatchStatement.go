...
type Wafv2WebAclRuleStatementOrStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
