...
type Wafv2WebAclRuleStatementNotStatementStatementByteMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementNotStatementStatementByteMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
