...
type Wafv2WebAclRuleStatementSqliMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementSqliMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
