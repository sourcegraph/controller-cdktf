...
type Wafv2WebAclRuleStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
