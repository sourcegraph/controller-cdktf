...
type Wafv2WebAclRuleStatementOrStatementStatementXssMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
