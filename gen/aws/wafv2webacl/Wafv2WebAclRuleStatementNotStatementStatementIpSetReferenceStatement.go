...
type Wafv2WebAclRuleStatementNotStatementStatementIpSetReferenceStatement struct {
	...
	IpSetForwardedIpConfig *Wafv2WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig `field:"optional" json:"ipSetForwardedIpConfig" yaml:"ipSetForwardedIpConfig"`
}
