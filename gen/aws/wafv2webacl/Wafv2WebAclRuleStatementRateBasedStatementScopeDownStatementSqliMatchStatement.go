...
type Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatement struct {
	...
	FieldToMatch *Wafv2WebAclRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
