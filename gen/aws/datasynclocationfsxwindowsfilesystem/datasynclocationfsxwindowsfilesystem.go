...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/datasynclocationfsxwindowsfilesystem/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datasync_location_fsx_windows_file_system aws_datasync_location_fsx_windows_file_system}.
...
func (j *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDatasyncLocationFsxWindowsFileSystem(scope constructs.Construct, id *string, config *DatasyncLocationFsxWindowsFileSystemConfig) DatasyncLocationFsxWindowsFileSystem {
	...
	if err := validateNewDatasyncLocationFsxWindowsFileSystemParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatasyncLocationFsxWindowsFileSystem) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
