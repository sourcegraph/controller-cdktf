...
func NewElasticsearchDomainLogPublishingOptionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticsearchDomainLogPublishingOptionsList {
	...
	if err := validateNewElasticsearchDomainLogPublishingOptionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticsearchDomainLogPublishingOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
