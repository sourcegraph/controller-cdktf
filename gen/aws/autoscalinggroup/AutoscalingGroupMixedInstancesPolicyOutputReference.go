...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewAutoscalingGroupMixedInstancesPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AutoscalingGroupMixedInstancesPolicyOutputReference {
	_init_.Initialize()

	if err := validateNewAutoscalingGroupMixedInstancesPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutoscalingGroupMixedInstancesPolicyOutputReference_Override(a AutoscalingGroupMixedInstancesPolicyOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (a *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AutoscalingGroupMixedInstancesPolicyOutputReference) ToString() *string {
	var returns *string
