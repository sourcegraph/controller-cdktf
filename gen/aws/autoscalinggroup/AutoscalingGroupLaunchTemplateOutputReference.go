...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAutoscalingGroupLaunchTemplateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AutoscalingGroupLaunchTemplateOutputReference {
	_init_.Initialize()

	if err := validateNewAutoscalingGroupLaunchTemplateOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutoscalingGroupLaunchTemplateOutputReference_Override(a AutoscalingGroupLaunchTemplateOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference)SetId(val *string) {
...
func (a *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AutoscalingGroupLaunchTemplateOutputReference) ToString() *string {
	var returns *string
