...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewAutoscalingGroupInstanceRefreshOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AutoscalingGroupInstanceRefreshOutputReference {
	_init_.Initialize()

	if err := validateNewAutoscalingGroupInstanceRefreshOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutoscalingGroupInstanceRefreshOutputReference_Override(a AutoscalingGroupInstanceRefreshOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (a *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) PutPreferences(value *AutoscalingGroupInstanceRefreshPreferences) {
	if err := a.validatePutPreferencesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AutoscalingGroupInstanceRefreshOutputReference) ToString() *string {
	var returns *string
