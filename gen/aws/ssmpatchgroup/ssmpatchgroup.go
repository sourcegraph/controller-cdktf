...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmpatchgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssm_patch_group aws_ssm_patch_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssm_patch_group aws_ssm_patch_group} Resource.
func NewSsmPatchGroup(scope constructs.Construct, id *string, config *SsmPatchGroupConfig) SsmPatchGroup {
	_init_.Initialize()

	if err := validateNewSsmPatchGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SsmPatchGroup)SetPatchGroup(val *string) {
	if err := j.validateSetPatchGroupParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SsmPatchGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsmPatchGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SsmPatchGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateSsmPatchGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SsmPatchGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSsmPatchGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SsmPatchGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSsmPatchGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SsmPatchGroup) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsmPatchGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SsmPatchGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsmPatchGroup) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsmPatchGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SsmPatchGroup) MoveToId(id *string) {
...
func (s *jsiiProxy_SsmPatchGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SsmPatchGroup) ToHclTerraform() interface{} {
	var returns interface{}
