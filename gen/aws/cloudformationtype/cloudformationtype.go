...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudformationtype/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudformation_type aws_cloudformation_type}.
...
func NewCloudformationType(scope constructs.Construct, id *string, config *CloudformationTypeConfig) CloudformationType {
	...
	if err := validateNewCloudformationTypeParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudformationType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudformationType_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudformationType) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudformationType) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudformationType) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudformationType) MoveToId(id *string) {
