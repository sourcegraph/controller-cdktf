...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesreceiptruleset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_receipt_rule_set aws_ses_receipt_rule_set}.
...
func (j *jsiiProxy_SesReceiptRuleSet) Connection() interface{} {
...
func (j *jsiiProxy_SesReceiptRuleSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesReceiptRuleSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesReceiptRuleSet) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_receipt_rule_set aws_ses_receipt_rule_set} Resource.
func NewSesReceiptRuleSet(scope constructs.Construct, id *string, config *SesReceiptRuleSetConfig) SesReceiptRuleSet {
	_init_.Initialize()

	if err := validateNewSesReceiptRuleSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesReceiptRuleSet)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SesReceiptRuleSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesReceiptRuleSet)SetId(val *string) {
...
func (j *jsiiProxy_SesReceiptRuleSet)SetProvisioners(val *[]interface{}) {
...
func SesReceiptRuleSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesReceiptRuleSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SesReceiptRuleSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateSesReceiptRuleSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SesReceiptRuleSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSesReceiptRuleSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SesReceiptRuleSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSesReceiptRuleSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SesReceiptRuleSet) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesReceiptRuleSet) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SesReceiptRuleSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesReceiptRuleSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesReceiptRuleSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesReceiptRuleSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesReceiptRuleSet) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SesReceiptRuleSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SesReceiptRuleSet) ToHclTerraform() interface{} {
	var returns interface{}
