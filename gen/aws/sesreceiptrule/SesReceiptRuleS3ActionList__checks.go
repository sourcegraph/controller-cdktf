...
func (s *jsiiProxy_SesReceiptRuleS3ActionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_SesReceiptRuleS3ActionList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*SesReceiptRuleS3Action:
		val := val.(*[]*SesReceiptRuleS3Action)
	...
	case []*SesReceiptRuleS3Action:
		val_ := val.([]*SesReceiptRuleS3Action)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*SesReceiptRuleS3Action; received %#v (a %T)", val, val)
		}
	}
