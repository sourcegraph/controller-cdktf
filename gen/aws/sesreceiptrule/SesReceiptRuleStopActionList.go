...
func (j *jsiiProxy_SesReceiptRuleStopActionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSesReceiptRuleStopActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SesReceiptRuleStopActionList {
	_init_.Initialize()
...
func NewSesReceiptRuleStopActionList_Override(s SesReceiptRuleStopActionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SesReceiptRuleStopActionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SesReceiptRuleStopActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SesReceiptRuleStopActionList) Resolve(_context cdktf.IResolveContext) interface{} {
