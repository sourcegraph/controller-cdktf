...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_gateway aws_dx_gateway}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_gateway aws_dx_gateway} Resource.
func NewDxGateway(scope constructs.Construct, id *string, config *DxGatewayConfig) DxGateway {
	_init_.Initialize()

	if err := validateNewDxGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DxGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDxGateway_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DxGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateDxGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DxGateway) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxGateway) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DxGateway) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DxGateway) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxGateway) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DxGateway) MoveToId(id *string) {
...
func (d *jsiiProxy_DxGateway) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DxGateway) ToHclTerraform() interface{} {
	var returns interface{}
