...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/rds_cluster_parameter_group aws_rds_cluster_parameter_group}.
...
func (j *jsiiProxy_RdsClusterParameterGroup) Connection() interface{} {
...
func (j *jsiiProxy_RdsClusterParameterGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RdsClusterParameterGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RdsClusterParameterGroup) Parameter() RdsClusterParameterGroupParameterList {
	var returns RdsClusterParameterGroupParameterList
	_jsii_.Get(
		j,
		"parameter",
		&returns,
...
func (j *jsiiProxy_RdsClusterParameterGroup) ParameterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parameterInput",
...
func (j *jsiiProxy_RdsClusterParameterGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_RdsClusterParameterGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_RdsClusterParameterGroup) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_RdsClusterParameterGroup) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_RdsClusterParameterGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/rds_cluster_parameter_group aws_rds_cluster_parameter_group} Resource.
func NewRdsClusterParameterGroup(scope constructs.Construct, id *string, config *RdsClusterParameterGroupConfig) RdsClusterParameterGroup {
	...
	if err := validateNewRdsClusterParameterGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetId(val *string) {
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_RdsClusterParameterGroup)SetTagsAll(val *map[string]*string) {
...
func RdsClusterParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRdsClusterParameterGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RdsClusterParameterGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateRdsClusterParameterGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RdsClusterParameterGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRdsClusterParameterGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RdsClusterParameterGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRdsClusterParameterGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RdsClusterParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (r *jsiiProxy_RdsClusterParameterGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RdsClusterParameterGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RdsClusterParameterGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RdsClusterParameterGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RdsClusterParameterGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RdsClusterParameterGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) MoveFromId(id *string) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) MoveToId(id *string) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) PutParameter(value interface{}) {
...
func (r *jsiiProxy_RdsClusterParameterGroup) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RdsClusterParameterGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RdsClusterParameterGroup) ToHclTerraform() interface{} {
	var returns interface{}
