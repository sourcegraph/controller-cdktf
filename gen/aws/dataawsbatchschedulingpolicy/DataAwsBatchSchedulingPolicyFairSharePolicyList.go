...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsbatchschedulingpolicy/internal"
)
...
func NewDataAwsBatchSchedulingPolicyFairSharePolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsBatchSchedulingPolicyFairSharePolicyList {
	...
	if err := validateNewDataAwsBatchSchedulingPolicyFairSharePolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsBatchSchedulingPolicyFairSharePolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
