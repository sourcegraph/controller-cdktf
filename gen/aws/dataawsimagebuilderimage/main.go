...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "buildVersionArn", GoGetter: "BuildVersionArn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "outputResources", GoGetter: "OutputResources"},
