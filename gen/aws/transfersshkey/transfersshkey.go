...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/transfersshkey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/transfer_ssh_key aws_transfer_ssh_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/transfer_ssh_key aws_transfer_ssh_key} Resource.
func NewTransferSshKey(scope constructs.Construct, id *string, config *TransferSshKeyConfig) TransferSshKey {
	_init_.Initialize()

	if err := validateNewTransferSshKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func TransferSshKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTransferSshKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func TransferSshKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateTransferSshKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TransferSshKey_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTransferSshKey_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TransferSshKey_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTransferSshKey_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TransferSshKey) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TransferSshKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TransferSshKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TransferSshKey) MoveFromId(id *string) {
...
func (t *jsiiProxy_TransferSshKey) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TransferSshKey) MoveToId(id *string) {
...
func (t *jsiiProxy_TransferSshKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TransferSshKey) ToHclTerraform() interface{} {
	var returns interface{}
