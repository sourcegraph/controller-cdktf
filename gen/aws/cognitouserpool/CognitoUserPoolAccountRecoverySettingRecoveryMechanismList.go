...
func NewCognitoUserPoolAccountRecoverySettingRecoveryMechanismList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoUserPoolAccountRecoverySettingRecoveryMechanismList {
	...
	if err := validateNewCognitoUserPoolAccountRecoverySettingRecoveryMechanismListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoUserPoolAccountRecoverySettingRecoveryMechanismList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
