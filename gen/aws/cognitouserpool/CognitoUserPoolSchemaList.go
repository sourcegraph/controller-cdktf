...
func NewCognitoUserPoolSchemaList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoUserPoolSchemaList {
	...
	if err := validateNewCognitoUserPoolSchemaListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoUserPoolSchemaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
