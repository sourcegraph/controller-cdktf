...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/docdbsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/docdb_subnet_group aws_docdb_subnet_group}.
...
func (j *jsiiProxy_DocdbSubnetGroup) Connection() interface{} {
...
func (j *jsiiProxy_DocdbSubnetGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DocdbSubnetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DocdbSubnetGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/docdb_subnet_group aws_docdb_subnet_group} Resource.
func NewDocdbSubnetGroup(scope constructs.Construct, id *string, config *DocdbSubnetGroupConfig) DocdbSubnetGroup {
	_init_.Initialize()

	if err := validateNewDocdbSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DocdbSubnetGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DocdbSubnetGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DocdbSubnetGroup)SetId(val *string) {
...
func (j *jsiiProxy_DocdbSubnetGroup)SetProvisioners(val *[]interface{}) {
...
func DocdbSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDocdbSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DocdbSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDocdbSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DocdbSubnetGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDocdbSubnetGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DocdbSubnetGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDocdbSubnetGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DocdbSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DocdbSubnetGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DocdbSubnetGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DocdbSubnetGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DocdbSubnetGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DocdbSubnetGroup) MoveToId(id *string) {
...
func (d *jsiiProxy_DocdbSubnetGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DocdbSubnetGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DocdbSubnetGroup) ToHclTerraform() interface{} {
	var returns interface{}
