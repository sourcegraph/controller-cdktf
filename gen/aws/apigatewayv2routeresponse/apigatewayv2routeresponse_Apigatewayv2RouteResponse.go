...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayv2routeresponse/internal"
)
...
func NewApigatewayv2RouteResponse(scope constructs.Construct, id *string, config *Apigatewayv2RouteResponseConfig) Apigatewayv2RouteResponse {
	...
	if err := validateNewApigatewayv2RouteResponseParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Apigatewayv2RouteResponse{}

	_jsii_.Create(
		"aws.apigatewayv2RouteResponse.Apigatewayv2RouteResponse",
...
func (j *jsiiProxy_Apigatewayv2RouteResponse)SetRouteResponseKey(val *string) {
	if err := j.validateSetRouteResponseKeyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func Apigatewayv2RouteResponse_IsConstruct(x interface{}) *bool {
	...
	if err := validateApigatewayv2RouteResponse_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
