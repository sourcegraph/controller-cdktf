...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53resolverruleassociation/internal"
)
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRoute53ResolverRuleAssociationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53ResolverRuleAssociationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRoute53ResolverRuleAssociationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRoute53ResolverRuleAssociationTimeoutsOutputReference_Override(r Route53ResolverRuleAssociationTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_Route53ResolverRuleAssociationTimeoutsOutputReference) ToString() *string {
	var returns *string
