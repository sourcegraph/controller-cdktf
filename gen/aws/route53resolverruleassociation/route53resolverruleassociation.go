...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_resolver_rule_association aws_route53_resolver_rule_association}.
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverRuleAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53ResolverRuleAssociation(scope constructs.Construct, id *string, config *Route53ResolverRuleAssociationConfig) Route53ResolverRuleAssociation {
	...
	if err := validateNewRoute53ResolverRuleAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53ResolverRuleAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverRuleAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverRuleAssociation) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
