...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3controlbucketpolicy/internal"
)
...
func (j *jsiiProxy_S3ControlBucketPolicy) Connection() interface{} {
...
func (j *jsiiProxy_S3ControlBucketPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlBucketPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlBucketPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewS3ControlBucketPolicy(scope constructs.Construct, id *string, config *S3ControlBucketPolicyConfig) S3ControlBucketPolicy {
	...
	if err := validateNewS3ControlBucketPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3ControlBucketPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3ControlBucketPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlBucketPolicy)SetId(val *string) {
...
func (j *jsiiProxy_S3ControlBucketPolicy)SetProvisioners(val *[]interface{}) {
...
func S3ControlBucketPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3ControlBucketPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlBucketPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
