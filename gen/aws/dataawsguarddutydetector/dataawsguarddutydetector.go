...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsguarddutydetector/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/guardduty_detector aws_guardduty_detector}.
...
func NewDataAwsGuarddutyDetector(scope constructs.Construct, id *string, config *DataAwsGuarddutyDetectorConfig) DataAwsGuarddutyDetector {
	...
	if err := validateNewDataAwsGuarddutyDetectorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsGuarddutyDetector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsGuarddutyDetector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
