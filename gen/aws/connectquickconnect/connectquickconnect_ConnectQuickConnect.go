...
func (j *jsiiProxy_ConnectQuickConnect) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectQuickConnect) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewConnectQuickConnect(scope constructs.Construct, id *string, config *ConnectQuickConnectConfig) ConnectQuickConnect {
	...
	if err := validateNewConnectQuickConnectParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectQuickConnect) PutQuickConnectConfig(value *ConnectQuickConnectQuickConnectConfig) {
	if err := c.validatePutQuickConnectConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConnectQuickConnect) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
