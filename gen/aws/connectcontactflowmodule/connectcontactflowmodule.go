...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/connectcontactflowmodule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_contact_flow_module aws_connect_contact_flow_module}.
...
func (j *jsiiProxy_ConnectContactFlowModule) Connection() interface{} {
...
func (j *jsiiProxy_ConnectContactFlowModule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectContactFlowModule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ConnectContactFlowModule) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_contact_flow_module aws_connect_contact_flow_module} Resource.
func NewConnectContactFlowModule(scope constructs.Construct, id *string, config *ConnectContactFlowModuleConfig) ConnectContactFlowModule {
	...
	if err := validateNewConnectContactFlowModuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ConnectContactFlowModule)SetConnection(val interface{}) {
...
func (j *jsiiProxy_ConnectContactFlowModule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConnectContactFlowModule)SetId(val *string) {
...
func (j *jsiiProxy_ConnectContactFlowModule)SetProvisioners(val *[]interface{}) {
...
func ConnectContactFlowModule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConnectContactFlowModule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConnectContactFlowModule_IsConstruct(x interface{}) *bool {
	...
	if err := validateConnectContactFlowModule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ConnectContactFlowModule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectContactFlowModule) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ConnectContactFlowModule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConnectContactFlowModule) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConnectContactFlowModule) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ConnectContactFlowModule) MoveToId(id *string) {
...
func (c *jsiiProxy_ConnectContactFlowModule) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ConnectContactFlowModule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ConnectContactFlowModule) ToHclTerraform() interface{} {
	var returns interface{}
