...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftsnapshotscheduleassociation/internal"
)
...
func NewRedshiftSnapshotScheduleAssociation(scope constructs.Construct, id *string, config *RedshiftSnapshotScheduleAssociationConfig) RedshiftSnapshotScheduleAssociation {
	...
	if err := validateNewRedshiftSnapshotScheduleAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
