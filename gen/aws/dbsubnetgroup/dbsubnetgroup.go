...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_subnet_group aws_db_subnet_group}.
...
func (j *jsiiProxy_DbSubnetGroup) Connection() interface{} {
...
func (j *jsiiProxy_DbSubnetGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbSubnetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbSubnetGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_DbSubnetGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_DbSubnetGroup) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DbSubnetGroup) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DbSubnetGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_subnet_group aws_db_subnet_group} Resource.
func NewDbSubnetGroup(scope constructs.Construct, id *string, config *DbSubnetGroupConfig) DbSubnetGroup {
	_init_.Initialize()

	if err := validateNewDbSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DbSubnetGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DbSubnetGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbSubnetGroup)SetId(val *string) {
...
func (j *jsiiProxy_DbSubnetGroup)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_DbSubnetGroup)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_DbSubnetGroup)SetTagsAll(val *map[string]*string) {
...
func DbSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DbSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDbSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbSubnetGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbSubnetGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbSubnetGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbSubnetGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DbSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbSubnetGroup) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DbSubnetGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbSubnetGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbSubnetGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbSubnetGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbSubnetGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DbSubnetGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbSubnetGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbSubnetGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DbSubnetGroup) MoveToId(id *string) {
...
func (d *jsiiProxy_DbSubnetGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DbSubnetGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DbSubnetGroup) ToHclTerraform() interface{} {
	var returns interface{}
