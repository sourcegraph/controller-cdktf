...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRoute53RecoveryreadinessResourceSetTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53RecoveryreadinessResourceSetTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRoute53RecoveryreadinessResourceSetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference{}

	_jsii_.Create(
		"aws.route53RecoveryreadinessResourceSet.Route53RecoveryreadinessResourceSetTimeoutsOutputReference",
...
func NewRoute53RecoveryreadinessResourceSetTimeoutsOutputReference_Override(r Route53RecoveryreadinessResourceSetTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessResourceSetTimeoutsOutputReference) ToString() *string {
	var returns *string
