...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamaccesskey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_access_key aws_iam_access_key}.
...
func (j *jsiiProxy_IamAccessKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamAccessKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamAccessKey(scope constructs.Construct, id *string, config *IamAccessKeyConfig) IamAccessKey {
	...
	if err := validateNewIamAccessKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamAccessKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamAccessKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamAccessKey) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamAccessKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamAccessKey) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamAccessKey) MoveToId(id *string) {
...
func (i *jsiiProxy_IamAccessKey) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
