...
func NewDlmLifecyclePolicyPolicyDetailsScheduleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DlmLifecyclePolicyPolicyDetailsScheduleList {
	...
	if err := validateNewDlmLifecyclePolicyPolicyDetailsScheduleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
