...
func (j *jsiiProxy_ServicecatalogPortfolio) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogPortfolio) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewServicecatalogPortfolio(scope constructs.Construct, id *string, config *ServicecatalogPortfolioConfig) ServicecatalogPortfolio {
	...
	if err := validateNewServicecatalogPortfolioParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogPortfolio) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
