...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicecatalogportfolio/internal"
)
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) Read() *string {
	var returns *string
	_jsii_.Get(
		j,
		"read",
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ReadInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readInput",
...
func NewServicecatalogPortfolioTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ServicecatalogPortfolioTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewServicecatalogPortfolioTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewServicecatalogPortfolioTimeoutsOutputReference_Override(s ServicecatalogPortfolioTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference)SetRead(val *string) {
...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ResetRead() {
	_jsii_.InvokeVoid(
		s,
		"resetRead",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_ServicecatalogPortfolioTimeoutsOutputReference) ToString() *string {
	var returns *string
