...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sagemakernotebookinstancelifecycleconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sagemaker_notebook_instance_lifecycle_configuration aws_sagemaker_notebook_instance_lifecycle_configuration}.
...
func (j *jsiiProxy_SagemakerNotebookInstanceLifecycleConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerNotebookInstanceLifecycleConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerNotebookInstanceLifecycleConfiguration(scope constructs.Construct, id *string, config *SagemakerNotebookInstanceLifecycleConfigurationConfig) SagemakerNotebookInstanceLifecycleConfiguration {
	...
	if err := validateNewSagemakerNotebookInstanceLifecycleConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SagemakerNotebookInstanceLifecycleConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerNotebookInstanceLifecycleConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerNotebookInstanceLifecycleConfiguration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerNotebookInstanceLifecycleConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
