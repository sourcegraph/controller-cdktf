...
func NewNeptuneParameterGroupParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NeptuneParameterGroupParameterList {
	...
	if err := validateNewNeptuneParameterGroupParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NeptuneParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
