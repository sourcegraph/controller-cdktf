...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_ipam_scope aws_vpc_ipam_scope}.
type VpcIpamScope interface {
	...
	PutTimeouts(value *VpcIpamScopeTimeouts)
	ResetDescription()
	ResetId()
...
func (j *jsiiProxy_VpcIpamScope) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpamScope) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcIpamScope) IsDefault() cdktf.IResolvable {
...
func (j *jsiiProxy_VpcIpamScope) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpcIpamScope) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpcIpamScope) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpcIpamScope) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_VpcIpamScope) Timeouts() VpcIpamScopeTimeoutsOutputReference {
	var returns VpcIpamScopeTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewVpcIpamScope(scope constructs.Construct, id *string, config *VpcIpamScopeConfig) VpcIpamScope {
	...
	if err := validateNewVpcIpamScopeParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VpcIpamScope_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcIpamScope_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpcIpamScope) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcIpamScope) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcIpamScope) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcIpamScope) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcIpamScope) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcIpamScope) PutTimeouts(value *VpcIpamScopeTimeouts) {
...
func (v *jsiiProxy_VpcIpamScope) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamScope) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
