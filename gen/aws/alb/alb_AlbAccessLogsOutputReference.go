...
func (j *jsiiProxy_AlbAccessLogsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AlbAccessLogsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AlbAccessLogsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AlbAccessLogsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewAlbAccessLogsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AlbAccessLogsOutputReference {
	...
	if err := validateNewAlbAccessLogsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAlbAccessLogsOutputReference_Override(a AlbAccessLogsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AlbAccessLogsOutputReference) ToString() *string {
	var returns *string
