...
func (j *jsiiProxy_DataAwsElasticacheClusterCacheNodesOutputReference) OutpostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outpostArn",
...
func NewDataAwsElasticacheClusterCacheNodesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsElasticacheClusterCacheNodesOutputReference {
	...
	if err := validateNewDataAwsElasticacheClusterCacheNodesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
