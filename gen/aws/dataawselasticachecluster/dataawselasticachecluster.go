...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselasticachecluster/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elasticache_cluster aws_elasticache_cluster}.
...
func NewDataAwsElasticacheCluster(scope constructs.Construct, id *string, config *DataAwsElasticacheClusterConfig) DataAwsElasticacheCluster {
	...
	if err := validateNewDataAwsElasticacheClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsElasticacheCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataAwsElasticacheCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
