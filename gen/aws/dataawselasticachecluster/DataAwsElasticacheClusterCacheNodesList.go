...
func NewDataAwsElasticacheClusterCacheNodesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticacheClusterCacheNodesList {
	...
	if err := validateNewDataAwsElasticacheClusterCacheNodesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsElasticacheClusterCacheNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
