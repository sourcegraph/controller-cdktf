...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/servicecatalog_product aws_servicecatalog_product}.
type DataAwsServicecatalogProduct interface {
	...
	PutTimeouts(value *DataAwsServicecatalogProductTimeouts)
	ResetAcceptLanguage()
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogProduct) Timeouts() DataAwsServicecatalogProductTimeoutsOutputReference {
	var returns DataAwsServicecatalogProductTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsServicecatalogProduct(scope constructs.Construct, id *string, config *DataAwsServicecatalogProductConfig) DataAwsServicecatalogProduct {
	...
	if err := validateNewDataAwsServicecatalogProductParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServicecatalogProduct_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServicecatalogProduct_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) PutTimeouts(value *DataAwsServicecatalogProductTimeouts) {
...
func (d *jsiiProxy_DataAwsServicecatalogProduct) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
