...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/amplifybackendenvironment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/amplify_backend_environment aws_amplify_backend_environment}.
...
func NewAmplifyBackendEnvironment(scope constructs.Construct, id *string, config *AmplifyBackendEnvironmentConfig) AmplifyBackendEnvironment {
	...
	if err := validateNewAmplifyBackendEnvironmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AmplifyBackendEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAmplifyBackendEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AmplifyBackendEnvironment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) MoveFromId(id *string) {
...
func (a *jsiiProxy_AmplifyBackendEnvironment) MoveToId(id *string) {
