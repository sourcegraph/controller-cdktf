...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudsearch_domain aws_cloudsearch_domain}.
...
func (j *jsiiProxy_CloudsearchDomain) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudsearchDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudsearchDomain) IndexField() CloudsearchDomainIndexFieldList {
	var returns CloudsearchDomainIndexFieldList
	_jsii_.Get(
		j,
		"indexField",
		&returns,
...
func NewCloudsearchDomain(scope constructs.Construct, id *string, config *CloudsearchDomainConfig) CloudsearchDomain {
	...
	if err := validateNewCloudsearchDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudsearchDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateCloudsearchDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudsearchDomain) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudsearchDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudsearchDomain) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudsearchDomain) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudsearchDomain) PutEndpointOptions(value *CloudsearchDomainEndpointOptions) {
	if err := c.validatePutEndpointOptionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudsearchDomain) PutScalingParameters(value *CloudsearchDomainScalingParameters) {
	if err := c.validatePutScalingParametersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudsearchDomain) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
