...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elastic_beanstalk_application aws_elastic_beanstalk_application}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elastic_beanstalk_application aws_elastic_beanstalk_application} Data Source.
func NewDataAwsElasticBeanstalkApplication(scope constructs.Construct, id *string, config *DataAwsElasticBeanstalkApplicationConfig) DataAwsElasticBeanstalkApplication {
	...
	if err := validateNewDataAwsElasticBeanstalkApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsElasticBeanstalkApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsElasticBeanstalkApplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsElasticBeanstalkApplication_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsElasticBeanstalkApplication_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsElasticBeanstalkApplication_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsElasticBeanstalkApplication_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsElasticBeanstalkApplication_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsElasticBeanstalkApplication_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsElasticBeanstalkApplication) ToHclTerraform() interface{} {
	var returns interface{}
