...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbeventsubscription/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_event_subscription aws_db_event_subscription}.
...
func (j *jsiiProxy_DbEventSubscription) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbEventSubscription) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbEventSubscription) Tags() *map[string]*string {
...
func (j *jsiiProxy_DbEventSubscription) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DbEventSubscription) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DbEventSubscription) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewDbEventSubscription(scope constructs.Construct, id *string, config *DbEventSubscriptionConfig) DbEventSubscription {
	...
	if err := validateNewDbEventSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbEventSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbEventSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbEventSubscription) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbEventSubscription) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbEventSubscription) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbEventSubscription) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbEventSubscription) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbEventSubscription) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbEventSubscription) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbEventSubscription) MoveToId(id *string) {
...
func (d *jsiiProxy_DbEventSubscription) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
