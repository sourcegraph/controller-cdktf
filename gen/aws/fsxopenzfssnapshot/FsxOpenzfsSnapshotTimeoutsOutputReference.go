...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/fsxopenzfssnapshot/internal"
)
...
func NewFsxOpenzfsSnapshotTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FsxOpenzfsSnapshotTimeoutsOutputReference {
	...
	if err := validateNewFsxOpenzfsSnapshotTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
