...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerWorkteamNotificationConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerWorkteamNotificationConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewSagemakerWorkteamNotificationConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSagemakerWorkteamNotificationConfigurationOutputReference_Override(s SagemakerWorkteamNotificationConfigurationOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerWorkteamNotificationConfigurationOutputReference) ToString() *string {
	var returns *string
