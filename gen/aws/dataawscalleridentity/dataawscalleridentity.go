...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscalleridentity/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/caller_identity aws_caller_identity}.
...
func NewDataAwsCallerIdentity(scope constructs.Construct, id *string, config *DataAwsCallerIdentityConfig) DataAwsCallerIdentity {
	...
	if err := validateNewDataAwsCallerIdentityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCallerIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCallerIdentity_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
