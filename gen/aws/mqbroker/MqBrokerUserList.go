...
func NewMqBrokerUserList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MqBrokerUserList {
	...
	if err := validateNewMqBrokerUserListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MqBrokerUserList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
