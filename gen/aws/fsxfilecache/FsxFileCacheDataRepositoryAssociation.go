...
type FsxFileCacheDataRepositoryAssociation struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/fsx_file_cache#file_cache_path FsxFileCache#file_cache_path}.
	FileCachePath *string `field:"required" json:"fileCachePath" yaml:"fileCachePath"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/fsx_file_cache#data_repository_subdirectories FsxFileCache#data_repository_subdirectories}.
