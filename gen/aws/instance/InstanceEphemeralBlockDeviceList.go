...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList) InternalValue() interface{} {
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_InstanceEphemeralBlockDeviceList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_InstanceEphemeralBlockDeviceList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_InstanceEphemeralBlockDeviceList) Get(index *float64) InstanceEphemeralBlockDeviceOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns InstanceEphemeralBlockDeviceOutputReference
...
func (i *jsiiProxy_InstanceEphemeralBlockDeviceList) ToString() *string {
	var returns *string
