...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/instance aws_instance}.
...
func Instance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_Instance) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_Instance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_Instance) MoveFromId(id *string) {
...
func (i *jsiiProxy_Instance) MoveToId(id *string) {
