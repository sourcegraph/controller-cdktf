...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/datapipelinepipeline/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datapipeline_pipeline aws_datapipeline_pipeline}.
...
func (j *jsiiProxy_DatapipelinePipeline) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datapipeline_pipeline aws_datapipeline_pipeline} Resource.
...
func (d *jsiiProxy_DatapipelinePipeline) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
