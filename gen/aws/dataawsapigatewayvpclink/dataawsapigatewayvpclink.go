...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewayvpclink/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/api_gateway_vpc_link aws_api_gateway_vpc_link}.
...
func NewDataAwsApiGatewayVpcLink(scope constructs.Construct, id *string, config *DataAwsApiGatewayVpcLinkConfig) DataAwsApiGatewayVpcLink {
	...
	if err := validateNewDataAwsApiGatewayVpcLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsApiGatewayVpcLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApiGatewayVpcLink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
