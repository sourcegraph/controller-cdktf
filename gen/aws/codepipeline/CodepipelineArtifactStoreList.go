...
func NewCodepipelineArtifactStoreList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodepipelineArtifactStoreList {
	...
	if err := validateNewCodepipelineArtifactStoreListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodepipelineArtifactStoreList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
