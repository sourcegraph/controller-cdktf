...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codepipeline aws_codepipeline}.
...
func NewCodepipeline(scope constructs.Construct, id *string, config *CodepipelineConfig) Codepipeline {
	...
	if err := validateNewCodepipelineParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Codepipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateCodepipeline_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_Codepipeline) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_Codepipeline) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_Codepipeline) MoveFromId(id *string) {
...
func (c *jsiiProxy_Codepipeline) MoveToId(id *string) {
