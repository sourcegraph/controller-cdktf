...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sagemakerstudiolifecycleconfig/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sagemaker_studio_lifecycle_config aws_sagemaker_studio_lifecycle_config}.
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerStudioLifecycleConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerStudioLifecycleConfig(scope constructs.Construct, id *string, config *SagemakerStudioLifecycleConfigConfig) SagemakerStudioLifecycleConfig {
	...
	if err := validateNewSagemakerStudioLifecycleConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SagemakerStudioLifecycleConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerStudioLifecycleConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerStudioLifecycleConfig) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
