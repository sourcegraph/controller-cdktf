...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesv2emailidentitymailfromattributes/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sesv2_email_identity_mail_from_attributes aws_sesv2_email_identity_mail_from_attributes}.
...
type jsiiProxy_Sesv2EmailIdentityMailFromAttributes struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) BehaviorOnMxFailure() *string {
	var returns *string
	_jsii_.Get(
		j,
		"behaviorOnMxFailure",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) BehaviorOnMxFailureInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) EmailIdentity() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailIdentity",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) EmailIdentityInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailIdentityInput",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) MailFromDomain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mailFromDomain",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) MailFromDomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mailFromDomainInput",
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) Node() constructs.Node {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewSesv2EmailIdentityMailFromAttributes(scope constructs.Construct, id *string, config *Sesv2EmailIdentityMailFromAttributesConfig) Sesv2EmailIdentityMailFromAttributes {
	...
	if err := validateNewSesv2EmailIdentityMailFromAttributesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Sesv2EmailIdentityMailFromAttributes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesv2EmailIdentityMailFromAttributes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Sesv2EmailIdentityMailFromAttributes_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.sesv2EmailIdentityMailFromAttributes.Sesv2EmailIdentityMailFromAttributes",
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) MoveFromId(id *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) MoveToId(id *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ResetBehaviorOnMxFailure() {
	_jsii_.InvokeVoid(
		s,
		"resetBehaviorOnMxFailure",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ResetMailFromDomain() {
	_jsii_.InvokeVoid(
		s,
		"resetMailFromDomain",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityMailFromAttributes) ToString() *string {
	var returns *string
