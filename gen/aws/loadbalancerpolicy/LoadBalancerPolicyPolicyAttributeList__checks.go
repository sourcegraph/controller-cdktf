...
func (l *jsiiProxy_LoadBalancerPolicyPolicyAttributeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_LoadBalancerPolicyPolicyAttributeList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*LoadBalancerPolicyPolicyAttribute:
		val := val.(*[]*LoadBalancerPolicyPolicyAttribute)
	...
	case []*LoadBalancerPolicyPolicyAttribute:
		val_ := val.([]*LoadBalancerPolicyPolicyAttribute)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*LoadBalancerPolicyPolicyAttribute; received %#v (a %T)", val, val)
		}
	}
