...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/load_balancer_policy aws_load_balancer_policy}.
...
func (j *jsiiProxy_LoadBalancerPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LoadBalancerPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoadBalancerPolicy) PolicyAttribute() LoadBalancerPolicyPolicyAttributeList {
	var returns LoadBalancerPolicyPolicyAttributeList
	_jsii_.Get(
		j,
		"policyAttribute",
		&returns,
...
func NewLoadBalancerPolicy(scope constructs.Construct, id *string, config *LoadBalancerPolicyConfig) LoadBalancerPolicy {
	...
	if err := validateNewLoadBalancerPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoadBalancerPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLoadBalancerPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LoadBalancerPolicy) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoadBalancerPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoadBalancerPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoadBalancerPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoadBalancerPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoadBalancerPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LoadBalancerPolicy) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoadBalancerPolicy) MoveToId(id *string) {
...
func (l *jsiiProxy_LoadBalancerPolicy) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
