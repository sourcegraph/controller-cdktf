...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicecatalogproductportfolioassociation/internal"
)
...
type ServicecatalogProductPortfolioAssociation interface {
	...
	PutTimeouts(value *ServicecatalogProductPortfolioAssociationTimeouts)
	ResetAcceptLanguage()
	ResetId()
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogProductPortfolioAssociation) Timeouts() ServicecatalogProductPortfolioAssociationTimeoutsOutputReference {
	var returns ServicecatalogProductPortfolioAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogProductPortfolioAssociation(scope constructs.Construct, id *string, config *ServicecatalogProductPortfolioAssociationConfig) ServicecatalogProductPortfolioAssociation {
	...
	if err := validateNewServicecatalogProductPortfolioAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) PutTimeouts(value *ServicecatalogProductPortfolioAssociationTimeouts) {
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogProductPortfolioAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
