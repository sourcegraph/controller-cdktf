...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/volumeattachment/internal"
)
...
func (j *jsiiProxy_VolumeAttachment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VolumeAttachment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
