...
func (j *jsiiProxy_DataAwsSignerSigningProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) RevocationRecord() DataAwsSignerSigningProfileRevocationRecordList {
	var returns DataAwsSignerSigningProfileRevocationRecordList
	_jsii_.Get(
		j,
		"revocationRecord",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningProfile) SignatureValidityPeriod() DataAwsSignerSigningProfileSignatureValidityPeriodList {
	var returns DataAwsSignerSigningProfileSignatureValidityPeriodList
	_jsii_.Get(
		j,
...
func NewDataAwsSignerSigningProfile(scope constructs.Construct, id *string, config *DataAwsSignerSigningProfileConfig) DataAwsSignerSigningProfile {
	...
	if err := validateNewDataAwsSignerSigningProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSignerSigningProfile) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
