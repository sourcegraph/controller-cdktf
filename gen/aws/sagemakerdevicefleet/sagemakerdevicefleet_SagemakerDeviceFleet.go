...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sagemakerdevicefleet/internal"
)
...
func (j *jsiiProxy_SagemakerDeviceFleet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerDeviceFleet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerDeviceFleet(scope constructs.Construct, id *string, config *SagemakerDeviceFleetConfig) SagemakerDeviceFleet {
	...
	if err := validateNewSagemakerDeviceFleetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerDeviceFleet) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
