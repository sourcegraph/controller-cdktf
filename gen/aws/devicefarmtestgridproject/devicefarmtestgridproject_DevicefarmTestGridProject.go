...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/devicefarmtestgridproject/internal"
)
...
func NewDevicefarmTestGridProject(scope constructs.Construct, id *string, config *DevicefarmTestGridProjectConfig) DevicefarmTestGridProject {
	...
	if err := validateNewDevicefarmTestGridProjectParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmTestGridProject) PutVpcConfig(value *DevicefarmTestGridProjectVpcConfig) {
	if err := d.validatePutVpcConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
