...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/opsworksrdsdbinstance/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/opsworks_rds_db_instance aws_opsworks_rds_db_instance}.
...
func (j *jsiiProxy_OpsworksRdsDbInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OpsworksRdsDbInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewOpsworksRdsDbInstance(scope constructs.Construct, id *string, config *OpsworksRdsDbInstanceConfig) OpsworksRdsDbInstance {
	...
	if err := validateNewOpsworksRdsDbInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OpsworksRdsDbInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOpsworksRdsDbInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksRdsDbInstance) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OpsworksRdsDbInstance) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
