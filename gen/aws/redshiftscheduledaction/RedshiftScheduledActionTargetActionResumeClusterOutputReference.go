...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftscheduledaction/internal"
)
...
func NewRedshiftScheduledActionTargetActionResumeClusterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RedshiftScheduledActionTargetActionResumeClusterOutputReference {
	...
	if err := validateNewRedshiftScheduledActionTargetActionResumeClusterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
