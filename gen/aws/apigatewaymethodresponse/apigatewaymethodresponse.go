...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaymethodresponse/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_method_response aws_api_gateway_method_response}.
...
func NewApiGatewayMethodResponse(scope constructs.Construct, id *string, config *ApiGatewayMethodResponseConfig) ApiGatewayMethodResponse {
	...
	if err := validateNewApiGatewayMethodResponseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiGatewayMethodResponse_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayMethodResponse_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayMethodResponse) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayMethodResponse) MoveToId(id *string) {
