...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dynamodbtableitem/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dynamodb_table_item aws_dynamodb_table_item}.
...
func (j *jsiiProxy_DynamodbTableItem) Connection() interface{} {
...
func (j *jsiiProxy_DynamodbTableItem) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DynamodbTableItem) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DynamodbTableItem) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dynamodb_table_item aws_dynamodb_table_item} Resource.
func NewDynamodbTableItem(scope constructs.Construct, id *string, config *DynamodbTableItemConfig) DynamodbTableItem {
	_init_.Initialize()

	if err := validateNewDynamodbTableItemParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DynamodbTableItem)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DynamodbTableItem)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynamodbTableItem)SetId(val *string) {
...
func (j *jsiiProxy_DynamodbTableItem)SetItem(val *string) {
	if err := j.validateSetItemParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DynamodbTableItem)SetProvisioners(val *[]interface{}) {
...
func DynamodbTableItem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDynamodbTableItem_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DynamodbTableItem_IsConstruct(x interface{}) *bool {
	...
	if err := validateDynamodbTableItem_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DynamodbTableItem_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDynamodbTableItem_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DynamodbTableItem_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDynamodbTableItem_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DynamodbTableItem) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DynamodbTableItem) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DynamodbTableItem) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbTableItem) MoveFromId(id *string) {
...
func (d *jsiiProxy_DynamodbTableItem) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DynamodbTableItem) MoveToId(id *string) {
...
func (d *jsiiProxy_DynamodbTableItem) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DynamodbTableItem) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DynamodbTableItem) ToHclTerraform() interface{} {
	var returns interface{}
