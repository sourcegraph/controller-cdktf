...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cognitoresourceserver/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cognito_resource_server aws_cognito_resource_server}.
...
func NewCognitoResourceServer(scope constructs.Construct, id *string, config *CognitoResourceServerConfig) CognitoResourceServer {
	...
	if err := validateNewCognitoResourceServerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CognitoResourceServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoResourceServer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoResourceServer) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoResourceServer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CognitoResourceServer) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoResourceServer) MoveToId(id *string) {
