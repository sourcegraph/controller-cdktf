...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) InternalValue() interface{} {
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList)SetWrapsSet(val *bool) {
...
func (w *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) Get(index *float64) WafGeoMatchSetGeoMatchConstraintOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WafGeoMatchSetGeoMatchConstraintOutputReference
...
func (w *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafGeoMatchSetGeoMatchConstraintList) ToString() *string {
	var returns *string
