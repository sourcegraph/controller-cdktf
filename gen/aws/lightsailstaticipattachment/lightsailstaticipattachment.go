package lightsailstaticipattachment
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lightsailstaticipattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_static_ip_attachment aws_lightsail_static_ip_attachment}.
...
func (j *jsiiProxy_LightsailStaticIpAttachment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_static_ip_attachment aws_lightsail_static_ip_attachment} Resource.
func NewLightsailStaticIpAttachment(scope constructs.Construct, id *string, config *LightsailStaticIpAttachmentConfig) LightsailStaticIpAttachment {
	...
	if err := validateNewLightsailStaticIpAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LightsailStaticIpAttachment)SetCount(val interface{}) {
...
func (j *jsiiProxy_LightsailStaticIpAttachment)SetStaticIpName(val *string) {
	if err := j.validateSetStaticIpNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func LightsailStaticIpAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailStaticIpAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LightsailStaticIpAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateLightsailStaticIpAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LightsailStaticIpAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLightsailStaticIpAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LightsailStaticIpAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLightsailStaticIpAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LightsailStaticIpAttachment) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LightsailStaticIpAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LightsailStaticIpAttachment) ToHclTerraform() interface{} {
	var returns interface{}
