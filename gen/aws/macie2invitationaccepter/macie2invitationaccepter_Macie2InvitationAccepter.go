...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/macie2invitationaccepter/internal"
)
...
func NewMacie2InvitationAccepter(scope constructs.Construct, id *string, config *Macie2InvitationAccepterConfig) Macie2InvitationAccepter {
	...
	if err := validateNewMacie2InvitationAccepterParameters(scope, id, config); err != nil {
		panic(err)
	}
