...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iotthing/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iot_thing aws_iot_thing}.
...
func (j *jsiiProxy_IotThing) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotThing) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIotThing(scope constructs.Construct, id *string, config *IotThingConfig) IotThing {
	...
	if err := validateNewIotThingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IotThing_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotThing_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotThing) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotThing) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotThing) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotThing) MoveToId(id *string) {
...
func (i *jsiiProxy_IotThing) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
