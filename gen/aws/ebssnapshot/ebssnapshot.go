...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ebssnapshot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ebs_snapshot aws_ebs_snapshot}.
...
func EbsSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEbsSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EbsSnapshot) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EbsSnapshot) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EbsSnapshot) MoveFromId(id *string) {
...
func (e *jsiiProxy_EbsSnapshot) MoveToId(id *string) {
