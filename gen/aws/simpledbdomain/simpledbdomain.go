...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/simpledbdomain/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/simpledb_domain aws_simpledb_domain}.
...
type jsiiProxy_SimpledbDomain struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_SimpledbDomain) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SimpledbDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SimpledbDomain) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SimpledbDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SimpledbDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SimpledbDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SimpledbDomain) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SimpledbDomain) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SimpledbDomain) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SimpledbDomain) Node() constructs.Node {
...
func (j *jsiiProxy_SimpledbDomain) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SimpledbDomain) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SimpledbDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewSimpledbDomain(scope constructs.Construct, id *string, config *SimpledbDomainConfig) SimpledbDomain {
	...
	if err := validateNewSimpledbDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SimpledbDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSimpledbDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SimpledbDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.simpledbDomain.SimpledbDomain",
...
func (s *jsiiProxy_SimpledbDomain) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SimpledbDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SimpledbDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SimpledbDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SimpledbDomain) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SimpledbDomain) MoveFromId(id *string) {
...
func (s *jsiiProxy_SimpledbDomain) MoveToId(id *string) {
...
func (s *jsiiProxy_SimpledbDomain) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SimpledbDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SimpledbDomain) ToString() *string {
	var returns *string
