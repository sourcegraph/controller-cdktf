...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscodeartifactrepositoryendpoint/internal"
)
...
func NewDataAwsCodeartifactRepositoryEndpoint(scope constructs.Construct, id *string, config *DataAwsCodeartifactRepositoryEndpointConfig) DataAwsCodeartifactRepositoryEndpoint {
	...
	if err := validateNewDataAwsCodeartifactRepositoryEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsCodeartifactRepositoryEndpoint{}

	_jsii_.Create(
		"aws.dataAwsCodeartifactRepositoryEndpoint.DataAwsCodeartifactRepositoryEndpoint",
