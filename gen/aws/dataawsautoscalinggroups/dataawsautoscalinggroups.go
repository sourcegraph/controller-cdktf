...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/autoscaling_groups aws_autoscaling_groups}.
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) Filter() DataAwsAutoscalingGroupsFilterList {
	var returns DataAwsAutoscalingGroupsFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsAutoscalingGroups) NamesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"namesInput",
...
func NewDataAwsAutoscalingGroups(scope constructs.Construct, id *string, config *DataAwsAutoscalingGroupsConfig) DataAwsAutoscalingGroups {
	...
	if err := validateNewDataAwsAutoscalingGroupsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsAutoscalingGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsAutoscalingGroups_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAutoscalingGroups) ResetNames() {
	_jsii_.InvokeVoid(
		d,
		"resetNames",
		nil, // no parameters
