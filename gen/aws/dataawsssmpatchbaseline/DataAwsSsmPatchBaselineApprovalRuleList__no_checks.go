...
func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSsmPatchBaselineApprovalRuleList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
