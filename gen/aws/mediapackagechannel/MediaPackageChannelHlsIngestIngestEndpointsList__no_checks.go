...
func (j *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_MediaPackageChannelHlsIngestIngestEndpointsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
