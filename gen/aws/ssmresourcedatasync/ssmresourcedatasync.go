...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmresourcedatasync/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssm_resource_data_sync aws_ssm_resource_data_sync}.
...
func (s *jsiiProxy_SsmResourceDataSync) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsmResourceDataSync) MoveToId(id *string) {
