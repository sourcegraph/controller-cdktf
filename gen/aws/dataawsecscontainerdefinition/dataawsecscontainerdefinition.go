...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsecscontainerdefinition/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ecs_container_definition aws_ecs_container_definition}.
...
func NewDataAwsEcsContainerDefinition(scope constructs.Construct, id *string, config *DataAwsEcsContainerDefinitionConfig) DataAwsEcsContainerDefinition {
	...
	if err := validateNewDataAwsEcsContainerDefinitionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEcsContainerDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEcsContainerDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
