...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewayv2apis/internal"
)
...
func NewDataAwsApigatewayv2Apis(scope constructs.Construct, id *string, config *DataAwsApigatewayv2ApisConfig) DataAwsApigatewayv2Apis {
	...
	if err := validateNewDataAwsApigatewayv2ApisParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsApigatewayv2Apis_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsApigatewayv2Apis_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
