...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_analytics_configuration aws_s3_bucket_analytics_configuration}.
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) Connection() interface{} {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_analytics_configuration aws_s3_bucket_analytics_configuration} Resource.
func NewS3BucketAnalyticsConfiguration(scope constructs.Construct, id *string, config *S3BucketAnalyticsConfigurationConfig) S3BucketAnalyticsConfiguration {
	...
	if err := validateNewS3BucketAnalyticsConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetId(val *string) {
...
func (j *jsiiProxy_S3BucketAnalyticsConfiguration)SetProvisioners(val *[]interface{}) {
...
func S3BucketAnalyticsConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketAnalyticsConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func S3BucketAnalyticsConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3BucketAnalyticsConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3BucketAnalyticsConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketAnalyticsConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3BucketAnalyticsConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketAnalyticsConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) PutStorageClassAnalysis(value *S3BucketAnalyticsConfigurationStorageClassAnalysis) {
	if err := s.validatePutStorageClassAnalysisParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3BucketAnalyticsConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
