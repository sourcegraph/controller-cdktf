...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketAnalyticsConfigurationStorageClassAnalysisOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference_Override(s S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketAnalyticsConfigurationStorageClassAnalysisOutputReference) ToString() *string {
	var returns *string
