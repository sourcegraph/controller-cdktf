...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53resolverfirewallconfig/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_resolver_firewall_config aws_route53_resolver_firewall_config}.
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverFirewallConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53ResolverFirewallConfig(scope constructs.Construct, id *string, config *Route53ResolverFirewallConfigConfig) Route53ResolverFirewallConfig {
	...
	if err := validateNewRoute53ResolverFirewallConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53ResolverFirewallConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverFirewallConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverFirewallConfig) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
