...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/daxsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dax_subnet_group aws_dax_subnet_group}.
...
func (j *jsiiProxy_DaxSubnetGroup) Connection() interface{} {
...
func (j *jsiiProxy_DaxSubnetGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DaxSubnetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DaxSubnetGroup) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dax_subnet_group aws_dax_subnet_group} Resource.
func NewDaxSubnetGroup(scope constructs.Construct, id *string, config *DaxSubnetGroupConfig) DaxSubnetGroup {
	_init_.Initialize()

	if err := validateNewDaxSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DaxSubnetGroup)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DaxSubnetGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DaxSubnetGroup)SetId(val *string) {
...
func (j *jsiiProxy_DaxSubnetGroup)SetProvisioners(val *[]interface{}) {
...
func DaxSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDaxSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DaxSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDaxSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DaxSubnetGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDaxSubnetGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DaxSubnetGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDaxSubnetGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DaxSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DaxSubnetGroup) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DaxSubnetGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DaxSubnetGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DaxSubnetGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DaxSubnetGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DaxSubnetGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DaxSubnetGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DaxSubnetGroup) ToHclTerraform() interface{} {
	var returns interface{}
