...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudhsm_v2_cluster aws_cloudhsm_v2_cluster}.
type CloudhsmV2Cluster interface {
	cdktf.TerraformResource
	// Experimental.
	CdktfStack() cdktf.TerraformStack
	ClusterCertificates() CloudhsmV2ClusterClusterCertificatesList
	ClusterId() *string
	ClusterState() *string
	// Experimental.
...
func (j *jsiiProxy_CloudhsmV2Cluster) ClusterCertificates() CloudhsmV2ClusterClusterCertificatesList {
	var returns CloudhsmV2ClusterClusterCertificatesList
	_jsii_.Get(
		j,
		"clusterCertificates",
		&returns,
...
func (j *jsiiProxy_CloudhsmV2Cluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudhsmV2Cluster) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudhsmV2Cluster) Tags() *map[string]*string {
...
func (j *jsiiProxy_CloudhsmV2Cluster) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CloudhsmV2Cluster) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CloudhsmV2Cluster) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewCloudhsmV2Cluster(scope constructs.Construct, id *string, config *CloudhsmV2ClusterConfig) CloudhsmV2Cluster {
	...
	if err := validateNewCloudhsmV2ClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudhsmV2Cluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudhsmV2Cluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudhsmV2Cluster) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudhsmV2Cluster) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CloudhsmV2Cluster) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CloudhsmV2Cluster) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CloudhsmV2Cluster) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CloudhsmV2Cluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudhsmV2Cluster) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudhsmV2Cluster) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudhsmV2Cluster) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
