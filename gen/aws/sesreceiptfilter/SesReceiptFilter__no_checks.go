...
func (j *jsiiProxy_SesReceiptFilter) validateSetCidrParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_SesReceiptFilter) validateSetNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_SesReceiptFilter) validateSetPolicyParameters(val *string) error {
	return nil
}
