...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesreceiptfilter/internal"
)
...
func (j *jsiiProxy_SesReceiptFilter) Connection() interface{} {
...
func (j *jsiiProxy_SesReceiptFilter) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SesReceiptFilter) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesReceiptFilter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesReceiptFilter) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSesReceiptFilter(scope constructs.Construct, id *string, config *SesReceiptFilterConfig) SesReceiptFilter {
	...
	if err := validateNewSesReceiptFilterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesReceiptFilter)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SesReceiptFilter)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_SesReceiptFilter)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesReceiptFilter)SetId(val *string) {
...
func (j *jsiiProxy_SesReceiptFilter)SetProvisioners(val *[]interface{}) {
...
func SesReceiptFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateSesReceiptFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SesReceiptFilter) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SesReceiptFilter) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesReceiptFilter) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesReceiptFilter) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesReceiptFilter) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesReceiptFilter) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
