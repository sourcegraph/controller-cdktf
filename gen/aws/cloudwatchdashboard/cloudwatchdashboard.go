...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatchdashboard/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_dashboard aws_cloudwatch_dashboard}.
...
func (j *jsiiProxy_CloudwatchDashboard) Connection() interface{} {
...
func (j *jsiiProxy_CloudwatchDashboard) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchDashboard) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudwatchDashboard) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_dashboard aws_cloudwatch_dashboard} Resource.
func NewCloudwatchDashboard(scope constructs.Construct, id *string, config *CloudwatchDashboardConfig) CloudwatchDashboard {
	_init_.Initialize()

	if err := validateNewCloudwatchDashboardParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudwatchDashboard)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CloudwatchDashboard)SetDashboardBody(val *string) {
	if err := j.validateSetDashboardBodyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CloudwatchDashboard)SetDashboardName(val *string) {
	if err := j.validateSetDashboardNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CloudwatchDashboard)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchDashboard)SetId(val *string) {
...
func (j *jsiiProxy_CloudwatchDashboard)SetProvisioners(val *[]interface{}) {
...
func CloudwatchDashboard_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchDashboard_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudwatchDashboard_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudwatchDashboard_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchDashboard_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchDashboard_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchDashboard_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchDashboard_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudwatchDashboard) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchDashboard) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudwatchDashboard) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchDashboard) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchDashboard) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudwatchDashboard) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudwatchDashboard) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchDashboard) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudwatchDashboard) ToHclTerraform() interface{} {
	var returns interface{}
