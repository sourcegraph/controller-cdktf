package prometheusalertmanagerdefinition
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/prometheusalertmanagerdefinition/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/prometheus_alert_manager_definition aws_prometheus_alert_manager_definition}.
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition) Connection() interface{} {
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/prometheus_alert_manager_definition aws_prometheus_alert_manager_definition} Resource.
func NewPrometheusAlertManagerDefinition(scope constructs.Construct, id *string, config *PrometheusAlertManagerDefinitionConfig) PrometheusAlertManagerDefinition {
	...
	if err := validateNewPrometheusAlertManagerDefinitionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition)SetConnection(val interface{}) {
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition)SetId(val *string) {
...
func (j *jsiiProxy_PrometheusAlertManagerDefinition)SetProvisioners(val *[]interface{}) {
...
func PrometheusAlertManagerDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePrometheusAlertManagerDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PrometheusAlertManagerDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validatePrometheusAlertManagerDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrometheusAlertManagerDefinition_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrometheusAlertManagerDefinition_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrometheusAlertManagerDefinition_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrometheusAlertManagerDefinition_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PrometheusAlertManagerDefinition) ToHclTerraform() interface{} {
	var returns interface{}
