...
func NewWafregionalRateBasedRulePredicateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalRateBasedRulePredicateList {
	...
	if err := validateNewWafregionalRateBasedRulePredicateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalRateBasedRulePredicateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
