...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewConnectInstanceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConnectInstanceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewConnectInstanceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewConnectInstanceTimeoutsOutputReference_Override(c ConnectInstanceTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ConnectInstanceTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_ConnectInstanceTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConnectInstanceTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ConnectInstanceTimeoutsOutputReference) ToString() *string {
	var returns *string
