...
func NewLexSlotTypeEnumerationValueList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexSlotTypeEnumerationValueList {
	...
	if err := validateNewLexSlotTypeEnumerationValueListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LexSlotTypeEnumerationValueList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
