...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselbserviceaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elb_service_account aws_elb_service_account}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elb_service_account aws_elb_service_account} Data Source.
func NewDataAwsElbServiceAccount(scope constructs.Construct, id *string, config *DataAwsElbServiceAccountConfig) DataAwsElbServiceAccount {
	...
	if err := validateNewDataAwsElbServiceAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsElbServiceAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsElbServiceAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsElbServiceAccount_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsElbServiceAccount_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsElbServiceAccount_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsElbServiceAccount_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsElbServiceAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsElbServiceAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsElbServiceAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsElbServiceAccount) ToHclTerraform() interface{} {
	var returns interface{}
