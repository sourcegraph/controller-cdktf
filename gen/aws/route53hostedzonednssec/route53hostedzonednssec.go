...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53hostedzonednssec/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_hosted_zone_dnssec aws_route53_hosted_zone_dnssec}.
...
func (j *jsiiProxy_Route53HostedZoneDnssec) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53HostedZoneDnssec) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53HostedZoneDnssec(scope constructs.Construct, id *string, config *Route53HostedZoneDnssecConfig) Route53HostedZoneDnssec {
	...
	if err := validateNewRoute53HostedZoneDnssecParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53HostedZoneDnssec_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53HostedZoneDnssec_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53HostedZoneDnssec) AddMoveTarget(moveTarget *string) {
