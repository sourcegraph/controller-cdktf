...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbinstanceroleassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_instance_role_association aws_db_instance_role_association}.
...
func (j *jsiiProxy_DbInstanceRoleAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbInstanceRoleAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDbInstanceRoleAssociation(scope constructs.Construct, id *string, config *DbInstanceRoleAssociationConfig) DbInstanceRoleAssociation {
	...
	if err := validateNewDbInstanceRoleAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbInstanceRoleAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbInstanceRoleAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbInstanceRoleAssociation) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbInstanceRoleAssociation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbInstanceRoleAssociation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbInstanceRoleAssociation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbInstanceRoleAssociation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
