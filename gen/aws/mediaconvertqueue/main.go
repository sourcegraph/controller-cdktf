...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putReservationPlanSettings", GoMethod: "PutReservationPlanSettings"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "reservationPlanSettings", GoGetter: "ReservationPlanSettings"},
			_jsii_.MemberProperty{JsiiProperty: "reservationPlanSettingsInput", GoGetter: "ReservationPlanSettingsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPricingPlan", GoMethod: "ResetPricingPlan"},
			_jsii_.MemberMethod{JsiiMethod: "resetReservationPlanSettings", GoMethod: "ResetReservationPlanSettings"},
	...
	_jsii_.RegisterStruct(
		"aws.mediaConvertQueue.MediaConvertQueueConfig",
		reflect.TypeOf((*MediaConvertQueueConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.mediaConvertQueue.MediaConvertQueueReservationPlanSettings",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "renewalType", GoGetter: "RenewalType"},
			_jsii_.MemberProperty{JsiiProperty: "renewalTypeInput", GoGetter: "RenewalTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "reservedSlots", GoGetter: "ReservedSlots"},
			_jsii_.MemberProperty{JsiiProperty: "reservedSlotsInput", GoGetter: "ReservedSlotsInput"},
