...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/mediaconvertqueue/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/media_convert_queue aws_media_convert_queue}.
...
func NewMediaConvertQueue(scope constructs.Construct, id *string, config *MediaConvertQueueConfig) MediaConvertQueue {
	...
	if err := validateNewMediaConvertQueueParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MediaConvertQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMediaConvertQueue_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MediaConvertQueue) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MediaConvertQueue) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MediaConvertQueue) MoveFromId(id *string) {
...
func (m *jsiiProxy_MediaConvertQueue) MoveToId(id *string) {
...
func (m *jsiiProxy_MediaConvertQueue) PutReservationPlanSettings(value *MediaConvertQueueReservationPlanSettings) {
	if err := m.validatePutReservationPlanSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
