...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ecstag/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecs_tag aws_ecs_tag}.
...
func NewEcsTag(scope constructs.Construct, id *string, config *EcsTagConfig) EcsTag {
	...
	if err := validateNewEcsTagParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_EcsTag{}
...
func EcsTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEcsTag_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsTag) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcsTag) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EcsTag) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcsTag) MoveToId(id *string) {
