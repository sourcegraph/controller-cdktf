...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/backupvaultnotifications/internal"
)
...
func (j *jsiiProxy_BackupVaultNotifications) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupVaultNotifications) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewBackupVaultNotifications(scope constructs.Construct, id *string, config *BackupVaultNotificationsConfig) BackupVaultNotifications {
	...
	if err := validateNewBackupVaultNotificationsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupVaultNotifications) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
