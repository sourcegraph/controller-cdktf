...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsecrauthorizationtoken/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ecr_authorization_token aws_ecr_authorization_token}.
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEcrAuthorizationToken) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEcrAuthorizationToken(scope constructs.Construct, id *string, config *DataAwsEcrAuthorizationTokenConfig) DataAwsEcrAuthorizationToken {
	...
	if err := validateNewDataAwsEcrAuthorizationTokenParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEcrAuthorizationToken) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
