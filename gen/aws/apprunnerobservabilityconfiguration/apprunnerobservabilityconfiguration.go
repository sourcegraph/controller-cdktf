...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apprunnerobservabilityconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/apprunner_observability_configuration aws_apprunner_observability_configuration}.
...
func NewApprunnerObservabilityConfiguration(scope constructs.Construct, id *string, config *ApprunnerObservabilityConfigurationConfig) ApprunnerObservabilityConfiguration {
	...
	if err := validateNewApprunnerObservabilityConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerObservabilityConfiguration) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApprunnerObservabilityConfiguration) PutTraceConfiguration(value *ApprunnerObservabilityConfigurationTraceConfiguration) {
	if err := a.validatePutTraceConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
