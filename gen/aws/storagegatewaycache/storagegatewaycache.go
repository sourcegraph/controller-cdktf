...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/storagegatewaycache/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/storagegateway_cache aws_storagegateway_cache}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/storagegateway_cache aws_storagegateway_cache} Resource.
func NewStoragegatewayCache(scope constructs.Construct, id *string, config *StoragegatewayCacheConfig) StoragegatewayCache {
	_init_.Initialize()

	if err := validateNewStoragegatewayCacheParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StoragegatewayCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStoragegatewayCache_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StoragegatewayCache_IsConstruct(x interface{}) *bool {
	...
	if err := validateStoragegatewayCache_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StoragegatewayCache_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStoragegatewayCache_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StoragegatewayCache_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStoragegatewayCache_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StoragegatewayCache) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StoragegatewayCache) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StoragegatewayCache) ToHclTerraform() interface{} {
	var returns interface{}
