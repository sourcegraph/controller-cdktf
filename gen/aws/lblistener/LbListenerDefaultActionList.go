...
func (j *jsiiProxy_LbListenerDefaultActionList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLbListenerDefaultActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LbListenerDefaultActionList {
	_init_.Initialize()
...
func NewLbListenerDefaultActionList_Override(l LbListenerDefaultActionList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LbListenerDefaultActionList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LbListenerDefaultActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LbListenerDefaultActionList) Resolve(_context cdktf.IResolveContext) interface{} {
