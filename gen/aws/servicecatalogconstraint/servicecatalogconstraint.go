...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/servicecatalog_constraint aws_servicecatalog_constraint}.
type ServicecatalogConstraint interface {
	...
	PutTimeouts(value *ServicecatalogConstraintTimeouts)
	ResetAcceptLanguage()
	ResetDescription()
	ResetId()
...
func (j *jsiiProxy_ServicecatalogConstraint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogConstraint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogConstraint) Timeouts() ServicecatalogConstraintTimeoutsOutputReference {
	var returns ServicecatalogConstraintTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogConstraint(scope constructs.Construct, id *string, config *ServicecatalogConstraintConfig) ServicecatalogConstraint {
	...
	if err := validateNewServicecatalogConstraintParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServicecatalogConstraint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogConstraint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogConstraint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogConstraint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogConstraint) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogConstraint) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogConstraint) PutTimeouts(value *ServicecatalogConstraintTimeouts) {
...
func (s *jsiiProxy_ServicecatalogConstraint) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogConstraint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
