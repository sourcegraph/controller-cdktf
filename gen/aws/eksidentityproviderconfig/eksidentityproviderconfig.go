...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/eks_identity_provider_config aws_eks_identity_provider_config}.
...
func (j *jsiiProxy_EksIdentityProviderConfig) ForEach() cdktf.ITerraformIterator {
...
func NewEksIdentityProviderConfig(scope constructs.Construct, id *string, config *EksIdentityProviderConfigConfig) EksIdentityProviderConfig {
	...
	if err := validateNewEksIdentityProviderConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EksIdentityProviderConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEksIdentityProviderConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EksIdentityProviderConfig) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) MoveFromId(id *string) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) MoveToId(id *string) {
...
func (e *jsiiProxy_EksIdentityProviderConfig) PutOidc(value *EksIdentityProviderConfigOidc) {
	if err := e.validatePutOidcParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EksIdentityProviderConfig) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
