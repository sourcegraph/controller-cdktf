...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cognitouseringroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cognito_user_in_group aws_cognito_user_in_group}.
...
func (j *jsiiProxy_CognitoUserInGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cognito_user_in_group aws_cognito_user_in_group} Resource.
func NewCognitoUserInGroup(scope constructs.Construct, id *string, config *CognitoUserInGroupConfig) CognitoUserInGroup {
	_init_.Initialize()

	if err := validateNewCognitoUserInGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_CognitoUserInGroup{}

	_jsii_.Create(
		"@cdktf/provider-aws.cognitoUserInGroup.CognitoUserInGroup",
...
func (j *jsiiProxy_CognitoUserInGroup)SetCount(val interface{}) {
...
func CognitoUserInGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoUserInGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CognitoUserInGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCognitoUserInGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CognitoUserInGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserInGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CognitoUserInGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCognitoUserInGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CognitoUserInGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CognitoUserInGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CognitoUserInGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserInGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_CognitoUserInGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CognitoUserInGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_CognitoUserInGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CognitoUserInGroup) ToHclTerraform() interface{} {
	var returns interface{}
