...
func (j *jsiiProxy_S3BucketNotification) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketNotification) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3BucketNotification) LambdaFunction() S3BucketNotificationLambdaFunctionList {
	var returns S3BucketNotificationLambdaFunctionList
	_jsii_.Get(
		j,
		"lambdaFunction",
		&returns,
...
func (j *jsiiProxy_S3BucketNotification) Queue() S3BucketNotificationQueueList {
	var returns S3BucketNotificationQueueList
	_jsii_.Get(
		j,
		"queue",
		&returns,
...
func (j *jsiiProxy_S3BucketNotification) Topic() S3BucketNotificationTopicList {
	var returns S3BucketNotificationTopicList
	_jsii_.Get(
		j,
		"topic",
		&returns,
...
func NewS3BucketNotification(scope constructs.Construct, id *string, config *S3BucketNotificationConfig) S3BucketNotification {
	...
	if err := validateNewS3BucketNotificationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketNotification) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
