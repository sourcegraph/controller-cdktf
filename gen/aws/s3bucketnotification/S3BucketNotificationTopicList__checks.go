...
func (s *jsiiProxy_S3BucketNotificationTopicList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_S3BucketNotificationTopicList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*S3BucketNotificationTopic:
		val := val.(*[]*S3BucketNotificationTopic)
	...
	case []*S3BucketNotificationTopic:
		val_ := val.([]*S3BucketNotificationTopic)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*S3BucketNotificationTopic; received %#v (a %T)", val, val)
		}
	}
