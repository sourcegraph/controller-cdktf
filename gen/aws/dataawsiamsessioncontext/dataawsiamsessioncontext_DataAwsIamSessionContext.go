...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamsessioncontext/internal"
)
...
func (j *jsiiProxy_DataAwsIamSessionContext) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamSessionContext) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamSessionContext(scope constructs.Construct, id *string, config *DataAwsIamSessionContextConfig) DataAwsIamSessionContext {
	...
	if err := validateNewDataAwsIamSessionContextParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsIamSessionContext)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamSessionContext)SetId(val *string) {
...
func DataAwsIamSessionContext_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIamSessionContext_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamSessionContext) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
