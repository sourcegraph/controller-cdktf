...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53querylog/internal"
)
...
func (j *jsiiProxy_Route53QueryLog) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53QueryLog) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53QueryLog(scope constructs.Construct, id *string, config *Route53QueryLogConfig) Route53QueryLog {
	...
	if err := validateNewRoute53QueryLogParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53QueryLog) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
