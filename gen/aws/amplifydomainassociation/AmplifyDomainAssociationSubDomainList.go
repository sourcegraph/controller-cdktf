...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/amplifydomainassociation/internal"
)
...
func (a *jsiiProxy_AmplifyDomainAssociationSubDomainList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
