...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/alblistenercertificate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_certificate aws_alb_listener_certificate}.
...
func (j *jsiiProxy_AlbListenerCertificate) Connection() interface{} {
...
func (j *jsiiProxy_AlbListenerCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AlbListenerCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AlbListenerCertificate) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_certificate aws_alb_listener_certificate} Resource.
func NewAlbListenerCertificate(scope constructs.Construct, id *string, config *AlbListenerCertificateConfig) AlbListenerCertificate {
	...
	if err := validateNewAlbListenerCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AlbListenerCertificate)SetConnection(val interface{}) {
...
func (j *jsiiProxy_AlbListenerCertificate)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AlbListenerCertificate)SetId(val *string) {
...
func (j *jsiiProxy_AlbListenerCertificate)SetProvisioners(val *[]interface{}) {
...
func AlbListenerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAlbListenerCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AlbListenerCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateAlbListenerCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AlbListenerCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAlbListenerCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AlbListenerCertificate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAlbListenerCertificate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AlbListenerCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AlbListenerCertificate) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (a *jsiiProxy_AlbListenerCertificate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AlbListenerCertificate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AlbListenerCertificate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AlbListenerCertificate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AlbListenerCertificate) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AlbListenerCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AlbListenerCertificate) ToHclTerraform() interface{} {
	var returns interface{}
