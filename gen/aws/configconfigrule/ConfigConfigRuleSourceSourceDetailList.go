...
func NewConfigConfigRuleSourceSourceDetailList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfigConfigRuleSourceSourceDetailList {
	...
	if err := validateNewConfigConfigRuleSourceSourceDetailListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigConfigRuleSourceSourceDetailList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
