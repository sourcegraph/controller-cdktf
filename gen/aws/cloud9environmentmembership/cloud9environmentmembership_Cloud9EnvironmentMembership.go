...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloud9environmentmembership/internal"
)
...
func NewCloud9EnvironmentMembership(scope constructs.Construct, id *string, config *Cloud9EnvironmentMembershipConfig) Cloud9EnvironmentMembership {
	...
	if err := validateNewCloud9EnvironmentMembershipParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Cloud9EnvironmentMembership_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloud9EnvironmentMembership_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
