...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssoadminpermissionset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssoadmin_permission_set aws_ssoadmin_permission_set}.
...
func (j *jsiiProxy_SsoadminPermissionSet) Connection() interface{} {
...
func (j *jsiiProxy_SsoadminPermissionSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminPermissionSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SsoadminPermissionSet) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SsoadminPermissionSet) Tags() *map[string]*string {
...
func (j *jsiiProxy_SsoadminPermissionSet) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_SsoadminPermissionSet) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_SsoadminPermissionSet) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssoadmin_permission_set aws_ssoadmin_permission_set} Resource.
func NewSsoadminPermissionSet(scope constructs.Construct, id *string, config *SsoadminPermissionSetConfig) SsoadminPermissionSet {
	...
	if err := validateNewSsoadminPermissionSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SsoadminPermissionSet)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SsoadminPermissionSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsoadminPermissionSet)SetId(val *string) {
...
func (j *jsiiProxy_SsoadminPermissionSet)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_SsoadminPermissionSet)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_SsoadminPermissionSet)SetTagsAll(val *map[string]*string) {
...
func SsoadminPermissionSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsoadminPermissionSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SsoadminPermissionSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateSsoadminPermissionSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SsoadminPermissionSet) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsoadminPermissionSet) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SsoadminPermissionSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SsoadminPermissionSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SsoadminPermissionSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SsoadminPermissionSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SsoadminPermissionSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SsoadminPermissionSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsoadminPermissionSet) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsoadminPermissionSet) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SsoadminPermissionSet) MoveToId(id *string) {
...
func (s *jsiiProxy_SsoadminPermissionSet) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminPermissionSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SsoadminPermissionSet) ToHclTerraform() interface{} {
	var returns interface{}
