...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_policy aws_iam_policy}.
...
func (j *jsiiProxy_IamPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamPolicy(scope constructs.Construct, id *string, config *IamPolicyConfig) IamPolicy {
	...
	if err := validateNewIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamPolicy) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamPolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamPolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_IamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
