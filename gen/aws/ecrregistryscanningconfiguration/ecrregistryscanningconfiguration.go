...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_registry_scanning_configuration aws_ecr_registry_scanning_configuration}.
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Connection() interface{} {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration) Rule() EcrRegistryScanningConfigurationRuleList {
	var returns EcrRegistryScanningConfigurationRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_registry_scanning_configuration aws_ecr_registry_scanning_configuration} Resource.
func NewEcrRegistryScanningConfiguration(scope constructs.Construct, id *string, config *EcrRegistryScanningConfigurationConfig) EcrRegistryScanningConfiguration {
	...
	if err := validateNewEcrRegistryScanningConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetConnection(val interface{}) {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetId(val *string) {
...
func (j *jsiiProxy_EcrRegistryScanningConfiguration)SetProvisioners(val *[]interface{}) {
...
func EcrRegistryScanningConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEcrRegistryScanningConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EcrRegistryScanningConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateEcrRegistryScanningConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrRegistryScanningConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrRegistryScanningConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrRegistryScanningConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrRegistryScanningConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) MoveToId(id *string) {
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) PutRule(value interface{}) {
	if err := e.validatePutRuleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EcrRegistryScanningConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
