...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsimagebuildercomponent/internal"
)
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderComponent) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsImagebuilderComponent(scope constructs.Construct, id *string, config *DataAwsImagebuilderComponentConfig) DataAwsImagebuilderComponent {
	...
	if err := validateNewDataAwsImagebuilderComponentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderComponent)SetId(val *string) {
...
func DataAwsImagebuilderComponent_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsImagebuilderComponent_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsImagebuilderComponent) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
