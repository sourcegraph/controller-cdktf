...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamroles/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_roles aws_iam_roles}.
...
func (j *jsiiProxy_DataAwsIamRoles) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamRoles) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_roles aws_iam_roles} Data Source.
func NewDataAwsIamRoles(scope constructs.Construct, id *string, config *DataAwsIamRolesConfig) DataAwsIamRoles {
	_init_.Initialize()

	if err := validateNewDataAwsIamRolesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsIamRoles)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamRoles)SetId(val *string) {
...
func DataAwsIamRoles_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamRoles_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsIamRoles_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIamRoles_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamRoles_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamRoles_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsIamRoles_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsIamRoles_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamRoles) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsIamRoles) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsIamRoles) ToHclTerraform() interface{} {
	var returns interface{}
