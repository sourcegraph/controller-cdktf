...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsconnectcontactflowmodule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_contact_flow_module aws_connect_contact_flow_module}.
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectContactFlowModule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsConnectContactFlowModule(scope constructs.Construct, id *string, config *DataAwsConnectContactFlowModuleConfig) DataAwsConnectContactFlowModule {
	...
	if err := validateNewDataAwsConnectContactFlowModuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsConnectContactFlowModule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectContactFlowModule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsConnectContactFlowModule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
