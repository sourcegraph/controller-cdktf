...
func (j *jsiiProxy_KmsGrantConstraintsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*KmsGrantConstraints:
		val := val.(*[]*KmsGrantConstraints)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*KmsGrantConstraints; received %#v (a %T)", val, val)
		}
	}
