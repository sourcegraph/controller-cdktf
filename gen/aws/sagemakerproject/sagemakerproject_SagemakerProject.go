...
func (j *jsiiProxy_SagemakerProject) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerProject) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerProject(scope constructs.Construct, id *string, config *SagemakerProjectConfig) SagemakerProject {
	...
	if err := validateNewSagemakerProjectParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SagemakerProject{}

	_jsii_.Create(
		"aws.sagemakerProject.SagemakerProject",
...
func (s *jsiiProxy_SagemakerProject) PutServiceCatalogProvisioningDetails(value *SagemakerProjectServiceCatalogProvisioningDetails) {
	if err := s.validatePutServiceCatalogProvisioningDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SagemakerProject) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
