...
func (j *jsiiProxy_EmrInstanceGroup) EbsConfig() EmrInstanceGroupEbsConfigList {
	var returns EmrInstanceGroupEbsConfigList
	_jsii_.Get(
		j,
		"ebsConfig",
		&returns,
...
func (j *jsiiProxy_EmrInstanceGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmrInstanceGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEmrInstanceGroup(scope constructs.Construct, id *string, config *EmrInstanceGroupConfig) EmrInstanceGroup {
	...
	if err := validateNewEmrInstanceGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrInstanceGroup) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
