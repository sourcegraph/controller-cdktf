...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dax_parameter_group aws_dax_parameter_group}.
...
func (j *jsiiProxy_DaxParameterGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DaxParameterGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DaxParameterGroup) Parameters() DaxParameterGroupParametersList {
	var returns DaxParameterGroupParametersList
	_jsii_.Get(
		j,
		"parameters",
		&returns,
...
func NewDaxParameterGroup(scope constructs.Construct, id *string, config *DaxParameterGroupConfig) DaxParameterGroup {
	...
	if err := validateNewDaxParameterGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DaxParameterGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDaxParameterGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DaxParameterGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DaxParameterGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DaxParameterGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DaxParameterGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DaxParameterGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DaxParameterGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DaxParameterGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DaxParameterGroup) MoveToId(id *string) {
...
func (d *jsiiProxy_DaxParameterGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
