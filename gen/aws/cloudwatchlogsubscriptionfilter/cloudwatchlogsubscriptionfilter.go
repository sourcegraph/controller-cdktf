...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatchlogsubscriptionfilter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_log_subscription_filter aws_cloudwatch_log_subscription_filter}.
...
func (j *jsiiProxy_CloudwatchLogSubscriptionFilter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudwatchLogSubscriptionFilter(scope constructs.Construct, id *string, config *CloudwatchLogSubscriptionFilterConfig) CloudwatchLogSubscriptionFilter {
	...
	if err := validateNewCloudwatchLogSubscriptionFilterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchLogSubscriptionFilter) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
