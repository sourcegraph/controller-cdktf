...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDbInstanceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DbInstanceTimeoutsOutputReference {
	...
	if err := validateNewDbInstanceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DbInstanceTimeoutsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DbInstanceTimeoutsOutputReference) ToString() *string {
	var returns *string
