...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dynamodb_global_table aws_dynamodb_global_table}.
...
func (j *jsiiProxy_DynamodbGlobalTable) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DynamodbGlobalTable) Replica() DynamodbGlobalTableReplicaList {
	var returns DynamodbGlobalTableReplicaList
	_jsii_.Get(
		j,
		"replica",
		&returns,
...
func (d *jsiiProxy_DynamodbGlobalTable) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
