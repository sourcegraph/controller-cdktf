...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/organizationspolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/organizations_policy aws_organizations_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/organizations_policy aws_organizations_policy} Resource.
func NewOrganizationsPolicy(scope constructs.Construct, id *string, config *OrganizationsPolicyConfig) OrganizationsPolicy {
	_init_.Initialize()

	if err := validateNewOrganizationsPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationsPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrganizationsPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func OrganizationsPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateOrganizationsPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (o *jsiiProxy_OrganizationsPolicy) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrganizationsPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OrganizationsPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsPolicy) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrganizationsPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OrganizationsPolicy) MoveToId(id *string) {
...
func (o *jsiiProxy_OrganizationsPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OrganizationsPolicy) ToHclTerraform() interface{} {
	var returns interface{}
