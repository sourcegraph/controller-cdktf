...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewaydomainname/internal"
)
...
func NewDataAwsApiGatewayDomainNameEndpointConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference {
	...
	if err := validateNewDataAwsApiGatewayDomainNameEndpointConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference{}

	_jsii_.Create(
		"aws.dataAwsApiGatewayDomainName.DataAwsApiGatewayDomainNameEndpointConfigurationOutputReference",
