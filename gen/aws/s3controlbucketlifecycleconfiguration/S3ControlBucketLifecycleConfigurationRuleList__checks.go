...
func (s *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*S3ControlBucketLifecycleConfigurationRule:
		val_ := val.([]*S3ControlBucketLifecycleConfigurationRule)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfigurationRuleList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
