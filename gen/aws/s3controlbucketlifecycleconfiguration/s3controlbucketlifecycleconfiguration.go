...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3control_bucket_lifecycle_configuration aws_s3control_bucket_lifecycle_configuration}.
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration) Connection() interface{} {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration) Rule() S3ControlBucketLifecycleConfigurationRuleList {
	var returns S3ControlBucketLifecycleConfigurationRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3control_bucket_lifecycle_configuration aws_s3control_bucket_lifecycle_configuration} Resource.
func NewS3ControlBucketLifecycleConfiguration(scope constructs.Construct, id *string, config *S3ControlBucketLifecycleConfigurationConfig) S3ControlBucketLifecycleConfiguration {
	...
	if err := validateNewS3ControlBucketLifecycleConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration)SetId(val *string) {
...
func (j *jsiiProxy_S3ControlBucketLifecycleConfiguration)SetProvisioners(val *[]interface{}) {
...
func S3ControlBucketLifecycleConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlBucketLifecycleConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func S3ControlBucketLifecycleConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3ControlBucketLifecycleConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlBucketLifecycleConfiguration_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlBucketLifecycleConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3ControlBucketLifecycleConfiguration_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3ControlBucketLifecycleConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) PutRule(value interface{}) {
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3ControlBucketLifecycleConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
