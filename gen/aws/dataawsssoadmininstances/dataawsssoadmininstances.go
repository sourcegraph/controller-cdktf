package dataawsssoadmininstances
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsssoadmininstances/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ssoadmin_instances aws_ssoadmin_instances}.
...
func (j *jsiiProxy_DataAwsSsoadminInstances) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsoadminInstances) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ssoadmin_instances aws_ssoadmin_instances} Data Source.
func NewDataAwsSsoadminInstances(scope constructs.Construct, id *string, config *DataAwsSsoadminInstancesConfig) DataAwsSsoadminInstances {
	...
	if err := validateNewDataAwsSsoadminInstancesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsSsoadminInstances)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsSsoadminInstances)SetId(val *string) {
...
func DataAwsSsoadminInstances_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSsoadminInstances_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsSsoadminInstances_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsSsoadminInstances_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSsoadminInstances) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataAwsSsoadminInstances) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsSsoadminInstances) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsSsoadminInstances) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsSsoadminInstances) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsSsoadminInstances) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSsoadminInstances) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSsoadminInstances) ToHclTerraform() interface{} {
	var returns interface{}
