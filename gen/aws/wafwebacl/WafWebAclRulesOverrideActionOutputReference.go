...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewWafWebAclRulesOverrideActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafWebAclRulesOverrideActionOutputReference {
	_init_.Initialize()

	if err := validateNewWafWebAclRulesOverrideActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafWebAclRulesOverrideActionOutputReference_Override(w WafWebAclRulesOverrideActionOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafWebAclRulesOverrideActionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafWebAclRulesOverrideActionOutputReference) ToString() *string {
	var returns *string
