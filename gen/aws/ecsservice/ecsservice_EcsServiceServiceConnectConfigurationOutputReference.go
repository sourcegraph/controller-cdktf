...
type EcsServiceServiceConnectConfigurationOutputReference interface {
	...
	SetInternalValue(val *EcsServiceServiceConnectConfiguration)
	LogConfiguration() EcsServiceServiceConnectConfigurationLogConfigurationOutputReference
	LogConfigurationInput() *EcsServiceServiceConnectConfigurationLogConfiguration
	Namespace() *string
	SetNamespace(val *string)
	NamespaceInput() *string
	Service() EcsServiceServiceConnectConfigurationServiceOutputReference
	ServiceInput() *EcsServiceServiceConnectConfigurationService
	// Experimental.
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) InternalValue() *EcsServiceServiceConnectConfiguration {
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) LogConfiguration() EcsServiceServiceConnectConfigurationLogConfigurationOutputReference {
	var returns EcsServiceServiceConnectConfigurationLogConfigurationOutputReference
	_jsii_.Get(
		j,
		"logConfiguration",
		&returns,
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) LogConfigurationInput() *EcsServiceServiceConnectConfigurationLogConfiguration {
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) NamespaceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceInput",
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) Service() EcsServiceServiceConnectConfigurationServiceOutputReference {
	var returns EcsServiceServiceConnectConfigurationServiceOutputReference
	_jsii_.Get(
		j,
		"service",
		&returns,
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ServiceInput() *EcsServiceServiceConnectConfigurationService {
...
func (j *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) PutService(value *EcsServiceServiceConnectConfigurationService) {
	if err := e.validatePutServiceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ResetLogConfiguration() {
	_jsii_.InvokeVoid(
		e,
		"resetLogConfiguration",
		nil, // no parameters
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ResetNamespace() {
	_jsii_.InvokeVoid(
		e,
		"resetNamespace",
		nil, // no parameters
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ResetService() {
	_jsii_.InvokeVoid(
		e,
		"resetService",
		nil, // no parameters
...
func (e *jsiiProxy_EcsServiceServiceConnectConfigurationOutputReference) ToString() *string {
	var returns *string
