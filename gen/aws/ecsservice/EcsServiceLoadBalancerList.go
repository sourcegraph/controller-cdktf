...
func NewEcsServiceLoadBalancerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsServiceLoadBalancerList {
	...
	if err := validateNewEcsServiceLoadBalancerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsServiceLoadBalancerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
