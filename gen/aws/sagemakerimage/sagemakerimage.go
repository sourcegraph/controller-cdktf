...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sagemakerimage/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sagemaker_image aws_sagemaker_image}.
...
func (j *jsiiProxy_SagemakerImage) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerImage) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerImage(scope constructs.Construct, id *string, config *SagemakerImageConfig) SagemakerImage {
	...
	if err := validateNewSagemakerImageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SagemakerImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerImage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerImage) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerImage) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerImage) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerImage) MoveToId(id *string) {
...
func (s *jsiiProxy_SagemakerImage) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
