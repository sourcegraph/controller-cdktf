package dataawscloudfrontlogdeliverycanonicaluserid
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudfrontlogdeliverycanonicaluserid/internal"
)
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsCloudfrontLogDeliveryCanonicalUserId(scope constructs.Construct, id *string, config *DataAwsCloudfrontLogDeliveryCanonicalUserIdConfig) DataAwsCloudfrontLogDeliveryCanonicalUserId {
	...
	if err := validateNewDataAwsCloudfrontLogDeliveryCanonicalUserIdParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId)SetId(val *string) {
...
func DataAwsCloudfrontLogDeliveryCanonicalUserId_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCloudfrontLogDeliveryCanonicalUserId_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCloudfrontLogDeliveryCanonicalUserId) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
