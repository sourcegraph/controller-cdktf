...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53recoveryreadinessrecoverygroup/internal"
)
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRoute53RecoveryreadinessRecoveryGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRoute53RecoveryreadinessRecoveryGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRoute53RecoveryreadinessRecoveryGroupTimeoutsOutputReference_Override(r Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroupTimeoutsOutputReference) ToString() *string {
	var returns *string
