...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53recoveryreadiness_recovery_group aws_route53recoveryreadiness_recovery_group}.
...
func (j *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53RecoveryreadinessRecoveryGroup(scope constructs.Construct, id *string, config *Route53RecoveryreadinessRecoveryGroupConfig) Route53RecoveryreadinessRecoveryGroup {
	...
	if err := validateNewRoute53RecoveryreadinessRecoveryGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
