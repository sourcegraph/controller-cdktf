...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cognitoidentityprovider/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cognito_identity_provider aws_cognito_identity_provider}.
...
func NewCognitoIdentityProvider(scope constructs.Construct, id *string, config *CognitoIdentityProviderConfig) CognitoIdentityProvider {
	...
	if err := validateNewCognitoIdentityProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CognitoIdentityProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCognitoIdentityProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoIdentityProvider) AddMoveTarget(moveTarget *string) {
