...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawseksclusterauth/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/eks_cluster_auth aws_eks_cluster_auth}.
...
func (j *jsiiProxy_DataAwsEksClusterAuth) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksClusterAuth) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/eks_cluster_auth aws_eks_cluster_auth} Data Source.
func NewDataAwsEksClusterAuth(scope constructs.Construct, id *string, config *DataAwsEksClusterAuthConfig) DataAwsEksClusterAuth {
	...
	if err := validateNewDataAwsEksClusterAuthParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsEksClusterAuth)SetId(val *string) {
...
func DataAwsEksClusterAuth_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEksClusterAuth_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsEksClusterAuth_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsEksClusterAuth_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksClusterAuth_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksClusterAuth_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsEksClusterAuth_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsEksClusterAuth_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsEksClusterAuth) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsEksClusterAuth) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsEksClusterAuth) ToHclTerraform() interface{} {
	var returns interface{}
