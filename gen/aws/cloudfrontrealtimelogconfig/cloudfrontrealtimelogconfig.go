...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudfront_realtime_log_config aws_cloudfront_realtime_log_config}.
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontRealtimeLogConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontRealtimeLogConfig(scope constructs.Construct, id *string, config *CloudfrontRealtimeLogConfigConfig) CloudfrontRealtimeLogConfig {
	...
	if err := validateNewCloudfrontRealtimeLogConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudfrontRealtimeLogConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontRealtimeLogConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) PutEndpoint(value *CloudfrontRealtimeLogConfigEndpoint) {
	if err := c.validatePutEndpointParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudfrontRealtimeLogConfig) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
