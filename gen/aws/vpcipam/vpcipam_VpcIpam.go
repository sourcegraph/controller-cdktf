...
func (j *jsiiProxy_VpcIpam) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcIpam) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VpcIpam) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcIpam) OperatingRegions() VpcIpamOperatingRegionsList {
	var returns VpcIpamOperatingRegionsList
	_jsii_.Get(
		j,
		"operatingRegions",
		&returns,
...
func (j *jsiiProxy_VpcIpam) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpcIpam) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpcIpam) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpcIpam) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewVpcIpam(scope constructs.Construct, id *string, config *VpcIpamConfig) VpcIpam {
	...
	if err := validateNewVpcIpamParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_VpcIpam{}
...
func (j *jsiiProxy_VpcIpam)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (v *jsiiProxy_VpcIpam) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcIpam) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcIpam) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcIpam) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcIpam) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
