...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/backupvault/internal"
)
...
func (j *jsiiProxy_BackupVault) Connection() interface{} {
...
func (j *jsiiProxy_BackupVault) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupVault) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BackupVault) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewBackupVault(scope constructs.Construct, id *string, config *BackupVaultConfig) BackupVault {
	...
	if err := validateNewBackupVaultParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_BackupVault{}

	_jsii_.Create(
		"aws.backupVault.BackupVault",
...
func (j *jsiiProxy_BackupVault)SetConnection(val interface{}) {
...
func (j *jsiiProxy_BackupVault)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupVault)SetId(val *string) {
...
func (j *jsiiProxy_BackupVault)SetProvisioners(val *[]interface{}) {
