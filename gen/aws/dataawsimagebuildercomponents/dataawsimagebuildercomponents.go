...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsimagebuildercomponents/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_components aws_imagebuilder_components}.
...
func (j *jsiiProxy_DataAwsImagebuilderComponents) Filter() DataAwsImagebuilderComponentsFilterList {
	var returns DataAwsImagebuilderComponentsFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderComponents) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderComponents) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_components aws_imagebuilder_components} Data Source.
func NewDataAwsImagebuilderComponents(scope constructs.Construct, id *string, config *DataAwsImagebuilderComponentsConfig) DataAwsImagebuilderComponents {
	...
	if err := validateNewDataAwsImagebuilderComponentsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsImagebuilderComponents)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsImagebuilderComponents)SetId(val *string) {
...
func DataAwsImagebuilderComponents_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsImagebuilderComponents_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsImagebuilderComponents) PutFilter(value interface{}) {
...
func (d *jsiiProxy_DataAwsImagebuilderComponents) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsImagebuilderComponents) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsImagebuilderComponents) ToHclTerraform() interface{} {
	var returns interface{}
