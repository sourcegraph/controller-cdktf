...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudhsmv2hsm/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudhsm_v2_hsm aws_cloudhsm_v2_hsm}.
...
func (j *jsiiProxy_CloudhsmV2Hsm) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudhsmV2Hsm) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudhsmV2Hsm(scope constructs.Construct, id *string, config *CloudhsmV2HsmConfig) CloudhsmV2Hsm {
	...
	if err := validateNewCloudhsmV2HsmParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudhsmV2Hsm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudhsmV2Hsm_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudhsmV2Hsm) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudhsmV2Hsm) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CloudhsmV2Hsm) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CloudhsmV2Hsm) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CloudhsmV2Hsm) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CloudhsmV2Hsm) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
