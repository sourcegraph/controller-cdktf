...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lightsailkeypair/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_key_pair aws_lightsail_key_pair}.
...
func NewLightsailKeyPair(scope constructs.Construct, id *string, config *LightsailKeyPairConfig) LightsailKeyPair {
	...
	if err := validateNewLightsailKeyPairParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LightsailKeyPair_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailKeyPair_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LightsailKeyPair) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LightsailKeyPair) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LightsailKeyPair) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailKeyPair) MoveToId(id *string) {
