...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/autoscalingattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/autoscaling_attachment aws_autoscaling_attachment}.
type AutoscalingAttachment interface {
	...
	SetLbTargetGroupArn(val *string)
	LbTargetGroupArnInput() *string
	// Experimental.
...
func (j *jsiiProxy_AutoscalingAttachment) Connection() interface{} {
...
func (j *jsiiProxy_AutoscalingAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AutoscalingAttachment) LbTargetGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lbTargetGroupArn",
...
func (j *jsiiProxy_AutoscalingAttachment) LbTargetGroupArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lbTargetGroupArnInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_AutoscalingAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/autoscaling_attachment aws_autoscaling_attachment} Resource.
func NewAutoscalingAttachment(scope constructs.Construct, id *string, config *AutoscalingAttachmentConfig) AutoscalingAttachment {
	...
	if err := validateNewAutoscalingAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AutoscalingAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_AutoscalingAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingAttachment)SetId(val *string) {
...
func (j *jsiiProxy_AutoscalingAttachment)SetLbTargetGroupArn(val *string) {
	if err := j.validateSetLbTargetGroupArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AutoscalingAttachment)SetProvisioners(val *[]interface{}) {
...
func AutoscalingAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAutoscalingAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AutoscalingAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateAutoscalingAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutoscalingAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutoscalingAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutoscalingAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutoscalingAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AutoscalingAttachment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutoscalingAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutoscalingAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingAttachment) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutoscalingAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AutoscalingAttachment) MoveToId(id *string) {
...
func (a *jsiiProxy_AutoscalingAttachment) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingAttachment) ResetLbTargetGroupArn() {
	_jsii_.InvokeVoid(
		a,
		"resetLbTargetGroupArn",
		nil, // no parameters
...
func (a *jsiiProxy_AutoscalingAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutoscalingAttachment) ToHclTerraform() interface{} {
	var returns interface{}
