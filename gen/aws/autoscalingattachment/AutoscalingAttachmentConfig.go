...
type AutoscalingAttachmentConfig struct {
	...
	AlbTargetGroupArn *string `field:"optional" json:"albTargetGroupArn" yaml:"albTargetGroupArn"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/autoscaling_attachment#elb AutoscalingAttachment#elb}.
	Elb *string `field:"optional" json:"elb" yaml:"elb"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/autoscaling_attachment#id AutoscalingAttachment#id}.
	//
