package dataawselasticbeanstalkhostedzone
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselasticbeanstalkhostedzone/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/elastic_beanstalk_hosted_zone aws_elastic_beanstalk_hosted_zone}.
...
func NewDataAwsElasticBeanstalkHostedZone(scope constructs.Construct, id *string, config *DataAwsElasticBeanstalkHostedZoneConfig) DataAwsElasticBeanstalkHostedZone {
	...
	if err := validateNewDataAwsElasticBeanstalkHostedZoneParameters(scope, id, config); err != nil {
		panic(err)
	}
