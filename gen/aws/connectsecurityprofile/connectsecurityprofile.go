...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/connectsecurityprofile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_security_profile aws_connect_security_profile}.
...
func (j *jsiiProxy_ConnectSecurityProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectSecurityProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewConnectSecurityProfile(scope constructs.Construct, id *string, config *ConnectSecurityProfileConfig) ConnectSecurityProfile {
	...
	if err := validateNewConnectSecurityProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConnectSecurityProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConnectSecurityProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectSecurityProfile) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
