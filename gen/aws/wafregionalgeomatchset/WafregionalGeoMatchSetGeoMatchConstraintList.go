...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalgeomatchset/internal"
)
...
func NewWafregionalGeoMatchSetGeoMatchConstraintList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WafregionalGeoMatchSetGeoMatchConstraintList {
	...
	if err := validateNewWafregionalGeoMatchSetGeoMatchConstraintListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafregionalGeoMatchSetGeoMatchConstraintList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
