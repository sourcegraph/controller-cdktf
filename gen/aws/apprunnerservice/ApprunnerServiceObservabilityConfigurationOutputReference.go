...
func NewApprunnerServiceObservabilityConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApprunnerServiceObservabilityConfigurationOutputReference {
	...
	if err := validateNewApprunnerServiceObservabilityConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerServiceObservabilityConfigurationOutputReference) ResetObservabilityConfigurationArn() {
	_jsii_.InvokeVoid(
		a,
		"resetObservabilityConfigurationArn",
		nil, // no parameters
