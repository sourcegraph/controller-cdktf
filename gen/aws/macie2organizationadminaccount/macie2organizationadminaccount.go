...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/macie2organizationadminaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie2_organization_admin_account aws_macie2_organization_admin_account}.
...
func NewMacie2OrganizationAdminAccount(scope constructs.Construct, id *string, config *Macie2OrganizationAdminAccountConfig) Macie2OrganizationAdminAccount {
	...
	if err := validateNewMacie2OrganizationAdminAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Macie2OrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacie2OrganizationAdminAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) MoveFromId(id *string) {
...
func (m *jsiiProxy_Macie2OrganizationAdminAccount) MoveToId(id *string) {
