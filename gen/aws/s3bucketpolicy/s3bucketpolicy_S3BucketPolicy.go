...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3bucketpolicy/internal"
)
...
func (j *jsiiProxy_S3BucketPolicy) Connection() interface{} {
...
func (j *jsiiProxy_S3BucketPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3BucketPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewS3BucketPolicy(scope constructs.Construct, id *string, config *S3BucketPolicyConfig) S3BucketPolicy {
	...
	_jsii_.Create(
		"aws.s3BucketPolicy.S3BucketPolicy",
...
func (s *jsiiProxy_S3BucketPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
