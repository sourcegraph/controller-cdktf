...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/loadbalancerbackendserverpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/load_balancer_backend_server_policy aws_load_balancer_backend_server_policy}.
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy) Connection() interface{} {
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/load_balancer_backend_server_policy aws_load_balancer_backend_server_policy} Resource.
func NewLoadBalancerBackendServerPolicy(scope constructs.Construct, id *string, config *LoadBalancerBackendServerPolicyConfig) LoadBalancerBackendServerPolicy {
	...
	if err := validateNewLoadBalancerBackendServerPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy)SetId(val *string) {
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy)SetPolicyNames(val *[]*string) {
	if err := j.validateSetPolicyNamesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_LoadBalancerBackendServerPolicy)SetProvisioners(val *[]interface{}) {
...
func LoadBalancerBackendServerPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLoadBalancerBackendServerPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LoadBalancerBackendServerPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateLoadBalancerBackendServerPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LoadBalancerBackendServerPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLoadBalancerBackendServerPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LoadBalancerBackendServerPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLoadBalancerBackendServerPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) MoveToId(id *string) {
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LoadBalancerBackendServerPolicy) ToHclTerraform() interface{} {
	var returns interface{}
