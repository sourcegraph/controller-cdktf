...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamvirtualmfadevice/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_virtual_mfa_device aws_iam_virtual_mfa_device}.
...
type jsiiProxy_IamVirtualMfaDevice struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_IamVirtualMfaDevice) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_IamVirtualMfaDevice) Base32StringSeed() *string {
	var returns *string
	_jsii_.Get(
		j,
		"base32StringSeed",
...
func (j *jsiiProxy_IamVirtualMfaDevice) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IamVirtualMfaDevice) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IamVirtualMfaDevice) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamVirtualMfaDevice) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IamVirtualMfaDevice) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IamVirtualMfaDevice) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IamVirtualMfaDevice) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamVirtualMfaDevice) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamVirtualMfaDevice) Node() constructs.Node {
...
func (j *jsiiProxy_IamVirtualMfaDevice) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_IamVirtualMfaDevice) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_IamVirtualMfaDevice) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IamVirtualMfaDevice) QrCodePng() *string {
	var returns *string
	_jsii_.Get(
		j,
		"qrCodePng",
...
func (j *jsiiProxy_IamVirtualMfaDevice) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_IamVirtualMfaDevice) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_IamVirtualMfaDevice) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_IamVirtualMfaDevice) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IamVirtualMfaDevice) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamVirtualMfaDevice) VirtualMfaDeviceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"virtualMfaDeviceNameInput",
		&returns,
	)
	return returns
}
...
func NewIamVirtualMfaDevice(scope constructs.Construct, id *string, config *IamVirtualMfaDeviceConfig) IamVirtualMfaDevice {
	...
	if err := validateNewIamVirtualMfaDeviceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamVirtualMfaDevice_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamVirtualMfaDevice_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IamVirtualMfaDevice_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.iamVirtualMfaDevice.IamVirtualMfaDevice",
...
func (i *jsiiProxy_IamVirtualMfaDevice) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IamVirtualMfaDevice) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IamVirtualMfaDevice) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamVirtualMfaDevice) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IamVirtualMfaDevice) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamVirtualMfaDevice) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IamVirtualMfaDevice) ResetPath() {
	_jsii_.InvokeVoid(
		i,
		"resetPath",
		nil, // no parameters
...
func (i *jsiiProxy_IamVirtualMfaDevice) ResetTags() {
	_jsii_.InvokeVoid(
		i,
		"resetTags",
		nil, // no parameters
...
func (i *jsiiProxy_IamVirtualMfaDevice) ResetTagsAll() {
	_jsii_.InvokeVoid(
		i,
		"resetTagsAll",
		nil, // no parameters
...
func (i *jsiiProxy_IamVirtualMfaDevice) ToString() *string {
	var returns *string
