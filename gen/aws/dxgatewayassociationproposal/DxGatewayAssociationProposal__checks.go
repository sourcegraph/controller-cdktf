...
func (d *jsiiProxy_DxGatewayAssociationProposal) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (d *jsiiProxy_DxGatewayAssociationProposal) validateImportFromParameters(id *string) error {
	if id == nil {
...
func validateDxGatewayAssociationProposal_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func validateDxGatewayAssociationProposal_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateDxGatewayAssociationProposal_IsTerraformResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
