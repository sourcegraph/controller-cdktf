...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayv2vpclink/internal"
)
...
func NewApigatewayv2VpcLink(scope constructs.Construct, id *string, config *Apigatewayv2VpcLinkConfig) Apigatewayv2VpcLink {
	...
	if err := validateNewApigatewayv2VpcLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Apigatewayv2VpcLink{}

	_jsii_.Create(
		"aws.apigatewayv2VpcLink.Apigatewayv2VpcLink",
