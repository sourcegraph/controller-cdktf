...
type AlbListenerRuleCondition struct {
	// host_header block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_rule#host_header AlbListenerRule#host_header}
	HostHeader *AlbListenerRuleConditionHostHeader `field:"optional" json:"hostHeader" yaml:"hostHeader"`
	// http_header block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_rule#http_header AlbListenerRule#http_header}
	HttpHeader *AlbListenerRuleConditionHttpHeader `field:"optional" json:"httpHeader" yaml:"httpHeader"`
	// http_request_method block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_rule#http_request_method AlbListenerRule#http_request_method}
	HttpRequestMethod *AlbListenerRuleConditionHttpRequestMethod `field:"optional" json:"httpRequestMethod" yaml:"httpRequestMethod"`
	// path_pattern block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_listener_rule#path_pattern AlbListenerRule#path_pattern}
