...
func NewCodebuildProjectSecondarySourceVersionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CodebuildProjectSecondarySourceVersionList {
	...
	if err := validateNewCodebuildProjectSecondarySourceVersionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodebuildProjectSecondarySourceVersionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
