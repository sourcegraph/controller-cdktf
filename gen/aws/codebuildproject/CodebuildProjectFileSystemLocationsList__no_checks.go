...
func (c *jsiiProxy_CodebuildProjectFileSystemLocationsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_CodebuildProjectFileSystemLocationsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_CodebuildProjectFileSystemLocationsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
