...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxhostedprivatevirtualinterface/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface} Resource.
func NewDxHostedPrivateVirtualInterface(scope constructs.Construct, id *string, config *DxHostedPrivateVirtualInterfaceConfig) DxHostedPrivateVirtualInterface {
	...
	if err := validateNewDxHostedPrivateVirtualInterfaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DxHostedPrivateVirtualInterface_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDxHostedPrivateVirtualInterface_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DxHostedPrivateVirtualInterface_IsConstruct(x interface{}) *bool {
	...
	if err := validateDxHostedPrivateVirtualInterface_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxHostedPrivateVirtualInterface_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxHostedPrivateVirtualInterface_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxHostedPrivateVirtualInterface_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxHostedPrivateVirtualInterface_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) MoveToId(id *string) {
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DxHostedPrivateVirtualInterface) ToHclTerraform() interface{} {
	var returns interface{}
