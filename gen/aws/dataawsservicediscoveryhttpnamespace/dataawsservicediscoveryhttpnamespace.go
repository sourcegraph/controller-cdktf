package dataawsservicediscoveryhttpnamespace
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsservicediscoveryhttpnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/service_discovery_http_namespace aws_service_discovery_http_namespace}.
...
func NewDataAwsServiceDiscoveryHttpNamespace(scope constructs.Construct, id *string, config *DataAwsServiceDiscoveryHttpNamespaceConfig) DataAwsServiceDiscoveryHttpNamespace {
	...
	if err := validateNewDataAwsServiceDiscoveryHttpNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServiceDiscoveryHttpNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServiceDiscoveryHttpNamespace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
