...
func (j *jsiiProxy_DataAwsEipsFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DataAwsEipsFilter:
		val := val.(*[]*DataAwsEipsFilter)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsEipsFilter; received %#v (a %T)", val, val)
		}
	}
