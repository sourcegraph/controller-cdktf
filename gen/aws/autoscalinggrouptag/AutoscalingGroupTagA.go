...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/autoscaling_group_tag aws_autoscaling_group_tag}.
...
func (j *jsiiProxy_AutoscalingGroupTagA) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingGroupTagA) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAutoscalingGroupTagA(scope constructs.Construct, id *string, config *AutoscalingGroupTagAConfig) AutoscalingGroupTagA {
	...
	if err := validateNewAutoscalingGroupTagAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AutoscalingGroupTagA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAutoscalingGroupTagA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AutoscalingGroupTagA) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutoscalingGroupTagA) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
