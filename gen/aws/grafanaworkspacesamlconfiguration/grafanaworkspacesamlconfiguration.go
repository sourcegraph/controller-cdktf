...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/grafanaworkspacesamlconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/grafana_workspace_saml_configuration aws_grafana_workspace_saml_configuration}.
...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) MoveFromId(id *string) {
...
func (g *jsiiProxy_GrafanaWorkspaceSamlConfiguration) MoveToId(id *string) {
