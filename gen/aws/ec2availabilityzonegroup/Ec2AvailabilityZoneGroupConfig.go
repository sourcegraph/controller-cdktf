...
type Ec2AvailabilityZoneGroupConfig struct {
	...
	OptInStatus *string `field:"required" json:"optInStatus" yaml:"optInStatus"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ec2_availability_zone_group#id Ec2AvailabilityZoneGroup#id}.
	//
