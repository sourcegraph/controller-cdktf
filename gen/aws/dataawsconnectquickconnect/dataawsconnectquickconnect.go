...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_quick_connect aws_connect_quick_connect}.
type DataAwsConnectQuickConnect interface {
	...
	QuickConnectConfig() DataAwsConnectQuickConnectQuickConnectConfigList
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsConnectQuickConnect) QuickConnectConfig() DataAwsConnectQuickConnectQuickConnectConfigList {
	var returns DataAwsConnectQuickConnectQuickConnectConfigList
	_jsii_.Get(
		j,
		"quickConnectConfig",
		&returns,
...
func NewDataAwsConnectQuickConnect(scope constructs.Construct, id *string, config *DataAwsConnectQuickConnectConfig) DataAwsConnectQuickConnect {
	...
	if err := validateNewDataAwsConnectQuickConnectParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsConnectQuickConnect_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectQuickConnect_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsConnectQuickConnect) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
