...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/configorganizationmanagedrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/config_organization_managed_rule aws_config_organization_managed_rule}.
...
func NewConfigOrganizationManagedRule(scope constructs.Construct, id *string, config *ConfigOrganizationManagedRuleConfig) ConfigOrganizationManagedRule {
	...
	_jsii_.Create(
		"aws.configOrganizationManagedRule.ConfigOrganizationManagedRule",
