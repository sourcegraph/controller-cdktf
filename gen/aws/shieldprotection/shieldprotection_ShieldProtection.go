...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/shieldprotection/internal"
)
...
func (j *jsiiProxy_ShieldProtection) Connection() interface{} {
...
func (j *jsiiProxy_ShieldProtection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ShieldProtection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ShieldProtection) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_ShieldProtection) Tags() *map[string]*string {
...
func (j *jsiiProxy_ShieldProtection) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_ShieldProtection) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_ShieldProtection) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewShieldProtection(scope constructs.Construct, id *string, config *ShieldProtectionConfig) ShieldProtection {
	...
	if err := validateNewShieldProtectionParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ShieldProtection{}

	_jsii_.Create(
		"aws.shieldProtection.ShieldProtection",
...
func (j *jsiiProxy_ShieldProtection)SetConnection(val interface{}) {
...
func (j *jsiiProxy_ShieldProtection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ShieldProtection)SetId(val *string) {
...
func (j *jsiiProxy_ShieldProtection)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_ShieldProtection)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_ShieldProtection)SetTagsAll(val *map[string]*string) {
...
func ShieldProtection_IsConstruct(x interface{}) *bool {
	...
	if err := validateShieldProtection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_ShieldProtection) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_ShieldProtection) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_ShieldProtection) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_ShieldProtection) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_ShieldProtection) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_ShieldProtection) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
