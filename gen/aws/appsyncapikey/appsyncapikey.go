...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appsyncapikey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appsync_api_key aws_appsync_api_key}.
...
func NewAppsyncApiKey(scope constructs.Construct, id *string, config *AppsyncApiKeyConfig) AppsyncApiKey {
	...
	if err := validateNewAppsyncApiKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppsyncApiKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppsyncApiKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppsyncApiKey) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppsyncApiKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppsyncApiKey) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppsyncApiKey) MoveToId(id *string) {
