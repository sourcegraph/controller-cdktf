...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawslambdacodesigningconfig/internal"
)
...
func NewDataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference {
	...
	if err := validateNewDataAwsLambdaCodeSigningConfigAllowedPublishersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference{}

	_jsii_.Create(
		"aws.dataAwsLambdaCodeSigningConfig.DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference",
