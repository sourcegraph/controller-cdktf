...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayusageplan/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_usage_plan aws_api_gateway_usage_plan}.
...
func (a *jsiiProxy_ApiGatewayUsagePlan) PutQuotaSettings(value *ApiGatewayUsagePlanQuotaSettings) {
	if err := a.validatePutQuotaSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApiGatewayUsagePlan) PutThrottleSettings(value *ApiGatewayUsagePlanThrottleSettings) {
	if err := a.validatePutThrottleSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
