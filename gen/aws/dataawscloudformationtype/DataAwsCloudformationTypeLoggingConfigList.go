...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudformationtype/internal"
)
...
func NewDataAwsCloudformationTypeLoggingConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCloudformationTypeLoggingConfigList {
	...
	if err := validateNewDataAwsCloudformationTypeLoggingConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCloudformationTypeLoggingConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
