...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/servicecatalog_tag_option_resource_association aws_servicecatalog_tag_option_resource_association}.
type ServicecatalogTagOptionResourceAssociation interface {
	...
	PutTimeouts(value *ServicecatalogTagOptionResourceAssociationTimeouts)
	ResetId()
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogTagOptionResourceAssociation) Timeouts() ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference {
	var returns ServicecatalogTagOptionResourceAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogTagOptionResourceAssociation(scope constructs.Construct, id *string, config *ServicecatalogTagOptionResourceAssociationConfig) ServicecatalogTagOptionResourceAssociation {
	...
	if err := validateNewServicecatalogTagOptionResourceAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) PutTimeouts(value *ServicecatalogTagOptionResourceAssociationTimeouts) {
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogTagOptionResourceAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
