...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/apprunner_custom_domain_association aws_apprunner_custom_domain_association}.
...
func NewApprunnerCustomDomainAssociation(scope constructs.Construct, id *string, config *ApprunnerCustomDomainAssociationConfig) ApprunnerCustomDomainAssociation {
	...
	if err := validateNewApprunnerCustomDomainAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
