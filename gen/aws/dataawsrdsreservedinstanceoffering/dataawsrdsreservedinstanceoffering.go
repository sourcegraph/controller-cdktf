...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsrdsreservedinstanceoffering/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/rds_reserved_instance_offering aws_rds_reserved_instance_offering}.
...
type jsiiProxy_DataAwsRdsReservedInstanceOffering struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) CurrencyCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"currencyCode",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) DbInstanceClass() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dbInstanceClass",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) DbInstanceClassInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Duration() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"duration",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) DurationInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"durationInput",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) FixedPrice() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"fixedPrice",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Node() constructs.Node {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) OfferingId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"offeringId",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) OfferingType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"offeringType",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) OfferingTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"offeringTypeInput",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) ProductDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"productDescription",
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) ProductDescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsRdsReservedInstanceOffering) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataAwsRdsReservedInstanceOffering(scope constructs.Construct, id *string, config *DataAwsRdsReservedInstanceOfferingConfig) DataAwsRdsReservedInstanceOffering {
	...
	if err := validateNewDataAwsRdsReservedInstanceOfferingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRdsReservedInstanceOffering_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRdsReservedInstanceOffering_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsRdsReservedInstanceOffering_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.dataAwsRdsReservedInstanceOffering.DataAwsRdsReservedInstanceOffering",
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRdsReservedInstanceOffering) ToString() *string {
	var returns *string
