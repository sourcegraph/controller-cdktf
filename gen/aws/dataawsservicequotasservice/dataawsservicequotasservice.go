...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsservicequotasservice/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/servicequotas_service aws_servicequotas_service}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/servicequotas_service aws_servicequotas_service} Data Source.
func NewDataAwsServicequotasService(scope constructs.Construct, id *string, config *DataAwsServicequotasServiceConfig) DataAwsServicequotasService {
	...
	if err := validateNewDataAwsServicequotasServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsServicequotasService{}

	_jsii_.Create(
		"@cdktf/provider-aws.dataAwsServicequotasService.DataAwsServicequotasService",
...
func DataAwsServicequotasService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServicequotasService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsServicequotasService_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsServicequotasService_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsServicequotasService_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsServicequotasService_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsServicequotasService_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsServicequotasService_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsServicequotasService) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsServicequotasService) ToHclTerraform() interface{} {
	var returns interface{}
