...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/eks_fargate_profile aws_eks_fargate_profile}.
...
func (j *jsiiProxy_EksFargateProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EksFargateProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEksFargateProfile(scope constructs.Construct, id *string, config *EksFargateProfileConfig) EksFargateProfile {
	...
	if err := validateNewEksFargateProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EksFargateProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEksFargateProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EksFargateProfile) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EksFargateProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EksFargateProfile) MoveFromId(id *string) {
...
func (e *jsiiProxy_EksFargateProfile) MoveToId(id *string) {
...
func (e *jsiiProxy_EksFargateProfile) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
