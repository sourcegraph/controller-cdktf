package dataawsroute53delegationset
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsroute53delegationset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/route53_delegation_set aws_route53_delegation_set}.
...
func (j *jsiiProxy_DataAwsRoute53DelegationSet) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/route53_delegation_set aws_route53_delegation_set} Data Source.
func NewDataAwsRoute53DelegationSet(scope constructs.Construct, id *string, config *DataAwsRoute53DelegationSetConfig) DataAwsRoute53DelegationSet {
	...
	if err := validateNewDataAwsRoute53DelegationSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsRoute53DelegationSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataAwsRoute53DelegationSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRoute53DelegationSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsRoute53DelegationSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsRoute53DelegationSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsRoute53DelegationSet_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsRoute53DelegationSet_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsRoute53DelegationSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsRoute53DelegationSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsRoute53DelegationSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsRoute53DelegationSet) ToHclTerraform() interface{} {
	var returns interface{}
