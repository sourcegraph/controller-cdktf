...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/signer_signing_job aws_signer_signing_job}.
type DataAwsSignerSigningJob interface {
	...
	SignedObject() DataAwsSignerSigningJobSignedObjectList
...
func (j *jsiiProxy_DataAwsSignerSigningJob) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSignerSigningJob) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsSignerSigningJob) RevocationRecord() DataAwsSignerSigningJobRevocationRecordList {
	var returns DataAwsSignerSigningJobRevocationRecordList
	_jsii_.Get(
		j,
		"revocationRecord",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningJob) SignedObject() DataAwsSignerSigningJobSignedObjectList {
	var returns DataAwsSignerSigningJobSignedObjectList
	_jsii_.Get(
		j,
		"signedObject",
		&returns,
...
func (j *jsiiProxy_DataAwsSignerSigningJob) Source() DataAwsSignerSigningJobSourceList {
	var returns DataAwsSignerSigningJobSourceList
	_jsii_.Get(
		j,
		"source",
		&returns,
...
func NewDataAwsSignerSigningJob(scope constructs.Construct, id *string, config *DataAwsSignerSigningJobConfig) DataAwsSignerSigningJob {
	...
	if err := validateNewDataAwsSignerSigningJobParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSignerSigningJob) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
