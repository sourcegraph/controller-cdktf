...
func (d *jsiiProxy_DataAwsSignerSigningJobSignedObjectS3List) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsSignerSigningJobSignedObjectS3List) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSignerSigningJobSignedObjectS3List) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsSignerSigningJobSignedObjectS3List) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
