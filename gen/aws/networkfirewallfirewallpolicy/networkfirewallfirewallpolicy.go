...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/networkfirewall_firewall_policy aws_networkfirewall_firewall_policy}.
...
func NewNetworkfirewallFirewallPolicy(scope constructs.Construct, id *string, config *NetworkfirewallFirewallPolicyConfig) NetworkfirewallFirewallPolicy {
	...
	if err := validateNewNetworkfirewallFirewallPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func NetworkfirewallFirewallPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkfirewallFirewallPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicy) AddMoveTarget(moveTarget *string) {
