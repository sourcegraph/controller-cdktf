...
func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsLambdaFunctionDeadLetterConfigList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
