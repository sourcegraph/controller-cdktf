...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawskmsciphertext/internal"
)
...
func (j *jsiiProxy_DataAwsKmsCiphertext) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsCiphertext) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsKmsCiphertext(scope constructs.Construct, id *string, config *DataAwsKmsCiphertextConfig) DataAwsKmsCiphertext {
	...
	if err := validateNewDataAwsKmsCiphertextParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsKmsCiphertext{}

	_jsii_.Create(
		"aws.dataAwsKmsCiphertext.DataAwsKmsCiphertext",
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsCiphertext)SetId(val *string) {
...
func DataAwsKmsCiphertext_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsKmsCiphertext_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsKmsCiphertext) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
