...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontOriginRequestPolicy(scope constructs.Construct, id *string, config *CloudfrontOriginRequestPolicyConfig) CloudfrontOriginRequestPolicy {
	...
	if err := validateNewCloudfrontOriginRequestPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicy) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
