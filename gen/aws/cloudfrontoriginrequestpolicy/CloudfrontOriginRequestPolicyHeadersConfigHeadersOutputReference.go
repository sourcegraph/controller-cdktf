...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudfrontoriginrequestpolicy/internal"
)
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference {
	...
	if err := validateNewCloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontOriginRequestPolicyHeadersConfigHeadersOutputReference) ToString() *string {
	var returns *string
