...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ivschannel/internal"
)
...
type IvsChannel interface {
	...
	PutTimeouts(value *IvsChannelTimeouts)
	ResetAuthorized()
	ResetId()
	ResetLatencyMode()
	ResetName()
...
func (j *jsiiProxy_IvsChannel) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IvsChannel) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IvsChannel) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_IvsChannel) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_IvsChannel) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_IvsChannel) Timeouts() IvsChannelTimeoutsOutputReference {
	var returns IvsChannelTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_IvsChannel)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (i *jsiiProxy_IvsChannel) PutTimeouts(value *IvsChannelTimeouts) {
...
func (i *jsiiProxy_IvsChannel) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IvsChannel) ResetTagsAll() {
	_jsii_.InvokeVoid(
		i,
		"resetTagsAll",
		nil, // no parameters
...
func (i *jsiiProxy_IvsChannel) ResetTimeouts() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeouts",
		nil, // no parameters
