...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/keyspaceskeyspace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/keyspaces_keyspace aws_keyspaces_keyspace}.
...
type jsiiProxy_KeyspacesKeyspace struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_KeyspacesKeyspace) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_KeyspacesKeyspace) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_KeyspacesKeyspace) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_KeyspacesKeyspace) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KeyspacesKeyspace) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_KeyspacesKeyspace) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_KeyspacesKeyspace) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_KeyspacesKeyspace) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KeyspacesKeyspace) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KeyspacesKeyspace) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_KeyspacesKeyspace) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_KeyspacesKeyspace) Node() constructs.Node {
...
func (j *jsiiProxy_KeyspacesKeyspace) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_KeyspacesKeyspace) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_KeyspacesKeyspace) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_KeyspacesKeyspace) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_KeyspacesKeyspace) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_KeyspacesKeyspace) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KeyspacesKeyspace) Timeouts() KeyspacesKeyspaceTimeoutsOutputReference {
	var returns KeyspacesKeyspaceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewKeyspacesKeyspace(scope constructs.Construct, id *string, config *KeyspacesKeyspaceConfig) KeyspacesKeyspace {
	...
	if err := validateNewKeyspacesKeyspaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func KeyspacesKeyspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKeyspacesKeyspace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyspacesKeyspace) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetStringAttribute(terraformAttribute *string) *string {
...
func (k *jsiiProxy_KeyspacesKeyspace) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (k *jsiiProxy_KeyspacesKeyspace) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyspacesKeyspace) OverrideLogicalId(newLogicalId *string) {
...
func (k *jsiiProxy_KeyspacesKeyspace) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
...
func (k *jsiiProxy_KeyspacesKeyspace) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		k,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (k *jsiiProxy_KeyspacesKeyspace) ResetTags() {
	_jsii_.InvokeVoid(
		k,
		"resetTags",
		nil, // no parameters
...
func (k *jsiiProxy_KeyspacesKeyspace) ResetTagsAll() {
	_jsii_.InvokeVoid(
		k,
		"resetTagsAll",
		nil, // no parameters
...
func (k *jsiiProxy_KeyspacesKeyspace) ResetTimeouts() {
	_jsii_.InvokeVoid(
		k,
		"resetTimeouts",
		nil, // no parameters
...
func (k *jsiiProxy_KeyspacesKeyspace) ToString() *string {
	var returns *string
