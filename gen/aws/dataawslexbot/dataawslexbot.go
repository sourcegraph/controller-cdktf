...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawslexbot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/lex_bot aws_lex_bot}.
...
func NewDataAwsLexBot(scope constructs.Construct, id *string, config *DataAwsLexBotConfig) DataAwsLexBot {
	...
	if err := validateNewDataAwsLexBotParameters(scope, id, config); err != nil {
		panic(err)
	}
