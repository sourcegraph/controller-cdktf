...
func (d *jsiiProxy_DataAwsIdentitystoreUserEmailsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsIdentitystoreUserEmailsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsIdentitystoreUserEmailsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsIdentitystoreUserEmailsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
