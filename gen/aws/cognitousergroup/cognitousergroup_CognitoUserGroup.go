...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cognitousergroup/internal"
)
...
func NewCognitoUserGroup(scope constructs.Construct, id *string, config *CognitoUserGroupConfig) CognitoUserGroup {
	...
	if err := validateNewCognitoUserGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CognitoUserGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCognitoUserGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
