...
func (j *jsiiProxy_S3BucketVersioningOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketVersioningOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketVersioningOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketVersioningOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketVersioningOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketVersioningOutputReference {
	...
	if err := validateNewS3BucketVersioningOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketVersioningOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketVersioningOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketVersioningOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketVersioningOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketVersioningOutputReference) ToString() *string {
	var returns *string
