...
func (s *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionTransitionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_S3BucketLifecycleRuleNoncurrentVersionTransitionList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*S3BucketLifecycleRuleNoncurrentVersionTransition:
		val := val.(*[]*S3BucketLifecycleRuleNoncurrentVersionTransition)
	...
	case []*S3BucketLifecycleRuleNoncurrentVersionTransition:
		val_ := val.([]*S3BucketLifecycleRuleNoncurrentVersionTransition)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*S3BucketLifecycleRuleNoncurrentVersionTransition; received %#v (a %T)", val, val)
		}
	}
