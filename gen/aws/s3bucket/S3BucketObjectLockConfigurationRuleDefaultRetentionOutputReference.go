...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleDefaultRetentionOutputReference) ToString() *string {
	var returns *string
