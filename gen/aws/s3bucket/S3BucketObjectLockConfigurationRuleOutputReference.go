...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) PutDefaultRetention(value *S3BucketObjectLockConfigurationRuleDefaultRetention) {
	if err := s.validatePutDefaultRetentionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationRuleOutputReference) ToString() *string {
	var returns *string
