...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketObjectLockConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketObjectLockConfigurationOutputReference {
	...
	if err := validateNewS3BucketObjectLockConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketObjectLockConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) ResetObjectLockEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetObjectLockEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketObjectLockConfigurationOutputReference) ToString() *string {
	var returns *string
