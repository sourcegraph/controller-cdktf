...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sagemakerhumantaskui/internal"
)
...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerHumanTaskUiUiTemplateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerHumanTaskUiUiTemplateOutputReference {
	...
	if err := validateNewSagemakerHumanTaskUiUiTemplateOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSagemakerHumanTaskUiUiTemplateOutputReference_Override(s SagemakerHumanTaskUiUiTemplateOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) ToString() *string {
	var returns *string
