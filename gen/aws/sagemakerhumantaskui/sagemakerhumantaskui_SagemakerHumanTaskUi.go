...
func (j *jsiiProxy_SagemakerHumanTaskUi) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerHumanTaskUi) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSagemakerHumanTaskUi(scope constructs.Construct, id *string, config *SagemakerHumanTaskUiConfig) SagemakerHumanTaskUi {
	...
	if err := validateNewSagemakerHumanTaskUiParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerHumanTaskUi) PutUiTemplate(value *SagemakerHumanTaskUiUiTemplate) {
	if err := s.validatePutUiTemplateParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SagemakerHumanTaskUi) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
