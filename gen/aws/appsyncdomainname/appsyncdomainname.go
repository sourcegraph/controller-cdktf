...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appsyncdomainname/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appsync_domain_name aws_appsync_domain_name}.
...
func NewAppsyncDomainName(scope constructs.Construct, id *string, config *AppsyncDomainNameConfig) AppsyncDomainName {
	...
	if err := validateNewAppsyncDomainNameParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppsyncDomainName_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppsyncDomainName_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppsyncDomainName) AddMoveTarget(moveTarget *string) {
