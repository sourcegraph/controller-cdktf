...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/configconfigurationaggregator/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/config_configuration_aggregator aws_config_configuration_aggregator}.
...
func (c *jsiiProxy_ConfigConfigurationAggregator) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfigConfigurationAggregator) PutAccountAggregationSource(value *ConfigConfigurationAggregatorAccountAggregationSource) {
	if err := c.validatePutAccountAggregationSourceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
