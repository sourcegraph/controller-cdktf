...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53resolverdnssecconfig/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_resolver_dnssec_config aws_route53_resolver_dnssec_config}.
...
func (j *jsiiProxy_Route53ResolverDnssecConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverDnssecConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53ResolverDnssecConfig(scope constructs.Construct, id *string, config *Route53ResolverDnssecConfigConfig) Route53ResolverDnssecConfig {
	...
	if err := validateNewRoute53ResolverDnssecConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53ResolverDnssecConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ResolverDnssecConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverDnssecConfig) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ResolverDnssecConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverDnssecConfig) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53ResolverDnssecConfig) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53ResolverDnssecConfig) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
