...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lakeformation_resource_lf_tags aws_lakeformation_resource_lf_tags}.
...
func NewLakeformationResourceLfTags(scope constructs.Construct, id *string, config *LakeformationResourceLfTagsConfig) LakeformationResourceLfTags {
	...
	if err := validateNewLakeformationResourceLfTagsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LakeformationResourceLfTags_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLakeformationResourceLfTags_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LakeformationResourceLfTags) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LakeformationResourceLfTags) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LakeformationResourceLfTags) MoveFromId(id *string) {
...
func (l *jsiiProxy_LakeformationResourceLfTags) MoveToId(id *string) {
