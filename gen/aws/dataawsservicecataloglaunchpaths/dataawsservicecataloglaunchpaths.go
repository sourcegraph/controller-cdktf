...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/servicecatalog_launch_paths aws_servicecatalog_launch_paths}.
type DataAwsServicecatalogLaunchPaths interface {
	...
	PutTimeouts(value *DataAwsServicecatalogLaunchPathsTimeouts)
	ResetAcceptLanguage()
	ResetId()
...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPaths) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsServicecatalogLaunchPaths) Timeouts() DataAwsServicecatalogLaunchPathsTimeoutsOutputReference {
	var returns DataAwsServicecatalogLaunchPathsTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsServicecatalogLaunchPaths(scope constructs.Construct, id *string, config *DataAwsServicecatalogLaunchPathsConfig) DataAwsServicecatalogLaunchPaths {
	...
	if err := validateNewDataAwsServicecatalogLaunchPathsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPaths) PutTimeouts(value *DataAwsServicecatalogLaunchPathsTimeouts) {
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPaths) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsServicecatalogLaunchPaths) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
