...
func NewDataAwsElasticsearchDomainNodeToNodeEncryptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElasticsearchDomainNodeToNodeEncryptionList {
	...
	if err := validateNewDataAwsElasticsearchDomainNodeToNodeEncryptionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsElasticsearchDomainNodeToNodeEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
