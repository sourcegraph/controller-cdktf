...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsservicediscoverydnsnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/service_discovery_dns_namespace aws_service_discovery_dns_namespace}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/service_discovery_dns_namespace aws_service_discovery_dns_namespace} Data Source.
func NewDataAwsServiceDiscoveryDnsNamespace(scope constructs.Construct, id *string, config *DataAwsServiceDiscoveryDnsNamespaceConfig) DataAwsServiceDiscoveryDnsNamespace {
	...
	if err := validateNewDataAwsServiceDiscoveryDnsNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServiceDiscoveryDnsNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsServiceDiscoveryDnsNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsServiceDiscoveryDnsNamespace_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsServiceDiscoveryDnsNamespace_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsServiceDiscoveryDnsNamespace_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsServiceDiscoveryDnsNamespace_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsServiceDiscoveryDnsNamespace) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsServiceDiscoveryDnsNamespace) ToHclTerraform() interface{} {
	var returns interface{}
