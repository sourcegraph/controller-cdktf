...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/secretsmanagersecretpolicy/internal"
)
...
func NewSecretsmanagerSecretPolicy(scope constructs.Construct, id *string, config *SecretsmanagerSecretPolicyConfig) SecretsmanagerSecretPolicy {
	...
	if err := validateNewSecretsmanagerSecretPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SecretsmanagerSecretPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecretsmanagerSecretPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretsmanagerSecretPolicy) MoveToId(id *string) {
