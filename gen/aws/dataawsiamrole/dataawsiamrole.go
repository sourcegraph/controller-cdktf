...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamrole/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_role aws_iam_role}.
...
func (j *jsiiProxy_DataAwsIamRole) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamRole(scope constructs.Construct, id *string, config *DataAwsIamRoleConfig) DataAwsIamRole {
	...
	if err := validateNewDataAwsIamRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsIamRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamRole_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsIamRole) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
