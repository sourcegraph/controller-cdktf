...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxtransitvirtualinterface/internal"
)
...
func NewDxTransitVirtualInterfaceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DxTransitVirtualInterfaceTimeoutsOutputReference {
	...
	if err := validateNewDxTransitVirtualInterfaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
