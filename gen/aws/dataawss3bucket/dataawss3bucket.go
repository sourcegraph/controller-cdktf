...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawss3bucket/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/s3_bucket aws_s3_bucket}.
...
func (j *jsiiProxy_DataAwsS3Bucket) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsS3Bucket) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/s3_bucket aws_s3_bucket} Data Source.
func NewDataAwsS3Bucket(scope constructs.Construct, id *string, config *DataAwsS3BucketConfig) DataAwsS3Bucket {
	_init_.Initialize()

	if err := validateNewDataAwsS3BucketParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsS3Bucket)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsS3Bucket)SetId(val *string) {
...
func DataAwsS3Bucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsS3Bucket_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsS3Bucket_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsS3Bucket_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsS3Bucket_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsS3Bucket_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsS3Bucket_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsS3Bucket_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsS3Bucket) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsS3Bucket) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsS3Bucket) ToHclTerraform() interface{} {
	var returns interface{}
