...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_rule aws_waf_rule}.
...
func (j *jsiiProxy_DataAwsWafRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_rule aws_waf_rule} Data Source.
func NewDataAwsWafRule(scope constructs.Construct, id *string, config *DataAwsWafRuleConfig) DataAwsWafRule {
	_init_.Initialize()

	if err := validateNewDataAwsWafRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsWafRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafRule)SetId(val *string) {
...
func DataAwsWafRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafRule_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafRule_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafRule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafRule) ToHclTerraform() interface{} {
	var returns interface{}
