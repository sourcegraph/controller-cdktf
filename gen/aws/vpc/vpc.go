...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpc/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc aws_vpc}.
type Vpc interface {
...
func (v *jsiiProxy_Vpc) ResetEnableClassiclinkDnsSupport() {
	_jsii_.InvokeVoid(
		v,
		"resetEnableClassiclinkDnsSupport",
		nil, // no parameters
