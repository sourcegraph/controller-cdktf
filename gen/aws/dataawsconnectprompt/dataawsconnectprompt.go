...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsconnectprompt/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_prompt aws_connect_prompt}.
...
func (j *jsiiProxy_DataAwsConnectPrompt) Count() interface{} {
...
func (j *jsiiProxy_DataAwsConnectPrompt) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectPrompt) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_prompt aws_connect_prompt} Data Source.
func NewDataAwsConnectPrompt(scope constructs.Construct, id *string, config *DataAwsConnectPromptConfig) DataAwsConnectPrompt {
	_init_.Initialize()

	if err := validateNewDataAwsConnectPromptParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsConnectPrompt)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAwsConnectPrompt)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsConnectPrompt)SetId(val *string) {
...
func DataAwsConnectPrompt_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectPrompt_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsConnectPrompt_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsConnectPrompt_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsConnectPrompt_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsConnectPrompt_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsConnectPrompt_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsConnectPrompt_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsConnectPrompt) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsConnectPrompt) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsConnectPrompt) ToHclTerraform() interface{} {
	var returns interface{}
