...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ecrlifecyclepolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_lifecycle_policy aws_ecr_lifecycle_policy}.
...
func (j *jsiiProxy_EcrLifecyclePolicy) Connection() interface{} {
...
func (j *jsiiProxy_EcrLifecyclePolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrLifecyclePolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EcrLifecyclePolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_lifecycle_policy aws_ecr_lifecycle_policy} Resource.
func NewEcrLifecyclePolicy(scope constructs.Construct, id *string, config *EcrLifecyclePolicyConfig) EcrLifecyclePolicy {
	_init_.Initialize()

	if err := validateNewEcrLifecyclePolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EcrLifecyclePolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_EcrLifecyclePolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrLifecyclePolicy)SetId(val *string) {
...
func (j *jsiiProxy_EcrLifecyclePolicy)SetProvisioners(val *[]interface{}) {
...
func EcrLifecyclePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEcrLifecyclePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EcrLifecyclePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateEcrLifecyclePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrLifecyclePolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrLifecyclePolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrLifecyclePolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrLifecyclePolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EcrLifecyclePolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrLifecyclePolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcrLifecyclePolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EcrLifecyclePolicy) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcrLifecyclePolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EcrLifecyclePolicy) MoveToId(id *string) {
...
func (e *jsiiProxy_EcrLifecyclePolicy) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EcrLifecyclePolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EcrLifecyclePolicy) ToHclTerraform() interface{} {
	var returns interface{}
