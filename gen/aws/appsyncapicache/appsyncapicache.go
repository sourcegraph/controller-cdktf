...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appsyncapicache/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appsync_api_cache aws_appsync_api_cache}.
...
func NewAppsyncApiCache(scope constructs.Construct, id *string, config *AppsyncApiCacheConfig) AppsyncApiCache {
	...
	if err := validateNewAppsyncApiCacheParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppsyncApiCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppsyncApiCache_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppsyncApiCache) AddMoveTarget(moveTarget *string) {
