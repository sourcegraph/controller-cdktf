...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) RepositoryAuthConfig() SagemakerModelContainerImageConfigRepositoryAuthConfigOutputReference {
	var returns SagemakerModelContainerImageConfigRepositoryAuthConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) RepositoryAuthConfigInput() *SagemakerModelContainerImageConfigRepositoryAuthConfig {
...
func NewSagemakerModelContainerImageConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerModelContainerImageConfigOutputReference {
	...
	if err := validateNewSagemakerModelContainerImageConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerModelContainerImageConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) PutRepositoryAuthConfig(value *SagemakerModelContainerImageConfigRepositoryAuthConfig) {
	if err := s.validatePutRepositoryAuthConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) ResetRepositoryAuthConfig() {
	_jsii_.InvokeVoid(
		s,
		"resetRepositoryAuthConfig",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerModelContainerImageConfigOutputReference) ToString() *string {
	var returns *string
