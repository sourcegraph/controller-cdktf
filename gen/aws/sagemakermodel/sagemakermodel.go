...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sagemaker_model aws_sagemaker_model}.
...
func SagemakerModel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSagemakerModel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerModel) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerModel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerModel) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerModel) MoveToId(id *string) {
