...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudwatchloggroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudwatch_log_group aws_cloudwatch_log_group}.
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudwatchLogGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsCloudwatchLogGroup(scope constructs.Construct, id *string, config *DataAwsCloudwatchLogGroupConfig) DataAwsCloudwatchLogGroup {
	...
	if err := validateNewDataAwsCloudwatchLogGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCloudwatchLogGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchLogGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCloudwatchLogGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
