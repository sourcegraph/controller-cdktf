...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsdefaulttags/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/default_tags aws_default_tags}.
...
func (j *jsiiProxy_DataAwsDefaultTags) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDefaultTags) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/default_tags aws_default_tags} Data Source.
func NewDataAwsDefaultTags(scope constructs.Construct, id *string, config *DataAwsDefaultTagsConfig) DataAwsDefaultTags {
	_init_.Initialize()

	if err := validateNewDataAwsDefaultTagsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsDefaultTags)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDefaultTags)SetId(val *string) {
...
func DataAwsDefaultTags_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsDefaultTags_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsDefaultTags_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsDefaultTags_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDefaultTags_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDefaultTags_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDefaultTags_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDefaultTags_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsDefaultTags) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDefaultTags) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDefaultTags) ToHclTerraform() interface{} {
	var returns interface{}
