...
type NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference interface {
	...
	IpSetReferencesInput() interface{}
	// Experimental.
	...
	PutIpSetReferences(value interface{})
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) IpSetReferencesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) PutIpSetReferences(value interface{}) {
...
func (n *jsiiProxy_NetworkfirewallRuleGroupRuleGroupReferenceSetsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
