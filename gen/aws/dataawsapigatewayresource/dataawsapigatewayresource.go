package dataawsapigatewayresource
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewayresource/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/api_gateway_resource aws_api_gateway_resource}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/api_gateway_resource aws_api_gateway_resource} Data Source.
func NewDataAwsApiGatewayResource(scope constructs.Construct, id *string, config *DataAwsApiGatewayResourceConfig) DataAwsApiGatewayResource {
	...
	if err := validateNewDataAwsApiGatewayResourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsApiGatewayResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsApiGatewayResource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsApiGatewayResource_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsApiGatewayResource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsApiGatewayResource) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsApiGatewayResource) ToHclTerraform() interface{} {
	var returns interface{}
