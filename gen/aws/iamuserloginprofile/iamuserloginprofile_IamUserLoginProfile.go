...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamuserloginprofile/internal"
)
...
func (j *jsiiProxy_IamUserLoginProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamUserLoginProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamUserLoginProfile) Password() *string {
	var returns *string
	_jsii_.Get(
		j,
		"password",
...
func NewIamUserLoginProfile(scope constructs.Construct, id *string, config *IamUserLoginProfileConfig) IamUserLoginProfile {
	...
	if err := validateNewIamUserLoginProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_IamUserLoginProfile{}

	_jsii_.Create(
		"aws.iamUserLoginProfile.IamUserLoginProfile",
...
func (i *jsiiProxy_IamUserLoginProfile) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamUserLoginProfile) ResetPgpKey() {
	_jsii_.InvokeVoid(
		i,
		"resetPgpKey",
		nil, // no parameters
