...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsacmpcacertificateauthority/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/acmpca_certificate_authority aws_acmpca_certificate_authority}.
...
func NewDataAwsAcmpcaCertificateAuthority(scope constructs.Construct, id *string, config *DataAwsAcmpcaCertificateAuthorityConfig) DataAwsAcmpcaCertificateAuthority {
	...
	if err := validateNewDataAwsAcmpcaCertificateAuthorityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsAcmpcaCertificateAuthority_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsAcmpcaCertificateAuthority_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
