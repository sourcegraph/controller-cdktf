...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_inventory aws_s3_bucket_inventory}.
...
func (j *jsiiProxy_S3BucketInventory) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketInventory) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3BucketInventory(scope constructs.Construct, id *string, config *S3BucketInventoryConfig) S3BucketInventory {
	...
	if err := validateNewS3BucketInventoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func S3BucketInventory_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketInventory_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketInventory) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketInventory) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketInventory) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketInventory) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketInventory) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
