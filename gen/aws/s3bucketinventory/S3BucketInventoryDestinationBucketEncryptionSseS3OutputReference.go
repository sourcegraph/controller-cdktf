...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketInventoryDestinationBucketEncryptionSseS3OutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference {
	...
	_jsii_.Create(
		"aws.s3BucketInventory.S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionSseS3OutputReference) ToString() *string {
	var returns *string
