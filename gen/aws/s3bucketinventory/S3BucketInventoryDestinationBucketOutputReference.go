...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketInventoryDestinationBucketOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketInventoryDestinationBucketOutputReference {
	...
	if err := validateNewS3BucketInventoryDestinationBucketOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketOutputReference) ToString() *string {
	var returns *string
