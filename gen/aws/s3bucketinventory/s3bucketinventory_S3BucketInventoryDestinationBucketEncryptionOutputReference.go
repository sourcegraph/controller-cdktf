...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketInventoryDestinationBucketEncryptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketInventoryDestinationBucketEncryptionOutputReference {
	...
	if err := validateNewS3BucketInventoryDestinationBucketEncryptionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference{}

	_jsii_.Create(
		"aws.s3BucketInventory.S3BucketInventoryDestinationBucketEncryptionOutputReference",
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketInventoryDestinationBucketEncryptionOutputReference) ToString() *string {
	var returns *string
