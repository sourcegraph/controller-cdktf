...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) InternalValue() *Sesv2ConfigurationSetReputationOptions {
...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) LastFreshStart() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastFreshStart",
...
func (j *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) ResetReputationMetricsEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetReputationMetricsEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2ConfigurationSetReputationOptionsOutputReference) ToString() *string {
	var returns *string
