...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/neptunecluster/internal"
)
...
func NewNeptuneClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NeptuneClusterTimeoutsOutputReference {
	...
	if err := validateNewNeptuneClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
