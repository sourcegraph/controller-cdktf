...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbclustersnapshot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_cluster_snapshot aws_db_cluster_snapshot}.
...
func (j *jsiiProxy_DbClusterSnapshot) Connection() interface{} {
...
func (j *jsiiProxy_DbClusterSnapshot) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbClusterSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbClusterSnapshot) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_DbClusterSnapshot) StorageEncrypted() cdktf.IResolvable {
...
func (j *jsiiProxy_DbClusterSnapshot) Tags() *map[string]*string {
...
func (j *jsiiProxy_DbClusterSnapshot) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DbClusterSnapshot) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DbClusterSnapshot) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DbClusterSnapshot) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_cluster_snapshot aws_db_cluster_snapshot} Resource.
func NewDbClusterSnapshot(scope constructs.Construct, id *string, config *DbClusterSnapshotConfig) DbClusterSnapshot {
	_init_.Initialize()

	if err := validateNewDbClusterSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DbClusterSnapshot{}

	_jsii_.Create(
		"@cdktf/provider-aws.dbClusterSnapshot.DbClusterSnapshot",
...
func (j *jsiiProxy_DbClusterSnapshot)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DbClusterSnapshot)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DbClusterSnapshot)SetId(val *string) {
...
func (j *jsiiProxy_DbClusterSnapshot)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_DbClusterSnapshot)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_DbClusterSnapshot)SetTagsAll(val *map[string]*string) {
...
func DbClusterSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbClusterSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DbClusterSnapshot_IsConstruct(x interface{}) *bool {
	...
	if err := validateDbClusterSnapshot_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbClusterSnapshot_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbClusterSnapshot_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DbClusterSnapshot_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDbClusterSnapshot_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DbClusterSnapshot) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbClusterSnapshot) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DbClusterSnapshot) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbClusterSnapshot) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbClusterSnapshot) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbClusterSnapshot) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbClusterSnapshot) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DbClusterSnapshot) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbClusterSnapshot) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbClusterSnapshot) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DbClusterSnapshot) MoveToId(id *string) {
...
func (d *jsiiProxy_DbClusterSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DbClusterSnapshot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DbClusterSnapshot) ToHclTerraform() interface{} {
	var returns interface{}
