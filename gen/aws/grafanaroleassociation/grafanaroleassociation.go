...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/grafana_role_association aws_grafana_role_association}.
type GrafanaRoleAssociation interface {
	...
	PutTimeouts(value *GrafanaRoleAssociationTimeouts)
	ResetGroupIds()
	ResetId()
...
type jsiiProxy_GrafanaRoleAssociation struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_GrafanaRoleAssociation) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GrafanaRoleAssociation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GrafanaRoleAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GrafanaRoleAssociation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GrafanaRoleAssociation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GrafanaRoleAssociation) GroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupIds",
...
func (j *jsiiProxy_GrafanaRoleAssociation) GroupIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupIdsInput",
...
func (j *jsiiProxy_GrafanaRoleAssociation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GrafanaRoleAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GrafanaRoleAssociation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GrafanaRoleAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_GrafanaRoleAssociation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GrafanaRoleAssociation) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_GrafanaRoleAssociation) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_GrafanaRoleAssociation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GrafanaRoleAssociation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GrafanaRoleAssociation) Timeouts() GrafanaRoleAssociationTimeoutsOutputReference {
	var returns GrafanaRoleAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GrafanaRoleAssociation) UserIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"userIds",
...
func (j *jsiiProxy_GrafanaRoleAssociation) UserIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"userIdsInput",
...
func (j *jsiiProxy_GrafanaRoleAssociation) WorkspaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceId",
...
func (j *jsiiProxy_GrafanaRoleAssociation) WorkspaceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceIdInput",
...
func NewGrafanaRoleAssociation(scope constructs.Construct, id *string, config *GrafanaRoleAssociationConfig) GrafanaRoleAssociation {
	...
	if err := validateNewGrafanaRoleAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GrafanaRoleAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGrafanaRoleAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GrafanaRoleAssociation) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GrafanaRoleAssociation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GrafanaRoleAssociation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GrafanaRoleAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GrafanaRoleAssociation) PutTimeouts(value *GrafanaRoleAssociationTimeouts) {
...
func (g *jsiiProxy_GrafanaRoleAssociation) ResetGroupIds() {
	_jsii_.InvokeVoid(
		g,
		"resetGroupIds",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaRoleAssociation) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaRoleAssociation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaRoleAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaRoleAssociation) ResetUserIds() {
	_jsii_.InvokeVoid(
		g,
		"resetUserIds",
		nil, // no parameters
...
func (g *jsiiProxy_GrafanaRoleAssociation) ToString() *string {
	var returns *string
