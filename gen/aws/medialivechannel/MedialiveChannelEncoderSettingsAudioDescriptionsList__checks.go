...
func (m *jsiiProxy_MedialiveChannelEncoderSettingsAudioDescriptionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (m *jsiiProxy_MedialiveChannelEncoderSettingsAudioDescriptionsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_MedialiveChannelEncoderSettingsAudioDescriptionsList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*MedialiveChannelEncoderSettingsAudioDescriptions:
		val_ := val.([]*MedialiveChannelEncoderSettingsAudioDescriptions)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_MedialiveChannelEncoderSettingsAudioDescriptionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_MedialiveChannelEncoderSettingsAudioDescriptionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
