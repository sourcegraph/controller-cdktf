...
func NewCloudtrailEventDataStoreAdvancedEventSelectorFieldSelectorList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CloudtrailEventDataStoreAdvancedEventSelectorFieldSelectorList {
	...
	if err := validateNewCloudtrailEventDataStoreAdvancedEventSelectorFieldSelectorListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudtrailEventDataStoreAdvancedEventSelectorFieldSelectorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
