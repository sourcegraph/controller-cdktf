...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafwebacl/internal"
)
...
func (j *jsiiProxy_DataAwsWafWebAcl) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafWebAcl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsWafWebAcl(scope constructs.Construct, id *string, config *DataAwsWafWebAclConfig) DataAwsWafWebAcl {
	...
	if err := validateNewDataAwsWafWebAclParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsWafWebAcl{}

	_jsii_.Create(
		"aws.dataAwsWafWebAcl.DataAwsWafWebAcl",
...
func (j *jsiiProxy_DataAwsWafWebAcl)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafWebAcl)SetId(val *string) {
...
func DataAwsWafWebAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafWebAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafWebAcl) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
