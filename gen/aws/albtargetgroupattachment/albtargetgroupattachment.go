...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/albtargetgroupattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_target_group_attachment aws_alb_target_group_attachment}.
...
func (j *jsiiProxy_AlbTargetGroupAttachment) Connection() interface{} {
...
func (j *jsiiProxy_AlbTargetGroupAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AlbTargetGroupAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AlbTargetGroupAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/alb_target_group_attachment aws_alb_target_group_attachment} Resource.
func NewAlbTargetGroupAttachment(scope constructs.Construct, id *string, config *AlbTargetGroupAttachmentConfig) AlbTargetGroupAttachment {
	...
	if err := validateNewAlbTargetGroupAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AlbTargetGroupAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_AlbTargetGroupAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AlbTargetGroupAttachment)SetId(val *string) {
...
func (j *jsiiProxy_AlbTargetGroupAttachment)SetProvisioners(val *[]interface{}) {
...
func AlbTargetGroupAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAlbTargetGroupAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AlbTargetGroupAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateAlbTargetGroupAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AlbTargetGroupAttachment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AlbTargetGroupAttachment) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AlbTargetGroupAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AlbTargetGroupAttachment) ToHclTerraform() interface{} {
	var returns interface{}
