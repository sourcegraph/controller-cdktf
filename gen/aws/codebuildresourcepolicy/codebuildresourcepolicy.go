...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/codebuildresourcepolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codebuild_resource_policy aws_codebuild_resource_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codebuild_resource_policy aws_codebuild_resource_policy} Resource.
func NewCodebuildResourcePolicy(scope constructs.Construct, id *string, config *CodebuildResourcePolicyConfig) CodebuildResourcePolicy {
	...
	if err := validateNewCodebuildResourcePolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodebuildResourcePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodebuildResourcePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CodebuildResourcePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCodebuildResourcePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodebuildResourcePolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodebuildResourcePolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CodebuildResourcePolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCodebuildResourcePolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CodebuildResourcePolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CodebuildResourcePolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) MoveToId(id *string) {
...
func (c *jsiiProxy_CodebuildResourcePolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CodebuildResourcePolicy) ToHclTerraform() interface{} {
	var returns interface{}
