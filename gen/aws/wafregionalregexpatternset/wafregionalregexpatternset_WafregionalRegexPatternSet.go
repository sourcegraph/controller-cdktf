...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalregexpatternset/internal"
)
...
func NewWafregionalRegexPatternSet(scope constructs.Construct, id *string, config *WafregionalRegexPatternSetConfig) WafregionalRegexPatternSet {
	...
	if err := validateNewWafregionalRegexPatternSetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_WafregionalRegexPatternSet{}

	_jsii_.Create(
		"aws.wafregionalRegexPatternSet.WafregionalRegexPatternSet",
...
func WafregionalRegexPatternSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalRegexPatternSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
