...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_connection aws_glue_connection}.
...
func (j *jsiiProxy_GlueConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GlueConnection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewGlueConnection(scope constructs.Construct, id *string, config *GlueConnectionConfig) GlueConnection {
	...
	if err := validateNewGlueConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GlueConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueConnection) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueConnection) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueConnection) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueConnection) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
