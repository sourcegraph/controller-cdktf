...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticacheparametergroup/internal"
)
...
func NewElasticacheParameterGroupParameterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ElasticacheParameterGroupParameterOutputReference {
	...
	if err := validateNewElasticacheParameterGroupParameterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
