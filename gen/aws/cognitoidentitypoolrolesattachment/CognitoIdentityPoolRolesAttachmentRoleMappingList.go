...
func NewCognitoIdentityPoolRolesAttachmentRoleMappingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitoIdentityPoolRolesAttachmentRoleMappingList {
	...
	if err := validateNewCognitoIdentityPoolRolesAttachmentRoleMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitoIdentityPoolRolesAttachmentRoleMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
