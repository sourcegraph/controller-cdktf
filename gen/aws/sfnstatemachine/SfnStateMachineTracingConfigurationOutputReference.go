...
func (j *jsiiProxy_SfnStateMachineTracingConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SfnStateMachineTracingConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SfnStateMachineTracingConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSfnStateMachineTracingConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SfnStateMachineTracingConfigurationOutputReference {
	...
	if err := validateNewSfnStateMachineTracingConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SfnStateMachineTracingConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SfnStateMachineTracingConfigurationOutputReference) ToString() *string {
	var returns *string
