...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/devicefarmupload/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/devicefarm_upload aws_devicefarm_upload}.
...
func NewDevicefarmUpload(scope constructs.Construct, id *string, config *DevicefarmUploadConfig) DevicefarmUpload {
	...
	if err := validateNewDevicefarmUploadParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DevicefarmUpload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDevicefarmUpload_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevicefarmUpload) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DevicefarmUpload) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DevicefarmUpload) MoveFromId(id *string) {
...
func (d *jsiiProxy_DevicefarmUpload) MoveToId(id *string) {
