...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/connectqueue/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_queue aws_connect_queue}.
...
func (j *jsiiProxy_ConnectQueue) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectQueue) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewConnectQueue(scope constructs.Construct, id *string, config *ConnectQueueConfig) ConnectQueue {
	...
	if err := validateNewConnectQueueParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConnectQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConnectQueue_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectQueue) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectQueue) PutOutboundCallerConfig(value *ConnectQueueOutboundCallerConfig) {
	if err := c.validatePutOutboundCallerConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConnectQueue) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
