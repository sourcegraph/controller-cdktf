...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticbeanstalkconfigurationtemplate/internal"
)
...
func NewElasticBeanstalkConfigurationTemplateSettingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ElasticBeanstalkConfigurationTemplateSettingOutputReference {
	...
	if err := validateNewElasticBeanstalkConfigurationTemplateSettingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ElasticBeanstalkConfigurationTemplateSettingOutputReference{}

	_jsii_.Create(
		"aws.elasticBeanstalkConfigurationTemplate.ElasticBeanstalkConfigurationTemplateSettingOutputReference",
