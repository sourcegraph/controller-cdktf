...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatchlogstream/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_log_stream aws_cloudwatch_log_stream}.
...
func (j *jsiiProxy_CloudwatchLogStream) Connection() interface{} {
...
func (j *jsiiProxy_CloudwatchLogStream) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchLogStream) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudwatchLogStream) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_log_stream aws_cloudwatch_log_stream} Resource.
func NewCloudwatchLogStream(scope constructs.Construct, id *string, config *CloudwatchLogStreamConfig) CloudwatchLogStream {
	_init_.Initialize()

	if err := validateNewCloudwatchLogStreamParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudwatchLogStream)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CloudwatchLogStream)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudwatchLogStream)SetId(val *string) {
...
func (j *jsiiProxy_CloudwatchLogStream)SetProvisioners(val *[]interface{}) {
...
func CloudwatchLogStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchLogStream_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudwatchLogStream_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudwatchLogStream_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchLogStream_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchLogStream_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudwatchLogStream_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudwatchLogStream_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudwatchLogStream) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchLogStream) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudwatchLogStream) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudwatchLogStream) ToHclTerraform() interface{} {
	var returns interface{}
