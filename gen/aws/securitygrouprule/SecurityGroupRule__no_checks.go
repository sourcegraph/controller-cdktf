...
func (j *jsiiProxy_SecurityGroupRule) validateSetCidrBlocksParameters(val *[]*string) error {
	return nil
}
...
func (j *jsiiProxy_SecurityGroupRule) validateSetFromPortParameters(val *float64) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetIpv6CidrBlocksParameters(val *[]*string) error {
	return nil
}
...
func (j *jsiiProxy_SecurityGroupRule) validateSetPrefixListIdsParameters(val *[]*string) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetProtocolParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_SecurityGroupRule) validateSetSelfAttributeParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetSourceSecurityGroupIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetToPortParameters(val *float64) error {
	return nil
}

func (j *jsiiProxy_SecurityGroupRule) validateSetTypeParameters(val *string) error {
	return nil
}
