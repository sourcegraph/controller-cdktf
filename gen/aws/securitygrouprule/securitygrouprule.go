...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/securitygrouprule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/security_group_rule aws_security_group_rule}.
...
func (j *jsiiProxy_SecurityGroupRule) CidrBlocks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"cidrBlocks",
...
func (j *jsiiProxy_SecurityGroupRule) CidrBlocksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"cidrBlocksInput",
...
func (j *jsiiProxy_SecurityGroupRule) FromPort() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"fromPort",
...
func (j *jsiiProxy_SecurityGroupRule) FromPortInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"fromPortInput",
...
func (j *jsiiProxy_SecurityGroupRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityGroupRule) Ipv6CidrBlocks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipv6CidrBlocks",
...
func (j *jsiiProxy_SecurityGroupRule) Ipv6CidrBlocksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipv6CidrBlocksInput",
...
func (j *jsiiProxy_SecurityGroupRule) PrefixListIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"prefixListIds",
...
func (j *jsiiProxy_SecurityGroupRule) PrefixListIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"prefixListIdsInput",
...
func (j *jsiiProxy_SecurityGroupRule) Protocol() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protocol",
...
func (j *jsiiProxy_SecurityGroupRule) ProtocolInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protocolInput",
...
func (j *jsiiProxy_SecurityGroupRule) SourceSecurityGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityGroupRule) SourceSecurityGroupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityGroupRule) ToPort() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"toPort",
...
func (j *jsiiProxy_SecurityGroupRule) ToPortInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"toPortInput",
...
func (j *jsiiProxy_SecurityGroupRule) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_SecurityGroupRule) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (s *jsiiProxy_SecurityGroupRule) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroupRule) ResetIpv6CidrBlocks() {
	_jsii_.InvokeVoid(
		s,
		"resetIpv6CidrBlocks",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroupRule) ResetPrefixListIds() {
	_jsii_.InvokeVoid(
		s,
		"resetPrefixListIds",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroupRule) ResetSelfAttribute() {
	_jsii_.InvokeVoid(
		s,
		"resetSelfAttribute",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroupRule) ResetSourceSecurityGroupId() {
	_jsii_.InvokeVoid(
		s,
		"resetSourceSecurityGroupId",
		nil, // no parameters
