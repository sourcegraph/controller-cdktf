...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53delegationset/internal"
)
...
func (j *jsiiProxy_Route53DelegationSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53DelegationSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53DelegationSet(scope constructs.Construct, id *string, config *Route53DelegationSetConfig) Route53DelegationSet {
	...
	if err := validateNewRoute53DelegationSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53DelegationSet) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
