...
type DataAwsImagebuilderImageRecipe interface {
	...
	SetArn(val *string)
	ArnInput() *string
	BlockDeviceMapping() DataAwsImagebuilderImageRecipeBlockDeviceMappingList
	// Experimental.
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) BlockDeviceMapping() DataAwsImagebuilderImageRecipeBlockDeviceMappingList {
	var returns DataAwsImagebuilderImageRecipeBlockDeviceMappingList
	_jsii_.Get(
		j,
		"blockDeviceMapping",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) Component() DataAwsImagebuilderImageRecipeComponentList {
	var returns DataAwsImagebuilderImageRecipeComponentList
	_jsii_.Get(
		j,
		"component",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsImagebuilderImageRecipe) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsImagebuilderImageRecipe(scope constructs.Construct, id *string, config *DataAwsImagebuilderImageRecipeConfig) DataAwsImagebuilderImageRecipe {
	...
	if err := validateNewDataAwsImagebuilderImageRecipeParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsImagebuilderImageRecipe{}

	_jsii_.Create(
		"aws.dataAwsImagebuilderImageRecipe.DataAwsImagebuilderImageRecipe",
...
func (d *jsiiProxy_DataAwsImagebuilderImageRecipe) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
