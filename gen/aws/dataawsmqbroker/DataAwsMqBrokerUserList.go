...
func NewDataAwsMqBrokerUserList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsMqBrokerUserList {
	...
	if err := validateNewDataAwsMqBrokerUserListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsMqBrokerUserList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
