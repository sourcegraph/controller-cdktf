...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsorganizationsdelegatedservices/internal"
)
...
func NewDataAwsOrganizationsDelegatedServicesDelegatedServicesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsOrganizationsDelegatedServicesDelegatedServicesList {
	...
	if err := validateNewDataAwsOrganizationsDelegatedServicesDelegatedServicesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsOrganizationsDelegatedServicesDelegatedServicesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
