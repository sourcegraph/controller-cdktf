...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/efs_access_point aws_efs_access_point}.
...
func (j *jsiiProxy_EfsAccessPoint) Connection() interface{} {
...
func (j *jsiiProxy_EfsAccessPoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EfsAccessPoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EfsAccessPoint) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/efs_access_point aws_efs_access_point} Resource.
func NewEfsAccessPoint(scope constructs.Construct, id *string, config *EfsAccessPointConfig) EfsAccessPoint {
	_init_.Initialize()

	if err := validateNewEfsAccessPointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EfsAccessPoint)SetConnection(val interface{}) {
...
func (j *jsiiProxy_EfsAccessPoint)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EfsAccessPoint)SetId(val *string) {
...
func (j *jsiiProxy_EfsAccessPoint)SetProvisioners(val *[]interface{}) {
...
func EfsAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateEfsAccessPoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EfsAccessPoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateEfsAccessPoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func EfsAccessPoint_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateEfsAccessPoint_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func EfsAccessPoint_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateEfsAccessPoint_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EfsAccessPoint) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EfsAccessPoint) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EfsAccessPoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EfsAccessPoint) MoveFromId(id *string) {
...
func (e *jsiiProxy_EfsAccessPoint) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EfsAccessPoint) MoveToId(id *string) {
...
func (e *jsiiProxy_EfsAccessPoint) PutPosixUser(value *EfsAccessPointPosixUser) {
	if err := e.validatePutPosixUserParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EfsAccessPoint) PutRootDirectory(value *EfsAccessPointRootDirectory) {
	if err := e.validatePutRootDirectoryParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EfsAccessPoint) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EfsAccessPoint) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EfsAccessPoint) ToHclTerraform() interface{} {
	var returns interface{}
