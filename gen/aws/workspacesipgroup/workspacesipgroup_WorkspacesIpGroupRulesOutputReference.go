...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/workspacesipgroup/internal"
)
...
func NewWorkspacesIpGroupRulesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkspacesIpGroupRulesOutputReference {
	...
	if err := validateNewWorkspacesIpGroupRulesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
