...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/globalacceleratorlistener/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/globalaccelerator_listener aws_globalaccelerator_listener}.
...
func NewGlobalacceleratorListener(scope constructs.Construct, id *string, config *GlobalacceleratorListenerConfig) GlobalacceleratorListener {
	...
	if err := validateNewGlobalacceleratorListenerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GlobalacceleratorListener_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlobalacceleratorListener_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlobalacceleratorListener) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlobalacceleratorListener) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlobalacceleratorListener) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlobalacceleratorListener) MoveToId(id *string) {
