...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsdxlocations/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/dx_locations aws_dx_locations}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/dx_locations aws_dx_locations} Data Source.
func NewDataAwsDxLocations(scope constructs.Construct, id *string, config *DataAwsDxLocationsConfig) DataAwsDxLocations {
	_init_.Initialize()

	if err := validateNewDataAwsDxLocationsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsDxLocations_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsDxLocations_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsDxLocations_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsDxLocations_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxLocations_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxLocations_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxLocations_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxLocations_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsDxLocations) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDxLocations) ToHclTerraform() interface{} {
	var returns interface{}
