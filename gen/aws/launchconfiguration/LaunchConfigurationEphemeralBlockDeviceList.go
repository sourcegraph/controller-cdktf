...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/launchconfiguration/internal"
)
...
func NewLaunchConfigurationEphemeralBlockDeviceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LaunchConfigurationEphemeralBlockDeviceList {
	...
	if err := validateNewLaunchConfigurationEphemeralBlockDeviceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LaunchConfigurationEphemeralBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
