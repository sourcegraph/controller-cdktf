...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawslakeformationdatalakesettings/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/lakeformation_data_lake_settings aws_lakeformation_data_lake_settings}.
...
func NewDataAwsLakeformationDataLakeSettings(scope constructs.Construct, id *string, config *DataAwsLakeformationDataLakeSettingsConfig) DataAwsLakeformationDataLakeSettings {
	...
	if err := validateNewDataAwsLakeformationDataLakeSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
