...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudwatcheventconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudwatch_event_connection aws_cloudwatch_event_connection}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudwatch_event_connection aws_cloudwatch_event_connection} Data Source.
func NewDataAwsCloudwatchEventConnection(scope constructs.Construct, id *string, config *DataAwsCloudwatchEventConnectionConfig) DataAwsCloudwatchEventConnection {
	...
	if err := validateNewDataAwsCloudwatchEventConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCloudwatchEventConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsCloudwatchEventConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCloudwatchEventConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudwatchEventConnection_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventConnection_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudwatchEventConnection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventConnection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCloudwatchEventConnection) ToHclTerraform() interface{} {
	var returns interface{}
