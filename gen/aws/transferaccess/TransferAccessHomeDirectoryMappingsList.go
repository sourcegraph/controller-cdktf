...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/transferaccess/internal"
)
...
func NewTransferAccessHomeDirectoryMappingsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferAccessHomeDirectoryMappingsList {
	...
	if err := validateNewTransferAccessHomeDirectoryMappingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TransferAccessHomeDirectoryMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
