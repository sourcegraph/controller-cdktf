...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesv2emailidentityfeedbackattributes/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sesv2_email_identity_feedback_attributes aws_sesv2_email_identity_feedback_attributes}.
...
type jsiiProxy_Sesv2EmailIdentityFeedbackAttributes struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) EmailIdentity() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailIdentity",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) EmailIdentityInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailIdentityInput",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) Node() constructs.Node {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewSesv2EmailIdentityFeedbackAttributes(scope constructs.Construct, id *string, config *Sesv2EmailIdentityFeedbackAttributesConfig) Sesv2EmailIdentityFeedbackAttributes {
	...
	if err := validateNewSesv2EmailIdentityFeedbackAttributesParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Sesv2EmailIdentityFeedbackAttributes{}
...
func Sesv2EmailIdentityFeedbackAttributes_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesv2EmailIdentityFeedbackAttributes_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Sesv2EmailIdentityFeedbackAttributes_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.sesv2EmailIdentityFeedbackAttributes.Sesv2EmailIdentityFeedbackAttributes",
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) MoveFromId(id *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) MoveToId(id *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ResetEmailForwardingEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetEmailForwardingEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_Sesv2EmailIdentityFeedbackAttributes) ToString() *string {
	var returns *string
