...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/memorydbsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/memorydb_subnet_group aws_memorydb_subnet_group}.
...
func (j *jsiiProxy_MemorydbSubnetGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbSubnetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewMemorydbSubnetGroup(scope constructs.Construct, id *string, config *MemorydbSubnetGroupConfig) MemorydbSubnetGroup {
	...
	if err := validateNewMemorydbSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MemorydbSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMemorydbSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MemorydbSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MemorydbSubnetGroup) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
