...
func (d *jsiiProxy_DataAwsEc2TransitGatewayRouteTableFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayRouteTableFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DataAwsEc2TransitGatewayRouteTableFilter:
		val := val.(*[]*DataAwsEc2TransitGatewayRouteTableFilter)
	...
	case []*DataAwsEc2TransitGatewayRouteTableFilter:
		val_ := val.([]*DataAwsEc2TransitGatewayRouteTableFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsEc2TransitGatewayRouteTableFilter; received %#v (a %T)", val, val)
		}
	}
