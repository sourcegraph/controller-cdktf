...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/directoryserviceregion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/directory_service_region aws_directory_service_region}.
...
func NewDirectoryServiceRegion(scope constructs.Construct, id *string, config *DirectoryServiceRegionConfig) DirectoryServiceRegion {
	...
	if err := validateNewDirectoryServiceRegionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DirectoryServiceRegion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectoryServiceRegion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectoryServiceRegion) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectoryServiceRegion) PutVpcSettings(value *DirectoryServiceRegionVpcSettings) {
	if err := d.validatePutVpcSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
