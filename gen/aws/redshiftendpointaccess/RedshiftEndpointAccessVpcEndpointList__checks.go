...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
