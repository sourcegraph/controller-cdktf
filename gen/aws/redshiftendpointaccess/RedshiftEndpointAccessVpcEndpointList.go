...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftendpointaccess/internal"
)
...
func NewRedshiftEndpointAccessVpcEndpointList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftEndpointAccessVpcEndpointList {
	...
	if err := validateNewRedshiftEndpointAccessVpcEndpointListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftEndpointAccessVpcEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
