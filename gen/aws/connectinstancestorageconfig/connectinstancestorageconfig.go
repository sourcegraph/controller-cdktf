...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_instance_storage_config aws_connect_instance_storage_config}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_instance_storage_config aws_connect_instance_storage_config} Resource.
...
func (c *jsiiProxy_ConnectInstanceStorageConfig) PutStorageConfig(value *ConnectInstanceStorageConfigStorageConfig) {
	if err := c.validatePutStorageConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
