...
func (j *jsiiProxy_NetworkfirewallFirewallSubnetMappingList) validateSetInternalValueParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_NetworkfirewallFirewallSubnetMappingList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_NetworkfirewallFirewallSubnetMappingList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
