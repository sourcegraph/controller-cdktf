...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/gameliftgamesessionqueue/internal"
)
...
func NewGameliftGameSessionQueuePlayerLatencyPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GameliftGameSessionQueuePlayerLatencyPolicyList {
	...
	if err := validateNewGameliftGameSessionQueuePlayerLatencyPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GameliftGameSessionQueuePlayerLatencyPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
