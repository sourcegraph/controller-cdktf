...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/configdeliverychannel/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/config_delivery_channel aws_config_delivery_channel}.
...
func ConfigDeliveryChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigDeliveryChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigDeliveryChannel) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigDeliveryChannel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigDeliveryChannel) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigDeliveryChannel) MoveToId(id *string) {
