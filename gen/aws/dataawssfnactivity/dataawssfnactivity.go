...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssfnactivity/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/sfn_activity aws_sfn_activity}.
...
func (j *jsiiProxy_DataAwsSfnActivity) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsSfnActivity) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSfnActivity) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsSfnActivity(scope constructs.Construct, id *string, config *DataAwsSfnActivityConfig) DataAwsSfnActivity {
	...
	if err := validateNewDataAwsSfnActivityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsSfnActivity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSfnActivity_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSfnActivity) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSfnActivity) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
