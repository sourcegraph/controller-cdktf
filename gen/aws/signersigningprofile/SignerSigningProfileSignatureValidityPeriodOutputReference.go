...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SignerSigningProfileSignatureValidityPeriodOutputReference) ToString() *string {
	var returns *string
