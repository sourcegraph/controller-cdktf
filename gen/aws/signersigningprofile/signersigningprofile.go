...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/signer_signing_profile aws_signer_signing_profile}.
...
func (j *jsiiProxy_SignerSigningProfile) Connection() interface{} {
...
func (j *jsiiProxy_SignerSigningProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SignerSigningProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SignerSigningProfile) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SignerSigningProfile) RevocationRecord() SignerSigningProfileRevocationRecordList {
	var returns SignerSigningProfileRevocationRecordList
	_jsii_.Get(
		j,
		"revocationRecord",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/signer_signing_profile aws_signer_signing_profile} Resource.
func NewSignerSigningProfile(scope constructs.Construct, id *string, config *SignerSigningProfileConfig) SignerSigningProfile {
	_init_.Initialize()

	if err := validateNewSignerSigningProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SignerSigningProfile)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SignerSigningProfile)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SignerSigningProfile)SetId(val *string) {
...
func (j *jsiiProxy_SignerSigningProfile)SetProvisioners(val *[]interface{}) {
...
func SignerSigningProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSignerSigningProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SignerSigningProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateSignerSigningProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SignerSigningProfile) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SignerSigningProfile) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SignerSigningProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SignerSigningProfile) MoveFromId(id *string) {
...
func (s *jsiiProxy_SignerSigningProfile) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SignerSigningProfile) MoveToId(id *string) {
...
func (s *jsiiProxy_SignerSigningProfile) PutSignatureValidityPeriod(value *SignerSigningProfileSignatureValidityPeriod) {
	if err := s.validatePutSignatureValidityPeriodParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SignerSigningProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SignerSigningProfile) ToHclTerraform() interface{} {
	var returns interface{}
