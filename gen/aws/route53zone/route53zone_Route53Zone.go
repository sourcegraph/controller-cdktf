...
func (j *jsiiProxy_Route53Zone) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53Zone) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53Zone(scope constructs.Construct, id *string, config *Route53ZoneConfig) Route53Zone {
	...
	if err := validateNewRoute53ZoneParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53Zone) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
