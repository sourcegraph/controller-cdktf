...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewImagebuilderImageTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ImagebuilderImageTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewImagebuilderImageTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewImagebuilderImageTimeoutsOutputReference_Override(i ImagebuilderImageTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ImagebuilderImageTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_ImagebuilderImageTimeoutsOutputReference) ToString() *string {
	var returns *string
