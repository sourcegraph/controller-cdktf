...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_event_destination aws_ses_event_destination}.
...
func SesEventDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesEventDestination_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesEventDestination) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesEventDestination) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SesEventDestination) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesEventDestination) MoveToId(id *string) {
