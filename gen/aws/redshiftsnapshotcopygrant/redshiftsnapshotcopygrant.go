...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftsnapshotcopygrant/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshift_snapshot_copy_grant aws_redshift_snapshot_copy_grant}.
...
func NewRedshiftSnapshotCopyGrant(scope constructs.Construct, id *string, config *RedshiftSnapshotCopyGrantConfig) RedshiftSnapshotCopyGrant {
	...
	if err := validateNewRedshiftSnapshotCopyGrantParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftSnapshotCopyGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftSnapshotCopyGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) AddMoveTarget(moveTarget *string) {
