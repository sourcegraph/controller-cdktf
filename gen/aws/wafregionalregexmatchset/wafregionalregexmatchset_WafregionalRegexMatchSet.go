...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalregexmatchset/internal"
)
...
func NewWafregionalRegexMatchSet(scope constructs.Construct, id *string, config *WafregionalRegexMatchSetConfig) WafregionalRegexMatchSet {
	...
	if err := validateNewWafregionalRegexMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_WafregionalRegexMatchSet{}

	_jsii_.Create(
		"aws.wafregionalRegexMatchSet.WafregionalRegexMatchSet",
