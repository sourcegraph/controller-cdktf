...
type jsiiProxy_DataAwsAmiIds struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataAwsAmiIds) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsAmiIds) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataAwsAmiIds) ExecutableUsers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"executableUsers",
...
func (j *jsiiProxy_DataAwsAmiIds) ExecutableUsersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAmiIds) Filter() DataAwsAmiIdsFilterList {
	var returns DataAwsAmiIdsFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsAmiIds) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAmiIds) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAwsAmiIds) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataAwsAmiIds) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataAwsAmiIds) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsAmiIds) Ids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ids",
...
func (j *jsiiProxy_DataAwsAmiIds) NameRegex() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameRegex",
...
func (j *jsiiProxy_DataAwsAmiIds) NameRegexInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameRegexInput",
...
func (j *jsiiProxy_DataAwsAmiIds) Node() constructs.Node {
...
func (j *jsiiProxy_DataAwsAmiIds) Owners() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"owners",
...
func (j *jsiiProxy_DataAwsAmiIds) OwnersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ownersInput",
...
func (j *jsiiProxy_DataAwsAmiIds) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAmiIds) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsAmiIds) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAmiIds) Timeouts() DataAwsAmiIdsTimeoutsOutputReference {
	var returns DataAwsAmiIdsTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsAmiIds(scope constructs.Construct, id *string, config *DataAwsAmiIdsConfig) DataAwsAmiIds {
	...
	if err := validateNewDataAwsAmiIdsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsAmiIds_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.dataAwsAmiIds.DataAwsAmiIds",
...
func (d *jsiiProxy_DataAwsAmiIds) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAmiIds) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsAmiIds) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataAwsAmiIds) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataAwsAmiIds) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsAmiIds) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsAmiIds) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataAwsAmiIds) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsAmiIds) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAmiIds) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataAwsAmiIds) PutTimeouts(value *DataAwsAmiIdsTimeouts) {
...
func (d *jsiiProxy_DataAwsAmiIds) ResetExecutableUsers() {
	_jsii_.InvokeVoid(
		d,
		"resetExecutableUsers",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetFilter() {
	_jsii_.InvokeVoid(
		d,
		"resetFilter",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetNameRegex() {
	_jsii_.InvokeVoid(
		d,
		"resetNameRegex",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetSortAscending() {
	_jsii_.InvokeVoid(
		d,
		"resetSortAscending",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAmiIds) ToString() *string {
	var returns *string
