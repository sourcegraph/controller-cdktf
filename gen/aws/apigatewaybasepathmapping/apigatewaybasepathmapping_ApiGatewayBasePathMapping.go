...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaybasepathmapping/internal"
)
...
func NewApiGatewayBasePathMapping(scope constructs.Construct, id *string, config *ApiGatewayBasePathMappingConfig) ApiGatewayBasePathMapping {
	...
	if err := validateNewApiGatewayBasePathMappingParameters(scope, id, config); err != nil {
		panic(err)
	}
