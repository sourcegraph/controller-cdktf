...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/datasynclocationobjectstorage/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datasync_location_object_storage aws_datasync_location_object_storage}.
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Tags() *map[string]*string {
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DatasyncLocationObjectStorage) Uri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uri",
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationObjectStorage) ResetTagsAll() {
	_jsii_.InvokeVoid(
		d,
		"resetTagsAll",
		nil, // no parameters
