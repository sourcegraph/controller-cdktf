...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsapigatewayv2api/internal"
)
...
func NewDataAwsApigatewayv2Api(scope constructs.Construct, id *string, config *DataAwsApigatewayv2ApiConfig) DataAwsApigatewayv2Api {
	...
	if err := validateNewDataAwsApigatewayv2ApiParameters(scope, id, config); err != nil {
		panic(err)
	}
