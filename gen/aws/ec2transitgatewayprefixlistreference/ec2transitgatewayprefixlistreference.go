...
func Ec2TransitGatewayPrefixListReference_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2TransitGatewayPrefixListReference_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) MoveFromId(id *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayPrefixListReference) MoveToId(id *string) {
