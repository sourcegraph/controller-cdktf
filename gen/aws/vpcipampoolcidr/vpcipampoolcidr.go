...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpcipampoolcidr/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_ipam_pool_cidr aws_vpc_ipam_pool_cidr}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_ipam_pool_cidr aws_vpc_ipam_pool_cidr} Resource.
...
func VpcIpamPoolCidr_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcIpamPoolCidr_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpcIpamPoolCidr) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpcIpamPoolCidr) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcIpamPoolCidr) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpcIpamPoolCidr) ToHclTerraform() interface{} {
	var returns interface{}
