...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) InternalValue() interface{} {
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) Get(index *float64) AlbListenerDefaultActionForwardTargetGroupOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns AlbListenerDefaultActionForwardTargetGroupOutputReference
...
func (a *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AlbListenerDefaultActionForwardTargetGroupList) ToString() *string {
	var returns *string
