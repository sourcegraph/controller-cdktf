...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticachecluster/internal"
)
...
func NewElasticacheClusterLogDeliveryConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticacheClusterLogDeliveryConfigurationList {
	...
	if err := validateNewElasticacheClusterLogDeliveryConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticacheClusterLogDeliveryConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
