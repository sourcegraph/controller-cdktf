...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftserverlesssnapshot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshiftserverless_snapshot aws_redshiftserverless_snapshot}.
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) AccountsWithRestoreAccess() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) AdminUsername() *string {
	var returns *string
	_jsii_.Get(
		j,
		"adminUsername",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) NamespaceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceArn",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) NamespaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceName",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) NamespaceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespaceNameInput",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) Node() constructs.Node {
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) OwnerAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerAccount",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) RetentionPeriod() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"retentionPeriod",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) RetentionPeriodInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) SnapshotName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotName",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) SnapshotNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotNameInput",
...
func (j *jsiiProxy_RedshiftserverlessSnapshot) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewRedshiftserverlessSnapshot(scope constructs.Construct, id *string, config *RedshiftserverlessSnapshotConfig) RedshiftserverlessSnapshot {
	...
	if err := validateNewRedshiftserverlessSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftserverlessSnapshot_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.redshiftserverlessSnapshot.RedshiftserverlessSnapshot",
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ResetRetentionPeriod() {
	_jsii_.InvokeVoid(
		r,
		"resetRetentionPeriod",
		nil, // no parameters
...
func (r *jsiiProxy_RedshiftserverlessSnapshot) ToString() *string {
	var returns *string
