...
func NewTransferWorkflowOnExceptionStepsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowOnExceptionStepsList {
	...
	if err := validateNewTransferWorkflowOnExceptionStepsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
