...
func (t *jsiiProxy_TransferWorkflowStepsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (t *jsiiProxy_TransferWorkflowStepsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *TransferWorkflowSteps:
		val := val.(*TransferWorkflowSteps)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case TransferWorkflowSteps:
		val_ := val.(TransferWorkflowSteps)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *TransferWorkflowSteps; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_TransferWorkflowStepsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewTransferWorkflowStepsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
