...
func NewTransferWorkflowStepsTagStepDetailsTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowStepsTagStepDetailsTagsList {
	...
	if err := validateNewTransferWorkflowStepsTagStepDetailsTagsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TransferWorkflowStepsTagStepDetailsTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
