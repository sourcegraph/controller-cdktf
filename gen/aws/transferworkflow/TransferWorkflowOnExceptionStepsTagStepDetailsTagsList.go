...
func NewTransferWorkflowOnExceptionStepsTagStepDetailsTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TransferWorkflowOnExceptionStepsTagStepDetailsTagsList {
	...
	if err := validateNewTransferWorkflowOnExceptionStepsTagStepDetailsTagsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TransferWorkflowOnExceptionStepsTagStepDetailsTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
