...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appconfighostedconfigurationversion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appconfig_hosted_configuration_version aws_appconfig_hosted_configuration_version}.
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AppconfigHostedConfigurationVersion) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAppconfigHostedConfigurationVersion(scope constructs.Construct, id *string, config *AppconfigHostedConfigurationVersionConfig) AppconfigHostedConfigurationVersion {
	...
	if err := validateNewAppconfigHostedConfigurationVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppconfigHostedConfigurationVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppconfigHostedConfigurationVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppconfigHostedConfigurationVersion) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppconfigHostedConfigurationVersion) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
