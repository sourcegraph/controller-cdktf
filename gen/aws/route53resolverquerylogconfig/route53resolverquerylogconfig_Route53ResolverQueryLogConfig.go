...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53resolverquerylogconfig/internal"
)
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverQueryLogConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53ResolverQueryLogConfig(scope constructs.Construct, id *string, config *Route53ResolverQueryLogConfigConfig) Route53ResolverQueryLogConfig {
	...
	if err := validateNewRoute53ResolverQueryLogConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverQueryLogConfig) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
