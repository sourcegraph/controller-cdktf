...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) ApplyOnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applyOnInput",
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) InternalValue() *LambdaFunctionSnapStart {
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) OptimizationStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"optimizationStatus",
...
func (j *jsiiProxy_LambdaFunctionSnapStartOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LambdaFunctionSnapStartOutputReference) ToString() *string {
	var returns *string
