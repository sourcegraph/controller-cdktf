...
type OpsworksPhpAppLayerCloudwatchConfigurationOutputReference interface {
	...
	LogStreams() OpsworksPhpAppLayerCloudwatchConfigurationLogStreamsList
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksPhpAppLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksPhpAppLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksPhpAppLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksPhpAppLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksPhpAppLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksPhpAppLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
