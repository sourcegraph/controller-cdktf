...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceGroupArn", GoMethod: "ResetResourceGroupArn"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupArn", GoGetter: "ResourceGroupArn"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupArnInput", GoGetter: "ResourceGroupArnInput"},
