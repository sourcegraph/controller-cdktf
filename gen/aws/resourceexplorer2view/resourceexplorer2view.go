...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/resourceexplorer2_view aws_resourceexplorer2_view}.
...
type jsiiProxy_Resourceexplorer2View struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Resourceexplorer2View) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Resourceexplorer2View) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Resourceexplorer2View) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Resourceexplorer2View) Filters() Resourceexplorer2ViewFiltersList {
	var returns Resourceexplorer2ViewFiltersList
	_jsii_.Get(
		j,
		"filters",
		&returns,
...
func (j *jsiiProxy_Resourceexplorer2View) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Resourceexplorer2View) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Resourceexplorer2View) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Resourceexplorer2View) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Resourceexplorer2View) IncludedProperty() Resourceexplorer2ViewIncludedPropertyList {
	var returns Resourceexplorer2ViewIncludedPropertyList
	_jsii_.Get(
		j,
		"includedProperty",
		&returns,
...
func (j *jsiiProxy_Resourceexplorer2View) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Resourceexplorer2View) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Resourceexplorer2View) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Resourceexplorer2View) Node() constructs.Node {
...
func (j *jsiiProxy_Resourceexplorer2View) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Resourceexplorer2View) Tags() *map[string]*string {
...
func (j *jsiiProxy_Resourceexplorer2View) TagsAll() cdktf.StringMap {
...
func (j *jsiiProxy_Resourceexplorer2View) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Resourceexplorer2View) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Resourceexplorer2View) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewResourceexplorer2View(scope constructs.Construct, id *string, config *Resourceexplorer2ViewConfig) Resourceexplorer2View {
	...
	if err := validateNewResourceexplorer2ViewParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Resourceexplorer2View_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateResourceexplorer2View_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Resourceexplorer2View) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Resourceexplorer2View) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Resourceexplorer2View) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_Resourceexplorer2View) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_Resourceexplorer2View) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_Resourceexplorer2View) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_Resourceexplorer2View) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_Resourceexplorer2View) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_Resourceexplorer2View) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_Resourceexplorer2View) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_Resourceexplorer2View) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_Resourceexplorer2View) ResetDefaultView() {
	_jsii_.InvokeVoid(
		r,
		"resetDefaultView",
		nil, // no parameters
...
func (r *jsiiProxy_Resourceexplorer2View) ResetFilters() {
	_jsii_.InvokeVoid(
		r,
		"resetFilters",
		nil, // no parameters
...
func (r *jsiiProxy_Resourceexplorer2View) ResetIncludedProperty() {
	_jsii_.InvokeVoid(
		r,
		"resetIncludedProperty",
		nil, // no parameters
...
func (r *jsiiProxy_Resourceexplorer2View) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_Resourceexplorer2View) ResetTags() {
	_jsii_.InvokeVoid(
		r,
		"resetTags",
		nil, // no parameters
...
func (r *jsiiProxy_Resourceexplorer2View) ToString() *string {
	var returns *string
