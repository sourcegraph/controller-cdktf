...
func (j *jsiiProxy_EcrReplicationConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrReplicationConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEcrReplicationConfiguration(scope constructs.Construct, id *string, config *EcrReplicationConfigurationConfig) EcrReplicationConfiguration {
	...
	if err := validateNewEcrReplicationConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcrReplicationConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
