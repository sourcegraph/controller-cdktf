...
func NewMwaaEnvironmentLastUpdatedErrorList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MwaaEnvironmentLastUpdatedErrorList {
	...
	if err := validateNewMwaaEnvironmentLastUpdatedErrorListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedErrorList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
