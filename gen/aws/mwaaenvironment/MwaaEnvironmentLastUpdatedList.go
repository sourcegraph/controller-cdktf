...
func NewMwaaEnvironmentLastUpdatedList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MwaaEnvironmentLastUpdatedList {
	...
	if err := validateNewMwaaEnvironmentLastUpdatedListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MwaaEnvironmentLastUpdatedList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
