...
func NewGameliftFleetEc2InboundPermissionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GameliftFleetEc2InboundPermissionList {
	...
	if err := validateNewGameliftFleetEc2InboundPermissionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GameliftFleetEc2InboundPermissionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
