...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayv2deployment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/apigatewayv2_deployment aws_apigatewayv2_deployment}.
...
func NewApigatewayv2Deployment(scope constructs.Construct, id *string, config *Apigatewayv2DeploymentConfig) Apigatewayv2Deployment {
	...
	if err := validateNewApigatewayv2DeploymentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Apigatewayv2Deployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApigatewayv2Deployment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_Apigatewayv2Deployment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_Apigatewayv2Deployment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_Apigatewayv2Deployment) MoveFromId(id *string) {
...
func (a *jsiiProxy_Apigatewayv2Deployment) MoveToId(id *string) {
