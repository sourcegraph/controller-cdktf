...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmpatchbaseline/internal"
)
...
func NewSsmPatchBaselineApprovalRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmPatchBaselineApprovalRuleList {
	...
	if err := validateNewSsmPatchBaselineApprovalRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmPatchBaselineApprovalRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
