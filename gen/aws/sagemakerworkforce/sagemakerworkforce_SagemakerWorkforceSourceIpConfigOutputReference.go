...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerWorkforceSourceIpConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerWorkforceSourceIpConfigOutputReference {
	_init_.Initialize()

	if err := validateNewSagemakerWorkforceSourceIpConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSagemakerWorkforceSourceIpConfigOutputReference_Override(s SagemakerWorkforceSourceIpConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerWorkforceSourceIpConfigOutputReference) ToString() *string {
	var returns *string
