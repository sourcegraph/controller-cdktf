...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Ip() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ip",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) IpInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipInput",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) Port() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"port",
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) PortInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"portInput",
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ResetPort() {
	_jsii_.InvokeVoid(
		r,
		"resetPort",
		nil, // no parameters
...
func (r *jsiiProxy_Route53ResolverRuleTargetIpOutputReference) ToString() *string {
	var returns *string
