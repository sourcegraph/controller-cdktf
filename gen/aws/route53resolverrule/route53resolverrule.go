...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_resolver_rule aws_route53_resolver_rule}.
...
func (j *jsiiProxy_Route53ResolverRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Route53ResolverRule) TargetIp() Route53ResolverRuleTargetIpList {
	var returns Route53ResolverRuleTargetIpList
	_jsii_.Get(
		j,
		"targetIp",
		&returns,
...
func NewRoute53ResolverRule(scope constructs.Construct, id *string, config *Route53ResolverRuleConfig) Route53ResolverRule {
	...
	if err := validateNewRoute53ResolverRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ResolverRule) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
