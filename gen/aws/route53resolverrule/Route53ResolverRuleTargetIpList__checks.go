...
func (r *jsiiProxy_Route53ResolverRuleTargetIpList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_Route53ResolverRuleTargetIpList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*Route53ResolverRuleTargetIp:
		val := val.(*[]*Route53ResolverRuleTargetIp)
	...
	case []*Route53ResolverRuleTargetIp:
		val_ := val.([]*Route53ResolverRuleTargetIp)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*Route53ResolverRuleTargetIp; received %#v (a %T)", val, val)
		}
	}
