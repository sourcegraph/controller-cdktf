...
func (j *jsiiProxy_DataAwsEc2TransitGatewayPeeringAttachmentFilterList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsEc2TransitGatewayPeeringAttachmentFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEc2TransitGatewayPeeringAttachmentFilterList {
	_init_.Initialize()
...
func NewDataAwsEc2TransitGatewayPeeringAttachmentFilterList_Override(d DataAwsEc2TransitGatewayPeeringAttachmentFilterList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEc2TransitGatewayPeeringAttachmentFilterList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayPeeringAttachmentFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2TransitGatewayPeeringAttachmentFilterList) Resolve(_context cdktf.IResolveContext) interface{} {
