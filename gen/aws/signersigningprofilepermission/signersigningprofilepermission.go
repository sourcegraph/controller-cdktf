...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/signersigningprofilepermission/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/signer_signing_profile_permission aws_signer_signing_profile_permission}.
...
func (j *jsiiProxy_SignerSigningProfilePermission) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SignerSigningProfilePermission) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSignerSigningProfilePermission(scope constructs.Construct, id *string, config *SignerSigningProfilePermissionConfig) SignerSigningProfilePermission {
	...
	if err := validateNewSignerSigningProfilePermissionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SignerSigningProfilePermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSignerSigningProfilePermission_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SignerSigningProfilePermission) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SignerSigningProfilePermission) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
