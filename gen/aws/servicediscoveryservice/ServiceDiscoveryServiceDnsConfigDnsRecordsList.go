...
func NewServiceDiscoveryServiceDnsConfigDnsRecordsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceDiscoveryServiceDnsConfigDnsRecordsList {
	...
	if err := validateNewServiceDiscoveryServiceDnsConfigDnsRecordsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceDiscoveryServiceDnsConfigDnsRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
