...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ram_resource_share aws_ram_resource_share}.
type DataAwsRamResourceShare interface {
	...
	SetResourceShareStatus(val *string)
	ResourceShareStatusInput() *string
	Status() *string
...
func (j *jsiiProxy_DataAwsRamResourceShare) Filter() DataAwsRamResourceShareFilterList {
	var returns DataAwsRamResourceShareFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsRamResourceShare) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRamResourceShare) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsRamResourceShare) ResourceShareStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceShareStatus",
...
func (j *jsiiProxy_DataAwsRamResourceShare) ResourceShareStatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceShareStatusInput",
		&returns,
	)
	return returns
}
...
func NewDataAwsRamResourceShare(scope constructs.Construct, id *string, config *DataAwsRamResourceShareConfig) DataAwsRamResourceShare {
	...
	if err := validateNewDataAwsRamResourceShareParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRamResourceShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRamResourceShare_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRamResourceShare) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsRamResourceShare) ResetResourceShareStatus() {
	_jsii_.InvokeVoid(
		d,
		"resetResourceShareStatus",
		nil, // no parameters
