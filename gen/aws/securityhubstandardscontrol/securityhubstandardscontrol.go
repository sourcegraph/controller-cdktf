...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/securityhubstandardscontrol/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/securityhub_standards_control aws_securityhub_standards_control}.
...
func (j *jsiiProxy_SecurityhubStandardsControl) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubStandardsControl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSecurityhubStandardsControl(scope constructs.Construct, id *string, config *SecurityhubStandardsControlConfig) SecurityhubStandardsControl {
	...
	if err := validateNewSecurityhubStandardsControlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SecurityhubStandardsControl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubStandardsControl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubStandardsControl) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubStandardsControl) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubStandardsControl) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubStandardsControl) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubStandardsControl) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
