...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamusergroupmembership/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_user_group_membership aws_iam_user_group_membership}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_user_group_membership aws_iam_user_group_membership} Resource.
func NewIamUserGroupMembership(scope constructs.Construct, id *string, config *IamUserGroupMembershipConfig) IamUserGroupMembership {
	...
	_jsii_.Create(
		"aws.iamUserGroupMembership.IamUserGroupMembership",
