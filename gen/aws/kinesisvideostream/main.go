...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataRetentionInHours", GoGetter: "DataRetentionInHours"},
			_jsii_.MemberProperty{JsiiProperty: "dataRetentionInHoursInput", GoGetter: "DataRetentionInHoursInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMediaType", GoMethod: "ResetMediaType"},
