...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) Items() CloudfrontResponseHeadersPolicyCustomHeadersConfigItemsList {
	var returns CloudfrontResponseHeadersPolicyCustomHeadersConfigItemsList
	_jsii_.Get(
		j,
		"items",
		&returns,
...
func NewCloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference {
	...
	if err := validateNewCloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) PutItems(value interface{}) {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontResponseHeadersPolicyCustomHeadersConfigOutputReference) ToString() *string {
	var returns *string
