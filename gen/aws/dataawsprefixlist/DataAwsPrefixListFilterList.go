...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsprefixlist/internal"
)
...
func NewDataAwsPrefixListFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsPrefixListFilterList {
	...
	if err := validateNewDataAwsPrefixListFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsPrefixListFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
