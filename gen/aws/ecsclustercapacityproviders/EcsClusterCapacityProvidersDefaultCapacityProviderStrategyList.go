...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ecsclustercapacityproviders/internal"
)
...
func NewEcsClusterCapacityProvidersDefaultCapacityProviderStrategyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsClusterCapacityProvidersDefaultCapacityProviderStrategyList {
	...
	if err := validateNewEcsClusterCapacityProvidersDefaultCapacityProviderStrategyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsClusterCapacityProvidersDefaultCapacityProviderStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
