...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (s *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_ServicecatalogServiceActionDefinitionOutputReference) ToString() *string {
	var returns *string
