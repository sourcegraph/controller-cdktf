...
func (d *jsiiProxy_DataAwsEc2CoipPoolFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsEc2CoipPoolFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DataAwsEc2CoipPoolFilter:
		val := val.(*[]*DataAwsEc2CoipPoolFilter)
	...
	case []*DataAwsEc2CoipPoolFilter:
		val_ := val.([]*DataAwsEc2CoipPoolFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsEc2CoipPoolFilter; received %#v (a %T)", val, val)
		}
	}
