...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudfront_cache_policy aws_cloudfront_cache_policy}.
...
func (j *jsiiProxy_CloudfrontCachePolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontCachePolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontCachePolicy(scope constructs.Construct, id *string, config *CloudfrontCachePolicyConfig) CloudfrontCachePolicy {
	...
	if err := validateNewCloudfrontCachePolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudfrontCachePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontCachePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontCachePolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontCachePolicy) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
