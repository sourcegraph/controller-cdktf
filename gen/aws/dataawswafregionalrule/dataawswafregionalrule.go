...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafregionalrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/wafregional_rule aws_wafregional_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/wafregional_rule aws_wafregional_rule} Data Source.
func NewDataAwsWafregionalRule(scope constructs.Construct, id *string, config *DataAwsWafregionalRuleConfig) DataAwsWafregionalRule {
	...
	if err := validateNewDataAwsWafregionalRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafregionalRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafregionalRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafregionalRule_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafregionalRule_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafregionalRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafregionalRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafregionalRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafregionalRule) ToHclTerraform() interface{} {
	var returns interface{}
