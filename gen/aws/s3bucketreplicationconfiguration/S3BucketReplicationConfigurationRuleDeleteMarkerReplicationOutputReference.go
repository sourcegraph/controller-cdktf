...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference {
	...
	if err := validateNewS3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDeleteMarkerReplicationOutputReference) ToString() *string {
	var returns *string
