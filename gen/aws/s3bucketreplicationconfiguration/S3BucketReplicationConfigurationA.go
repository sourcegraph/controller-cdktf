...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_replication_configuration aws_s3_bucket_replication_configuration}.
...
func (j *jsiiProxy_S3BucketReplicationConfigurationA) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationA) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationA) Rule() S3BucketReplicationConfigurationRuleList {
	var returns S3BucketReplicationConfigurationRuleList
	_jsii_.Get(
		j,
		"rule",
		&returns,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationA) Token() *string {
	var returns *string
	_jsii_.Get(
		j,
		"token",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationA) TokenInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenInput",
...
func NewS3BucketReplicationConfigurationA(scope constructs.Construct, id *string, config *S3BucketReplicationConfigurationAConfig) S3BucketReplicationConfigurationA {
	...
	if err := validateNewS3BucketReplicationConfigurationAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func S3BucketReplicationConfigurationA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketReplicationConfigurationA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketReplicationConfigurationA) ResetToken() {
	_jsii_.InvokeVoid(
		s,
		"resetToken",
		nil, // no parameters
