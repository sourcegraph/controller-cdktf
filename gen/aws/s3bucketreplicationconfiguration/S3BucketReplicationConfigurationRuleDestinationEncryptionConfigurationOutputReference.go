...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference {
	...
	if err := validateNewS3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketReplicationConfigurationRuleDestinationEncryptionConfigurationOutputReference) ToString() *string {
	var returns *string
