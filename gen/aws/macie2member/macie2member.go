...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/macie2member/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie2_member aws_macie2_member}.
...
func NewMacie2Member(scope constructs.Construct, id *string, config *Macie2MemberConfig) Macie2Member {
	...
	if err := validateNewMacie2MemberParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Macie2Member_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacie2Member_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_Macie2Member) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_Macie2Member) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_Macie2Member) MoveFromId(id *string) {
...
func (m *jsiiProxy_Macie2Member) MoveToId(id *string) {
