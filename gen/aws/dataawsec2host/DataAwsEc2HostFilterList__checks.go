...
func (d *jsiiProxy_DataAwsEc2HostFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsEc2HostFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*DataAwsEc2HostFilter:
		val := val.(*[]*DataAwsEc2HostFilter)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsEc2HostFilter; received %#v (a %T)", val, val)
		}
	}
