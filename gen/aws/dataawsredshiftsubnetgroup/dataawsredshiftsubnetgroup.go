...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsredshiftsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/redshift_subnet_group aws_redshift_subnet_group}.
...
func NewDataAwsRedshiftSubnetGroup(scope constructs.Construct, id *string, config *DataAwsRedshiftSubnetGroupConfig) DataAwsRedshiftSubnetGroup {
	...
	if err := validateNewDataAwsRedshiftSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRedshiftSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRedshiftSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
