...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssoadmin_instance_access_control_attributes aws_ssoadmin_instance_access_control_attributes}.
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) Attribute() SsoadminInstanceAccessControlAttributesAttributeList {
	var returns SsoadminInstanceAccessControlAttributesAttributeList
	_jsii_.Get(
		j,
		"attribute",
		&returns,
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) InstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArnInput",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) Node() constructs.Node {
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) StatusReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusReason",
...
func (j *jsiiProxy_SsoadminInstanceAccessControlAttributes) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewSsoadminInstanceAccessControlAttributes(scope constructs.Construct, id *string, config *SsoadminInstanceAccessControlAttributesConfig) SsoadminInstanceAccessControlAttributes {
	...
	if err := validateNewSsoadminInstanceAccessControlAttributesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SsoadminInstanceAccessControlAttributes_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.ssoadminInstanceAccessControlAttributes.SsoadminInstanceAccessControlAttributes",
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) MoveToId(id *string) {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SsoadminInstanceAccessControlAttributes) ToString() *string {
	var returns *string
