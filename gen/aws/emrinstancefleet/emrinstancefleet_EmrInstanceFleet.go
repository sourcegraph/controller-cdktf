...
func (j *jsiiProxy_EmrInstanceFleet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmrInstanceFleet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EmrInstanceFleet) InstanceTypeConfigs() EmrInstanceFleetInstanceTypeConfigsList {
	var returns EmrInstanceFleetInstanceTypeConfigsList
	_jsii_.Get(
		j,
		"instanceTypeConfigs",
		&returns,
...
func NewEmrInstanceFleet(scope constructs.Construct, id *string, config *EmrInstanceFleetConfig) EmrInstanceFleet {
	...
	if err := validateNewEmrInstanceFleetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrInstanceFleet) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
