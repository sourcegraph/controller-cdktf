...
func (d *jsiiProxy_DataAwsLbTargetGroupHealthCheckList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsLbTargetGroupHealthCheckList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsLbTargetGroupHealthCheckList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsLbTargetGroupHealthCheckList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
