...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerFlowDefinitionHumanLoopRequestSourceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference {
	...
	if err := validateNewSagemakerFlowDefinitionHumanLoopRequestSourceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference)SetAwsManagedHumanLoopRequestSource(val *string) {
	if err := j.validateSetAwsManagedHumanLoopRequestSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerFlowDefinitionHumanLoopRequestSourceOutputReference) ToString() *string {
	var returns *string
