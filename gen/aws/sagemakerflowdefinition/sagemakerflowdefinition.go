...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sagemaker_flow_definition aws_sagemaker_flow_definition}.
...
func SagemakerFlowDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateSagemakerFlowDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SagemakerFlowDefinition) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SagemakerFlowDefinition) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerFlowDefinition) MoveFromId(id *string) {
...
func (s *jsiiProxy_SagemakerFlowDefinition) MoveToId(id *string) {
