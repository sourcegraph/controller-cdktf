...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apprunnerautoscalingconfigurationversion/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/apprunner_auto_scaling_configuration_version aws_apprunner_auto_scaling_configuration_version}.
...
func NewApprunnerAutoScalingConfigurationVersion(scope constructs.Construct, id *string, config *ApprunnerAutoScalingConfigurationVersionConfig) ApprunnerAutoScalingConfigurationVersion {
	...
	if err := validateNewApprunnerAutoScalingConfigurationVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApprunnerAutoScalingConfigurationVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApprunnerAutoScalingConfigurationVersion_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApprunnerAutoScalingConfigurationVersion) MoveToId(id *string) {
