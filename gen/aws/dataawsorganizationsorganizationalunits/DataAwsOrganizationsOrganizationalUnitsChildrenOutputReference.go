...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsorganizationsorganizationalunits/internal"
)
...
func NewDataAwsOrganizationsOrganizationalUnitsChildrenOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsOrganizationsOrganizationalUnitsChildrenOutputReference {
	...
	if err := validateNewDataAwsOrganizationsOrganizationalUnitsChildrenOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
