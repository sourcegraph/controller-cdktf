...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayaccount/internal"
)
...
func NewApiGatewayAccountThrottleSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiGatewayAccountThrottleSettingsOutputReference {
	...
	if err := validateNewApiGatewayAccountThrottleSettingsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
