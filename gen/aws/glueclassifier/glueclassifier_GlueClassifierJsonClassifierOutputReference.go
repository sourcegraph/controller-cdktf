...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/glueclassifier/internal"
)
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueClassifierJsonClassifierOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueClassifierJsonClassifierOutputReference {
	_init_.Initialize()

	if err := validateNewGlueClassifierJsonClassifierOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGlueClassifierJsonClassifierOutputReference_Override(g GlueClassifierJsonClassifierOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueClassifierJsonClassifierOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueClassifierJsonClassifierOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueClassifierJsonClassifierOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueClassifierJsonClassifierOutputReference) ToString() *string {
	var returns *string
