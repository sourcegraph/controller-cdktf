...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamgrouppolicyattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_group_policy_attachment aws_iam_group_policy_attachment}.
...
func (j *jsiiProxy_IamGroupPolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamGroupPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamGroupPolicyAttachment(scope constructs.Construct, id *string, config *IamGroupPolicyAttachmentConfig) IamGroupPolicyAttachment {
	...
	if err := validateNewIamGroupPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamGroupPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamGroupPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamGroupPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) MoveToId(id *string) {
...
func (i *jsiiProxy_IamGroupPolicyAttachment) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
