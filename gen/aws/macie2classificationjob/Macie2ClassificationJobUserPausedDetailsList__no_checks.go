...
func (j *jsiiProxy_Macie2ClassificationJobUserPausedDetailsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Macie2ClassificationJobUserPausedDetailsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
