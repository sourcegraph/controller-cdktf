...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/applicationinsightsapplication/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/applicationinsights_application aws_applicationinsights_application}.
type ApplicationinsightsApplication interface {
	cdktf.TerraformResource
	Arn() *string
	AutoConfigEnabled() interface{}
	SetAutoConfigEnabled(val interface{})
	AutoConfigEnabledInput() interface{}
...
func (j *jsiiProxy_ApplicationinsightsApplication) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_ApplicationinsightsApplication) AutoConfigEnabled() interface{} {
...
func (j *jsiiProxy_ApplicationinsightsApplication) AutoConfigEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoConfigEnabledInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ApplicationinsightsApplication) AutoCreate() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoCreate",
...
func (j *jsiiProxy_ApplicationinsightsApplication) AutoCreateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoCreateInput",
...
func (j *jsiiProxy_ApplicationinsightsApplication) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ApplicationinsightsApplication) Tags() *map[string]*string {
...
func (j *jsiiProxy_ApplicationinsightsApplication) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_ApplicationinsightsApplication) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_ApplicationinsightsApplication) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/applicationinsights_application aws_applicationinsights_application} Resource.
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetAutoConfigEnabled(val interface{}) {
	if err := j.validateSetAutoConfigEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetAutoCreate(val interface{}) {
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetId(val *string) {
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_ApplicationinsightsApplication)SetTagsAll(val *map[string]*string) {
...
func (a *jsiiProxy_ApplicationinsightsApplication) ResetAutoConfigEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetAutoConfigEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationinsightsApplication) ResetAutoCreate() {
	_jsii_.InvokeVoid(
		a,
		"resetAutoCreate",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationinsightsApplication) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationinsightsApplication) ResetTagsAll() {
	_jsii_.InvokeVoid(
		a,
		"resetTagsAll",
		nil, // no parameters
