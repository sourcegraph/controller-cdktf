...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoConfigEnabled", GoGetter: "AutoConfigEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "autoConfigEnabledInput", GoGetter: "AutoConfigEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoConfigEnabled", GoMethod: "ResetAutoConfigEnabled"},
	...
	_jsii_.RegisterStruct(
		"aws.applicationinsightsApplication.ApplicationinsightsApplicationConfig",
