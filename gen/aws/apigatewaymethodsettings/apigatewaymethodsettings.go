...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_method_settings aws_api_gateway_method_settings}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_method_settings aws_api_gateway_method_settings} Resource.
func NewApiGatewayMethodSettings(scope constructs.Construct, id *string, config *ApiGatewayMethodSettingsConfig) ApiGatewayMethodSettings {
	...
	if err := validateNewApiGatewayMethodSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiGatewayMethodSettings)SetMethodPath(val *string) {
	if err := j.validateSetMethodPathParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func ApiGatewayMethodSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayMethodSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiGatewayMethodSettings_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiGatewayMethodSettings_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayMethodSettings_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayMethodSettings_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiGatewayMethodSettings_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiGatewayMethodSettings_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiGatewayMethodSettings) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayMethodSettings) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiGatewayMethodSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayMethodSettings) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayMethodSettings) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiGatewayMethodSettings) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiGatewayMethodSettings) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiGatewayMethodSettings) ToHclTerraform() interface{} {
	var returns interface{}
