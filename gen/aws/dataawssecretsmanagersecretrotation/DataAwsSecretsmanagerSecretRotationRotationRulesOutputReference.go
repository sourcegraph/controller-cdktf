...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssecretsmanagersecretrotation/internal"
)
...
func NewDataAwsSecretsmanagerSecretRotationRotationRulesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference {
	...
	if err := validateNewDataAwsSecretsmanagerSecretRotationRotationRulesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference{}

	_jsii_.Create(
		"aws.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference",
