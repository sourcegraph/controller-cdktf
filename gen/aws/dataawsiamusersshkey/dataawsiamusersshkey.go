...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamusersshkey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_user_ssh_key aws_iam_user_ssh_key}.
...
func (j *jsiiProxy_DataAwsIamUserSshKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamUserSshKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamUserSshKey(scope constructs.Construct, id *string, config *DataAwsIamUserSshKeyConfig) DataAwsIamUserSshKey {
	...
	if err := validateNewDataAwsIamUserSshKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsIamUserSshKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamUserSshKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsIamUserSshKey) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
