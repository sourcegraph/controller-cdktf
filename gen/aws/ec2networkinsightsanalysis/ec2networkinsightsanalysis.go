...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.ec2NetworkInsightsAnalysis.Ec2NetworkInsightsAnalysisExplanationsPrefixList",
		reflect.TypeOf((*Ec2NetworkInsightsAnalysisExplanationsPrefixList)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws.ec2NetworkInsightsAnalysis.Ec2NetworkInsightsAnalysisExplanationsPrefixListList",
