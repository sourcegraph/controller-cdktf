...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticachesecuritygroup/internal"
)
...
func NewElasticacheSecurityGroup(scope constructs.Construct, id *string, config *ElasticacheSecurityGroupConfig) ElasticacheSecurityGroup {
	...
	if err := validateNewElasticacheSecurityGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
