...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/subnet/internal"
)
...
func NewSubnetTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SubnetTimeoutsOutputReference {
	...
	if err := validateNewSubnetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
