...
func (j *jsiiProxy_GlueUserDefinedFunction) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewGlueUserDefinedFunction(scope constructs.Construct, id *string, config *GlueUserDefinedFunctionConfig) GlueUserDefinedFunction {
	...
	if err := validateNewGlueUserDefinedFunctionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueUserDefinedFunction) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
