...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftendpointauthorization/internal"
)
...
func (j *jsiiProxy_RedshiftEndpointAuthorization) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RedshiftEndpointAuthorization)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
