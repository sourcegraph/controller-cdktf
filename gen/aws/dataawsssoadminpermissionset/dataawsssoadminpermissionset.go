...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsssoadminpermissionset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ssoadmin_permission_set aws_ssoadmin_permission_set}.
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsSsoadminPermissionSet) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewDataAwsSsoadminPermissionSet(scope constructs.Construct, id *string, config *DataAwsSsoadminPermissionSetConfig) DataAwsSsoadminPermissionSet {
	...
	if err := validateNewDataAwsSsoadminPermissionSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsSsoadminPermissionSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSsoadminPermissionSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsSsoadminPermissionSet) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
