...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaydeployment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_deployment aws_api_gateway_deployment}.
...
func NewApiGatewayDeployment(scope constructs.Construct, id *string, config *ApiGatewayDeploymentConfig) ApiGatewayDeployment {
	...
	if err := validateNewApiGatewayDeploymentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiGatewayDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayDeployment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayDeployment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayDeployment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayDeployment) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayDeployment) MoveToId(id *string) {
