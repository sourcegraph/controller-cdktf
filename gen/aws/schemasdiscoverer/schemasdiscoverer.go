...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/schemasdiscoverer/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/schemas_discoverer aws_schemas_discoverer}.
...
func (j *jsiiProxy_SchemasDiscoverer) Connection() interface{} {
...
func (j *jsiiProxy_SchemasDiscoverer) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SchemasDiscoverer) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SchemasDiscoverer) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/schemas_discoverer aws_schemas_discoverer} Resource.
func NewSchemasDiscoverer(scope constructs.Construct, id *string, config *SchemasDiscovererConfig) SchemasDiscoverer {
	_init_.Initialize()

	if err := validateNewSchemasDiscovererParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SchemasDiscoverer)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SchemasDiscoverer)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SchemasDiscoverer)SetId(val *string) {
...
func (j *jsiiProxy_SchemasDiscoverer)SetProvisioners(val *[]interface{}) {
...
func SchemasDiscoverer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSchemasDiscoverer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SchemasDiscoverer_IsConstruct(x interface{}) *bool {
	...
	if err := validateSchemasDiscoverer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SchemasDiscoverer_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSchemasDiscoverer_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SchemasDiscoverer_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSchemasDiscoverer_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SchemasDiscoverer) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SchemasDiscoverer) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SchemasDiscoverer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SchemasDiscoverer) MoveFromId(id *string) {
...
func (s *jsiiProxy_SchemasDiscoverer) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SchemasDiscoverer) MoveToId(id *string) {
...
func (s *jsiiProxy_SchemasDiscoverer) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SchemasDiscoverer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SchemasDiscoverer) ToHclTerraform() interface{} {
	var returns interface{}
