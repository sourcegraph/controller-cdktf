...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3bucketownershipcontrols/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_ownership_controls aws_s3_bucket_ownership_controls}.
...
func (j *jsiiProxy_S3BucketOwnershipControls) Connection() interface{} {
...
func (j *jsiiProxy_S3BucketOwnershipControls) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketOwnershipControls) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3BucketOwnershipControls) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_ownership_controls aws_s3_bucket_ownership_controls} Resource.
func NewS3BucketOwnershipControls(scope constructs.Construct, id *string, config *S3BucketOwnershipControlsConfig) S3BucketOwnershipControls {
	...
	if err := validateNewS3BucketOwnershipControlsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3BucketOwnershipControls)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3BucketOwnershipControls)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3BucketOwnershipControls)SetId(val *string) {
...
func (j *jsiiProxy_S3BucketOwnershipControls)SetProvisioners(val *[]interface{}) {
...
func S3BucketOwnershipControls_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3BucketOwnershipControls_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func S3BucketOwnershipControls_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3BucketOwnershipControls_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3BucketOwnershipControls_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketOwnershipControls_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func S3BucketOwnershipControls_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateS3BucketOwnershipControls_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3BucketOwnershipControls) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3BucketOwnershipControls) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_S3BucketOwnershipControls) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3BucketOwnershipControls) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3BucketOwnershipControls) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_S3BucketOwnershipControls) MoveToId(id *string) {
...
func (s *jsiiProxy_S3BucketOwnershipControls) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_S3BucketOwnershipControls) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_S3BucketOwnershipControls) ToHclTerraform() interface{} {
	var returns interface{}
