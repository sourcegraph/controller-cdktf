...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsavailabilityzones/internal"
)
...
func NewDataAwsAvailabilityZonesTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAwsAvailabilityZonesTimeoutsOutputReference {
	...
	if err := validateNewDataAwsAvailabilityZonesTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
