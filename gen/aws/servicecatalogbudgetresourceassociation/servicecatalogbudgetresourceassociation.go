...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicecatalogbudgetresourceassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/servicecatalog_budget_resource_association aws_servicecatalog_budget_resource_association}.
type ServicecatalogBudgetResourceAssociation interface {
	...
	PutTimeouts(value *ServicecatalogBudgetResourceAssociationTimeouts)
	ResetId()
...
func (j *jsiiProxy_ServicecatalogBudgetResourceAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogBudgetResourceAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogBudgetResourceAssociation) Timeouts() ServicecatalogBudgetResourceAssociationTimeoutsOutputReference {
	var returns ServicecatalogBudgetResourceAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogBudgetResourceAssociation(scope constructs.Construct, id *string, config *ServicecatalogBudgetResourceAssociationConfig) ServicecatalogBudgetResourceAssociation {
	...
	if err := validateNewServicecatalogBudgetResourceAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServicecatalogBudgetResourceAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogBudgetResourceAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) PutTimeouts(value *ServicecatalogBudgetResourceAssociationTimeouts) {
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogBudgetResourceAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
