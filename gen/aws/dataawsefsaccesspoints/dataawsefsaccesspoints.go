package dataawsefsaccesspoints
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsefsaccesspoints/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/efs_access_points aws_efs_access_points}.
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEfsAccessPoints) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEfsAccessPoints(scope constructs.Construct, id *string, config *DataAwsEfsAccessPointsConfig) DataAwsEfsAccessPoints {
	...
	if err := validateNewDataAwsEfsAccessPointsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEfsAccessPoints_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEfsAccessPoints_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEfsAccessPoints) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
