...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudfrontpublickey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudfront_public_key aws_cloudfront_public_key}.
...
func (j *jsiiProxy_CloudfrontPublicKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontPublicKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontPublicKey(scope constructs.Construct, id *string, config *CloudfrontPublicKeyConfig) CloudfrontPublicKey {
	...
	if err := validateNewCloudfrontPublicKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudfrontPublicKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontPublicKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontPublicKey) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontPublicKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontPublicKey) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudfrontPublicKey) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudfrontPublicKey) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
