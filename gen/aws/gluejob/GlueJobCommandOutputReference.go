...
func (j *jsiiProxy_GlueJobCommandOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueJobCommandOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJobCommandOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueJobCommandOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueJobCommandOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueJobCommandOutputReference {
	...
	if err := validateNewGlueJobCommandOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueJobCommandOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueJobCommandOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueJobCommandOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueJobCommandOutputReference) ToString() *string {
	var returns *string
