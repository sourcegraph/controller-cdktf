...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueJobExecutionPropertyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueJobExecutionPropertyOutputReference {
	...
	if err := validateNewGlueJobExecutionPropertyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueJobExecutionPropertyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueJobExecutionPropertyOutputReference) ToString() *string {
	var returns *string
