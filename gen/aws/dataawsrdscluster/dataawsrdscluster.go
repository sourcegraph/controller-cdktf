...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsrdscluster/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/rds_cluster aws_rds_cluster}.
type DataAwsRdsCluster interface {
	...
	HostedZoneId() *string
	IamDatabaseAuthenticationEnabled() cdktf.IResolvable
	IamRoles() *[]*string
	Id() *string
	SetId(val *string)
	IdInput() *string
...
func (j *jsiiProxy_DataAwsRdsCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsRdsCluster) IamDatabaseAuthenticationEnabled() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsRdsCluster) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsRdsCluster) StorageEncrypted() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"storageEncrypted",
...
func (j *jsiiProxy_DataAwsRdsCluster) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsRdsCluster) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewDataAwsRdsCluster(scope constructs.Construct, id *string, config *DataAwsRdsClusterConfig) DataAwsRdsCluster {
	...
	if err := validateNewDataAwsRdsClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsRdsCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsRdsCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRdsCluster) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsRdsCluster) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsRdsCluster) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsRdsCluster) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsRdsCluster) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
