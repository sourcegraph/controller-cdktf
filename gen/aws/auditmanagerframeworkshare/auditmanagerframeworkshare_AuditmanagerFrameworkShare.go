...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/auditmanagerframeworkshare/internal"
)
...
type AuditmanagerFrameworkShare interface {
	...
	SetDestinationAccount(val *string)
...
type jsiiProxy_AuditmanagerFrameworkShare struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AuditmanagerFrameworkShare) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) DestinationAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationAccount",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) DestinationAccountInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) DestinationRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationRegion",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) DestinationRegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) FrameworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"frameworkId",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) FrameworkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"frameworkIdInput",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Node() constructs.Node {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuditmanagerFrameworkShare) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAuditmanagerFrameworkShare(scope constructs.Construct, id *string, config *AuditmanagerFrameworkShareConfig) AuditmanagerFrameworkShare {
	...
	if err := validateNewAuditmanagerFrameworkShareParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) ResetComment() {
	_jsii_.InvokeVoid(
		a,
		"resetComment",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerFrameworkShare) ToString() *string {
	var returns *string
