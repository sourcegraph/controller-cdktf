...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataexchangedataset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dataexchange_data_set aws_dataexchange_data_set}.
...
func (j *jsiiProxy_DataexchangeDataSet) Connection() interface{} {
...
func (j *jsiiProxy_DataexchangeDataSet) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataexchangeDataSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataexchangeDataSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataexchangeDataSet) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dataexchange_data_set aws_dataexchange_data_set} Resource.
func NewDataexchangeDataSet(scope constructs.Construct, id *string, config *DataexchangeDataSetConfig) DataexchangeDataSet {
	_init_.Initialize()

	if err := validateNewDataexchangeDataSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataexchangeDataSet)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DataexchangeDataSet)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataexchangeDataSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataexchangeDataSet)SetId(val *string) {
...
func (j *jsiiProxy_DataexchangeDataSet)SetProvisioners(val *[]interface{}) {
...
func DataexchangeDataSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataexchangeDataSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataexchangeDataSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataexchangeDataSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataexchangeDataSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataexchangeDataSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataexchangeDataSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataexchangeDataSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataexchangeDataSet) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataexchangeDataSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataexchangeDataSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DataexchangeDataSet) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataexchangeDataSet) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataexchangeDataSet) MoveToId(id *string) {
...
func (d *jsiiProxy_DataexchangeDataSet) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataexchangeDataSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataexchangeDataSet) ToHclTerraform() interface{} {
	var returns interface{}
