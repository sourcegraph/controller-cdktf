...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/pinpointsmschannel/internal"
)
...
func NewPinpointSmsChannel(scope constructs.Construct, id *string, config *PinpointSmsChannelConfig) PinpointSmsChannel {
	...
	if err := validateNewPinpointSmsChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_PinpointSmsChannel{}

	_jsii_.Create(
		"aws.pinpointSmsChannel.PinpointSmsChannel",
