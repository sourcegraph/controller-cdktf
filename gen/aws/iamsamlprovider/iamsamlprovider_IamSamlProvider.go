...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamsamlprovider/internal"
)
...
func (j *jsiiProxy_IamSamlProvider) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamSamlProvider) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamSamlProvider(scope constructs.Construct, id *string, config *IamSamlProviderConfig) IamSamlProvider {
	...
	if err := validateNewIamSamlProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamSamlProvider) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
