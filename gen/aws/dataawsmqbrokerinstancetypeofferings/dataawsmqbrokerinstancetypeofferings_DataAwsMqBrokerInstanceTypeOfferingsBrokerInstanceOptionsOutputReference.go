...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsmqbrokerinstancetypeofferings/internal"
)
...
func NewDataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference {
	...
	if err := validateNewDataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
