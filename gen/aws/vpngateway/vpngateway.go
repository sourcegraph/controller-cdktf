...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpngateway/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpn_gateway aws_vpn_gateway}.
...
func (j *jsiiProxy_VpnGateway) AmazonSideAsn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"amazonSideAsn",
...
func (j *jsiiProxy_VpnGateway) AmazonSideAsnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"amazonSideAsnInput",
...
func (j *jsiiProxy_VpnGateway) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_VpnGateway) AvailabilityZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityZone",
...
func (j *jsiiProxy_VpnGateway) AvailabilityZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpnGateway) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpnGateway) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpnGateway) VpcIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcIdInput",
...
func (v *jsiiProxy_VpnGateway) ResetAmazonSideAsn() {
	_jsii_.InvokeVoid(
		v,
		"resetAmazonSideAsn",
		nil, // no parameters
...
func (v *jsiiProxy_VpnGateway) ResetAvailabilityZone() {
	_jsii_.InvokeVoid(
		v,
		"resetAvailabilityZone",
		nil, // no parameters
...
func (v *jsiiProxy_VpnGateway) ResetTagsAll() {
	_jsii_.InvokeVoid(
		v,
		"resetTagsAll",
		nil, // no parameters
...
func (v *jsiiProxy_VpnGateway) ResetVpcId() {
	_jsii_.InvokeVoid(
		v,
		"resetVpcId",
		nil, // no parameters
