...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftusagelimit/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshift_usage_limit aws_redshift_usage_limit}.
...
func NewRedshiftUsageLimit(scope constructs.Construct, id *string, config *RedshiftUsageLimitConfig) RedshiftUsageLimit {
	...
	if err := validateNewRedshiftUsageLimitParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftUsageLimit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftUsageLimit_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftUsageLimit) AddMoveTarget(moveTarget *string) {
