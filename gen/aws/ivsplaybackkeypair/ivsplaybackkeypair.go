...
func (j *jsiiProxy_IvsPlaybackKeyPair) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/aws/r/ivs_playback_key_pair aws_ivs_playback_key_pair} Resource.
...
func (j *jsiiProxy_IvsPlaybackKeyPair)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
