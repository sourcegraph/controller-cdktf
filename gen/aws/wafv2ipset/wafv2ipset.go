...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafv2ipset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafv2_ip_set aws_wafv2_ip_set}.
...
type jsiiProxy_Wafv2IpSet struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Wafv2IpSet) Addresses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"addresses",
...
func (j *jsiiProxy_Wafv2IpSet) AddressesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"addressesInput",
...
func (j *jsiiProxy_Wafv2IpSet) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Wafv2IpSet) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Wafv2IpSet) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Wafv2IpSet) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Wafv2IpSet) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Wafv2IpSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Wafv2IpSet) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Wafv2IpSet) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Wafv2IpSet) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Wafv2IpSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Wafv2IpSet) IpAddressVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressVersion",
...
func (j *jsiiProxy_Wafv2IpSet) IpAddressVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressVersionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_Wafv2IpSet) LockToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lockToken",
...
func (j *jsiiProxy_Wafv2IpSet) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Wafv2IpSet) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Wafv2IpSet) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Wafv2IpSet) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_Wafv2IpSet) ScopeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeInput",
...
func (j *jsiiProxy_Wafv2IpSet) Tags() *map[string]*string {
...
func (j *jsiiProxy_Wafv2IpSet) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_Wafv2IpSet) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_Wafv2IpSet) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Wafv2IpSet) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Wafv2IpSet) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewWafv2IpSet(scope constructs.Construct, id *string, config *Wafv2IpSetConfig) Wafv2IpSet {
	...
	if err := validateNewWafv2IpSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Wafv2IpSet_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.wafv2IpSet.Wafv2IpSet",
...
func (w *jsiiProxy_Wafv2IpSet) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_Wafv2IpSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_Wafv2IpSet) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_Wafv2IpSet) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_Wafv2IpSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_Wafv2IpSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_Wafv2IpSet) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_Wafv2IpSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_Wafv2IpSet) ResetAddresses() {
	_jsii_.InvokeVoid(
		w,
		"resetAddresses",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ResetDescription() {
	_jsii_.InvokeVoid(
		w,
		"resetDescription",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ResetTags() {
	_jsii_.InvokeVoid(
		w,
		"resetTags",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ResetTagsAll() {
	_jsii_.InvokeVoid(
		w,
		"resetTagsAll",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2IpSet) ToString() *string {
	var returns *string
