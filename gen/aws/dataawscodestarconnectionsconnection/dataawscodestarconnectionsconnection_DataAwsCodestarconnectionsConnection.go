...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscodestarconnectionsconnection/internal"
)
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsCodestarconnectionsConnection) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func NewDataAwsCodestarconnectionsConnection(scope constructs.Construct, id *string, config *DataAwsCodestarconnectionsConnectionConfig) DataAwsCodestarconnectionsConnection {
	...
	if err := validateNewDataAwsCodestarconnectionsConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsCodestarconnectionsConnection) ResetName() {
	_jsii_.InvokeVoid(
		d,
		"resetName",
		nil, // no parameters
