...
func (j *jsiiProxy_DataAwsAlbListener) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsAlbListener) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAwsAlbListener) DefaultAction() DataAwsAlbListenerDefaultActionList {
	var returns DataAwsAlbListenerDefaultActionList
	_jsii_.Get(
		j,
		"defaultAction",
		&returns,
...
func (j *jsiiProxy_DataAwsAlbListener) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAlbListener) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsAlbListener) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsAlbListener) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsAlbListener) Timeouts() DataAwsAlbListenerTimeoutsOutputReference {
	var returns DataAwsAlbListenerTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsAlbListener(scope constructs.Construct, id *string, config *DataAwsAlbListenerConfig) DataAwsAlbListener {
	...
	if err := validateNewDataAwsAlbListenerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsAlbListener)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (d *jsiiProxy_DataAwsAlbListener) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsAlbListener) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsAlbListener) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsAlbListener) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsAlbListener) PutTimeouts(value *DataAwsAlbListenerTimeouts) {
...
func (d *jsiiProxy_DataAwsAlbListener) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAlbListener) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAlbListener) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
