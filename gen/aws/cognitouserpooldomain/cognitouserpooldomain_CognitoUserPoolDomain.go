...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cognitouserpooldomain/internal"
)
...
func NewCognitoUserPoolDomain(scope constructs.Construct, id *string, config *CognitoUserPoolDomainConfig) CognitoUserPoolDomain {
	...
	if err := validateNewCognitoUserPoolDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
