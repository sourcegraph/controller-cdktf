...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbproxyendpoint/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_proxy_endpoint aws_db_proxy_endpoint}.
...
func (j *jsiiProxy_DbProxyEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbProxyEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbProxyEndpoint) IsDefault() cdktf.IResolvable {
...
func (j *jsiiProxy_DbProxyEndpoint) Tags() *map[string]*string {
...
func (j *jsiiProxy_DbProxyEndpoint) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DbProxyEndpoint) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DbProxyEndpoint) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewDbProxyEndpoint(scope constructs.Construct, id *string, config *DbProxyEndpointConfig) DbProxyEndpoint {
	...
	if err := validateNewDbProxyEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbProxyEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbProxyEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbProxyEndpoint) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbProxyEndpoint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbProxyEndpoint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbProxyEndpoint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbProxyEndpoint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbProxyEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbProxyEndpoint) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbProxyEndpoint) MoveToId(id *string) {
...
func (d *jsiiProxy_DbProxyEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
