...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamrolepolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_role_policy aws_iam_role_policy}.
...
func (j *jsiiProxy_IamRolePolicy) Connection() interface{} {
...
func (j *jsiiProxy_IamRolePolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamRolePolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamRolePolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_role_policy aws_iam_role_policy} Resource.
func NewIamRolePolicy(scope constructs.Construct, id *string, config *IamRolePolicyConfig) IamRolePolicy {
	_init_.Initialize()

	if err := validateNewIamRolePolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IamRolePolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IamRolePolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamRolePolicy)SetId(val *string) {
...
func (j *jsiiProxy_IamRolePolicy)SetProvisioners(val *[]interface{}) {
...
func IamRolePolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamRolePolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IamRolePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateIamRolePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamRolePolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamRolePolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IamRolePolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIamRolePolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamRolePolicy) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamRolePolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IamRolePolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamRolePolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamRolePolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IamRolePolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_IamRolePolicy) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamRolePolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IamRolePolicy) ToHclTerraform() interface{} {
	var returns interface{}
