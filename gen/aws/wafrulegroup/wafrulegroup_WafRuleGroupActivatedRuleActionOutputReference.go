...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewWafRuleGroupActivatedRuleActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafRuleGroupActivatedRuleActionOutputReference {
	_init_.Initialize()

	if err := validateNewWafRuleGroupActivatedRuleActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafRuleGroupActivatedRuleActionOutputReference_Override(w WafRuleGroupActivatedRuleActionOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafRuleGroupActivatedRuleActionOutputReference) ToString() *string {
	var returns *string
