...
func (j *jsiiProxy_WafRuleGroup) ActivatedRule() WafRuleGroupActivatedRuleList {
	var returns WafRuleGroupActivatedRuleList
	_jsii_.Get(
		j,
		"activatedRule",
		&returns,
...
func (j *jsiiProxy_WafRuleGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafRuleGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewWafRuleGroup(scope constructs.Construct, id *string, config *WafRuleGroupConfig) WafRuleGroup {
	...
	if err := validateNewWafRuleGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WafRuleGroup) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
