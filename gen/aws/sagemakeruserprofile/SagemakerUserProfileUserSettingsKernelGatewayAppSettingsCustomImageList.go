...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsKernelGatewayAppSettingsCustomImageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
