...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy}.
type DataAwsCloudfrontOriginRequestPolicy interface {
	...
	CookiesConfig() DataAwsCloudfrontOriginRequestPolicyCookiesConfigList
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	HeadersConfig() DataAwsCloudfrontOriginRequestPolicyHeadersConfigList
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
	...
	QueryStringsConfig() DataAwsCloudfrontOriginRequestPolicyQueryStringsConfigList
	// Experimental.
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) CookiesConfig() DataAwsCloudfrontOriginRequestPolicyCookiesConfigList {
	var returns DataAwsCloudfrontOriginRequestPolicyCookiesConfigList
	_jsii_.Get(
		j,
		"cookiesConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) HeadersConfig() DataAwsCloudfrontOriginRequestPolicyHeadersConfigList {
	var returns DataAwsCloudfrontOriginRequestPolicyHeadersConfigList
	_jsii_.Get(
		j,
		"headersConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) QueryStringsConfig() DataAwsCloudfrontOriginRequestPolicyQueryStringsConfigList {
	var returns DataAwsCloudfrontOriginRequestPolicyQueryStringsConfigList
	_jsii_.Get(
		j,
		"queryStringsConfig",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudfront_origin_request_policy aws_cloudfront_origin_request_policy} Data Source.
func NewDataAwsCloudfrontOriginRequestPolicy(scope constructs.Construct, id *string, config *DataAwsCloudfrontOriginRequestPolicyConfig) DataAwsCloudfrontOriginRequestPolicy {
	...
	if err := validateNewDataAwsCloudfrontOriginRequestPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataAwsCloudfrontOriginRequestPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudfrontOriginRequestPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsCloudfrontOriginRequestPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCloudfrontOriginRequestPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudfrontOriginRequestPolicy_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudfrontOriginRequestPolicy_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCloudfrontOriginRequestPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCloudfrontOriginRequestPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCloudfrontOriginRequestPolicy) ToHclTerraform() interface{} {
	var returns interface{}
