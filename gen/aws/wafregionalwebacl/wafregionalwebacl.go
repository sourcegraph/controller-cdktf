...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_web_acl aws_wafregional_web_acl}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_web_acl aws_wafregional_web_acl} Resource.
func NewWafregionalWebAcl(scope constructs.Construct, id *string, config *WafregionalWebAclConfig) WafregionalWebAcl {
	_init_.Initialize()

	if err := validateNewWafregionalWebAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalWebAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalWebAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalWebAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalWebAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalWebAcl_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalWebAcl_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalWebAcl_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalWebAcl_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalWebAcl) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalWebAcl) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalWebAcl) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalWebAcl) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalWebAcl) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalWebAcl) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalWebAcl) PutLoggingConfiguration(value *WafregionalWebAclLoggingConfiguration) {
	if err := w.validatePutLoggingConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalWebAcl) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalWebAcl) ToHclTerraform() interface{} {
	var returns interface{}
