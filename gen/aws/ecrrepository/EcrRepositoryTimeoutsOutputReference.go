...
func (j *jsiiProxy_EcrRepositoryTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrRepositoryTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EcrRepositoryTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewEcrRepositoryTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EcrRepositoryTimeoutsOutputReference {
	...
	if err := validateNewEcrRepositoryTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEcrRepositoryTimeoutsOutputReference_Override(e EcrRepositoryTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (e *jsiiProxy_EcrRepositoryTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EcrRepositoryTimeoutsOutputReference) ToString() *string {
	var returns *string
