...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselasticbeanstalksolutionstack/internal"
)
...
func NewDataAwsElasticBeanstalkSolutionStack(scope constructs.Construct, id *string, config *DataAwsElasticBeanstalkSolutionStackConfig) DataAwsElasticBeanstalkSolutionStack {
	...
	if err := validateNewDataAwsElasticBeanstalkSolutionStackParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsElasticBeanstalkSolutionStack{}

	_jsii_.Create(
		"aws.dataAwsElasticBeanstalkSolutionStack.DataAwsElasticBeanstalkSolutionStack",
