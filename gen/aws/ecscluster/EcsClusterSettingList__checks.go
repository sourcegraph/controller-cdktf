...
func (e *jsiiProxy_EcsClusterSettingList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_EcsClusterSettingList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*EcsClusterSetting; received %#v (a %T)", val, val)
		}
	}
