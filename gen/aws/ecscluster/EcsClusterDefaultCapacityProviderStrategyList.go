...
func NewEcsClusterDefaultCapacityProviderStrategyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsClusterDefaultCapacityProviderStrategyList {
	...
	if err := validateNewEcsClusterDefaultCapacityProviderStrategyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsClusterDefaultCapacityProviderStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
