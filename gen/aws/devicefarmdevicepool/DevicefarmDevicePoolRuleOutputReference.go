...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/devicefarmdevicepool/internal"
)
...
func NewDevicefarmDevicePoolRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DevicefarmDevicePoolRuleOutputReference {
	...
	if err := validateNewDevicefarmDevicePoolRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
