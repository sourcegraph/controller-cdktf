...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxhostedprivatevirtualinterfaceaccepter/internal"
)
...
func NewDxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference {
	...
	if err := validateNewDxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference{}

	_jsii_.Create(
		"aws.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference",
