...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList {
	_init_.Initialize()
...
func NewDataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList_Override(d DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsEc2LocalGatewayVirtualInterfaceGroupFilterList) Resolve(_context cdktf.IResolveContext) interface{} {
