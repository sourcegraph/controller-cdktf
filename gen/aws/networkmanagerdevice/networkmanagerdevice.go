...
func (j *jsiiProxy_NetworkmanagerDevice) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkmanagerDevice) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NetworkmanagerDevice) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkmanagerDevice) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkmanagerDevice) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkmanagerDevice) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkmanagerDevice)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (n *jsiiProxy_NetworkmanagerDevice) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerDevice) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
