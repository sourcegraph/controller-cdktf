...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSourceS3Path", GoMethod: "PutSourceS3Path"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceS3PathInput", GoGetter: "SourceS3PathInput"},
