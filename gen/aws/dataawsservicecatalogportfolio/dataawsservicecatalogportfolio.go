...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/servicecatalog_portfolio aws_servicecatalog_portfolio}.
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolio) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsServicecatalogPortfolio) Timeouts() DataAwsServicecatalogPortfolioTimeoutsOutputReference {
	var returns DataAwsServicecatalogPortfolioTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsServicecatalogPortfolio(scope constructs.Construct, id *string, config *DataAwsServicecatalogPortfolioConfig) DataAwsServicecatalogPortfolio {
	...
	if err := validateNewDataAwsServicecatalogPortfolioParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServicecatalogPortfolio_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServicecatalogPortfolio_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolio) PutTimeouts(value *DataAwsServicecatalogPortfolioTimeouts) {
...
func (d *jsiiProxy_DataAwsServicecatalogPortfolio) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
