...
func (d *jsiiProxy_DataAwsConnectInstanceStorageConfigStorageConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsConnectInstanceStorageConfigStorageConfigList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsConnectInstanceStorageConfigStorageConfigList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsConnectInstanceStorageConfigStorageConfigList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
