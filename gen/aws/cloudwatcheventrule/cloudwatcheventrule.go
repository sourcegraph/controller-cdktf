...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatcheventrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_event_rule aws_cloudwatch_event_rule}.
...
func NewCloudwatchEventRule(scope constructs.Construct, id *string, config *CloudwatchEventRuleConfig) CloudwatchEventRule {
	...
	if err := validateNewCloudwatchEventRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudwatchEventRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchEventRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchEventRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchEventRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchEventRule) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchEventRule) MoveToId(id *string) {
