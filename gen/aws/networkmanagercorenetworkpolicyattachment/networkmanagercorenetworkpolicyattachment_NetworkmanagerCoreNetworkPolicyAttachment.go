...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/networkmanagercorenetworkpolicyattachment/internal"
)
...
func (j *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func NewNetworkmanagerCoreNetworkPolicyAttachment(scope constructs.Construct, id *string, config *NetworkmanagerCoreNetworkPolicyAttachmentConfig) NetworkmanagerCoreNetworkPolicyAttachment {
	...
	_jsii_.Create(
		"aws.networkmanagerCoreNetworkPolicyAttachment.NetworkmanagerCoreNetworkPolicyAttachment",
...
func (j *jsiiProxy_NetworkmanagerCoreNetworkPolicyAttachment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
