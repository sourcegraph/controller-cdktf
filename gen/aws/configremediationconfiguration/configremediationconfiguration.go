...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/config_remediation_configuration aws_config_remediation_configuration}.
...
func ConfigRemediationConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConfigRemediationConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigRemediationConfiguration) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) MoveToId(id *string) {
