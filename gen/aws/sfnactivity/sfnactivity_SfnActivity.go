...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sfnactivity/internal"
)
...
func (j *jsiiProxy_SfnActivity) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SfnActivity) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSfnActivity(scope constructs.Construct, id *string, config *SfnActivityConfig) SfnActivity {
	...
	if err := validateNewSfnActivityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SfnActivity) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
