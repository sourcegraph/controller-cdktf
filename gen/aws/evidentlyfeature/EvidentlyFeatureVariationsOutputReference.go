...
type EvidentlyFeatureVariationsOutputReference interface {
	...
	ValueInput() *EvidentlyFeatureVariationsValue
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	PutValue(value *EvidentlyFeatureVariationsValue)
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference) Value() EvidentlyFeatureVariationsValueOutputReference {
	var returns EvidentlyFeatureVariationsValueOutputReference
	_jsii_.Get(
		j,
		"value",
		&returns,
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference) ValueInput() *EvidentlyFeatureVariationsValue {
...
func (j *jsiiProxy_EvidentlyFeatureVariationsOutputReference)SetName(val *string) {
...
func (e *jsiiProxy_EvidentlyFeatureVariationsOutputReference) PutValue(value *EvidentlyFeatureVariationsValue) {
