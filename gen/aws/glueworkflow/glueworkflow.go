...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/glueworkflow/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_workflow aws_glue_workflow}.
...
func (j *jsiiProxy_GlueWorkflow) Connection() interface{} {
...
func (j *jsiiProxy_GlueWorkflow) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GlueWorkflow) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueWorkflow) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_workflow aws_glue_workflow} Resource.
func NewGlueWorkflow(scope constructs.Construct, id *string, config *GlueWorkflowConfig) GlueWorkflow {
	_init_.Initialize()

	if err := validateNewGlueWorkflowParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueWorkflow)SetConnection(val interface{}) {
...
func (j *jsiiProxy_GlueWorkflow)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GlueWorkflow)SetId(val *string) {
...
func (j *jsiiProxy_GlueWorkflow)SetProvisioners(val *[]interface{}) {
...
func GlueWorkflow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueWorkflow_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GlueWorkflow_IsConstruct(x interface{}) *bool {
	...
	if err := validateGlueWorkflow_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GlueWorkflow_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlueWorkflow_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GlueWorkflow_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlueWorkflow_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GlueWorkflow) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueWorkflow) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueWorkflow) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueWorkflow) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueWorkflow) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GlueWorkflow) MoveToId(id *string) {
...
func (g *jsiiProxy_GlueWorkflow) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GlueWorkflow) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlueWorkflow) ToHclTerraform() interface{} {
	var returns interface{}
