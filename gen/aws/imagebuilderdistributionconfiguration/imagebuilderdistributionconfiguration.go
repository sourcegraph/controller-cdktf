...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/imagebuilder_distribution_configuration aws_imagebuilder_distribution_configuration}.
...
func NewImagebuilderDistributionConfiguration(scope constructs.Construct, id *string, config *ImagebuilderDistributionConfigurationConfig) ImagebuilderDistributionConfiguration {
	...
	_jsii_.Create(
		"aws.imagebuilderDistributionConfiguration.ImagebuilderDistributionConfiguration",
