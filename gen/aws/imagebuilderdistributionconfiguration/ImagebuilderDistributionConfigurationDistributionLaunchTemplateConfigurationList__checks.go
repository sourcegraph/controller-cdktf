...
func (i *jsiiProxy_ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfigurationList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (i *jsiiProxy_ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfigurationList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfigurationList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfiguration:
		val_ := val.([]*ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfiguration)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfigurationList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ImagebuilderDistributionConfigurationDistributionLaunchTemplateConfigurationList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
