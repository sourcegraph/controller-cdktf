...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dbproxytarget/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/db_proxy_target aws_db_proxy_target}.
...
func (j *jsiiProxy_DbProxyTarget) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbProxyTarget) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDbProxyTarget(scope constructs.Construct, id *string, config *DbProxyTargetConfig) DbProxyTarget {
	...
	if err := validateNewDbProxyTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbProxyTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDbProxyTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DbProxyTarget) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DbProxyTarget) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbProxyTarget) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbProxyTarget) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbProxyTarget) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbProxyTarget) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DbProxyTarget) MoveFromId(id *string) {
...
func (d *jsiiProxy_DbProxyTarget) MoveToId(id *string) {
...
func (d *jsiiProxy_DbProxyTarget) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
