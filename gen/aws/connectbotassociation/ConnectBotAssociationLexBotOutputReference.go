...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/connectbotassociation/internal"
)
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewConnectBotAssociationLexBotOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConnectBotAssociationLexBotOutputReference {
	_init_.Initialize()

	if err := validateNewConnectBotAssociationLexBotOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewConnectBotAssociationLexBotOutputReference_Override(c ConnectBotAssociationLexBotOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ConnectBotAssociationLexBotOutputReference)SetLexRegion(val *string) {
	if err := j.validateSetLexRegionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_ConnectBotAssociationLexBotOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConnectBotAssociationLexBotOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ConnectBotAssociationLexBotOutputReference) ToString() *string {
	var returns *string
