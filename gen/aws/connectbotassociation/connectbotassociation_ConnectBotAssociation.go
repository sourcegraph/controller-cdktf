...
func (j *jsiiProxy_ConnectBotAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectBotAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewConnectBotAssociation(scope constructs.Construct, id *string, config *ConnectBotAssociationConfig) ConnectBotAssociation {
	...
	if err := validateNewConnectBotAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectBotAssociation) PutLexBot(value *ConnectBotAssociationLexBot) {
	if err := c.validatePutLexBotParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConnectBotAssociation) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
