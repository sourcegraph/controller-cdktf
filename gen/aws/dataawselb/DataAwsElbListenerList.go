...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselb/internal"
)
...
func NewDataAwsElbListenerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsElbListenerList {
	...
	if err := validateNewDataAwsElbListenerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsElbListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
