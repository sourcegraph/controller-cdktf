...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudfrontfieldlevelencryptionprofile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudfront_field_level_encryption_profile aws_cloudfront_field_level_encryption_profile}.
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) Connection() interface{} {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudfront_field_level_encryption_profile aws_cloudfront_field_level_encryption_profile} Resource.
func NewCloudfrontFieldLevelEncryptionProfile(scope constructs.Construct, id *string, config *CloudfrontFieldLevelEncryptionProfileConfig) CloudfrontFieldLevelEncryptionProfile {
	...
	if err := validateNewCloudfrontFieldLevelEncryptionProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile)SetId(val *string) {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfile)SetProvisioners(val *[]interface{}) {
...
func CloudfrontFieldLevelEncryptionProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudfrontFieldLevelEncryptionProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudfrontFieldLevelEncryptionProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudfrontFieldLevelEncryptionProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudfrontFieldLevelEncryptionProfile_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontFieldLevelEncryptionProfile_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudfrontFieldLevelEncryptionProfile_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudfrontFieldLevelEncryptionProfile_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) PutEncryptionEntities(value *CloudfrontFieldLevelEncryptionProfileEncryptionEntities) {
	if err := c.validatePutEncryptionEntitiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfile) ToHclTerraform() interface{} {
	var returns interface{}
