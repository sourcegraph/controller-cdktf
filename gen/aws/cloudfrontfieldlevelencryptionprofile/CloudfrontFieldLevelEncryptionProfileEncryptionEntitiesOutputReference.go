...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) Items() CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesItemsList {
	var returns CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesItemsList
	_jsii_.Get(
		j,
		"items",
		&returns,
...
func NewCloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference {
	...
	if err := validateNewCloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) PutItems(value interface{}) {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontFieldLevelEncryptionProfileEncryptionEntitiesOutputReference) ToString() *string {
	var returns *string
