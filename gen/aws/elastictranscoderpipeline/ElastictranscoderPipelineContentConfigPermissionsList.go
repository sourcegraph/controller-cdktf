...
func NewElastictranscoderPipelineContentConfigPermissionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElastictranscoderPipelineContentConfigPermissionsList {
	...
	if err := validateNewElastictranscoderPipelineContentConfigPermissionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastictranscoderPipelineContentConfigPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
