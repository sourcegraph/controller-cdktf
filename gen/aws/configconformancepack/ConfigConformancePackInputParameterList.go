...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/configconformancepack/internal"
)
...
func NewConfigConformancePackInputParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfigConformancePackInputParameterList {
	...
	if err := validateNewConfigConformancePackInputParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfigConformancePackInputParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
