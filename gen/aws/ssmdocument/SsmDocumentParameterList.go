...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmdocument/internal"
)
...
func NewSsmDocumentParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmDocumentParameterList {
	...
	if err := validateNewSsmDocumentParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmDocumentParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
