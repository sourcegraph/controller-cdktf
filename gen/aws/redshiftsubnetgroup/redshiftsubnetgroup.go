...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftsubnetgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshift_subnet_group aws_redshift_subnet_group}.
...
func NewRedshiftSubnetGroup(scope constructs.Construct, id *string, config *RedshiftSubnetGroupConfig) RedshiftSubnetGroup {
	...
	if err := validateNewRedshiftSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftSubnetGroup) AddMoveTarget(moveTarget *string) {
