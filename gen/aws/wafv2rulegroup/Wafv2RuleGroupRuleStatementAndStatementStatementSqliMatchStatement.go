...
type Wafv2RuleGroupRuleStatementAndStatementStatementSqliMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
