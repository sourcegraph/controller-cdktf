...
type Wafv2RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
