...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) Action() Wafv2RuleGroupRuleActionOutputReference {
	var returns Wafv2RuleGroupRuleActionOutputReference
	_jsii_.Get(
		j,
		"action",
		&returns,
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) ActionInput() *Wafv2RuleGroupRuleAction {
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) PriorityInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priorityInput",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) RuleLabel() Wafv2RuleGroupRuleRuleLabelList {
	var returns Wafv2RuleGroupRuleRuleLabelList
	_jsii_.Get(
		j,
		"ruleLabel",
		&returns,
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) VisibilityConfig() Wafv2RuleGroupRuleVisibilityConfigOutputReference {
	var returns Wafv2RuleGroupRuleVisibilityConfigOutputReference
	_jsii_.Get(
		j,
		"visibilityConfig",
		&returns,
...
func (j *jsiiProxy_Wafv2RuleGroupRuleOutputReference) VisibilityConfigInput() *Wafv2RuleGroupRuleVisibilityConfig {
	var returns *Wafv2RuleGroupRuleVisibilityConfig
	_jsii_.Get(
		j,
...
func NewWafv2RuleGroupRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) Wafv2RuleGroupRuleOutputReference {
	...
	_jsii_.Create(
		"aws.wafv2RuleGroup.Wafv2RuleGroupRuleOutputReference",
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) PutAction(value *Wafv2RuleGroupRuleAction) {
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) ResetRuleLabel() {
	_jsii_.InvokeVoid(
		w,
		"resetRuleLabel",
		nil, // no parameters
...
func (w *jsiiProxy_Wafv2RuleGroupRuleOutputReference) ToString() *string {
	var returns *string
