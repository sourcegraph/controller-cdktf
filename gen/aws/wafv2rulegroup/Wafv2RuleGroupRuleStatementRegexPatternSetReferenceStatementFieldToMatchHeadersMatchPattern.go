...
type Wafv2RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeadersMatchPattern struct {
	// all block.
	//
	...
	All *Wafv2RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeadersMatchPatternAll `field:"optional" json:"all" yaml:"all"`
