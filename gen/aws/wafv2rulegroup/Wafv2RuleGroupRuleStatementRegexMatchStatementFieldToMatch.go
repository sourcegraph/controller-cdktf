...
type Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatch struct {
	...
	AllQueryArguments *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchAllQueryArguments `field:"optional" json:"allQueryArguments" yaml:"allQueryArguments"`
	// body block.
	//
	...
	Body *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchBody `field:"optional" json:"body" yaml:"body"`
	// cookies block.
	//
	...
	Cookies *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies `field:"optional" json:"cookies" yaml:"cookies"`
	// headers block.
	//
	...
	JsonBody *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody `field:"optional" json:"jsonBody" yaml:"jsonBody"`
	// method block.
	//
	...
	Method *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchMethod `field:"optional" json:"method" yaml:"method"`
	// query_string block.
	//
	...
	QueryString *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchQueryString `field:"optional" json:"queryString" yaml:"queryString"`
	// single_header block.
	//
	...
	SingleHeader *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleHeader `field:"optional" json:"singleHeader" yaml:"singleHeader"`
	...
	SingleQueryArgument *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchSingleQueryArgument `field:"optional" json:"singleQueryArgument" yaml:"singleQueryArgument"`
	// uri_path block.
	//
	...
	UriPath *Wafv2RuleGroupRuleStatementRegexMatchStatementFieldToMatchUriPath `field:"optional" json:"uriPath" yaml:"uriPath"`
}
