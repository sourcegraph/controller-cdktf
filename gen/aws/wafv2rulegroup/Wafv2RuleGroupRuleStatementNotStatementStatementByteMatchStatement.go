...
type Wafv2RuleGroupRuleStatementNotStatementStatementByteMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementNotStatementStatementByteMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
