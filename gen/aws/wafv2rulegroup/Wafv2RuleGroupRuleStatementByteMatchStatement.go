...
type Wafv2RuleGroupRuleStatementByteMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementByteMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
