...
type Wafv2RuleGroupRuleStatementAndStatementStatementRegexMatchStatement struct {
	...
	FieldToMatch *Wafv2RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatch `field:"optional" json:"fieldToMatch" yaml:"fieldToMatch"`
}
