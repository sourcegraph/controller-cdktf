...
type Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList
type jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewWafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList {
	...
	if err := validateNewWafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) Get(index *float64) Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderOutputReference
...
func (w *jsiiProxy_Wafv2RuleGroupRuleActionAllowCustomRequestHandlingInsertHeaderList) ToString() *string {
	var returns *string
