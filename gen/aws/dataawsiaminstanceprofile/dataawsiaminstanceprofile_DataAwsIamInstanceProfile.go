...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiaminstanceprofile/internal"
)
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamInstanceProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamInstanceProfile(scope constructs.Construct, id *string, config *DataAwsIamInstanceProfileConfig) DataAwsIamInstanceProfile {
	...
	if err := validateNewDataAwsIamInstanceProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsIamInstanceProfile{}

	_jsii_.Create(
		"aws.dataAwsIamInstanceProfile.DataAwsIamInstanceProfile",
...
func (j *jsiiProxy_DataAwsIamInstanceProfile)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamInstanceProfile)SetId(val *string) {
...
func DataAwsIamInstanceProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIamInstanceProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamInstanceProfile) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
