...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/natgateway/internal"
)
...
func (j *jsiiProxy_NatGateway) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NatGateway)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
