...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmparameter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssm_parameter aws_ssm_parameter}.
...
func NewSsmParameter(scope constructs.Construct, id *string, config *SsmParameterConfig) SsmParameter {
	...
	if err := validateNewSsmParameterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SsmParameter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsmParameter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmParameter) AddMoveTarget(moveTarget *string) {
