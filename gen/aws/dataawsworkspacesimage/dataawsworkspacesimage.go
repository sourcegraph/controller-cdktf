...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsworkspacesimage/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/workspaces_image aws_workspaces_image}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/workspaces_image aws_workspaces_image} Data Source.
func NewDataAwsWorkspacesImage(scope constructs.Construct, id *string, config *DataAwsWorkspacesImageConfig) DataAwsWorkspacesImage {
	...
	if err := validateNewDataAwsWorkspacesImageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsWorkspacesImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWorkspacesImage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWorkspacesImage_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWorkspacesImage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWorkspacesImage_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWorkspacesImage_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWorkspacesImage_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWorkspacesImage_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWorkspacesImage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWorkspacesImage) ToHclTerraform() interface{} {
	var returns interface{}
