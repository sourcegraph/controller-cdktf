...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/imagebuilder_distribution_configurations aws_imagebuilder_distribution_configurations}.
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfigurations) Filter() DataAwsImagebuilderDistributionConfigurationsFilterList {
	var returns DataAwsImagebuilderDistributionConfigurationsFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsImagebuilderDistributionConfigurations) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsImagebuilderDistributionConfigurations(scope constructs.Construct, id *string, config *DataAwsImagebuilderDistributionConfigurationsConfig) DataAwsImagebuilderDistributionConfigurations {
	...
	if err := validateNewDataAwsImagebuilderDistributionConfigurationsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsImagebuilderDistributionConfigurations) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
