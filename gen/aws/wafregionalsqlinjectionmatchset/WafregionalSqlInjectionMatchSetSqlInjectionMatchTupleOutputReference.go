...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalsqlinjectionmatchset/internal"
)
...
func NewWafregionalSqlInjectionMatchSetSqlInjectionMatchTupleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleOutputReference {
	...
	if err := validateNewWafregionalSqlInjectionMatchSetSqlInjectionMatchTupleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
