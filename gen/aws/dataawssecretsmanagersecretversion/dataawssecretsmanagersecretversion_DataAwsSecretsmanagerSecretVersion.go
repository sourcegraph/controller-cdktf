...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssecretsmanagersecretversion/internal"
)
...
func NewDataAwsSecretsmanagerSecretVersion(scope constructs.Construct, id *string, config *DataAwsSecretsmanagerSecretVersionConfig) DataAwsSecretsmanagerSecretVersion {
	...
	if err := validateNewDataAwsSecretsmanagerSecretVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
