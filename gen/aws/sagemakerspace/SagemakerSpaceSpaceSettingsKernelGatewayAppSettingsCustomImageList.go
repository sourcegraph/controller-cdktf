...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsKernelGatewayAppSettingsCustomImageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
