...
func NewMskconnectConnectorPluginList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MskconnectConnectorPluginList {
	...
	if err := validateNewMskconnectConnectorPluginListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MskconnectConnectorPluginList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
