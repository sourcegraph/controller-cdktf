...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_ml_transform aws_glue_ml_transform}.
...
func (j *jsiiProxy_GlueMlTransform) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GlueMlTransform) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlueMlTransform) InputRecordTables() GlueMlTransformInputRecordTablesList {
	var returns GlueMlTransformInputRecordTablesList
	_jsii_.Get(
		j,
		"inputRecordTables",
		&returns,
...
func (j *jsiiProxy_GlueMlTransform) Schema() GlueMlTransformSchemaList {
	var returns GlueMlTransformSchemaList
	_jsii_.Get(
		j,
		"schema",
		&returns,
...
func GlueMlTransform_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GlueMlTransform) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueMlTransform) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
