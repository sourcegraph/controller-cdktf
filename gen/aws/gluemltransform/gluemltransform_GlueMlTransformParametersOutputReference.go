...
func (j *jsiiProxy_GlueMlTransformParametersOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueMlTransformParametersOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueMlTransformParametersOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueMlTransformParametersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueMlTransformParametersOutputReference {
	...
	if err := validateNewGlueMlTransformParametersOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueMlTransformParametersOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueMlTransformParametersOutputReference) PutFindMatchesParameters(value *GlueMlTransformParametersFindMatchesParameters) {
	if err := g.validatePutFindMatchesParametersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
...
func (g *jsiiProxy_GlueMlTransformParametersOutputReference) ToString() *string {
	var returns *string
