...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lightsaildiskattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_disk_attachment aws_lightsail_disk_attachment}.
...
type jsiiProxy_LightsailDiskAttachment struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_LightsailDiskAttachment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LightsailDiskAttachment) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LightsailDiskAttachment) DiskName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"diskName",
...
func (j *jsiiProxy_LightsailDiskAttachment) DiskNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"diskNameInput",
...
func (j *jsiiProxy_LightsailDiskAttachment) DiskPath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"diskPath",
...
func (j *jsiiProxy_LightsailDiskAttachment) DiskPathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"diskPathInput",
...
func (j *jsiiProxy_LightsailDiskAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LightsailDiskAttachment) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LightsailDiskAttachment) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LightsailDiskAttachment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LightsailDiskAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LightsailDiskAttachment) InstanceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceName",
...
func (j *jsiiProxy_LightsailDiskAttachment) InstanceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceNameInput",
...
func (j *jsiiProxy_LightsailDiskAttachment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailDiskAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_LightsailDiskAttachment) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LightsailDiskAttachment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LightsailDiskAttachment) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewLightsailDiskAttachment(scope constructs.Construct, id *string, config *LightsailDiskAttachmentConfig) LightsailDiskAttachment {
	...
	if err := validateNewLightsailDiskAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LightsailDiskAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailDiskAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LightsailDiskAttachment_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.lightsailDiskAttachment.LightsailDiskAttachment",
...
func (l *jsiiProxy_LightsailDiskAttachment) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LightsailDiskAttachment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LightsailDiskAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LightsailDiskAttachment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailDiskAttachment) MoveFromId(id *string) {
...
func (l *jsiiProxy_LightsailDiskAttachment) MoveToId(id *string) {
...
func (l *jsiiProxy_LightsailDiskAttachment) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LightsailDiskAttachment) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDiskAttachment) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDiskAttachment) ToString() *string {
	var returns *string
