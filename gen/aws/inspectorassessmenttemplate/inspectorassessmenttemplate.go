...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/inspectorassessmenttemplate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/inspector_assessment_template aws_inspector_assessment_template}.
...
func (j *jsiiProxy_InspectorAssessmentTemplate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_InspectorAssessmentTemplate) Tags() *map[string]*string {
...
func (j *jsiiProxy_InspectorAssessmentTemplate) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_InspectorAssessmentTemplate) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_InspectorAssessmentTemplate) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
