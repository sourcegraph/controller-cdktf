...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxconnectionconfirmation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_connection_confirmation aws_dx_connection_confirmation} Resource.
func NewDxConnectionConfirmation(scope constructs.Construct, id *string, config *DxConnectionConfirmationConfig) DxConnectionConfirmation {
	...
	if err := validateNewDxConnectionConfirmationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DxConnectionConfirmation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDxConnectionConfirmation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DxConnectionConfirmation_IsConstruct(x interface{}) *bool {
	...
	if err := validateDxConnectionConfirmation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxConnectionConfirmation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxConnectionConfirmation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxConnectionConfirmation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxConnectionConfirmation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DxConnectionConfirmation) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxConnectionConfirmation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DxConnectionConfirmation) ToHclTerraform() interface{} {
	var returns interface{}
