...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/shieldprotectiongroup/internal"
)
...
func (j *jsiiProxy_ShieldProtectionGroup) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ShieldProtectionGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ShieldProtectionGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ShieldProtectionGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_ShieldProtectionGroup) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_ShieldProtectionGroup) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_ShieldProtectionGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewShieldProtectionGroup(scope constructs.Construct, id *string, config *ShieldProtectionGroupConfig) ShieldProtectionGroup {
	...
	if err := validateNewShieldProtectionGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ShieldProtectionGroup)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (s *jsiiProxy_ShieldProtectionGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_ShieldProtectionGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_ShieldProtectionGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_ShieldProtectionGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_ShieldProtectionGroup) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
