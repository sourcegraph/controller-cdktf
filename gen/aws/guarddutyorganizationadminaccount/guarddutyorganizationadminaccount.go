...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/guarddutyorganizationadminaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/guardduty_organization_admin_account aws_guardduty_organization_admin_account}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/guardduty_organization_admin_account aws_guardduty_organization_admin_account} Resource.
func NewGuarddutyOrganizationAdminAccount(scope constructs.Construct, id *string, config *GuarddutyOrganizationAdminAccountConfig) GuarddutyOrganizationAdminAccount {
	...
	if err := validateNewGuarddutyOrganizationAdminAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GuarddutyOrganizationAdminAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyOrganizationAdminAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func GuarddutyOrganizationAdminAccount_IsConstruct(x interface{}) *bool {
	...
	if err := validateGuarddutyOrganizationAdminAccount_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GuarddutyOrganizationAdminAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGuarddutyOrganizationAdminAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GuarddutyOrganizationAdminAccount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGuarddutyOrganizationAdminAccount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) MoveFromId(id *string) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) MoveToId(id *string) {
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GuarddutyOrganizationAdminAccount) ToHclTerraform() interface{} {
	var returns interface{}
