...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/acm_certificate aws_acm_certificate}.
...
func NewAcmCertificate(scope constructs.Construct, id *string, config *AcmCertificateConfig) AcmCertificate {
	...
	if err := validateNewAcmCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AcmCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAcmCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmCertificate) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AcmCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AcmCertificate) MoveFromId(id *string) {
...
func (a *jsiiProxy_AcmCertificate) MoveToId(id *string) {
