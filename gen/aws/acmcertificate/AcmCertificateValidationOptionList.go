...
func NewAcmCertificateValidationOptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AcmCertificateValidationOptionList {
	...
	if err := validateNewAcmCertificateValidationOptionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AcmCertificateValidationOptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
