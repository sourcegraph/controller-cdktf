...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elbattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/elb_attachment aws_elb_attachment}.
...
func ElbAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ElbAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
