...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueCrawlerRecrawlPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueCrawlerRecrawlPolicyOutputReference {
	...
	if err := validateNewGlueCrawlerRecrawlPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference)SetRecrawlBehavior(val *string) {
	if err := j.validateSetRecrawlBehaviorParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueCrawlerRecrawlPolicyOutputReference) ToString() *string {
	var returns *string
