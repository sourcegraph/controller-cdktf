...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/codebuildreportgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codebuild_report_group aws_codebuild_report_group}.
...
func NewCodebuildReportGroup(scope constructs.Construct, id *string, config *CodebuildReportGroupConfig) CodebuildReportGroup {
	...
	if err := validateNewCodebuildReportGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodebuildReportGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodebuildReportGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodebuildReportGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodebuildReportGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodebuildReportGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodebuildReportGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_CodebuildReportGroup) PutExportConfig(value *CodebuildReportGroupExportConfig) {
	if err := c.validatePutExportConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
