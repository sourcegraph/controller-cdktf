...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/guarddutypublishingdestination/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/guardduty_publishing_destination aws_guardduty_publishing_destination}.
...
func NewGuarddutyPublishingDestination(scope constructs.Construct, id *string, config *GuarddutyPublishingDestinationConfig) GuarddutyPublishingDestination {
	...
	if err := validateNewGuarddutyPublishingDestinationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GuarddutyPublishingDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGuarddutyPublishingDestination_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GuarddutyPublishingDestination) AddMoveTarget(moveTarget *string) {
