...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/kms_secret aws_kms_secret}.
...
func (j *jsiiProxy_DataAwsKmsSecret) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsSecret) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsKmsSecret) Secret() DataAwsKmsSecretSecretList {
	var returns DataAwsKmsSecretSecretList
	_jsii_.Get(
		j,
		"secret",
		&returns,
...
func NewDataAwsKmsSecret(scope constructs.Construct, id *string, config *DataAwsKmsSecretConfig) DataAwsKmsSecret {
	...
	if err := validateNewDataAwsKmsSecretParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsKmsSecret_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsKmsSecret_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsKmsSecret) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
