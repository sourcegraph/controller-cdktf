...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/auditmanagerassessmentreport/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/auditmanager_assessment_report aws_auditmanager_assessment_report}.
...
type jsiiProxy_AuditmanagerAssessmentReport struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AuditmanagerAssessmentReport) AssessmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assessmentId",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) AssessmentIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assessmentIdInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Author() *string {
	var returns *string
	_jsii_.Get(
		j,
		"author",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Node() constructs.Node {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AuditmanagerAssessmentReport) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAuditmanagerAssessmentReport(scope constructs.Construct, id *string, config *AuditmanagerAssessmentReportConfig) AuditmanagerAssessmentReport {
	...
	if err := validateNewAuditmanagerAssessmentReportParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AuditmanagerAssessmentReport_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAuditmanagerAssessmentReport_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AuditmanagerAssessmentReport_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.auditmanagerAssessmentReport.AuditmanagerAssessmentReport",
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) ResetDescription() {
	_jsii_.InvokeVoid(
		a,
		"resetDescription",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAssessmentReport) ToString() *string {
	var returns *string
