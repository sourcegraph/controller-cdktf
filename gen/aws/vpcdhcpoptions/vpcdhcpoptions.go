...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpcdhcpoptions/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_dhcp_options aws_vpc_dhcp_options}.
...
func (j *jsiiProxy_VpcDhcpOptions) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VpcDhcpOptions) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_VpcDhcpOptions) DomainNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainNameInput",
...
func (j *jsiiProxy_VpcDhcpOptions) DomainNameServers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"domainNameServers",
...
func (j *jsiiProxy_VpcDhcpOptions) DomainNameServersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcDhcpOptions) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VpcDhcpOptions) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VpcDhcpOptions) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VpcDhcpOptions) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcDhcpOptions) NetbiosNameServers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"netbiosNameServers",
...
func (j *jsiiProxy_VpcDhcpOptions) NetbiosNameServersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcDhcpOptions) NetbiosNodeType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"netbiosNodeType",
...
func (j *jsiiProxy_VpcDhcpOptions) NetbiosNodeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcDhcpOptions) Node() constructs.Node {
...
func (j *jsiiProxy_VpcDhcpOptions) NtpServers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ntpServers",
...
func (j *jsiiProxy_VpcDhcpOptions) NtpServersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ntpServersInput",
...
func (j *jsiiProxy_VpcDhcpOptions) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_VpcDhcpOptions) Tags() *map[string]*string {
...
func (j *jsiiProxy_VpcDhcpOptions) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_VpcDhcpOptions) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_VpcDhcpOptions) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_VpcDhcpOptions) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewVpcDhcpOptions(scope constructs.Construct, id *string, config *VpcDhcpOptionsConfig) VpcDhcpOptions {
	...
	if err := validateNewVpcDhcpOptionsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VpcDhcpOptions_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.vpcDhcpOptions.VpcDhcpOptions",
...
func (v *jsiiProxy_VpcDhcpOptions) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcDhcpOptions) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcDhcpOptions) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VpcDhcpOptions) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VpcDhcpOptions) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcDhcpOptions) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcDhcpOptions) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VpcDhcpOptions) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcDhcpOptions) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VpcDhcpOptions) ResetDomainName() {
	_jsii_.InvokeVoid(
		v,
		"resetDomainName",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetDomainNameServers() {
	_jsii_.InvokeVoid(
		v,
		"resetDomainNameServers",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetNetbiosNameServers() {
	_jsii_.InvokeVoid(
		v,
		"resetNetbiosNameServers",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetNetbiosNodeType() {
	_jsii_.InvokeVoid(
		v,
		"resetNetbiosNodeType",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetNtpServers() {
	_jsii_.InvokeVoid(
		v,
		"resetNtpServers",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetTags() {
	_jsii_.InvokeVoid(
		v,
		"resetTags",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ResetTagsAll() {
	_jsii_.InvokeVoid(
		v,
		"resetTagsAll",
		nil, // no parameters
...
func (v *jsiiProxy_VpcDhcpOptions) ToString() *string {
	var returns *string
