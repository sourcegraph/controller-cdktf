...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appconfigapplication/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appconfig_application aws_appconfig_application}.
...
func (j *jsiiProxy_AppconfigApplication) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AppconfigApplication) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAppconfigApplication(scope constructs.Construct, id *string, config *AppconfigApplicationConfig) AppconfigApplication {
	...
	if err := validateNewAppconfigApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppconfigApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppconfigApplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppconfigApplication) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppconfigApplication) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppconfigApplication) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppconfigApplication) MoveToId(id *string) {
...
func (a *jsiiProxy_AppconfigApplication) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
