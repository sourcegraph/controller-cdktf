...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/evidently_launch aws_evidently_launch}.
...
func (j *jsiiProxy_EvidentlyLaunch) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_EvidentlyLaunch) Execution() EvidentlyLaunchExecutionList {
	var returns EvidentlyLaunchExecutionList
	_jsii_.Get(
		j,
		"execution",
		&returns,
...
func (j *jsiiProxy_EvidentlyLaunch) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EvidentlyLaunch) LastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedTime",
...
func (j *jsiiProxy_EvidentlyLaunch) ScheduledSplitsConfigInput() *EvidentlyLaunchScheduledSplitsConfig {
...
func (j *jsiiProxy_EvidentlyLaunch) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_EvidentlyLaunch) StatusReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statusReason",
...
func (j *jsiiProxy_EvidentlyLaunch) Tags() *map[string]*string {
...
func (j *jsiiProxy_EvidentlyLaunch) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_EvidentlyLaunch) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_EvidentlyLaunch) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_EvidentlyLaunch) Timeouts() EvidentlyLaunchTimeoutsOutputReference {
	var returns EvidentlyLaunchTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_EvidentlyLaunch) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (e *jsiiProxy_EvidentlyLaunch) PutScheduledSplitsConfig(value *EvidentlyLaunchScheduledSplitsConfig) {
...
func (e *jsiiProxy_EvidentlyLaunch) PutTimeouts(value *EvidentlyLaunchTimeouts) {
...
func (e *jsiiProxy_EvidentlyLaunch) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EvidentlyLaunch) ResetScheduledSplitsConfig() {
	_jsii_.InvokeVoid(
		e,
		"resetScheduledSplitsConfig",
		nil, // no parameters
...
func (e *jsiiProxy_EvidentlyLaunch) ResetTagsAll() {
	_jsii_.InvokeVoid(
		e,
		"resetTagsAll",
		nil, // no parameters
...
func (e *jsiiProxy_EvidentlyLaunch) ResetTimeouts() {
	_jsii_.InvokeVoid(
		e,
		"resetTimeouts",
		nil, // no parameters
