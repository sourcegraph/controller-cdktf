package dataawsbillingserviceaccount
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsbillingserviceaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/billing_service_account aws_billing_service_account}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/billing_service_account aws_billing_service_account} Data Source.
func NewDataAwsBillingServiceAccount(scope constructs.Construct, id *string, config *DataAwsBillingServiceAccountConfig) DataAwsBillingServiceAccount {
	...
	if err := validateNewDataAwsBillingServiceAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsBillingServiceAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBillingServiceAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsBillingServiceAccount_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsBillingServiceAccount_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsBillingServiceAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsBillingServiceAccount) ToHclTerraform() interface{} {
	var returns interface{}
