...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/appmesh_virtual_service aws_appmesh_virtual_service}.
...
type jsiiProxy_DataAwsAppmeshVirtualService struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataAwsAppmeshVirtualService) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) CreatedDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdDate",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) LastUpdatedDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdatedDate",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) MeshName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"meshName",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) MeshNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"meshNameInput",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) MeshOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"meshOwner",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) MeshOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"meshOwnerInput",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Node() constructs.Node {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Spec() DataAwsAppmeshVirtualServiceSpecList {
	var returns DataAwsAppmeshVirtualServiceSpecList
	_jsii_.Get(
		j,
		"spec",
		&returns,
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsAppmeshVirtualService) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataAwsAppmeshVirtualService(scope constructs.Construct, id *string, config *DataAwsAppmeshVirtualServiceConfig) DataAwsAppmeshVirtualService {
	...
	if err := validateNewDataAwsAppmeshVirtualServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsAppmeshVirtualService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataAwsAppmeshVirtualService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) ResetMeshOwner() {
	_jsii_.InvokeVoid(
		d,
		"resetMeshOwner",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAppmeshVirtualService) ToString() *string {
	var returns *string
