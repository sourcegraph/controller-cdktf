...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/detectiveinvitationaccepter/internal"
)
...
func (j *jsiiProxy_DetectiveInvitationAccepter) Connection() interface{} {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DetectiveInvitationAccepter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DetectiveInvitationAccepter) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewDetectiveInvitationAccepter(scope constructs.Construct, id *string, config *DetectiveInvitationAccepterConfig) DetectiveInvitationAccepter {
	...
	if err := validateNewDetectiveInvitationAccepterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetConnection(val interface{}) {
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetId(val *string) {
...
func (j *jsiiProxy_DetectiveInvitationAccepter)SetProvisioners(val *[]interface{}) {
...
func DetectiveInvitationAccepter_IsConstruct(x interface{}) *bool {
	...
	if err := validateDetectiveInvitationAccepter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DetectiveInvitationAccepter) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
