...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/detectivegraph/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/detective_graph aws_detective_graph}.
...
func (j *jsiiProxy_DetectiveGraph) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DetectiveGraph) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDetectiveGraph(scope constructs.Construct, id *string, config *DetectiveGraphConfig) DetectiveGraph {
	...
	if err := validateNewDetectiveGraphParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DetectiveGraph_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDetectiveGraph_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DetectiveGraph) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DetectiveGraph) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DetectiveGraph) MoveFromId(id *string) {
...
func (d *jsiiProxy_DetectiveGraph) MoveToId(id *string) {
...
func (d *jsiiProxy_DetectiveGraph) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
