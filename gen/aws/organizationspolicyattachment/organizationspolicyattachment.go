...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/organizationspolicyattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/organizations_policy_attachment aws_organizations_policy_attachment}.
...
func NewOrganizationsPolicyAttachment(scope constructs.Construct, id *string, config *OrganizationsPolicyAttachmentConfig) OrganizationsPolicyAttachment {
	...
	if err := validateNewOrganizationsPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationsPolicyAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrganizationsPolicyAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrganizationsPolicyAttachment) MoveToId(id *string) {
