...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3accesspoint/internal"
)
...
func (j *jsiiProxy_S3AccessPoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3AccessPoint(scope constructs.Construct, id *string, config *S3AccessPointConfig) S3AccessPoint {
	...
	if err := validateNewS3AccessPointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3AccessPoint) PutVpcConfiguration(value *S3AccessPointVpcConfiguration) {
	if err := s.validatePutVpcConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3AccessPoint) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
