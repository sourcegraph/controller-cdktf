...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/kmsreplicakey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/kms_replica_key aws_kms_replica_key}.
...
func (j *jsiiProxy_KmsReplicaKey) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_KmsReplicaKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KmsReplicaKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KmsReplicaKey) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/kms_replica_key aws_kms_replica_key} Resource.
func NewKmsReplicaKey(scope constructs.Construct, id *string, config *KmsReplicaKeyConfig) KmsReplicaKey {
	_init_.Initialize()

	if err := validateNewKmsReplicaKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KmsReplicaKey)SetConnection(val interface{}) {
...
func (j *jsiiProxy_KmsReplicaKey)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KmsReplicaKey)SetId(val *string) {
...
func (j *jsiiProxy_KmsReplicaKey)SetProvisioners(val *[]interface{}) {
...
func KmsReplicaKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKmsReplicaKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func KmsReplicaKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateKmsReplicaKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KmsReplicaKey_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKmsReplicaKey_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KmsReplicaKey_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKmsReplicaKey_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KmsReplicaKey) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsReplicaKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KmsReplicaKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KmsReplicaKey) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsReplicaKey) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KmsReplicaKey) MoveToId(id *string) {
...
func (k *jsiiProxy_KmsReplicaKey) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsReplicaKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KmsReplicaKey) ToHclTerraform() interface{} {
	var returns interface{}
