...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws.appstreamImageBuilder.AppstreamImageBuilderAccessEndpoint",
	...
	_jsii_.RegisterStruct(
		"aws.appstreamImageBuilder.AppstreamImageBuilderConfig",
	...
	_jsii_.RegisterStruct(
		"aws.appstreamImageBuilder.AppstreamImageBuilderVpcConfig",
