...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iaminstanceprofile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_instance_profile aws_iam_instance_profile}.
...
func (j *jsiiProxy_IamInstanceProfile) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamInstanceProfile) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamInstanceProfile(scope constructs.Construct, id *string, config *IamInstanceProfileConfig) IamInstanceProfile {
	...
	if err := validateNewIamInstanceProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamInstanceProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamInstanceProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamInstanceProfile) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamInstanceProfile) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
