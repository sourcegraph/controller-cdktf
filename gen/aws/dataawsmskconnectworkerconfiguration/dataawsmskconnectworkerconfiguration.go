...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsmskconnectworkerconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/mskconnect_worker_configuration aws_mskconnect_worker_configuration}.
...
func NewDataAwsMskconnectWorkerConfiguration(scope constructs.Construct, id *string, config *DataAwsMskconnectWorkerConfigurationConfig) DataAwsMskconnectWorkerConfiguration {
	...
	if err := validateNewDataAwsMskconnectWorkerConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsMskconnectWorkerConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskconnectWorkerConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
