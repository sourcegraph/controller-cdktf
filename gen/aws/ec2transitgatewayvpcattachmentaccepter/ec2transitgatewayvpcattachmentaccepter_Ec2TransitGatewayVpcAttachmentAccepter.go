...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2transitgatewayvpcattachmentaccepter/internal"
)
...
func NewEc2TransitGatewayVpcAttachmentAccepter(scope constructs.Construct, id *string, config *Ec2TransitGatewayVpcAttachmentAccepterConfig) Ec2TransitGatewayVpcAttachmentAccepter {
	...
	_jsii_.Create(
		"aws.ec2TransitGatewayVpcAttachmentAccepter.Ec2TransitGatewayVpcAttachmentAccepter",
