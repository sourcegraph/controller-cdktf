...
type jsiiProxy_RumAppMonitor struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_RumAppMonitor) AppMonitorConfiguration() RumAppMonitorAppMonitorConfigurationOutputReference {
	var returns RumAppMonitorAppMonitorConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RumAppMonitor) AppMonitorConfigurationInput() *RumAppMonitorAppMonitorConfiguration {
...
func (j *jsiiProxy_RumAppMonitor) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_RumAppMonitor) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RumAppMonitor) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RumAppMonitor) CwLogGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cwLogGroup",
...
func (j *jsiiProxy_RumAppMonitor) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_RumAppMonitor) DomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainInput",
...
func (j *jsiiProxy_RumAppMonitor) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RumAppMonitor) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RumAppMonitor) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RumAppMonitor) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RumAppMonitor) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RumAppMonitor) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RumAppMonitor) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_RumAppMonitor) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_RumAppMonitor) Node() constructs.Node {
...
func (j *jsiiProxy_RumAppMonitor) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_RumAppMonitor) Tags() *map[string]*string {
...
func (j *jsiiProxy_RumAppMonitor) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_RumAppMonitor) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_RumAppMonitor) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_RumAppMonitor) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RumAppMonitor) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewRumAppMonitor(scope constructs.Construct, id *string, config *RumAppMonitorConfig) RumAppMonitor {
	...
	if err := validateNewRumAppMonitorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RumAppMonitor)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (r *jsiiProxy_RumAppMonitor) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RumAppMonitor) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RumAppMonitor) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RumAppMonitor) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RumAppMonitor) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RumAppMonitor) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RumAppMonitor) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RumAppMonitor) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RumAppMonitor) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RumAppMonitor) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RumAppMonitor) PutAppMonitorConfiguration(value *RumAppMonitorAppMonitorConfiguration) {
	if err := r.validatePutAppMonitorConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_RumAppMonitor) ResetCwLogEnabled() {
	_jsii_.InvokeVoid(
		r,
		"resetCwLogEnabled",
		nil, // no parameters
...
func (r *jsiiProxy_RumAppMonitor) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RumAppMonitor) ResetTags() {
	_jsii_.InvokeVoid(
		r,
		"resetTags",
		nil, // no parameters
...
func (r *jsiiProxy_RumAppMonitor) ResetTagsAll() {
	_jsii_.InvokeVoid(
		r,
		"resetTagsAll",
		nil, // no parameters
...
func (r *jsiiProxy_RumAppMonitor) ToString() *string {
	var returns *string
