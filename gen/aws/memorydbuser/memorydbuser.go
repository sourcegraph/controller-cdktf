...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/memorydbuser/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/memorydb_user aws_memorydb_user}.
...
func (j *jsiiProxy_MemorydbUser) Connection() interface{} {
...
func (j *jsiiProxy_MemorydbUser) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MemorydbUser) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MemorydbUser) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/memorydb_user aws_memorydb_user} Resource.
func NewMemorydbUser(scope constructs.Construct, id *string, config *MemorydbUserConfig) MemorydbUser {
	_init_.Initialize()

	if err := validateNewMemorydbUserParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MemorydbUser)SetConnection(val interface{}) {
...
func (j *jsiiProxy_MemorydbUser)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MemorydbUser)SetId(val *string) {
...
func (j *jsiiProxy_MemorydbUser)SetProvisioners(val *[]interface{}) {
...
func MemorydbUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMemorydbUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MemorydbUser_IsConstruct(x interface{}) *bool {
	...
	if err := validateMemorydbUser_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MemorydbUser_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMemorydbUser_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MemorydbUser_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMemorydbUser_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MemorydbUser) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MemorydbUser) PutAuthenticationMode(value *MemorydbUserAuthenticationMode) {
	if err := m.validatePutAuthenticationModeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MemorydbUser) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MemorydbUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MemorydbUser) ToHclTerraform() interface{} {
	var returns interface{}
