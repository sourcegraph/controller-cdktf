...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_MemorydbUserAuthenticationModeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (m *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_MemorydbUserAuthenticationModeOutputReference) ToString() *string {
	var returns *string
