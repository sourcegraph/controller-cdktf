...
func (j *jsiiProxy_SignerSigningJobDestinationS3OutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SignerSigningJobDestinationS3OutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SignerSigningJobDestinationS3OutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSignerSigningJobDestinationS3OutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SignerSigningJobDestinationS3OutputReference {
	...
	if err := validateNewSignerSigningJobDestinationS3OutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SignerSigningJobDestinationS3OutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SignerSigningJobDestinationS3OutputReference) ToString() *string {
	var returns *string
