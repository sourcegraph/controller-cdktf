...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/signer_signing_job aws_signer_signing_job}.
...
func NewSignerSigningJob(scope constructs.Construct, id *string, config *SignerSigningJobConfig) SignerSigningJob {
	...
	_jsii_.Create(
		"aws.signerSigningJob.SignerSigningJob",
