...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSignerSigningJobDestinationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SignerSigningJobDestinationOutputReference {
	...
	if err := validateNewSignerSigningJobDestinationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SignerSigningJobDestinationOutputReference{}

	_jsii_.Create(
		"aws.signerSigningJob.SignerSigningJobDestinationOutputReference",
...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SignerSigningJobDestinationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) PutS3(value *SignerSigningJobDestinationS3) {
	if err := s.validatePutS3Parameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SignerSigningJobDestinationOutputReference) ToString() *string {
	var returns *string
