...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_rule aws_wafregional_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_rule aws_wafregional_rule} Resource.
func NewWafregionalRule(scope constructs.Construct, id *string, config *WafregionalRuleConfig) WafregionalRule {
	_init_.Initialize()

	if err := validateNewWafregionalRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalRule) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalRule) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalRule) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalRule) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalRule) PutPredicate(value interface{}) {
	if err := w.validatePutPredicateParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalRule) ToHclTerraform() interface{} {
	var returns interface{}
