...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsbackupvault/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/backup_vault aws_backup_vault}.
...
func (j *jsiiProxy_DataAwsBackupVault) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsBackupVault) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsBackupVault(scope constructs.Construct, id *string, config *DataAwsBackupVaultConfig) DataAwsBackupVault {
	...
	if err := validateNewDataAwsBackupVaultParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsBackupVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBackupVault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsBackupVault) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
