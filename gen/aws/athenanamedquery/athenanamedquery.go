...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/athenanamedquery/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/athena_named_query aws_athena_named_query}.
...
func (j *jsiiProxy_AthenaNamedQuery) Connection() interface{} {
...
func (j *jsiiProxy_AthenaNamedQuery) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AthenaNamedQuery) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AthenaNamedQuery) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/athena_named_query aws_athena_named_query} Resource.
func NewAthenaNamedQuery(scope constructs.Construct, id *string, config *AthenaNamedQueryConfig) AthenaNamedQuery {
	_init_.Initialize()

	if err := validateNewAthenaNamedQueryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AthenaNamedQuery)SetConnection(val interface{}) {
...
func (j *jsiiProxy_AthenaNamedQuery)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AthenaNamedQuery)SetId(val *string) {
...
func (j *jsiiProxy_AthenaNamedQuery)SetProvisioners(val *[]interface{}) {
...
func AthenaNamedQuery_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAthenaNamedQuery_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AthenaNamedQuery_IsConstruct(x interface{}) *bool {
	...
	if err := validateAthenaNamedQuery_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AthenaNamedQuery) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AthenaNamedQuery) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AthenaNamedQuery) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AthenaNamedQuery) MoveFromId(id *string) {
...
func (a *jsiiProxy_AthenaNamedQuery) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AthenaNamedQuery) MoveToId(id *string) {
...
func (a *jsiiProxy_AthenaNamedQuery) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaNamedQuery) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AthenaNamedQuery) ToHclTerraform() interface{} {
	var returns interface{}
