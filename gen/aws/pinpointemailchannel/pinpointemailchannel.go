...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/pinpointemailchannel/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/pinpoint_email_channel aws_pinpoint_email_channel}.
...
func NewPinpointEmailChannel(scope constructs.Construct, id *string, config *PinpointEmailChannelConfig) PinpointEmailChannel {
	...
	if err := validateNewPinpointEmailChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointEmailChannel) AddMoveTarget(moveTarget *string) {
