...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscognitouserpoolclients/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cognito_user_pool_clients aws_cognito_user_pool_clients}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cognito_user_pool_clients aws_cognito_user_pool_clients} Data Source.
func NewDataAwsCognitoUserPoolClients(scope constructs.Construct, id *string, config *DataAwsCognitoUserPoolClientsConfig) DataAwsCognitoUserPoolClients {
	...
	if err := validateNewDataAwsCognitoUserPoolClientsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCognitoUserPoolClients_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCognitoUserPoolClients_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsCognitoUserPoolClients_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCognitoUserPoolClients_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClients) ToHclTerraform() interface{} {
	var returns interface{}
