...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/pricing_product aws_pricing_product}.
...
func (j *jsiiProxy_DataAwsPricingProduct) Filters() DataAwsPricingProductFiltersList {
	var returns DataAwsPricingProductFiltersList
	_jsii_.Get(
		j,
		"filters",
		&returns,
...
func (j *jsiiProxy_DataAwsPricingProduct) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsPricingProduct) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsPricingProduct(scope constructs.Construct, id *string, config *DataAwsPricingProductConfig) DataAwsPricingProduct {
	...
	if err := validateNewDataAwsPricingProductParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsPricingProduct_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsPricingProduct_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsPricingProduct) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
