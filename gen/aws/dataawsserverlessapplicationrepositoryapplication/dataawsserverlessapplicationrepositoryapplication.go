...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsserverlessapplicationrepositoryapplication/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/serverlessapplicationrepository_application aws_serverlessapplicationrepository_application}.
...
func NewDataAwsServerlessapplicationrepositoryApplication(scope constructs.Construct, id *string, config *DataAwsServerlessapplicationrepositoryApplicationConfig) DataAwsServerlessapplicationrepositoryApplication {
	...
	if err := validateNewDataAwsServerlessapplicationrepositoryApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServerlessapplicationrepositoryApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServerlessapplicationrepositoryApplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
