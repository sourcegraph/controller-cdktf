...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lambdainvocation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lambda_invocation aws_lambda_invocation}.
...
func LambdaInvocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaInvocation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaInvocation) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaInvocation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LambdaInvocation) MoveFromId(id *string) {
...
func (l *jsiiProxy_LambdaInvocation) MoveToId(id *string) {
