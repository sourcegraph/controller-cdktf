...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/emr_release_labels aws_emr_release_labels}.
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEmrReleaseLabels) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEmrReleaseLabels(scope constructs.Construct, id *string, config *DataAwsEmrReleaseLabelsConfig) DataAwsEmrReleaseLabels {
	...
	if err := validateNewDataAwsEmrReleaseLabelsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEmrReleaseLabels_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEmrReleaseLabels_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEmrReleaseLabels) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
