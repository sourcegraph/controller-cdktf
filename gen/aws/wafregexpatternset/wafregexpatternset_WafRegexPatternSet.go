...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregexpatternset/internal"
)
...
func (j *jsiiProxy_WafRegexPatternSet) Connection() interface{} {
...
func (j *jsiiProxy_WafRegexPatternSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafRegexPatternSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafRegexPatternSet) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewWafRegexPatternSet(scope constructs.Construct, id *string, config *WafRegexPatternSetConfig) WafRegexPatternSet {
	...
	if err := validateNewWafRegexPatternSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafRegexPatternSet)SetConnection(val interface{}) {
...
func (j *jsiiProxy_WafRegexPatternSet)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRegexPatternSet)SetId(val *string) {
...
func (j *jsiiProxy_WafRegexPatternSet)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_WafRegexPatternSet)SetRegexPatternStrings(val *[]*string) {
	if err := j.validateSetRegexPatternStringsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func WafRegexPatternSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafRegexPatternSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafRegexPatternSet) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
