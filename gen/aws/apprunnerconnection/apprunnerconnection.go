...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apprunnerconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/apprunner_connection aws_apprunner_connection}.
...
func NewApprunnerConnection(scope constructs.Construct, id *string, config *ApprunnerConnectionConfig) ApprunnerConnection {
	...
	if err := validateNewApprunnerConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApprunnerConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApprunnerConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApprunnerConnection) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApprunnerConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApprunnerConnection) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApprunnerConnection) MoveToId(id *string) {
