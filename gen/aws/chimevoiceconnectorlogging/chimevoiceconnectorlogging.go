...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/chimevoiceconnectorlogging/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/chime_voice_connector_logging aws_chime_voice_connector_logging}.
...
func NewChimeVoiceConnectorLogging(scope constructs.Construct, id *string, config *ChimeVoiceConnectorLoggingConfig) ChimeVoiceConnectorLogging {
	...
	if err := validateNewChimeVoiceConnectorLoggingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ChimeVoiceConnectorLogging_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateChimeVoiceConnectorLogging_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ChimeVoiceConnectorLogging) AddMoveTarget(moveTarget *string) {
