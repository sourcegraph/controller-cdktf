...
func (d *jsiiProxy_DataAwsLaunchTemplateCapacityReservationSpecificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
