...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/networkmanager_link_association aws_networkmanager_link_association}.
type NetworkmanagerLinkAssociation interface {
	...
	PutTimeouts(value *NetworkmanagerLinkAssociationTimeouts)
	ResetId()
...
type jsiiProxy_NetworkmanagerLinkAssociation struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_NetworkmanagerLinkAssociation) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) DeviceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deviceId",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) DeviceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deviceIdInput",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) GlobalNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"globalNetworkId",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) GlobalNetworkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) LinkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkId",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) LinkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkIdInput",
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkmanagerLinkAssociation) Timeouts() NetworkmanagerLinkAssociationTimeoutsOutputReference {
	var returns NetworkmanagerLinkAssociationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewNetworkmanagerLinkAssociation(scope constructs.Construct, id *string, config *NetworkmanagerLinkAssociationConfig) NetworkmanagerLinkAssociation {
	...
	if err := validateNewNetworkmanagerLinkAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func NetworkmanagerLinkAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkmanagerLinkAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func NetworkmanagerLinkAssociation_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.networkmanagerLinkAssociation.NetworkmanagerLinkAssociation",
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) PutTimeouts(value *NetworkmanagerLinkAssociationTimeouts) {
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerLinkAssociation) ToString() *string {
	var returns *string
