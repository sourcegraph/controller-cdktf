...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaymethod/internal"
)
...
func (a *jsiiProxy_ApiGatewayMethod) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayMethod) MoveToId(id *string) {
