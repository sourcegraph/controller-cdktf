...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticachereplicationgroup/internal"
)
...
func NewElasticacheReplicationGroupLogDeliveryConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticacheReplicationGroupLogDeliveryConfigurationList {
	...
	if err := validateNewElasticacheReplicationGroupLogDeliveryConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
