...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/networkmanager_connect_attachment aws_networkmanager_connect_attachment}.
type NetworkmanagerConnectAttachment interface {
	...
	OptionsInput() *NetworkmanagerConnectAttachmentOptions
	...
	PutTimeouts(value *NetworkmanagerConnectAttachmentTimeouts)
	ResetId()
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) OptionsInput() *NetworkmanagerConnectAttachmentOptions {
	var returns *NetworkmanagerConnectAttachmentOptions
	_jsii_.Get(
		j,
		"optionsInput",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) Tags() *map[string]*string {
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkmanagerConnectAttachment) Timeouts() NetworkmanagerConnectAttachmentTimeoutsOutputReference {
	var returns NetworkmanagerConnectAttachmentTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) PutTimeouts(value *NetworkmanagerConnectAttachmentTimeouts) {
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) ResetTagsAll() {
	_jsii_.InvokeVoid(
		n,
		"resetTagsAll",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerConnectAttachment) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
