...
func (d *jsiiProxy_DataAwsConnectUserHierarchyStructureHierarchyStructureLevelThreeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
