...
func (d *jsiiProxy_DataAwsConnectUserHierarchyStructureHierarchyStructureLevelFourList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
