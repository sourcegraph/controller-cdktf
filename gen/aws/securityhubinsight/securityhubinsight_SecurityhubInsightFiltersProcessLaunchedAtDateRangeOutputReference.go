...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference {
	_init_.Initialize()

	if err := validateNewSecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference_Override(s SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityhubInsightFiltersProcessLaunchedAtDateRangeOutputReference) ToString() *string {
	var returns *string
