...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSecurityhubInsightFiltersUpdatedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference {
	_init_.Initialize()

	if err := validateNewSecurityhubInsightFiltersUpdatedAtDateRangeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference{}

	_jsii_.Create(
		"aws.securityhubInsight.SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference",
...
func NewSecurityhubInsightFiltersUpdatedAtDateRangeOutputReference_Override(s SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityhubInsightFiltersUpdatedAtDateRangeOutputReference) ToString() *string {
	var returns *string
