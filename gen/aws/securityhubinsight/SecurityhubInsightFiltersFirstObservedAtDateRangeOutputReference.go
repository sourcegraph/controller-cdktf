...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference {
	_init_.Initialize()

	if err := validateNewSecurityhubInsightFiltersFirstObservedAtDateRangeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference_Override(s SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityhubInsightFiltersFirstObservedAtDateRangeOutputReference) ToString() *string {
	var returns *string
