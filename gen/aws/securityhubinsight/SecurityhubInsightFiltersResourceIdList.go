...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceIdList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSecurityhubInsightFiltersResourceIdList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SecurityhubInsightFiltersResourceIdList {
	_init_.Initialize()
...
func NewSecurityhubInsightFiltersResourceIdList_Override(s SecurityhubInsightFiltersResourceIdList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityhubInsightFiltersResourceIdList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceIdList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityhubInsightFiltersResourceIdList) Resolve(_context cdktf.IResolveContext) interface{} {
