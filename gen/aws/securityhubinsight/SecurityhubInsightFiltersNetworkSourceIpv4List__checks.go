...
func (s *jsiiProxy_SecurityhubInsightFiltersNetworkSourceIpv4List) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_SecurityhubInsightFiltersNetworkSourceIpv4List) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*SecurityhubInsightFiltersNetworkSourceIpv4:
		val := val.(*[]*SecurityhubInsightFiltersNetworkSourceIpv4)
	...
	case []*SecurityhubInsightFiltersNetworkSourceIpv4:
		val_ := val.([]*SecurityhubInsightFiltersNetworkSourceIpv4)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*SecurityhubInsightFiltersNetworkSourceIpv4; received %#v (a %T)", val, val)
		}
	}
