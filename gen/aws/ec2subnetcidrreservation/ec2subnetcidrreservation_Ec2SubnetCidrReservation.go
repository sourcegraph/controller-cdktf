...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2subnetcidrreservation/internal"
)
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2SubnetCidrReservation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEc2SubnetCidrReservation(scope constructs.Construct, id *string, config *Ec2SubnetCidrReservationConfig) Ec2SubnetCidrReservation {
	...
	if err := validateNewEc2SubnetCidrReservationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2SubnetCidrReservation) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
