...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sestemplate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_template aws_ses_template}.
...
func (j *jsiiProxy_SesTemplate) Connection() interface{} {
...
func (j *jsiiProxy_SesTemplate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesTemplate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesTemplate) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_template aws_ses_template} Resource.
func NewSesTemplate(scope constructs.Construct, id *string, config *SesTemplateConfig) SesTemplate {
	_init_.Initialize()

	if err := validateNewSesTemplateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesTemplate)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SesTemplate)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesTemplate)SetId(val *string) {
...
func (j *jsiiProxy_SesTemplate)SetProvisioners(val *[]interface{}) {
...
func SesTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesTemplate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SesTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateSesTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SesTemplate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSesTemplate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SesTemplate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSesTemplate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SesTemplate) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesTemplate) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SesTemplate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesTemplate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesTemplate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesTemplate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesTemplate) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SesTemplate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SesTemplate) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesTemplate) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SesTemplate) MoveToId(id *string) {
...
func (s *jsiiProxy_SesTemplate) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SesTemplate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SesTemplate) ToHclTerraform() interface{} {
	var returns interface{}
