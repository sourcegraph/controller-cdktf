...
func (j *jsiiProxy_CeAnomalySubscription) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_CeAnomalySubscription) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_CeAnomalySubscription) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CeAnomalySubscription) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CeAnomalySubscription) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CeAnomalySubscription) Subscriber() CeAnomalySubscriptionSubscriberList {
	var returns CeAnomalySubscriptionSubscriberList
	_jsii_.Get(
		j,
		"subscriber",
		&returns,
...
func (j *jsiiProxy_CeAnomalySubscription) SubscriberInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"subscriberInput",
...
func (j *jsiiProxy_CeAnomalySubscription) Tags() *map[string]*string {
...
func (j *jsiiProxy_CeAnomalySubscription) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CeAnomalySubscription) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CeAnomalySubscription) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_CeAnomalySubscription)SetAccountId(val *string) {
...
func (j *jsiiProxy_CeAnomalySubscription)SetId(val *string) {
...
func (j *jsiiProxy_CeAnomalySubscription)SetName(val *string) {
...
func (j *jsiiProxy_CeAnomalySubscription)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_CeAnomalySubscription)SetTagsAll(val *map[string]*string) {
...
func (c *jsiiProxy_CeAnomalySubscription) PutSubscriber(value interface{}) {
	if err := c.validatePutSubscriberParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CeAnomalySubscription) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CeAnomalySubscription) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
...
func (c *jsiiProxy_CeAnomalySubscription) ResetTagsAll() {
	_jsii_.InvokeVoid(
		c,
		"resetTagsAll",
		nil, // no parameters
