...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_peering_connection_accepter aws_vpc_peering_connection_accepter}.
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcPeeringConnectionAccepterA) MoveToId(id *string) {
