...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/worklink_fleet aws_worklink_fleet}.
...
func WorklinkFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateWorklinkFleet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WorklinkFleet) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorklinkFleet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorklinkFleet) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorklinkFleet) MoveToId(id *string) {
