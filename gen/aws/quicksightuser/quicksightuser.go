...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/quicksightuser/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/quicksight_user aws_quicksight_user}.
...
func NewQuicksightUser(scope constructs.Construct, id *string, config *QuicksightUserConfig) QuicksightUser {
	...
	if err := validateNewQuicksightUserParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func QuicksightUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateQuicksightUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (q *jsiiProxy_QuicksightUser) AddMoveTarget(moveTarget *string) {
...
func (q *jsiiProxy_QuicksightUser) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (q *jsiiProxy_QuicksightUser) MoveFromId(id *string) {
...
func (q *jsiiProxy_QuicksightUser) MoveToId(id *string) {
