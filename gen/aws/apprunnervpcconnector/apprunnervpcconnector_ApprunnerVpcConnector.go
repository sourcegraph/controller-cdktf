...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apprunnervpcconnector/internal"
)
...
func NewApprunnerVpcConnector(scope constructs.Construct, id *string, config *ApprunnerVpcConnectorConfig) ApprunnerVpcConnector {
	...
	if err := validateNewApprunnerVpcConnectorParameters(scope, id, config); err != nil {
		panic(err)
	}
