...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/securityhubaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/securityhub_account aws_securityhub_account}.
...
func (j *jsiiProxy_SecurityhubAccount) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityhubAccount) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSecurityhubAccount(scope constructs.Construct, id *string, config *SecurityhubAccountConfig) SecurityhubAccount {
	...
	if err := validateNewSecurityhubAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SecurityhubAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityhubAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityhubAccount) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityhubAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityhubAccount) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityhubAccount) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityhubAccount) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
