...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_connection aws_dx_connection}.
...
func (j *jsiiProxy_DxConnection) VlanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vlanId",
...
func NewDxConnection(scope constructs.Construct, id *string, config *DxConnectionConfig) DxConnection {
	...
	if err := validateNewDxConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DxConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDxConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DxConnection) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DxConnection) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxConnection) MoveToId(id *string) {
