...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamusersshkey/internal"
)
...
func (j *jsiiProxy_IamUserSshKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamUserSshKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamUserSshKey(scope constructs.Construct, id *string, config *IamUserSshKeyConfig) IamUserSshKey {
	...
	if err := validateNewIamUserSshKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamUserSshKey) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
