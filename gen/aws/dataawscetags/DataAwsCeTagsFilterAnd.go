...
type DataAwsCeTagsFilterAnd struct {
	...
	// dimension block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/ce_tags#dimension DataAwsCeTags#dimension}
