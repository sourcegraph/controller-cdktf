...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsstoragegatewaylocaldisk/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/storagegateway_local_disk aws_storagegateway_local_disk}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/storagegateway_local_disk aws_storagegateway_local_disk} Data Source.
func NewDataAwsStoragegatewayLocalDisk(scope constructs.Construct, id *string, config *DataAwsStoragegatewayLocalDiskConfig) DataAwsStoragegatewayLocalDisk {
	...
	if err := validateNewDataAwsStoragegatewayLocalDiskParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsStoragegatewayLocalDisk)SetDiskNode(val *string) {
	if err := j.validateSetDiskNodeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataAwsStoragegatewayLocalDisk_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsStoragegatewayLocalDisk_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsStoragegatewayLocalDisk_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsStoragegatewayLocalDisk_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsStoragegatewayLocalDisk_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsStoragegatewayLocalDisk_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsStoragegatewayLocalDisk) ToHclTerraform() interface{} {
	var returns interface{}
