...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsconnectinstance/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_instance aws_connect_instance}.
...
func (j *jsiiProxy_DataAwsConnectInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsConnectInstance(scope constructs.Construct, id *string, config *DataAwsConnectInstanceConfig) DataAwsConnectInstance {
	...
	if err := validateNewDataAwsConnectInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsConnectInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsConnectInstance) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
