...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/configconfigurationrecorderstatus/internal"
)
...
func NewConfigConfigurationRecorderStatus(scope constructs.Construct, id *string, config *ConfigConfigurationRecorderStatusConfig) ConfigConfigurationRecorderStatus {
	...
	if err := validateNewConfigConfigurationRecorderStatusParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ConfigConfigurationRecorderStatus{}

	_jsii_.Create(
		"aws.configConfigurationRecorderStatus.ConfigConfigurationRecorderStatus",
