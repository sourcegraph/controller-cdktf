...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/kms_secrets aws_kms_secrets}.
...
func (j *jsiiProxy_DataAwsKmsSecrets) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsSecrets) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsKmsSecrets) Plaintext() cdktf.StringMap {
...
func NewDataAwsKmsSecrets(scope constructs.Construct, id *string, config *DataAwsKmsSecretsConfig) DataAwsKmsSecrets {
	...
	if err := validateNewDataAwsKmsSecretsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsKmsSecrets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsKmsSecrets_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsKmsSecrets) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
