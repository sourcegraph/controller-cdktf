...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewSagemakerDomainRetentionPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SagemakerDomainRetentionPolicyOutputReference {
	...
	if err := validateNewSagemakerDomainRetentionPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference)SetHomeEfsFileSystem(val *string) {
	if err := j.validateSetHomeEfsFileSystemParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SagemakerDomainRetentionPolicyOutputReference) ToString() *string {
	var returns *string
