...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsorganizationsdelegatedadministrators/internal"
)
...
func NewDataAwsOrganizationsDelegatedAdministrators(scope constructs.Construct, id *string, config *DataAwsOrganizationsDelegatedAdministratorsConfig) DataAwsOrganizationsDelegatedAdministrators {
	...
	if err := validateNewDataAwsOrganizationsDelegatedAdministratorsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsOrganizationsDelegatedAdministrators{}

	_jsii_.Create(
		"aws.dataAwsOrganizationsDelegatedAdministrators.DataAwsOrganizationsDelegatedAdministrators",
