...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lightsaillbcertificateattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_lb_certificate_attachment aws_lightsail_lb_certificate_attachment}.
...
func (j *jsiiProxy_LightsailLbCertificateAttachment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LightsailLbCertificateAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LightsailLbCertificateAttachment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailLbCertificateAttachment) Provider() cdktf.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_lb_certificate_attachment aws_lightsail_lb_certificate_attachment} Resource.
...
func (j *jsiiProxy_LightsailLbCertificateAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailLbCertificateAttachment)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailLbCertificateAttachment)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailLbCertificateAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailLbCertificateAttachment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailLbCertificateAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LightsailLbCertificateAttachment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
