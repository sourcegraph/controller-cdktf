...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewaymodel/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/api_gateway_model aws_api_gateway_model}.
...
func NewApiGatewayModel(scope constructs.Construct, id *string, config *ApiGatewayModelConfig) ApiGatewayModel {
	...
	if err := validateNewApiGatewayModelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApiGatewayModel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApiGatewayModel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiGatewayModel) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiGatewayModel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApiGatewayModel) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiGatewayModel) MoveToId(id *string) {
