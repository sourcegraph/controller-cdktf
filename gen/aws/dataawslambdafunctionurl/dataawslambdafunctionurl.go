...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawslambdafunctionurl/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/lambda_function_url aws_lambda_function_url}.
...
func NewDataAwsLambdaFunctionUrl(scope constructs.Construct, id *string, config *DataAwsLambdaFunctionUrlConfig) DataAwsLambdaFunctionUrl {
	...
	if err := validateNewDataAwsLambdaFunctionUrlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsLambdaFunctionUrl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsLambdaFunctionUrl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
