...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawselasticacheuser/internal"
)
...
func NewDataAwsElasticacheUser(scope constructs.Construct, id *string, config *DataAwsElasticacheUserConfig) DataAwsElasticacheUser {
	...
	if err := validateNewDataAwsElasticacheUserParameters(scope, id, config); err != nil {
		panic(err)
	}
