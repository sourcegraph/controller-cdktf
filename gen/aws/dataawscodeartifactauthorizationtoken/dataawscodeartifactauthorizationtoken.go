...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscodeartifactauthorizationtoken/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/codeartifact_authorization_token aws_codeartifact_authorization_token}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/codeartifact_authorization_token aws_codeartifact_authorization_token} Data Source.
func NewDataAwsCodeartifactAuthorizationToken(scope constructs.Construct, id *string, config *DataAwsCodeartifactAuthorizationTokenConfig) DataAwsCodeartifactAuthorizationToken {
	...
	if err := validateNewDataAwsCodeartifactAuthorizationTokenParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCodeartifactAuthorizationToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCodeartifactAuthorizationToken_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsCodeartifactAuthorizationToken_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsCodeartifactAuthorizationToken_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCodeartifactAuthorizationToken_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCodeartifactAuthorizationToken_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsCodeartifactAuthorizationToken_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsCodeartifactAuthorizationToken_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsCodeartifactAuthorizationToken) ToHclTerraform() interface{} {
	var returns interface{}
