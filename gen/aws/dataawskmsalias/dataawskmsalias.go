...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawskmsalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/kms_alias aws_kms_alias}.
...
func (j *jsiiProxy_DataAwsKmsAlias) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsAlias) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/kms_alias aws_kms_alias} Data Source.
func NewDataAwsKmsAlias(scope constructs.Construct, id *string, config *DataAwsKmsAliasConfig) DataAwsKmsAlias {
	_init_.Initialize()

	if err := validateNewDataAwsKmsAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsKmsAlias)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsKmsAlias)SetId(val *string) {
...
func DataAwsKmsAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsKmsAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsKmsAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsKmsAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsKmsAlias_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsKmsAlias_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsKmsAlias_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsKmsAlias_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsKmsAlias) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsKmsAlias) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsKmsAlias) ToHclTerraform() interface{} {
	var returns interface{}
