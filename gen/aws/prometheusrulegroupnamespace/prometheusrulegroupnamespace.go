...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/prometheusrulegroupnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/prometheus_rule_group_namespace aws_prometheus_rule_group_namespace}.
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace) Connection() interface{} {
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/prometheus_rule_group_namespace aws_prometheus_rule_group_namespace} Resource.
func NewPrometheusRuleGroupNamespace(scope constructs.Construct, id *string, config *PrometheusRuleGroupNamespaceConfig) PrometheusRuleGroupNamespace {
	...
	if err := validateNewPrometheusRuleGroupNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace)SetConnection(val interface{}) {
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace)SetId(val *string) {
...
func (j *jsiiProxy_PrometheusRuleGroupNamespace)SetProvisioners(val *[]interface{}) {
...
func PrometheusRuleGroupNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePrometheusRuleGroupNamespace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PrometheusRuleGroupNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validatePrometheusRuleGroupNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrometheusRuleGroupNamespace_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrometheusRuleGroupNamespace_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PrometheusRuleGroupNamespace_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePrometheusRuleGroupNamespace_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) MoveFromId(id *string) {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) MoveToId(id *string) {
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PrometheusRuleGroupNamespace) ToHclTerraform() interface{} {
	var returns interface{}
