...
type OpsworksJavaAppLayerCloudwatchConfigurationOutputReference interface {
	...
	LogStreams() OpsworksJavaAppLayerCloudwatchConfigurationLogStreamsList
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksJavaAppLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksJavaAppLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksJavaAppLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksJavaAppLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksJavaAppLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksJavaAppLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
