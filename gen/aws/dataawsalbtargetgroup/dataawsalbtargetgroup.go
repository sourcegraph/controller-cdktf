...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/alb_target_group aws_alb_target_group}.
type DataAwsAlbTargetGroup interface {
	...
	HealthCheck() DataAwsAlbTargetGroupHealthCheckList
	Id() *string
	SetId(val *string)
	IdInput() *string
	LambdaMultiValueHeadersEnabled() cdktf.IResolvable
	// Experimental.
	...
	PutTimeouts(value *DataAwsAlbTargetGroupTimeouts)
	ResetArn()
	ResetId()
	ResetName()
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) ArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arnInput",
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) ConnectionTermination() cdktf.IResolvable {
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) HealthCheck() DataAwsAlbTargetGroupHealthCheckList {
	var returns DataAwsAlbTargetGroupHealthCheckList
	_jsii_.Get(
		j,
		"healthCheck",
		&returns,
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) LambdaMultiValueHeadersEnabled() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) ProxyProtocolV2() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"proxyProtocolV2",
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) Stickiness() DataAwsAlbTargetGroupStickinessList {
	var returns DataAwsAlbTargetGroupStickinessList
	_jsii_.Get(
		j,
		"stickiness",
		&returns,
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) Timeouts() DataAwsAlbTargetGroupTimeoutsOutputReference {
	var returns DataAwsAlbTargetGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DataAwsAlbTargetGroup) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/alb_target_group aws_alb_target_group} Data Source.
func NewDataAwsAlbTargetGroup(scope constructs.Construct, id *string, config *DataAwsAlbTargetGroupConfig) DataAwsAlbTargetGroup {
	...
	if err := validateNewDataAwsAlbTargetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsAlbTargetGroup)SetArn(val *string) {
...
func (j *jsiiProxy_DataAwsAlbTargetGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsAlbTargetGroup)SetId(val *string) {
...
func (j *jsiiProxy_DataAwsAlbTargetGroup)SetTags(val *map[string]*string) {
...
func DataAwsAlbTargetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsAlbTargetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsAlbTargetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsAlbTargetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsAlbTargetGroup_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsAlbTargetGroup_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsAlbTargetGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsAlbTargetGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) PutTimeouts(value *DataAwsAlbTargetGroupTimeouts) {
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) ResetArn() {
	_jsii_.InvokeVoid(
		d,
		"resetArn",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsAlbTargetGroup) ToHclTerraform() interface{} {
	var returns interface{}
