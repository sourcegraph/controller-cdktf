...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloud9environmentec2/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloud9_environment_ec2 aws_cloud9_environment_ec2}.
...
func NewCloud9EnvironmentEc2(scope constructs.Construct, id *string, config *Cloud9EnvironmentEc2Config) Cloud9EnvironmentEc2 {
	...
	if err := validateNewCloud9EnvironmentEc2Parameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Cloud9EnvironmentEc2_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloud9EnvironmentEc2_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_Cloud9EnvironmentEc2) AddMoveTarget(moveTarget *string) {
