...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automaticStopTimeMinutesInput", GoGetter: "AutomaticStopTimeMinutesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ownerArnInput", GoGetter: "OwnerArnInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutomaticStopTimeMinutes", GoMethod: "ResetAutomaticStopTimeMinutes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOwnerArn", GoMethod: "ResetOwnerArn"},
