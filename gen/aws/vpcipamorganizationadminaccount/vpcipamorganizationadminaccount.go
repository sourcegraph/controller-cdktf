package vpcipamorganizationadminaccount
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpcipamorganizationadminaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_ipam_organization_admin_account aws_vpc_ipam_organization_admin_account}.
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) DelegatedAdminAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) DelegatedAdminAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delegatedAdminAccountIdInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) Email() *string {
	var returns *string
	_jsii_.Get(
		j,
		"email",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) Node() constructs.Node {
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) ServicePrincipal() *string {
	var returns *string
	_jsii_.Get(
		j,
		"servicePrincipal",
...
func (j *jsiiProxy_VpcIpamOrganizationAdminAccount) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewVpcIpamOrganizationAdminAccount(scope constructs.Construct, id *string, config *VpcIpamOrganizationAdminAccountConfig) VpcIpamOrganizationAdminAccount {
	...
	if err := validateNewVpcIpamOrganizationAdminAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VpcIpamOrganizationAdminAccount_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.vpcIpamOrganizationAdminAccount.VpcIpamOrganizationAdminAccount",
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcIpamOrganizationAdminAccount) ToString() *string {
	var returns *string
