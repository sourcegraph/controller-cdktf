...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ramresourceshare/internal"
)
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewRamResourceShareTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RamResourceShareTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRamResourceShareTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_RamResourceShareTimeoutsOutputReference{}

	_jsii_.Create(
		"aws.ramResourceShare.RamResourceShareTimeoutsOutputReference",
...
func NewRamResourceShareTimeoutsOutputReference_Override(r RamResourceShareTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_RamResourceShareTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (r *jsiiProxy_RamResourceShareTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RamResourceShareTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (r *jsiiProxy_RamResourceShareTimeoutsOutputReference) ToString() *string {
	var returns *string
