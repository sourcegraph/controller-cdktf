...
func (j *jsiiProxy_RamResourceShare) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RamResourceShare) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RamResourceShare) PermissionArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissionArns",
...
func (j *jsiiProxy_RamResourceShare) PermissionArnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissionArnsInput",
...
func NewRamResourceShare(scope constructs.Construct, id *string, config *RamResourceShareConfig) RamResourceShare {
	...
	if err := validateNewRamResourceShareParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RamResourceShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRamResourceShare_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RamResourceShare) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RamResourceShare) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RamResourceShare) MoveFromId(id *string) {
...
func (r *jsiiProxy_RamResourceShare) MoveToId(id *string) {
...
func (r *jsiiProxy_RamResourceShare) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RamResourceShare) ResetPermissionArns() {
	_jsii_.InvokeVoid(
		r,
		"resetPermissionArns",
		nil, // no parameters
