...
func (j *jsiiProxy_DataAwsKeyPair) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataAwsKeyPair) Filter() DataAwsKeyPairFilterList {
	var returns DataAwsKeyPairFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsKeyPair) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKeyPair) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsKeyPair) KeyType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyType",
...
func (j *jsiiProxy_DataAwsKeyPair) PublicKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKey",
...
func (j *jsiiProxy_DataAwsKeyPair) Tags() *map[string]*string {
...
func (j *jsiiProxy_DataAwsKeyPair) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DataAwsKeyPair) Timeouts() DataAwsKeyPairTimeoutsOutputReference {
	var returns DataAwsKeyPairTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDataAwsKeyPair(scope constructs.Construct, id *string, config *DataAwsKeyPairConfig) DataAwsKeyPair {
	...
	if err := validateNewDataAwsKeyPairParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsKeyPair) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsKeyPair) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsKeyPair) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsKeyPair) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsKeyPair) PutTimeouts(value *DataAwsKeyPairTimeouts) {
...
func (d *jsiiProxy_DataAwsKeyPair) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsKeyPair) ResetIncludePublicKey() {
	_jsii_.InvokeVoid(
		d,
		"resetIncludePublicKey",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsKeyPair) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
