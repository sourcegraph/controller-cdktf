...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssecretsmanagersecrets/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/secretsmanager_secrets aws_secretsmanager_secrets}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/secretsmanager_secrets aws_secretsmanager_secrets} Data Source.
func NewDataAwsSecretsmanagerSecrets(scope constructs.Construct, id *string, config *DataAwsSecretsmanagerSecretsConfig) DataAwsSecretsmanagerSecrets {
	...
	if err := validateNewDataAwsSecretsmanagerSecretsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsSecretsmanagerSecrets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecrets_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsSecretsmanagerSecrets_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsSecretsmanagerSecrets_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSecretsmanagerSecrets_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecrets_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsSecretsmanagerSecrets_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsSecretsmanagerSecrets_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsSecretsmanagerSecrets) ToHclTerraform() interface{} {
	var returns interface{}
