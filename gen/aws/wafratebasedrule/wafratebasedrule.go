...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/waf_rate_based_rule aws_waf_rate_based_rule}.
...
func (j *jsiiProxy_WafRateBasedRule) Connection() interface{} {
...
func (j *jsiiProxy_WafRateBasedRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafRateBasedRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafRateBasedRule) Predicates() WafRateBasedRulePredicatesList {
	var returns WafRateBasedRulePredicatesList
	_jsii_.Get(
		j,
		"predicates",
		&returns,
...
func (j *jsiiProxy_WafRateBasedRule) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/waf_rate_based_rule aws_waf_rate_based_rule} Resource.
func NewWafRateBasedRule(scope constructs.Construct, id *string, config *WafRateBasedRuleConfig) WafRateBasedRule {
	_init_.Initialize()

	if err := validateNewWafRateBasedRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WafRateBasedRule)SetConnection(val interface{}) {
...
func (j *jsiiProxy_WafRateBasedRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WafRateBasedRule)SetId(val *string) {
...
func (j *jsiiProxy_WafRateBasedRule)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_WafRateBasedRule)SetRateKey(val *string) {
	if err := j.validateSetRateKeyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func WafRateBasedRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafRateBasedRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafRateBasedRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRateBasedRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafRateBasedRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRateBasedRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafRateBasedRule) PutPredicates(value interface{}) {
...
func (w *jsiiProxy_WafRateBasedRule) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
