...
func NewEcsTaskSetCapacityProviderStrategyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EcsTaskSetCapacityProviderStrategyList {
	...
	if err := validateNewEcsTaskSetCapacityProviderStrategyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcsTaskSetCapacityProviderStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
