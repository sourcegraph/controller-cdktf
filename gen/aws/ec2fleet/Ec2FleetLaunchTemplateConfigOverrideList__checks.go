...
func (e *jsiiProxy_Ec2FleetLaunchTemplateConfigOverrideList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_Ec2FleetLaunchTemplateConfigOverrideList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*Ec2FleetLaunchTemplateConfigOverride:
		val := val.(*[]*Ec2FleetLaunchTemplateConfigOverride)
	...
	case []*Ec2FleetLaunchTemplateConfigOverride:
		val_ := val.([]*Ec2FleetLaunchTemplateConfigOverride)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*Ec2FleetLaunchTemplateConfigOverride; received %#v (a %T)", val, val)
		}
	}
