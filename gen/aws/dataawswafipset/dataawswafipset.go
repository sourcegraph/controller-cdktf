...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafipset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_ipset aws_waf_ipset}.
...
func (j *jsiiProxy_DataAwsWafIpset) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafIpset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_ipset aws_waf_ipset} Data Source.
func NewDataAwsWafIpset(scope constructs.Construct, id *string, config *DataAwsWafIpsetConfig) DataAwsWafIpset {
	_init_.Initialize()

	if err := validateNewDataAwsWafIpsetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsWafIpset)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafIpset)SetId(val *string) {
...
func DataAwsWafIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafIpset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafIpset_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafIpset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafIpset_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafIpset_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafIpset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafIpset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafIpset) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafIpset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafIpset) ToHclTerraform() interface{} {
	var returns interface{}
