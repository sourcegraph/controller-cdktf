...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/rolesanywhere_trust_anchor aws_rolesanywhere_trust_anchor}.
...
type jsiiProxy_RolesanywhereTrustAnchor struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_RolesanywhereTrustAnchor) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Node() constructs.Node {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Source() RolesanywhereTrustAnchorSourceOutputReference {
	var returns RolesanywhereTrustAnchorSourceOutputReference
	_jsii_.Get(
		j,
		"source",
		&returns,
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) SourceInput() *RolesanywhereTrustAnchorSource {
	var returns *RolesanywhereTrustAnchorSource
	_jsii_.Get(
		j,
		"sourceInput",
		&returns,
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) Tags() *map[string]*string {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RolesanywhereTrustAnchor) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewRolesanywhereTrustAnchor(scope constructs.Construct, id *string, config *RolesanywhereTrustAnchorConfig) RolesanywhereTrustAnchor {
	...
	if err := validateNewRolesanywhereTrustAnchorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RolesanywhereTrustAnchor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRolesanywhereTrustAnchor_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ResetEnabled() {
	_jsii_.InvokeVoid(
		r,
		"resetEnabled",
		nil, // no parameters
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ResetTags() {
	_jsii_.InvokeVoid(
		r,
		"resetTags",
		nil, // no parameters
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ResetTagsAll() {
	_jsii_.InvokeVoid(
		r,
		"resetTagsAll",
		nil, // no parameters
...
func (r *jsiiProxy_RolesanywhereTrustAnchor) ToString() *string {
	var returns *string
