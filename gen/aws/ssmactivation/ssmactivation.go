...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmactivation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ssm_activation aws_ssm_activation}.
...
func NewSsmActivation(scope constructs.Construct, id *string, config *SsmActivationConfig) SsmActivation {
	...
	if err := validateNewSsmActivationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SsmActivation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSsmActivation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmActivation) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SsmActivation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SsmActivation) MoveFromId(id *string) {
...
func (s *jsiiProxy_SsmActivation) MoveToId(id *string) {
