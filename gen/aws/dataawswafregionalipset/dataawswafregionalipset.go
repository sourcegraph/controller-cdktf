package dataawswafregionalipset
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafregionalipset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/wafregional_ipset aws_wafregional_ipset}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/wafregional_ipset aws_wafregional_ipset} Data Source.
func NewDataAwsWafregionalIpset(scope constructs.Construct, id *string, config *DataAwsWafregionalIpsetConfig) DataAwsWafregionalIpset {
	...
	if err := validateNewDataAwsWafregionalIpsetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafregionalIpset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalIpset_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafregionalIpset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafregionalIpset_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafregionalIpset_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsWafregionalIpset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsWafregionalIpset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafregionalIpset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafregionalIpset) ToHclTerraform() interface{} {
	var returns interface{}
