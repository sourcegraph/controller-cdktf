...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/connectcontactflow/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/connect_contact_flow aws_connect_contact_flow}.
...
func (j *jsiiProxy_ConnectContactFlow) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ConnectContactFlow) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewConnectContactFlow(scope constructs.Construct, id *string, config *ConnectContactFlowConfig) ConnectContactFlow {
	...
	if err := validateNewConnectContactFlowParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ConnectContactFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateConnectContactFlow_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConnectContactFlow) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConnectContactFlow) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ConnectContactFlow) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConnectContactFlow) MoveToId(id *string) {
...
func (c *jsiiProxy_ConnectContactFlow) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
