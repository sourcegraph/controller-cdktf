...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/pinpointbaiduchannel/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/pinpoint_baidu_channel aws_pinpoint_baidu_channel}.
...
func NewPinpointBaiduChannel(scope constructs.Construct, id *string, config *PinpointBaiduChannelConfig) PinpointBaiduChannel {
	...
	if err := validateNewPinpointBaiduChannelParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PinpointBaiduChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePinpointBaiduChannel_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PinpointBaiduChannel) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PinpointBaiduChannel) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PinpointBaiduChannel) MoveFromId(id *string) {
...
func (p *jsiiProxy_PinpointBaiduChannel) MoveToId(id *string) {
