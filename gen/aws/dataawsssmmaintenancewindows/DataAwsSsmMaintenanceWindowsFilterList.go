...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsssmmaintenancewindows/internal"
)
...
func NewDataAwsSsmMaintenanceWindowsFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsSsmMaintenanceWindowsFilterList {
	...
	if err := validateNewDataAwsSsmMaintenanceWindowsFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSsmMaintenanceWindowsFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
