...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsdatapipelinepipeline/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/datapipeline_pipeline aws_datapipeline_pipeline}.
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/datapipeline_pipeline aws_datapipeline_pipeline} Data Source.
func NewDataAwsDatapipelinePipeline(scope constructs.Construct, id *string, config *DataAwsDatapipelinePipelineConfig) DataAwsDatapipelinePipeline {
	...
	if err := validateNewDataAwsDatapipelinePipelineParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsDatapipelinePipeline)SetId(val *string) {
...
func DataAwsDatapipelinePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsDatapipelinePipeline_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsDatapipelinePipeline_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsDatapipelinePipeline_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDatapipelinePipeline_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDatapipelinePipeline_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDatapipelinePipeline_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDatapipelinePipeline_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDatapipelinePipeline) ToHclTerraform() interface{} {
	var returns interface{}
