...
func NewLexIntentFollowUpPromptRejectionStatementMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentFollowUpPromptRejectionStatementMessageList {
	...
	if err := validateNewLexIntentFollowUpPromptRejectionStatementMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LexIntentFollowUpPromptRejectionStatementMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
