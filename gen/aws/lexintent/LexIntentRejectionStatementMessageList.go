...
func NewLexIntentRejectionStatementMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LexIntentRejectionStatementMessageList {
	...
	if err := validateNewLexIntentRejectionStatementMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LexIntentRejectionStatementMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
