...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/codestarconnectionsconnection/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codestarconnections_connection aws_codestarconnections_connection}.
...
func (j *jsiiProxy_CodestarconnectionsConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CodestarconnectionsConnection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCodestarconnectionsConnection(scope constructs.Construct, id *string, config *CodestarconnectionsConnectionConfig) CodestarconnectionsConnection {
	...
	if err := validateNewCodestarconnectionsConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodestarconnectionsConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodestarconnectionsConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodestarconnectionsConnection) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) MoveToId(id *string) {
...
func (c *jsiiProxy_CodestarconnectionsConnection) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
