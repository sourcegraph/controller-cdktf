...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecrpublic_repository aws_ecrpublic_repository}.
...
func (j *jsiiProxy_EcrpublicRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrpublicRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEcrpublicRepository(scope constructs.Construct, id *string, config *EcrpublicRepositoryConfig) EcrpublicRepository {
	...
	if err := validateNewEcrpublicRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EcrpublicRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateEcrpublicRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcrpublicRepository) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrpublicRepository) PutCatalogData(value *EcrpublicRepositoryCatalogData) {
	if err := e.validatePutCatalogDataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_EcrpublicRepository) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
