...
// The jsii proxy struct for AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List
type jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewAppmeshVirtualNodeSpecListenerConnectionPoolHttp2List(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List {
	...
	if err := validateNewAppmeshVirtualNodeSpecListenerConnectionPoolHttp2ListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) Get(index *float64) AppmeshVirtualNodeSpecListenerConnectionPoolHttp2OutputReference {
...
func (a *jsiiProxy_AppmeshVirtualNodeSpecListenerConnectionPoolHttp2List) ToString() *string {
	var returns *string
