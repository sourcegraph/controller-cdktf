...
func (a *jsiiProxy_AppmeshVirtualNodeSpecBackendList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_AppmeshVirtualNodeSpecBackendList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*AppmeshVirtualNodeSpecBackend:
		val := val.(*[]*AppmeshVirtualNodeSpecBackend)
	...
	case []*AppmeshVirtualNodeSpecBackend:
		val_ := val.([]*AppmeshVirtualNodeSpecBackend)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*AppmeshVirtualNodeSpecBackend; received %#v (a %T)", val, val)
		}
	}
