...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_GlueTriggerTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GlueTriggerTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueTriggerTimeoutsOutputReference) ToString() *string {
	var returns *string
