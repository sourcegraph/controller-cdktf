...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cognito_user_pool_client aws_cognito_user_pool_client}.
...
func NewDataAwsCognitoUserPoolClient(scope constructs.Construct, id *string, config *DataAwsCognitoUserPoolClientConfig) DataAwsCognitoUserPoolClient {
	...
	if err := validateNewDataAwsCognitoUserPoolClientParameters(scope, id, config); err != nil {
		panic(err)
	}
