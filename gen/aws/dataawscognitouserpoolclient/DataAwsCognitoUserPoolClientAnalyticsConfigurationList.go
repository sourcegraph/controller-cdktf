...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscognitouserpoolclient/internal"
)
...
func NewDataAwsCognitoUserPoolClientAnalyticsConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsCognitoUserPoolClientAnalyticsConfigurationList {
	...
	if err := validateNewDataAwsCognitoUserPoolClientAnalyticsConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCognitoUserPoolClientAnalyticsConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
