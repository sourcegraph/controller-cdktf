...
func (j *jsiiProxy_DataAwsKendraThesaurusSourceS3PathList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsKendraThesaurusSourceS3PathList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
