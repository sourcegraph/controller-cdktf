...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appautoscalingtarget/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appautoscaling_target aws_appautoscaling_target}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appautoscaling_target aws_appautoscaling_target} Resource.
func NewAppautoscalingTarget(scope constructs.Construct, id *string, config *AppautoscalingTargetConfig) AppautoscalingTarget {
	_init_.Initialize()

	if err := validateNewAppautoscalingTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppautoscalingTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppautoscalingTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AppautoscalingTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppautoscalingTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppautoscalingTarget) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppautoscalingTarget) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppautoscalingTarget) ToHclTerraform() interface{} {
	var returns interface{}
