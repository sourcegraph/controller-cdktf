...
func (d *jsiiProxy_DataAwsAvailabilityZoneFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsAvailabilityZoneFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DataAwsAvailabilityZoneFilter:
		val := val.(*[]*DataAwsAvailabilityZoneFilter)
	...
	case []*DataAwsAvailabilityZoneFilter:
		val_ := val.([]*DataAwsAvailabilityZoneFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsAvailabilityZoneFilter; received %#v (a %T)", val, val)
		}
	}
