...
func NewLightsailInstancePublicPortsPortInfoList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LightsailInstancePublicPortsPortInfoList {
	...
	if err := validateNewLightsailInstancePublicPortsPortInfoListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LightsailInstancePublicPortsPortInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
