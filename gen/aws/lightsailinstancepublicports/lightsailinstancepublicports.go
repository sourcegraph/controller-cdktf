...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_instance_public_ports aws_lightsail_instance_public_ports}.
...
func NewLightsailInstancePublicPorts(scope constructs.Construct, id *string, config *LightsailInstancePublicPortsConfig) LightsailInstancePublicPorts {
	...
	if err := validateNewLightsailInstancePublicPortsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LightsailInstancePublicPorts_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailInstancePublicPorts_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LightsailInstancePublicPorts) AddMoveTarget(moveTarget *string) {
