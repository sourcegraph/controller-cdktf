...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamopenidconnectprovider/internal"
)
...
func (j *jsiiProxy_IamOpenidConnectProvider) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamOpenidConnectProvider) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamOpenidConnectProvider(scope constructs.Construct, id *string, config *IamOpenidConnectProviderConfig) IamOpenidConnectProvider {
	...
	if err := validateNewIamOpenidConnectProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamOpenidConnectProvider) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
