...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamgrouppolicy/internal"
)
...
func (j *jsiiProxy_IamGroupPolicy) Connection() interface{} {
...
func (j *jsiiProxy_IamGroupPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamGroupPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamGroupPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewIamGroupPolicy(scope constructs.Construct, id *string, config *IamGroupPolicyConfig) IamGroupPolicy {
	...
	if err := validateNewIamGroupPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IamGroupPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_IamGroupPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IamGroupPolicy)SetId(val *string) {
...
func (j *jsiiProxy_IamGroupPolicy)SetProvisioners(val *[]interface{}) {
...
func IamGroupPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateIamGroupPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IamGroupPolicy) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
