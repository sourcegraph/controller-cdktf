...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference {
	...
	_jsii_.Create(
		"aws.s3ControlMultiRegionAccessPointPolicy.S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference",
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicyTimeoutsOutputReference) ToString() *string {
	var returns *string
