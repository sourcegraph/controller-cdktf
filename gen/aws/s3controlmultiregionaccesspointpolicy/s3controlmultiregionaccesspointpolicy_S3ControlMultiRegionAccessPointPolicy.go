...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) Connection() interface{} {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func NewS3ControlMultiRegionAccessPointPolicy(scope constructs.Construct, id *string, config *S3ControlMultiRegionAccessPointPolicyConfig) S3ControlMultiRegionAccessPointPolicy {
	...
	if err := validateNewS3ControlMultiRegionAccessPointPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetId(val *string) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicy)SetProvisioners(val *[]interface{}) {
...
func S3ControlMultiRegionAccessPointPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3ControlMultiRegionAccessPointPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
