...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3ControlMultiRegionAccessPointPolicyDetailsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3ControlMultiRegionAccessPointPolicyDetailsOutputReference {
	_init_.Initialize()

	if err := validateNewS3ControlMultiRegionAccessPointPolicyDetailsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3ControlMultiRegionAccessPointPolicyDetailsOutputReference_Override(s S3ControlMultiRegionAccessPointPolicyDetailsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPointPolicyDetailsOutputReference) ToString() *string {
	var returns *string
