...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudcontrolapiresource/internal"
)
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewCloudcontrolapiResourceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudcontrolapiResourceTimeoutsOutputReference {
	...
	if err := validateNewCloudcontrolapiResourceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudcontrolapiResourceTimeoutsOutputReference) ToString() *string {
	var returns *string
