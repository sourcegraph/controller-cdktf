...
func (j *jsiiProxy_CloudcontrolapiResource) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudcontrolapiResource) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudcontrolapiResource(scope constructs.Construct, id *string, config *CloudcontrolapiResourceConfig) CloudcontrolapiResource {
	...
	if err := validateNewCloudcontrolapiResourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudcontrolapiResource) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
