...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lambdalayerversionpermission/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lambda_layer_version_permission aws_lambda_layer_version_permission}.
...
func LambdaLayerVersionPermission_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLambdaLayerVersionPermission_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaLayerVersionPermission) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) MoveFromId(id *string) {
...
func (l *jsiiProxy_LambdaLayerVersionPermission) MoveToId(id *string) {
