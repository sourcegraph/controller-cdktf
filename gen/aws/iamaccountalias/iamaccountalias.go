...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamaccountalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_account_alias aws_iam_account_alias}.
...
func (j *jsiiProxy_IamAccountAlias) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamAccountAlias) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamAccountAlias(scope constructs.Construct, id *string, config *IamAccountAliasConfig) IamAccountAlias {
	...
	if err := validateNewIamAccountAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamAccountAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamAccountAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamAccountAlias) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamAccountAlias) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamAccountAlias) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamAccountAlias) MoveToId(id *string) {
...
func (i *jsiiProxy_IamAccountAlias) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
