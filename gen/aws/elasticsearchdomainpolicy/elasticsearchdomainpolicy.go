...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/elasticsearchdomainpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/elasticsearch_domain_policy aws_elasticsearch_domain_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/elasticsearch_domain_policy aws_elasticsearch_domain_policy} Resource.
func NewElasticsearchDomainPolicy(scope constructs.Construct, id *string, config *ElasticsearchDomainPolicyConfig) ElasticsearchDomainPolicy {
	...
	if err := validateNewElasticsearchDomainPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ElasticsearchDomainPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElasticsearchDomainPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ElasticsearchDomainPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateElasticsearchDomainPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ElasticsearchDomainPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticsearchDomainPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ElasticsearchDomainPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateElasticsearchDomainPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_ElasticsearchDomainPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElasticsearchDomainPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ElasticsearchDomainPolicy) ToHclTerraform() interface{} {
	var returns interface{}
