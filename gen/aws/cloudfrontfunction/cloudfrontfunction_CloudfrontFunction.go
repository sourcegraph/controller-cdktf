...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudfrontfunction/internal"
)
...
func (j *jsiiProxy_CloudfrontFunction) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudfrontFunction) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontFunction(scope constructs.Construct, id *string, config *CloudfrontFunctionConfig) CloudfrontFunction {
	...
	if err := validateNewCloudfrontFunctionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontFunction) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
