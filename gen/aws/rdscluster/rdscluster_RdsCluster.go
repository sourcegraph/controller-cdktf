...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/rdscluster/internal"
)
...
func (j *jsiiProxy_RdsCluster) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RdsCluster)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
