...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocumentRuleItemsList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	case cdktf.IResolvable:
		// ok
	case *[]*DataAwsRoute53TrafficPolicyDocumentRuleItems:
		val := val.(*[]*DataAwsRoute53TrafficPolicyDocumentRuleItems)
	...
	case []*DataAwsRoute53TrafficPolicyDocumentRuleItems:
		val_ := val.([]*DataAwsRoute53TrafficPolicyDocumentRuleItems)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsRoute53TrafficPolicyDocumentRuleItems; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocumentRuleItemsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocumentRuleItemsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
