...
func (d *jsiiProxy_DataAwsRoute53TrafficPolicyDocumentEndpointList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsRoute53TrafficPolicyDocumentEndpointList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*DataAwsRoute53TrafficPolicyDocumentEndpoint:
		val := val.(*[]*DataAwsRoute53TrafficPolicyDocumentEndpoint)
	...
	case []*DataAwsRoute53TrafficPolicyDocumentEndpoint:
		val_ := val.([]*DataAwsRoute53TrafficPolicyDocumentEndpoint)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DataAwsRoute53TrafficPolicyDocumentEndpoint; received %#v (a %T)", val, val)
		}
	}
