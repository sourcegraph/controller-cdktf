...
func (j *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksGangliaLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksGangliaLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksGangliaLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksGangliaLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksGangliaLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksGangliaLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
