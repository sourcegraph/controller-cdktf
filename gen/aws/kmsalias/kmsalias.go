...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/kmsalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/kms_alias aws_kms_alias}.
...
func (j *jsiiProxy_KmsAlias) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KmsAlias) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewKmsAlias(scope constructs.Construct, id *string, config *KmsAliasConfig) KmsAlias {
	...
	if err := validateNewKmsAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func KmsAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKmsAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KmsAlias) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KmsAlias) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KmsAlias) MoveFromId(id *string) {
...
func (k *jsiiProxy_KmsAlias) MoveToId(id *string) {
...
func (k *jsiiProxy_KmsAlias) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
