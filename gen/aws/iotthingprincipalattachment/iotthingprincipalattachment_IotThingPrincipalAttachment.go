...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iotthingprincipalattachment/internal"
)
...
func (j *jsiiProxy_IotThingPrincipalAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotThingPrincipalAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIotThingPrincipalAttachment(scope constructs.Construct, id *string, config *IotThingPrincipalAttachmentConfig) IotThingPrincipalAttachment {
	...
	if err := validateNewIotThingPrincipalAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotThingPrincipalAttachment) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
