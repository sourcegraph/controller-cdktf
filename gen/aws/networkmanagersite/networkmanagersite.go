...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/networkmanager_site aws_networkmanager_site}.
type NetworkmanagerSite interface {
	...
	LocationInput() *NetworkmanagerSiteLocation
	// The tree node.
	...
	PutTimeouts(value *NetworkmanagerSiteTimeouts)
	ResetDescription()
	ResetId()
	ResetLocation()
...
func (j *jsiiProxy_NetworkmanagerSite) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_NetworkmanagerSite) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkmanagerSite) LocationInput() *NetworkmanagerSiteLocation {
...
func (j *jsiiProxy_NetworkmanagerSite) Tags() *map[string]*string {
...
func (j *jsiiProxy_NetworkmanagerSite) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_NetworkmanagerSite) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_NetworkmanagerSite) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_NetworkmanagerSite) Timeouts() NetworkmanagerSiteTimeoutsOutputReference {
	var returns NetworkmanagerSiteTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (n *jsiiProxy_NetworkmanagerSite) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkmanagerSite) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkmanagerSite) PutTimeouts(value *NetworkmanagerSiteTimeouts) {
...
func (n *jsiiProxy_NetworkmanagerSite) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSite) ResetTagsAll() {
	_jsii_.InvokeVoid(
		n,
		"resetTagsAll",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkmanagerSite) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
