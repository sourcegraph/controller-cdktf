...
type DbInstanceAutomatedBackupsReplication interface {
	...
	SetSourceDbInstanceArn(val *string)
	SourceDbInstanceArnInput() *string
	// Experimental.
	...
	PutTimeouts(value *DbInstanceAutomatedBackupsReplicationTimeouts)
	ResetId()
	ResetKmsKeyId()
...
type jsiiProxy_DbInstanceAutomatedBackupsReplication struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) KmsKeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdInput",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Node() constructs.Node {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) PreSignedUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"preSignedUrl",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) PreSignedUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"preSignedUrlInput",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) RetentionPeriodInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) SourceDbInstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceDbInstanceArn",
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) SourceDbInstanceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceDbInstanceArnInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DbInstanceAutomatedBackupsReplication) Timeouts() DbInstanceAutomatedBackupsReplicationTimeoutsOutputReference {
	var returns DbInstanceAutomatedBackupsReplicationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDbInstanceAutomatedBackupsReplication(scope constructs.Construct, id *string, config *DbInstanceAutomatedBackupsReplicationConfig) DbInstanceAutomatedBackupsReplication {
	...
	if err := validateNewDbInstanceAutomatedBackupsReplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DbInstanceAutomatedBackupsReplication_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws.dbInstanceAutomatedBackupsReplication.DbInstanceAutomatedBackupsReplication",
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) PutTimeouts(value *DbInstanceAutomatedBackupsReplicationTimeouts) {
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetKmsKeyId() {
	_jsii_.InvokeVoid(
		d,
		"resetKmsKeyId",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetPreSignedUrl() {
	_jsii_.InvokeVoid(
		d,
		"resetPreSignedUrl",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetRetentionPeriod() {
	_jsii_.InvokeVoid(
		d,
		"resetRetentionPeriod",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DbInstanceAutomatedBackupsReplication) ToString() *string {
	var returns *string
