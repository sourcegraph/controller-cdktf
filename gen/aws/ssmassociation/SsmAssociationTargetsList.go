...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssmassociation/internal"
)
...
func NewSsmAssociationTargetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsmAssociationTargetsList {
	...
	if err := validateNewSsmAssociationTargetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SsmAssociationTargetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
