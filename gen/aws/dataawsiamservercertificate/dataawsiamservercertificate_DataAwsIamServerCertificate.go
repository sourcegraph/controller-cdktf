...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamservercertificate/internal"
)
...
func (j *jsiiProxy_DataAwsIamServerCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamServerCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamServerCertificate(scope constructs.Construct, id *string, config *DataAwsIamServerCertificateConfig) DataAwsIamServerCertificate {
	...
	if err := validateNewDataAwsIamServerCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsIamServerCertificate)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsIamServerCertificate)SetId(val *string) {
...
func DataAwsIamServerCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsIamServerCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsIamServerCertificate) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
