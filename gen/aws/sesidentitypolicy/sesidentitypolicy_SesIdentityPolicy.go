...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesidentitypolicy/internal"
)
...
func (j *jsiiProxy_SesIdentityPolicy) Connection() interface{} {
...
func (j *jsiiProxy_SesIdentityPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesIdentityPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesIdentityPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSesIdentityPolicy(scope constructs.Construct, id *string, config *SesIdentityPolicyConfig) SesIdentityPolicy {
	...
	if err := validateNewSesIdentityPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesIdentityPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SesIdentityPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesIdentityPolicy)SetId(val *string) {
...
func (j *jsiiProxy_SesIdentityPolicy)SetProvisioners(val *[]interface{}) {
...
func SesIdentityPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateSesIdentityPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SesIdentityPolicy) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SesIdentityPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesIdentityPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesIdentityPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesIdentityPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesIdentityPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
