...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsmskconnectconnector/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/mskconnect_connector aws_mskconnect_connector}.
...
func NewDataAwsMskconnectConnector(scope constructs.Construct, id *string, config *DataAwsMskconnectConnectorConfig) DataAwsMskconnectConnector {
	...
	if err := validateNewDataAwsMskconnectConnectorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsMskconnectConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskconnectConnector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
