...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/snstopicpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sns_topic_policy aws_sns_topic_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/sns_topic_policy aws_sns_topic_policy} Resource.
func NewSnsTopicPolicy(scope constructs.Construct, id *string, config *SnsTopicPolicyConfig) SnsTopicPolicy {
	_init_.Initialize()

	if err := validateNewSnsTopicPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SnsTopicPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSnsTopicPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SnsTopicPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateSnsTopicPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SnsTopicPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SnsTopicPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SnsTopicPolicy) ToHclTerraform() interface{} {
	var returns interface{}
