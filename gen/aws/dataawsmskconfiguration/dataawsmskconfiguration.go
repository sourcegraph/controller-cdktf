...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsmskconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/msk_configuration aws_msk_configuration}.
...
func NewDataAwsMskConfiguration(scope constructs.Construct, id *string, config *DataAwsMskConfigurationConfig) DataAwsMskConfiguration {
	...
	if err := validateNewDataAwsMskConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsMskConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsMskConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
