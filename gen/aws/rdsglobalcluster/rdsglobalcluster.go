...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/rds_global_cluster aws_rds_global_cluster}.
type RdsGlobalCluster interface {
	...
	GlobalClusterMembers() RdsGlobalClusterGlobalClusterMembersList
	...
	PutTimeouts(value *RdsGlobalClusterTimeouts)
	ResetDatabaseName()
...
func (j *jsiiProxy_RdsGlobalCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RdsGlobalCluster) GlobalClusterMembers() RdsGlobalClusterGlobalClusterMembersList {
	var returns RdsGlobalClusterGlobalClusterMembersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RdsGlobalCluster) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RdsGlobalCluster) Timeouts() RdsGlobalClusterTimeoutsOutputReference {
	var returns RdsGlobalClusterTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewRdsGlobalCluster(scope constructs.Construct, id *string, config *RdsGlobalClusterConfig) RdsGlobalCluster {
	...
	if err := validateNewRdsGlobalClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RdsGlobalCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRdsGlobalCluster_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RdsGlobalCluster) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RdsGlobalCluster) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RdsGlobalCluster) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RdsGlobalCluster) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RdsGlobalCluster) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RdsGlobalCluster) PutTimeouts(value *RdsGlobalClusterTimeouts) {
...
func (r *jsiiProxy_RdsGlobalCluster) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RdsGlobalCluster) ResetTimeouts() {
	_jsii_.InvokeVoid(
		r,
		"resetTimeouts",
		nil, // no parameters
