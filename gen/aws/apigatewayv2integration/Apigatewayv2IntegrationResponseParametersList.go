...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/apigatewayv2integration/internal"
)
...
func NewApigatewayv2IntegrationResponseParametersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) Apigatewayv2IntegrationResponseParametersList {
	...
	if err := validateNewApigatewayv2IntegrationResponseParametersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
