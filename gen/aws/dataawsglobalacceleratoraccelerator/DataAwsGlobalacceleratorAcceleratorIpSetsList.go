...
func NewDataAwsGlobalacceleratorAcceleratorIpSetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsGlobalacceleratorAcceleratorIpSetsList {
	...
	if err := validateNewDataAwsGlobalacceleratorAcceleratorIpSetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsGlobalacceleratorAcceleratorIpSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
