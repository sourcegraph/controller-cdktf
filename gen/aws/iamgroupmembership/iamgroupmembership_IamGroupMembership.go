...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamgroupmembership/internal"
)
...
func (j *jsiiProxy_IamGroupMembership) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamGroupMembership) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamGroupMembership(scope constructs.Construct, id *string, config *IamGroupMembershipConfig) IamGroupMembership {
	...
	if err := validateNewIamGroupMembershipParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_IamGroupMembership{}

	_jsii_.Create(
		"aws.iamGroupMembership.IamGroupMembership",
...
func (i *jsiiProxy_IamGroupMembership) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
