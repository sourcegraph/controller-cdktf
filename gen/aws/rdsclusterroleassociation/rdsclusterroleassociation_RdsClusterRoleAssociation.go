...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/rdsclusterroleassociation/internal"
)
...
func (j *jsiiProxy_RdsClusterRoleAssociation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RdsClusterRoleAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RdsClusterRoleAssociation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_RdsClusterRoleAssociation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
