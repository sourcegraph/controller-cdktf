...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsorganizationsorganization/internal"
)
...
func NewDataAwsOrganizationsOrganizationNonMasterAccountsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference {
	...
	if err := validateNewDataAwsOrganizationsOrganizationNonMasterAccountsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
