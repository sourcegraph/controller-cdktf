...
func (m *jsiiProxy_MedialiveInputDestinationsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_MedialiveInputDestinationsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_MedialiveInputDestinationsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
