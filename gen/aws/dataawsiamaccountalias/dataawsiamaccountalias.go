package dataawsiamaccountalias
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsiamaccountalias/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/iam_account_alias aws_iam_account_alias}.
...
func (j *jsiiProxy_DataAwsIamAccountAlias) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsIamAccountAlias) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsIamAccountAlias(scope constructs.Construct, id *string, config *DataAwsIamAccountAliasConfig) DataAwsIamAccountAlias {
	...
	if err := validateNewDataAwsIamAccountAliasParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsIamAccountAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsIamAccountAlias_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsIamAccountAlias) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
