...
func (k *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionStaticColumnList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*KeyspacesTableSchemaDefinitionStaticColumn:
		val_ := val.([]*KeyspacesTableSchemaDefinitionStaticColumn)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
