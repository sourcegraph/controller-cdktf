...
func (k *jsiiProxy_KeyspacesTableSchemaDefinitionClusteringKeyList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionClusteringKeyList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*KeyspacesTableSchemaDefinitionClusteringKey:
		val_ := val.([]*KeyspacesTableSchemaDefinitionClusteringKey)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionClusteringKeyList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_KeyspacesTableSchemaDefinitionClusteringKeyList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
