...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSchemaDefinition", GoMethod: "PutSchemaDefinition"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putClusteringKey", GoMethod: "PutClusteringKey"},
			_jsii_.MemberMethod{JsiiMethod: "putColumn", GoMethod: "PutColumn"},
			_jsii_.MemberMethod{JsiiMethod: "putPartitionKey", GoMethod: "PutPartitionKey"},
			_jsii_.MemberMethod{JsiiMethod: "putStaticColumn", GoMethod: "PutStaticColumn"},
			_jsii_.MemberMethod{JsiiMethod: "resetClusteringKey", GoMethod: "ResetClusteringKey"},
			_jsii_.MemberMethod{JsiiMethod: "resetStaticColumn", GoMethod: "ResetStaticColumn"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "staticColumn", GoGetter: "StaticColumn"},
			_jsii_.MemberProperty{JsiiProperty: "staticColumnInput", GoGetter: "StaticColumnInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
