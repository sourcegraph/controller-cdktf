...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/schemasschema/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/schemas_schema aws_schemas_schema}.
...
func (j *jsiiProxy_SchemasSchema) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SchemasSchema) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSchemasSchema(scope constructs.Construct, id *string, config *SchemasSchemaConfig) SchemasSchema {
	...
	if err := validateNewSchemasSchemaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SchemasSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSchemasSchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SchemasSchema) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SchemasSchema) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
