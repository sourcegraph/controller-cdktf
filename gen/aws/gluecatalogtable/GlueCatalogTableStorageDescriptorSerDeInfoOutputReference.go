...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewGlueCatalogTableStorageDescriptorSerDeInfoOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GlueCatalogTableStorageDescriptorSerDeInfoOutputReference {
	...
	if err := validateNewGlueCatalogTableStorageDescriptorSerDeInfoOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference{}

	_jsii_.Create(
		"aws.glueCatalogTable.GlueCatalogTableStorageDescriptorSerDeInfoOutputReference",
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (g *jsiiProxy_GlueCatalogTableStorageDescriptorSerDeInfoOutputReference) ToString() *string {
	var returns *string
