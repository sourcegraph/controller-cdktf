...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/identitystore_group aws_identitystore_group}.
type IdentitystoreGroup interface {
	...
	ExternalIds() IdentitystoreGroupExternalIdsList
	// Experimental.
...
type jsiiProxy_IdentitystoreGroup struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_IdentitystoreGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IdentitystoreGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IdentitystoreGroup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_IdentitystoreGroup) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_IdentitystoreGroup) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_IdentitystoreGroup) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_IdentitystoreGroup) ExternalIds() IdentitystoreGroupExternalIdsList {
	var returns IdentitystoreGroupExternalIdsList
	_jsii_.Get(
		j,
		"externalIds",
		&returns,
...
func (j *jsiiProxy_IdentitystoreGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IdentitystoreGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IdentitystoreGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IdentitystoreGroup) GroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupId",
...
func (j *jsiiProxy_IdentitystoreGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IdentitystoreGroup) IdentityStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityStoreId",
...
func (j *jsiiProxy_IdentitystoreGroup) IdentityStoreIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IdentitystoreGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IdentitystoreGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IdentitystoreGroup) Node() constructs.Node {
...
func (j *jsiiProxy_IdentitystoreGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IdentitystoreGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IdentitystoreGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewIdentitystoreGroup(scope constructs.Construct, id *string, config *IdentitystoreGroupConfig) IdentitystoreGroup {
	...
	if err := validateNewIdentitystoreGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IdentitystoreGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIdentitystoreGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IdentitystoreGroup_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.identitystoreGroup.IdentitystoreGroup",
...
func (i *jsiiProxy_IdentitystoreGroup) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IdentitystoreGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentitystoreGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IdentitystoreGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IdentitystoreGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IdentitystoreGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IdentitystoreGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IdentitystoreGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IdentitystoreGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IdentitystoreGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentitystoreGroup) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IdentitystoreGroup) ResetDescription() {
	_jsii_.InvokeVoid(
		i,
		"resetDescription",
		nil, // no parameters
...
func (i *jsiiProxy_IdentitystoreGroup) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IdentitystoreGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IdentitystoreGroup) ToString() *string {
	var returns *string
