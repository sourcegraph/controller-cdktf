...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) EgressFilter() AppmeshMeshSpecEgressFilterOutputReference {
	var returns AppmeshMeshSpecEgressFilterOutputReference
	_jsii_.Get(
		j,
		"egressFilter",
		&returns,
...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) EgressFilterInput() *AppmeshMeshSpecEgressFilter {
...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppmeshMeshSpecOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) PutEgressFilter(value *AppmeshMeshSpecEgressFilter) {
...
func (a *jsiiProxy_AppmeshMeshSpecOutputReference) ToString() *string {
	var returns *string
