...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLbListenerRuleConditionHostHeaderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LbListenerRuleConditionHostHeaderOutputReference {
	...
	if err := validateNewLbListenerRuleConditionHostHeaderOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LbListenerRuleConditionHostHeaderOutputReference) ToString() *string {
	var returns *string
