...
type LbListenerRuleCondition struct {
	// host_header block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lb_listener_rule#host_header LbListenerRule#host_header}
	HostHeader *LbListenerRuleConditionHostHeader `field:"optional" json:"hostHeader" yaml:"hostHeader"`
	// http_header block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lb_listener_rule#http_header LbListenerRule#http_header}
	HttpHeader *LbListenerRuleConditionHttpHeader `field:"optional" json:"httpHeader" yaml:"httpHeader"`
	// http_request_method block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lb_listener_rule#http_request_method LbListenerRule#http_request_method}
	HttpRequestMethod *LbListenerRuleConditionHttpRequestMethod `field:"optional" json:"httpRequestMethod" yaml:"httpRequestMethod"`
	// path_pattern block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lb_listener_rule#path_pattern LbListenerRule#path_pattern}
