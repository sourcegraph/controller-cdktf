...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLbListenerRuleConditionHttpHeaderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LbListenerRuleConditionHttpHeaderOutputReference {
	...
	if err := validateNewLbListenerRuleConditionHttpHeaderOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbListenerRuleConditionHttpHeaderOutputReference) ToString() *string {
	var returns *string
