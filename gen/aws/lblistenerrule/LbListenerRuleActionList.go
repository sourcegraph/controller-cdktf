...
func (j *jsiiProxy_LbListenerRuleActionList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LbListenerRuleActionList) InternalValue() interface{} {
...
func (j *jsiiProxy_LbListenerRuleActionList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LbListenerRuleActionList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_LbListenerRuleActionList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_LbListenerRuleActionList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_LbListenerRuleActionList)SetWrapsSet(val *bool) {
...
func (l *jsiiProxy_LbListenerRuleActionList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LbListenerRuleActionList) Get(index *float64) LbListenerRuleActionOutputReference {
	if err := l.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns LbListenerRuleActionOutputReference
...
func (l *jsiiProxy_LbListenerRuleActionList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LbListenerRuleActionList) ToString() *string {
	var returns *string
