...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53recoverycontrolconfigroutingcontrol/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53recoverycontrolconfig_routing_control aws_route53recoverycontrolconfig_routing_control}.
...
func (j *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53RecoverycontrolconfigRoutingControl(scope constructs.Construct, id *string, config *Route53RecoverycontrolconfigRoutingControlConfig) Route53RecoverycontrolconfigRoutingControl {
	...
	if err := validateNewRoute53RecoverycontrolconfigRoutingControlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53RecoverycontrolconfigRoutingControl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53RecoverycontrolconfigRoutingControl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) MoveFromId(id *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) MoveToId(id *string) {
...
func (r *jsiiProxy_Route53RecoverycontrolconfigRoutingControl) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
