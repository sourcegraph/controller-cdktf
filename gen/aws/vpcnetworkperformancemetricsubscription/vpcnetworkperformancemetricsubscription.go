package vpcnetworkperformancemetricsubscription
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/vpcnetworkperformancemetricsubscription/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/vpc_network_performance_metric_subscription aws_vpc_network_performance_metric_subscription}.
...
type jsiiProxy_VpcNetworkPerformanceMetricSubscription struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Destination() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destination",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) DestinationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationInput",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Metric() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metric",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) MetricInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metricInput",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Node() constructs.Node {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Period() *string {
	var returns *string
	_jsii_.Get(
		j,
		"period",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) SourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceInput",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) Statistic() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statistic",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) StatisticInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statisticInput",
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VpcNetworkPerformanceMetricSubscription) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewVpcNetworkPerformanceMetricSubscription(scope constructs.Construct, id *string, config *VpcNetworkPerformanceMetricSubscriptionConfig) VpcNetworkPerformanceMetricSubscription {
	...
	if err := validateNewVpcNetworkPerformanceMetricSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VpcNetworkPerformanceMetricSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcNetworkPerformanceMetricSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VpcNetworkPerformanceMetricSubscription_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.vpcNetworkPerformanceMetricSubscription.VpcNetworkPerformanceMetricSubscription",
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ResetMetric() {
	_jsii_.InvokeVoid(
		v,
		"resetMetric",
		nil, // no parameters
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ResetStatistic() {
	_jsii_.InvokeVoid(
		v,
		"resetStatistic",
		nil, // no parameters
...
func (v *jsiiProxy_VpcNetworkPerformanceMetricSubscription) ToString() *string {
	var returns *string
