...
func (j *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (g *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GluePartitionStorageDescriptorSkewedInfoOutputReference) ToString() *string {
	var returns *string
