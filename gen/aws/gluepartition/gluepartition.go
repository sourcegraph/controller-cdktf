...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_partition aws_glue_partition}.
...
func (j *jsiiProxy_GluePartition) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GluePartition) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewGluePartition(scope constructs.Construct, id *string, config *GluePartitionConfig) GluePartition {
	...
	if err := validateNewGluePartitionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GluePartition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGluePartition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GluePartition) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GluePartition) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GluePartition) MoveFromId(id *string) {
...
func (g *jsiiProxy_GluePartition) MoveToId(id *string) {
...
func (g *jsiiProxy_GluePartition) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
