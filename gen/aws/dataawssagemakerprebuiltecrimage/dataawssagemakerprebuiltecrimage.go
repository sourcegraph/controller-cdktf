...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssagemakerprebuiltecrimage/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/sagemaker_prebuilt_ecr_image aws_sagemaker_prebuilt_ecr_image}.
...
func NewDataAwsSagemakerPrebuiltEcrImage(scope constructs.Construct, id *string, config *DataAwsSagemakerPrebuiltEcrImageConfig) DataAwsSagemakerPrebuiltEcrImage {
	...
	_jsii_.Create(
		"aws.dataAwsSagemakerPrebuiltEcrImage.DataAwsSagemakerPrebuiltEcrImage",
