...
func (j *jsiiProxy_S3BucketMetric) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3BucketMetric) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3BucketMetric(scope constructs.Construct, id *string, config *S3BucketMetricConfig) S3BucketMetric {
	...
	if err := validateNewS3BucketMetricParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3BucketMetric) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
