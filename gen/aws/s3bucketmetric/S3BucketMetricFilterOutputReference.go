...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3bucketmetric/internal"
)
...
func (j *jsiiProxy_S3BucketMetricFilterOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketMetricFilterOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketMetricFilterOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketMetricFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketMetricFilterOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketMetricFilterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3BucketMetricFilterOutputReference_Override(s S3BucketMetricFilterOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketMetricFilterOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketMetricFilterOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketMetricFilterOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketMetricFilterOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketMetricFilterOutputReference) ToString() *string {
	var returns *string
