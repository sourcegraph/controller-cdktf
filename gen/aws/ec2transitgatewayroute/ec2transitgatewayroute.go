...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2transitgatewayroute/internal"
)
...
type jsiiProxy_Ec2TransitGatewayRoute struct {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) DestinationCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) DestinationCidrBlockInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) Node() constructs.Node {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TransitGatewayAttachmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TransitGatewayAttachmentIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TransitGatewayRouteTableId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayRoute) TransitGatewayRouteTableIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewEc2TransitGatewayRoute(scope constructs.Construct, id *string, config *Ec2TransitGatewayRouteConfig) Ec2TransitGatewayRoute {
	...
	if err := validateNewEc2TransitGatewayRouteParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Ec2TransitGatewayRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2TransitGatewayRoute_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Ec2TransitGatewayRoute_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.ec2TransitGatewayRoute.Ec2TransitGatewayRoute",
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) MoveFromId(id *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) MoveToId(id *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ResetBlackhole() {
	_jsii_.InvokeVoid(
		e,
		"resetBlackhole",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ResetTransitGatewayAttachmentId() {
	_jsii_.InvokeVoid(
		e,
		"resetTransitGatewayAttachmentId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TransitGatewayRoute) ToString() *string {
	var returns *string
