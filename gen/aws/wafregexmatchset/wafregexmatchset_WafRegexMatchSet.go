...
func (j *jsiiProxy_WafRegexMatchSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WafRegexMatchSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_WafRegexMatchSet) RegexMatchTuple() WafRegexMatchSetRegexMatchTupleList {
	var returns WafRegexMatchSetRegexMatchTupleList
	_jsii_.Get(
		j,
		"regexMatchTuple",
		&returns,
...
func NewWafRegexMatchSet(scope constructs.Construct, id *string, config *WafRegexMatchSetConfig) WafRegexMatchSet {
	...
	if err := validateNewWafRegexMatchSetParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_WafRegexMatchSet{}

	_jsii_.Create(
		"aws.wafRegexMatchSet.WafRegexMatchSet",
...
func (w *jsiiProxy_WafRegexMatchSet) ResetId() {
	_jsii_.InvokeVoid(
		w,
		"resetId",
		nil, // no parameters
