...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsdxgateway/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/dx_gateway aws_dx_gateway}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/dx_gateway aws_dx_gateway} Data Source.
func NewDataAwsDxGateway(scope constructs.Construct, id *string, config *DataAwsDxGatewayConfig) DataAwsDxGateway {
	_init_.Initialize()

	if err := validateNewDataAwsDxGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsDxGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataAwsDxGateway_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsDxGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsDxGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxGateway_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxGateway_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsDxGateway_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsDxGateway_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsDxGateway) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDxGateway) ToHclTerraform() interface{} {
	var returns interface{}
