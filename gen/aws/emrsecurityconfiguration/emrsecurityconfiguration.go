...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/emrsecurityconfiguration/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/emr_security_configuration aws_emr_security_configuration}.
...
func (j *jsiiProxy_EmrSecurityConfiguration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmrSecurityConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEmrSecurityConfiguration(scope constructs.Construct, id *string, config *EmrSecurityConfigurationConfig) EmrSecurityConfiguration {
	...
	if err := validateNewEmrSecurityConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EmrSecurityConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmrSecurityConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrSecurityConfiguration) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) MoveFromId(id *string) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) MoveToId(id *string) {
...
func (e *jsiiProxy_EmrSecurityConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
