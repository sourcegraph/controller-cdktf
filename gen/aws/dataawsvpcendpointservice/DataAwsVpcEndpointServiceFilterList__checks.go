...
func (d *jsiiProxy_DataAwsVpcEndpointServiceFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_DataAwsVpcEndpointServiceFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*DataAwsVpcEndpointServiceFilter:
		val_ := val.([]*DataAwsVpcEndpointServiceFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
