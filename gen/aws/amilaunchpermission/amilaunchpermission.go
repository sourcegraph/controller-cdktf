...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "organizationalUnitArn", GoGetter: "OrganizationalUnitArn"},
			_jsii_.MemberProperty{JsiiProperty: "organizationalUnitArnInput", GoGetter: "OrganizationalUnitArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOrganizationalUnitArn", GoMethod: "ResetOrganizationalUnitArn"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrganizationArn", GoMethod: "ResetOrganizationArn"},
	...
	_jsii_.RegisterStruct(
		"aws.amiLaunchPermission.AmiLaunchPermissionConfig",
