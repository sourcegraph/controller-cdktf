...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lightsaildomainentry/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lightsail_domain_entry aws_lightsail_domain_entry}.
...
type jsiiProxy_LightsailDomainEntry struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_LightsailDomainEntry) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LightsailDomainEntry) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LightsailDomainEntry) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_LightsailDomainEntry) DomainNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainNameInput",
...
func (j *jsiiProxy_LightsailDomainEntry) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LightsailDomainEntry) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LightsailDomainEntry) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LightsailDomainEntry) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LightsailDomainEntry) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LightsailDomainEntry) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailDomainEntry) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LightsailDomainEntry) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LightsailDomainEntry) Node() constructs.Node {
...
func (j *jsiiProxy_LightsailDomainEntry) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LightsailDomainEntry) Target() *string {
	var returns *string
	_jsii_.Get(
		j,
		"target",
...
func (j *jsiiProxy_LightsailDomainEntry) TargetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetInput",
...
func (j *jsiiProxy_LightsailDomainEntry) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LightsailDomainEntry) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LightsailDomainEntry) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_LightsailDomainEntry) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewLightsailDomainEntry(scope constructs.Construct, id *string, config *LightsailDomainEntryConfig) LightsailDomainEntry {
	...
	if err := validateNewLightsailDomainEntryParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_LightsailDomainEntry{}
...
func LightsailDomainEntry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLightsailDomainEntry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LightsailDomainEntry_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.lightsailDomainEntry.LightsailDomainEntry",
...
func (l *jsiiProxy_LightsailDomainEntry) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LightsailDomainEntry) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailDomainEntry) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LightsailDomainEntry) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LightsailDomainEntry) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LightsailDomainEntry) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LightsailDomainEntry) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LightsailDomainEntry) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LightsailDomainEntry) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LightsailDomainEntry) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LightsailDomainEntry) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LightsailDomainEntry) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDomainEntry) ResetIsAlias() {
	_jsii_.InvokeVoid(
		l,
		"resetIsAlias",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDomainEntry) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LightsailDomainEntry) ToString() *string {
	var returns *string
