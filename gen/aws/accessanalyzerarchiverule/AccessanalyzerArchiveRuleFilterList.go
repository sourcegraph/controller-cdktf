...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/accessanalyzerarchiverule/internal"
)
...
func NewAccessanalyzerArchiveRuleFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AccessanalyzerArchiveRuleFilterList {
	...
	if err := validateNewAccessanalyzerArchiveRuleFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessanalyzerArchiveRuleFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
