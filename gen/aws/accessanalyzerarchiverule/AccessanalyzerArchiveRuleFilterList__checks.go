...
func (a *jsiiProxy_AccessanalyzerArchiveRuleFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_AccessanalyzerArchiveRuleFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*AccessanalyzerArchiveRuleFilter:
		val_ := val.([]*AccessanalyzerArchiveRuleFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
