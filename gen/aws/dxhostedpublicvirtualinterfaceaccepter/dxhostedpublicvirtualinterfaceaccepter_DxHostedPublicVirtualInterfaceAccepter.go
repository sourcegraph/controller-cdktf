...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxhostedpublicvirtualinterfaceaccepter/internal"
)
...
func NewDxHostedPublicVirtualInterfaceAccepter(scope constructs.Construct, id *string, config *DxHostedPublicVirtualInterfaceAccepterConfig) DxHostedPublicVirtualInterfaceAccepter {
	...
	if err := validateNewDxHostedPublicVirtualInterfaceAccepterParameters(scope, id, config); err != nil {
		panic(err)
	}
