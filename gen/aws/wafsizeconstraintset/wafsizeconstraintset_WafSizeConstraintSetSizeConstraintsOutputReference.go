...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference)SetInternalValue(val interface{}) {
...
func (w *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (w *jsiiProxy_WafSizeConstraintSetSizeConstraintsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
