...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewWafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference {
	_init_.Initialize()

	if err := validateNewWafSizeConstraintSetSizeConstraintsFieldToMatchOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference_Override(w WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (w *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WafSizeConstraintSetSizeConstraintsFieldToMatchOutputReference) ToString() *string {
	var returns *string
