...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusOutputReference) CapacityUsageSummary() DataAwsNetworkfirewallFirewallFirewallStatusCapacityUsageSummaryList {
	var returns DataAwsNetworkfirewallFirewallFirewallStatusCapacityUsageSummaryList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusOutputReference) ConfigurationSyncStateSummary() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsNetworkfirewallFirewallFirewallStatusOutputReference) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func NewDataAwsNetworkfirewallFirewallFirewallStatusOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsNetworkfirewallFirewallFirewallStatusOutputReference {
	...
	if err := validateNewDataAwsNetworkfirewallFirewallFirewallStatusOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
