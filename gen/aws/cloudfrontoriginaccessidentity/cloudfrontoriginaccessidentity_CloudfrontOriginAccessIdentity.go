...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudfrontoriginaccessidentity/internal"
)
...
func (j *jsiiProxy_CloudfrontOriginAccessIdentity) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudfrontOriginAccessIdentity(scope constructs.Construct, id *string, config *CloudfrontOriginAccessIdentityConfig) CloudfrontOriginAccessIdentity {
	...
	if err := validateNewCloudfrontOriginAccessIdentityParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudfrontOriginAccessIdentity) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
