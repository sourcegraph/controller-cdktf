...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawseksaddon/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/eks_addon aws_eks_addon}.
...
func (j *jsiiProxy_DataAwsEksAddon) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEksAddon) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsEksAddon(scope constructs.Construct, id *string, config *DataAwsEksAddonConfig) DataAwsEksAddon {
	...
	if err := validateNewDataAwsEksAddonParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsEksAddon_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsEksAddon_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEksAddon) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
