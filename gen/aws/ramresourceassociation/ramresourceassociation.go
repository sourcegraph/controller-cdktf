package ramresourceassociation
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ramresourceassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ram_resource_association aws_ram_resource_association}.
...
func (j *jsiiProxy_RamResourceAssociation) Connection() interface{} {
...
func (j *jsiiProxy_RamResourceAssociation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RamResourceAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RamResourceAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_RamResourceAssociation) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ram_resource_association aws_ram_resource_association} Resource.
func NewRamResourceAssociation(scope constructs.Construct, id *string, config *RamResourceAssociationConfig) RamResourceAssociation {
	...
	if err := validateNewRamResourceAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RamResourceAssociation)SetConnection(val interface{}) {
...
func (j *jsiiProxy_RamResourceAssociation)SetCount(val interface{}) {
...
func (j *jsiiProxy_RamResourceAssociation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RamResourceAssociation)SetId(val *string) {
...
func (j *jsiiProxy_RamResourceAssociation)SetProvisioners(val *[]interface{}) {
...
func RamResourceAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRamResourceAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RamResourceAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateRamResourceAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RamResourceAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRamResourceAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RamResourceAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRamResourceAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RamResourceAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RamResourceAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RamResourceAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RamResourceAssociation) MoveFromId(id *string) {
...
func (r *jsiiProxy_RamResourceAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RamResourceAssociation) MoveToId(id *string) {
...
func (r *jsiiProxy_RamResourceAssociation) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_RamResourceAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RamResourceAssociation) ToHclTerraform() interface{} {
	var returns interface{}
