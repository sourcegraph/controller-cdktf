...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/organizationsaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/organizations_account aws_organizations_account}.
...
func NewOrganizationsAccount(scope constructs.Construct, id *string, config *OrganizationsAccountConfig) OrganizationsAccount {
	...
	if err := validateNewOrganizationsAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationsAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrganizationsAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsAccount) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrganizationsAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrganizationsAccount) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrganizationsAccount) MoveToId(id *string) {
