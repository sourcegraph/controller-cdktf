...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/codecommitapprovalruletemplate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codecommit_approval_rule_template aws_codecommit_approval_rule_template}.
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CodecommitApprovalRuleTemplate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCodecommitApprovalRuleTemplate(scope constructs.Construct, id *string, config *CodecommitApprovalRuleTemplateConfig) CodecommitApprovalRuleTemplate {
	...
	if err := validateNewCodecommitApprovalRuleTemplateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodecommitApprovalRuleTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodecommitApprovalRuleTemplate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) MoveToId(id *string) {
...
func (c *jsiiProxy_CodecommitApprovalRuleTemplate) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
