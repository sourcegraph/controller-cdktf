...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList) InternalValue() interface{} {
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_IotTopicRuleHttpHttpHeaderList)SetWrapsSet(val *bool) {
...
func (i *jsiiProxy_IotTopicRuleHttpHttpHeaderList) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleHttpHttpHeaderList) Get(index *float64) IotTopicRuleHttpHttpHeaderOutputReference {
	if err := i.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns IotTopicRuleHttpHttpHeaderOutputReference
...
func (i *jsiiProxy_IotTopicRuleHttpHttpHeaderList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleHttpHttpHeaderList) ToString() *string {
	var returns *string
