...
type IotTopicRuleErrorActionStepFunctionsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionStepFunctions
	SetInternalValue(val *IotTopicRuleErrorActionStepFunctions)
	RoleArn() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) InternalValue() *IotTopicRuleErrorActionStepFunctions {
...
func NewIotTopicRuleErrorActionStepFunctionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionStepFunctionsOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionStepFunctionsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionStepFunctionsOutputReference_Override(i IotTopicRuleErrorActionStepFunctionsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference)SetExecutionNamePrefix(val *string) {
	if err := j.validateSetExecutionNamePrefixParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference)SetInternalValue(val *IotTopicRuleErrorActionStepFunctions) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionStepFunctionsOutputReference) ToString() *string {
	var returns *string
