...
type IotTopicRuleErrorActionElasticsearchOutputReference interface {
	...
	SetIndex(val *string)
	IndexInput() *string
	InternalValue() *IotTopicRuleErrorActionElasticsearch
	SetInternalValue(val *IotTopicRuleErrorActionElasticsearch)
	RoleArn() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) InternalValue() *IotTopicRuleErrorActionElasticsearch {
...
func (i *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionElasticsearchOutputReference) ToString() *string {
	var returns *string
