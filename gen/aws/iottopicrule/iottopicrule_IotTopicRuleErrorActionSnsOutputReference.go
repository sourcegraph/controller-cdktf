...
type IotTopicRuleErrorActionSnsOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionSns
	SetInternalValue(val *IotTopicRuleErrorActionSns)
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) InternalValue() *IotTopicRuleErrorActionSns {
...
func NewIotTopicRuleErrorActionSnsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionSnsOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionSnsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionSnsOutputReference_Override(i IotTopicRuleErrorActionSnsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference)SetInternalValue(val *IotTopicRuleErrorActionSns) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionSnsOutputReference) ToString() *string {
	var returns *string
