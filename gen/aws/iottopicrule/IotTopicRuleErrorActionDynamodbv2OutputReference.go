...
type IotTopicRuleErrorActionDynamodbv2OutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionDynamodbv2
	SetInternalValue(val *IotTopicRuleErrorActionDynamodbv2)
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) InternalValue() *IotTopicRuleErrorActionDynamodbv2 {
...
func NewIotTopicRuleErrorActionDynamodbv2OutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionDynamodbv2OutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionDynamodbv2OutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionDynamodbv2OutputReference_Override(i IotTopicRuleErrorActionDynamodbv2OutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference)SetInternalValue(val *IotTopicRuleErrorActionDynamodbv2) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionDynamodbv2OutputReference) ToString() *string {
	var returns *string
