...
type IotTopicRuleErrorActionKinesisOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionKinesis
	SetInternalValue(val *IotTopicRuleErrorActionKinesis)
	PartitionKey() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) InternalValue() *IotTopicRuleErrorActionKinesis {
...
func NewIotTopicRuleErrorActionKinesisOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionKinesisOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionKinesisOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionKinesisOutputReference_Override(i IotTopicRuleErrorActionKinesisOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference)SetInternalValue(val *IotTopicRuleErrorActionKinesis) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionKinesisOutputReference) ToString() *string {
	var returns *string
