...
type IotTopicRuleErrorActionRepublishOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionRepublish
	SetInternalValue(val *IotTopicRuleErrorActionRepublish)
	Qos() *float64
	SetQos(val *float64)
	QosInput() *float64
	RoleArn() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) InternalValue() *IotTopicRuleErrorActionRepublish {
...
func NewIotTopicRuleErrorActionRepublishOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTopicRuleErrorActionRepublishOutputReference {
	_init_.Initialize()

	if err := validateNewIotTopicRuleErrorActionRepublishOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotTopicRuleErrorActionRepublishOutputReference_Override(i IotTopicRuleErrorActionRepublishOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference)SetInternalValue(val *IotTopicRuleErrorActionRepublish) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotTopicRuleErrorActionRepublishOutputReference) ToString() *string {
	var returns *string
