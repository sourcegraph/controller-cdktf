...
type IotTopicRuleErrorActionCloudwatchAlarmOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotTopicRuleErrorActionCloudwatchAlarm
	SetInternalValue(val *IotTopicRuleErrorActionCloudwatchAlarm)
	RoleArn() *string
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) InternalValue() *IotTopicRuleErrorActionCloudwatchAlarm {
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference)SetInternalValue(val *IotTopicRuleErrorActionCloudwatchAlarm) {
...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotTopicRuleErrorActionCloudwatchAlarmOutputReference) ToString() *string {
	var returns *string
