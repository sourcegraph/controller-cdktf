...
func (d *jsiiProxy_DataAwsS3ControlMultiRegionAccessPointPublicAccessBlockList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
