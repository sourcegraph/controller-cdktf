...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/servicediscoveryhttpnamespace/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/service_discovery_http_namespace aws_service_discovery_http_namespace}.
...
func NewServiceDiscoveryHttpNamespace(scope constructs.Construct, id *string, config *ServiceDiscoveryHttpNamespaceConfig) ServiceDiscoveryHttpNamespace {
	...
	if err := validateNewServiceDiscoveryHttpNamespaceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServiceDiscoveryHttpNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceDiscoveryHttpNamespace_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceDiscoveryHttpNamespace) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceDiscoveryHttpNamespace) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServiceDiscoveryHttpNamespace) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServiceDiscoveryHttpNamespace) MoveToId(id *string) {
