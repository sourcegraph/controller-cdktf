...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/licensemanagerlicenseconfiguration/internal"
)
...
func (j *jsiiProxy_LicensemanagerLicenseConfiguration) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewLicensemanagerLicenseConfiguration(scope constructs.Construct, id *string, config *LicensemanagerLicenseConfigurationConfig) LicensemanagerLicenseConfiguration {
	...
	if err := validateNewLicensemanagerLicenseConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LicensemanagerLicenseConfiguration) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
