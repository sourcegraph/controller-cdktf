...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/codecommitrepository/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/codecommit_repository aws_codecommit_repository}.
...
func (j *jsiiProxy_CodecommitRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CodecommitRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CodecommitRepository) Tags() *map[string]*string {
...
func (j *jsiiProxy_CodecommitRepository) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_CodecommitRepository) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_CodecommitRepository) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewCodecommitRepository(scope constructs.Construct, id *string, config *CodecommitRepositoryConfig) CodecommitRepository {
	...
	if err := validateNewCodecommitRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CodecommitRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCodecommitRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CodecommitRepository) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CodecommitRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CodecommitRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CodecommitRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CodecommitRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CodecommitRepository) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CodecommitRepository) MoveFromId(id *string) {
...
func (c *jsiiProxy_CodecommitRepository) MoveToId(id *string) {
...
func (c *jsiiProxy_CodecommitRepository) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
