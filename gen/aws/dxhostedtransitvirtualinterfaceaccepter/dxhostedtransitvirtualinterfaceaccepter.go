...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dxhostedtransitvirtualinterfaceaccepter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_hosted_transit_virtual_interface_accepter aws_dx_hosted_transit_virtual_interface_accepter}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dx_hosted_transit_virtual_interface_accepter aws_dx_hosted_transit_virtual_interface_accepter} Resource.
func NewDxHostedTransitVirtualInterfaceAccepter(scope constructs.Construct, id *string, config *DxHostedTransitVirtualInterfaceAccepterConfig) DxHostedTransitVirtualInterfaceAccepter {
	...
	if err := validateNewDxHostedTransitVirtualInterfaceAccepterParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DxHostedTransitVirtualInterfaceAccepter{}

	_jsii_.Create(
		"@cdktf/provider-aws.dxHostedTransitVirtualInterfaceAccepter.DxHostedTransitVirtualInterfaceAccepter",
...
func DxHostedTransitVirtualInterfaceAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDxHostedTransitVirtualInterfaceAccepter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DxHostedTransitVirtualInterfaceAccepter_IsConstruct(x interface{}) *bool {
	...
	if err := validateDxHostedTransitVirtualInterfaceAccepter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxHostedTransitVirtualInterfaceAccepter_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxHostedTransitVirtualInterfaceAccepter_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DxHostedTransitVirtualInterfaceAccepter_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDxHostedTransitVirtualInterfaceAccepter_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) MoveFromId(id *string) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) MoveToId(id *string) {
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DxHostedTransitVirtualInterfaceAccepter) ToHclTerraform() interface{} {
	var returns interface{}
