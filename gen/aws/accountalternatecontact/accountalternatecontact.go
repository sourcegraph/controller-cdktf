...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/account_alternate_contact aws_account_alternate_contact}.
type AccountAlternateContact interface {
	...
	PutTimeouts(value *AccountAlternateContactTimeouts)
	ResetAccountId()
	ResetId()
...
func (j *jsiiProxy_AccountAlternateContact) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccountAlternateContact) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AccountAlternateContact) Timeouts() AccountAlternateContactTimeoutsOutputReference {
	var returns AccountAlternateContactTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewAccountAlternateContact(scope constructs.Construct, id *string, config *AccountAlternateContactConfig) AccountAlternateContact {
	...
	if err := validateNewAccountAlternateContactParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AccountAlternateContact_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccountAlternateContact_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccountAlternateContact) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccountAlternateContact) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccountAlternateContact) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccountAlternateContact) MoveToId(id *string) {
...
func (a *jsiiProxy_AccountAlternateContact) PutTimeouts(value *AccountAlternateContactTimeouts) {
...
func (a *jsiiProxy_AccountAlternateContact) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AccountAlternateContact) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
