...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafregionalratebasedrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/wafregional_rate_based_rule aws_wafregional_rate_based_rule}.
...
func NewDataAwsWafregionalRateBasedRule(scope constructs.Construct, id *string, config *DataAwsWafregionalRateBasedRuleConfig) DataAwsWafregionalRateBasedRule {
	...
	if err := validateNewDataAwsWafregionalRateBasedRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsWafregionalRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafregionalRateBasedRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
