...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/maciememberaccountassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie_member_account_association aws_macie_member_account_association}.
...
func (j *jsiiProxy_MacieMemberAccountAssociation) Connection() interface{} {
...
func (j *jsiiProxy_MacieMemberAccountAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MacieMemberAccountAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MacieMemberAccountAssociation) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/macie_member_account_association aws_macie_member_account_association} Resource.
func NewMacieMemberAccountAssociation(scope constructs.Construct, id *string, config *MacieMemberAccountAssociationConfig) MacieMemberAccountAssociation {
	...
	if err := validateNewMacieMemberAccountAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MacieMemberAccountAssociation)SetConnection(val interface{}) {
...
func (j *jsiiProxy_MacieMemberAccountAssociation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MacieMemberAccountAssociation)SetId(val *string) {
...
func (j *jsiiProxy_MacieMemberAccountAssociation)SetProvisioners(val *[]interface{}) {
...
func MacieMemberAccountAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMacieMemberAccountAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MacieMemberAccountAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateMacieMemberAccountAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MacieMemberAccountAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMacieMemberAccountAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MacieMemberAccountAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMacieMemberAccountAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MacieMemberAccountAssociation) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MacieMemberAccountAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MacieMemberAccountAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MacieMemberAccountAssociation) MoveFromId(id *string) {
...
func (m *jsiiProxy_MacieMemberAccountAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MacieMemberAccountAssociation) MoveToId(id *string) {
...
func (m *jsiiProxy_MacieMemberAccountAssociation) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MacieMemberAccountAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MacieMemberAccountAssociation) ToHclTerraform() interface{} {
	var returns interface{}
