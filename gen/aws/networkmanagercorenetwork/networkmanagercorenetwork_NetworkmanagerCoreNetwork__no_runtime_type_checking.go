...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) validateSetIdParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_NetworkmanagerCoreNetwork) validateSetTagsParameters(val *map[string]*string) error {
	return nil
}

func (j *jsiiProxy_NetworkmanagerCoreNetwork) validateSetTagsAllParameters(val *map[string]*string) error {
	return nil
}
