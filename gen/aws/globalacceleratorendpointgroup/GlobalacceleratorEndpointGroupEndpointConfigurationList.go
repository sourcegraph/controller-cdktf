...
func NewGlobalacceleratorEndpointGroupEndpointConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GlobalacceleratorEndpointGroupEndpointConfigurationList {
	...
	if err := validateNewGlobalacceleratorEndpointGroupEndpointConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroupEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
