...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawskmspublickey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/kms_public_key aws_kms_public_key}.
...
func (j *jsiiProxy_DataAwsKmsPublicKey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsKmsPublicKey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsKmsPublicKey) PublicKeyPem() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyPem",
...
func NewDataAwsKmsPublicKey(scope constructs.Construct, id *string, config *DataAwsKmsPublicKeyConfig) DataAwsKmsPublicKey {
	...
	if err := validateNewDataAwsKmsPublicKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsKmsPublicKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsKmsPublicKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsKmsPublicKey) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
