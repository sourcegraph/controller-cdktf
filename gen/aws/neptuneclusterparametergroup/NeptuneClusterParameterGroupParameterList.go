...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/neptuneclusterparametergroup/internal"
)
...
func NewNeptuneClusterParameterGroupParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NeptuneClusterParameterGroupParameterList {
	...
	if err := validateNewNeptuneClusterParameterGroupParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NeptuneClusterParameterGroupParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
