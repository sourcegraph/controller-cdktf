...
type DataAwsEfsFileSystem interface {
	...
	LifecyclePolicy() DataAwsEfsFileSystemLifecyclePolicyList
	// The tree node.
...
func (j *jsiiProxy_DataAwsEfsFileSystem) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsEfsFileSystem) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataAwsEfsFileSystem) LifecyclePolicy() DataAwsEfsFileSystemLifecyclePolicyList {
	var returns DataAwsEfsFileSystemLifecyclePolicyList
	_jsii_.Get(
		j,
		"lifecyclePolicy",
		&returns,
...
func NewDataAwsEfsFileSystem(scope constructs.Construct, id *string, config *DataAwsEfsFileSystemConfig) DataAwsEfsFileSystem {
	...
	if err := validateNewDataAwsEfsFileSystemParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsEfsFileSystem) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
