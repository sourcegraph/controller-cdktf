...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "monitorSpecificationInput", GoGetter: "MonitorSpecificationInput"},
			_jsii_.MemberProperty{JsiiProperty: "monitorType", GoGetter: "MonitorType"},
			_jsii_.MemberProperty{JsiiProperty: "monitorTypeInput", GoGetter: "MonitorTypeInput"},
