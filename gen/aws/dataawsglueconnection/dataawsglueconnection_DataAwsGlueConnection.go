...
type DataAwsGlueConnection interface {
	...
	PhysicalConnectionRequirements() DataAwsGlueConnectionPhysicalConnectionRequirementsList
	// Experimental.
...
func (j *jsiiProxy_DataAwsGlueConnection) ConnectionProperties() cdktf.StringMap {
...
func (j *jsiiProxy_DataAwsGlueConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsGlueConnection) PhysicalConnectionRequirements() DataAwsGlueConnectionPhysicalConnectionRequirementsList {
	var returns DataAwsGlueConnectionPhysicalConnectionRequirementsList
	_jsii_.Get(
		j,
...
func NewDataAwsGlueConnection(scope constructs.Construct, id *string, config *DataAwsGlueConnectionConfig) DataAwsGlueConnection {
	...
	if err := validateNewDataAwsGlueConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
