...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/chimevoiceconnectorterminationcredentials/internal"
)
...
func NewChimeVoiceConnectorTerminationCredentialsCredentialsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ChimeVoiceConnectorTerminationCredentialsCredentialsOutputReference {
	...
	if err := validateNewChimeVoiceConnectorTerminationCredentialsCredentialsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
