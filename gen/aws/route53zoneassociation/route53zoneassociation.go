...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/route53zoneassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/route53_zone_association aws_route53_zone_association}.
...
func (j *jsiiProxy_Route53ZoneAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Route53ZoneAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRoute53ZoneAssociation(scope constructs.Construct, id *string, config *Route53ZoneAssociationConfig) Route53ZoneAssociation {
	...
	if err := validateNewRoute53ZoneAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Route53ZoneAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRoute53ZoneAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Route53ZoneAssociation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Route53ZoneAssociation) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
