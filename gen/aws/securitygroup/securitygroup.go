...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/securitygroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/security_group aws_security_group}.
...
func (j *jsiiProxy_SecurityGroup) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_SecurityGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SecurityGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SecurityGroup) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_SecurityGroup) Egress() SecurityGroupEgressList {
	var returns SecurityGroupEgressList
	_jsii_.Get(
		j,
		"egress",
		&returns,
...
func (j *jsiiProxy_SecurityGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecurityGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SecurityGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecurityGroup) Ingress() SecurityGroupIngressList {
	var returns SecurityGroupIngressList
	_jsii_.Get(
		j,
		"ingress",
		&returns,
...
func (j *jsiiProxy_SecurityGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SecurityGroup) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SecurityGroup) NamePrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefix",
...
func (j *jsiiProxy_SecurityGroup) NamePrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namePrefixInput",
...
func (j *jsiiProxy_SecurityGroup) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_SecurityGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SecurityGroup) Tags() *map[string]*string {
...
func (j *jsiiProxy_SecurityGroup) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_SecurityGroup) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_SecurityGroup) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SecurityGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecurityGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecurityGroup) Timeouts() SecurityGroupTimeoutsOutputReference {
	var returns SecurityGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_SecurityGroup) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
func (j *jsiiProxy_SecurityGroup) VpcIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcIdInput",
...
func NewSecurityGroup(scope constructs.Construct, id *string, config *SecurityGroupConfig) SecurityGroup {
	...
	if err := validateNewSecurityGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityGroup) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SecurityGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SecurityGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SecurityGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SecurityGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SecurityGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SecurityGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SecurityGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityGroup) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SecurityGroup) PutTimeouts(value *SecurityGroupTimeouts) {
...
func (s *jsiiProxy_SecurityGroup) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetEgress() {
	_jsii_.InvokeVoid(
		s,
		"resetEgress",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetIngress() {
	_jsii_.InvokeVoid(
		s,
		"resetIngress",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetNamePrefix() {
	_jsii_.InvokeVoid(
		s,
		"resetNamePrefix",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetRevokeRulesOnDelete() {
	_jsii_.InvokeVoid(
		s,
		"resetRevokeRulesOnDelete",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetTags() {
	_jsii_.InvokeVoid(
		s,
		"resetTags",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetTagsAll() {
	_jsii_.InvokeVoid(
		s,
		"resetTagsAll",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SecurityGroup) ResetVpcId() {
	_jsii_.InvokeVoid(
		s,
		"resetVpcId",
		nil, // no parameters
