...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCloudfrontDistributionOriginGroupFailoverCriteriaOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference {
	...
	if err := validateNewCloudfrontDistributionOriginGroupFailoverCriteriaOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference)SetStatusCodes(val *[]*float64) {
	if err := j.validateSetStatusCodesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupFailoverCriteriaOutputReference) ToString() *string {
	var returns *string
