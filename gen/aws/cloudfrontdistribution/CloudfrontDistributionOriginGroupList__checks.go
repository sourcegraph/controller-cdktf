...
func (c *jsiiProxy_CloudfrontDistributionOriginGroupList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_CloudfrontDistributionOriginGroupList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*CloudfrontDistributionOriginGroup:
		val_ := val.([]*CloudfrontDistributionOriginGroup)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
