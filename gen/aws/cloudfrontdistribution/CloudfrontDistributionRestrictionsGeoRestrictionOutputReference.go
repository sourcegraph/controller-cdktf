...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewCloudfrontDistributionRestrictionsGeoRestrictionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CloudfrontDistributionRestrictionsGeoRestrictionOutputReference {
	...
	if err := validateNewCloudfrontDistributionRestrictionsGeoRestrictionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CloudfrontDistributionRestrictionsGeoRestrictionOutputReference) ToString() *string {
	var returns *string
