...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "experienceId", GoGetter: "ExperienceId"},
	...
	_jsii_.RegisterStruct(
		"aws.kendraExperience.KendraExperienceConfig",
		reflect.TypeOf((*KendraExperienceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws.kendraExperience.KendraExperienceConfiguration",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataSourceIds", GoGetter: "DataSourceIds"},
			_jsii_.MemberProperty{JsiiProperty: "dataSourceIdsInput", GoGetter: "DataSourceIdsInput"},
			_jsii_.MemberProperty{JsiiProperty: "directPutContent", GoGetter: "DirectPutContent"},
			_jsii_.MemberProperty{JsiiProperty: "directPutContentInput", GoGetter: "DirectPutContentInput"},
			_jsii_.MemberProperty{JsiiProperty: "faqIds", GoGetter: "FaqIds"},
			_jsii_.MemberProperty{JsiiProperty: "faqIdsInput", GoGetter: "FaqIdsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataSourceIds", GoMethod: "ResetDataSourceIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetDirectPutContent", GoMethod: "ResetDirectPutContent"},
			_jsii_.MemberMethod{JsiiMethod: "resetFaqIds", GoMethod: "ResetFaqIds"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "contentSourceConfiguration", GoGetter: "ContentSourceConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "contentSourceConfigurationInput", GoGetter: "ContentSourceConfigurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putContentSourceConfiguration", GoMethod: "PutContentSourceConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "putUserIdentityConfiguration", GoMethod: "PutUserIdentityConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetContentSourceConfiguration", GoMethod: "ResetContentSourceConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetUserIdentityConfiguration", GoMethod: "ResetUserIdentityConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"aws.kendraExperience.KendraExperienceConfigurationUserIdentityConfiguration",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "identityAttributeName", GoGetter: "IdentityAttributeName"},
			_jsii_.MemberProperty{JsiiProperty: "identityAttributeNameInput", GoGetter: "IdentityAttributeNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterStruct(
		"aws.kendraExperience.KendraExperienceEndpoints",
	...
	_jsii_.RegisterStruct(
		"aws.kendraExperience.KendraExperienceTimeouts",
