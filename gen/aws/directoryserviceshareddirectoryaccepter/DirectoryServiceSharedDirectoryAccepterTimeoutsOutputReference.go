...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/directoryserviceshareddirectoryaccepter/internal"
)
...
func NewDirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference {
	...
	if err := validateNewDirectoryServiceSharedDirectoryAccepterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference{}

	_jsii_.Create(
		"aws.directoryServiceSharedDirectoryAccepter.DirectoryServiceSharedDirectoryAccepterTimeoutsOutputReference",
