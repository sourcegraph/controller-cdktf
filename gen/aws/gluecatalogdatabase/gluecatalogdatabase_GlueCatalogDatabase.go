...
func (j *jsiiProxy_GlueCatalogDatabase) CreateTableDefaultPermission() GlueCatalogDatabaseCreateTableDefaultPermissionList {
	var returns GlueCatalogDatabaseCreateTableDefaultPermissionList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueCatalogDatabase) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GlueCatalogDatabase) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewGlueCatalogDatabase(scope constructs.Construct, id *string, config *GlueCatalogDatabaseConfig) GlueCatalogDatabase {
	...
	if err := validateNewGlueCatalogDatabaseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueCatalogDatabase) ResetCreateTableDefaultPermission() {
	_jsii_.InvokeVoid(
		g,
		"resetCreateTableDefaultPermission",
		nil, // no parameters
...
func (g *jsiiProxy_GlueCatalogDatabase) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
