...
type ServicecatalogTagOption interface {
	...
	PutTimeouts(value *ServicecatalogTagOptionTimeouts)
	ResetActive()
	ResetId()
...
func (j *jsiiProxy_ServicecatalogTagOption) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicecatalogTagOption) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ServicecatalogTagOption) Timeouts() ServicecatalogTagOptionTimeoutsOutputReference {
	var returns ServicecatalogTagOptionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewServicecatalogTagOption(scope constructs.Construct, id *string, config *ServicecatalogTagOptionConfig) ServicecatalogTagOption {
	...
	if err := validateNewServicecatalogTagOptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ServicecatalogTagOption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicecatalogTagOption_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicecatalogTagOption) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicecatalogTagOption) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServicecatalogTagOption) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicecatalogTagOption) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicecatalogTagOption) PutTimeouts(value *ServicecatalogTagOptionTimeouts) {
...
func (s *jsiiProxy_ServicecatalogTagOption) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_ServicecatalogTagOption) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
