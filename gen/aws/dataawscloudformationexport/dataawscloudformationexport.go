package dataawscloudformationexport
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudformationexport/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudformation_export aws_cloudformation_export}.
...
func NewDataAwsCloudformationExport(scope constructs.Construct, id *string, config *DataAwsCloudformationExportConfig) DataAwsCloudformationExport {
	...
	if err := validateNewDataAwsCloudformationExportParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCloudformationExport_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudformationExport_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
