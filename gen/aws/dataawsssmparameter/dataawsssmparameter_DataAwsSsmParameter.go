...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsssmparameter/internal"
)
...
func NewDataAwsSsmParameter(scope constructs.Construct, id *string, config *DataAwsSsmParameterConfig) DataAwsSsmParameter {
	...
	if err := validateNewDataAwsSsmParameterParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAwsSsmParameter{}

	_jsii_.Create(
		"aws.dataAwsSsmParameter.DataAwsSsmParameter",
