...
type AthenaWorkgroupConfigurationResultConfigurationOutputReference interface {
	...
	PutAclConfiguration(value *AthenaWorkgroupConfigurationResultConfigurationAclConfiguration)
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) AclConfiguration() AthenaWorkgroupConfigurationResultConfigurationAclConfigurationOutputReference {
	var returns AthenaWorkgroupConfigurationResultConfigurationAclConfigurationOutputReference
	_jsii_.Get(
		j,
		"aclConfiguration",
		&returns,
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) AclConfigurationInput() *AthenaWorkgroupConfigurationResultConfigurationAclConfiguration {
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ExpectedBucketOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewAthenaWorkgroupConfigurationResultConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AthenaWorkgroupConfigurationResultConfigurationOutputReference {
	...
	if err := validateNewAthenaWorkgroupConfigurationResultConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) PutAclConfiguration(value *AthenaWorkgroupConfigurationResultConfigurationAclConfiguration) {
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ResetAclConfiguration() {
	_jsii_.InvokeVoid(
		a,
		"resetAclConfiguration",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ResetExpectedBucketOwner() {
	_jsii_.InvokeVoid(
		a,
		"resetExpectedBucketOwner",
		nil, // no parameters
...
func (a *jsiiProxy_AthenaWorkgroupConfigurationResultConfigurationOutputReference) ToString() *string {
	var returns *string
