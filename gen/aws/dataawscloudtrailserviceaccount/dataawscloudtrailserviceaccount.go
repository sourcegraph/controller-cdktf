package dataawscloudtrailserviceaccount
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudtrailserviceaccount/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudtrail_service_account aws_cloudtrail_service_account}.
...
func NewDataAwsCloudtrailServiceAccount(scope constructs.Construct, id *string, config *DataAwsCloudtrailServiceAccountConfig) DataAwsCloudtrailServiceAccount {
	...
	if err := validateNewDataAwsCloudtrailServiceAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCloudtrailServiceAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudtrailServiceAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
