...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudsearch_domain_service_access_policy aws_cloudsearch_domain_service_access_policy}.
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) Connection() interface{} {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudsearch_domain_service_access_policy aws_cloudsearch_domain_service_access_policy} Resource.
func NewCloudsearchDomainServiceAccessPolicy(scope constructs.Construct, id *string, config *CloudsearchDomainServiceAccessPolicyConfig) CloudsearchDomainServiceAccessPolicy {
	...
	if err := validateNewCloudsearchDomainServiceAccessPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetId(val *string) {
...
func (j *jsiiProxy_CloudsearchDomainServiceAccessPolicy)SetProvisioners(val *[]interface{}) {
...
func CloudsearchDomainServiceAccessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudsearchDomainServiceAccessPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CloudsearchDomainServiceAccessPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCloudsearchDomainServiceAccessPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudsearchDomainServiceAccessPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudsearchDomainServiceAccessPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudsearchDomainServiceAccessPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudsearchDomainServiceAccessPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudsearchDomainServiceAccessPolicy) ToHclTerraform() interface{} {
	var returns interface{}
