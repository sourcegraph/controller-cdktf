...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/efsbackuppolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/efs_backup_policy aws_efs_backup_policy}.
...
func (j *jsiiProxy_EfsBackupPolicy) Connection() interface{} {
...
func (j *jsiiProxy_EfsBackupPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EfsBackupPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EfsBackupPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/efs_backup_policy aws_efs_backup_policy} Resource.
func NewEfsBackupPolicy(scope constructs.Construct, id *string, config *EfsBackupPolicyConfig) EfsBackupPolicy {
	_init_.Initialize()

	if err := validateNewEfsBackupPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EfsBackupPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_EfsBackupPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EfsBackupPolicy)SetId(val *string) {
...
func (j *jsiiProxy_EfsBackupPolicy)SetProvisioners(val *[]interface{}) {
...
func EfsBackupPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEfsBackupPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EfsBackupPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateEfsBackupPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EfsBackupPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEfsBackupPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EfsBackupPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEfsBackupPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EfsBackupPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EfsBackupPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EfsBackupPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EfsBackupPolicy) MoveFromId(id *string) {
...
func (e *jsiiProxy_EfsBackupPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EfsBackupPolicy) MoveToId(id *string) {
...
func (e *jsiiProxy_EfsBackupPolicy) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EfsBackupPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EfsBackupPolicy) ToHclTerraform() interface{} {
	var returns interface{}
