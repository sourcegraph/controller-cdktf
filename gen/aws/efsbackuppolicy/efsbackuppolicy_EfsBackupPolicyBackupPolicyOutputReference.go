...
func (j *jsiiProxy_EfsBackupPolicyBackupPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EfsBackupPolicyBackupPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EfsBackupPolicyBackupPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewEfsBackupPolicyBackupPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EfsBackupPolicyBackupPolicyOutputReference {
	...
	if err := validateNewEfsBackupPolicyBackupPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEfsBackupPolicyBackupPolicyOutputReference_Override(e EfsBackupPolicyBackupPolicyOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (e *jsiiProxy_EfsBackupPolicyBackupPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EfsBackupPolicyBackupPolicyOutputReference) ToString() *string {
	var returns *string
