...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/directoryservicedirectory/internal"
)
...
func NewDirectoryServiceDirectoryVpcSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DirectoryServiceDirectoryVpcSettingsOutputReference {
	...
	if err := validateNewDirectoryServiceDirectoryVpcSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
