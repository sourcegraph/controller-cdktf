...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/emrmanagedscalingpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/emr_managed_scaling_policy aws_emr_managed_scaling_policy}.
...
func (j *jsiiProxy_EmrManagedScalingPolicy) ComputeLimits() EmrManagedScalingPolicyComputeLimitsList {
	var returns EmrManagedScalingPolicyComputeLimitsList
	_jsii_.Get(
		j,
		"computeLimits",
		&returns,
...
func (j *jsiiProxy_EmrManagedScalingPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EmrManagedScalingPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEmrManagedScalingPolicy(scope constructs.Construct, id *string, config *EmrManagedScalingPolicyConfig) EmrManagedScalingPolicy {
	...
	if err := validateNewEmrManagedScalingPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EmrManagedScalingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEmrManagedScalingPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrManagedScalingPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EmrManagedScalingPolicy) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
