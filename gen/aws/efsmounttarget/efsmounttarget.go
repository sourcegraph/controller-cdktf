...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/efs_mount_target aws_efs_mount_target}.
...
func (j *jsiiProxy_EfsMountTarget) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EfsMountTarget) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEfsMountTarget(scope constructs.Construct, id *string, config *EfsMountTargetConfig) EfsMountTarget {
	...
	if err := validateNewEfsMountTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EfsMountTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEfsMountTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EfsMountTarget) AddMoveTarget(moveTarget *string) {
