...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/storagegatewayfilesystemassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/storagegateway_file_system_association aws_storagegateway_file_system_association}.
...
func NewStoragegatewayFileSystemAssociation(scope constructs.Construct, id *string, config *StoragegatewayFileSystemAssociationConfig) StoragegatewayFileSystemAssociation {
	...
	if err := validateNewStoragegatewayFileSystemAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StoragegatewayFileSystemAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStoragegatewayFileSystemAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) MoveFromId(id *string) {
...
func (s *jsiiProxy_StoragegatewayFileSystemAssociation) MoveToId(id *string) {
