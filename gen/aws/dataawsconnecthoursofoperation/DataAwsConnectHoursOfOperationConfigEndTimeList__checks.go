...
func (d *jsiiProxy_DataAwsConnectHoursOfOperationConfigEndTimeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperationConfigEndTimeList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperationConfigEndTimeList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperationConfigEndTimeList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
