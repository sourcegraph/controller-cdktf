...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/connect_hours_of_operation aws_connect_hours_of_operation}.
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) Config() DataAwsConnectHoursOfOperationConfigAList {
	var returns DataAwsConnectHoursOfOperationConfigAList
	_jsii_.Get(
		j,
		"config",
		&returns,
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsConnectHoursOfOperation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsConnectHoursOfOperation(scope constructs.Construct, id *string, config *DataAwsConnectHoursOfOperationConfig) DataAwsConnectHoursOfOperation {
	...
	if err := validateNewDataAwsConnectHoursOfOperationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsConnectHoursOfOperation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsConnectHoursOfOperation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsConnectHoursOfOperation) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
