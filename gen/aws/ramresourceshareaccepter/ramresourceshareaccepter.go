...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ramresourceshareaccepter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ram_resource_share_accepter aws_ram_resource_share_accepter}.
...
func (j *jsiiProxy_RamResourceShareAccepter) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RamResourceShareAccepter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewRamResourceShareAccepter(scope constructs.Construct, id *string, config *RamResourceShareAccepterConfig) RamResourceShareAccepter {
	...
	if err := validateNewRamResourceShareAccepterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RamResourceShareAccepter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRamResourceShareAccepter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RamResourceShareAccepter) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RamResourceShareAccepter) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
