...
func (j *jsiiProxy_RamResourceShareAccepterTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RamResourceShareAccepterTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RamResourceShareAccepterTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewRamResourceShareAccepterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RamResourceShareAccepterTimeoutsOutputReference {
	...
	if err := validateNewRamResourceShareAccepterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRamResourceShareAccepterTimeoutsOutputReference_Override(r RamResourceShareAccepterTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (r *jsiiProxy_RamResourceShareAccepterTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RamResourceShareAccepterTimeoutsOutputReference) ToString() *string {
	var returns *string
