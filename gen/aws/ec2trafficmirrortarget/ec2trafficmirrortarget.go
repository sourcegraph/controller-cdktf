...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ec2trafficmirrortarget/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ec2_traffic_mirror_target aws_ec2_traffic_mirror_target}.
...
type jsiiProxy_Ec2TrafficMirrorTarget struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Ec2TrafficMirrorTarget) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) NetworkInterfaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInterfaceId",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) NetworkInterfaceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) NetworkLoadBalancerArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) NetworkLoadBalancerArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkLoadBalancerArnInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_Ec2TrafficMirrorTarget) Node() constructs.Node {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) Tags() *map[string]*string {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2TrafficMirrorTarget) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewEc2TrafficMirrorTarget(scope constructs.Construct, id *string, config *Ec2TrafficMirrorTargetConfig) Ec2TrafficMirrorTarget {
	...
	if err := validateNewEc2TrafficMirrorTargetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func Ec2TrafficMirrorTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEc2TrafficMirrorTarget_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func Ec2TrafficMirrorTarget_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.ec2TrafficMirrorTarget.Ec2TrafficMirrorTarget",
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) OverrideLogicalId(newLogicalId *string) {
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetDescription() {
	_jsii_.InvokeVoid(
		e,
		"resetDescription",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetNetworkInterfaceId() {
	_jsii_.InvokeVoid(
		e,
		"resetNetworkInterfaceId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetNetworkLoadBalancerArn() {
	_jsii_.InvokeVoid(
		e,
		"resetNetworkLoadBalancerArn",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		e,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetTags() {
	_jsii_.InvokeVoid(
		e,
		"resetTags",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ResetTagsAll() {
	_jsii_.InvokeVoid(
		e,
		"resetTagsAll",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2TrafficMirrorTarget) ToString() *string {
	var returns *string
