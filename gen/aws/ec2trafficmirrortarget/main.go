...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gatewayLoadBalancerEndpointIdInput", GoGetter: "GatewayLoadBalancerEndpointIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGatewayLoadBalancerEndpointId", GoMethod: "ResetGatewayLoadBalancerEndpointId"},
	...
	_jsii_.RegisterStruct(
		"aws.ec2TrafficMirrorTarget.Ec2TrafficMirrorTargetConfig",
