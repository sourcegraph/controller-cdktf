...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3outpostsendpoint/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3outposts_endpoint aws_s3outposts_endpoint}.
type S3OutpostsEndpoint interface {
	...
	NetworkInterfaces() S3OutpostsEndpointNetworkInterfacesList
	// The tree node.
...
func (j *jsiiProxy_S3OutpostsEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3OutpostsEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3OutpostsEndpoint) NetworkInterfaces() S3OutpostsEndpointNetworkInterfacesList {
	var returns S3OutpostsEndpointNetworkInterfacesList
	_jsii_.Get(
		j,
		"networkInterfaces",
		&returns,
...
func NewS3OutpostsEndpoint(scope constructs.Construct, id *string, config *S3OutpostsEndpointConfig) S3OutpostsEndpoint {
	...
	if err := validateNewS3OutpostsEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func S3OutpostsEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3OutpostsEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3OutpostsEndpoint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3OutpostsEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
