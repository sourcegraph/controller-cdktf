...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ecrregistrypolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_registry_policy aws_ecr_registry_policy}.
...
func (j *jsiiProxy_EcrRegistryPolicy) Connection() interface{} {
...
func (j *jsiiProxy_EcrRegistryPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrRegistryPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_EcrRegistryPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_registry_policy aws_ecr_registry_policy} Resource.
func NewEcrRegistryPolicy(scope constructs.Construct, id *string, config *EcrRegistryPolicyConfig) EcrRegistryPolicy {
	_init_.Initialize()

	if err := validateNewEcrRegistryPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EcrRegistryPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_EcrRegistryPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EcrRegistryPolicy)SetId(val *string) {
...
func (j *jsiiProxy_EcrRegistryPolicy)SetProvisioners(val *[]interface{}) {
...
func EcrRegistryPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEcrRegistryPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EcrRegistryPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateEcrRegistryPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrRegistryPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrRegistryPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EcrRegistryPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEcrRegistryPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EcrRegistryPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrRegistryPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcrRegistryPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EcrRegistryPolicy) MoveFromId(id *string) {
...
func (e *jsiiProxy_EcrRegistryPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EcrRegistryPolicy) MoveToId(id *string) {
...
func (e *jsiiProxy_EcrRegistryPolicy) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
...
func (e *jsiiProxy_EcrRegistryPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EcrRegistryPolicy) ToHclTerraform() interface{} {
	var returns interface{}
