...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsworkspacesworkspace/internal"
)
...
func NewDataAwsWorkspacesWorkspaceWorkspacePropertiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsWorkspacesWorkspaceWorkspacePropertiesOutputReference {
	...
	if err := validateNewDataAwsWorkspacesWorkspaceWorkspacePropertiesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
