...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3control_multi_region_access_point aws_s3control_multi_region_access_point}.
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlMultiRegionAccessPoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewS3ControlMultiRegionAccessPoint(scope constructs.Construct, id *string, config *S3ControlMultiRegionAccessPointConfig) S3ControlMultiRegionAccessPoint {
	...
	if err := validateNewS3ControlMultiRegionAccessPointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func S3ControlMultiRegionAccessPoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateS3ControlMultiRegionAccessPoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) MoveFromId(id *string) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) MoveToId(id *string) {
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) PutDetails(value *S3ControlMultiRegionAccessPointDetails) {
	if err := s.validatePutDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3ControlMultiRegionAccessPoint) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
