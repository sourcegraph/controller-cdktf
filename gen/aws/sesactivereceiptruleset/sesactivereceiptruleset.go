...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesactivereceiptruleset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_active_receipt_rule_set aws_ses_active_receipt_rule_set}.
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesActiveReceiptRuleSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSesActiveReceiptRuleSet(scope constructs.Construct, id *string, config *SesActiveReceiptRuleSetConfig) SesActiveReceiptRuleSet {
	...
	if err := validateNewSesActiveReceiptRuleSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SesActiveReceiptRuleSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesActiveReceiptRuleSet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) MoveFromId(id *string) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) MoveToId(id *string) {
...
func (s *jsiiProxy_SesActiveReceiptRuleSet) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
