...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iamservercertificate/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iam_server_certificate aws_iam_server_certificate}.
...
func (j *jsiiProxy_IamServerCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamServerCertificate) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIamServerCertificate(scope constructs.Construct, id *string, config *IamServerCertificateConfig) IamServerCertificate {
	...
	if err := validateNewIamServerCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamServerCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIamServerCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IamServerCertificate) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamServerCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamServerCertificate) MoveFromId(id *string) {
...
func (i *jsiiProxy_IamServerCertificate) MoveToId(id *string) {
...
func (i *jsiiProxy_IamServerCertificate) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
