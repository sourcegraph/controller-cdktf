...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/backupregionsettings/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/backup_region_settings aws_backup_region_settings}.
...
func (j *jsiiProxy_BackupRegionSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BackupRegionSettings) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewBackupRegionSettings(scope constructs.Construct, id *string, config *BackupRegionSettingsConfig) BackupRegionSettings {
	...
	if err := validateNewBackupRegionSettingsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func BackupRegionSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBackupRegionSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupRegionSettings) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupRegionSettings) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
