...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/wafregionalipset/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_ipset aws_wafregional_ipset}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/wafregional_ipset aws_wafregional_ipset} Resource.
func NewWafregionalIpset(scope constructs.Construct, id *string, config *WafregionalIpsetConfig) WafregionalIpset {
	_init_.Initialize()

	if err := validateNewWafregionalIpsetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WafregionalIpset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafregionalIpset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WafregionalIpset_IsConstruct(x interface{}) *bool {
	...
	if err := validateWafregionalIpset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalIpset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalIpset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafregionalIpset_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafregionalIpset_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafregionalIpset) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafregionalIpset) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafregionalIpset) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafregionalIpset) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafregionalIpset) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafregionalIpset) MoveToId(id *string) {
...
func (w *jsiiProxy_WafregionalIpset) PutIpSetDescriptor(value interface{}) {
	if err := w.validatePutIpSetDescriptorParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WafregionalIpset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafregionalIpset) ToHclTerraform() interface{} {
	var returns interface{}
