...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ecrrepositorypolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ecr_repository_policy aws_ecr_repository_policy}.
...
func (j *jsiiProxy_EcrRepositoryPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_EcrRepositoryPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewEcrRepositoryPolicy(scope constructs.Construct, id *string, config *EcrRepositoryPolicyConfig) EcrRepositoryPolicy {
	...
	if err := validateNewEcrRepositoryPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EcrRepositoryPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEcrRepositoryPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EcrRepositoryPolicy) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EcrRepositoryPolicy) ResetId() {
	_jsii_.InvokeVoid(
		e,
		"resetId",
		nil, // no parameters
