...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawssfnstatemachine/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/sfn_state_machine aws_sfn_state_machine}.
...
func (j *jsiiProxy_DataAwsSfnStateMachine) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsSfnStateMachine(scope constructs.Construct, id *string, config *DataAwsSfnStateMachineConfig) DataAwsSfnStateMachine {
	...
	if err := validateNewDataAwsSfnStateMachineParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsSfnStateMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsSfnStateMachine_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsSfnStateMachine) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
