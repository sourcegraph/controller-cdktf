...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/swfdomain/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/swf_domain aws_swf_domain}.
...
func (j *jsiiProxy_SwfDomain) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SwfDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewSwfDomain(scope constructs.Construct, id *string, config *SwfDomainConfig) SwfDomain {
	...
	if err := validateNewSwfDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SwfDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSwfDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SwfDomain) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SwfDomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SwfDomain) MoveFromId(id *string) {
...
func (s *jsiiProxy_SwfDomain) MoveToId(id *string) {
...
func (s *jsiiProxy_SwfDomain) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
