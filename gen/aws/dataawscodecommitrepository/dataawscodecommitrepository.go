...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscodecommitrepository/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/codecommit_repository aws_codecommit_repository}.
...
func (j *jsiiProxy_DataAwsCodecommitRepository) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsCodecommitRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsCodecommitRepository(scope constructs.Construct, id *string, config *DataAwsCodecommitRepositoryConfig) DataAwsCodecommitRepository {
	...
	if err := validateNewDataAwsCodecommitRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCodecommitRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCodecommitRepository_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsCodecommitRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAwsCodecommitRepository) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
