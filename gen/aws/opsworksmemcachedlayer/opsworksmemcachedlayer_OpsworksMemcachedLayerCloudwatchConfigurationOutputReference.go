...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) LogStreams() OpsworksMemcachedLayerCloudwatchConfigurationLogStreamsList {
	var returns OpsworksMemcachedLayerCloudwatchConfigurationLogStreamsList
	_jsii_.Get(
		j,
		"logStreams",
		&returns,
...
func NewOpsworksMemcachedLayerCloudwatchConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OpsworksMemcachedLayerCloudwatchConfigurationOutputReference {
	...
	if err := validateNewOpsworksMemcachedLayerCloudwatchConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (o *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) PutLogStreams(value interface{}) {
...
func (o *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OpsworksMemcachedLayerCloudwatchConfigurationOutputReference) ToString() *string {
	var returns *string
