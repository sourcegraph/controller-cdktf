...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/opsworks_memcached_layer aws_opsworks_memcached_layer}.
...
func (j *jsiiProxy_OpsworksMemcachedLayer) EbsVolume() OpsworksMemcachedLayerEbsVolumeList {
	var returns OpsworksMemcachedLayerEbsVolumeList
	_jsii_.Get(
		j,
		"ebsVolume",
		&returns,
...
func (j *jsiiProxy_OpsworksMemcachedLayer) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OpsworksMemcachedLayer) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewOpsworksMemcachedLayer(scope constructs.Construct, id *string, config *OpsworksMemcachedLayerConfig) OpsworksMemcachedLayer {
	...
	if err := validateNewOpsworksMemcachedLayerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OpsworksMemcachedLayer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOpsworksMemcachedLayer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksMemcachedLayer) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OpsworksMemcachedLayer) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
