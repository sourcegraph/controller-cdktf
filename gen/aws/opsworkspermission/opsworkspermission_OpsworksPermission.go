...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/opsworkspermission/internal"
)
...
func (j *jsiiProxy_OpsworksPermission) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OpsworksPermission) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewOpsworksPermission(scope constructs.Construct, id *string, config *OpsworksPermissionConfig) OpsworksPermission {
	...
	if err := validateNewOpsworksPermissionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OpsworksPermission) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
