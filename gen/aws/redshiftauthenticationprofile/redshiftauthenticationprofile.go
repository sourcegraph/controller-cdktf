...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/redshiftauthenticationprofile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/redshift_authentication_profile aws_redshift_authentication_profile}.
...
func NewRedshiftAuthenticationProfile(scope constructs.Construct, id *string, config *RedshiftAuthenticationProfileConfig) RedshiftAuthenticationProfile {
	...
	if err := validateNewRedshiftAuthenticationProfileParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func RedshiftAuthenticationProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRedshiftAuthenticationProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) MoveFromId(id *string) {
...
func (r *jsiiProxy_RedshiftAuthenticationProfile) MoveToId(id *string) {
