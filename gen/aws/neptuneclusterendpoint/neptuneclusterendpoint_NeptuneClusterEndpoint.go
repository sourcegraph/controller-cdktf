...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/neptuneclusterendpoint/internal"
)
...
func NewNeptuneClusterEndpoint(scope constructs.Construct, id *string, config *NeptuneClusterEndpointConfig) NeptuneClusterEndpoint {
	...
	if err := validateNewNeptuneClusterEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
