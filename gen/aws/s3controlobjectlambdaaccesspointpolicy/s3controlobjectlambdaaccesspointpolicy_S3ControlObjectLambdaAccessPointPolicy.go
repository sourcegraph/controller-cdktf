...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/s3controlobjectlambdaaccesspointpolicy/internal"
)
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) Connection() interface{} {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewS3ControlObjectLambdaAccessPointPolicy(scope constructs.Construct, id *string, config *S3ControlObjectLambdaAccessPointPolicyConfig) S3ControlObjectLambdaAccessPointPolicy {
	...
	if err := validateNewS3ControlObjectLambdaAccessPointPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_S3ControlObjectLambdaAccessPointPolicy{}

	_jsii_.Create(
		"aws.s3ControlObjectLambdaAccessPointPolicy.S3ControlObjectLambdaAccessPointPolicy",
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy)SetId(val *string) {
...
func (j *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy)SetProvisioners(val *[]interface{}) {
...
func S3ControlObjectLambdaAccessPointPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateS3ControlObjectLambdaAccessPointPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
