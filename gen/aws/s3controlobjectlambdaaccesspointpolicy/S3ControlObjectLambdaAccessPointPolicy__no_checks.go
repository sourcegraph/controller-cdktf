...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) validateImportFromParameters(id *string) error {
	return nil
}
...
func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (s *jsiiProxy_S3ControlObjectLambdaAccessPointPolicy) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateS3ControlObjectLambdaAccessPointPolicy_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func validateS3ControlObjectLambdaAccessPointPolicy_IsTerraformElementParameters(x interface{}) error {
	return nil
}

func validateS3ControlObjectLambdaAccessPointPolicy_IsTerraformResourceParameters(x interface{}) error {
	return nil
}
