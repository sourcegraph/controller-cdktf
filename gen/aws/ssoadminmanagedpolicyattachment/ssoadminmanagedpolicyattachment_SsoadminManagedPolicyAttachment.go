...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/ssoadminmanagedpolicyattachment/internal"
)
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) Connection() interface{} {
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewSsoadminManagedPolicyAttachment(scope constructs.Construct, id *string, config *SsoadminManagedPolicyAttachmentConfig) SsoadminManagedPolicyAttachment {
	...
	if err := validateNewSsoadminManagedPolicyAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetId(val *string) {
...
func (j *jsiiProxy_SsoadminManagedPolicyAttachment)SetProvisioners(val *[]interface{}) {
...
func SsoadminManagedPolicyAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateSsoadminManagedPolicyAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SsoadminManagedPolicyAttachment) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
