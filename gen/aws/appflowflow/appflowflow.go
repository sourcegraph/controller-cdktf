...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appflow_flow aws_appflow_flow}.
type AppflowFlow interface {
	...
	TriggerConfigInput() *AppflowFlowTriggerConfig
...
func (j *jsiiProxy_AppflowFlow) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_AppflowFlow) DestinationFlowConfig() AppflowFlowDestinationFlowConfigList {
	var returns AppflowFlowDestinationFlowConfigList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppflowFlow) DestinationFlowConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppflowFlow) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppflowFlow) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AppflowFlow) SourceFlowConfigInput() *AppflowFlowSourceFlowConfig {
...
func (j *jsiiProxy_AppflowFlow) Tags() *map[string]*string {
...
func (j *jsiiProxy_AppflowFlow) TagsAll() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_AppflowFlow) TagsAllInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_AppflowFlow) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_AppflowFlow) Task() AppflowFlowTaskList {
	var returns AppflowFlowTaskList
	_jsii_.Get(
		j,
		"task",
		&returns,
...
func (j *jsiiProxy_AppflowFlow) TaskInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"taskInput",
...
func (j *jsiiProxy_AppflowFlow) TriggerConfigInput() *AppflowFlowTriggerConfig {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appflow_flow aws_appflow_flow} Resource.
...
func (j *jsiiProxy_AppflowFlow)SetId(val *string) {
...
func (j *jsiiProxy_AppflowFlow)SetName(val *string) {
...
func (j *jsiiProxy_AppflowFlow)SetTags(val *map[string]*string) {
...
func (j *jsiiProxy_AppflowFlow)SetTagsAll(val *map[string]*string) {
...
func (a *jsiiProxy_AppflowFlow) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppflowFlow) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppflowFlow) MoveToId(id *string) {
...
func (a *jsiiProxy_AppflowFlow) PutDestinationFlowConfig(value interface{}) {
	if err := a.validatePutDestinationFlowConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
		"putDestinationFlowConfig",
		[]interface{}{value},
	)
}
...
func (a *jsiiProxy_AppflowFlow) PutTask(value interface{}) {
	if err := a.validatePutTaskParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AppflowFlow) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AppflowFlow) ResetTagsAll() {
	_jsii_.InvokeVoid(
		a,
		"resetTagsAll",
		nil, // no parameters
...
func (a *jsiiProxy_AppflowFlow) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppflowFlow) ToHclTerraform() interface{} {
	var returns interface{}
