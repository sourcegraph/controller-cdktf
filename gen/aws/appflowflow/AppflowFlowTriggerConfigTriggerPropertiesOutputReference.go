...
type AppflowFlowTriggerConfigTriggerPropertiesOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *AppflowFlowTriggerConfigTriggerProperties
	SetInternalValue(val *AppflowFlowTriggerConfigTriggerProperties)
	Scheduled() AppflowFlowTriggerConfigTriggerPropertiesScheduledOutputReference
	ScheduledInput() *AppflowFlowTriggerConfigTriggerPropertiesScheduled
	// Experimental.
	...
	PutScheduled(value *AppflowFlowTriggerConfigTriggerPropertiesScheduled)
	ResetScheduled()
...
func (j *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference) InternalValue() *AppflowFlowTriggerConfigTriggerProperties {
...
func (j *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference) Scheduled() AppflowFlowTriggerConfigTriggerPropertiesScheduledOutputReference {
	var returns AppflowFlowTriggerConfigTriggerPropertiesScheduledOutputReference
	_jsii_.Get(
		j,
		"scheduled",
		&returns,
...
func (j *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference) ScheduledInput() *AppflowFlowTriggerConfigTriggerPropertiesScheduled {
...
func (j *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference)SetInternalValue(val *AppflowFlowTriggerConfigTriggerProperties) {
...
func (a *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference) PutScheduled(value *AppflowFlowTriggerConfigTriggerPropertiesScheduled) {
	if err := a.validatePutScheduledParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AppflowFlowTriggerConfigTriggerPropertiesOutputReference) ResetScheduled() {
	_jsii_.InvokeVoid(
		a,
		"resetScheduled",
		nil, // no parameters
