...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) WeightedTarget() AppmeshRouteSpecHttp2RouteActionWeightedTargetList {
	var returns AppmeshRouteSpecHttp2RouteActionWeightedTargetList
	_jsii_.Get(
		j,
		"weightedTarget",
		&returns,
...
func NewAppmeshRouteSpecHttp2RouteActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppmeshRouteSpecHttp2RouteActionOutputReference {
	...
	if err := validateNewAppmeshRouteSpecHttp2RouteActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppmeshRouteSpecHttp2RouteActionOutputReference) ToString() *string {
	var returns *string
