...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/sesidentitynotificationtopic/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_identity_notification_topic aws_ses_identity_notification_topic}.
...
func (j *jsiiProxy_SesIdentityNotificationTopic) Connection() interface{} {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SesIdentityNotificationTopic) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SesIdentityNotificationTopic) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/ses_identity_notification_topic aws_ses_identity_notification_topic} Resource.
func NewSesIdentityNotificationTopic(scope constructs.Construct, id *string, config *SesIdentityNotificationTopicConfig) SesIdentityNotificationTopic {
	...
	if err := validateNewSesIdentityNotificationTopicParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetConnection(val interface{}) {
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetId(val *string) {
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetIncludeOriginalHeaders(val interface{}) {
	if err := j.validateSetIncludeOriginalHeadersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SesIdentityNotificationTopic)SetProvisioners(val *[]interface{}) {
...
func SesIdentityNotificationTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSesIdentityNotificationTopic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SesIdentityNotificationTopic_IsConstruct(x interface{}) *bool {
	...
	if err := validateSesIdentityNotificationTopic_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SesIdentityNotificationTopic) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SesIdentityNotificationTopic) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SesIdentityNotificationTopic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SesIdentityNotificationTopic) ToHclTerraform() interface{} {
	var returns interface{}
