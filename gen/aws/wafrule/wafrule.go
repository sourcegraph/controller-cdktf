...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/waf_rule aws_waf_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/waf_rule aws_waf_rule} Resource.
...
func WafRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWafRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func WafRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WafRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWafRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WafRule) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WafRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WafRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WafRule) MoveFromId(id *string) {
...
func (w *jsiiProxy_WafRule) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WafRule) MoveToId(id *string) {
...
func (w *jsiiProxy_WafRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WafRule) ToHclTerraform() interface{} {
	var returns interface{}
