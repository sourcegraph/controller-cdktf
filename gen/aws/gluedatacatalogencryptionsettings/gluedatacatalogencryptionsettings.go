...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/glue_data_catalog_encryption_settings aws_glue_data_catalog_encryption_settings}.
...
func GlueDataCatalogEncryptionSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGlueDataCatalogEncryptionSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettings) MoveToId(id *string) {
