...
func (c *jsiiProxy_CodedeployDeploymentGroupEc2TagFilterList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (j *jsiiProxy_CodedeployDeploymentGroupEc2TagFilterList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*CodedeployDeploymentGroupEc2TagFilter:
		val := val.(*[]*CodedeployDeploymentGroupEc2TagFilter)
	...
	case []*CodedeployDeploymentGroupEc2TagFilter:
		val_ := val.([]*CodedeployDeploymentGroupEc2TagFilter)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*CodedeployDeploymentGroupEc2TagFilter; received %#v (a %T)", val, val)
		}
	}
