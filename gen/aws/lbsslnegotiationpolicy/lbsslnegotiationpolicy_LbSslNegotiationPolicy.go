...
func (j *jsiiProxy_LbSslNegotiationPolicy) Attribute() LbSslNegotiationPolicyAttributeList {
	var returns LbSslNegotiationPolicyAttributeList
	_jsii_.Get(
		j,
		"attribute",
		&returns,
...
func (j *jsiiProxy_LbSslNegotiationPolicy) AttributeInput() interface{} {
...
func (j *jsiiProxy_LbSslNegotiationPolicy) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_LbSslNegotiationPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LbSslNegotiationPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LbSslNegotiationPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func NewLbSslNegotiationPolicy(scope constructs.Construct, id *string, config *LbSslNegotiationPolicyConfig) LbSslNegotiationPolicy {
	...
	if err := validateNewLbSslNegotiationPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LbSslNegotiationPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_LbSslNegotiationPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbSslNegotiationPolicy)SetId(val *string) {
...
func (j *jsiiProxy_LbSslNegotiationPolicy)SetProvisioners(val *[]interface{}) {
...
func LbSslNegotiationPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateLbSslNegotiationPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LbSslNegotiationPolicy) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbSslNegotiationPolicy) PutAttribute(value interface{}) {
	if err := l.validatePutAttributeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LbSslNegotiationPolicy) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
