...
func NewRedshiftdataStatementParametersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftdataStatementParametersList {
	...
	if err := validateNewRedshiftdataStatementParametersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RedshiftdataStatementParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
