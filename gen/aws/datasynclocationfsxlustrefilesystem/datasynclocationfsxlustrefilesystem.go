...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/datasynclocationfsxlustrefilesystem/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/datasync_location_fsx_lustre_file_system aws_datasync_location_fsx_lustre_file_system}.
...
func (j *jsiiProxy_DatasyncLocationFsxLustreFileSystem) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDatasyncLocationFsxLustreFileSystem(scope constructs.Construct, id *string, config *DatasyncLocationFsxLustreFileSystemConfig) DatasyncLocationFsxLustreFileSystem {
	...
	if err := validateNewDatasyncLocationFsxLustreFileSystemParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatasyncLocationFsxLustreFileSystem) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatasyncLocationFsxLustreFileSystem) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
