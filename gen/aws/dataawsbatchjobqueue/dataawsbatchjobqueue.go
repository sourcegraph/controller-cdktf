...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsbatchjobqueue/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/batch_job_queue aws_batch_job_queue}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/batch_job_queue aws_batch_job_queue} Data Source.
func NewDataAwsBatchJobQueue(scope constructs.Construct, id *string, config *DataAwsBatchJobQueueConfig) DataAwsBatchJobQueue {
	_init_.Initialize()

	if err := validateNewDataAwsBatchJobQueueParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsBatchJobQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsBatchJobQueue_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsBatchJobQueue_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsBatchJobQueue_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsBatchJobQueue_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsBatchJobQueue_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAwsBatchJobQueue_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAwsBatchJobQueue_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsBatchJobQueue) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsBatchJobQueue) ToHclTerraform() interface{} {
	var returns interface{}
