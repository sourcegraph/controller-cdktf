...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsworkspacesbundle/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/workspaces_bundle aws_workspaces_bundle}.
...
func NewDataAwsWorkspacesBundle(scope constructs.Construct, id *string, config *DataAwsWorkspacesBundleConfig) DataAwsWorkspacesBundle {
	...
	if err := validateNewDataAwsWorkspacesBundleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsWorkspacesBundle_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWorkspacesBundle_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
