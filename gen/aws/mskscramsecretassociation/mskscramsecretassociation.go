...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/mskscramsecretassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/msk_scram_secret_association aws_msk_scram_secret_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/msk_scram_secret_association aws_msk_scram_secret_association} Resource.
func NewMskScramSecretAssociation(scope constructs.Construct, id *string, config *MskScramSecretAssociationConfig) MskScramSecretAssociation {
	...
	if err := validateNewMskScramSecretAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MskScramSecretAssociation)SetSecretArnList(val *[]*string) {
	if err := j.validateSetSecretArnListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func MskScramSecretAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMskScramSecretAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MskScramSecretAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateMskScramSecretAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MskScramSecretAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskScramSecretAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MskScramSecretAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMskScramSecretAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MskScramSecretAssociation) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MskScramSecretAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MskScramSecretAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MskScramSecretAssociation) MoveFromId(id *string) {
...
func (m *jsiiProxy_MskScramSecretAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MskScramSecretAssociation) MoveToId(id *string) {
...
func (m *jsiiProxy_MskScramSecretAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MskScramSecretAssociation) ToHclTerraform() interface{} {
	var returns interface{}
