...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dmseventsubscription/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dms_event_subscription aws_dms_event_subscription}.
...
func NewDmsEventSubscription(scope constructs.Construct, id *string, config *DmsEventSubscriptionConfig) DmsEventSubscription {
	...
	if err := validateNewDmsEventSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DmsEventSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDmsEventSubscription_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DmsEventSubscription) AddMoveTarget(moveTarget *string) {
