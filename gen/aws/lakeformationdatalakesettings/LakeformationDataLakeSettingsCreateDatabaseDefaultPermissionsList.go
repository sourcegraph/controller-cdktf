...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lakeformationdatalakesettings/internal"
)
...
func NewLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList {
	...
	if err := validateNewLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
