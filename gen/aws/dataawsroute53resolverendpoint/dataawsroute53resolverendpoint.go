...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsroute53resolverendpoint/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/route53_resolver_endpoint aws_route53_resolver_endpoint}.
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) Filter() DataAwsRoute53ResolverEndpointFilterList {
	var returns DataAwsRoute53ResolverEndpointFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_DataAwsRoute53ResolverEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewDataAwsRoute53ResolverEndpoint(scope constructs.Construct, id *string, config *DataAwsRoute53ResolverEndpointConfig) DataAwsRoute53ResolverEndpoint {
	...
	if err := validateNewDataAwsRoute53ResolverEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsRoute53ResolverEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
