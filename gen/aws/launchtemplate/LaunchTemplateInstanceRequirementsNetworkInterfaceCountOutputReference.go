...
func (l *jsiiProxy_LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LaunchTemplateInstanceRequirementsNetworkInterfaceCountOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
