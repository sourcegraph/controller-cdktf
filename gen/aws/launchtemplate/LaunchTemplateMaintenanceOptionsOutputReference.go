...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) AutoRecoveryInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"autoRecoveryInput",
...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) InternalValue() *LaunchTemplateMaintenanceOptions {
...
func (j *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) ResetAutoRecovery() {
	_jsii_.InvokeVoid(
		l,
		"resetAutoRecovery",
		nil, // no parameters
...
func (l *jsiiProxy_LaunchTemplateMaintenanceOptionsOutputReference) ToString() *string {
	var returns *string
