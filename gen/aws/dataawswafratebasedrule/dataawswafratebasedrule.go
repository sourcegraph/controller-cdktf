...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawswafratebasedrule/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_rate_based_rule aws_waf_rate_based_rule}.
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsWafRateBasedRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/waf_rate_based_rule aws_waf_rate_based_rule} Data Source.
func NewDataAwsWafRateBasedRule(scope constructs.Construct, id *string, config *DataAwsWafRateBasedRuleConfig) DataAwsWafRateBasedRule {
	...
	if err := validateNewDataAwsWafRateBasedRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAwsWafRateBasedRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsWafRateBasedRule)SetId(val *string) {
...
func DataAwsWafRateBasedRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsWafRateBasedRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAwsWafRateBasedRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAwsWafRateBasedRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsWafRateBasedRule) ToHclTerraform() interface{} {
	var returns interface{}
