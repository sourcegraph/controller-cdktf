...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/proxyprotocolpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/proxy_protocol_policy aws_proxy_protocol_policy}.
...
func (j *jsiiProxy_ProxyProtocolPolicy) Connection() interface{} {
...
func (j *jsiiProxy_ProxyProtocolPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ProxyProtocolPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ProxyProtocolPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/proxy_protocol_policy aws_proxy_protocol_policy} Resource.
func NewProxyProtocolPolicy(scope constructs.Construct, id *string, config *ProxyProtocolPolicyConfig) ProxyProtocolPolicy {
	_init_.Initialize()

	if err := validateNewProxyProtocolPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ProxyProtocolPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_ProxyProtocolPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ProxyProtocolPolicy)SetId(val *string) {
...
func (j *jsiiProxy_ProxyProtocolPolicy)SetProvisioners(val *[]interface{}) {
...
func ProxyProtocolPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProxyProtocolPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ProxyProtocolPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateProxyProtocolPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProxyProtocolPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProxyProtocolPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProxyProtocolPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProxyProtocolPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProxyProtocolPolicy) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (p *jsiiProxy_ProxyProtocolPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_ProxyProtocolPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_ProxyProtocolPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_ProxyProtocolPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_ProxyProtocolPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProxyProtocolPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) MoveToId(id *string) {
...
func (p *jsiiProxy_ProxyProtocolPolicy) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_ProxyProtocolPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProxyProtocolPolicy) ToHclTerraform() interface{} {
	var returns interface{}
