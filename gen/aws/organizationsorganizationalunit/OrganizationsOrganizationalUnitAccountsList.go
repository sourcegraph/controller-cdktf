...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/organizationsorganizationalunit/internal"
)
...
func NewOrganizationsOrganizationalUnitAccountsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrganizationsOrganizationalUnitAccountsList {
	...
	if err := validateNewOrganizationsOrganizationalUnitAccountsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrganizationsOrganizationalUnitAccountsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
