...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dynamodbtablereplica/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dynamodb_table_replica aws_dynamodb_table_replica}.
...
func NewDynamodbTableReplicaA(scope constructs.Construct, id *string, config *DynamodbTableReplicaAConfig) DynamodbTableReplicaA {
	...
	if err := validateNewDynamodbTableReplicaAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DynamodbTableReplicaA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDynamodbTableReplicaA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DynamodbTableReplicaA) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DynamodbTableReplicaA) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DynamodbTableReplicaA) MoveFromId(id *string) {
...
func (d *jsiiProxy_DynamodbTableReplicaA) MoveToId(id *string) {
