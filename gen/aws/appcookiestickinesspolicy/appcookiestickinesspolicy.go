...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appcookiestickinesspolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/app_cookie_stickiness_policy aws_app_cookie_stickiness_policy}.
...
func (j *jsiiProxy_AppCookieStickinessPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AppCookieStickinessPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewAppCookieStickinessPolicy(scope constructs.Construct, id *string, config *AppCookieStickinessPolicyConfig) AppCookieStickinessPolicy {
	...
	if err := validateNewAppCookieStickinessPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AppCookieStickinessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppCookieStickinessPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppCookieStickinessPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) MoveToId(id *string) {
...
func (a *jsiiProxy_AppCookieStickinessPolicy) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
