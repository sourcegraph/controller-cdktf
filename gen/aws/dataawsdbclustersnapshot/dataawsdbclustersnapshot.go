...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsdbclustersnapshot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/db_cluster_snapshot aws_db_cluster_snapshot}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/db_cluster_snapshot aws_db_cluster_snapshot} Data Source.
...
func DataAwsDbClusterSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsDbClusterSnapshot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsDbClusterSnapshot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAwsDbClusterSnapshot) ToHclTerraform() interface{} {
	var returns interface{}
