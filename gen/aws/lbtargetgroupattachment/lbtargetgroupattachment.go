package lbtargetgroupattachment
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/lbtargetgroupattachment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/lb_target_group_attachment aws_lb_target_group_attachment}.
...
func (j *jsiiProxy_LbTargetGroupAttachment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LbTargetGroupAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewLbTargetGroupAttachment(scope constructs.Construct, id *string, config *LbTargetGroupAttachmentConfig) LbTargetGroupAttachment {
	...
	if err := validateNewLbTargetGroupAttachmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LbTargetGroupAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLbTargetGroupAttachment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LbTargetGroupAttachment) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbTargetGroupAttachment) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LbTargetGroupAttachment) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LbTargetGroupAttachment) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LbTargetGroupAttachment) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LbTargetGroupAttachment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LbTargetGroupAttachment) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbTargetGroupAttachment) MoveToId(id *string) {
...
func (l *jsiiProxy_LbTargetGroupAttachment) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
