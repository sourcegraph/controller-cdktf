...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawsservicediscoveryservice/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/service_discovery_service aws_service_discovery_service}.
...
func NewDataAwsServiceDiscoveryService(scope constructs.Construct, id *string, config *DataAwsServiceDiscoveryServiceConfig) DataAwsServiceDiscoveryService {
	...
	if err := validateNewDataAwsServiceDiscoveryServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsServiceDiscoveryService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsServiceDiscoveryService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
