...
func NewDataAwsServiceDiscoveryServiceHealthCheckCustomConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList {
	...
	if err := validateNewDataAwsServiceDiscoveryServiceHealthCheckCustomConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
