...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appstreamfleetstackassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appstream_fleet_stack_association aws_appstream_fleet_stack_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appstream_fleet_stack_association aws_appstream_fleet_stack_association} Resource.
func NewAppstreamFleetStackAssociation(scope constructs.Construct, id *string, config *AppstreamFleetStackAssociationConfig) AppstreamFleetStackAssociation {
	...
	if err := validateNewAppstreamFleetStackAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AppstreamFleetStackAssociation)SetFleetName(val *string) {
	if err := j.validateSetFleetNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func AppstreamFleetStackAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAppstreamFleetStackAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AppstreamFleetStackAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppstreamFleetStackAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppstreamFleetStackAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppstreamFleetStackAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppstreamFleetStackAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppstreamFleetStackAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppstreamFleetStackAssociation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppstreamFleetStackAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppstreamFleetStackAssociation) ToHclTerraform() interface{} {
	var returns interface{}
