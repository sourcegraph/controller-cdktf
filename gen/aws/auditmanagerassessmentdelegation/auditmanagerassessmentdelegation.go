...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/auditmanagerassessmentdelegation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/auditmanager_assessment_delegation aws_auditmanager_assessment_delegation}.
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) AssessmentIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assessmentIdInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) ControlSetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"controlSetId",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) ControlSetIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"controlSetIdInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) DelegationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delegationId",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) Node() constructs.Node {
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) RoleArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArnInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) RoleType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleType",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) RoleTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleTypeInput",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_AuditmanagerAssessmentDelegation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewAuditmanagerAssessmentDelegation(scope constructs.Construct, id *string, config *AuditmanagerAssessmentDelegationConfig) AuditmanagerAssessmentDelegation {
	...
	if err := validateNewAuditmanagerAssessmentDelegationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func AuditmanagerAssessmentDelegation_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-aws.auditmanagerAssessmentDelegation.AuditmanagerAssessmentDelegation",
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) MoveFromId(id *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) MoveToId(id *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) ResetComment() {
	_jsii_.InvokeVoid(
		a,
		"resetComment",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AuditmanagerAssessmentDelegation) ToString() *string {
	var returns *string
