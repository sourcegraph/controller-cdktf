...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/s3_bucket_intelligent_tiering_configuration aws_s3_bucket_intelligent_tiering_configuration}.
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfiguration) ForEach() cdktf.ITerraformIterator {
...
func S3BucketIntelligentTieringConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
