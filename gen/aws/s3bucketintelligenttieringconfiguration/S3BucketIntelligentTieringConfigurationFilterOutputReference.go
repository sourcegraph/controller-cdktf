...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func NewS3BucketIntelligentTieringConfigurationFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) S3BucketIntelligentTieringConfigurationFilterOutputReference {
	_init_.Initialize()

	if err := validateNewS3BucketIntelligentTieringConfigurationFilterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference{}

	_jsii_.Create(
		"aws.s3BucketIntelligentTieringConfiguration.S3BucketIntelligentTieringConfigurationFilterOutputReference",
...
func NewS3BucketIntelligentTieringConfigurationFilterOutputReference_Override(s S3BucketIntelligentTieringConfigurationFilterOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_S3BucketIntelligentTieringConfigurationFilterOutputReference) ToString() *string {
	var returns *string
