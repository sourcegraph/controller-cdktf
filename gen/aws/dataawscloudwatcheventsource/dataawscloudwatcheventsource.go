...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/dataawscloudwatcheventsource/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/data-sources/cloudwatch_event_source aws_cloudwatch_event_source}.
...
func NewDataAwsCloudwatchEventSource(scope constructs.Construct, id *string, config *DataAwsCloudwatchEventSourceConfig) DataAwsCloudwatchEventSource {
	...
	if err := validateNewDataAwsCloudwatchEventSourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAwsCloudwatchEventSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAwsCloudwatchEventSource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
