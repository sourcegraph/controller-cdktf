...
func (j *jsiiProxy_AutoscalingPolicyPredictiveScalingConfigurationOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AutoscalingPolicyPredictiveScalingConfigurationOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AutoscalingPolicyPredictiveScalingConfigurationOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (a *jsiiProxy_AutoscalingPolicyPredictiveScalingConfigurationOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutoscalingPolicyPredictiveScalingConfigurationOutputReference) ToString() *string {
	var returns *string
