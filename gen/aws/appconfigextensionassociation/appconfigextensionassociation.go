...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/appconfigextensionassociation/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/appconfig_extension_association aws_appconfig_extension_association}.
type AppconfigExtensionAssociation interface {
	...
	ExtensionArn() *string
	SetExtensionArn(val *string)
	ExtensionArnInput() *string
	ExtensionVersion() *float64
	// Experimental.
...
func (j *jsiiProxy_AppconfigExtensionAssociation) ExtensionArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"extensionArnInput",
...
func (j *jsiiProxy_AppconfigExtensionAssociation) ExtensionVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"extensionVersion",
...
func (j *jsiiProxy_AppconfigExtensionAssociation) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppconfigExtensionAssociation) ResourceArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArnInput",
...
func (a *jsiiProxy_AppconfigExtensionAssociation) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
