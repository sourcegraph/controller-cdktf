...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/acmcertificatevalidation/internal"
)
...
func NewAcmCertificateValidation(scope constructs.Construct, id *string, config *AcmCertificateValidationConfig) AcmCertificateValidation {
	...
	if err := validateNewAcmCertificateValidationParameters(scope, id, config); err != nil {
		panic(err)
	}
