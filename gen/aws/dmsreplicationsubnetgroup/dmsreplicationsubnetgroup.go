...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/dms_replication_subnet_group aws_dms_replication_subnet_group}.
...
func NewDmsReplicationSubnetGroup(scope constructs.Construct, id *string, config *DmsReplicationSubnetGroupConfig) DmsReplicationSubnetGroup {
	...
	if err := validateNewDmsReplicationSubnetGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DmsReplicationSubnetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDmsReplicationSubnetGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) MoveFromId(id *string) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) MoveToId(id *string) {
