...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/iot_thing_type aws_iot_thing_type}.
...
func (j *jsiiProxy_IotThingType) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IotThingType) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewIotThingType(scope constructs.Construct, id *string, config *IotThingTypeConfig) IotThingType {
	...
	if err := validateNewIotThingTypeParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IotThingType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotThingType_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotThingType) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotThingType) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotThingType) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotThingType) MoveToId(id *string) {
...
func (i *jsiiProxy_IotThingType) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IotThingType) ResetTags() {
	_jsii_.InvokeVoid(
		i,
		"resetTags",
		nil, // no parameters
...
func (i *jsiiProxy_IotThingType) ResetTagsAll() {
	_jsii_.InvokeVoid(
		i,
		"resetTagsAll",
		nil, // no parameters
