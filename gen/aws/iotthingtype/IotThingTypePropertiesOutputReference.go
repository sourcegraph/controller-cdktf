...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/iotthingtype/internal"
)
...
type IotThingTypePropertiesOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *IotThingTypeProperties
	SetInternalValue(val *IotThingTypeProperties)
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference) InternalValue() *IotThingTypeProperties {
...
func NewIotThingTypePropertiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotThingTypePropertiesOutputReference {
	_init_.Initialize()

	if err := validateNewIotThingTypePropertiesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotThingTypePropertiesOutputReference_Override(i IotThingTypePropertiesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference)SetInternalValue(val *IotThingTypeProperties) {
...
func (j *jsiiProxy_IotThingTypePropertiesOutputReference)SetSearchableAttributes(val *[]*string) {
	if err := j.validateSetSearchableAttributesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_IotThingTypePropertiesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_IotThingTypePropertiesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (i *jsiiProxy_IotThingTypePropertiesOutputReference) ToString() *string {
	var returns *string
