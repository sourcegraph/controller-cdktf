...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/aws/cloudwatchquerydefinition/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/4.54.0/docs/resources/cloudwatch_query_definition aws_cloudwatch_query_definition}.
...
func (j *jsiiProxy_CloudwatchQueryDefinition) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CloudwatchQueryDefinition) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func NewCloudwatchQueryDefinition(scope constructs.Construct, id *string, config *CloudwatchQueryDefinitionConfig) CloudwatchQueryDefinition {
	...
	if err := validateNewCloudwatchQueryDefinitionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudwatchQueryDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudwatchQueryDefinition_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudwatchQueryDefinition) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudwatchQueryDefinition) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
