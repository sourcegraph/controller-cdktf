...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/storage_bucket_object google_storage_bucket_object}.
...
func (j *jsiiProxy_StorageBucketObject) Md5Hexhash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5Hexhash",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/storage_bucket_object google_storage_bucket_object} Resource.
...
func StorageBucketObject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageBucketObject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageBucketObject) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageBucketObject) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageBucketObject) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageBucketObject) MoveToId(id *string) {
