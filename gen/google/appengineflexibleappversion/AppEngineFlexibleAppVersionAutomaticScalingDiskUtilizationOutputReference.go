...
func (a *jsiiProxy_AppEngineFlexibleAppVersionAutomaticScalingDiskUtilizationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineFlexibleAppVersionAutomaticScalingDiskUtilizationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
