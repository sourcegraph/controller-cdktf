...
func (j *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) Get(index *float64) LookerInstancePscConfigServiceAttachmentsOutputReference {
	if err := l.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns LookerInstancePscConfigServiceAttachmentsOutputReference
...
func (l *jsiiProxy_LookerInstancePscConfigServiceAttachmentsList) ToString() *string {
	var returns *string
