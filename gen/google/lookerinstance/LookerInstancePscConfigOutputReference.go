...
type LookerInstancePscConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *LookerInstancePscConfig
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) AllowedVpcsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedVpcsInput",
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) InternalValue() *LookerInstancePscConfig {
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) LookerServiceAttachmentUri() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) ServiceAttachments() LookerInstancePscConfigServiceAttachmentsList {
	var returns LookerInstancePscConfigServiceAttachmentsList
	_jsii_.Get(
		j,
		"serviceAttachments",
		&returns,
...
func (j *jsiiProxy_LookerInstancePscConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) ResetAllowedVpcs() {
	_jsii_.InvokeVoid(
		l,
		"resetAllowedVpcs",
		nil, // no parameters
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) ResetServiceAttachments() {
	_jsii_.InvokeVoid(
		l,
		"resetServiceAttachments",
		nil, // no parameters
...
func (l *jsiiProxy_LookerInstancePscConfigOutputReference) ToString() *string {
	var returns *string
