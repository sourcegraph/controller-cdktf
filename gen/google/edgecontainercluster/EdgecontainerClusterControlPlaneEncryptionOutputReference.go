...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) InternalValue() *EdgecontainerClusterControlPlaneEncryption {
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) KmsKeyActiveVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyActiveVersion",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) KmsKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyInput",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) KmsKeyState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyState",
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) KmsStatus() EdgecontainerClusterControlPlaneEncryptionKmsStatusList {
	var returns EdgecontainerClusterControlPlaneEncryptionKmsStatusList
	_jsii_.Get(
		j,
		"kmsStatus",
		&returns,
...
func (j *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) ResetKmsKey() {
	_jsii_.InvokeVoid(
		e,
		"resetKmsKey",
		nil, // no parameters
...
func (e *jsiiProxy_EdgecontainerClusterControlPlaneEncryptionOutputReference) ToString() *string {
	var returns *string
