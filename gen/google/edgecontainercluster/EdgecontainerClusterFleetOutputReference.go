...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) InternalValue() *EdgecontainerClusterFleet {
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) Membership() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membership",
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_EdgecontainerClusterFleetOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EdgecontainerClusterFleetOutputReference) ToString() *string {
	var returns *string
