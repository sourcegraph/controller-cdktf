...
type EdgecontainerClusterFleet struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.4.0/docs/resources/edgecontainer_cluster#project EdgecontainerCluster#project}
