...
func init() {
	_jsii_.RegisterClass(
		"google.dataGoogleBigqueryTableIamPolicy.DataGoogleBigqueryTableIamPolicy",
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBigqueryTableIamPolicy.DataGoogleBigqueryTableIamPolicyConfig",
