...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/iam_workforce_pool google_iam_workforce_pool}.
...
func (j *jsiiProxy_IamWorkforcePool) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IamWorkforcePool) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_IamWorkforcePool) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_IamWorkforcePool) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_IamWorkforcePool) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_IamWorkforcePool) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IamWorkforcePool) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IamWorkforcePool) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IamWorkforcePool) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamWorkforcePool) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_IamWorkforcePool) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_IamWorkforcePool) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_IamWorkforcePool) Node() constructs.Node {
...
func (j *jsiiProxy_IamWorkforcePool) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_IamWorkforcePool) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_IamWorkforcePool) SessionDuration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sessionDuration",
...
func (j *jsiiProxy_IamWorkforcePool) SessionDurationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamWorkforcePool) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_IamWorkforcePool) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamWorkforcePool) Timeouts() IamWorkforcePoolTimeoutsOutputReference {
	var returns IamWorkforcePoolTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_IamWorkforcePool) WorkforcePoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workforcePoolId",
...
func (j *jsiiProxy_IamWorkforcePool) WorkforcePoolIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/iam_workforce_pool google_iam_workforce_pool} Resource.
func NewIamWorkforcePool(scope constructs.Construct, id *string, config *IamWorkforcePoolConfig) IamWorkforcePool {
	_init_.Initialize()

	if err := validateNewIamWorkforcePoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamWorkforcePool_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.iamWorkforcePool.IamWorkforcePool",
...
func (i *jsiiProxy_IamWorkforcePool) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IamWorkforcePool) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IamWorkforcePool) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IamWorkforcePool) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IamWorkforcePool) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IamWorkforcePool) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IamWorkforcePool) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IamWorkforcePool) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IamWorkforcePool) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IamWorkforcePool) ResetDescription() {
	_jsii_.InvokeVoid(
		i,
		"resetDescription",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetDisabled() {
	_jsii_.InvokeVoid(
		i,
		"resetDisabled",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetDisplayName() {
	_jsii_.InvokeVoid(
		i,
		"resetDisplayName",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetSessionDuration() {
	_jsii_.InvokeVoid(
		i,
		"resetSessionDuration",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ResetTimeouts() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeouts",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkforcePool) ToString() *string {
	var returns *string
