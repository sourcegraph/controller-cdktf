...
func (o *jsiiProxy_OrgPolicyPolicySpecOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrgPolicyPolicySpecOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
