...
type ClouddeployAutomationRulesAdvanceRolloutRule struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/clouddeploy_automation#source_phases ClouddeployAutomation#source_phases}
	SourcePhases *[]*string `field:"optional" json:"sourcePhases" yaml:"sourcePhases"`
	// Optional. How long to wait after a rollout is finished.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/clouddeploy_automation#wait ClouddeployAutomation#wait}
