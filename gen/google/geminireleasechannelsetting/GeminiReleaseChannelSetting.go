...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/gemini_release_channel_setting google_gemini_release_channel_setting}.
type GeminiReleaseChannelSetting interface {
	...
	PutTimeouts(value *GeminiReleaseChannelSettingTimeouts)
	ResetId()
	ResetLabels()
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Labels() *map[string]*string {
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Node() constructs.Node {
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) ReleaseChannel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"releaseChannel",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) ReleaseChannelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"releaseChannelInput",
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) ReleaseChannelSettingId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) ReleaseChannelSettingIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"releaseChannelSettingIdInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) Timeouts() GeminiReleaseChannelSettingTimeoutsOutputReference {
	var returns GeminiReleaseChannelSettingTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GeminiReleaseChannelSetting) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/gemini_release_channel_setting google_gemini_release_channel_setting} Resource.
func NewGeminiReleaseChannelSetting(scope constructs.Construct, id *string, config *GeminiReleaseChannelSettingConfig) GeminiReleaseChannelSetting {
	...
	if err := validateNewGeminiReleaseChannelSettingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func GeminiReleaseChannelSetting_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.geminiReleaseChannelSetting.GeminiReleaseChannelSetting",
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) MoveFromId(id *string) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) MoveToId(id *string) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) PutTimeouts(value *GeminiReleaseChannelSettingTimeouts) {
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetReleaseChannel() {
	_jsii_.InvokeVoid(
		g,
		"resetReleaseChannel",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GeminiReleaseChannelSetting) ToString() *string {
	var returns *string
