...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_resize_request google_compute_resize_request}.
type ComputeResizeRequest interface {
	...
	PutRequestedRunDuration(value *ComputeResizeRequestRequestedRunDuration)
	PutTimeouts(value *ComputeResizeRequestTimeouts)
	ResetDescription()
	ResetId()
...
func (j *jsiiProxy_ComputeResizeRequest) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_ComputeResizeRequest) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ComputeResizeRequest) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ComputeResizeRequest) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ComputeResizeRequest) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeResizeRequest) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ComputeResizeRequest) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ComputeResizeRequest) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ComputeResizeRequest) InstanceGroupManager() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeResizeRequest) InstanceGroupManagerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeResizeRequest) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ComputeResizeRequest) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ComputeResizeRequest) Node() constructs.Node {
...
func (j *jsiiProxy_ComputeResizeRequest) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ComputeResizeRequest) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputeResizeRequest) RequestedRunDuration() ComputeResizeRequestRequestedRunDurationOutputReference {
	var returns ComputeResizeRequestRequestedRunDurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeResizeRequest) RequestedRunDurationInput() *ComputeResizeRequestRequestedRunDuration {
...
func (j *jsiiProxy_ComputeResizeRequest) ResizeBy() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"resizeBy",
...
func (j *jsiiProxy_ComputeResizeRequest) ResizeByInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"resizeByInput",
...
func (j *jsiiProxy_ComputeResizeRequest) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_ComputeResizeRequest) Status() ComputeResizeRequestStatusList {
	var returns ComputeResizeRequestStatusList
	_jsii_.Get(
		j,
		"status",
		&returns,
...
func (j *jsiiProxy_ComputeResizeRequest) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeResizeRequest) Timeouts() ComputeResizeRequestTimeoutsOutputReference {
	var returns ComputeResizeRequestTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ComputeResizeRequest) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_ComputeResizeRequest) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_resize_request google_compute_resize_request} Resource.
func NewComputeResizeRequest(scope constructs.Construct, id *string, config *ComputeResizeRequestConfig) ComputeResizeRequest {
	_init_.Initialize()

	if err := validateNewComputeResizeRequestParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ComputeResizeRequest_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.computeResizeRequest.ComputeResizeRequest",
...
func (c *jsiiProxy_ComputeResizeRequest) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeResizeRequest) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ComputeResizeRequest) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ComputeResizeRequest) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ComputeResizeRequest) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ComputeResizeRequest) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ComputeResizeRequest) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ComputeResizeRequest) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ComputeResizeRequest) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeResizeRequest) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeResizeRequest) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ComputeResizeRequest) PutRequestedRunDuration(value *ComputeResizeRequestRequestedRunDuration) {
	if err := c.validatePutRequestedRunDurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ComputeResizeRequest) PutTimeouts(value *ComputeResizeRequestTimeouts) {
...
func (c *jsiiProxy_ComputeResizeRequest) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ResetRequestedRunDuration() {
	_jsii_.InvokeVoid(
		c,
		"resetRequestedRunDuration",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeResizeRequest) ToString() *string {
	var returns *string
