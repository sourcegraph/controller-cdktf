...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/secret_manager_secret_iam_member google_secret_manager_secret_iam_member}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/secret_manager_secret_iam_member google_secret_manager_secret_iam_member} Resource.
...
func SecretManagerSecretIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecretManagerSecretIamMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecretManagerSecretIamMember) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecretManagerSecretIamMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) MoveToId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecretIamMember) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecretManagerSecretIamMember) ToHclTerraform() interface{} {
	var returns interface{}
