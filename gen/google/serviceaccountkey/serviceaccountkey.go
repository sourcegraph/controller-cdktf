...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/serviceaccountkey/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/service_account_key google_service_account_key}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/service_account_key google_service_account_key} Resource.
...
func ServiceAccountKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateServiceAccountKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceAccountKey) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceAccountKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServiceAccountKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_ServiceAccountKey) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServiceAccountKey) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServiceAccountKey) MoveToId(id *string) {
...
func (s *jsiiProxy_ServiceAccountKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServiceAccountKey) ToHclTerraform() interface{} {
	var returns interface{}
