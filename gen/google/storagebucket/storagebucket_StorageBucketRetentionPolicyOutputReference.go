...
// The jsii proxy struct for StorageBucketRetentionPolicyOutputReference
type jsiiProxy_StorageBucketRetentionPolicyOutputReference struct {
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) InternalValue() *StorageBucketRetentionPolicy {
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_StorageBucketRetentionPolicyOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewStorageBucketRetentionPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageBucketRetentionPolicyOutputReference {
	...
	if err := validateNewStorageBucketRetentionPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) ResetIsLocked() {
	_jsii_.InvokeVoid(
		s,
		"resetIsLocked",
		nil, // no parameters
...
func (s *jsiiProxy_StorageBucketRetentionPolicyOutputReference) ToString() *string {
	var returns *string
