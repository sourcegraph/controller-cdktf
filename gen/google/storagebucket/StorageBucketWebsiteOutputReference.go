...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference) MainPageSuffix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mainPageSuffix",
...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference) MainPageSuffixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mainPageSuffixInput",
...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference) NotFoundPage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"notFoundPage",
...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference) NotFoundPageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"notFoundPageInput",
...
func NewStorageBucketWebsiteOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageBucketWebsiteOutputReference {
	...
	if err := validateNewStorageBucketWebsiteOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference)SetMainPageSuffix(val *string) {
...
func (j *jsiiProxy_StorageBucketWebsiteOutputReference)SetNotFoundPage(val *string) {
...
func (s *jsiiProxy_StorageBucketWebsiteOutputReference) ResetMainPageSuffix() {
	_jsii_.InvokeVoid(
		s,
		"resetMainPageSuffix",
		nil, // no parameters
...
func (s *jsiiProxy_StorageBucketWebsiteOutputReference) ResetNotFoundPage() {
	_jsii_.InvokeVoid(
		s,
		"resetNotFoundPage",
		nil, // no parameters
