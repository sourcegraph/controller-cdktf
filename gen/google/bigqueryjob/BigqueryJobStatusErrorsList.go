...
func (j *jsiiProxy_BigqueryJobStatusErrorsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BigqueryJobStatusErrorsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_BigqueryJobStatusErrorsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (b *jsiiProxy_BigqueryJobStatusErrorsList) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BigqueryJobStatusErrorsList) Get(index *float64) BigqueryJobStatusErrorsOutputReference {
	if err := b.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns BigqueryJobStatusErrorsOutputReference
...
func (b *jsiiProxy_BigqueryJobStatusErrorsList) ToString() *string {
	var returns *string
