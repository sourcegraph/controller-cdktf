...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
