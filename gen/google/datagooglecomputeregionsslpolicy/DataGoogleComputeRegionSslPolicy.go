package datagooglecomputeregionsslpolicy
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagooglecomputeregionsslpolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/compute_region_ssl_policy google_compute_region_ssl_policy}.
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) CustomFeatures() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"customFeatures",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) EnabledFeatures() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"enabledFeatures",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Fingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fingerprint",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) MinTlsVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"minTlsVersion",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Profile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"profile",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_DataGoogleComputeRegionSslPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/compute_region_ssl_policy google_compute_region_ssl_policy} Data Source.
func NewDataGoogleComputeRegionSslPolicy(scope constructs.Construct, id *string, config *DataGoogleComputeRegionSslPolicyConfig) DataGoogleComputeRegionSslPolicy {
	...
	if err := validateNewDataGoogleComputeRegionSslPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleComputeRegionSslPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleComputeRegionSslPolicy.DataGoogleComputeRegionSslPolicy",
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeRegionSslPolicy) ToString() *string {
	var returns *string
