...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/healthcare_consent_store_iam_binding google_healthcare_consent_store_iam_binding}.
type HealthcareConsentStoreIamBinding interface {
	...
	PutCondition(value *HealthcareConsentStoreIamBindingCondition)
	ResetCondition()
	ResetId()
...
type jsiiProxy_HealthcareConsentStoreIamBinding struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_HealthcareConsentStoreIamBinding) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Condition() HealthcareConsentStoreIamBindingConditionOutputReference {
	var returns HealthcareConsentStoreIamBindingConditionOutputReference
	_jsii_.Get(
		j,
		"condition",
		&returns,
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) ConditionInput() *HealthcareConsentStoreIamBindingCondition {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) ConsentStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"consentStoreId",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) ConsentStoreIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"consentStoreIdInput",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Dataset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataset",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) DatasetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetInput",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Members() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"members",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) MembersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"membersInput",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Node() constructs.Node {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_HealthcareConsentStoreIamBinding) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/healthcare_consent_store_iam_binding google_healthcare_consent_store_iam_binding} Resource.
func NewHealthcareConsentStoreIamBinding(scope constructs.Construct, id *string, config *HealthcareConsentStoreIamBindingConfig) HealthcareConsentStoreIamBinding {
	...
	if err := validateNewHealthcareConsentStoreIamBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func HealthcareConsentStoreIamBinding_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBinding",
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetStringAttribute(terraformAttribute *string) *string {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) PutCondition(value *HealthcareConsentStoreIamBindingCondition) {
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) ResetCondition() {
	_jsii_.InvokeVoid(
		h,
		"resetCondition",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) ResetId() {
	_jsii_.InvokeVoid(
		h,
		"resetId",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		h,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareConsentStoreIamBinding) ToString() *string {
	var returns *string
