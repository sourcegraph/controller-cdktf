...
type DataprocCluster interface {
	...
	PutVirtualClusterConfig(value *DataprocClusterVirtualClusterConfig)
	ResetClusterConfig()
...
func (j *jsiiProxy_DataprocCluster) GracefulDecommissionTimeout() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataprocCluster) GracefulDecommissionTimeoutInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataprocCluster) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataprocCluster) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataprocCluster) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataprocCluster) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataprocCluster) VirtualClusterConfig() DataprocClusterVirtualClusterConfigOutputReference {
	var returns DataprocClusterVirtualClusterConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataprocCluster) VirtualClusterConfigInput() *DataprocClusterVirtualClusterConfig {
...
func NewDataprocCluster(scope constructs.Construct, id *string, config *DataprocClusterConfig) DataprocCluster {
	...
	if err := validateNewDataprocClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataprocCluster{}

	_jsii_.Create(
		"google.dataprocCluster.DataprocCluster",
...
func (d *jsiiProxy_DataprocCluster) PutClusterConfig(value *DataprocClusterClusterConfig) {
	if err := d.validatePutClusterConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DataprocCluster) PutVirtualClusterConfig(value *DataprocClusterVirtualClusterConfig) {
	if err := d.validatePutVirtualClusterConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DataprocCluster) ResetClusterConfig() {
	_jsii_.InvokeVoid(
		d,
		"resetClusterConfig",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocCluster) ResetGracefulDecommissionTimeout() {
	_jsii_.InvokeVoid(
		d,
		"resetGracefulDecommissionTimeout",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocCluster) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocCluster) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocCluster) ResetVirtualClusterConfig() {
	_jsii_.InvokeVoid(
		d,
		"resetVirtualClusterConfig",
		nil, // no parameters
