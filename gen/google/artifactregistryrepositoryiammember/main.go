...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.artifactRegistryRepositoryIamMember.ArtifactRegistryRepositoryIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google.artifactRegistryRepositoryIamMember.ArtifactRegistryRepositoryIamMemberConfig",
