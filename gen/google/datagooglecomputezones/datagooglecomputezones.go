...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeZones)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeZones.DataGoogleComputeZonesConfig",
		reflect.TypeOf((*DataGoogleComputeZonesConfig)(nil)).Elem(),
	)
}
