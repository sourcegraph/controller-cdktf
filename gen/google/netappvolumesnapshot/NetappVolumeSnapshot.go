...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/netappvolumesnapshot/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/netapp_volume_snapshot google_netapp_volume_snapshot}.
...
func (j *jsiiProxy_NetappVolumeSnapshot) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_NetappVolumeSnapshot) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetappVolumeSnapshot) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetappVolumeSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Labels() *map[string]*string {
...
func (j *jsiiProxy_NetappVolumeSnapshot) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_NetappVolumeSnapshot) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_NetappVolumeSnapshot) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) Node() constructs.Node {
...
func (j *jsiiProxy_NetappVolumeSnapshot) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_NetappVolumeSnapshot) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_NetappVolumeSnapshot) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetappVolumeSnapshot) Timeouts() NetappVolumeSnapshotTimeoutsOutputReference {
	var returns NetappVolumeSnapshotTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_NetappVolumeSnapshot) UsedBytes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"usedBytes",
...
func (j *jsiiProxy_NetappVolumeSnapshot) VolumeName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"volumeName",
...
func (j *jsiiProxy_NetappVolumeSnapshot) VolumeNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"volumeNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/netapp_volume_snapshot google_netapp_volume_snapshot} Resource.
func NewNetappVolumeSnapshot(scope constructs.Construct, id *string, config *NetappVolumeSnapshotConfig) NetappVolumeSnapshot {
	_init_.Initialize()

	if err := validateNewNetappVolumeSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func NetappVolumeSnapshot_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.netappVolumeSnapshot.NetappVolumeSnapshot",
...
func (n *jsiiProxy_NetappVolumeSnapshot) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetappVolumeSnapshot) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetappVolumeSnapshot) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetappVolumeSnapshot) MoveToId(id *string) {
...
func (n *jsiiProxy_NetappVolumeSnapshot) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NetappVolumeSnapshot) PutTimeouts(value *NetappVolumeSnapshotTimeouts) {
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetDescription() {
	_jsii_.InvokeVoid(
		n,
		"resetDescription",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetLabels() {
	_jsii_.InvokeVoid(
		n,
		"resetLabels",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetProject() {
	_jsii_.InvokeVoid(
		n,
		"resetProject",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
...
func (n *jsiiProxy_NetappVolumeSnapshot) ToString() *string {
	var returns *string
