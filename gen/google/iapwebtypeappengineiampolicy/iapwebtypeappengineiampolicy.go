package iapwebtypeappengineiampolicy
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/iapwebtypeappengineiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/iap_web_type_app_engine_iam_policy google_iap_web_type_app_engine_iam_policy}.
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) AppIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appIdInput",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) PolicyDataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDataInput",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_IapWebTypeAppEngineIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/iap_web_type_app_engine_iam_policy google_iap_web_type_app_engine_iam_policy} Resource.
func NewIapWebTypeAppEngineIamPolicy(scope constructs.Construct, id *string, config *IapWebTypeAppEngineIamPolicyConfig) IapWebTypeAppEngineIamPolicy {
	...
	if err := validateNewIapWebTypeAppEngineIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_IapWebTypeAppEngineIamPolicy{}
...
func IapWebTypeAppEngineIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.iapWebTypeAppEngineIamPolicy.IapWebTypeAppEngineIamPolicy",
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) MoveFromId(id *string) {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) MoveToId(id *string) {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		i,
		"resetProject",
		nil, // no parameters
...
func (i *jsiiProxy_IapWebTypeAppEngineIamPolicy) ToString() *string {
	var returns *string
