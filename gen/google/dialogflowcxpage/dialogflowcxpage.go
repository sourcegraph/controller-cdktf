...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/dialogflow_cx_page google_dialogflow_cx_page}.
...
func (j *jsiiProxy_DialogflowCxPage) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/dialogflow_cx_page google_dialogflow_cx_page} Resource.
...
func (j *jsiiProxy_DialogflowCxPage)SetCount(val interface{}) {
...
func DialogflowCxPage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDialogflowCxPage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DialogflowCxPage_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDialogflowCxPage_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DialogflowCxPage_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateDialogflowCxPage_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DialogflowCxPage) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DialogflowCxPage) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DialogflowCxPage) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DialogflowCxPage) MoveFromId(id *string) {
...
func (d *jsiiProxy_DialogflowCxPage) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DialogflowCxPage) MoveToId(id *string) {
...
func (d *jsiiProxy_DialogflowCxPage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DialogflowCxPage) ToHclTerraform() interface{} {
	var returns interface{}
