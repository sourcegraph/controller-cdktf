...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/data-sources/service_accounts google_service_accounts}.
...
func (j *jsiiProxy_DataGoogleServiceAccounts) Accounts() DataGoogleServiceAccountsAccountsList {
	var returns DataGoogleServiceAccountsAccountsList
	_jsii_.Get(
		j,
		"accounts",
		&returns,
...
func (j *jsiiProxy_DataGoogleServiceAccounts) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleServiceAccounts) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleServiceAccounts) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/data-sources/service_accounts google_service_accounts} Data Source.
func NewDataGoogleServiceAccounts(scope constructs.Construct, id *string, config *DataGoogleServiceAccountsConfig) DataGoogleServiceAccounts {
	...
	if err := validateNewDataGoogleServiceAccountsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleServiceAccounts_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleServiceAccounts.DataGoogleServiceAccounts",
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleServiceAccounts) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleServiceAccounts) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleServiceAccounts) ToString() *string {
	var returns *string
