...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/vertex_ai_index_endpoint google_vertex_ai_index_endpoint}.
...
type jsiiProxy_VertexAiIndexEndpoint struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_VertexAiIndexEndpoint) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Labels() *map[string]*string {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Node() constructs.Node {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VertexAiIndexEndpoint) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_VertexAiIndexEndpoint) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiIndexEndpoint) Timeouts() VertexAiIndexEndpointTimeoutsOutputReference {
	var returns VertexAiIndexEndpointTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VertexAiIndexEndpoint) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/vertex_ai_index_endpoint google_vertex_ai_index_endpoint} Resource.
func NewVertexAiIndexEndpoint(scope constructs.Construct, id *string, config *VertexAiIndexEndpointConfig) VertexAiIndexEndpoint {
	...
	if err := validateNewVertexAiIndexEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VertexAiIndexEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVertexAiIndexEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VertexAiIndexEndpoint_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.vertexAiIndexEndpoint.VertexAiIndexEndpoint",
...
func (v *jsiiProxy_VertexAiIndexEndpoint) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) MoveFromId(id *string) {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) MoveToId(id *string) {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetDescription() {
	_jsii_.InvokeVoid(
		v,
		"resetDescription",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetNetwork() {
	_jsii_.InvokeVoid(
		v,
		"resetNetwork",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetProject() {
	_jsii_.InvokeVoid(
		v,
		"resetProject",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiIndexEndpoint) ToString() *string {
	var returns *string
