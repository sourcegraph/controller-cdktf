...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/firestore_index google_firestore_index}.
...
func (j *jsiiProxy_FirestoreIndex) Collection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collection",
...
func (j *jsiiProxy_FirestoreIndex) CollectionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collectionInput",
...
func (j *jsiiProxy_FirestoreIndex) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_FirestoreIndex) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_FirestoreIndex) Fields() FirestoreIndexFieldsList {
	var returns FirestoreIndexFieldsList
	_jsii_.Get(
		j,
		"fields",
		&returns,
...
func (j *jsiiProxy_FirestoreIndex) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_FirestoreIndex) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirestoreIndex) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_FirestoreIndex) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_FirestoreIndex) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_FirestoreIndex) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FirestoreIndex) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_FirestoreIndex) Node() constructs.Node {
...
func (j *jsiiProxy_FirestoreIndex) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_FirestoreIndex) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_FirestoreIndex) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_FirestoreIndex) QueryScope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryScope",
...
func (j *jsiiProxy_FirestoreIndex) QueryScopeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryScopeInput",
...
func (j *jsiiProxy_FirestoreIndex) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirestoreIndex) Timeouts() FirestoreIndexTimeoutsOutputReference {
	var returns FirestoreIndexTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/firestore_index google_firestore_index} Resource.
func NewFirestoreIndex(scope constructs.Construct, id *string, config *FirestoreIndexConfig) FirestoreIndex {
	_init_.Initialize()

	if err := validateNewFirestoreIndexParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func FirestoreIndex_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateFirestoreIndex_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirestoreIndex) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FirestoreIndex) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirestoreIndex) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FirestoreIndex) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FirestoreIndex) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FirestoreIndex) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FirestoreIndex) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FirestoreIndex) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FirestoreIndex) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FirestoreIndex) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FirestoreIndex) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirestoreIndex) MoveFromId(id *string) {
...
func (f *jsiiProxy_FirestoreIndex) MoveToId(id *string) {
...
func (f *jsiiProxy_FirestoreIndex) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_FirestoreIndex) PutTimeouts(value *FirestoreIndexTimeouts) {
...
func (f *jsiiProxy_FirestoreIndex) ResetDatabase() {
	_jsii_.InvokeVoid(
		f,
		"resetDatabase",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreIndex) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		f,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreIndex) ResetProject() {
	_jsii_.InvokeVoid(
		f,
		"resetProject",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreIndex) ResetQueryScope() {
	_jsii_.InvokeVoid(
		f,
		"resetQueryScope",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreIndex) ToString() *string {
	var returns *string
