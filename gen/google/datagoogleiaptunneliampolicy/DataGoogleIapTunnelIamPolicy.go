...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagoogleiaptunneliampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/iap_tunnel_iam_policy google_iap_tunnel_iam_policy}.
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleIapTunnelIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/iap_tunnel_iam_policy google_iap_tunnel_iam_policy} Data Source.
func NewDataGoogleIapTunnelIamPolicy(scope constructs.Construct, id *string, config *DataGoogleIapTunnelIamPolicyConfig) DataGoogleIapTunnelIamPolicy {
	...
	if err := validateNewDataGoogleIapTunnelIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleIapTunnelIamPolicy{}

	_jsii_.Create(
		"@cdktf/provider-google.dataGoogleIapTunnelIamPolicy.DataGoogleIapTunnelIamPolicy",
...
func DataGoogleIapTunnelIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleIapTunnelIamPolicy.DataGoogleIapTunnelIamPolicy",
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleIapTunnelIamPolicy) ToString() *string {
	var returns *string
