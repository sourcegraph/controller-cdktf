...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.cloudbuildWorkerPool.CloudbuildWorkerPoolNetworkConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peeredNetworkIpRange", GoGetter: "PeeredNetworkIpRange"},
			_jsii_.MemberProperty{JsiiProperty: "peeredNetworkIpRangeInput", GoGetter: "PeeredNetworkIpRangeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPeeredNetworkIpRange", GoMethod: "ResetPeeredNetworkIpRange"},
	...
	_jsii_.RegisterStruct(
		"google.cloudbuildWorkerPool.CloudbuildWorkerPoolTimeouts",
		reflect.TypeOf((*CloudbuildWorkerPoolTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.cloudbuildWorkerPool.CloudbuildWorkerPoolTimeoutsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.cloudbuildWorkerPool.CloudbuildWorkerPoolWorkerConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "noExternalIp", GoGetter: "NoExternalIp"},
			_jsii_.MemberProperty{JsiiProperty: "noExternalIpInput", GoGetter: "NoExternalIpInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNoExternalIp", GoMethod: "ResetNoExternalIp"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
