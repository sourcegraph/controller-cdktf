...
type HealthcareFhirStoreNotificationConfigsList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for HealthcareFhirStoreNotificationConfigsList
type jsiiProxy_HealthcareFhirStoreNotificationConfigsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewHealthcareFhirStoreNotificationConfigsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HealthcareFhirStoreNotificationConfigsList {
	...
	if err := validateNewHealthcareFhirStoreNotificationConfigsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) ComputeFqn() *string {
	var returns *string
...
func (h *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) Get(index *float64) HealthcareFhirStoreNotificationConfigsOutputReference {
	if err := h.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns HealthcareFhirStoreNotificationConfigsOutputReference
...
func (h *jsiiProxy_HealthcareFhirStoreNotificationConfigsList) ToString() *string {
	var returns *string
