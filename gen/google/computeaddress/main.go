...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv6EndpointType", GoGetter: "Ipv6EndpointType"},
			_jsii_.MemberProperty{JsiiProperty: "ipv6EndpointTypeInput", GoGetter: "Ipv6EndpointTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpv6EndpointType", GoMethod: "ResetIpv6EndpointType"},
