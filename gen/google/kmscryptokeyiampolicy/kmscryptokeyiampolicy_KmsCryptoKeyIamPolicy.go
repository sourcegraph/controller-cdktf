...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/kmscryptokeyiampolicy/internal"
)
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy) Connection() interface{} {
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy)SetConnection(val interface{}) {
...
func (j *jsiiProxy_KmsCryptoKeyIamPolicy)SetProvisioners(val *[]interface{}) {
...
func KmsCryptoKeyIamPolicy_IsConstruct(x interface{}) *bool {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) AddOverride(path *string, value interface{}) {
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) ToMetadata() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) ToTerraform() interface{} {
	var returns interface{}
