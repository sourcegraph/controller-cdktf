package dataprocmetastoreserviceiampolicy
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/dataprocmetastoreserviceiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/dataproc_metastore_service_iam_policy google_dataproc_metastore_service_iam_policy}.
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) PolicyDataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDataInput",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) ServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceId",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) ServiceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceIdInput",
...
func (j *jsiiProxy_DataprocMetastoreServiceIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/dataproc_metastore_service_iam_policy google_dataproc_metastore_service_iam_policy} Resource.
func NewDataprocMetastoreServiceIamPolicy(scope constructs.Construct, id *string, config *DataprocMetastoreServiceIamPolicyConfig) DataprocMetastoreServiceIamPolicy {
	...
	if err := validateNewDataprocMetastoreServiceIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataprocMetastoreServiceIamPolicy{}
...
func DataprocMetastoreServiceIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataprocMetastoreServiceIamPolicy.DataprocMetastoreServiceIamPolicy",
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) MoveToId(id *string) {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataprocMetastoreServiceIamPolicy) ToString() *string {
	var returns *string
