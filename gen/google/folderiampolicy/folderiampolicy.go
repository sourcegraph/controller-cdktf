...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/folderiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/resources/folder_iam_policy google_folder_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/resources/folder_iam_policy google_folder_iam_policy} Resource.
func NewFolderIamPolicy(scope constructs.Construct, id *string, config *FolderIamPolicyConfig) FolderIamPolicy {
	...
	_jsii_.Create(
		"google.folderIamPolicy.FolderIamPolicy",
