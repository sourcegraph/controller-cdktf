...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/firebaseappcheckrecaptchaenterpriseconfig/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/firebase_app_check_recaptcha_enterprise_config google_firebase_app_check_recaptcha_enterprise_config}.
type FirebaseAppCheckRecaptchaEnterpriseConfig interface {
	...
	PutTimeouts(value *FirebaseAppCheckRecaptchaEnterpriseConfigTimeouts)
	ResetId()
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) AppIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appIdInput",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Node() constructs.Node {
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) SiteKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteKey",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) SiteKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteKeyInput",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) Timeouts() FirebaseAppCheckRecaptchaEnterpriseConfigTimeoutsOutputReference {
	var returns FirebaseAppCheckRecaptchaEnterpriseConfigTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) TokenTtl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenTtl",
...
func (j *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) TokenTtlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenTtlInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/firebase_app_check_recaptcha_enterprise_config google_firebase_app_check_recaptcha_enterprise_config} Resource.
func NewFirebaseAppCheckRecaptchaEnterpriseConfig(scope constructs.Construct, id *string, config *FirebaseAppCheckRecaptchaEnterpriseConfigConfig) FirebaseAppCheckRecaptchaEnterpriseConfig {
	...
	if err := validateNewFirebaseAppCheckRecaptchaEnterpriseConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig{}
...
func FirebaseAppCheckRecaptchaEnterpriseConfig_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.firebaseAppCheckRecaptchaEnterpriseConfig.FirebaseAppCheckRecaptchaEnterpriseConfig",
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) MoveFromId(id *string) {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) MoveToId(id *string) {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) OverrideLogicalId(newLogicalId *string) {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) PutTimeouts(value *FirebaseAppCheckRecaptchaEnterpriseConfigTimeouts) {
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ResetId() {
	_jsii_.InvokeVoid(
		f,
		"resetId",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		f,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ResetProject() {
	_jsii_.InvokeVoid(
		f,
		"resetProject",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ResetTimeouts() {
	_jsii_.InvokeVoid(
		f,
		"resetTimeouts",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ResetTokenTtl() {
	_jsii_.InvokeVoid(
		f,
		"resetTokenTtl",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaseAppCheckRecaptchaEnterpriseConfig) ToString() *string {
	var returns *string
