...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeRegionSslPolicy.ComputeRegionSslPolicyConfig",
		reflect.TypeOf((*ComputeRegionSslPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computeRegionSslPolicy.ComputeRegionSslPolicyTimeouts",
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ComputeRegionSslPolicyTimeoutsOutputReference{}
