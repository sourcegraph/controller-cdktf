...
func (j *jsiiProxy_ComputeFirewallPolicyRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ComputeFirewallPolicyRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeFirewallPolicyRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ComputeFirewallPolicyRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeFirewallPolicyRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ComputeFirewallPolicyRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func NewComputeFirewallPolicyRule(scope constructs.Construct, id *string, config *ComputeFirewallPolicyRuleConfig) ComputeFirewallPolicyRule {
	...
	_jsii_.Create(
		"google.computeFirewallPolicyRule.ComputeFirewallPolicyRule",
...
func (j *jsiiProxy_ComputeFirewallPolicyRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (c *jsiiProxy_ComputeFirewallPolicyRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeFirewallPolicyRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
