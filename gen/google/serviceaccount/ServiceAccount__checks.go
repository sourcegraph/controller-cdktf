...
func (j *jsiiProxy_ServiceAccount) validateSetAccountIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ServiceAccount) validateSetDisabledParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_ServiceAccount) validateSetDisplayNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ServiceAccount) validateSetProjectParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
