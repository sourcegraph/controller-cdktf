...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/resources/dns_response_policy_rule google_dns_response_policy_rule} Resource.
func NewDnsResponsePolicyRule(scope constructs.Construct, id *string, config *DnsResponsePolicyRuleConfig) DnsResponsePolicyRule {
	...
	_jsii_.Create(
		"google.dnsResponsePolicyRule.DnsResponsePolicyRule",
