...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/dns_response_policy_rule google_dns_response_policy_rule}.
type DnsResponsePolicyRule interface {
	...
	PutLocalData(value *DnsResponsePolicyRuleLocalData)
	PutTimeouts(value *DnsResponsePolicyRuleTimeouts)
	ResetId()
	ResetLocalData()
...
func (j *jsiiProxy_DnsResponsePolicyRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DnsResponsePolicyRule) DnsName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsName",
...
func (j *jsiiProxy_DnsResponsePolicyRule) DnsNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsNameInput",
...
func (j *jsiiProxy_DnsResponsePolicyRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DnsResponsePolicyRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DnsResponsePolicyRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DnsResponsePolicyRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DnsResponsePolicyRule) LocalData() DnsResponsePolicyRuleLocalDataOutputReference {
	var returns DnsResponsePolicyRuleLocalDataOutputReference
	_jsii_.Get(
		j,
		"localData",
		&returns,
...
func (j *jsiiProxy_DnsResponsePolicyRule) LocalDataInput() *DnsResponsePolicyRuleLocalData {
...
func (j *jsiiProxy_DnsResponsePolicyRule) Node() constructs.Node {
...
func (j *jsiiProxy_DnsResponsePolicyRule) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DnsResponsePolicyRule) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DnsResponsePolicyRule) ResponsePolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responsePolicy",
...
func (j *jsiiProxy_DnsResponsePolicyRule) ResponsePolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"responsePolicyInput",
...
func (j *jsiiProxy_DnsResponsePolicyRule) RuleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleName",
...
func (j *jsiiProxy_DnsResponsePolicyRule) RuleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleNameInput",
...
func (j *jsiiProxy_DnsResponsePolicyRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsResponsePolicyRule) Timeouts() DnsResponsePolicyRuleTimeoutsOutputReference {
	var returns DnsResponsePolicyRuleTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/dns_response_policy_rule google_dns_response_policy_rule} Resource.
func NewDnsResponsePolicyRule(scope constructs.Construct, id *string, config *DnsResponsePolicyRuleConfig) DnsResponsePolicyRule {
	...
	if err := validateNewDnsResponsePolicyRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/dns_response_policy_rule google_dns_response_policy_rule} Resource.
func NewDnsResponsePolicyRule_Override(d DnsResponsePolicyRule, scope constructs.Construct, id *string, config *DnsResponsePolicyRuleConfig) {
	_init_.Initialize()
...
func DnsResponsePolicyRule_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dnsResponsePolicyRule.DnsResponsePolicyRule",
...
func (d *jsiiProxy_DnsResponsePolicyRule) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DnsResponsePolicyRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DnsResponsePolicyRule) MoveFromId(id *string) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) MoveToId(id *string) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) PutLocalData(value *DnsResponsePolicyRuleLocalData) {
	if err := d.validatePutLocalDataParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DnsResponsePolicyRule) PutTimeouts(value *DnsResponsePolicyRuleTimeouts) {
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetLocalData() {
	_jsii_.InvokeVoid(
		d,
		"resetLocalData",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DnsResponsePolicyRule) ToString() *string {
	var returns *string
