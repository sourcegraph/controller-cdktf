...
func (j *jsiiProxy_NotebooksInstanceIamMember) Connection() interface{} {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_NotebooksInstanceIamMember) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NotebooksInstanceIamMember) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_NotebooksInstanceIamMember) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_NotebooksInstanceIamMember) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://www.terraform.io/docs/providers/google/r/notebooks_instance_iam_member google_notebooks_instance_iam_member} Resource.
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetConnection(val interface{}) {
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_NotebooksInstanceIamMember)SetProvisioners(val *[]interface{}) {
...
func NotebooksInstanceIamMember_IsConstruct(x interface{}) *bool {
	_init_.Initialize()
...
func (n *jsiiProxy_NotebooksInstanceIamMember) AddOverride(path *string, value interface{}) {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (n *jsiiProxy_NotebooksInstanceIamMember) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NotebooksInstanceIamMember) ToMetadata() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NotebooksInstanceIamMember) ToTerraform() interface{} {
	var returns interface{}
