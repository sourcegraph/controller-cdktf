...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) InternalValue() interface{} {
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) Get(index *float64) AssuredWorkloadsWorkloadResourceSettingsOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns AssuredWorkloadsWorkloadResourceSettingsOutputReference
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadResourceSettingsList) ToString() *string {
	var returns *string
