...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/loggingprojectsink/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/logging_project_sink google_logging_project_sink}.
type LoggingProjectSink interface {
	cdktf.TerraformResource
	BigqueryOptions() LoggingProjectSinkBigqueryOptionsOutputReference
	BigqueryOptionsInput() *LoggingProjectSinkBigqueryOptions
	// Experimental.
...
type jsiiProxy_LoggingProjectSink struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_LoggingProjectSink) BigqueryOptions() LoggingProjectSinkBigqueryOptionsOutputReference {
	var returns LoggingProjectSinkBigqueryOptionsOutputReference
	_jsii_.Get(
		j,
		"bigqueryOptions",
		&returns,
...
func (j *jsiiProxy_LoggingProjectSink) BigqueryOptionsInput() *LoggingProjectSinkBigqueryOptions {
	var returns *LoggingProjectSinkBigqueryOptions
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingProjectSink) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LoggingProjectSink) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingProjectSink) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LoggingProjectSink) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LoggingProjectSink) Destination() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destination",
...
func (j *jsiiProxy_LoggingProjectSink) DestinationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destinationInput",
...
func (j *jsiiProxy_LoggingProjectSink) Exclusions() LoggingProjectSinkExclusionsList {
	var returns LoggingProjectSinkExclusionsList
	_jsii_.Get(
		j,
		"exclusions",
		&returns,
...
func (j *jsiiProxy_LoggingProjectSink) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_LoggingProjectSink) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_LoggingProjectSink) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LoggingProjectSink) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingProjectSink) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingProjectSink) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingProjectSink) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingProjectSink) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LoggingProjectSink) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingProjectSink) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LoggingProjectSink) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingProjectSink) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_LoggingProjectSink) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_LoggingProjectSink) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LoggingProjectSink) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LoggingProjectSink) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingProjectSink) WriterIdentity() *string {
	var returns *string
	_jsii_.Get(
		j,
		"writerIdentity",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/logging_project_sink google_logging_project_sink} Resource.
func NewLoggingProjectSink(scope constructs.Construct, id *string, config *LoggingProjectSinkConfig) LoggingProjectSink {
	_init_.Initialize()

	if err := validateNewLoggingProjectSinkParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoggingProjectSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLoggingProjectSink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LoggingProjectSink) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingProjectSink) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoggingProjectSink) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingProjectSink) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingProjectSink) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingProjectSink) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingProjectSink) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingProjectSink) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingProjectSink) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingProjectSink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LoggingProjectSink) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoggingProjectSink) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingProjectSink) MoveToId(id *string) {
...
func (l *jsiiProxy_LoggingProjectSink) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingProjectSink) PutBigqueryOptions(value *LoggingProjectSinkBigqueryOptions) {
...
func (l *jsiiProxy_LoggingProjectSink) ResetBigqueryOptions() {
	_jsii_.InvokeVoid(
		l,
		"resetBigqueryOptions",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetDisabled() {
	_jsii_.InvokeVoid(
		l,
		"resetDisabled",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetExclusions() {
	_jsii_.InvokeVoid(
		l,
		"resetExclusions",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetFilter() {
	_jsii_.InvokeVoid(
		l,
		"resetFilter",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetProject() {
	_jsii_.InvokeVoid(
		l,
		"resetProject",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ResetUniqueWriterIdentity() {
	_jsii_.InvokeVoid(
		l,
		"resetUniqueWriterIdentity",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectSink) ToString() *string {
	var returns *string
