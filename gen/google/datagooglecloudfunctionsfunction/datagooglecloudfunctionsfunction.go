...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/cloudfunctions_function google_cloudfunctions_function}.
...
func (j *jsiiProxy_DataGoogleCloudfunctionsFunction) VersionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/cloudfunctions_function google_cloudfunctions_function} Data Source.
...
func DataGoogleCloudfunctionsFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleCloudfunctionsFunction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
