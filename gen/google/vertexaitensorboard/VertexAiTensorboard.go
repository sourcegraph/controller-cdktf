...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/vertex_ai_tensorboard google_vertex_ai_tensorboard}.
...
func (j *jsiiProxy_VertexAiTensorboard) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_VertexAiTensorboard) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VertexAiTensorboard) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_VertexAiTensorboard) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_VertexAiTensorboard) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_VertexAiTensorboard) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_VertexAiTensorboard) EncryptionSpec() VertexAiTensorboardEncryptionSpecOutputReference {
	var returns VertexAiTensorboardEncryptionSpecOutputReference
	_jsii_.Get(
		j,
		"encryptionSpec",
		&returns,
...
func (j *jsiiProxy_VertexAiTensorboard) EncryptionSpecInput() *VertexAiTensorboardEncryptionSpec {
...
func (j *jsiiProxy_VertexAiTensorboard) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiTensorboard) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VertexAiTensorboard) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VertexAiTensorboard) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VertexAiTensorboard) Labels() *map[string]*string {
...
func (j *jsiiProxy_VertexAiTensorboard) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_VertexAiTensorboard) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VertexAiTensorboard) Node() constructs.Node {
...
func (j *jsiiProxy_VertexAiTensorboard) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_VertexAiTensorboard) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_VertexAiTensorboard) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VertexAiTensorboard) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VertexAiTensorboard) RunCount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runCount",
...
func (j *jsiiProxy_VertexAiTensorboard) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiTensorboard) Timeouts() VertexAiTensorboardTimeoutsOutputReference {
	var returns VertexAiTensorboardTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VertexAiTensorboard) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/vertex_ai_tensorboard google_vertex_ai_tensorboard} Resource.
func NewVertexAiTensorboard(scope constructs.Construct, id *string, config *VertexAiTensorboardConfig) VertexAiTensorboard {
	_init_.Initialize()

	if err := validateNewVertexAiTensorboardParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VertexAiTensorboard_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.vertexAiTensorboard.VertexAiTensorboard",
...
func (v *jsiiProxy_VertexAiTensorboard) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VertexAiTensorboard) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiTensorboard) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiTensorboard) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiTensorboard) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiTensorboard) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiTensorboard) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiTensorboard) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiTensorboard) MoveFromId(id *string) {
...
func (v *jsiiProxy_VertexAiTensorboard) MoveToId(id *string) {
...
func (v *jsiiProxy_VertexAiTensorboard) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VertexAiTensorboard) PutEncryptionSpec(value *VertexAiTensorboardEncryptionSpec) {
...
func (v *jsiiProxy_VertexAiTensorboard) PutTimeouts(value *VertexAiTensorboardTimeouts) {
...
func (v *jsiiProxy_VertexAiTensorboard) ResetDescription() {
	_jsii_.InvokeVoid(
		v,
		"resetDescription",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetEncryptionSpec() {
	_jsii_.InvokeVoid(
		v,
		"resetEncryptionSpec",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetProject() {
	_jsii_.InvokeVoid(
		v,
		"resetProject",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiTensorboard) ToString() *string {
	var returns *string
