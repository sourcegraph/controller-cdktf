...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/cloud_tasks_queue_iam_binding google_cloud_tasks_queue_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/cloud_tasks_queue_iam_binding google_cloud_tasks_queue_iam_binding} Resource.
...
func CloudTasksQueueIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudTasksQueueIamBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudTasksQueueIamBinding) ToHclTerraform() interface{} {
	var returns interface{}
