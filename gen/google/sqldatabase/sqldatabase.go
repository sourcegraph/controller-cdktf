...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/sqldatabase/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/resources/sql_database google_sql_database}.
...
func (j *jsiiProxy_SqlDatabase) Charset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"charset",
...
func (j *jsiiProxy_SqlDatabase) CharsetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"charsetInput",
...
func (j *jsiiProxy_SqlDatabase) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SqlDatabase) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_SqlDatabase) Instance() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instance",
...
func (j *jsiiProxy_SqlDatabase) InstanceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceInput",
...
func (j *jsiiProxy_SqlDatabase) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_SqlDatabase) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_SqlDatabase) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/resources/sql_database google_sql_database} Resource.
func NewSqlDatabase(scope constructs.Construct, id *string, config *SqlDatabaseConfig) SqlDatabase {
	...
	_jsii_.Create(
		"google.sqlDatabase.SqlDatabase",
...
func (s *jsiiProxy_SqlDatabase) ResetCharset() {
	_jsii_.InvokeVoid(
		s,
		"resetCharset",
		nil, // no parameters
...
func (s *jsiiProxy_SqlDatabase) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (s *jsiiProxy_SqlDatabase) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
