...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_instance_group google_compute_instance_group}.
...
func (j *jsiiProxy_ComputeInstanceGroup) Instances() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"instances",
...
func (j *jsiiProxy_ComputeInstanceGroup) InstancesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"instancesInput",
...
func (j *jsiiProxy_ComputeInstanceGroup) NamedPort() ComputeInstanceGroupNamedPortList {
	var returns ComputeInstanceGroupNamedPortList
	_jsii_.Get(
		j,
		"namedPort",
		&returns,
...
func (j *jsiiProxy_ComputeInstanceGroup) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_ComputeInstanceGroup) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_ComputeInstanceGroup) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ComputeInstanceGroup) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputeInstanceGroup) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_ComputeInstanceGroup) Size() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"size",
...
func (j *jsiiProxy_ComputeInstanceGroup) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_ComputeInstanceGroup) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_instance_group google_compute_instance_group} Resource.
func NewComputeInstanceGroup(scope constructs.Construct, id *string, config *ComputeInstanceGroupConfig) ComputeInstanceGroup {
	_init_.Initialize()

	if err := validateNewComputeInstanceGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ComputeInstanceGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeInstanceGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeInstanceGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeInstanceGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeInstanceGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeInstanceGroup) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeInstanceGroup) ResetInstances() {
	_jsii_.InvokeVoid(
		c,
		"resetInstances",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceGroup) ResetNamedPort() {
	_jsii_.InvokeVoid(
		c,
		"resetNamedPort",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceGroup) ResetNetwork() {
	_jsii_.InvokeVoid(
		c,
		"resetNetwork",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceGroup) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceGroup) ResetZone() {
	_jsii_.InvokeVoid(
		c,
		"resetZone",
		nil, // no parameters
