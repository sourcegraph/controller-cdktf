...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) AnimationFade() TranscoderJobConfigOverlaysAnimationsAnimationFadeOutputReference {
	var returns TranscoderJobConfigOverlaysAnimationsAnimationFadeOutputReference
	_jsii_.Get(
		j,
		"animationFade",
		&returns,
...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) AnimationFadeInput() *TranscoderJobConfigOverlaysAnimationsAnimationFade {
...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) PutAnimationFade(value *TranscoderJobConfigOverlaysAnimationsAnimationFade) {
	if err := t.validatePutAnimationFadeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) ResetAnimationFade() {
	_jsii_.InvokeVoid(
		t,
		"resetAnimationFade",
		nil, // no parameters
...
func (t *jsiiProxy_TranscoderJobConfigOverlaysAnimationsOutputReference) ToString() *string {
	var returns *string
