...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList {
	_init_.Initialize()
...
func NewDataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList_Override(d DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBackupDrDataSourceBackupConfigInfoGcpBackupConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
