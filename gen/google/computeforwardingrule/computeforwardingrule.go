...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_forwarding_rule google_compute_forwarding_rule}.
...
func (j *jsiiProxy_ComputeForwardingRule) ForwardingRuleId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"forwardingRuleId",
...
func (j *jsiiProxy_ComputeForwardingRule) IpCollection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCollection",
...
func (j *jsiiProxy_ComputeForwardingRule) IpCollectionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCollectionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_forwarding_rule google_compute_forwarding_rule} Resource.
...
func (c *jsiiProxy_ComputeForwardingRule) ResetIpCollection() {
	_jsii_.InvokeVoid(
		c,
		"resetIpCollection",
		nil, // no parameters
