...
func (j *jsiiProxy_DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePubsubSubscriptionCloudStorageConfigAvroConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
