...
// Generates CDKTF code for importing a GameServicesGameServerConfig resource upon running "cdktf plan <stack-name>".
func GameServicesGameServerConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGameServicesGameServerConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GameServicesGameServerConfig) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GameServicesGameServerConfig) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GameServicesGameServerConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GameServicesGameServerConfig) MoveFromId(id *string) {
...
func (g *jsiiProxy_GameServicesGameServerConfig) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GameServicesGameServerConfig) MoveToId(id *string) {
