...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/containerregistry/internal"
)
...
func (j *jsiiProxy_ContainerRegistry) BucketSelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketSelfLink",
...
func (j *jsiiProxy_ContainerRegistry) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ContainerRegistry) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func NewContainerRegistry(scope constructs.Construct, id *string, config *ContainerRegistryConfig) ContainerRegistry {
	...
	_jsii_.Create(
		"google.containerRegistry.ContainerRegistry",
...
func (c *jsiiProxy_ContainerRegistry) ResetLocation() {
	_jsii_.InvokeVoid(
		c,
		"resetLocation",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerRegistry) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
