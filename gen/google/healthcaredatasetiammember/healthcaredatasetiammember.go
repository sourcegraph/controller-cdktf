...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/healthcare_dataset_iam_member google_healthcare_dataset_iam_member}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/healthcare_dataset_iam_member google_healthcare_dataset_iam_member} Resource.
...
func HealthcareDatasetIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateHealthcareDatasetIamMember_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HealthcareDatasetIamMember) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) HasResourceMove() interface{} {
	var returns interface{}
...
func (h *jsiiProxy_HealthcareDatasetIamMember) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) MoveFromId(id *string) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) MoveTo(moveTarget *string, index interface{}) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) MoveToId(id *string) {
...
func (h *jsiiProxy_HealthcareDatasetIamMember) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HealthcareDatasetIamMember) ToHclTerraform() interface{} {
	var returns interface{}
