...
type BackupDrBackupPlanBackupRulesOutputReference interface {
	...
	RuleIdInput() *string
	StandardSchedule() BackupDrBackupPlanBackupRulesStandardScheduleOutputReference
	StandardScheduleInput() *BackupDrBackupPlanBackupRulesStandardSchedule
	// Experimental.
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) BackupRetentionDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) RuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleId",
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) RuleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleIdInput",
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) StandardSchedule() BackupDrBackupPlanBackupRulesStandardScheduleOutputReference {
	var returns BackupDrBackupPlanBackupRulesStandardScheduleOutputReference
	_jsii_.Get(
		j,
		"standardSchedule",
		&returns,
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) StandardScheduleInput() *BackupDrBackupPlanBackupRulesStandardSchedule {
...
func (j *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) PutStandardSchedule(value *BackupDrBackupPlanBackupRulesStandardSchedule) {
	if err := b.validatePutStandardScheduleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BackupDrBackupPlanBackupRulesOutputReference) ToString() *string {
	var returns *string
