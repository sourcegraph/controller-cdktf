...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/backup_dr_backup_plan google_backup_dr_backup_plan}.
...
type jsiiProxy_BackupDrBackupPlan struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_BackupDrBackupPlan) BackupPlanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupPlanId",
...
func (j *jsiiProxy_BackupDrBackupPlan) BackupPlanIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupPlanIdInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) BackupRules() BackupDrBackupPlanBackupRulesList {
	var returns BackupDrBackupPlanBackupRulesList
	_jsii_.Get(
		j,
		"backupRules",
		&returns,
...
func (j *jsiiProxy_BackupDrBackupPlan) BackupVault() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupVault",
...
func (j *jsiiProxy_BackupDrBackupPlan) BackupVaultInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupVaultInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) BackupVaultServiceAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupDrBackupPlan) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BackupDrBackupPlan) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_BackupDrBackupPlan) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BackupDrBackupPlan) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_BackupDrBackupPlan) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BackupDrBackupPlan) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BackupDrBackupPlan) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BackupDrBackupPlan) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupDrBackupPlan) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_BackupDrBackupPlan) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) Node() constructs.Node {
...
func (j *jsiiProxy_BackupDrBackupPlan) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_BackupDrBackupPlan) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BackupDrBackupPlan) ResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceType",
...
func (j *jsiiProxy_BackupDrBackupPlan) ResourceTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceTypeInput",
...
func (j *jsiiProxy_BackupDrBackupPlan) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupDrBackupPlan) Timeouts() BackupDrBackupPlanTimeoutsOutputReference {
	var returns BackupDrBackupPlanTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_BackupDrBackupPlan) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/backup_dr_backup_plan google_backup_dr_backup_plan} Resource.
func NewBackupDrBackupPlan(scope constructs.Construct, id *string, config *BackupDrBackupPlanConfig) BackupDrBackupPlan {
	_init_.Initialize()

	if err := validateNewBackupDrBackupPlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func BackupDrBackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBackupDrBackupPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BackupDrBackupPlan_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.backupDrBackupPlan.BackupDrBackupPlan",
...
func (b *jsiiProxy_BackupDrBackupPlan) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BackupDrBackupPlan) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BackupDrBackupPlan) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BackupDrBackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupDrBackupPlan) MoveFromId(id *string) {
...
func (b *jsiiProxy_BackupDrBackupPlan) MoveToId(id *string) {
...
func (b *jsiiProxy_BackupDrBackupPlan) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BackupDrBackupPlan) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		b,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (b *jsiiProxy_BackupDrBackupPlan) ResetProject() {
	_jsii_.InvokeVoid(
		b,
		"resetProject",
		nil, // no parameters
...
func (b *jsiiProxy_BackupDrBackupPlan) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
...
func (b *jsiiProxy_BackupDrBackupPlan) ToString() *string {
	var returns *string
