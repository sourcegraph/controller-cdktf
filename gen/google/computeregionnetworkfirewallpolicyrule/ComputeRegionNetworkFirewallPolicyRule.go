...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_region_network_firewall_policy_rule google_compute_region_network_firewall_policy_rule}.
...
func (j *jsiiProxy_ComputeRegionNetworkFirewallPolicyRule) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_region_network_firewall_policy_rule google_compute_region_network_firewall_policy_rule} Resource.
...
func (c *jsiiProxy_ComputeRegionNetworkFirewallPolicyRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeRegionNetworkFirewallPolicyRule) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeRegionNetworkFirewallPolicyRule) MoveToId(id *string) {
