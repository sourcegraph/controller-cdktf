...
func init() {
	_jsii_.RegisterClass(
		"google.cloudbuildv2ConnectionIamMember.Cloudbuildv2ConnectionIamMember",
		reflect.TypeOf((*Cloudbuildv2ConnectionIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Cloudbuildv2ConnectionIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"google.cloudbuildv2ConnectionIamMember.Cloudbuildv2ConnectionIamMemberCondition",
		reflect.TypeOf((*Cloudbuildv2ConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.cloudbuildv2ConnectionIamMember.Cloudbuildv2ConnectionIamMemberConditionOutputReference",
		reflect.TypeOf((*Cloudbuildv2ConnectionIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.cloudbuildv2ConnectionIamMember.Cloudbuildv2ConnectionIamMemberConfig",
		reflect.TypeOf((*Cloudbuildv2ConnectionIamMemberConfig)(nil)).Elem(),
	)
}
