...
func (j *jsiiProxy_AccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraintsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (a *jsiiProxy_AccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraintsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
