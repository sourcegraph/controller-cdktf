...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/data-sources/secret_manager_secret_version_access google_secret_manager_secret_version_access}.
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Secret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secret",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) SecretData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretData",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) SecretInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretInput",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
func (j *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) VersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.76.0/docs/data-sources/secret_manager_secret_version_access google_secret_manager_secret_version_access} Data Source.
func NewDataGoogleSecretManagerSecretVersionAccess(scope constructs.Construct, id *string, config *DataGoogleSecretManagerSecretVersionAccessConfig) DataGoogleSecretManagerSecretVersionAccess {
	...
	if err := validateNewDataGoogleSecretManagerSecretVersionAccessParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleSecretManagerSecretVersionAccess{}

	_jsii_.Create(
		"google.dataGoogleSecretManagerSecretVersionAccess.DataGoogleSecretManagerSecretVersionAccess",
...
func DataGoogleSecretManagerSecretVersionAccess_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.dataGoogleSecretManagerSecretVersionAccess.DataGoogleSecretManagerSecretVersionAccess",
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ResetVersion() {
	_jsii_.InvokeVoid(
		d,
		"resetVersion",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSecretManagerSecretVersionAccess) ToString() *string {
	var returns *string
