...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
