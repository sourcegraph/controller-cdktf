...
func (d *jsiiProxy_DataLossPreventionInspectTemplateInspectConfigRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
