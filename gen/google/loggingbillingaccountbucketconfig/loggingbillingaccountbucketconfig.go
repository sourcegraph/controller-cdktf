...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/logging_billing_account_bucket_config google_logging_billing_account_bucket_config}.
...
type jsiiProxy_LoggingBillingAccountBucketConfig struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_LoggingBillingAccountBucketConfig) BillingAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccount",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) BillingAccountInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccountInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) BucketId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketId",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) BucketIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketIdInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) IndexConfigs() LoggingBillingAccountBucketConfigIndexConfigsList {
	var returns LoggingBillingAccountBucketConfigIndexConfigsList
	_jsii_.Get(
		j,
		"indexConfigs",
		&returns,
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) LifecycleState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lifecycleState",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) RetentionDays() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"retentionDays",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) RetentionDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"retentionDaysInput",
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LoggingBillingAccountBucketConfig) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/logging_billing_account_bucket_config google_logging_billing_account_bucket_config} Resource.
func NewLoggingBillingAccountBucketConfig(scope constructs.Construct, id *string, config *LoggingBillingAccountBucketConfigConfig) LoggingBillingAccountBucketConfig {
	...
	if err := validateNewLoggingBillingAccountBucketConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoggingBillingAccountBucketConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLoggingBillingAccountBucketConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) MoveToId(id *string) {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ResetIndexConfigs() {
	_jsii_.InvokeVoid(
		l,
		"resetIndexConfigs",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ResetRetentionDays() {
	_jsii_.InvokeVoid(
		l,
		"resetRetentionDays",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingBillingAccountBucketConfig) ToString() *string {
	var returns *string
