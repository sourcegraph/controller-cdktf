...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList {
	...
	_jsii_.Create(
		"@cdktf/provider-google.dataGoogleCloudIdentityGroupTransitiveMemberships.DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList",
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) Get(index *float64) DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsOutputReference
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataGoogleCloudIdentityGroupTransitiveMembershipsMembershipsList) ToString() *string {
	var returns *string
