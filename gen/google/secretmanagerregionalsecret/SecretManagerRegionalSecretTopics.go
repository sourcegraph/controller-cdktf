...
type SecretManagerRegionalSecretTopics struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/secret_manager_regional_secret#name SecretManagerRegionalSecret#name}
	//
