package datagooglecloudfunctions2functioniampolicy
...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/cloudfunctions2_function_iam_policy google_cloudfunctions2_function_iam_policy}.
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) CloudFunction() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudFunction",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) CloudFunctionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudFunctionInput",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/cloudfunctions2_function_iam_policy google_cloudfunctions2_function_iam_policy} Data Source.
func NewDataGoogleCloudfunctions2FunctionIamPolicy(scope constructs.Construct, id *string, config *DataGoogleCloudfunctions2FunctionIamPolicyConfig) DataGoogleCloudfunctions2FunctionIamPolicy {
	...
	if err := validateNewDataGoogleCloudfunctions2FunctionIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy{}

	_jsii_.Create(
		"google.dataGoogleCloudfunctions2FunctionIamPolicy.DataGoogleCloudfunctions2FunctionIamPolicy",
...
func DataGoogleCloudfunctions2FunctionIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.dataGoogleCloudfunctions2FunctionIamPolicy.DataGoogleCloudfunctions2FunctionIamPolicy",
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudfunctions2FunctionIamPolicy) ToString() *string {
	var returns *string
