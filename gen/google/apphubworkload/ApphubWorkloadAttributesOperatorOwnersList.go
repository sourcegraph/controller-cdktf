...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) InternalValue() interface{} {
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) Get(index *float64) ApphubWorkloadAttributesOperatorOwnersOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ApphubWorkloadAttributesOperatorOwnersOutputReference
...
func (a *jsiiProxy_ApphubWorkloadAttributesOperatorOwnersList) ToString() *string {
	var returns *string
