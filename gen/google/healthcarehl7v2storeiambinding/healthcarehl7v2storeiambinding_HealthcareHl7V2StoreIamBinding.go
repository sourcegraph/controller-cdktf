...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/healthcarehl7v2storeiambinding/internal"
)
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) Connection() interface{} {
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding)SetConnection(val interface{}) {
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding)SetProvisioners(val *[]interface{}) {
...
func HealthcareHl7V2StoreIamBinding_IsConstruct(x interface{}) *bool {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) AddOverride(path *string, value interface{}) {
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) ToMetadata() interface{} {
	var returns interface{}
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) ToTerraform() interface{} {
	var returns interface{}
