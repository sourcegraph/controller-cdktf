...
func (j *jsiiProxy_IamWorkloadIdentityPool) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Node() constructs.Node {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_IamWorkloadIdentityPool) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IamWorkloadIdentityPool) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamWorkloadIdentityPool) Timeouts() IamWorkloadIdentityPoolTimeoutsOutputReference {
	var returns IamWorkloadIdentityPoolTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_IamWorkloadIdentityPool) WorkloadIdentityPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IamWorkloadIdentityPool) WorkloadIdentityPoolIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewIamWorkloadIdentityPool(scope constructs.Construct, id *string, config *IamWorkloadIdentityPoolConfig) IamWorkloadIdentityPool {
	...
	if err := validateNewIamWorkloadIdentityPoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IamWorkloadIdentityPool_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.iamWorkloadIdentityPool.IamWorkloadIdentityPool",
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetDescription() {
	_jsii_.InvokeVoid(
		i,
		"resetDescription",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetDisabled() {
	_jsii_.InvokeVoid(
		i,
		"resetDisabled",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetDisplayName() {
	_jsii_.InvokeVoid(
		i,
		"resetDisplayName",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetProject() {
	_jsii_.InvokeVoid(
		i,
		"resetProject",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ResetTimeouts() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeouts",
		nil, // no parameters
...
func (i *jsiiProxy_IamWorkloadIdentityPool) ToString() *string {
	var returns *string
