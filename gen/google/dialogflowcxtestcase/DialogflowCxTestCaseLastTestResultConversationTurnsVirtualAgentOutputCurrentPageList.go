...
func (j *jsiiProxy_DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList {
	_init_.Initialize()
...
func NewDialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList_Override(d DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxTestCaseLastTestResultConversationTurnsVirtualAgentOutputCurrentPageList) Resolve(_context cdktf.IResolveContext) interface{} {
