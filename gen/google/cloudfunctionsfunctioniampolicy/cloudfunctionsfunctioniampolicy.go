...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudfunctionsFunctionIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.cloudfunctionsFunctionIamPolicy.CloudfunctionsFunctionIamPolicyConfig",
		reflect.TypeOf((*CloudfunctionsFunctionIamPolicyConfig)(nil)).Elem(),
	)
}
