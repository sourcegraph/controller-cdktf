...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/logging_linked_dataset google_logging_linked_dataset}.
...
func (j *jsiiProxy_LoggingLinkedDataset) BigqueryDataset() LoggingLinkedDatasetBigqueryDatasetList {
	var returns LoggingLinkedDatasetBigqueryDatasetList
	_jsii_.Get(
		j,
		"bigqueryDataset",
		&returns,
...
func (j *jsiiProxy_LoggingLinkedDataset) Bucket() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucket",
...
func (j *jsiiProxy_LoggingLinkedDataset) BucketInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_LoggingLinkedDataset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingLinkedDataset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LoggingLinkedDataset) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingLinkedDataset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingLinkedDataset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingLinkedDataset) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) LifecycleState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lifecycleState",
...
func (j *jsiiProxy_LoggingLinkedDataset) LinkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkId",
...
func (j *jsiiProxy_LoggingLinkedDataset) LinkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"linkIdInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_LoggingLinkedDataset) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingLinkedDataset) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingLinkedDataset) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_LoggingLinkedDataset) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_LoggingLinkedDataset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LoggingLinkedDataset) Timeouts() LoggingLinkedDatasetTimeoutsOutputReference {
	var returns LoggingLinkedDatasetTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/logging_linked_dataset google_logging_linked_dataset} Resource.
func NewLoggingLinkedDataset(scope constructs.Construct, id *string, config *LoggingLinkedDatasetConfig) LoggingLinkedDataset {
	_init_.Initialize()

	if err := validateNewLoggingLinkedDatasetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoggingLinkedDataset_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.loggingLinkedDataset.LoggingLinkedDataset",
...
func (l *jsiiProxy_LoggingLinkedDataset) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingLinkedDataset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingLinkedDataset) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingLinkedDataset) MoveToId(id *string) {
...
func (l *jsiiProxy_LoggingLinkedDataset) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingLinkedDataset) PutTimeouts(value *LoggingLinkedDatasetTimeouts) {
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetBigqueryDataset() {
	_jsii_.InvokeVoid(
		l,
		"resetBigqueryDataset",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetLocation() {
	_jsii_.InvokeVoid(
		l,
		"resetLocation",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetParent() {
	_jsii_.InvokeVoid(
		l,
		"resetParent",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLinkedDataset) ToString() *string {
	var returns *string
