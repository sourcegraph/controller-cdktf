...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clusterRegion", GoGetter: "ClusterRegion"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "managedPrometheusConfig", GoGetter: "ManagedPrometheusConfig"},
			_jsii_.MemberProperty{JsiiProperty: "managedPrometheusConfigInput", GoGetter: "ManagedPrometheusConfigInput"},
			_jsii_.MemberMethod{JsiiMethod: "putManagedPrometheusConfig", GoMethod: "PutManagedPrometheusConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedPrometheusConfig", GoMethod: "ResetManagedPrometheusConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
