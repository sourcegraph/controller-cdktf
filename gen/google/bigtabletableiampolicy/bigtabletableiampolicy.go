...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BigtableTableIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.bigtableTableIamPolicy.BigtableTableIamPolicyConfig",
		reflect.TypeOf((*BigtableTableIamPolicyConfig)(nil)).Elem(),
	)
}
