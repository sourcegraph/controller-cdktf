...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectedProjects", GoGetter: "ConnectedProjects"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxThroughputInput", GoGetter: "MaxThroughputInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "minThroughputInput", GoGetter: "MinThroughputInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxThroughput", GoMethod: "ResetMaxThroughput"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinInstances", GoMethod: "ResetMinInstances"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinThroughput", GoMethod: "ResetMinThroughput"},
