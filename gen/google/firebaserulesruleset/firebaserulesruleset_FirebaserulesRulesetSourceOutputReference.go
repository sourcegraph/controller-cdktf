...
type FirebaserulesRulesetSourceOutputReference interface {
	...
	SetInternalValue(val *FirebaserulesRulesetSource)
	Language() *string
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) Files() FirebaserulesRulesetSourceFilesList {
	var returns FirebaserulesRulesetSourceFilesList
	_jsii_.Get(
		j,
		"files",
		&returns,
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) InternalValue() *FirebaserulesRulesetSource {
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) Language() *string {
	var returns *string
	_jsii_.Get(
		j,
		"language",
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) LanguageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"languageInput",
...
func (j *jsiiProxy_FirebaserulesRulesetSourceOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) ResetLanguage() {
	_jsii_.InvokeVoid(
		f,
		"resetLanguage",
		nil, // no parameters
...
func (f *jsiiProxy_FirebaserulesRulesetSourceOutputReference) ToString() *string {
	var returns *string
