...
type FirebaserulesRulesetMetadataList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for FirebaserulesRulesetMetadataList
type jsiiProxy_FirebaserulesRulesetMetadataList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_FirebaserulesRulesetMetadataList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FirebaserulesRulesetMetadataList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirebaserulesRulesetMetadataList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FirebaserulesRulesetMetadataList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_FirebaserulesRulesetMetadataList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewFirebaserulesRulesetMetadataList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirebaserulesRulesetMetadataList {
	...
	if err := validateNewFirebaserulesRulesetMetadataListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirebaserulesRulesetMetadataList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirebaserulesRulesetMetadataList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FirebaserulesRulesetMetadataList) Get(index *float64) FirebaserulesRulesetMetadataOutputReference {
	if err := f.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns FirebaserulesRulesetMetadataOutputReference
...
func (f *jsiiProxy_FirebaserulesRulesetMetadataList) ToString() *string {
	var returns *string
