...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/compute_health_check google_compute_health_check}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/compute_health_check google_compute_health_check} Resource.
...
func ComputeHealthCheck_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeHealthCheck_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeHealthCheck) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeHealthCheck) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeHealthCheck) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeHealthCheck) MoveToId(id *string) {
