...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/secret_manager_secret google_secret_manager_secret}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/secret_manager_secret google_secret_manager_secret} Resource.
...
func (s *jsiiProxy_SecretManagerSecret) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretManagerSecret) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecret) MoveToId(id *string) {
