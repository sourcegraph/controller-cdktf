...
func (p *jsiiProxy_PrivatecaCertificateCertificateDescriptionX509DescriptionKeyUsageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
