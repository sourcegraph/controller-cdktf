...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceRange", GoGetter: "SourceRange"},
			_jsii_.MemberProperty{JsiiProperty: "sourceRangeInput", GoGetter: "SourceRangeInput"},
	...
	_jsii_.RegisterStruct(
		"google.appEngineFirewallRule.AppEngineFirewallRuleConfig",
		reflect.TypeOf((*AppEngineFirewallRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.appEngineFirewallRule.AppEngineFirewallRuleTimeouts",
