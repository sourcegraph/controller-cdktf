...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolNodeConfigSoleTenantConfigNodeAffinityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
