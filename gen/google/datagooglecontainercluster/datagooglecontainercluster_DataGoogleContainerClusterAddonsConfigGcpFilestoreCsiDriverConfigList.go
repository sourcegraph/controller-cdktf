...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList_Override(d DataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterAddonsConfigGcpFilestoreCsiDriverConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
