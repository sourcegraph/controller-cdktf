...
func (j *jsiiProxy_DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList_Override(d DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterPrivateClusterConfigMasterGlobalAccessConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
