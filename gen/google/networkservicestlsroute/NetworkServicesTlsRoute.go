...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/network_services_tls_route google_network_services_tls_route}.
...
func (j *jsiiProxy_NetworkServicesTlsRoute) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Gateways() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"gateways",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) GatewaysInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"gatewaysInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) MeshesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"meshesInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Node() constructs.Node {
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Rules() NetworkServicesTlsRouteRulesList {
	var returns NetworkServicesTlsRouteRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_NetworkServicesTlsRoute) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_NetworkServicesTlsRoute) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkServicesTlsRoute) Timeouts() NetworkServicesTlsRouteTimeoutsOutputReference {
	var returns NetworkServicesTlsRouteTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_NetworkServicesTlsRoute) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/network_services_tls_route google_network_services_tls_route} Resource.
func NewNetworkServicesTlsRoute(scope constructs.Construct, id *string, config *NetworkServicesTlsRouteConfig) NetworkServicesTlsRoute {
	...
	if err := validateNewNetworkServicesTlsRouteParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func NetworkServicesTlsRoute_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.networkServicesTlsRoute.NetworkServicesTlsRoute",
...
func (n *jsiiProxy_NetworkServicesTlsRoute) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) PutTimeouts(value *NetworkServicesTlsRouteTimeouts) {
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetDescription() {
	_jsii_.InvokeVoid(
		n,
		"resetDescription",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetGateways() {
	_jsii_.InvokeVoid(
		n,
		"resetGateways",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetProject() {
	_jsii_.InvokeVoid(
		n,
		"resetProject",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkServicesTlsRoute) ToString() *string {
	var returns *string
