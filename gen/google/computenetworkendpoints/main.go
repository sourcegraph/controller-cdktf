...
func init() {
	_jsii_.RegisterClass(
		"google.computeNetworkEndpoints.ComputeNetworkEndpoints",
	...
	_jsii_.RegisterStruct(
		"google.computeNetworkEndpoints.ComputeNetworkEndpointsNetworkEndpoints",
		reflect.TypeOf((*ComputeNetworkEndpointsNetworkEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeNetworkEndpoints.ComputeNetworkEndpointsNetworkEndpointsList",
	...
	_jsii_.RegisterStruct(
		"google.computeNetworkEndpoints.ComputeNetworkEndpointsTimeouts",
		reflect.TypeOf((*ComputeNetworkEndpointsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeNetworkEndpoints.ComputeNetworkEndpointsTimeoutsOutputReference",
