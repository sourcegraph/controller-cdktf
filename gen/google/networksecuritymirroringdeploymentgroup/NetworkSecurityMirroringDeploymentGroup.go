...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/network_security_mirroring_deployment_group google_network_security_mirroring_deployment_group}.
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) Reconciling() cdktf.IResolvable {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/network_security_mirroring_deployment_group google_network_security_mirroring_deployment_group} Resource.
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkSecurityMirroringDeploymentGroup)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkSecurityMirroringDeploymentGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkSecurityMirroringDeploymentGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
