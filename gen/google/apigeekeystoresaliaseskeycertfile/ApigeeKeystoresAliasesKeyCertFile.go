...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/apigeekeystoresaliaseskeycertfile/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/apigee_keystores_aliases_key_cert_file google_apigee_keystores_aliases_key_cert_file}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/apigee_keystores_aliases_key_cert_file google_apigee_keystores_aliases_key_cert_file} Resource.
...
func ApigeeKeystoresAliasesKeyCertFile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApigeeKeystoresAliasesKeyCertFile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFile) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFile) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApigeeKeystoresAliasesKeyCertFile) MoveToId(id *string) {
