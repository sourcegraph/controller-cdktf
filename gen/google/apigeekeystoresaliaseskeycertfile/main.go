...
func init() {
	_jsii_.RegisterClass(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFile",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "certsInfoInput", GoGetter: "CertsInfoInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCertsInfo", GoMethod: "PutCertsInfo"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCertsInfo", GoMethod: "ResetCertsInfo"},
	...
	_jsii_.RegisterStruct(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfo",
		reflect.TypeOf((*ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfo)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfoList",
	...
	_jsii_.RegisterClass(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFileCertsInfoCertInfoOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "expiryDateInput", GoGetter: "ExpiryDateInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "isValidInput", GoGetter: "IsValidInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBasicConstraints", GoMethod: "ResetBasicConstraints"},
			_jsii_.MemberMethod{JsiiMethod: "resetExpiryDate", GoMethod: "ResetExpiryDate"},
			_jsii_.MemberMethod{JsiiMethod: "resetIssuer", GoMethod: "ResetIssuer"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsValid", GoMethod: "ResetIsValid"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSigAlgName", GoMethod: "ResetSigAlgName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sigAlgNameInput", GoGetter: "SigAlgNameInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putCertInfo", GoMethod: "PutCertInfo"},
			_jsii_.MemberMethod{JsiiMethod: "resetCertInfo", GoMethod: "ResetCertInfo"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFileConfig",
		reflect.TypeOf((*ApigeeKeystoresAliasesKeyCertFileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.apigeeKeystoresAliasesKeyCertFile.ApigeeKeystoresAliasesKeyCertFileTimeouts",
