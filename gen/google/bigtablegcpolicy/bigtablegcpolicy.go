...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/bigtable_gc_policy google_bigtable_gc_policy}.
...
func (j *jsiiProxy_BigtableGcPolicy) ColumnFamily() *string {
	var returns *string
	_jsii_.Get(
		j,
		"columnFamily",
...
func (j *jsiiProxy_BigtableGcPolicy) ColumnFamilyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"columnFamilyInput",
...
func (j *jsiiProxy_BigtableGcPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BigtableGcPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BigtableGcPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BigtableGcPolicy) GcRules() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gcRules",
...
func (j *jsiiProxy_BigtableGcPolicy) GcRulesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gcRulesInput",
...
func (j *jsiiProxy_BigtableGcPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BigtableGcPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BigtableGcPolicy) InstanceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceName",
...
func (j *jsiiProxy_BigtableGcPolicy) InstanceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceNameInput",
...
func (j *jsiiProxy_BigtableGcPolicy) MaxAge() BigtableGcPolicyMaxAgeOutputReference {
	var returns BigtableGcPolicyMaxAgeOutputReference
	_jsii_.Get(
		j,
		"maxAge",
		&returns,
...
func (j *jsiiProxy_BigtableGcPolicy) MaxAgeInput() *BigtableGcPolicyMaxAge {
...
func (j *jsiiProxy_BigtableGcPolicy) MaxVersion() BigtableGcPolicyMaxVersionList {
	var returns BigtableGcPolicyMaxVersionList
	_jsii_.Get(
		j,
		"maxVersion",
		&returns,
...
func (j *jsiiProxy_BigtableGcPolicy) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_BigtableGcPolicy) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_BigtableGcPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_BigtableGcPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_BigtableGcPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_BigtableGcPolicy) Table() *string {
	var returns *string
	_jsii_.Get(
		j,
		"table",
...
func (j *jsiiProxy_BigtableGcPolicy) TableInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableInput",
...
func (j *jsiiProxy_BigtableGcPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/bigtable_gc_policy google_bigtable_gc_policy} Resource.
func NewBigtableGcPolicy(scope constructs.Construct, id *string, config *BigtableGcPolicyConfig) BigtableGcPolicy {
	_init_.Initialize()

	if err := validateNewBigtableGcPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func BigtableGcPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.bigtableGcPolicy.BigtableGcPolicy",
...
func (b *jsiiProxy_BigtableGcPolicy) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BigtableGcPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BigtableGcPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BigtableGcPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BigtableGcPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BigtableGcPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BigtableGcPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BigtableGcPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BigtableGcPolicy) MoveFromId(id *string) {
...
func (b *jsiiProxy_BigtableGcPolicy) MoveToId(id *string) {
...
func (b *jsiiProxy_BigtableGcPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BigtableGcPolicy) PutMaxAge(value *BigtableGcPolicyMaxAge) {
	if err := b.validatePutMaxAgeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BigtableGcPolicy) ResetGcRules() {
	_jsii_.InvokeVoid(
		b,
		"resetGcRules",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetIgnoreWarnings() {
	_jsii_.InvokeVoid(
		b,
		"resetIgnoreWarnings",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetMaxAge() {
	_jsii_.InvokeVoid(
		b,
		"resetMaxAge",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetMaxVersion() {
	_jsii_.InvokeVoid(
		b,
		"resetMaxVersion",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetMode() {
	_jsii_.InvokeVoid(
		b,
		"resetMode",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		b,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		b,
		"resetProject",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableGcPolicy) ToString() *string {
	var returns *string
