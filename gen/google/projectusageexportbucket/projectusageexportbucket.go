...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/project_usage_export_bucket google_project_usage_export_bucket}.
...
func (j *jsiiProxy_ProjectUsageExportBucket) BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketNameInput",
...
func (j *jsiiProxy_ProjectUsageExportBucket) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ProjectUsageExportBucket) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ProjectUsageExportBucket) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ProjectUsageExportBucket) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ProjectUsageExportBucket) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ProjectUsageExportBucket) Node() constructs.Node {
...
func (j *jsiiProxy_ProjectUsageExportBucket) Prefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefix",
...
func (j *jsiiProxy_ProjectUsageExportBucket) PrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefixInput",
...
func (j *jsiiProxy_ProjectUsageExportBucket) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ProjectUsageExportBucket) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ProjectUsageExportBucket) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ProjectUsageExportBucket) Timeouts() ProjectUsageExportBucketTimeoutsOutputReference {
	var returns ProjectUsageExportBucketTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/project_usage_export_bucket google_project_usage_export_bucket} Resource.
func NewProjectUsageExportBucket(scope constructs.Construct, id *string, config *ProjectUsageExportBucketConfig) ProjectUsageExportBucket {
	...
	if err := validateNewProjectUsageExportBucketParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ProjectUsageExportBucket_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.projectUsageExportBucket.ProjectUsageExportBucket",
...
func (p *jsiiProxy_ProjectUsageExportBucket) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_ProjectUsageExportBucket) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_ProjectUsageExportBucket) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectUsageExportBucket) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectUsageExportBucket) OverrideLogicalId(newLogicalId *string) {
...
func (p *jsiiProxy_ProjectUsageExportBucket) PutTimeouts(value *ProjectUsageExportBucketTimeouts) {
...
func (p *jsiiProxy_ProjectUsageExportBucket) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectUsageExportBucket) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		p,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectUsageExportBucket) ResetPrefix() {
	_jsii_.InvokeVoid(
		p,
		"resetPrefix",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectUsageExportBucket) ResetProject() {
	_jsii_.InvokeVoid(
		p,
		"resetProject",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectUsageExportBucket) ResetTimeouts() {
	_jsii_.InvokeVoid(
		p,
		"resetTimeouts",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectUsageExportBucket) ToString() *string {
	var returns *string
