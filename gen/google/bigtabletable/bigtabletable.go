...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/bigtable_table google_bigtable_table}.
type BigtableTable interface {
	cdktf.TerraformResource
	AutomatedBackupPolicy() BigtableTableAutomatedBackupPolicyOutputReference
	AutomatedBackupPolicyInput() *BigtableTableAutomatedBackupPolicy
	// Experimental.
...
type jsiiProxy_BigtableTable struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_BigtableTable) AutomatedBackupPolicy() BigtableTableAutomatedBackupPolicyOutputReference {
	var returns BigtableTableAutomatedBackupPolicyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigtableTable) AutomatedBackupPolicyInput() *BigtableTableAutomatedBackupPolicy {
...
func (j *jsiiProxy_BigtableTable) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BigtableTable) ColumnFamily() BigtableTableColumnFamilyList {
	var returns BigtableTableColumnFamilyList
	_jsii_.Get(
		j,
		"columnFamily",
		&returns,
...
func (j *jsiiProxy_BigtableTable) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BigtableTable) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BigtableTable) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BigtableTable) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BigtableTable) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BigtableTable) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BigtableTable) InstanceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceName",
...
func (j *jsiiProxy_BigtableTable) InstanceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceNameInput",
...
func (j *jsiiProxy_BigtableTable) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigtableTable) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_BigtableTable) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_BigtableTable) Node() constructs.Node {
...
func (j *jsiiProxy_BigtableTable) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_BigtableTable) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_BigtableTable) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BigtableTable) SplitKeysInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"splitKeysInput",
...
func (j *jsiiProxy_BigtableTable) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BigtableTable) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/bigtable_table google_bigtable_table} Resource.
func NewBigtableTable(scope constructs.Construct, id *string, config *BigtableTableConfig) BigtableTable {
	_init_.Initialize()

	if err := validateNewBigtableTableParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func BigtableTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBigtableTable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BigtableTable_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.bigtableTable.BigtableTable",
...
func (b *jsiiProxy_BigtableTable) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BigtableTable) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigtableTable) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BigtableTable) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BigtableTable) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BigtableTable) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BigtableTable) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BigtableTable) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BigtableTable) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BigtableTable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BigtableTable) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigtableTable) MoveFromId(id *string) {
...
func (b *jsiiProxy_BigtableTable) MoveToId(id *string) {
...
func (b *jsiiProxy_BigtableTable) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BigtableTable) PutAutomatedBackupPolicy(value *BigtableTableAutomatedBackupPolicy) {
	if err := b.validatePutAutomatedBackupPolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BigtableTable) ResetAutomatedBackupPolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetAutomatedBackupPolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableTable) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableTable) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		b,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableTable) ResetProject() {
	_jsii_.InvokeVoid(
		b,
		"resetProject",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableTable) ResetSplitKeys() {
	_jsii_.InvokeVoid(
		b,
		"resetSplitKeys",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableTable) ToString() *string {
	var returns *string
