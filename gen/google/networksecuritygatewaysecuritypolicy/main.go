...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkSecurityGatewaySecurityPolicy.NetworkSecurityGatewaySecurityPolicyConfig",
		reflect.TypeOf((*NetworkSecurityGatewaySecurityPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkSecurityGatewaySecurityPolicy.NetworkSecurityGatewaySecurityPolicyTimeouts",
		reflect.TypeOf((*NetworkSecurityGatewaySecurityPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.networkSecurityGatewaySecurityPolicy.NetworkSecurityGatewaySecurityPolicyTimeoutsOutputReference",
