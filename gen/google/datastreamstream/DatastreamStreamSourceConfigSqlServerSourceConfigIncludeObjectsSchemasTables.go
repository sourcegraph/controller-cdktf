...
type DatastreamStreamSourceConfigSqlServerSourceConfigIncludeObjectsSchemasTables struct {
	...
	// columns block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/datastream_stream#columns DatastreamStream#columns}
