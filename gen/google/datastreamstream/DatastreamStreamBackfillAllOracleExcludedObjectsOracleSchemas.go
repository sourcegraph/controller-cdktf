...
type DatastreamStreamBackfillAllOracleExcludedObjectsOracleSchemas struct {
	...
	// oracle_tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/datastream_stream#oracle_tables DatastreamStream#oracle_tables}
