...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/beyondcorp_app_gateway google_beyondcorp_app_gateway}.
...
func (j *jsiiProxy_BeyondcorpAppGateway) AllocatedConnections() BeyondcorpAppGatewayAllocatedConnectionsList {
	var returns BeyondcorpAppGatewayAllocatedConnectionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BeyondcorpAppGateway) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_BeyondcorpAppGateway) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_BeyondcorpAppGateway) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BeyondcorpAppGateway) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_BeyondcorpAppGateway) HostType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostType",
...
func (j *jsiiProxy_BeyondcorpAppGateway) HostTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostTypeInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_BeyondcorpAppGateway) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Labels() *map[string]*string {
...
func (j *jsiiProxy_BeyondcorpAppGateway) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_BeyondcorpAppGateway) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Node() constructs.Node {
...
func (j *jsiiProxy_BeyondcorpAppGateway) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_BeyondcorpAppGateway) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_BeyondcorpAppGateway) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_BeyondcorpAppGateway) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BeyondcorpAppGateway) Timeouts() BeyondcorpAppGatewayTimeoutsOutputReference {
	var returns BeyondcorpAppGatewayTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_BeyondcorpAppGateway) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_BeyondcorpAppGateway) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_BeyondcorpAppGateway) Uri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uri",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/beyondcorp_app_gateway google_beyondcorp_app_gateway} Resource.
func NewBeyondcorpAppGateway(scope constructs.Construct, id *string, config *BeyondcorpAppGatewayConfig) BeyondcorpAppGateway {
	_init_.Initialize()

	if err := validateNewBeyondcorpAppGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func BeyondcorpAppGateway_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.beyondcorpAppGateway.BeyondcorpAppGateway",
...
func (b *jsiiProxy_BeyondcorpAppGateway) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BeyondcorpAppGateway) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BeyondcorpAppGateway) MoveFromId(id *string) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) MoveToId(id *string) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) OverrideLogicalId(newLogicalId *string) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) PutTimeouts(value *BeyondcorpAppGatewayTimeouts) {
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetDisplayName() {
	_jsii_.InvokeVoid(
		b,
		"resetDisplayName",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetHostType() {
	_jsii_.InvokeVoid(
		b,
		"resetHostType",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetId() {
	_jsii_.InvokeVoid(
		b,
		"resetId",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetLabels() {
	_jsii_.InvokeVoid(
		b,
		"resetLabels",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		b,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetProject() {
	_jsii_.InvokeVoid(
		b,
		"resetProject",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetRegion() {
	_jsii_.InvokeVoid(
		b,
		"resetRegion",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ResetType() {
	_jsii_.InvokeVoid(
		b,
		"resetType",
		nil, // no parameters
...
func (b *jsiiProxy_BeyondcorpAppGateway) ToString() *string {
	var returns *string
