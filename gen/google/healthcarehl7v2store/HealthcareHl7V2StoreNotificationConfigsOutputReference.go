...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) PubsubTopic() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pubsubTopic",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) PubsubTopicInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pubsubTopicInput",
...
func (j *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) ResetFilter() {
	_jsii_.InvokeVoid(
		h,
		"resetFilter",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareHl7V2StoreNotificationConfigsOutputReference) ToString() *string {
	var returns *string
