...
func (j *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBigtableAuthorizedViewSubsetViewFamilySubsetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BigtableAuthorizedViewSubsetViewFamilySubsetsList {
	_init_.Initialize()
...
func NewBigtableAuthorizedViewSubsetViewFamilySubsetsList_Override(b BigtableAuthorizedViewSubsetViewFamilySubsetsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BigtableAuthorizedViewSubsetViewFamilySubsetsList) Resolve(_context cdktf.IResolveContext) interface{} {
