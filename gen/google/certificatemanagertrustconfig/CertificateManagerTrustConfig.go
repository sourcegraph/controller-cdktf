...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/certificate_manager_trust_config google_certificate_manager_trust_config}.
...
func (j *jsiiProxy_CertificateManagerTrustConfig) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Labels() *map[string]*string {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Node() constructs.Node {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CertificateManagerTrustConfig) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_CertificateManagerTrustConfig) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CertificateManagerTrustConfig) Timeouts() CertificateManagerTrustConfigTimeoutsOutputReference {
	var returns CertificateManagerTrustConfigTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_CertificateManagerTrustConfig) TrustStores() CertificateManagerTrustConfigTrustStoresList {
	var returns CertificateManagerTrustConfigTrustStoresList
	_jsii_.Get(
		j,
		"trustStores",
		&returns,
...
func (j *jsiiProxy_CertificateManagerTrustConfig) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/certificate_manager_trust_config google_certificate_manager_trust_config} Resource.
func NewCertificateManagerTrustConfig(scope constructs.Construct, id *string, config *CertificateManagerTrustConfigConfig) CertificateManagerTrustConfig {
	...
	if err := validateNewCertificateManagerTrustConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CertificateManagerTrustConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCertificateManagerTrustConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CertificateManagerTrustConfig_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.certificateManagerTrustConfig.CertificateManagerTrustConfig",
...
func (c *jsiiProxy_CertificateManagerTrustConfig) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) MoveFromId(id *string) {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) MoveToId(id *string) {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetLabels() {
	_jsii_.InvokeVoid(
		c,
		"resetLabels",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ResetTrustStores() {
	_jsii_.InvokeVoid(
		c,
		"resetTrustStores",
		nil, // no parameters
...
func (c *jsiiProxy_CertificateManagerTrustConfig) ToString() *string {
	var returns *string
