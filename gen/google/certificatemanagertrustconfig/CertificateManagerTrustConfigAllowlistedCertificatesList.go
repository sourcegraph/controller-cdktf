...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) InternalValue() interface{} {
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) Get(index *float64) CertificateManagerTrustConfigAllowlistedCertificatesOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns CertificateManagerTrustConfigAllowlistedCertificatesOutputReference
...
func (c *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CertificateManagerTrustConfigAllowlistedCertificatesList) ToString() *string {
	var returns *string
