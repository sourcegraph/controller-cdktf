package datagooglecontainerengineversions
...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagooglecontainerengineversions/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/container_engine_versions google_container_engine_versions}.
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) DefaultClusterVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) LatestMasterVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"latestMasterVersion",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) LatestNodeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"latestNodeVersion",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) ValidMasterVersions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"validMasterVersions",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) ValidNodeVersions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"validNodeVersions",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) VersionPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionPrefix",
...
func (j *jsiiProxy_DataGoogleContainerEngineVersions) VersionPrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionPrefixInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/data-sources/container_engine_versions google_container_engine_versions} Data Source.
func NewDataGoogleContainerEngineVersions(scope constructs.Construct, id *string, config *DataGoogleContainerEngineVersionsConfig) DataGoogleContainerEngineVersions {
	...
	if err := validateNewDataGoogleContainerEngineVersionsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleContainerEngineVersions{}

	_jsii_.Create(
		"google.dataGoogleContainerEngineVersions.DataGoogleContainerEngineVersions",
...
func DataGoogleContainerEngineVersions_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.dataGoogleContainerEngineVersions.DataGoogleContainerEngineVersions",
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ResetVersionPrefix() {
	_jsii_.InvokeVoid(
		d,
		"resetVersionPrefix",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) ToString() *string {
	var returns *string
