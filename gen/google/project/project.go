...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/project google_project}.
...
func (j *jsiiProxy_Project) BillingAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccount",
...
func (j *jsiiProxy_Project) BillingAccountInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingAccountInput",
...
func (j *jsiiProxy_Project) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_Project) FolderId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderId",
...
func (j *jsiiProxy_Project) FolderIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderIdInput",
...
func (j *jsiiProxy_Project) Labels() *map[string]*string {
...
func (j *jsiiProxy_Project) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_Project) Number() *string {
	var returns *string
	_jsii_.Get(
		j,
		"number",
...
func (j *jsiiProxy_Project) ProjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdInput",
...
func (j *jsiiProxy_Project) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/project google_project} Resource.
...
func (p *jsiiProxy_Project) ResetAutoCreateNetwork() {
	_jsii_.InvokeVoid(
		p,
		"resetAutoCreateNetwork",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetBillingAccount() {
	_jsii_.InvokeVoid(
		p,
		"resetBillingAccount",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetLabels() {
	_jsii_.InvokeVoid(
		p,
		"resetLabels",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetOrgId() {
	_jsii_.InvokeVoid(
		p,
		"resetOrgId",
		nil, // no parameters
