...
func (j *jsiiProxy_Project) validateSetBillingAccountParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Project) validateSetLabelsParameters(val *map[string]*string) error {
	return nil
}
...
func (j *jsiiProxy_Project) validateSetOrgIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Project) validateSetProjectIdParameters(val *string) error {
	return nil
}
