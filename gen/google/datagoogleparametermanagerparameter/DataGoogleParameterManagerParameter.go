...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagoogleparametermanagerparameter/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/data-sources/parameter_manager_parameter google_parameter_manager_parameter}.
type DataGoogleParameterManagerParameter interface {
	...
	PolicyMember() DataGoogleParameterManagerParameterPolicyMemberList
	Project() *string
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Format() *string {
	var returns *string
	_jsii_.Get(
		j,
		"format",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) ParameterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterId",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) ParameterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterIdInput",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) PolicyMember() DataGoogleParameterManagerParameterPolicyMemberList {
	var returns DataGoogleParameterManagerParameterPolicyMemberList
	_jsii_.Get(
		j,
		"policyMember",
		&returns,
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleParameterManagerParameter) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/data-sources/parameter_manager_parameter google_parameter_manager_parameter} Data Source.
func NewDataGoogleParameterManagerParameter(scope constructs.Construct, id *string, config *DataGoogleParameterManagerParameterConfig) DataGoogleParameterManagerParameter {
	...
	if err := validateNewDataGoogleParameterManagerParameterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleParameterManagerParameter_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleParameterManagerParameter.DataGoogleParameterManagerParameter",
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleParameterManagerParameter) ToString() *string {
	var returns *string
