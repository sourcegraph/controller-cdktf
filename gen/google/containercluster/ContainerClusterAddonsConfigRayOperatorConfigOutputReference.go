...
func (c *jsiiProxy_ContainerClusterAddonsConfigRayOperatorConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterAddonsConfigRayOperatorConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
