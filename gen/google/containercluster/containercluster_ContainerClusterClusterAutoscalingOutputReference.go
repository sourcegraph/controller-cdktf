...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) AutoProvisioningDefaults() ContainerClusterClusterAutoscalingAutoProvisioningDefaultsOutputReference {
	var returns ContainerClusterClusterAutoscalingAutoProvisioningDefaultsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) AutoProvisioningDefaultsInput() *ContainerClusterClusterAutoscalingAutoProvisioningDefaults {
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) InternalValue() *ContainerClusterClusterAutoscaling {
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ResourceLimits() ContainerClusterClusterAutoscalingResourceLimitsList {
	var returns ContainerClusterClusterAutoscalingResourceLimitsList
	_jsii_.Get(
		j,
		"resourceLimits",
		&returns,
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) PutAutoProvisioningDefaults(value *ContainerClusterClusterAutoscalingAutoProvisioningDefaults) {
	if err := c.validatePutAutoProvisioningDefaultsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ResetAutoProvisioningDefaults() {
	_jsii_.InvokeVoid(
		c,
		"resetAutoProvisioningDefaults",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ResetResourceLimits() {
	_jsii_.InvokeVoid(
		c,
		"resetResourceLimits",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ToString() *string {
	var returns *string
