...
func (j *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList {
	_init_.Initialize()
...
func NewDataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList_Override(d DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleAlloydbClusterContinuousBackupInfoEncryptionInfoList) Resolve(_context cdktf.IResolveContext) interface{} {
