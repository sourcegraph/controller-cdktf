...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/spanner_instance google_spanner_instance}.
...
func (j *jsiiProxy_SpannerInstance) Config() *string {
	var returns *string
	_jsii_.Get(
		j,
		"config",
...
func (j *jsiiProxy_SpannerInstance) ConfigInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configInput",
...
func (j *jsiiProxy_SpannerInstance) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_SpannerInstance) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_SpannerInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_SpannerInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SpannerInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SpannerInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SpannerInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SpannerInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SpannerInstance) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_SpannerInstance) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpannerInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SpannerInstance) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SpannerInstance) Node() constructs.Node {
...
func (j *jsiiProxy_SpannerInstance) NumNodes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"numNodes",
...
func (j *jsiiProxy_SpannerInstance) NumNodesInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"numNodesInput",
...
func (j *jsiiProxy_SpannerInstance) ProcessingUnits() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"processingUnits",
...
func (j *jsiiProxy_SpannerInstance) ProcessingUnitsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SpannerInstance) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_SpannerInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_SpannerInstance) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SpannerInstance) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_SpannerInstance) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SpannerInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_SpannerInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SpannerInstance) Timeouts() SpannerInstanceTimeoutsOutputReference {
	var returns SpannerInstanceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/spanner_instance google_spanner_instance} Resource.
func NewSpannerInstance(scope constructs.Construct, id *string, config *SpannerInstanceConfig) SpannerInstance {
	_init_.Initialize()

	if err := validateNewSpannerInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SpannerInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateSpannerInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpannerInstance) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpannerInstance) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpannerInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SpannerInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SpannerInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SpannerInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SpannerInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SpannerInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SpannerInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SpannerInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SpannerInstance) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpannerInstance) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpannerInstance) MoveToId(id *string) {
...
func (s *jsiiProxy_SpannerInstance) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SpannerInstance) ResetForceDestroy() {
	_jsii_.InvokeVoid(
		s,
		"resetForceDestroy",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetLabels() {
	_jsii_.InvokeVoid(
		s,
		"resetLabels",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetNumNodes() {
	_jsii_.InvokeVoid(
		s,
		"resetNumNodes",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetProcessingUnits() {
	_jsii_.InvokeVoid(
		s,
		"resetProcessingUnits",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SpannerInstance) ToString() *string {
	var returns *string
