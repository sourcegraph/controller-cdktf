...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/securesourcemanagerrepository/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/secure_source_manager_repository google_secure_source_manager_repository}.
type SecureSourceManagerRepository interface {
	...
	SetId(val *string)
	IdInput() *string
	InitialConfig() SecureSourceManagerRepositoryInitialConfigOutputReference
	InitialConfigInput() *SecureSourceManagerRepositoryInitialConfig
	Instance() *string
...
func (j *jsiiProxy_SecureSourceManagerRepository) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_SecureSourceManagerRepository) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_SecureSourceManagerRepository) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecureSourceManagerRepository) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SecureSourceManagerRepository) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) InitialConfig() SecureSourceManagerRepositoryInitialConfigOutputReference {
	var returns SecureSourceManagerRepositoryInitialConfigOutputReference
	_jsii_.Get(
		j,
		"initialConfig",
		&returns,
...
func (j *jsiiProxy_SecureSourceManagerRepository) InitialConfigInput() *SecureSourceManagerRepositoryInitialConfig {
...
func (j *jsiiProxy_SecureSourceManagerRepository) Instance() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instance",
...
func (j *jsiiProxy_SecureSourceManagerRepository) InstanceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_SecureSourceManagerRepository) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Node() constructs.Node {
...
func (j *jsiiProxy_SecureSourceManagerRepository) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_SecureSourceManagerRepository) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) RepositoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryId",
...
func (j *jsiiProxy_SecureSourceManagerRepository) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_SecureSourceManagerRepository) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SecureSourceManagerRepository) Timeouts() SecureSourceManagerRepositoryTimeoutsOutputReference {
	var returns SecureSourceManagerRepositoryTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_SecureSourceManagerRepository) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_SecureSourceManagerRepository) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_SecureSourceManagerRepository) Uris() SecureSourceManagerRepositoryUrisList {
	var returns SecureSourceManagerRepositoryUrisList
	_jsii_.Get(
		j,
		"uris",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/secure_source_manager_repository google_secure_source_manager_repository} Resource.
func NewSecureSourceManagerRepository(scope constructs.Construct, id *string, config *SecureSourceManagerRepositoryConfig) SecureSourceManagerRepository {
	...
	if err := validateNewSecureSourceManagerRepositoryParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecureSourceManagerRepository) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SecureSourceManagerRepository) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SecureSourceManagerRepository) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecureSourceManagerRepository) MoveToId(id *string) {
...
func (s *jsiiProxy_SecureSourceManagerRepository) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SecureSourceManagerRepository) PutInitialConfig(value *SecureSourceManagerRepositoryInitialConfig) {
	if err := s.validatePutInitialConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetInitialConfig() {
	_jsii_.InvokeVoid(
		s,
		"resetInitialConfig",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SecureSourceManagerRepository) ToString() *string {
	var returns *string
