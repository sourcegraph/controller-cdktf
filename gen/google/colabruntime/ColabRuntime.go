...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/colab_runtime google_colab_runtime}.
...
func (j *jsiiProxy_ColabRuntime) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ColabRuntime) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ColabRuntime) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ColabRuntime) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_ColabRuntime) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ColabRuntime) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ColabRuntime) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ColabRuntime) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ColabRuntime) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ColabRuntime) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ColabRuntime) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_ColabRuntime) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_ColabRuntime) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ColabRuntime) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ColabRuntime) Node() constructs.Node {
...
func (j *jsiiProxy_ColabRuntime) NotebookRuntimeTemplateRef() ColabRuntimeNotebookRuntimeTemplateRefOutputReference {
	var returns ColabRuntimeNotebookRuntimeTemplateRefOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ColabRuntime) NotebookRuntimeTemplateRefInput() *ColabRuntimeNotebookRuntimeTemplateRef {
	var returns *ColabRuntimeNotebookRuntimeTemplateRef
	_jsii_.Get(
		j,
		"notebookRuntimeTemplateRefInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ColabRuntime) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ColabRuntime) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ColabRuntime) RuntimeUser() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runtimeUser",
...
func (j *jsiiProxy_ColabRuntime) RuntimeUserInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runtimeUserInput",
...
func (j *jsiiProxy_ColabRuntime) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ColabRuntime) Timeouts() ColabRuntimeTimeoutsOutputReference {
	var returns ColabRuntimeTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/colab_runtime google_colab_runtime} Resource.
func NewColabRuntime(scope constructs.Construct, id *string, config *ColabRuntimeConfig) ColabRuntime {
	_init_.Initialize()

	if err := validateNewColabRuntimeParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ColabRuntime_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateColabRuntime_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ColabRuntime_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.colabRuntime.ColabRuntime",
...
func (c *jsiiProxy_ColabRuntime) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ColabRuntime) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ColabRuntime) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ColabRuntime) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ColabRuntime) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ColabRuntime) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ColabRuntime) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ColabRuntime) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ColabRuntime) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ColabRuntime) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ColabRuntime) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ColabRuntime) MoveFromId(id *string) {
...
func (c *jsiiProxy_ColabRuntime) MoveToId(id *string) {
...
func (c *jsiiProxy_ColabRuntime) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ColabRuntime) PutNotebookRuntimeTemplateRef(value *ColabRuntimeNotebookRuntimeTemplateRef) {
	if err := c.validatePutNotebookRuntimeTemplateRefParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ColabRuntime) PutTimeouts(value *ColabRuntimeTimeouts) {
...
func (c *jsiiProxy_ColabRuntime) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ResetName() {
	_jsii_.InvokeVoid(
		c,
		"resetName",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ResetNotebookRuntimeTemplateRef() {
	_jsii_.InvokeVoid(
		c,
		"resetNotebookRuntimeTemplateRef",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ColabRuntime) ToString() *string {
	var returns *string
