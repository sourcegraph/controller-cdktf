...
func (j *jsiiProxy_ComputeHaVpnGatewayVpnInterfacesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewComputeHaVpnGatewayVpnInterfacesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeHaVpnGatewayVpnInterfacesList {
	_init_.Initialize()
...
func NewComputeHaVpnGatewayVpnInterfacesList_Override(c ComputeHaVpnGatewayVpnInterfacesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeHaVpnGatewayVpnInterfacesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeHaVpnGatewayVpnInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeHaVpnGatewayVpnInterfacesList) Resolve(_context cdktf.IResolveContext) interface{} {
