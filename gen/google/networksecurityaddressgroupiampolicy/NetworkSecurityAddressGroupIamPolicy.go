...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/networksecurityaddressgroupiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/network_security_address_group_iam_policy google_network_security_address_group_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/network_security_address_group_iam_policy google_network_security_address_group_iam_policy} Resource.
func NewNetworkSecurityAddressGroupIamPolicy(scope constructs.Construct, id *string, config *NetworkSecurityAddressGroupIamPolicyConfig) NetworkSecurityAddressGroupIamPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-google.networkSecurityAddressGroupIamPolicy.NetworkSecurityAddressGroupIamPolicy",
