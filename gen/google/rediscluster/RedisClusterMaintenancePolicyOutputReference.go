...
type RedisClusterMaintenancePolicyOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *RedisClusterMaintenancePolicy
	SetInternalValue(val *RedisClusterMaintenancePolicy)
	// Experimental.
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) InternalValue() *RedisClusterMaintenancePolicy {
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) WeeklyMaintenanceWindow() RedisClusterMaintenancePolicyWeeklyMaintenanceWindowList {
	var returns RedisClusterMaintenancePolicyWeeklyMaintenanceWindowList
	_jsii_.Get(
		j,
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) ResetWeeklyMaintenanceWindow() {
	_jsii_.InvokeVoid(
		r,
		"resetWeeklyMaintenanceWindow",
		nil, // no parameters
...
func (r *jsiiProxy_RedisClusterMaintenancePolicyOutputReference) ToString() *string {
	var returns *string
