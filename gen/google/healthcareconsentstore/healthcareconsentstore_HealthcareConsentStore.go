...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/healthcareconsentstore/internal"
)
...
func (j *jsiiProxy_HealthcareConsentStore) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_HealthcareConsentStore)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
