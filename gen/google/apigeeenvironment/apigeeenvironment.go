...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/apigee_environment google_apigee_environment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/apigee_environment google_apigee_environment} Resource.
...
func ApigeeEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateApigeeEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApigeeEnvironment) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApigeeEnvironment) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApigeeEnvironment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApigeeEnvironment) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApigeeEnvironment) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApigeeEnvironment) MoveToId(id *string) {
...
func (a *jsiiProxy_ApigeeEnvironment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApigeeEnvironment) ToHclTerraform() interface{} {
	var returns interface{}
