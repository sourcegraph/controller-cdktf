...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_node_group google_compute_node_group}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/compute_node_group google_compute_node_group} Resource.
...
func ComputeNodeGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeNodeGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeNodeGroup) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeNodeGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeNodeGroup) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeNodeGroup) MoveToId(id *string) {
