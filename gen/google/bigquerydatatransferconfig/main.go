...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataRefreshWindowDays", GoGetter: "DataRefreshWindowDays"},
			_jsii_.MemberProperty{JsiiProperty: "dataRefreshWindowDaysInput", GoGetter: "DataRefreshWindowDaysInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationDatasetId", GoGetter: "DestinationDatasetId"},
			_jsii_.MemberProperty{JsiiProperty: "destinationDatasetIdInput", GoGetter: "DestinationDatasetIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "emailPreferences", GoGetter: "EmailPreferences"},
			_jsii_.MemberProperty{JsiiProperty: "emailPreferencesInput", GoGetter: "EmailPreferencesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "notificationPubsubTopic", GoGetter: "NotificationPubsubTopic"},
			_jsii_.MemberProperty{JsiiProperty: "notificationPubsubTopicInput", GoGetter: "NotificationPubsubTopicInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putEmailPreferences", GoMethod: "PutEmailPreferences"},
			_jsii_.MemberMethod{JsiiMethod: "putScheduleOptions", GoMethod: "PutScheduleOptions"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEmailPreferences", GoMethod: "ResetEmailPreferences"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocation", GoMethod: "ResetLocation"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotificationPubsubTopic", GoMethod: "ResetNotificationPubsubTopic"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProject", GoMethod: "ResetProject"},
			_jsii_.MemberMethod{JsiiMethod: "resetSchedule", GoMethod: "ResetSchedule"},
			_jsii_.MemberMethod{JsiiMethod: "resetScheduleOptions", GoMethod: "ResetScheduleOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetSensitiveParams", GoMethod: "ResetSensitiveParams"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scheduleOptions", GoGetter: "ScheduleOptions"},
			_jsii_.MemberProperty{JsiiProperty: "scheduleOptionsInput", GoGetter: "ScheduleOptionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "sensitiveParams", GoGetter: "SensitiveParams"},
			_jsii_.MemberProperty{JsiiProperty: "sensitiveParamsInput", GoGetter: "SensitiveParamsInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableFailureEmail", GoGetter: "EnableFailureEmail"},
			_jsii_.MemberProperty{JsiiProperty: "enableFailureEmailInput", GoGetter: "EnableFailureEmailInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "disableAutoScheduling", GoGetter: "DisableAutoScheduling"},
			_jsii_.MemberProperty{JsiiProperty: "disableAutoSchedulingInput", GoGetter: "DisableAutoSchedulingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisableAutoScheduling", GoMethod: "ResetDisableAutoScheduling"},
