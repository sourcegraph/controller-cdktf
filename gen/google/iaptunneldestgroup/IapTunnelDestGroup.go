...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/iaptunneldestgroup/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/iap_tunnel_dest_group google_iap_tunnel_dest_group}.
...
func (j *jsiiProxy_IapTunnelDestGroup) Cidrs() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"cidrs",
...
func (j *jsiiProxy_IapTunnelDestGroup) CidrsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"cidrsInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IapTunnelDestGroup) Fqdns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"fqdns",
...
func (j *jsiiProxy_IapTunnelDestGroup) FqdnsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"fqdnsInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IapTunnelDestGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IapTunnelDestGroup) GroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupName",
...
func (j *jsiiProxy_IapTunnelDestGroup) GroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupNameInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IapTunnelDestGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_IapTunnelDestGroup) Node() constructs.Node {
...
func (j *jsiiProxy_IapTunnelDestGroup) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_IapTunnelDestGroup) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_IapTunnelDestGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_IapTunnelDestGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IapTunnelDestGroup) Timeouts() IapTunnelDestGroupTimeoutsOutputReference {
	var returns IapTunnelDestGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/iap_tunnel_dest_group google_iap_tunnel_dest_group} Resource.
func NewIapTunnelDestGroup(scope constructs.Construct, id *string, config *IapTunnelDestGroupConfig) IapTunnelDestGroup {
	_init_.Initialize()

	if err := validateNewIapTunnelDestGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IapTunnelDestGroup_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.iapTunnelDestGroup.IapTunnelDestGroup",
...
func (i *jsiiProxy_IapTunnelDestGroup) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IapTunnelDestGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IapTunnelDestGroup) MoveFromId(id *string) {
...
func (i *jsiiProxy_IapTunnelDestGroup) MoveToId(id *string) {
...
func (i *jsiiProxy_IapTunnelDestGroup) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IapTunnelDestGroup) PutTimeouts(value *IapTunnelDestGroupTimeouts) {
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetCidrs() {
	_jsii_.InvokeVoid(
		i,
		"resetCidrs",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetFqdns() {
	_jsii_.InvokeVoid(
		i,
		"resetFqdns",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetProject() {
	_jsii_.InvokeVoid(
		i,
		"resetProject",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		i,
		"resetRegion",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeouts",
		nil, // no parameters
...
func (i *jsiiProxy_IapTunnelDestGroup) ToString() *string {
	var returns *string
