...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/bigquerycapacitycommitment/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/bigquery_capacity_commitment google_bigquery_capacity_commitment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/bigquery_capacity_commitment google_bigquery_capacity_commitment} Resource.
...
func (b *jsiiProxy_BigqueryCapacityCommitment) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BigqueryCapacityCommitment) MoveFromId(id *string) {
...
func (b *jsiiProxy_BigqueryCapacityCommitment) MoveToId(id *string) {
