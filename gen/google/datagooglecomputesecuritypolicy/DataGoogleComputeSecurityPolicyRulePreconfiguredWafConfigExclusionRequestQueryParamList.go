...
func (d *jsiiProxy_DataGoogleComputeSecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParamList) Resolve(_context cdktf.IResolveContext) interface{} {
