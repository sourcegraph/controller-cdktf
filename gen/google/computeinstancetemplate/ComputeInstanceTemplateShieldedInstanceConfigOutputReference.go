...
func (c *jsiiProxy_ComputeInstanceTemplateShieldedInstanceConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateShieldedInstanceConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
