...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/gke_backup_restore_plan google_gke_backup_restore_plan}.
type GkeBackupRestorePlan interface {
	...
	PutRestoreConfig(value *GkeBackupRestorePlanRestoreConfig)
	PutTimeouts(value *GkeBackupRestorePlanTimeouts)
	ResetDescription()
	ResetId()
	ResetLabels()
...
func (j *jsiiProxy_GkeBackupRestorePlan) BackupPlanInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"backupPlanInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Cluster() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cluster",
...
func (j *jsiiProxy_GkeBackupRestorePlan) ClusterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GkeBackupRestorePlan) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GkeBackupRestorePlan) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GkeBackupRestorePlan) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Labels() *map[string]*string {
...
func (j *jsiiProxy_GkeBackupRestorePlan) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GkeBackupRestorePlan) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GkeBackupRestorePlan) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) Node() constructs.Node {
...
func (j *jsiiProxy_GkeBackupRestorePlan) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GkeBackupRestorePlan) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GkeBackupRestorePlan) RestoreConfig() GkeBackupRestorePlanRestoreConfigOutputReference {
	var returns GkeBackupRestorePlanRestoreConfigOutputReference
	_jsii_.Get(
		j,
		"restoreConfig",
		&returns,
...
func (j *jsiiProxy_GkeBackupRestorePlan) RestoreConfigInput() *GkeBackupRestorePlanRestoreConfig {
...
func (j *jsiiProxy_GkeBackupRestorePlan) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_GkeBackupRestorePlan) StateReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateReason",
...
func (j *jsiiProxy_GkeBackupRestorePlan) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GkeBackupRestorePlan) Timeouts() GkeBackupRestorePlanTimeoutsOutputReference {
	var returns GkeBackupRestorePlanTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GkeBackupRestorePlan) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/gke_backup_restore_plan google_gke_backup_restore_plan} Resource.
func NewGkeBackupRestorePlan(scope constructs.Construct, id *string, config *GkeBackupRestorePlanConfig) GkeBackupRestorePlan {
	_init_.Initialize()

	if err := validateNewGkeBackupRestorePlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GkeBackupRestorePlan) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GkeBackupRestorePlan) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GkeBackupRestorePlan) MoveFromId(id *string) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) MoveToId(id *string) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) PutRestoreConfig(value *GkeBackupRestorePlanRestoreConfig) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) PutTimeouts(value *GkeBackupRestorePlanTimeouts) {
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GkeBackupRestorePlan) ToString() *string {
	var returns *string
