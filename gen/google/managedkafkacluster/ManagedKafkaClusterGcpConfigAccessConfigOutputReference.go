...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) InternalValue() *ManagedKafkaClusterGcpConfigAccessConfig {
...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) NetworkConfigs() ManagedKafkaClusterGcpConfigAccessConfigNetworkConfigsList {
	var returns ManagedKafkaClusterGcpConfigAccessConfigNetworkConfigsList
	_jsii_.Get(
		j,
		"networkConfigs",
		&returns,
...
func (j *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedKafkaClusterGcpConfigAccessConfigOutputReference) ToString() *string {
	var returns *string
