...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/compute_reservation google_compute_reservation}.
...
func (j *jsiiProxy_DataGoogleComputeReservation) Commitment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commitment",
...
func (j *jsiiProxy_DataGoogleComputeReservation) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_DataGoogleComputeReservation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleComputeReservation) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataGoogleComputeReservation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleComputeReservation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleComputeReservation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleComputeReservation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleComputeReservation) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleComputeReservation) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleComputeReservation) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleComputeReservation) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleComputeReservation) ShareSettings() DataGoogleComputeReservationShareSettingsList {
	var returns DataGoogleComputeReservationShareSettingsList
	_jsii_.Get(
		j,
		"shareSettings",
		&returns,
...
func (j *jsiiProxy_DataGoogleComputeReservation) SpecificReservation() DataGoogleComputeReservationSpecificReservationList {
	var returns DataGoogleComputeReservationSpecificReservationList
	_jsii_.Get(
		j,
		"specificReservation",
		&returns,
...
func (j *jsiiProxy_DataGoogleComputeReservation) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataGoogleComputeReservation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleComputeReservation) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_DataGoogleComputeReservation) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/data-sources/compute_reservation google_compute_reservation} Data Source.
func NewDataGoogleComputeReservation(scope constructs.Construct, id *string, config *DataGoogleComputeReservationConfig) DataGoogleComputeReservation {
	...
	if err := validateNewDataGoogleComputeReservationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleComputeReservation_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleComputeReservation.DataGoogleComputeReservation",
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleComputeReservation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleComputeReservation) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleComputeReservation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeReservation) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleComputeReservation) ToString() *string {
	var returns *string
