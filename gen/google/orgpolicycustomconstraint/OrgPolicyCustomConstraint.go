...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/org_policy_custom_constraint google_org_policy_custom_constraint}.
type OrgPolicyCustomConstraint interface {
	...
	PutTimeouts(value *OrgPolicyCustomConstraintTimeouts)
	ResetDescription()
	ResetDisplayName()
	ResetId()
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) ActionTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"actionTypeInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Condition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"condition",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) ConditionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"conditionInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) MethodTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"methodTypes",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) MethodTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"methodTypesInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Node() constructs.Node {
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) ResourceTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypes",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) ResourceTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypesInput",
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) Timeouts() OrgPolicyCustomConstraintTimeoutsOutputReference {
	var returns OrgPolicyCustomConstraintTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_OrgPolicyCustomConstraint) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/org_policy_custom_constraint google_org_policy_custom_constraint} Resource.
func NewOrgPolicyCustomConstraint(scope constructs.Construct, id *string, config *OrgPolicyCustomConstraintConfig) OrgPolicyCustomConstraint {
	...
	if err := validateNewOrgPolicyCustomConstraintParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/org_policy_custom_constraint google_org_policy_custom_constraint} Resource.
func NewOrgPolicyCustomConstraint_Override(o OrgPolicyCustomConstraint, scope constructs.Construct, id *string, config *OrgPolicyCustomConstraintConfig) {
	_init_.Initialize()
...
func OrgPolicyCustomConstraint_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.orgPolicyCustomConstraint.OrgPolicyCustomConstraint",
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetStringAttribute(terraformAttribute *string) *string {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) MoveToId(id *string) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) OverrideLogicalId(newLogicalId *string) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) PutTimeouts(value *OrgPolicyCustomConstraintTimeouts) {
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetDescription() {
	_jsii_.InvokeVoid(
		o,
		"resetDescription",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetDisplayName() {
	_jsii_.InvokeVoid(
		o,
		"resetDisplayName",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		o,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ResetTimeouts() {
	_jsii_.InvokeVoid(
		o,
		"resetTimeouts",
		nil, // no parameters
...
func (o *jsiiProxy_OrgPolicyCustomConstraint) ToString() *string {
	var returns *string
