...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/folder_access_approval_settings google_folder_access_approval_settings}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/folder_access_approval_settings google_folder_access_approval_settings} Resource.
...
func FolderAccessApprovalSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFolderAccessApprovalSettings_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FolderAccessApprovalSettings) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FolderAccessApprovalSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FolderAccessApprovalSettings) MoveFromId(id *string) {
...
func (f *jsiiProxy_FolderAccessApprovalSettings) MoveToId(id *string) {
