...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/dns_record_set google_dns_record_set}.
type DnsRecordSet interface {
	...
	PutRoutingPolicy(value *DnsRecordSetRoutingPolicy)
	ResetId()
...
func (j *jsiiProxy_DnsRecordSet) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DnsRecordSet) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DnsRecordSet) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DnsRecordSet) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DnsRecordSet) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DnsRecordSet) ManagedZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managedZone",
...
func (j *jsiiProxy_DnsRecordSet) ManagedZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managedZoneInput",
...
func (j *jsiiProxy_DnsRecordSet) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DnsRecordSet) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DnsRecordSet) Node() constructs.Node {
...
func (j *jsiiProxy_DnsRecordSet) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DnsRecordSet) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DnsRecordSet) RoutingPolicy() DnsRecordSetRoutingPolicyOutputReference {
	var returns DnsRecordSetRoutingPolicyOutputReference
	_jsii_.Get(
		j,
		"routingPolicy",
		&returns,
...
func (j *jsiiProxy_DnsRecordSet) RoutingPolicyInput() *DnsRecordSetRoutingPolicy {
...
func (j *jsiiProxy_DnsRecordSet) Rrdatas() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rrdatas",
...
func (j *jsiiProxy_DnsRecordSet) RrdatasInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rrdatasInput",
...
func (j *jsiiProxy_DnsRecordSet) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsRecordSet) Ttl() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"ttl",
...
func (j *jsiiProxy_DnsRecordSet) TtlInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"ttlInput",
...
func (j *jsiiProxy_DnsRecordSet) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DnsRecordSet) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/dns_record_set google_dns_record_set} Resource.
func NewDnsRecordSet(scope constructs.Construct, id *string, config *DnsRecordSetConfig) DnsRecordSet {
	_init_.Initialize()

	if err := validateNewDnsRecordSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DnsRecordSet) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DnsRecordSet) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DnsRecordSet) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DnsRecordSet) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DnsRecordSet) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DnsRecordSet) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DnsRecordSet) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DnsRecordSet) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DnsRecordSet) MoveFromId(id *string) {
...
func (d *jsiiProxy_DnsRecordSet) MoveToId(id *string) {
...
func (d *jsiiProxy_DnsRecordSet) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DnsRecordSet) PutRoutingPolicy(value *DnsRecordSetRoutingPolicy) {
	if err := d.validatePutRoutingPolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DnsRecordSet) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ResetRoutingPolicy() {
	_jsii_.InvokeVoid(
		d,
		"resetRoutingPolicy",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ResetRrdatas() {
	_jsii_.InvokeVoid(
		d,
		"resetRrdatas",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ResetTtl() {
	_jsii_.InvokeVoid(
		d,
		"resetTtl",
		nil, // no parameters
...
func (d *jsiiProxy_DnsRecordSet) ToString() *string {
	var returns *string
