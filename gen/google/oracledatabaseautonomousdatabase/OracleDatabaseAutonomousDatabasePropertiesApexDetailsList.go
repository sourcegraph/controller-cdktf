...
func (j *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesApexDetailsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewOracleDatabaseAutonomousDatabasePropertiesApexDetailsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OracleDatabaseAutonomousDatabasePropertiesApexDetailsList {
	_init_.Initialize()
...
func NewOracleDatabaseAutonomousDatabasePropertiesApexDetailsList_Override(o OracleDatabaseAutonomousDatabasePropertiesApexDetailsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesApexDetailsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (o *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesApexDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
