...
func (j *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference {
	_init_.Initialize()
...
func NewOracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference_Override(o OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (o *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (o *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OracleDatabaseAutonomousDatabasePropertiesLocalStandbyDbOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
