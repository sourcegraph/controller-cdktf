...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) InternalValue() interface{} {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList)SetWrapsSet(val *bool) {
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) Get(index *float64) WorkbenchInstanceGceSetupServiceAccountsOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WorkbenchInstanceGceSetupServiceAccountsOutputReference
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupServiceAccountsList) ToString() *string {
	var returns *string
