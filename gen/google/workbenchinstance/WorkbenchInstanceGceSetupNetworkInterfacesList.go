...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) Get(index *float64) WorkbenchInstanceGceSetupNetworkInterfacesOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WorkbenchInstanceGceSetupNetworkInterfacesOutputReference
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesList) ToString() *string {
	var returns *string
