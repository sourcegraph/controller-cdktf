...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/site_verification_web_resource google_site_verification_web_resource}.
type SiteVerificationWebResource interface {
	...
	PutSite(value *SiteVerificationWebResourceSite)
	PutTimeouts(value *SiteVerificationWebResourceTimeouts)
	ResetId()
...
func (j *jsiiProxy_SiteVerificationWebResource) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SiteVerificationWebResource) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SiteVerificationWebResource) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SiteVerificationWebResource) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SiteVerificationWebResource) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SiteVerificationWebResource) Node() constructs.Node {
...
func (j *jsiiProxy_SiteVerificationWebResource) Owners() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"owners",
...
func (j *jsiiProxy_SiteVerificationWebResource) Site() SiteVerificationWebResourceSiteOutputReference {
	var returns SiteVerificationWebResourceSiteOutputReference
	_jsii_.Get(
		j,
		"site",
		&returns,
...
func (j *jsiiProxy_SiteVerificationWebResource) SiteInput() *SiteVerificationWebResourceSite {
	var returns *SiteVerificationWebResourceSite
	_jsii_.Get(
		j,
		"siteInput",
		&returns,
...
func (j *jsiiProxy_SiteVerificationWebResource) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SiteVerificationWebResource) Timeouts() SiteVerificationWebResourceTimeoutsOutputReference {
	var returns SiteVerificationWebResourceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_SiteVerificationWebResource) VerificationMethod() *string {
	var returns *string
	_jsii_.Get(
		j,
		"verificationMethod",
...
func (j *jsiiProxy_SiteVerificationWebResource) VerificationMethodInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SiteVerificationWebResource) WebResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"webResourceId",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/site_verification_web_resource google_site_verification_web_resource} Resource.
func NewSiteVerificationWebResource(scope constructs.Construct, id *string, config *SiteVerificationWebResourceConfig) SiteVerificationWebResource {
	...
	if err := validateNewSiteVerificationWebResourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SiteVerificationWebResource_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.siteVerificationWebResource.SiteVerificationWebResource",
...
func (s *jsiiProxy_SiteVerificationWebResource) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SiteVerificationWebResource) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SiteVerificationWebResource) MoveFromId(id *string) {
...
func (s *jsiiProxy_SiteVerificationWebResource) MoveToId(id *string) {
...
func (s *jsiiProxy_SiteVerificationWebResource) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SiteVerificationWebResource) PutSite(value *SiteVerificationWebResourceSite) {
	if err := s.validatePutSiteParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SiteVerificationWebResource) PutTimeouts(value *SiteVerificationWebResourceTimeouts) {
...
func (s *jsiiProxy_SiteVerificationWebResource) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SiteVerificationWebResource) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SiteVerificationWebResource) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SiteVerificationWebResource) ToString() *string {
	var returns *string
