...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagoogleserviceaccountidtoken/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/data-sources/service_account_id_token google_service_account_id_token}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/data-sources/service_account_id_token google_service_account_id_token} Data Source.
func NewDataGoogleServiceAccountIdToken(scope constructs.Construct, id *string, config *DataGoogleServiceAccountIdTokenConfig) DataGoogleServiceAccountIdToken {
	...
	_jsii_.Create(
		"google.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
