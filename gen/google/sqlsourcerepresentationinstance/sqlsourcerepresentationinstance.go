...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/sqlsourcerepresentationinstance/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/sql_source_representation_instance google_sql_source_representation_instance}.
...
type jsiiProxy_SqlSourceRepresentationInstance struct {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) DatabaseVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseVersion",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) DatabaseVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Host() *string {
	var returns *string
	_jsii_.Get(
		j,
		"host",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) HostInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Node() constructs.Node {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Port() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"port",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) PortInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"portInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlSourceRepresentationInstance) Timeouts() SqlSourceRepresentationInstanceTimeoutsOutputReference {
	var returns SqlSourceRepresentationInstanceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/sql_source_representation_instance google_sql_source_representation_instance} Resource.
func NewSqlSourceRepresentationInstance(scope constructs.Construct, id *string, config *SqlSourceRepresentationInstanceConfig) SqlSourceRepresentationInstance {
	...
	if err := validateNewSqlSourceRepresentationInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SqlSourceRepresentationInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSqlSourceRepresentationInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) MoveFromId(id *string) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) MoveToId(id *string) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) PutTimeouts(value *SqlSourceRepresentationInstanceTimeouts) {
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ResetPort() {
	_jsii_.InvokeVoid(
		s,
		"resetPort",
		nil, // no parameters
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		s,
		"resetRegion",
		nil, // no parameters
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_SqlSourceRepresentationInstance) ToString() *string {
	var returns *string
