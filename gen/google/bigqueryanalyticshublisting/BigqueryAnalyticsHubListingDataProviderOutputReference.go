...
type BigqueryAnalyticsHubListingDataProviderOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *BigqueryAnalyticsHubListingDataProvider
	SetInternalValue(val *BigqueryAnalyticsHubListingDataProvider)
	Name() *string
	SetName(val *string)
	NameInput() *string
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) InternalValue() *BigqueryAnalyticsHubListingDataProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) PrimaryContact() *string {
	var returns *string
	_jsii_.Get(
		j,
		"primaryContact",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) PrimaryContactInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"primaryContactInput",
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) ResetPrimaryContact() {
	_jsii_.InvokeVoid(
		b,
		"resetPrimaryContact",
		nil, // no parameters
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingDataProviderOutputReference) ToString() *string {
	var returns *string
