...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Node() constructs.Node {
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Service() *string {
	var returns *string
	_jsii_.Get(
		j,
		"service",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) ServiceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceInput",
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Split() AppEngineServiceSplitTrafficSplitOutputReference {
	var returns AppEngineServiceSplitTrafficSplitOutputReference
	_jsii_.Get(
		j,
		"split",
		&returns,
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) SplitInput() *AppEngineServiceSplitTrafficSplit {
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic) Timeouts() AppEngineServiceSplitTrafficTimeoutsOutputReference {
	var returns AppEngineServiceSplitTrafficTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewAppEngineServiceSplitTraffic(scope constructs.Construct, id *string, config *AppEngineServiceSplitTrafficConfig) AppEngineServiceSplitTraffic {
	...
	if err := validateNewAppEngineServiceSplitTrafficParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AppEngineServiceSplitTraffic)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func AppEngineServiceSplitTraffic_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.appEngineServiceSplitTraffic.AppEngineServiceSplitTraffic",
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) PutSplit(value *AppEngineServiceSplitTrafficSplit) {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) PutTimeouts(value *AppEngineServiceSplitTrafficTimeouts) {
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ResetMigrateTraffic() {
	_jsii_.InvokeVoid(
		a,
		"resetMigrateTraffic",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ResetProject() {
	_jsii_.InvokeVoid(
		a,
		"resetProject",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineServiceSplitTraffic) ToString() *string {
	var returns *string
