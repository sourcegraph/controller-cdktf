...
func init() {
	_jsii_.RegisterClass(
		"google.dataGoogleOrganization.DataGoogleOrganization",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "directoryCustomerId", GoGetter: "DirectoryCustomerId"},
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleOrganization.DataGoogleOrganizationConfig",
