...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagooglesqldatabase/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/data-sources/sql_database google_sql_database}.
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Charset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"charset",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Collation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collation",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Instance() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instance",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) InstanceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceInput",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleSqlDatabase) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_DataGoogleSqlDatabase) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/data-sources/sql_database google_sql_database} Data Source.
func NewDataGoogleSqlDatabase(scope constructs.Construct, id *string, config *DataGoogleSqlDatabaseConfig) DataGoogleSqlDatabase {
	...
	if err := validateNewDataGoogleSqlDatabaseParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleSqlDatabase{}

	_jsii_.Create(
		"google.dataGoogleSqlDatabase.DataGoogleSqlDatabase",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/data-sources/sql_database google_sql_database} Data Source.
func NewDataGoogleSqlDatabase_Override(d DataGoogleSqlDatabase, scope constructs.Construct, id *string, config *DataGoogleSqlDatabaseConfig) {
	_init_.Initialize()
...
func DataGoogleSqlDatabase_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.dataGoogleSqlDatabase.DataGoogleSqlDatabase",
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleSqlDatabase) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSqlDatabase) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSqlDatabase) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleSqlDatabase) ToString() *string {
	var returns *string
