...
func (d *jsiiProxy_DataGoogleComputeInstanceReservationAffinitySpecificReservationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
