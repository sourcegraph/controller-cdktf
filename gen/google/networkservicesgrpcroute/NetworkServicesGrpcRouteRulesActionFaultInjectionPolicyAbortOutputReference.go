...
func (n *jsiiProxy_NetworkServicesGrpcRouteRulesActionFaultInjectionPolicyAbortOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesGrpcRouteRulesActionFaultInjectionPolicyAbortOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
