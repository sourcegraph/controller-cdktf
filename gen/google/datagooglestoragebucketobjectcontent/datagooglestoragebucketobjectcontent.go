...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/storage_bucket_object_content google_storage_bucket_object_content}.
...
func (j *jsiiProxy_DataGoogleStorageBucketObjectContent) ContentBase64() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64",
...
func (j *jsiiProxy_DataGoogleStorageBucketObjectContent) Generation() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"generation",
...
func (j *jsiiProxy_DataGoogleStorageBucketObjectContent) Md5Hexhash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5Hexhash",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/storage_bucket_object_content google_storage_bucket_object_content} Data Source.
