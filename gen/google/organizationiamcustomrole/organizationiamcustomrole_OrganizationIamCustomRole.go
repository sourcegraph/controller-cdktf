...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/organizationiamcustomrole/internal"
)
...
func (j *jsiiProxy_OrganizationIamCustomRole) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_OrganizationIamCustomRole) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OrganizationIamCustomRole) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_OrganizationIamCustomRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Node() constructs.Node {
...
func (j *jsiiProxy_OrganizationIamCustomRole) OrgId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgId",
...
func (j *jsiiProxy_OrganizationIamCustomRole) OrgIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgIdInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Permissions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissions",
...
func (j *jsiiProxy_OrganizationIamCustomRole) PermissionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissionsInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) RoleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleId",
...
func (j *jsiiProxy_OrganizationIamCustomRole) RoleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleIdInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) Stage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stage",
...
func (j *jsiiProxy_OrganizationIamCustomRole) StageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stageInput",
...
func (j *jsiiProxy_OrganizationIamCustomRole) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrganizationIamCustomRole) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_OrganizationIamCustomRole) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
func NewOrganizationIamCustomRole(scope constructs.Construct, id *string, config *OrganizationIamCustomRoleConfig) OrganizationIamCustomRole {
	...
	if err := validateNewOrganizationIamCustomRoleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func OrganizationIamCustomRole_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.organizationIamCustomRole.OrganizationIamCustomRole",
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetStringAttribute(terraformAttribute *string) *string {
...
func (o *jsiiProxy_OrganizationIamCustomRole) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (o *jsiiProxy_OrganizationIamCustomRole) OverrideLogicalId(newLogicalId *string) {
...
func (o *jsiiProxy_OrganizationIamCustomRole) ResetDescription() {
	_jsii_.InvokeVoid(
		o,
		"resetDescription",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationIamCustomRole) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationIamCustomRole) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		o,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationIamCustomRole) ResetStage() {
	_jsii_.InvokeVoid(
		o,
		"resetStage",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationIamCustomRole) ToString() *string {
	var returns *string
