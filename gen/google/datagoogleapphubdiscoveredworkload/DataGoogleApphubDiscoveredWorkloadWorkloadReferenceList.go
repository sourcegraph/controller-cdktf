...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagoogleapphubdiscoveredworkload/internal"
)
...
func (d *jsiiProxy_DataGoogleApphubDiscoveredWorkloadWorkloadReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
