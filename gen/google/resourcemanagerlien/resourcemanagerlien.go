...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/resourcemanagerlien/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/resource_manager_lien google_resource_manager_lien}.
...
func (j *jsiiProxy_ResourceManagerLien) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_ResourceManagerLien) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ResourceManagerLien) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ResourceManagerLien) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ResourceManagerLien) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ResourceManagerLien) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ResourceManagerLien) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ResourceManagerLien) Node() constructs.Node {
...
func (j *jsiiProxy_ResourceManagerLien) Origin() *string {
	var returns *string
	_jsii_.Get(
		j,
		"origin",
...
func (j *jsiiProxy_ResourceManagerLien) OriginInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"originInput",
...
func (j *jsiiProxy_ResourceManagerLien) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_ResourceManagerLien) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_ResourceManagerLien) Reason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reason",
...
func (j *jsiiProxy_ResourceManagerLien) ReasonInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reasonInput",
...
func (j *jsiiProxy_ResourceManagerLien) Restrictions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"restrictions",
...
func (j *jsiiProxy_ResourceManagerLien) RestrictionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"restrictionsInput",
...
func (j *jsiiProxy_ResourceManagerLien) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ResourceManagerLien) Timeouts() ResourceManagerLienTimeoutsOutputReference {
	var returns ResourceManagerLienTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/resource_manager_lien google_resource_manager_lien} Resource.
func NewResourceManagerLien(scope constructs.Construct, id *string, config *ResourceManagerLienConfig) ResourceManagerLien {
	_init_.Initialize()

	if err := validateNewResourceManagerLienParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ResourceManagerLien_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.resourceManagerLien.ResourceManagerLien",
...
func (r *jsiiProxy_ResourceManagerLien) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourceManagerLien) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_ResourceManagerLien) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_ResourceManagerLien) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_ResourceManagerLien) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_ResourceManagerLien) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_ResourceManagerLien) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_ResourceManagerLien) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_ResourceManagerLien) MoveFromId(id *string) {
...
func (r *jsiiProxy_ResourceManagerLien) MoveToId(id *string) {
...
func (r *jsiiProxy_ResourceManagerLien) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_ResourceManagerLien) PutTimeouts(value *ResourceManagerLienTimeouts) {
...
func (r *jsiiProxy_ResourceManagerLien) ResetId() {
	_jsii_.InvokeVoid(
		r,
		"resetId",
		nil, // no parameters
...
func (r *jsiiProxy_ResourceManagerLien) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_ResourceManagerLien) ResetTimeouts() {
	_jsii_.InvokeVoid(
		r,
		"resetTimeouts",
		nil, // no parameters
...
func (r *jsiiProxy_ResourceManagerLien) ToString() *string {
	var returns *string
