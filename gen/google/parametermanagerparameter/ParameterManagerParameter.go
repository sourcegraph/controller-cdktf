...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/parameter_manager_parameter google_parameter_manager_parameter}.
type ParameterManagerParameter interface {
	...
	PolicyMember() ParameterManagerParameterPolicyMemberList
	Project() *string
	...
	PutTimeouts(value *ParameterManagerParameterTimeouts)
	ResetFormat()
	ResetId()
	ResetKmsKey()
	ResetLabels()
...
func (j *jsiiProxy_ParameterManagerParameter) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_ParameterManagerParameter) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ParameterManagerParameter) Format() *string {
	var returns *string
	_jsii_.Get(
		j,
		"format",
...
func (j *jsiiProxy_ParameterManagerParameter) FormatInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"formatInput",
...
func (j *jsiiProxy_ParameterManagerParameter) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ParameterManagerParameter) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ParameterManagerParameter) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ParameterManagerParameter) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ParameterManagerParameter) KmsKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKey",
...
func (j *jsiiProxy_ParameterManagerParameter) KmsKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyInput",
...
func (j *jsiiProxy_ParameterManagerParameter) Labels() *map[string]*string {
...
func (j *jsiiProxy_ParameterManagerParameter) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_ParameterManagerParameter) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ParameterManagerParameter) Node() constructs.Node {
...
func (j *jsiiProxy_ParameterManagerParameter) ParameterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterId",
...
func (j *jsiiProxy_ParameterManagerParameter) ParameterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterIdInput",
...
func (j *jsiiProxy_ParameterManagerParameter) PolicyMember() ParameterManagerParameterPolicyMemberList {
	var returns ParameterManagerParameterPolicyMemberList
	_jsii_.Get(
		j,
		"policyMember",
		&returns,
...
func (j *jsiiProxy_ParameterManagerParameter) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ParameterManagerParameter) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ParameterManagerParameter) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ParameterManagerParameter) Timeouts() ParameterManagerParameterTimeoutsOutputReference {
	var returns ParameterManagerParameterTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ParameterManagerParameter) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.32.0/docs/resources/parameter_manager_parameter google_parameter_manager_parameter} Resource.
func NewParameterManagerParameter(scope constructs.Construct, id *string, config *ParameterManagerParameterConfig) ParameterManagerParameter {
	...
	if err := validateNewParameterManagerParameterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ParameterManagerParameter_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.parameterManagerParameter.ParameterManagerParameter",
...
func (p *jsiiProxy_ParameterManagerParameter) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ParameterManagerParameter) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_ParameterManagerParameter) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_ParameterManagerParameter) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_ParameterManagerParameter) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_ParameterManagerParameter) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_ParameterManagerParameter) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_ParameterManagerParameter) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_ParameterManagerParameter) MoveFromId(id *string) {
...
func (p *jsiiProxy_ParameterManagerParameter) MoveToId(id *string) {
...
func (p *jsiiProxy_ParameterManagerParameter) OverrideLogicalId(newLogicalId *string) {
...
func (p *jsiiProxy_ParameterManagerParameter) PutTimeouts(value *ParameterManagerParameterTimeouts) {
...
func (p *jsiiProxy_ParameterManagerParameter) ResetFormat() {
	_jsii_.InvokeVoid(
		p,
		"resetFormat",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetKmsKey() {
	_jsii_.InvokeVoid(
		p,
		"resetKmsKey",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetLabels() {
	_jsii_.InvokeVoid(
		p,
		"resetLabels",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		p,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetProject() {
	_jsii_.InvokeVoid(
		p,
		"resetProject",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ResetTimeouts() {
	_jsii_.InvokeVoid(
		p,
		"resetTimeouts",
		nil, // no parameters
...
func (p *jsiiProxy_ParameterManagerParameter) ToString() *string {
	var returns *string
