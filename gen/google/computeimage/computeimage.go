...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/compute_image google_compute_image}.
...
func (j *jsiiProxy_ComputeImage) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_ComputeImage) DiskSizeGb() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"diskSizeGb",
...
func (j *jsiiProxy_ComputeImage) DiskSizeGbInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"diskSizeGbInput",
...
func (j *jsiiProxy_ComputeImage) GuestOsFeatures() ComputeImageGuestOsFeaturesList {
	var returns ComputeImageGuestOsFeaturesList
	_jsii_.Get(
		j,
		"guestOsFeatures",
		&returns,
...
func (j *jsiiProxy_ComputeImage) LabelFingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelFingerprint",
...
func (j *jsiiProxy_ComputeImage) Licenses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"licenses",
...
func (j *jsiiProxy_ComputeImage) LicensesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"licensesInput",
...
func (j *jsiiProxy_ComputeImage) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputeImage) RawDisk() ComputeImageRawDiskOutputReference {
	var returns ComputeImageRawDiskOutputReference
	_jsii_.Get(
		j,
		"rawDisk",
		&returns,
...
func (j *jsiiProxy_ComputeImage) RawDiskInput() *ComputeImageRawDisk {
	var returns *ComputeImageRawDisk
	_jsii_.Get(
		j,
		"rawDiskInput",
		&returns,
...
func (j *jsiiProxy_ComputeImage) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/compute_image google_compute_image} Resource.
func NewComputeImage(scope constructs.Construct, id *string, config *ComputeImageConfig) ComputeImage {
	_init_.Initialize()

	if err := validateNewComputeImageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeImage) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeImage) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeImage) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputeImage) ResetDiskSizeGb() {
	_jsii_.InvokeVoid(
		c,
		"resetDiskSizeGb",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeImage) ResetGuestOsFeatures() {
	_jsii_.InvokeVoid(
		c,
		"resetGuestOsFeatures",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeImage) ResetLicenses() {
	_jsii_.InvokeVoid(
		c,
		"resetLicenses",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeImage) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeImage) ResetRawDisk() {
	_jsii_.InvokeVoid(
		c,
		"resetRawDisk",
		nil, // no parameters
