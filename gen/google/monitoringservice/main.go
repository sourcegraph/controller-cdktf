...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "basicService", GoGetter: "BasicService"},
			_jsii_.MemberProperty{JsiiProperty: "basicServiceInput", GoGetter: "BasicServiceInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetServiceLabels", GoMethod: "ResetServiceLabels"},
			_jsii_.MemberMethod{JsiiMethod: "resetServiceType", GoMethod: "ResetServiceType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "serviceLabels", GoGetter: "ServiceLabels"},
			_jsii_.MemberProperty{JsiiProperty: "serviceLabelsInput", GoGetter: "ServiceLabelsInput"},
