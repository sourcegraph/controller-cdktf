...
func (j *jsiiProxy_ComputeInterconnectMacsecOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ComputeInterconnectMacsecOutputReference) PreSharedKeysInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"preSharedKeysInput",
...
func (j *jsiiProxy_ComputeInterconnectMacsecOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (c *jsiiProxy_ComputeInterconnectMacsecOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (c *jsiiProxy_ComputeInterconnectMacsecOutputReference) PutPreSharedKeys(value interface{}) {
...
func (c *jsiiProxy_ComputeInterconnectMacsecOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
