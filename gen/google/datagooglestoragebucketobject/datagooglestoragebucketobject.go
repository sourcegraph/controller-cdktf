...
func (j *jsiiProxy_DataGoogleStorageBucketObject) Md5Hexhash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5Hexhash",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/data-sources/storage_bucket_object google_storage_bucket_object} Data Source.
