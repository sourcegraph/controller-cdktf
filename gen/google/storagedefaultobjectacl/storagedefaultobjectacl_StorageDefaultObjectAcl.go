...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/storagedefaultobjectacl/internal"
)
...
func (j *jsiiProxy_StorageDefaultObjectAcl) BucketInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketInput",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) Node() constructs.Node {
...
func (j *jsiiProxy_StorageDefaultObjectAcl) RoleEntity() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roleEntity",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) RoleEntityInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roleEntityInput",
...
func (j *jsiiProxy_StorageDefaultObjectAcl) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewStorageDefaultObjectAcl(scope constructs.Construct, id *string, config *StorageDefaultObjectAclConfig) StorageDefaultObjectAcl {
	...
	if err := validateNewStorageDefaultObjectAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StorageDefaultObjectAcl)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func StorageDefaultObjectAcl_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.storageDefaultObjectAcl.StorageDefaultObjectAcl",
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_StorageDefaultObjectAcl) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageDefaultObjectAcl) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageDefaultObjectAcl) ResetRoleEntity() {
	_jsii_.InvokeVoid(
		s,
		"resetRoleEntity",
		nil, // no parameters
...
func (s *jsiiProxy_StorageDefaultObjectAcl) ToString() *string {
	var returns *string
