...
type AccessContextManagerGcpUserAccessBinding interface {
	...
	ScopedAccessSettings() AccessContextManagerGcpUserAccessBindingScopedAccessSettingsList
	ScopedAccessSettingsInput() interface{}
	SessionSettings() AccessContextManagerGcpUserAccessBindingSessionSettingsOutputReference
	SessionSettingsInput() *AccessContextManagerGcpUserAccessBindingSessionSettings
	// Experimental.
...
func (j *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ScopedAccessSettings() AccessContextManagerGcpUserAccessBindingScopedAccessSettingsList {
	var returns AccessContextManagerGcpUserAccessBindingScopedAccessSettingsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ScopedAccessSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessContextManagerGcpUserAccessBinding) SessionSettings() AccessContextManagerGcpUserAccessBindingSessionSettingsOutputReference {
	var returns AccessContextManagerGcpUserAccessBindingSessionSettingsOutputReference
	_jsii_.Get(
		j,
		"sessionSettings",
		&returns,
...
func (j *jsiiProxy_AccessContextManagerGcpUserAccessBinding) SessionSettingsInput() *AccessContextManagerGcpUserAccessBindingSessionSettings {
...
func AccessContextManagerGcpUserAccessBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAccessContextManagerGcpUserAccessBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) MoveToId(id *string) {
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) PutSessionSettings(value *AccessContextManagerGcpUserAccessBindingSessionSettings) {
	if err := a.validatePutSessionSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ResetAccessLevels() {
	_jsii_.InvokeVoid(
		a,
		"resetAccessLevels",
		nil, // no parameters
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ResetScopedAccessSettings() {
	_jsii_.InvokeVoid(
		a,
		"resetScopedAccessSettings",
		nil, // no parameters
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ResetSessionSettings() {
	_jsii_.InvokeVoid(
		a,
		"resetSessionSettings",
		nil, // no parameters
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AccessContextManagerGcpUserAccessBinding) ToHclTerraform() interface{} {
	var returns interface{}
