...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "overrideStrategy", GoGetter: "OverrideStrategy"},
			_jsii_.MemberProperty{JsiiProperty: "overrideStrategyInput", GoGetter: "OverrideStrategyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSslSettings", GoMethod: "ResetSslSettings"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceRecords", GoGetter: "ResourceRecords"},
			_jsii_.MemberProperty{JsiiProperty: "sslSettings", GoGetter: "SslSettings"},
			_jsii_.MemberProperty{JsiiProperty: "sslSettingsInput", GoGetter: "SslSettingsInput"},
	...
	_jsii_.RegisterStruct(
		"google.appEngineDomainMapping.AppEngineDomainMappingConfig",
		reflect.TypeOf((*AppEngineDomainMappingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.appEngineDomainMapping.AppEngineDomainMappingResourceRecords",
		reflect.TypeOf((*AppEngineDomainMappingResourceRecords)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.appEngineDomainMapping.AppEngineDomainMappingResourceRecordsList",
	...
	_jsii_.RegisterStruct(
		"google.appEngineDomainMapping.AppEngineDomainMappingSslSettings",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "pendingManagedCertificateId", GoGetter: "PendingManagedCertificateId"},
			_jsii_.MemberMethod{JsiiMethod: "resetCertificateId", GoMethod: "ResetCertificateId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sslManagementType", GoGetter: "SslManagementType"},
			_jsii_.MemberProperty{JsiiProperty: "sslManagementTypeInput", GoGetter: "SslManagementTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"google.appEngineDomainMapping.AppEngineDomainMappingTimeouts",
