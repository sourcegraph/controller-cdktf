...
type FolderOrganizationPolicyBooleanPolicyOutputReference interface {
	...
	SetInternalValue(val *FolderOrganizationPolicyBooleanPolicy)
	// Experimental.
...
func (j *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) InternalValue() *FolderOrganizationPolicyBooleanPolicy {
...
func (j *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (f *jsiiProxy_FolderOrganizationPolicyBooleanPolicyOutputReference) ToString() *string {
	var returns *string
