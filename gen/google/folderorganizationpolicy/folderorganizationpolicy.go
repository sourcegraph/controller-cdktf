...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/folder_organization_policy google_folder_organization_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/folder_organization_policy google_folder_organization_policy} Resource.
...
func FolderOrganizationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFolderOrganizationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FolderOrganizationPolicy) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FolderOrganizationPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FolderOrganizationPolicy) MoveFromId(id *string) {
...
func (f *jsiiProxy_FolderOrganizationPolicy) MoveToId(id *string) {
