...
type VertexAiFeatureOnlineStoreBigtableOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *VertexAiFeatureOnlineStoreBigtable
	SetInternalValue(val *VertexAiFeatureOnlineStoreBigtable)
	// Experimental.
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) AutoScaling() VertexAiFeatureOnlineStoreBigtableAutoScalingOutputReference {
	var returns VertexAiFeatureOnlineStoreBigtableAutoScalingOutputReference
	_jsii_.Get(
		j,
		"autoScaling",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) AutoScalingInput() *VertexAiFeatureOnlineStoreBigtableAutoScaling {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) InternalValue() *VertexAiFeatureOnlineStoreBigtable {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) ComputeFqn() *string {
	var returns *string
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) PutAutoScaling(value *VertexAiFeatureOnlineStoreBigtableAutoScaling) {
	if err := v.validatePutAutoScalingParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VertexAiFeatureOnlineStoreBigtableOutputReference) ToString() *string {
	var returns *string
