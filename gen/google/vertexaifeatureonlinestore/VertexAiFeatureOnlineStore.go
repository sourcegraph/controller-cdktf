...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/vertex_ai_feature_online_store google_vertex_ai_feature_online_store}.
type VertexAiFeatureOnlineStore interface {
	cdktf.TerraformResource
	Bigtable() VertexAiFeatureOnlineStoreBigtableOutputReference
	BigtableInput() *VertexAiFeatureOnlineStoreBigtable
	// Experimental.
...
type jsiiProxy_VertexAiFeatureOnlineStore struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_VertexAiFeatureOnlineStore) Bigtable() VertexAiFeatureOnlineStoreBigtableOutputReference {
	var returns VertexAiFeatureOnlineStoreBigtableOutputReference
	_jsii_.Get(
		j,
		"bigtable",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) BigtableInput() *VertexAiFeatureOnlineStoreBigtable {
	var returns *VertexAiFeatureOnlineStoreBigtable
	_jsii_.Get(
		j,
		"bigtableInput",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Labels() *map[string]*string {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Node() constructs.Node {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) Timeouts() VertexAiFeatureOnlineStoreTimeoutsOutputReference {
	var returns VertexAiFeatureOnlineStoreTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureOnlineStore) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/resources/vertex_ai_feature_online_store google_vertex_ai_feature_online_store} Resource.
func NewVertexAiFeatureOnlineStore(scope constructs.Construct, id *string, config *VertexAiFeatureOnlineStoreConfig) VertexAiFeatureOnlineStore {
	...
	if err := validateNewVertexAiFeatureOnlineStoreParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VertexAiFeatureOnlineStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVertexAiFeatureOnlineStore_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VertexAiFeatureOnlineStore_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.vertexAiFeatureOnlineStore.VertexAiFeatureOnlineStore",
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) MoveFromId(id *string) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) MoveToId(id *string) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) PutBigtable(value *VertexAiFeatureOnlineStoreBigtable) {
	if err := v.validatePutBigtableParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetBigtable() {
	_jsii_.InvokeVoid(
		v,
		"resetBigtable",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetForceDestroy() {
	_jsii_.InvokeVoid(
		v,
		"resetForceDestroy",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetProject() {
	_jsii_.InvokeVoid(
		v,
		"resetProject",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureOnlineStore) ToString() *string {
	var returns *string
