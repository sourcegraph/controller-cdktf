...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/data-sources/dataplex_datascan_iam_policy google_dataplex_datascan_iam_policy}.
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) DataScanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataScanId",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) DataScanIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataScanIdInput",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/data-sources/dataplex_datascan_iam_policy google_dataplex_datascan_iam_policy} Data Source.
func NewDataGoogleDataplexDatascanIamPolicy(scope constructs.Construct, id *string, config *DataGoogleDataplexDatascanIamPolicyConfig) DataGoogleDataplexDatascanIamPolicy {
	...
	if err := validateNewDataGoogleDataplexDatascanIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.45.0/docs/data-sources/dataplex_datascan_iam_policy google_dataplex_datascan_iam_policy} Data Source.
func NewDataGoogleDataplexDatascanIamPolicy_Override(d DataGoogleDataplexDatascanIamPolicy, scope constructs.Construct, id *string, config *DataGoogleDataplexDatascanIamPolicyConfig) {
	_init_.Initialize()
...
func DataGoogleDataplexDatascanIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleDataplexDatascanIamPolicy.DataGoogleDataplexDatascanIamPolicy",
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexDatascanIamPolicy) ToString() *string {
	var returns *string
