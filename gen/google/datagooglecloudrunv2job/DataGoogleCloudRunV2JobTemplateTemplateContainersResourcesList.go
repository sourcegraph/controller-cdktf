...
func (j *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList_Override(d DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2JobTemplateTemplateContainersResourcesList) Resolve(_context cdktf.IResolveContext) interface{} {
