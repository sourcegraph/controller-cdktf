...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/bigqueryanalyticshubdataexchangeiambinding/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/bigquery_analytics_hub_data_exchange_iam_binding google_bigquery_analytics_hub_data_exchange_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.30.0/docs/resources/bigquery_analytics_hub_data_exchange_iam_binding google_bigquery_analytics_hub_data_exchange_iam_binding} Resource.
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) ToHclTerraform() interface{} {
	var returns interface{}
