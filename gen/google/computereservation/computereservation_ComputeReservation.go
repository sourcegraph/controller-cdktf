...
func (j *jsiiProxy_ComputeReservation) Commitment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commitment",
...
func (j *jsiiProxy_ComputeReservation) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ComputeReservation) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_ComputeReservation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ComputeReservation) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ComputeReservation) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ComputeReservation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ComputeReservation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeReservation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ComputeReservation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ComputeReservation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeReservation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ComputeReservation) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ComputeReservation) Node() constructs.Node {
...
func (j *jsiiProxy_ComputeReservation) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputeReservation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ComputeReservation) ShareSettings() ComputeReservationShareSettingsOutputReference {
	var returns ComputeReservationShareSettingsOutputReference
	_jsii_.Get(
		j,
		"shareSettings",
		&returns,
...
func (j *jsiiProxy_ComputeReservation) ShareSettingsInput() *ComputeReservationShareSettings {
	var returns *ComputeReservationShareSettings
	_jsii_.Get(
		j,
		"shareSettingsInput",
		&returns,
...
func (j *jsiiProxy_ComputeReservation) SpecificReservation() ComputeReservationSpecificReservationOutputReference {
	var returns ComputeReservationSpecificReservationOutputReference
	_jsii_.Get(
		j,
		"specificReservation",
		&returns,
...
func (j *jsiiProxy_ComputeReservation) SpecificReservationInput() *ComputeReservationSpecificReservation {
	var returns *ComputeReservationSpecificReservation
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeReservation) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_ComputeReservation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ComputeReservation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeReservation) Timeouts() ComputeReservationTimeoutsOutputReference {
	var returns ComputeReservationTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ComputeReservation) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_ComputeReservation) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
func NewComputeReservation(scope constructs.Construct, id *string, config *ComputeReservationConfig) ComputeReservation {
	...
	if err := validateNewComputeReservationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ComputeReservation)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func ComputeReservation_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.computeReservation.ComputeReservation",
...
func (c *jsiiProxy_ComputeReservation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeReservation) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ComputeReservation) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ComputeReservation) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ComputeReservation) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ComputeReservation) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ComputeReservation) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ComputeReservation) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ComputeReservation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeReservation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ComputeReservation) PutSpecificReservation(value *ComputeReservationSpecificReservation) {
...
func (c *jsiiProxy_ComputeReservation) PutTimeouts(value *ComputeReservationTimeouts) {
...
func (c *jsiiProxy_ComputeReservation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeReservation) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeReservation) ResetShareSettings() {
	_jsii_.InvokeVoid(
		c,
		"resetShareSettings",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeReservation) ResetSpecificReservationRequired() {
	_jsii_.InvokeVoid(
		c,
		"resetSpecificReservationRequired",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeReservation) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeReservation) ToString() *string {
	var returns *string
