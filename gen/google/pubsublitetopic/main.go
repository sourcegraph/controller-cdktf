...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "partitionConfig", GoGetter: "PartitionConfig"},
			_jsii_.MemberProperty{JsiiProperty: "partitionConfigInput", GoGetter: "PartitionConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "project", GoGetter: "Project"},
			_jsii_.MemberProperty{JsiiProperty: "projectInput", GoGetter: "ProjectInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putPartitionConfig", GoMethod: "PutPartitionConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putReservationConfig", GoMethod: "PutReservationConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putRetentionConfig", GoMethod: "PutRetentionConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPartitionConfig", GoMethod: "ResetPartitionConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetProject", GoMethod: "ResetProject"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegion", GoMethod: "ResetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resetReservationConfig", GoMethod: "ResetReservationConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetRetentionConfig", GoMethod: "ResetRetentionConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetZone", GoMethod: "ResetZone"},
			_jsii_.MemberProperty{JsiiProperty: "retentionConfig", GoGetter: "RetentionConfig"},
			_jsii_.MemberProperty{JsiiProperty: "retentionConfigInput", GoGetter: "RetentionConfigInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "publishMibPerSec", GoGetter: "PublishMibPerSec"},
			_jsii_.MemberProperty{JsiiProperty: "publishMibPerSecInput", GoGetter: "PublishMibPerSecInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "subscribeMibPerSec", GoGetter: "SubscribeMibPerSec"},
			_jsii_.MemberProperty{JsiiProperty: "subscribeMibPerSecInput", GoGetter: "SubscribeMibPerSecInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetThroughputReservation", GoMethod: "ResetThroughputReservation"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "throughputReservation", GoGetter: "ThroughputReservation"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "perPartitionBytes", GoGetter: "PerPartitionBytes"},
			_jsii_.MemberProperty{JsiiProperty: "perPartitionBytesInput", GoGetter: "PerPartitionBytesInput"},
