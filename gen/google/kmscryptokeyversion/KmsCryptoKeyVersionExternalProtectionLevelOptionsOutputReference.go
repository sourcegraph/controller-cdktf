...
func (k *jsiiProxy_KmsCryptoKeyVersionExternalProtectionLevelOptionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KmsCryptoKeyVersionExternalProtectionLevelOptionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
