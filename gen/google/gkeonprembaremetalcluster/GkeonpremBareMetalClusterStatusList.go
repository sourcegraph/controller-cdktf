...
func (j *jsiiProxy_GkeonpremBareMetalClusterStatusList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GkeonpremBareMetalClusterStatusList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_GkeonpremBareMetalClusterStatusList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_GkeonpremBareMetalClusterStatusList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_GkeonpremBareMetalClusterStatusList)SetWrapsSet(val *bool) {
...
func (g *jsiiProxy_GkeonpremBareMetalClusterStatusList) ComputeFqn() *string {
	var returns *string
...
func (g *jsiiProxy_GkeonpremBareMetalClusterStatusList) Get(index *float64) GkeonpremBareMetalClusterStatusOutputReference {
	if err := g.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns GkeonpremBareMetalClusterStatusOutputReference
...
func (g *jsiiProxy_GkeonpremBareMetalClusterStatusList) ToString() *string {
	var returns *string
