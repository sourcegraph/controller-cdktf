...
func (n *jsiiProxy_NetworkServicesHttpRouteRulesActionRequestHeaderModifierOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesHttpRouteRulesActionRequestHeaderModifierOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
