...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/resources/compute_target_https_proxy google_compute_target_https_proxy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.69.1/docs/resources/compute_target_https_proxy google_compute_target_https_proxy} Resource.
func NewComputeTargetHttpsProxy(scope constructs.Construct, id *string, config *ComputeTargetHttpsProxyConfig) ComputeTargetHttpsProxy {
	...
	_jsii_.Create(
		"google.computeTargetHttpsProxy.ComputeTargetHttpsProxy",
