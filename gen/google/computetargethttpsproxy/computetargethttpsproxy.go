...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_target_https_proxy google_compute_target_https_proxy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/compute_target_https_proxy google_compute_target_https_proxy} Resource.
...
func ComputeTargetHttpsProxy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateComputeTargetHttpsProxy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputeTargetHttpsProxy) MoveToId(id *string) {
