...
func (j *jsiiProxy_MonitoringGroup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_MonitoringGroup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MonitoringGroup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitoringGroup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_MonitoringGroup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MonitoringGroup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitoringGroup)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitoringGroup)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (m *jsiiProxy_MonitoringGroup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringGroup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
