...
func (m *jsiiProxy_MonitoringSloWindowsBasedSliGoodTotalRatioThresholdBasicSliPerformanceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
