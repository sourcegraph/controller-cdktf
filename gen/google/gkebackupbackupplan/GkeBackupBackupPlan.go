...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/gke_backup_backup_plan google_gke_backup_backup_plan}.
...
func (j *jsiiProxy_GkeBackupBackupPlan) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GkeBackupBackupPlan) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/gke_backup_backup_plan google_gke_backup_backup_plan} Resource.
...
func GkeBackupBackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGkeBackupBackupPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GkeBackupBackupPlan) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GkeBackupBackupPlan) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GkeBackupBackupPlan) MoveFromId(id *string) {
...
func (g *jsiiProxy_GkeBackupBackupPlan) MoveToId(id *string) {
