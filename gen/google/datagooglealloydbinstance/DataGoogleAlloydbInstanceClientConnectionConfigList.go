...
func (j *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) Get(index *float64) DataGoogleAlloydbInstanceClientConnectionConfigOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataGoogleAlloydbInstanceClientConnectionConfigOutputReference
...
func (d *jsiiProxy_DataGoogleAlloydbInstanceClientConnectionConfigList) ToString() *string {
	var returns *string
