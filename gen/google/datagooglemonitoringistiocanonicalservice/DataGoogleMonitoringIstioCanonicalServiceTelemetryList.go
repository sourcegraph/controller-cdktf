...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/datagooglemonitoringistiocanonicalservice/internal"
)
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalServiceTelemetryList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleMonitoringIstioCanonicalServiceTelemetryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMonitoringIstioCanonicalServiceTelemetryList {
	_init_.Initialize()
...
func NewDataGoogleMonitoringIstioCanonicalServiceTelemetryList_Override(d DataGoogleMonitoringIstioCanonicalServiceTelemetryList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleMonitoringIstioCanonicalServiceTelemetryList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalServiceTelemetryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleMonitoringIstioCanonicalServiceTelemetryList) Resolve(_context cdktf.IResolveContext) interface{} {
