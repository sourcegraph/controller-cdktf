...
func (j *jsiiProxy_ActiveDirectoryDomain) AdminInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"adminInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) AuthorizedNetworks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"authorizedNetworks",
...
func (j *jsiiProxy_ActiveDirectoryDomain) AuthorizedNetworksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ActiveDirectoryDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ActiveDirectoryDomain) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_ActiveDirectoryDomain) DomainNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainNameInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Fqdn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqdn",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ActiveDirectoryDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ActiveDirectoryDomain) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Labels() *map[string]*string {
...
func (j *jsiiProxy_ActiveDirectoryDomain) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Locations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"locations",
...
func (j *jsiiProxy_ActiveDirectoryDomain) LocationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"locationsInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ActiveDirectoryDomain) Node() constructs.Node {
...
func (j *jsiiProxy_ActiveDirectoryDomain) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ActiveDirectoryDomain) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ActiveDirectoryDomain) ReservedIpRange() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reservedIpRange",
...
func (j *jsiiProxy_ActiveDirectoryDomain) ReservedIpRangeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ActiveDirectoryDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ActiveDirectoryDomain) Timeouts() ActiveDirectoryDomainTimeoutsOutputReference {
	var returns ActiveDirectoryDomainTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewActiveDirectoryDomain(scope constructs.Construct, id *string, config *ActiveDirectoryDomainConfig) ActiveDirectoryDomain {
	...
	if err := validateNewActiveDirectoryDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ActiveDirectoryDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.activeDirectoryDomain.ActiveDirectoryDomain",
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ActiveDirectoryDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ActiveDirectoryDomain) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ActiveDirectoryDomain) PutTimeouts(value *ActiveDirectoryDomainTimeouts) {
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetAdmin() {
	_jsii_.InvokeVoid(
		a,
		"resetAdmin",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetAuthorizedNetworks() {
	_jsii_.InvokeVoid(
		a,
		"resetAuthorizedNetworks",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetLabels() {
	_jsii_.InvokeVoid(
		a,
		"resetLabels",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetProject() {
	_jsii_.InvokeVoid(
		a,
		"resetProject",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_ActiveDirectoryDomain) ToString() *string {
	var returns *string
