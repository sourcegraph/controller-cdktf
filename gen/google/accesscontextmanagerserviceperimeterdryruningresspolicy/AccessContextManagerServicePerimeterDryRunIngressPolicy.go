...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/access_context_manager_service_perimeter_dry_run_ingress_policy google_access_context_manager_service_perimeter_dry_run_ingress_policy}.
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunIngressPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunIngressPolicy) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_AccessContextManagerServicePerimeterDryRunIngressPolicy) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.30.0/docs/resources/access_context_manager_service_perimeter_dry_run_ingress_policy google_access_context_manager_service_perimeter_dry_run_ingress_policy} Resource.
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunIngressPolicy) ResetTitle() {
	_jsii_.InvokeVoid(
		a,
		"resetTitle",
		nil, // no parameters
