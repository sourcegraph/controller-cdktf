...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/tagstagkeyiampolicy/internal"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/tags_tag_key_iam_policy google_tags_tag_key_iam_policy}.
...
func (j *jsiiProxy_TagsTagKeyIamPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/tags_tag_key_iam_policy google_tags_tag_key_iam_policy} Resource.
...
func (j *jsiiProxy_TagsTagKeyIamPolicy)SetCount(val interface{}) {
...
func TagsTagKeyIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTagsTagKeyIamPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) MoveFromId(id *string) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) MoveToId(id *string) {
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TagsTagKeyIamPolicy) ToHclTerraform() interface{} {
	var returns interface{}
