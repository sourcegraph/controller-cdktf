...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "indexUpdateMethodInput", GoGetter: "IndexUpdateMethodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIndexUpdateMethod", GoMethod: "ResetIndexUpdateMethod"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "leafNodesToSearchPercentInput", GoGetter: "LeafNodesToSearchPercentInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetLeafNodeEmbeddingCount", GoMethod: "ResetLeafNodeEmbeddingCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetLeafNodesToSearchPercent", GoMethod: "ResetLeafNodesToSearchPercent"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "approximateNeighborsCountInput", GoGetter: "ApproximateNeighborsCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberProperty{JsiiProperty: "featureNormTypeInput", GoGetter: "FeatureNormTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAlgorithmConfig", GoMethod: "PutAlgorithmConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlgorithmConfig", GoMethod: "ResetAlgorithmConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetApproximateNeighborsCount", GoMethod: "ResetApproximateNeighborsCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetDistanceMeasureType", GoMethod: "ResetDistanceMeasureType"},
			_jsii_.MemberMethod{JsiiMethod: "resetFeatureNormType", GoMethod: "ResetFeatureNormType"},
			_jsii_.MemberMethod{JsiiMethod: "resetShardSize", GoMethod: "ResetShardSize"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "shardSize", GoGetter: "ShardSize"},
			_jsii_.MemberProperty{JsiiProperty: "shardSizeInput", GoGetter: "ShardSizeInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "contentsDeltaUriInput", GoGetter: "ContentsDeltaUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
