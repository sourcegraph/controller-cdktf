...
func (v *jsiiProxy_VertexAiIndexMetadataConfigAlgorithmConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiIndexMetadataConfigAlgorithmConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
