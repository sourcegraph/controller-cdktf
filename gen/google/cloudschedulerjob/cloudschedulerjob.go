...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/cloud_scheduler_job google_cloud_scheduler_job}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/cloud_scheduler_job google_cloud_scheduler_job} Resource.
...
func CloudSchedulerJob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCloudSchedulerJob_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CloudSchedulerJob) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudSchedulerJob) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudSchedulerJob) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudSchedulerJob) MoveToId(id *string) {
