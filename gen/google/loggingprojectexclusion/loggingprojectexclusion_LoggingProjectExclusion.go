...
import (
	...
	"github.com/sourcegraph/controller-cdktf/gen/google/loggingprojectexclusion/internal"
)
...
func (j *jsiiProxy_LoggingProjectExclusion) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LoggingProjectExclusion) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingProjectExclusion) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LoggingProjectExclusion) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LoggingProjectExclusion) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_LoggingProjectExclusion) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_LoggingProjectExclusion) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingProjectExclusion) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingProjectExclusion) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingProjectExclusion) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingProjectExclusion) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingProjectExclusion) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LoggingProjectExclusion) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingProjectExclusion) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_LoggingProjectExclusion) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_LoggingProjectExclusion) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewLoggingProjectExclusion(scope constructs.Construct, id *string, config *LoggingProjectExclusionConfig) LoggingProjectExclusion {
	...
	if err := validateNewLoggingProjectExclusionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LoggingProjectExclusion)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func LoggingProjectExclusion_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google.loggingProjectExclusion.LoggingProjectExclusion",
...
func (l *jsiiProxy_LoggingProjectExclusion) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingProjectExclusion) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingProjectExclusion) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingProjectExclusion) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectExclusion) ResetDisabled() {
	_jsii_.InvokeVoid(
		l,
		"resetDisabled",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectExclusion) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectExclusion) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectExclusion) ResetProject() {
	_jsii_.InvokeVoid(
		l,
		"resetProject",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingProjectExclusion) ToString() *string {
	var returns *string
