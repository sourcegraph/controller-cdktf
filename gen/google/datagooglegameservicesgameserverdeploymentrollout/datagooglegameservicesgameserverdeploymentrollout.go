...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/data-sources/game_services_game_server_deployment_rollout google_game_services_game_server_deployment_rollout} Data Source.
...
func DataGoogleGameServicesGameServerDeploymentRollout_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGoogleGameServicesGameServerDeploymentRollout_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func DataGoogleGameServicesGameServerDeploymentRollout_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGoogleGameServicesGameServerDeploymentRollout_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGoogleGameServicesGameServerDeploymentRollout_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGoogleGameServicesGameServerDeploymentRollout_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
